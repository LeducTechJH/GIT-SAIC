     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "ZIP_LOV_FR" );

    Debug.println ( Debug.TRACE, "ZIP_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ZIP_LOV_FR.jdp" );
