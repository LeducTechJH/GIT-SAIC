     ...
     extends Form
{
   ...
   *
   */
  public SEL_OCUP_PTRA_FR ( )
  {
    super ( );
    this.setName ( "SEL_OCUP_PTRA_FR" );

    Debug.println ( Debug.TRACE, "SEL_OCUP_PTRA_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SEL_OCUP_PTRA_FR.jdp" );
