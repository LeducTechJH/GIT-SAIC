     ...
     extends Form
{
   ...
   *
   */
  public DSS171_RMENU_FR ( )
  {
    super ( );
    this.setName ( "DSS171_RMENU_FR" );

    Debug.println ( Debug.TRACE, "DSS171_RMENU_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DSS171_RMENU_FR.jdp" );
  ...
  {
    this.registerListener ( "DSS171_FCHI", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; DSS171_RMENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "DSS171_LF", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
