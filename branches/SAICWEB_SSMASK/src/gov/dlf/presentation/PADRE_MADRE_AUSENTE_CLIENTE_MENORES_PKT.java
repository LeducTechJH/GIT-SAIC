 ...
 */
public class PADRE_MADRE_AUSENTE_CLIENTE_MENORES_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PADRE_MADRE_AUSENTE_CLIENTE_MENORES_PKT ( )
  {
    super ( "PADRE_MADRE_AUSENTE_CLIENTE_MENORES_PKT" );
   ...
   *
   */
  public PADRE_MADRE_AUSENTE_CLIENTE_MENORES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PADRE_MADRE_AUSENTE_CLIENTE_MENORES_PKT ( MDIFrame pFrame )
  {
    super ( "PADRE_MADRE_AUSENTE_CLIENTE_MENORES_PKT", pFrame );
  ...
  {
    this.createComponents ( new PADRE_MADRE_AUSENTE_CLIENTE_MENORES_FR ( ) );
   ...
   *
   */
  public static PADRE_MADRE_AUSENTE_CLIENTE_MENORES_PKT get ( RallyApplication __app )
  {
    return ( PADRE_MADRE_AUSENTE_CLIENTE_MENORES_PKT ) __app.getNewInstance ( "PADRE_MADRE_AUSENTE_CLIENTE_MENORES_PKT" );
  }
  ...
  {
    PADRE_MADRE_AUSENTE_CLIENTE_MENORES_PKT fSheet = PADRE_MADRE_AUSENTE_CLIENTE_MENORES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PADRE_MADRE_AUSENTE_CLIENTE_MENORES_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; PADRE_MADRE_AUSENTE_MENORES_PAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
