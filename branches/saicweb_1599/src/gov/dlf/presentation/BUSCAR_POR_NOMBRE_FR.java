 ...
 */
public class BUSCAR_POR_NOMBRE_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public BUSCAR_POR_NOMBRE_FR ( )
  {
    super ( );
    this.setName ( "BUSCAR_POR_NOMBRE_FR" );

    Debug.println ( Debug.TRACE, "BUSCAR_POR_NOMBRE_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/BUSCAR_POR_NOMBRE_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "BUSCAR_POR_NOMBRE_GP", new BUSCAR_POR_NOMBRE_FR_BUSCAR_POR_NOMBRE_GP_Arguments ( this ) );
  ...
  {
    this.registerListener ( "BUSCAR_POR_NOMBRE_GP", JDataPanelListener.HOTKEYPRESS, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; BUSCAR_POR_NOMBRE_SELECT_SSN_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class BUSCAR_POR_NOMBRE_FR_BUSCAR_POR_NOMBRE_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public BUSCAR_POR_NOMBRE_FR_BUSCAR_POR_NOMBRE_GP_Arguments ( Form form )
  {
    this.model = form;

    this.setArgName ( "PATERNO_PAR" );
    this.setArgName ( "MATERNO_PAR" );
  ...
  public Object getArgValue ( String argName )
  {
    ...
    else if ( argName.equals ( "PATERNO_PAR" ) )
    {
      return this.app.getPATERNO_GBL ( ); // Global Variable
    }
    else if ( argName.equals ( "MATERNO_PAR" ) )
    {
      return this.app.getMATERNO_GBL ( ); // Global Variable
    }
