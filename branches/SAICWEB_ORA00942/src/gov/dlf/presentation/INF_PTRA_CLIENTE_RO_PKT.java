 ...
 */
public class INF_PTRA_CLIENTE_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INF_PTRA_CLIENTE_RO_PKT ( )
  {
    super ( "INF_PTRA_CLIENTE_RO_PKT" );
   ...
   *
   */
  public INF_PTRA_CLIENTE_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INF_PTRA_CLIENTE_RO_PKT ( MDIFrame pFrame )
  {
    super ( "INF_PTRA_CLIENTE_RO_PKT", pFrame );
   ...
   *
   */
  public static INF_PTRA_CLIENTE_RO_PKT get ( RallyApplication __app )
  {
    return ( INF_PTRA_CLIENTE_RO_PKT ) __app.getNewInstance ( "INF_PTRA_CLIENTE_RO_PKT" );
  }
  ...
  {
    INF_PTRA_CLIENTE_RO_PKT fSheet = INF_PTRA_CLIENTE_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INF_PTRA_CLIENTE_RO_PKT.exec ( __app );
  }
