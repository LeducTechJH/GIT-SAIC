 ...
 */
public class TRANSFER_ENVIADAS_SEL_FECHAS_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TRANSFER_ENVIADAS_SEL_FECHAS_FR ( )
  {
    super ( );
    this.setName ( "TRANSFER_ENVIADAS_SEL_FECHAS_FR" );

    Debug.println ( Debug.TRACE, "TRANSFER_ENVIADAS_SEL_FECHAS_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TRANSFER_ENVIADAS_SEL_FECHAS_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "FINISH_ACTION", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      { 
        app.errorFlag = true; TRANSFER_ENVIADAS_ADL.exec ( app ); return app.errorFlag;    
      }
    } );
  }
}
