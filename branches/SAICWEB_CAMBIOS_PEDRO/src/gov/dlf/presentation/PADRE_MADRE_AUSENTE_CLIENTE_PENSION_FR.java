...
import gov.dlf.logic.CHECK_NUM_PADRE_MADRE_AUSENTE_PENSION_ADL;
import gov.dlf.logic.CHECK_PADRE_MADRE_AUSENTE_PENSION_PARK_CMD_ADL;
import gov.dlf.logic.PADRE_MADRE_AUSENTE_CLIENTE_PENSION_BV_ADL;
 ...
 */
public class PADRE_MADRE_AUSENTE_CLIENTE_PENSION_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public PADRE_MADRE_AUSENTE_CLIENTE_PENSION_FR ( )
  {
    super ( );
    this.setName ( "PADRE_MADRE_AUSENTE_CLIENTE_PENSION_FR" );

    Debug.println ( Debug.TRACE, "PADRE_MADRE_AUSENTE_CLIENTE_PENSION_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/PADRE_MADRE_AUSENTE_CLIENTE_PENSION_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "NOMBRE_PADRE_AUSENTE", new PADRE_MADRE_AUSENTE_CLIENTE_PENSION_FR_NOMBRE_PADRE_AUSENTE_Arguments ( this ) );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "SEGURO_SOCIAL_PADRE_AUSENTE", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CHECK_NUM_PADRE_MADRE_AUSENTE_PENSION_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    ...
    this.registerListener ( "PARK", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CHECK_PADRE_MADRE_AUSENTE_PENSION_PARK_CMD_ADL.exec ( app ); return app.errorFlag;
      }
    } );
/*
...
*/
    ...
    this.registerListener ( "INGRESO_CLIENTE", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; PADRE_MADRE_AUSENTE_CLIENTE_PENSION_BV_ADL.exec ( app ); return app.errorFlag;
      }
    } );
 ...
 *
 */
class PADRE_MADRE_AUSENTE_CLIENTE_PENSION_FR_NOMBRE_PADRE_AUSENTE_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public PADRE_MADRE_AUSENTE_CLIENTE_PENSION_FR_NOMBRE_PADRE_AUSENTE_Arguments ( Form form )
  {
    this.model = form;
