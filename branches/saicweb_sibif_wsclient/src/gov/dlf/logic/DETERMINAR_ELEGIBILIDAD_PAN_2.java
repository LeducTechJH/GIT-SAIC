...
//*****
     ...
     //Mod by JOR an LLM 5/4/2010
    	if ((Compare.ge(MathService.plus(MathService.plus(MathService.plus(MathService.plus(ANCIANO_COUNT, INCAPACITADO_COUNT), MENOR_COUNT), CONY_COUNT), NCAL_COUNT),NCAL_COUNT )) && (Compare.lt(MENOR_COUNT, UNIDAD_NCAL)) && (Compare.equals (OTROS,0) )  && (Compare.equals (INGRESO_CONY,0)) )             
//*****
     {
