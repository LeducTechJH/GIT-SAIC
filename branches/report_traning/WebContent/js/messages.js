  ...
  this.viewLegend = function ( messageArray )
  {
    ...
    */
    ...
    if ( legendComponent )
    {
      ...
      legendComponent.style.zIndex = 10000;
...
function printForm  ( code )
{
  ...
  printWin = window.open ( "PrintFormAction.mes?printFormAction=" + code, null, "top=50000,height=" + h +",width=" + w + ",status=no,toolbar=no,menubar=no,location=no,scrollbars=no", false );
...
function printPdf  ( code )
{
 ...
 printWin = window.open ( "PrintFormAction.mes?printFormAction=" + code, null, "top=50000,height=" + h +",width=" + w + ",status=no,toolbar=no,menubar=no,location=no,scrollbars=yes", false );
