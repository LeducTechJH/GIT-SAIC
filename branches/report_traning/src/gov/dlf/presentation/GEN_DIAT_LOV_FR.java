     ...
     extends Form
{
   ...
   *
   */
  public GEN_DIAT_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_DIAT_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_DIAT_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_DIAT_LOV_FR.jdp" );
