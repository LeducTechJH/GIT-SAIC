 ...
 */
public class SEGUIMIENTO_GESTION_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SEGUIMIENTO_GESTION_PKT ( )
  {
    super ( "SEGUIMIENTO_GESTION_PKT" );
   ...
   *
   */
  public SEGUIMIENTO_GESTION_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SEGUIMIENTO_GESTION_PKT ( MDIFrame pFrame )
  {
    super ( "SEGUIMIENTO_GESTION_PKT", pFrame );
   ...
   *
   */
  public static SEGUIMIENTO_GESTION_PKT get ( RallyApplication __app )
  {
    return ( SEGUIMIENTO_GESTION_PKT ) __app.getNewInstance ( "SEGUIMIENTO_GESTION_PKT" );
  }
  ...
  {
    SEGUIMIENTO_GESTION_PKT fSheet = SEGUIMIENTO_GESTION_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SEGUIMIENTO_GESTION_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; EMP_PAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
