     ...
     extends Form
{
   ...
   *
   */
  public GEN_TLIC_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_TLIC_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_TLIC_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_TLIC_LOV_FR.jdp" );
