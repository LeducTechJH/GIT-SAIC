 ...
 */
public class ANTECEDENTE_CLIENTE_UPDATE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ANTECEDENTE_CLIENTE_UPDATE_PKT ( )
  {
    super ( "ANTECEDENTE_CLIENTE_UPDATE_PKT" );
   ...
   *
   */
  public ANTECEDENTE_CLIENTE_UPDATE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ANTECEDENTE_CLIENTE_UPDATE_PKT ( MDIFrame pFrame )
  {
    super ( "ANTECEDENTE_CLIENTE_UPDATE_PKT", pFrame );
  ...
  {
    this.createComponents ( new ANTECEDENTE_CLIENTE_FR ( ) );
   ...
   *
   */
  public static ANTECEDENTE_CLIENTE_UPDATE_PKT get ( RallyApplication __app )
  {
    return ( ANTECEDENTE_CLIENTE_UPDATE_PKT ) __app.getNewInstance ( "ANTECEDENTE_CLIENTE_UPDATE_PKT" );
  }
  ...
  {
    ANTECEDENTE_CLIENTE_UPDATE_PKT fSheet = ANTECEDENTE_CLIENTE_UPDATE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ANTECEDENTE_CLIENTE_UPDATE_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; ANTE_PAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
