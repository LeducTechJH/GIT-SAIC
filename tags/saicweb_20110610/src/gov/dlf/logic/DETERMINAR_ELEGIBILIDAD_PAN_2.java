...
//*****
  ...
  protected void process ( ParameterSet ps )
  {
    ...
    switch ( this.currentStep )
    {
      ...
      case 37:  { this.currentStep ++; this.step37 ( this.keyParms ); break; }
      case 38:  { this.currentStep ++; this.step38 ( this.keyParms ); break; }
      case 39:  { this.currentStep ++; this.step39 ( this.keyParms ); break; }
      case 40:  { this.currentStep ++; this.step40 ( this.keyParms ); break; }
      case 41:  { this.currentStep ++; this.step41 ( this.keyParms ); break; }
      case 42:  { this.currentStep ++; this.step42 ( this.keyParms ); break; }
      case 43:  { this.currentStep ++; this.step43 ( this.keyParms ); break; }
      case 44:  { this.currentStep ++; this.step44 ( this.keyParms ); break; }
      default:
      {
        this.currentStep = 0;
...
//*****
  ...
  protected void step9 ( ParameterSet ps )
  {
    ...
    if ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) )
    {
      if ( Compare.ge ( this.app.SYSTEM_DATE, RallySpanishDatesParser.parseDateString ( "1-MAR-2007" ) ) )
      {
        INGRESO_BRUTO = 0;
        RECURSOS_BRUTO = 0;
      }
    ...
    {
      if ( Compare.ge ( this.app.SYSTEM_DATE, RallySpanishDatesParser.parseDateString ( "13-MAR-2007" ) ) )
      {
        INGRESO_BRUTO = 0;
        RECURSOS_BRUTO = 0;
      }
    ...
    if ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) )
    {
      if ( ( Compare.ge ( this.app.SYSTEM_DATE, RallySpanishDatesParser.parseDateString ( "1-MAR-2007" ) ) ) && ( Compare.lt ( this.app.SYSTEM_DATE, RallySpanishDatesParser.parseDateString ( "1-ABR-2007" ) ) )  )
      {
    ...
    {
      while ( ( Compare.equals ( STATUS_CODE, 0 ) ) && ( Compare.le ( this.dm.getFieldDate ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "FECHA_EFECTIVIDAD" ), this.app.SYSTEM_DATE ) )   )
      {
...
/// Changes Amendment # 3 PAN oct-2008
    ...
    if ( Compare.ge ( this.app.SYSTEM_DATE, RallySpanishDatesParser.parseDateString ( "21-SEP-2008" ) ) )
    {
...
//*****
    ...
    else if ( Compare.ge ( this.app.SYSTEM_DATE, RallySpanishDatesParser.parseDateString ( "1-OCT-2007" ) ) )
            {
//*****
              ...
              if (Compare.ge(MathService.plus(MathService.plus(ANCIANO_COUNT, INCAPACITADO_COUNT), MENOR_COUNT), UNIDAD_NCAL) && (Compare.lt(MENOR_COUNT, UNIDAD_NCAL)) && (Compare.equals (INGRESOS_NUCLEO,SEG_SOC) )   )
//*****
                {
                            SEG_SOC =  TruncService.round(SEG_SOC*EXENCION_SEG_SOC,2);
                }
            }
    else if ( Compare.ge ( this.app.SYSTEM_DATE, RallySpanishDatesParser.parseDateString ( "1-OCT-2004" ) ) )
            {
//*****
...
//*****
    ...
    while ( Compare.equals ( STATUS_CODE, 0 )  )
    {
      ...
      {
        EDAD_IND = DateUtil.monthsBetween ( this.app.FCH_SOLIC_SERV_GBL, this.dm.getFieldDate ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FCH_NACIMIENTO" ) ) / 12;
      }
...
//***** START MODS BY J. OLMEDA (KPG INC) 7/17/2009 *****
          ...
          if ( Compare.gt ( this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" ), 525 ) )
          {
...
//***** END MODS BY J. OLMEDA (KPG INC) 7/17/2009 *****
  ...
  protected void step21 ( ParameterSet ps )
  {
    ...
    if ( this._condition8 )
    {
      ...
      if ( ( Compare.ge ( DIA_SOLIC_LV, 1 ) ) && ( Compare.le ( DIA_SOLIC_LV, 10 ) )  )
      {
        BENEFICIO_PRORRATEADO = BENEFICIO_TEMP;
      }
      else if ( ( Compare.ge ( DIA_SOLIC_LV, 11 ) ) && ( Compare.le ( DIA_SOLIC_LV, 20 ) )   )
      {
        BENEFICIO_PRORRATEADO = TruncService.trunc ( BENEFICIO_TEMP * 0.66 ) ;
      }
      else if ( ( Compare.ge ( DIA_SOLIC_LV, 21 ) ) && ( Compare.le ( DIA_SOLIC_LV, 31 ) )   )
      {
        BENEFICIO_PRORRATEADO = TruncService.trunc ( BENEFICIO_TEMP * 0.34 ) ;
      }
    ...
    if ( this._condition10 )
    {
      ...
      if ( this._condition11 )
      {
        ...
        if ( this._condition12 )
        {
          ...
          {
            BENEFICIO = 10;
            Debug.println ( Debug.TRACE, "BENEFICIO is set in line 4899" );
  ...
  protected void step26 ( ParameterSet ps )
  {
    ...
    {
      if ( this._condition11 )    //      if ( Compare.lt ( BENEFICIO, 10 ) )
      {
        if ( this._condition12 )    //        if ( Compare.equals ( UNIDAD, 1 ) )
        {
          if ( ( Compare.ge ( INGRESO_NETO, 166 ) ) && ( Compare.lt ( INGRESO_NETO, 304 ) )  )
          {
          }
    ...
    if ( this._condition10 )    //    if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) || ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) ) )
    {
      if ( this._condition11 )    //      if ( Compare.lt ( BENEFICIO, 10 ) )
      {
        ...
        if ( this._condition13 )
        {
          ...
          {
            BENEFICIO = 10;
            Debug.println ( Debug.TRACE, "BENEFICIO is set in line 5071" );
  ...
  protected void step30 ( ParameterSet ps )
  {
    if ( this._condition10 )    //    if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) || ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) ) )
    {
      if ( this._condition11 )    //      if ( Compare.lt ( BENEFICIO, 10 ) )
      {
        if ( this._condition13 )    //        if ( Compare.equals ( UNIDAD, 2 ) )
        {
          if ( ( Compare.ge ( INGRESO_NETO, 334 ) ) && ( Compare.lt ( INGRESO_NETO, 410 ) )  )
          {
          }
    ...
    if ( this._condition10 )    //    if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) || ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) ) )
    {
      if ( this._condition11 )    //      if ( Compare.lt ( BENEFICIO, 10 ) )
      {
        ...
        if ( this._condition14 )
        {
          ...
          {
            BENEFICIO = 10;
            Debug.println ( Debug.TRACE, "BENEFICIO is set in line 5243" );
  ...
  protected void step34 ( ParameterSet ps )
  {
    if ( this._condition10 )    //    if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) || ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) ) )
    {
      if ( this._condition11 )    //      if ( Compare.lt ( BENEFICIO, 10 ) )
      {
        if ( this._condition14 )    //        if ( Compare.equals ( UNIDAD, 3 ) )
        {
          if ( ( Compare.ge ( INGRESO_NETO, 490 ) ) && ( Compare.lt ( INGRESO_NETO, 520 ) )  )
          {
          }
   ...
   *
   */
  protected void step37 ( ParameterSet ps )
  {
    if ( this._condition10 )    //    if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) || ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) ) )
    {
      if ( this._condition11 )    //      if ( Compare.lt ( BENEFICIO, 10 ) )
   ...
   *
   */
  protected void step38 ( ParameterSet ps )
  {
    if ( this._condition10 )    //    if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) || ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) ) )
    {
      if ( this._condition11 )    //      if ( Compare.lt ( BENEFICIO, 10 ) )
      {
        if ( this._condition15 )    //        if ( Compare.gt ( UNIDAD, 3 ) )
        {
          DETERMINACION_FINAL_MENU.exec ( this.app );
          return;
        }
   ...
   *
   */
  protected void step39 ( ParameterSet ps )
  {
    if ( this._condition10 )    //    if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) || ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) ) )
    {
      if ( this._condition11 )    //      if ( Compare.lt ( BENEFICIO, 10 ) )
   ...
   *
   */
  protected void step40 ( ParameterSet ps )
  {
    if ( this._condition10 )    //    if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) || ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) ) )
    {
      if ( this._condition11 )    //      if ( Compare.lt ( BENEFICIO, 10 ) )
   ...
   *
   */
  protected void step41 ( ParameterSet ps )
  {
    if ( this._condition10 )    //    if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) || ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) ) )
    {
      if ( this._condition11 )    //      if ( Compare.lt ( BENEFICIO, 10 ) )
    ...
    if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) && ( Compare.equals ( ELEGIBLE_EMER, "*" ) )  && ( Compare.le ( DIA_SOLIC_LV, 10 ) )  )
    {
   ...
   *
   */
  protected void step42 ( ParameterSet ps )
  {
    DIA_SOLIC_LV = FormattingFactory.parseStringToDouble ( StringService.toStringValue  ( this.app.FCH_SOLIC_SERV_GBL ,"dd" ,StringService.Language.SPANISH ) );
    if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) && ( Compare.equals ( this.app.AJUSTE_GLB, 0.0 ) )  )
    {
      if ( ( Compare.ge ( DIA_SOLIC_LV, 1 ) ) && ( Compare.le ( DIA_SOLIC_LV, 10 ) )  )
      {
    ...
    if ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) )
    {
      if ( Compare.ge ( this.app.SYSTEM_DATE, RallySpanishDatesParser.parseDateString ( "27-MAR-2007" ) ) )
      {
      ...
      {
        BENEFICIO = TruncService.trunc ( BENEFICIO ) ;
        Debug.println ( Debug.TRACE, "BENEFICIO is set in line 5612" );
   ...
   *
   */
  protected void step43 ( ParameterSet ps )
  {
    DETERMINACION_FINAL_MENU.exec ( this.app );
    return;
   ...
   *
   */
  protected void step44 ( ParameterSet ps )
  {
    if ( ( Compare.equals ( this.app.DETERMINACION_FINAL_GBL, "N" ) ) || ( Compare.equals ( this.app.DETERMINACION_FINAL_GBL, "n" ) ) )
    {
      this.doReturn ( );
