     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS172_RMENU_PKT ( )
  {
    super ( "DSS172_RMENU_PKT" );
   ...
   *
   */
  public DSS172_RMENU_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS172_RMENU_PKT ( MDIFrame pFrame )
  {
    super ( "DSS172_RMENU_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS172_RMENU_FR ( ) );
   ...
   *
   */
  public static DSS172_RMENU_PKT get ( RallyApplication __app )
  {
    return ( DSS172_RMENU_PKT ) __app.getNewInstance ( "DSS172_RMENU_PKT" );
  }
  ...
  {
    DSS172_RMENU_PKT fSheet = DSS172_RMENU_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS172_RMENU_PKT.exec ( __app );
  }
