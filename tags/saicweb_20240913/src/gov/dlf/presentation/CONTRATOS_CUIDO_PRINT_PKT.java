 ...
 */
public class CONTRATOS_CUIDO_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CONTRATOS_CUIDO_PRINT_PKT ( )
  {
    super ( "CONTRATOS_CUIDO_PRINT_PKT" );
   ...
   *
   */
  public CONTRATOS_CUIDO_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CONTRATOS_CUIDO_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "CONTRATOS_CUIDO_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CONTRATOS_CUIDO_PRINT_FR ( ) );
   ...
   *
   */
  public static CONTRATOS_CUIDO_PRINT_PKT get ( RallyApplication __app )
  {
    return ( CONTRATOS_CUIDO_PRINT_PKT ) __app.getNewInstance ( "CONTRATOS_CUIDO_PRINT_PKT" );
  }
  ...
  {
    CONTRATOS_CUIDO_PRINT_PKT fSheet = CONTRATOS_CUIDO_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CONTRATOS_CUIDO_PRINT_PKT.exec ( __app );
  }
