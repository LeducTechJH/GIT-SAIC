 ...
 */
public class ENTREVISTA_BLANCO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ENTREVISTA_BLANCO_PKT ( )
  {
    super ( "ENTREVISTA_BLANCO_PKT" );
   ...
   *
   */
  public ENTREVISTA_BLANCO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ENTREVISTA_BLANCO_PKT ( MDIFrame pFrame )
  {
    super ( "ENTREVISTA_BLANCO_PKT", pFrame );
  ...
  {
    this.createComponents ( new ENTREVISTA_BLANCO_FR ( ) );
   ...
   *
   */
  public static ENTREVISTA_BLANCO_PKT get ( RallyApplication __app )
  {
    return ( ENTREVISTA_BLANCO_PKT ) __app.getNewInstance ( "ENTREVISTA_BLANCO_PKT" );
  }
  ...
  {
    ENTREVISTA_BLANCO_PKT fSheet = ENTREVISTA_BLANCO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ENTREVISTA_BLANCO_PKT.exec ( __app );
  }
