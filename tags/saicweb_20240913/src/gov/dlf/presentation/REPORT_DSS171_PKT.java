 ...
 */
public class REPORT_DSS171_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REPORT_DSS171_PKT ( )
  {
    super ( "REPORT_DSS171_PKT" );
   ...
   *
   */
  public REPORT_DSS171_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REPORT_DSS171_PKT ( MDIFrame pFrame )
  {
    super ( "REPORT_DSS171_PKT", pFrame );
  ...
  {
    this.createComponents ( new REPORT_DSS171_RP ( ) );
   ...
   *
   */
  public static REPORT_DSS171_PKT get ( RallyApplication __app )
  {
    return ( REPORT_DSS171_PKT ) __app.getNewInstance ( "REPORT_DSS171_PKT" );
  }
  ...
  {
    REPORT_DSS171_PKT fSheet = REPORT_DSS171_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REPORT_DSS171_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; REPORT_DSS171_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
