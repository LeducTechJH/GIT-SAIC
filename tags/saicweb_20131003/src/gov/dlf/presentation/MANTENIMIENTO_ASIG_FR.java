 ...
 */
public class MANTENIMIENTO_ASIG_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_ASIG_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_ASIG_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_ASIG_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_ASIG_FR.jdp" );
