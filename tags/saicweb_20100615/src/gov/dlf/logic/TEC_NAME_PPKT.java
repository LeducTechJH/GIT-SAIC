  ...
  implements IRegisteredObject 
{
   ...
   *
   */
  public static TEC_NAME_PPKT get ( RallyApplication __app )
  {
    TEC_NAME_PPKT pp = ( TEC_NAME_PPKT ) __app.getNewInstance ( "TEC_NAME_PPKT" );
    return pp;
  }
  ...
  {
    return TEC_NAME_PPKT.exec ( __app );
  }
  ...
  {
    Debug.println ( Debug.TRACE, "TEC_NAME_PPKT" );
    this.prepareParms ( );
  ...
  {
    this.app.form ( "SOLIC_SERV_VISITAS_PARA_HOY_FR" ).setValue ( "TECNICO_VAR", this.parms.getDouble ( 0 ) );
    this.app.form ( "SOLIC_SERV_VISITAS_PARA_HOY_FR" ).setValue ( "TECNICO_NAME", this.parms.getString ( 1 ) );
  }
  ...
  {
    this.parms.reset ( );
    this.parms.set ( this.app.form ( "SOLIC_SERV_VISITAS_PARA_HOY_FR" ).getValue ( "TECNICO_VAR" ) );
    this.parms.set ( this.app.form ( "SOLIC_SERV_VISITAS_PARA_HOY_FR" ).getValue ( "TECNICO_NAME" ) );
  }
