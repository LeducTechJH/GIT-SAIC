 ...
 */
public class COMPENSACION_RECLA_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public COMPENSACION_RECLA_PKT ( )
  {
    super ( "COMPENSACION_RECLA_PKT" );
   ...
   *
   */
  public COMPENSACION_RECLA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public COMPENSACION_RECLA_PKT ( MDIFrame pFrame )
  {
    super ( "COMPENSACION_RECLA_PKT", pFrame );
   ...
   *
   */
  public static COMPENSACION_RECLA_PKT get ( RallyApplication __app )
  {
    return ( COMPENSACION_RECLA_PKT ) __app.getNewInstance ( "COMPENSACION_RECLA_PKT" );
  }
  ...
  {
    COMPENSACION_RECLA_PKT fSheet = COMPENSACION_RECLA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return COMPENSACION_RECLA_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; BEFORE_QUIT_COMPENSACION_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; BEFORE_FORM_COMPENSACION_ADL.exec ( app ); return app.errorFlag;
      }
    } );
