     ...
     extends Form
{
   ...
   *
   */
  public JUNTA_MEDICA_FR ( )
  {
    super ( );
    this.setName ( "JUNTA_MEDICA_FR" );

    Debug.println ( Debug.TRACE, "JUNTA_MEDICA_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/JUNTA_MEDICA_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "SERVICIOS_GP", new JUNTA_MEDICA_FR_SERVICIOS_GP_Arguments ( this ) );

    this.setObjectEvents ( );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new JUNTA_MEDICA_FR_OFICINAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "FECHA" );
    field.setValueProvider ( new JUNTA_MEDICA_FR_FECHAProvider ( this ) );
 ...
 *
 */
class JUNTA_MEDICA_FR_SERVICIOS_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public JUNTA_MEDICA_FR_SERVICIOS_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class JUNTA_MEDICA_FR_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public JUNTA_MEDICA_FR_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class JUNTA_MEDICA_FR_FECHAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public JUNTA_MEDICA_FR_FECHAProvider ( Form form )
  {
    this.model = form;
  }
