 ...
 */
public class COD_ACTIVIDADES_CALEND_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public COD_ACTIVIDADES_CALEND_LOV_FR ( )
  {
    super ( );
    this.setName ( "COD_ACTIVIDADES_CALEND_LOV_FR" );

    Debug.println ( Debug.TRACE, "COD_ACTIVIDADES_CALEND_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/COD_ACTIVIDADES_CALEND_LOV_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "COD_ACTIVIDADES_CALEND_LOV_GP", new COD_ACTIVIDADES_CALEND_LOV_FR_COD_ACTIVIDADES_CALEND_LOV_GP_Arguments ( this ) );
  ...
  {
    this.registerListener ( "RAZON_CONTACTO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CONCATENATE_DSC_CORTA_LARGA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class COD_ACTIVIDADES_CALEND_LOV_FR_COD_ACTIVIDADES_CALEND_LOV_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public COD_ACTIVIDADES_CALEND_LOV_FR_COD_ACTIVIDADES_CALEND_LOV_GP_Arguments ( Form form )
  {
    this.model = form;

    this.setArgName ( "COD_SERVICIO_PARM" );
  }
  ...
  public Object getArgValue ( String argName )
  {
    ...
    else if ( argName.equals ( "COD_SERVICIO_PARM" ) )
    {
