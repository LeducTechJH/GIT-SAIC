 ...
 */
public class CASOS_HIST_ESFUERZO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CASOS_HIST_ESFUERZO_PKT ( )
  {
    super ( "CASOS_HIST_ESFUERZO_PKT" );
   ...
   *
   */
  public CASOS_HIST_ESFUERZO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CASOS_HIST_ESFUERZO_PKT ( MDIFrame pFrame )
  {
    super ( "CASOS_HIST_ESFUERZO_PKT", pFrame );
  ...
  {
    this.createComponents ( new CASOS_HIST_ESFUERZO_RP ( ) );
   ...
   *
   */
  public static CASOS_HIST_ESFUERZO_PKT get ( RallyApplication __app )
  {
    return ( CASOS_HIST_ESFUERZO_PKT ) __app.getNewInstance ( "CASOS_HIST_ESFUERZO_PKT" );
  }
  ...
  {
    CASOS_HIST_ESFUERZO_PKT fSheet = CASOS_HIST_ESFUERZO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CASOS_HIST_ESFUERZO_PKT.exec ( __app );
  }
