     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS171_RMENU_PKT ( )
  {
    super ( "DSS171_RMENU_PKT" );
   ...
   *
   */
  public DSS171_RMENU_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS171_RMENU_PKT ( MDIFrame pFrame )
  {
    super ( "DSS171_RMENU_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS171_RMENU_FR ( ) );
   ...
   *
   */
  public static DSS171_RMENU_PKT get ( RallyApplication __app )
  {
    return ( DSS171_RMENU_PKT ) __app.getNewInstance ( "DSS171_RMENU_PKT" );
  }
  ...
  {
    DSS171_RMENU_PKT fSheet = DSS171_RMENU_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS171_RMENU_PKT.exec ( __app );
  }
