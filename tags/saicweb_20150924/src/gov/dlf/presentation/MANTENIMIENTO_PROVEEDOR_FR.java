     ...
     extends Form
{
  ...
  public void setObjectEvents ( )
  {
	  ...
	  this.registerListener ( "NUM_EBT", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
	  {
		  public boolean eventFired ( String eventName )
		  {
			  String numCta =  app.form("MANTENIMIENTO_PROVEEDOR_FR").getStringItem( "NUM_EBT" );  
    		  ...
    		  if (numCta.length() != 9) 
    		  {
    			  app.setError ("0", "El numero de cuenta debe ser de 9 digitos.");
    			  app.errorFlag = false;
    			  return app.errorFlag;
    		  }
			  else
