 ...
 */
public class MANTENIMIENTO_ORG_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_ORG_PKT ( )
  {
    super ( "MANTENIMIENTO_ORG_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_ORG_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_ORG_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_ORG_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_ORG_FR ( ) );
   ...
   *
   */
  public static MANTENIMIENTO_ORG_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_ORG_PKT ) __app.getNewInstance ( "MANTENIMIENTO_ORG_PKT" );
  }
  ...
  {
    MANTENIMIENTO_ORG_PKT fSheet = MANTENIMIENTO_ORG_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_ORG_PKT.exec ( __app );
  }
