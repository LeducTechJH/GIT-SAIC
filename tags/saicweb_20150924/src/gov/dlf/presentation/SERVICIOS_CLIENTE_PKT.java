 ...
 */
public class SERVICIOS_CLIENTE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SERVICIOS_CLIENTE_PKT ( )
  {
    super ( "SERVICIOS_CLIENTE_PKT" );
   ...
   *
   */
  public SERVICIOS_CLIENTE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SERVICIOS_CLIENTE_PKT ( MDIFrame pFrame )
  {
    super ( "SERVICIOS_CLIENTE_PKT", pFrame );
  ...
  {
    this.createComponents ( new SERVICIOS_CLIENTE_FRM ( ) );
   ...
   *
   */
  public static SERVICIOS_CLIENTE_PKT get ( RallyApplication __app )
  {
    return ( SERVICIOS_CLIENTE_PKT ) __app.getNewInstance ( "SERVICIOS_CLIENTE_PKT" );
  }
  ...
  {
    SERVICIOS_CLIENTE_PKT fSheet = SERVICIOS_CLIENTE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SERVICIOS_CLIENTE_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SERVICIO_CLIENTE_BEF_FORM_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
