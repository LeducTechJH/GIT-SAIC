     ...
     extends FormSheet
{
   ...
   *
   */
  public REPORT_9_18_PKT ( )
  {
    super ( "REPORT_9_18_PKT" );
   ...
   *
   */
  public REPORT_9_18_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REPORT_9_18_PKT ( MDIFrame pFrame )
  {
    super ( "REPORT_9_18_PKT", pFrame );
  ...
  {
    this.createComponents ( new REPORT_9_18_FR ( ) );
   ...
   *
   */
  public static REPORT_9_18_PKT get ( RallyApplication __app )
  {
    return ( REPORT_9_18_PKT ) __app.getNewInstance ( "REPORT_9_18_PKT" );
  }
  ...
  {
    REPORT_9_18_PKT fSheet = REPORT_9_18_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REPORT_9_18_PKT.exec ( __app );
  }
