...
function nextObject ( obj )
{
  ...
  {
	  objName = "FCH_ULT_PARIS.0";
  }
  else if ( current == "FCH_ULT_PARIS.0" )
  {
	  objName = "ULT_ACCION_PARIS.0";
  }
  else if ( current == "ULT_ACCION_PARIS.0" )
  {
	  objName = "COMENTARIO.0";
  }
...
{
  var value = getElement ( "MANT_ACCION_SERV_COPY.0" ).value; 
...
function AEC_COND ( )
{
  var value = getElement ( "COD_SERVICIO.0" ).value; 
...
function RAZON_60 ( )
{
  var value = getElement ( "TOTAL_MESES_TANF.0" ).value; 
