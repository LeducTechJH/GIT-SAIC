     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    /* Buscar en CLIENTES por SS_JEFE_GBL */    
    ...
    if ( Compare.equals ( CLIENTES2_STATUS_CODE, 0 )  )
    {
    	...
    	while ( Compare.equals ( CLIENTES2_STATUS_CODE, 0 )  )
    	{
    		...
    		noMoreRows = false;
    		while ( Compare.equals ( noMoreRows, false ) )
    		{
    			...
    			INGRESOS_CLIENTE_2_STATUS_CODE  = getFirstRow ( INGRESOS_CLIENTE_2_DSD_ID );
    			if ( Compare.equals ( INGRESOS_CLIENTE_2_STATUS_CODE, 0 ) )
    			{
    				INGRESOS_CLIENTE_2_STATUS_CODE  = this.dm.delete ( INGRESOS_CLIENTE_2_DSD_ID );
    				INGRESOS_CLIENTE_2_STATUS_CODE  = this.dm.update ( INGRESOS_CLIENTE_2_DSD );
    			}
    			else
    			{
    				noMoreRows = true;
    		...
    		while ( Compare.equals ( noMoreRows, false ) )
    		{
    			...
    			RECURSOS_CLIENTE_STATUS_CODE  = getFirstRow ( RECURSOS_CLIENTE_2_DSD_ID );
    			if ( Compare.equals ( RECURSOS_CLIENTE_STATUS_CODE, 0 ) )
    			{
    				RECURSOS_CLIENTE_STATUS_CODE  = this.dm.delete ( RECURSOS_CLIENTE_2_DSD_ID );
    				RECURSOS_CLIENTE_STATUS_CODE  = this.dm.update ( RECURSOS_CLIENTE_2_DSD );
    			}
    			else
    			{
    				noMoreRows = true;
    		...
    		while ( Compare.equals ( noMoreRows, false ) )
    		{
    			...
    			DEDUCCIONES_CLIENTE2_STATUS_CODE  = getFirstRow ( DEDUCCIONES_CLIENTE2_DSD_ID );
    			if ( Compare.equals ( DEDUCCIONES_CLIENTE2_STATUS_CODE, 0 ) )
    			{
    				DEDUCCIONES_CLIENTE2_STATUS_CODE  = this.dm.delete ( DEDUCCIONES_CLIENTE2_DSD_ID );
    				DEDUCCIONES_CLIENTE2_STATUS_CODE  = this.dm.update ( DEDUCCIONES_CLIENTE2_DSD );
    			}
    			else
    			{
    				noMoreRows = true;
    		...
    		while ( Compare.equals ( noMoreRows, false ) )
    		{
    			...
    			BILLETES_STATUS_CODE  = getFirstRow ( BILLETES_DSD_ID );
    			if ( Compare.equals ( BILLETES_STATUS_CODE, 0 ) )
    			{
    				BILLETES_STATUS_CODE  = this.dm.delete ( BILLETES_DSD_ID );
    				BILLETES_STATUS_CODE  = this.dm.update ( BILLETES_DSD );
    			}
    			else
    			{
    				noMoreRows = true;
		...
		while ( Compare.equals ( noMoreRows, false ) )
		{
			...
			NUCLEO_SERVICIO_STATUS_CODE = setFieldDouble ( NUCLEO_SERVICIO_UPD_DSD , "RMO_OFICINA", this.app.RMO_GBL );
			//NUCLEO_SERVICIO_STATUS_CODE = setFieldDouble ( NUCLEO_SERVICIO_UPD_DSD , "RMO_OFICINA2", this.app.RMO_GBL );
			NUCLEO_SERVICIO_STATUS_CODE  = getFirstRow ( NUCLEO_SERVICIO_DSD_ID );
			if ( Compare.equals ( NUCLEO_SERVICIO_STATUS_CODE, 0 ) )
			{
				NUCLEO_SERVICIO_STATUS_CODE  = this.dm.delete ( NUCLEO_SERVICIO_DSD_ID );
				NUCLEO_SERVICIO_STATUS_CODE  = this.dm.update ( NUCLEO_SERVICIO_UPD_DSD );
			}
			else
			{
				noMoreRows = true;
		...
		while ( Compare.equals ( noMoreRows, false ) )
		{
			...
			if ( Compare.equals ( CLIENTES2_STATUS_CODE, 0 ) )
			{
				...
				CLIENTES2_STATUS_CODE  = this.dm.update ( CLIENTES2_DSD );
			}
			else
			{
				noMoreRows = true;
		...
		/* --------------------- */
		/* Copiar datos del HIST */
		/* --------------------- */
	    CLIENTES_HIST_RW_STATUS_CODE  = this.dm.reset ( CLIENTES_HIST_RW_DSD_ID );
	    setFieldDouble ( CLIENTES_HIST_RW_DSD, "SEGURO_SOCIAL_JEFE_FAMILIA", this.app.SS_JEFE_GBL );
	    setFieldString ( CLIENTES_HIST_RW_DSD, "TIPO_TRANS", "T" );
	    CLIENTES_HIST_RW_STATUS_CODE  = getFirstRow ( CLIENTES_HIST_RW_DSD_ID );
	    if ( ! Compare.equals ( CLIENTES_HIST_RW_STATUS_CODE, 0 ) ) 
	    {
	    	this.app.setError ( 2, CLIENTES_HIST_RW_STATUS_CODE );
	    }
	    while ( Compare.equals ( CLIENTES_HIST_RW_STATUS_CODE, 0 )  )
	    {
			// copiar record corriente de CLIENTES_HIST a CLIENTES
	    	setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "RMO_OFICINA");
	    	setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "USUARIO" );
	    	setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "SEGURO_SOCIAL_CLIENTE" );
	    	setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "SEGURO_SOCIAL_JEFE_FAMILIA" );
	    	setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "DSC_APELLIDO_PATERNO" );
	    	setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "DSC_APELLIDO_MATERNO" );
	    	setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "DSC_NOMBRE" );
	    	setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "DSC_INICIAL" );
	    	setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_PARENTESCO_FAM" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_NACIMIENTO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "SEXO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "ID_INDICE_SOUNDEX" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_DISPOSICION_CLIENTE" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_STATUS_DISP" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "TELEFONO_HOGAR" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "TELEFONO_TRABAJO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_INSTITUCION" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_INCAPACIDAD_PRIMARIA" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_INCAPACIDAD_SECUNDARIA" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_CIUDADANIA" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_ESCOLARIDAD" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_ESTATUS_EMPLEO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_ESTADO_CIVIL" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_OCUPACION" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_PROBLEMA" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "ID_NUMERO_EXTRANJERO" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_ARRIBO_EXTRANJERO" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_EXPIRACION_MEDICAID" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "ID_NUMERO_MEDICAID" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_EXPIRACION_MEDICARE" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "ID_NUMERO_MEDICARE" );
	        setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "SEGURO_SOCIAL_ANTERIOR" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_PASOS" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_RAZON_DESCALIFICADO_PAN" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_RAZON_DESCALIFICADO_AE" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_ANTECEDENTES_PROGRAMA" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "ANTECEDE_PROGRAMA_NUM_CASO" );
	        setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "ANTECEDE_PROGRAMA_OFIC_LOCAL" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "ANTECEDE_FECHAS_CIERRE" );
	        setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "NUM_MESES_DESC_PAN" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_DESCALIFICADO_PAN" );
	        setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "NUM_MESES_DESC_AE" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_DESCALIFACADO_AE" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "ANTECEDE_RAZON" );
	        setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "NUM_VECES_DESC" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FLG_DESCALIFICADO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FLG_INCAPACIDAD_VERIFICADA" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "DSC_INSTITUCION_ESCUELA" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_PSM" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_AEC_FACTOR_ELEG" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FLG_REHABILITACION_VOC" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FACT_ELEGIBILIDAD_AEC" );
	        setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "RMO_COD" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "COD_STATUS" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_STATUS" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "CESION_MEDICAID" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "NOMBRE_PLAN_MEDICO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "TIPO_CUBIERTA_MEDICARE" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "DSC_APODO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FLG_PRES" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FLG_TANF" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "TIPO_REGISTRO" );
	        setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "MESES_SWIP" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "ESTUDIA_TIEMPO_COMPLETO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "ASISTE_REGULARIDAD" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "CONVICTO_SUSTANCIAS" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "CONVICTO_SUSTANCIAS_F_E" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "CONVICTO_DECL_FRAUD" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "CONVICTO_DECL_FRAUD_F_E" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "VIOLACION_PROBATORIA" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "VIOLACION_PROBATORIA_F_E" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "HUELGA" );
	        setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "CONTEO_60_MESES_TANF" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_VENCIMIENTO_DESC" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_CIERRE_DESCA" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "MOTIVOS_ELEGIBILIDAD" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_FIRMO_PRI" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_ENTREGA_AUTOGESTION" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_REFERIDO_MANEJO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "ESTATUS_PART_TRABAJO" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_EFECT_DESCA" );
	        setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "MESES_EXENCION_TANF" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FLG_PTRA" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FLG_VET" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FLG_18ANOS" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FLG_60ANOS" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FLG_5MESES" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FECHA_DESDE_EXEN" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FECHA_HASTA_EXEN" );
	        setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "REMANENTE" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_JUNTA_MEDICA" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "DSC_ASISTE_REGULARIDAD" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_VENCIMIENTO_DESC_AE" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_CIERRE_DESCA_AE" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FCH_EFECT_DESCA_AE" );
	        setFieldDate   ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "FECHA_REGISTRO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "OCUPACION1" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "OCUPACION2" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "OCUPACION3" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "ACEPTA_REGISTRO_EMPLEO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RW_DSD, "ACTIVO_REGISTRO_EMPLEO" );
	        ...
	        setFieldDouble ( INGRESOS_CLIENTE_HIST_RW_DSD , CLIENTES_HIST_RW_DSD, "SEGURO_SOCIAL_CLIENTE" );
	        ...
	        setFieldDouble ( RECURSOS_CLIENTE_HIST_RW_DSD , CLIENTES_HIST_RW_DSD, "SEGURO_SOCIAL_CLIENTE" );
	        ...
	        setFieldDouble ( DEDUCCIONES_CLIENTE_HIST_RW_DSD , CLIENTES_HIST_RW_DSD, "SEGURO_SOCIAL_CLIENTE" );
	        ...
	        setFieldDouble ( BILLETES_HIST_RW_DSD , CLIENTES_HIST_RW_DSD, "SEGURO_SOCIAL_CLIENTE" );
	        ...
	        CLIENTES_HIST_RW_STATUS_CODE  = this.dm.nextRow ( CLIENTES_HIST_RW_DSD_ID );
	    ...
	    setFieldDouble ( NUCLEO_SERVICIO_HIST_RW_DSD , "SEGURO_SOCIAL_JEFE_FAM", this.app.SS_JEFE_GBL );
	    setFieldDouble ( NUCLEO_SERVICIO_HIST_RW_DSD , "SEGURO_SOCIAL_JEFE_SERV", this.app.SS_SERV_GBL  );
	    setFieldString ( NUCLEO_SERVICIO_HIST_RW_DSD , "COD_SERVICIO", this.app.COD_SERV_GBL );
	    ...
	    if ( ! Compare.equals ( CLIENTES_HIST_RW_STATUS_CODE, 0 ) ) 
	    {
	    	this.app.setError ( 3, CLIENTES_HIST_RW_STATUS_CODE );
	    }    
	    while ( Compare.equals ( CLIENTES_HIST_RW_STATUS_CODE, 0 )  )
	    {
	    	...
	    	while ( Compare.equals ( noMoreRows, false ) )
	    	{
	    		...
	    		setFieldString ( INGRESOS_CLIENTE_HIST_RW_DSD, "TIPO_TRANS", "T" );
	    		INGRESOS_CLIENTE_HIST_RW_STATUS_CODE  = getFirstRow ( INGRESOS_CLIENTE_HIST_RW_DSD_ID );
	    		if ( Compare.equals ( INGRESOS_CLIENTE_HIST_RW_STATUS_CODE, 0 ) )
	    		{
	    			INGRESOS_CLIENTE_HIST_RW_STATUS_CODE  = this.dm.delete ( INGRESOS_CLIENTE_HIST_RW_DSD_ID );
	    			INGRESOS_CLIENTE_HIST_RW_STATUS_CODE  = this.dm.update ( INGRESOS_CLIENTE_HIST_RW_DSD );
	    		}
	    		else
	    		{
	    			noMoreRows = true;
	    	...
	    	while ( Compare.equals ( noMoreRows, false ) )
	    	{
	    		...
	    		setFieldString ( RECURSOS_CLIENTE_HIST_RW_DSD, "TIPO_TRANS", "T" );
	    		RECURSOS_CLIENTE_HIST_RW_STATUS_CODE  = getFirstRow ( RECURSOS_CLIENTE_HIST_RW_DSD_ID );
	    		if ( Compare.equals ( RECURSOS_CLIENTE_HIST_RW_STATUS_CODE, 0 ) )
	    		{
	    			RECURSOS_CLIENTE_HIST_RW_STATUS_CODE  = this.dm.delete ( RECURSOS_CLIENTE_HIST_RW_DSD_ID );
	    			RECURSOS_CLIENTE_HIST_RW_STATUS_CODE  = this.dm.update ( RECURSOS_CLIENTE_HIST_RW_DSD );
	    		}
	    		else
	    		{
	    			noMoreRows = true;
	    	...
	    	while ( Compare.equals ( noMoreRows, false ) )
	    	{
	    		...
	    		setFieldString ( DEDUCCIONES_CLIENTE_HIST_RW_DSD , "TIPO_TRANS", "T" );
	    		DEDUCCIONES_CLIENTE_HIST_RW_STATUS_CODE  = getFirstRow ( DEDUCCIONES_CLIENTES_HIST_RW_DSD_ID );
	    		if ( Compare.equals ( DEDUCCIONES_CLIENTE_HIST_RW_STATUS_CODE, 0 ) )
	    		{
	    			DEDUCCIONES_CLIENTE_HIST_RW_STATUS_CODE  = this.dm.delete ( DEDUCCIONES_CLIENTES_HIST_RW_DSD_ID );
	    			DEDUCCIONES_CLIENTE_HIST_RW_STATUS_CODE  = this.dm.update ( DEDUCCIONES_CLIENTE_HIST_RW_DSD );
	    		}
	    		else
	    		{
	    			noMoreRows = true;
	    	...
	    	while ( Compare.equals ( noMoreRows, false ) )
	    	{
	    		...
	    		setFieldString ( BILLETES_HIST_RW_DSD, "TIPO_TRANS", "T" );
	    		BILLETES_HIST_RW_STATUS_CODE  = getFirstRow ( BILLETES_HIST_RW_DSD_ID );
	    		if ( Compare.equals ( BILLETES_HIST_RW_STATUS_CODE, 0 ) )
	    		{
	    			BILLETES_HIST_RW_STATUS_CODE  = this.dm.delete ( BILLETES_HIST_RW_DSD_ID );
	    			BILLETES_HIST_RW_STATUS_CODE  = this.dm.update ( BILLETES_HIST_RW_DSD );
	    		}
	    		else
	    		{
	    			noMoreRows = true;
	    ...
	    while ( Compare.equals ( noMoreRows, false ) )
	    {
	    	...
	    	setFieldDouble ( NUCLEO_SERVICIO_HIST_RW_DSD, "SEGURO_SOCIAL_JEFE_SERV", this.app.SS_SERV_GBL );
	    	setFieldString ( NUCLEO_SERVICIO_HIST_RW_DSD, "COD_SERVICIO", this.app.COD_SERV_GBL );
	    	setFieldDouble ( NUCLEO_SERVICIO_HIST_RW_DSD, "RMO_OFICINA", this.app.RMO_GBL );
	    	//setFieldDouble ( NUCLEO_SERVICIO_HIST_RW_DSD, "RMO_OFICINA2", this.app.RMO_GBL );
	    	setFieldString ( NUCLEO_SERVICIO_HIST_RW_DSD , "TIPO_TRANS", "T" );
	    	NUCLEO_SERVICIO_HIST_RW_STATUS_CODE  = getFirstRow ( NUCLEO_SERVICIO_HIST_RW_DSD_ID );
	    	if ( Compare.equals ( NUCLEO_SERVICIO_HIST_RW_STATUS_CODE, 0 ) )
	    	{
	    		NUCLEO_SERVICIO_HIST_RW_STATUS_CODE  = this.dm.delete ( NUCLEO_SERVICIO_HIST_RW_DSD_ID );
	    		NUCLEO_SERVICIO_HIST_RW_STATUS_CODE  = this.dm.update ( NUCLEO_SERVICIO_HIST_RW_DSD );
	    	}
	    	else
	    	{
	    		noMoreRows = true;
	    ...
	    while ( Compare.equals ( noMoreRows, false ) )
	    {
	    	...
	    	if ( Compare.equals ( CLIENTES_HIST_RW_STATUS_CODE, 0 ) )
	    	{
	    		...
	    		CLIENTES_HIST_RW_STATUS_CODE  = this.dm.update ( CLIENTES_HIST_RW_DSD );
	    	}
	    	else
	    	{
	    		noMoreRows = true;
	    ...
	    /* Hacer commit de los cambios hechos al db */   
