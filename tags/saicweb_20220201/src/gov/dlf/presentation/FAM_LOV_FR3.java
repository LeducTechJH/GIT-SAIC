     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "FAM_LOV_FR3" );

    Debug.println ( Debug.TRACE, "FAM_LOV_FR3 - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/FAM_LOV_FR3.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "FAM_LOV_GP", new FAM_LOV_FR3_FAM_LOV_GP_Arguments ( this ) );

    this.setObjectEvents ( );



    calculator = new FAM_LOV_FR3_DSC_NOMBRE_COMPUTECalculator ( this );
 ...
 *
 */
class FAM_LOV_FR3_FAM_LOV_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public FAM_LOV_FR3_FAM_LOV_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class FAM_LOV_FR3_DSC_NOMBRE_COMPUTECalculator implements ICalculator
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public FAM_LOV_FR3_DSC_NOMBRE_COMPUTECalculator ( Form form )
  {
    this.model = form;
  }
  ...
  {
    if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
    CONCATENATE_NAME_ADL3.exec ( this.app, null );
  }
}
