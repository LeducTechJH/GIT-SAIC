 ...
 */
public class TRANSFER_ENVIADAS_PRE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TRANSFER_ENVIADAS_PRE_PKT ( )
  {
    super ( "TRANSFER_ENVIADAS_PRE_PKT" );
   ...
   *
   */
  public TRANSFER_ENVIADAS_PRE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TRANSFER_ENVIADAS_PRE_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_ENVIADAS_PRE_PKT", pFrame );
  ...
  {
    this.createComponents ( new TRANSFER_ENVIADAS_SEL_FECHAS_FR ( ) );
   ...
   *
   */
  public static TRANSFER_ENVIADAS_PRE_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_ENVIADAS_PRE_PKT ) __app.getNewInstance ( "TRANSFER_ENVIADAS_PRE_PKT" );
  }
  ...
  {
    TRANSFER_ENVIADAS_PRE_PKT fSheet = TRANSFER_ENVIADAS_PRE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_ENVIADAS_PRE_PKT.exec ( __app );
  }
