     ...
     extends FormSheet
{
   ...
   *
   */
  public REPORT_3_2_PKT ( )
  {
    super ( "REPORT_3_2_PKT" );
   ...
   *
   */
  public REPORT_3_2_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REPORT_3_2_PKT ( MDIFrame pFrame )
  {
    super ( "REPORT_3_2_PKT", pFrame );
  ...
  {
    this.createComponents ( new REPORT_3_2_FR ( ) );
   ...
   *
   */
  public static REPORT_3_2_PKT get ( RallyApplication __app )
  {
    return ( REPORT_3_2_PKT ) __app.getNewInstance ( "REPORT_3_2_PKT" );
  }
  ...
  {
    REPORT_3_2_PKT fSheet = REPORT_3_2_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REPORT_3_2_PKT.exec ( __app );
  }
