     ...
     extends FormSheet
{
   ...
   *
   */
  public INFOR_BIO_RO_PKT ( )
  {
    super ( "INFOR_BIO_RO_PKT" );
   ...
   *
   */
  public INFOR_BIO_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INFOR_BIO_RO_PKT ( MDIFrame pFrame )
  {
    super ( "INFOR_BIO_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new INFOR_BIO_FRM ( ) );
   ...
   *
   */
  public static INFOR_BIO_RO_PKT get ( RallyApplication __app )
  {
    return ( INFOR_BIO_RO_PKT ) __app.getNewInstance ( "INFOR_BIO_RO_PKT" );
  }
  ...
  {
    INFOR_BIO_RO_PKT fSheet = INFOR_BIO_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INFOR_BIO_RO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; ADSEF_PPT1_RO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; INFO_PAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
