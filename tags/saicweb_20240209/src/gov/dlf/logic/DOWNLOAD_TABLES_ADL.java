  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( Compare.equals ( CLIENTES_HIST_RO_STATUS_CODE, 0 )  )
    {
	    while ( Compare.equals ( CLIENTES_HIST_RO_STATUS_CODE, 0 )  )
	    {
	        ...
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "VERIFICACION_SEGUROSOCIAL" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "VERIFICACION_IDENTIDAD" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "VERIFICACION_CIUDADANIA" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "VERIFICACION_RESIDENCIA" );
	        
	        
	        /*NEW CODE MISSING ITEMS 10/17/2023 */
	        
	      
	        /* setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "USUARIO" );*/
	        setFieldDate ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "HORA_ACTUAL" );
	        setFieldDate ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "FCH_TRANSFERIDO" );
	        setFieldDate ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "FECHA_ACTUALIZO_REMANENTE" );
	        setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "RMO_ANTERIOR" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "SAICV1_CONV" );
	        setFieldDate ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "LAST_UPDATE" );
	        setFieldDate ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "FECHA_CAMBIO_AL_MANEJADOR" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "TELEFONO_OTRO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "REFERENCIA_TELEFONO_OTRO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "COD_RZ_NSS_SUST" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "EMAIL" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "TELEFONO_CELULAR" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "NUM_VER_SS" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "NUM_VER_RES" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "NUM_VER_ID" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "NUM_VER_CIU" );
	        setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "REMANENTE_TANF" );
	        setFieldDouble ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "CODIGO_ESCUELA" );
	        setFieldDate ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "FECHA_EMIGRACION" );
	        setFieldDate ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "FECHA_DECESO" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "PERSONAID" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "EXPEDIENTEID" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "COD_ETNICIDAD" );
	        setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "FLG_SERV_SELECTIVO" );
	        /*setFieldString ( CLIENTES2_DSD, CLIENTES_HIST_RO_DSD, "FUERZA_LABORAL" );*/
