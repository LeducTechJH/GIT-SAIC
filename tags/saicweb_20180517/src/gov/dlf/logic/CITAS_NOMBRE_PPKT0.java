 ...
 */
public class CITAS_NOMBRE_PPKT0 
  implements IRegisteredObject 
{
   ...
   *
   */
  public static CITAS_NOMBRE_PPKT0 get ( RallyApplication __app )
  {
    CITAS_NOMBRE_PPKT0 pp = ( CITAS_NOMBRE_PPKT0 ) __app.getNewInstance ( "CITAS_NOMBRE_PPKT0" );
    return pp;
  }
  ...
  {
    return CITAS_NOMBRE_PPKT0.exec ( __app );
  }
  ...
  {
    Debug.println ( Debug.TRACE, "CITAS_NOMBRE_PPKT0" );
    this.prepareParms ( );
  ...
  {
    this.app.form ( "INFOR_CITAS_FR" ).setValue ( "JEFE_SERV", this.parms.getDouble ( 0 ) );
    this.app.form ( "INFOR_CITAS_FR" ).setValue ( "NOMBNRE", this.parms.getString ( 1 ) );
  }
  ...
  {
    this.parms.reset ( );
    this.parms.set ( this.app.form ( "INFOR_CITAS_FR" ).getValue ( "JEFE_SERV" ) );
    this.parms.set ( this.app.form ( "INFOR_CITAS_FR" ).getValue ( "NOMBNRE" ) );
  }
