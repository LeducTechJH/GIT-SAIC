 ...
 */
public class INFOR_OCUPACION_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public INFOR_OCUPACION_LOV_FR ( )
  {
    super ( );
    this.setName ( "INFOR_OCUPACION_LOV_FR" );

    Debug.println ( Debug.TRACE, "INFOR_OCUPACION_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/INFOR_OCUPACION_LOV_FR.jdp" );
