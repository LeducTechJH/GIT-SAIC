     ...
     extends Form
{
   ...
   *
   */
  public GEN_MODU_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_MODU_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_MODU_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_MODU_LOV_FR.jdp" );
