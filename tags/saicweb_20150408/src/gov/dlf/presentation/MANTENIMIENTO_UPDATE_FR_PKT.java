 ...
 */
public class MANTENIMIENTO_UPDATE_FR_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_UPDATE_FR_PKT ( )
  {
    super ( "MANTENIMIENTO_UPDATE_FR_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_UPDATE_FR_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_UPDATE_FR_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_UPDATE_FR_PKT", pFrame );
   ...
   *
   */
  public static MANTENIMIENTO_UPDATE_FR_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_UPDATE_FR_PKT ) __app.getNewInstance ( "MANTENIMIENTO_UPDATE_FR_PKT" );
  }
  ...
  {
    MANTENIMIENTO_UPDATE_FR_PKT fSheet = MANTENIMIENTO_UPDATE_FR_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_UPDATE_FR_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SECURITY_ING_COD_ACCES_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
