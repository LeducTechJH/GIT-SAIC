 ...
 */
public class PTRA_EMPLEO_INS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PTRA_EMPLEO_INS_PKT ( )
  {
    super ( "PTRA_EMPLEO_INS_PKT" );
   ...
   *
   */
  public PTRA_EMPLEO_INS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PTRA_EMPLEO_INS_PKT ( MDIFrame pFrame )
  {
    super ( "PTRA_EMPLEO_INS_PKT", pFrame );
  ...
  {
    this.createComponents ( new PTRA_EMPLEO_FR ( ) );
   ...
   *
   */
  public static PTRA_EMPLEO_INS_PKT get ( RallyApplication __app )
  {
    return ( PTRA_EMPLEO_INS_PKT ) __app.getNewInstance ( "PTRA_EMPLEO_INS_PKT" );
  }
  ...
  {
    PTRA_EMPLEO_INS_PKT fSheet = PTRA_EMPLEO_INS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PTRA_EMPLEO_INS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  PTRA_FCH_EXENCION_PPKT.exec ( app, null );
 return app.errorFlag;
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true;  PTRA_FCH_EXENCION_BEF_PPKT.exec ( app, null );
 return app.errorFlag;
      }
    } );
  }
