     ...
     extends Form
{
   ...
   *
   */
  public DSS171_MENU_FR ( )
  {
    super ( );
    this.setName ( "DSS171_MENU_FR" );

    Debug.println ( Debug.TRACE, "DSS171_MENU_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DSS171_MENU_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "DSS171_FCHI", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; DSS171_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
