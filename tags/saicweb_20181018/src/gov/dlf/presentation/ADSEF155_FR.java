     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "ADSEF155_FR" );

    Debug.println ( Debug.TRACE, "ADSEF155_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ADSEF155_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "D1", new ADSEF155_FR_Arguments ( this ) );
    this.setArguments ( "D2", new ADSEF155_FR_Arguments ( this ) );
    this.setArguments ( "D3", new ADSEF155_FR_Arguments ( this ) );

    this.setObjectEvents ( );



    calculator = new ADSEF155_FR_NOMBRE_COMPLETOCalculator ( this );
 ...
 *
 */
class ADSEF155_FR_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public ADSEF155_FR_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class ADSEF155_FR_NOMBRE_COMPLETOCalculator implements ICalculator
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ADSEF155_FR_NOMBRE_COMPLETOCalculator ( Form form )
  {
    this.model = form;
  }
  ...
  {
    if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
    ADSEF155_GET_NOMBRE_ADL.exec ( this.app, null );
  }
}
