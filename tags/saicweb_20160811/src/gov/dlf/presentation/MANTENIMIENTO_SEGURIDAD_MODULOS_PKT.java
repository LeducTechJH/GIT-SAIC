 ...
 */
public class MANTENIMIENTO_SEGURIDAD_MODULOS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_SEGURIDAD_MODULOS_PKT ( )
  {
    super ( "MANTENIMIENTO_SEGURIDAD_MODULOS_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_SEGURIDAD_MODULOS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_SEGURIDAD_MODULOS_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_SEGURIDAD_MODULOS_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_SEGURIDAD_MODULOS_FRM ( ) );
   ...
   *
   */
  public static MANTENIMIENTO_SEGURIDAD_MODULOS_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_SEGURIDAD_MODULOS_PKT ) __app.getNewInstance ( "MANTENIMIENTO_SEGURIDAD_MODULOS_PKT" );
  }
  ...
  {
    MANTENIMIENTO_SEGURIDAD_MODULOS_PKT fSheet = MANTENIMIENTO_SEGURIDAD_MODULOS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_SEGURIDAD_MODULOS_PKT.exec ( __app );
  }
