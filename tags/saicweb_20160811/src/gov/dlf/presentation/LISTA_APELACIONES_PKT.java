 ...
 */
public class LISTA_APELACIONES_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public LISTA_APELACIONES_PKT ( )
  {
    super ( "LISTA_APELACIONES_PKT" );
   ...
   *
   */
  public LISTA_APELACIONES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public LISTA_APELACIONES_PKT ( MDIFrame pFrame )
  {
    super ( "LISTA_APELACIONES_PKT", pFrame );
  ...
  {
    this.createComponents ( new LISTA_APELACIONES_FR ( ) );
   ...
   *
   */
  public static LISTA_APELACIONES_PKT get ( RallyApplication __app )
  {
    return ( LISTA_APELACIONES_PKT ) __app.getNewInstance ( "LISTA_APELACIONES_PKT" );
  }
  ...
  {
    LISTA_APELACIONES_PKT fSheet = LISTA_APELACIONES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return LISTA_APELACIONES_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; LLENAR_LISTA_APELA_ADL.exec ( app ); if ( Compare.gt ( app.form ( "LISTA_APELACIONES_FR" ).getDoubleItem ( "NUM_APP_AGGREGATE" ), 0 ) ) app.form ( "LISTA_APELACIONES_FR" ).getField ( "CLIENTES_SEGURO_SOCIAL_CLIENTE" ).setLegendCode ( "" ); return app.errorFlag;
      }
    } );
  }
}
