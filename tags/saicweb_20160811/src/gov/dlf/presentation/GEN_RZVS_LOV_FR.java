     ...
     extends Form
{
   ...
   *
   */
  public GEN_RZVS_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_RZVS_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_RZVS_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_RZVS_LOV_FR.jdp" );
