 ...
 */
public class MANTENIMIENTO_GENERAL_UPDATE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_GENERAL_UPDATE_PKT ( )
  {
    super ( "MANTENIMIENTO_GENERAL_UPDATE_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_GENERAL_UPDATE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_GENERAL_UPDATE_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_GENERAL_UPDATE_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_GENERAL_FR ( ) );
   ...
   *
   */
  public static MANTENIMIENTO_GENERAL_UPDATE_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_GENERAL_UPDATE_PKT ) __app.getNewInstance ( "MANTENIMIENTO_GENERAL_UPDATE_PKT" );
  }
  ...
  {
    MANTENIMIENTO_GENERAL_UPDATE_PKT fSheet = MANTENIMIENTO_GENERAL_UPDATE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_GENERAL_UPDATE_PKT.exec ( __app );
  }
