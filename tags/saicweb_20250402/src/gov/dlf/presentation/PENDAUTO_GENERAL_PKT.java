 ...
 */
public class PENDAUTO_GENERAL_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PENDAUTO_GENERAL_PKT ( )
  {
    super ( "PENDAUTO_LIEHEAP_PKT" );
   ...
   *
   */
  public PENDAUTO_GENERAL_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PENDAUTO_GENERAL_PKT ( MDIFrame pFrame )
  {
    super ( "PENDAUTO_LIEHEAP_PKT", pFrame );
  ...
  {
    this.createComponents ( new PENDAUTO_GENERAL_FR ( ) );
   ...
   *
   */
  public static PENDAUTO_GENERAL_PKT get ( RallyApplication __app )
  {
    return ( PENDAUTO_GENERAL_PKT ) __app.getNewInstance ( "PENDAUTO_GENERAL_PKT" );
  }
  ...
  {
	  PENDAUTO_GENERAL_PKT fSheet = PENDAUTO_GENERAL_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PENDAUTO_GENERAL_PKT.exec ( __app );
  }
