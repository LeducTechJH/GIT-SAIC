 ...
 */
public class TRANSFER_RECIBIDAS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
  ...
  {
    TRANSFER_RECIBIDAS_PKT fSheet = TRANSFER_RECIBIDAS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_RECIBIDAS_PKT.exec ( __app );
  }
   ...
   *
   */
  public static TRANSFER_RECIBIDAS_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_RECIBIDAS_PKT ) __app.getNewInstance ( "TRANSFER_RECIBIDAS_PKT" );
  }
   ...
   *
   */
  public TRANSFER_RECIBIDAS_PKT ( )
  {
    super ( "TRANSFER_RECIBIDAS_PKT" );
   ...
   *
   */
  public TRANSFER_RECIBIDAS_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_RECIBIDAS_PKT", pFrame );
   ...
   *
   */
  public TRANSFER_RECIBIDAS_PKT ( String packetTitle )
  {
    super ( packetTitle );
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_TRANSFER_RECIBIDAS_MENU.exec ( app, null );
