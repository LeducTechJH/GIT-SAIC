     ...
     extends Form
{
   ...
   *
   */
  public AEE_SERV_LOV_FR ( )
  {
    super ( );
    this.setName ( "AEE_SERV_LOV_FR" );

    Debug.println ( Debug.TRACE, "AEE_SERV_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/AEE_SERV_LOV_FR.jdp" );
