     ...
     extends Form
{
   ...
   *
   */
  public DSS108_MENU_FR ( )
  {
    super ( );
    this.setName ( "DSS108_MENU_FR" );

    Debug.println ( Debug.TRACE, "DSS108_MENU_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DSS108_MENU_FR.jdp" );
  ...
  {
    this.registerListener ( "DSS108_CS", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; DSS108_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "DSS108_LF", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; RETURN_MNU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
