 ...
 */
public class REDETERMINACION_RECLA_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REDETERMINACION_RECLA_RO_PKT ( )
  {
    super ( "REDETERMINACION_RECLA_RO_PKT" );
   ...
   *
   */
  public REDETERMINACION_RECLA_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REDETERMINACION_RECLA_RO_PKT ( MDIFrame pFrame )
  {
    super ( "REDETERMINACION_RECLA_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new REDETERMINACION_RECLA_FR ( ) );
   ...
   *
   */
  public static REDETERMINACION_RECLA_RO_PKT get ( RallyApplication __app )
  {
    return ( REDETERMINACION_RECLA_RO_PKT ) __app.getNewInstance ( "REDETERMINACION_RECLA_RO_PKT" );
  }
  ...
  {
    REDETERMINACION_RECLA_RO_PKT fSheet = REDETERMINACION_RECLA_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REDETERMINACION_RECLA_RO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SET_REDETERMINACION_RECLA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
