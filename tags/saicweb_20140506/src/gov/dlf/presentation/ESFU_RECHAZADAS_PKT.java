 ...
 */
public class ESFU_RECHAZADAS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ESFU_RECHAZADAS_PKT ( )
  {
    super ( "ESFU_RECHAZADAS_PKT" );
   ...
   *
   */
  public ESFU_RECHAZADAS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ESFU_RECHAZADAS_PKT ( MDIFrame pFrame )
  {
    super ( "ESFU_RECHAZADAS_PKT", pFrame );
  ...
  {
    this.createComponents ( new ESFU_RECHAZADAS_RP ( ) );
   ...
   *
   */
  public static ESFU_RECHAZADAS_PKT get ( RallyApplication __app )
  {
    return ( ESFU_RECHAZADAS_PKT ) __app.getNewInstance ( "ESFU_RECHAZADAS_PKT" );
  }
  ...
  {
    ESFU_RECHAZADAS_PKT fSheet = ESFU_RECHAZADAS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ESFU_RECHAZADAS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_ESFU_RECHAZOS_MENU.exec ( app, null );
 return app.errorFlag;
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; ESFU_RECHAZADA_BEF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
