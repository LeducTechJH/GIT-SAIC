 ...
 */
public class INFORME_ESTADISTICO_APEL_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INFORME_ESTADISTICO_APEL_PKT ( )
  {
    super ( "INFORME_ESTADISTICO_APEL_PKT" );
   ...
   *
   */
  public INFORME_ESTADISTICO_APEL_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INFORME_ESTADISTICO_APEL_PKT ( MDIFrame pFrame )
  {
    super ( "INFORME_ESTADISTICO_APEL_PKT", pFrame );
   ...
   *
   */
  public static INFORME_ESTADISTICO_APEL_PKT get ( RallyApplication __app )
  {
    return ( INFORME_ESTADISTICO_APEL_PKT ) __app.getNewInstance ( "INFORME_ESTADISTICO_APEL_PKT" );
  }
  ...
  {
    INFORME_ESTADISTICO_APEL_PKT fSheet = INFORME_ESTADISTICO_APEL_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INFORME_ESTADISTICO_APEL_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_APEL_MENU.exec ( app, null );
