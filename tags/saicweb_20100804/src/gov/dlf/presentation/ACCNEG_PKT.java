     ...
     extends FormSheet
{
   ...
   *
   */
  public ACCNEG_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ACCNEG_PKT ( MDIFrame pFrame )
  {
    super ( "ACCNEG_PKT", pFrame );
   ...
   *
   */
  public static ACCNEG_PKT get ( RallyApplication __app )
  {
    return ( ACCNEG_PKT ) __app.getNewInstance ( "ACCNEG_PKT" );
  }
  ...
  {
    ACCNEG_PKT fSheet = ACCNEG_PKT.get ( __app );
    fSheet.execute ( null );
