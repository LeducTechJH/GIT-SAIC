     ...
     extends Form
{
   ...
   *
   */
  public GEN_TENE_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_TENE_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_TENE_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_TENE_LOV_FR.jdp" );
