     ...
     extends Form
{
   ...
   *
   */
  public DSS170_RPT_FR ( )
  {
    super ( );
    this.setName ( "DSS170_RPT_FR" );

    Debug.println ( Debug.TRACE, "DSS170_RPT_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DSS170_RPT_FR.jdp" );
