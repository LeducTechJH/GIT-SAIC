...
import gov.dlf.webservice.client.sibif.prequalification.*;
...
public class SIBIF_PREQUAL_INFO_GET_ADL extends ADL {
	...
	// -------------------------------------------------------------------
	  ...
	  protected void step0 ( ParameterSet ps )
	  {
		    ...
		    this.dm.setField ( this.dm.get ( "CLIENTES2_DSD" ), "SEGURO_SOCIAL_CLIENTE", this.app.form("CHECK_SOLIC_EXT_FR").getDoubleValue( "SS" ) );
	  ...
	  protected void step1 ( ParameterSet ps )
	  {
		  ...
		  //Double  ss = this.app.form("CHECK_SOLIC_EXT_FR").getDoubleValue( "SS" );
		  //double rmo = this.app.getRMO_GBL();
		  
		  String ss = StringService.toStringValue ( (int) this.app.form("CHECK_SOLIC_EXT_FR").getDoubleValue( "SS" ) );
		  ...
		  this.preQualObj = soap.getPrequalificationInfo (ctrl, Long.parseLong(ss) );
	  ...
	  protected void step2 ( ParameterSet ps )
	  {
		  ...
		  /*BEGIN Inicializar los DSD a utilizarse*/
		    ...
		    if ( Compare.equals ( CLIENTES2_STATUS_CODE, 0 )  )
		    {
		    	...
		    	this.dm.setField(CLIENTES2_DSD, "RMO_OFICINA", this.app.getRMO_GBL() );
		    	...
		    	this.dm.setField(CLIENTES2_DSD, "DSC_APELLIDO_PATERNO", this.preQualObj.getCustomer().getPaternalLastName().toUpperCase());

		    	if ( ! Compare.equals( this.preQualObj.getCustomer().getMaternalLastName(), "NA" ) ){
		    		this.dm.setField(CLIENTES2_DSD, "DSC_APELLIDO_MATERNO", this.preQualObj.getCustomer().getMaternalLastName().toUpperCase());
		    	}


		    	this.dm.setField(CLIENTES2_DSD, "DSC_NOMBRE", this.preQualObj.getCustomer().getName().toUpperCase());
		    	...
		    	if ( ! Compare.equals( this.preQualObj.getCustomer().getInitial(), "NA" ) ){
		    		...
		    		this.dm.setField(CLIENTES2_DSD, "DSC_INICIAL", this.preQualObj.getCustomer().getInitial().toUpperCase());
		    	}

		    	if ( ! Compare.equals( this.preQualObj.getCustomer().getNickname(), "NA" ) ){
		    		this.dm.setField(CLIENTES2_DSD, "DSC_APODO", this.preQualObj.getCustomer().getNickname().toUpperCase());
		    	}
		    	...
		    	//Validacion para si es RESI en SIBIF insertar REPE en SAIC
		    	if ( Compare.equals(this.preQualObj.getCustomer().getCitizenship(), "RESI") )
		    	{
		    		this.dm.setField(CLIENTES2_DSD, "COD_CIUDADANIA", "REPE");
		    	}
		    	else
		    	{
		    	...
		    	//this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", this.preQualObj.getCustomer().getScholarity()); //hacer correlacion de codigos de escolaridad
		    	
		    	if ( Compare.equals( this.preQualObj.getCustomer().getScholarity(), "ELEM" ) && this.preQualObj.getCustomer().isFulltimeStudent() )
		    	{
		    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "ES06");
		    	}
		    	else if ( Compare.equals( this.preQualObj.getCustomer().getScholarity(), "ELEM" ) && ! this.preQualObj.getCustomer().isFulltimeStudent() )
		    	{
		    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "NE09");
		    	}
		    	else if ( Compare.equals( this.preQualObj.getCustomer().getScholarity(), "INTE" ) && this.preQualObj.getCustomer().isFulltimeStudent() )
		    	{
		    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "ES09");
		    	}
		    	else if ( Compare.equals( this.preQualObj.getCustomer().getScholarity(), "INTE" ) && ! this.preQualObj.getCustomer().isFulltimeStudent() )
		    	{
		    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "NE09");
		    	}
		    	else if ( Compare.equals( this.preQualObj.getCustomer().getScholarity(), "NING" ) )
		    	{
		    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "NING");
		    	}
		    	else if ( Compare.equals( this.preQualObj.getCustomer().getScholarity(), "POSG" ) )
		    	{
		    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "MAES");
		    	}
		    	else if ( Compare.equals( this.preQualObj.getCustomer().getScholarity(), "POSS" ) )
		    	{
		    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "BACH");
		    	}
		    	else if ( Compare.equals( this.preQualObj.getCustomer().getScholarity(), "SUPE" ) )
		    	{
		    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "ES12");
		    	}
		    	else if ( Compare.equals( this.preQualObj.getCustomer().getScholarity(), "SUPE" ) && ! this.preQualObj.getCustomer().isFulltimeStudent() )
		    	{
		    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "NE09");
		    	}
		    	else
		    	{
		    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "NA");
		    	}
		    ...
		    if ( this.preQualObj.getCustomer().getMinorDetails().isTakingCareExpenses() )
		    {
	    		...
	    		this.dm.setField(DEDUCCIONES_CLIENTE2_DSD, "RMO_OFICINA", this.app.getRMO_GBL() );
		    ...
		    if ( Compare.equals ( DIRECCIONES_STATUS_CODE, 0 )  )
		    {
		    	...
		    	//Se supone que la dirección residencial siempre viene con datos.

		    	this.dm.setField(DIRECCIONES_DSD, "RMO_OFICINA", this.app.getRMO_GBL() );
		    	...
		    	this.dm.setField(DIRECCIONES_DSD, "DSC_DIRECCION_1", this.preQualObj.getCustomer().getResidentialAddress().getLine1().toUpperCase());
		    	this.dm.setField(DIRECCIONES_DSD, "DSC_DIRECCION_2", this.preQualObj.getCustomer().getResidentialAddress().getLine2().toUpperCase());
		    ...
		    if ( Compare.equals ( INGRESOS_CLIENTE_2_STATUS_CODE, 0 )  )
		    {
		    	...
		    	for (; incomeIter.hasNext();)
		    	{
		    		...
		    		if ( ! Compare.equals( income.getType(), "NA" ) )
		    		{
		    			...
		    			if ( Compare.equals(income.getType(), "DESE") )
		    			{
		    				this.dm.setField(INGRESOS_CLIENTE_2_DSD, "COD_TIPO_INGRESO", "CODE");
		    			}
		    			else if ( Compare.equals(income.getType(), "JORN") )
		    			{
		    				this.dm.setField(INGRESOS_CLIENTE_2_DSD, "COD_TIPO_INGRESO", "SALA");
		    			}
		    			else if ( Compare.equals(income.getType(), "ADIE") )
		    			{
		    				this.dm.setField(INGRESOS_CLIENTE_2_DSD, "COD_TIPO_INGRESO", "SALA");
		    			}
		    			else if ( Compare.equals(income.getType(), "OTPE") )
		    			{
		    				this.dm.setField(INGRESOS_CLIENTE_2_DSD, "COD_TIPO_INGRESO", "CFSE");
		    			}
		    			else if ( Compare.equals(income.getType(), "SAEM") )
		    			{
		    				this.dm.setField(INGRESOS_CLIENTE_2_DSD, "COD_TIPO_INGRESO", "SALA");
		    			}
		    			else
		    			...
		    			this.dm.setField(INGRESOS_CLIENTE_2_DSD, "RMO_OFICINA", this.app.getRMO_GBL() );
		    ...
		    if ( Compare.equals ( RECURSOS_CLIENTE_STATUS_CODE, 0 )  )
		    {
		    	...
		    	for (; resIter.hasNext();)
		    	{
		    		...
		    		if ( ! Compare.equals( res.getType(), "NA" ) )
		    		{
		    			...
		    			this.dm.setField(RECURSOS_CLIENTE_2_DSD, "RMO_OFICINA", this.app.getRMO_GBL() );
		  ...
		  //Verificar e insertar si el cliente solicitante tiene incapacidad.
		    ...
		    //Los codigos de incapacidad de SIBIF se deben interpretar como codigo PINC en cliente.
		    ...
		    if ( ! Compare.equals(this.preQualObj.getCustomer().getDisability().getCode(), "NA"))
		    {
		    	if ( Compare.equals ( CLIENTE_AGENCIA2_STATUS_CODE, 0 )  )
			    {
		    		...
		    		{
		    			if (Compare.equals(this.preQualObj.getCustomer().getDisability().getCertifyingAgencyCode(), "OTRO"))
		    			{
		    				this.dm.setField(CLIENTE_AGENCIA2_DSD, "COD_AGENCIA", "OTRA");
		    			}
		    			else
		    			{
				    	...
				    	this.dm.setField(CLIENTE_AGENCIA2_DSD, "RMO_OFICINA", this.app.getRMO_GBL() );
			        ...
			        {
			    		CLIENTES2_STATUS_CODE  = this.dm.firstRow ( CLIENTES2_DSD_ID );
			    		this.dm.setField(CLIENTES2_DSD, "COD_INCAPACIDAD_PRIMARIA", "OTRA");
		    ...
		    if ( Compare.equals ( CLIENTES2_STATUS_CODE, 0 )  )
		    {
		    	for (; depIter.hasNext();)
		    	{
			    	...
			    	this.dm.setField(CLIENTES2_DSD, "DSC_APELLIDO_PATERNO", per.getPaternalLastName().toUpperCase());

			    	if ( ! Compare.equals( per.getMaternalLastName(), "NA" ) ){
			    		this.dm.setField(CLIENTES2_DSD, "DSC_APELLIDO_MATERNO", per.getMaternalLastName().toUpperCase());
			    	}


			    	this.dm.setField(CLIENTES2_DSD, "DSC_NOMBRE", per.getName().toUpperCase());
			    	...
			    	if ( ! Compare.equals( per.getInitial(), "NA" ) ){
			    		...
			    		this.dm.setField(CLIENTES2_DSD, "DSC_INICIAL", per.getInitial().toUpperCase());
			    	}

			    	if ( ! Compare.equals( per.getNickname(), "NA" )){
			    		this.dm.setField(CLIENTES2_DSD, "DSC_APODO", per.getNickname().toUpperCase());
			    	}
			    	...
			    	//Validacion para si es RESI en SIBIF insertar REPE en SAIC
			    	if ( Compare.equals(per.getCitizenship(), "RESI") )
			    	{
			    		this.dm.setField(CLIENTES2_DSD, "COD_CIUDADANIA", "REPE");
			    	}
			    	else
			    	...
			    	//this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", per.getScholarity()); //hacer correlacion de codigos de escolaridad
			    	
			    	if ( Compare.equals( per.getScholarity(), "ELEM" ) && per.isFulltimeStudent() )
			    	{
			    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "ES06");
			    	}
			    	else if ( Compare.equals( per.getScholarity(), "ELEM" ) && ! per.isFulltimeStudent() )
			    	{
			    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "NE06");
			    	}
			    	else if ( Compare.equals( per.getScholarity(), "INTE" ) && per.isFulltimeStudent() )
			    	{
			    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "ES09");
			    	}
			    	else if ( Compare.equals( per.getScholarity(), "INTE" ) && ! per.isFulltimeStudent() )
			    	...
			    	else if ( Compare.equals( per.getScholarity(), "NING" ) )
			    	{
			    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "NING");
			    	}
			    	else if ( Compare.equals( per.getScholarity(), "POSG" ) )
			    	{
			    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "MAES");
			    	}
			    	else if ( Compare.equals( per.getScholarity(), "POSS" ) )
			    	{
			    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "BACH");
			    	}
			    	else if ( Compare.equals( per.getScholarity(), "SUPE" ) && per.isFulltimeStudent() )
			    	{
			    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "ES12");
			    	}
			    	else if ( Compare.equals( per.getScholarity(), "SUPE" ) && ! per.isFulltimeStudent() )
			    	{
			    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "NE12");
			    	}
			    	else
			    	{
			    		this.dm.setField(CLIENTES2_DSD, "COD_ESCOLARIDAD", "NA");
					    ...
					    if ( Compare.equals ( INGRESOS_CLIENTE_2_STATUS_CODE, 0 )  )
					    {
					    	...
					    	for (; perIncomeIter.hasNext();)
					    	{
					    		...
					    		if ( ! Compare.equals( perIncome.getType(), "NA" ) )
					    		{
					    			...
					    			if ( Compare.equals(perIncome.getType(), "DESE") )
					    			{
					    				this.dm.setField(INGRESOS_CLIENTE_2_DSD, "COD_TIPO_INGRESO", "CODE");
					    			}
					    			else if ( Compare.equals(perIncome.getType(), "JORN") )
					    			{
					    				this.dm.setField(INGRESOS_CLIENTE_2_DSD, "COD_TIPO_INGRESO", "SALA");
					    			}
					    			else if ( Compare.equals(perIncome.getType(), "ADIE") )
					    			{
					    				this.dm.setField(INGRESOS_CLIENTE_2_DSD, "COD_TIPO_INGRESO", "SALA");
					    			}
					    			else if ( Compare.equals(perIncome.getType(), "OTPE") )
					    			{
					    				this.dm.setField(INGRESOS_CLIENTE_2_DSD, "COD_TIPO_INGRESO", "CFSE");
					    			}
					    			else if ( Compare.equals(perIncome.getType(), "SAEM") )
					    			{
					    				this.dm.setField(INGRESOS_CLIENTE_2_DSD, "COD_TIPO_INGRESO", "SALA");
					    			}
					    			else
					    ...
					    if ( ! Compare.equals( per.getDisability().getCode(), "NA") )
					    {
					    	if ( Compare.equals ( CLIENTE_AGENCIA2_STATUS_CODE, 0 )  )
						    {
					    		if ( ! Compare.equals(per.getDisability().getCertifyingAgencyCode(), "NA") )
					    		{
					    			...
					    			if (Compare.equals( per.getDisability().getCertifyingAgencyCode(), "OTRO"))
					    			{
					    				this.dm.setField(CLIENTE_AGENCIA2_DSD, "COD_AGENCIA", "OTRA");
					    			}
					    			else
