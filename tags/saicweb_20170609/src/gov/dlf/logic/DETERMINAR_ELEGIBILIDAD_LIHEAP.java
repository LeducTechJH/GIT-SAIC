	...
	protected void step1(ParameterSet ps) 
	{
		...
		if(Compare.ge(LIHEAP_INCOME_MAX, INGRESOS_NUCLEO))
		{
			...
			if (Compare.equals (RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "LICE" ))
			{
				...
				//							}
				if(Compare.equals(this.app.COD_SERV_GBL,"LICE1"))
				{
				...
				if(Compare.equals(this.app.COD_SERV_GBL,"LICE3"))
				{
					if(Compare.ge(CANTIDAD_AUTO, 500))
					{
						CANTIDAD_AUTO = 500;
					}
				}
				...
				{
					if(Compare.ge(CANTIDAD_AUTO, 75))
					{
						CANTIDAD_AUTO = 75;
					}
				}
