...
function afterInit ( )
{
  var form = document.getElementById ( "CALENDARIO_TEC_SIBIF_FR" );
  createButton ( form, 0, "Calendario SIBIF", 223, 96, showCalendar );
}
...
function showCalendar ( )
{
  ...
  var url = "http://10.200.255.159/sisca/SaiCRedircet.aspx?param1=" + token + "&param2=" + tecnico;
