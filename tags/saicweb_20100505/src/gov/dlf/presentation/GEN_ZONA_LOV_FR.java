     ...
     extends Form
{
   ...
   *
   */
  public GEN_ZONA_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_ZONA_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_ZONA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_ZONA_LOV_FR.jdp" );
