 ...
 */
public class TRANSFER_COPY__SUB_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TRANSFER_COPY__SUB_PKT ( )
  {
    super ( "TRANSFER_COPY__SUB_PKT" );
   ...
   *
   */
  public TRANSFER_COPY__SUB_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TRANSFER_COPY__SUB_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_COPY__SUB_PKT", pFrame );
  ...
  {
    this.createComponents ( new TRANSFER_COPY_SUB_FR ( ) );
   ...
   *
   */
  public static TRANSFER_COPY__SUB_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_COPY__SUB_PKT ) __app.getNewInstance ( "TRANSFER_COPY__SUB_PKT" );
  }
  ...
  {
    TRANSFER_COPY__SUB_PKT fSheet = TRANSFER_COPY__SUB_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_COPY__SUB_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        //app.errorFlag = true; TRANSFER_COPY_ANS_PKT.exec ( app ); return app.errorFlag;
        app.errorFlag = true; TRANSFER_COPY_ANS_MENU.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
