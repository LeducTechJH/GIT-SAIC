 ...
 *
 */
@WebServiceClient(name = "ADSEF", targetNamespace = "http://208.234.46.171/WebServiceADSEF/", wsdlLocation = "http://208.234.46.171/WebServiceADSEF/ADSEF.asmx?WSDL")
public class ADSEF
    extends Service
{
    ...
    private final static QName ADSEF_QNAME = new QName("http://208.234.46.171/WebServiceADSEF/", "ADSEF");
    ...
    public ADSEFSoap getADSEFSoap() {
        return super.getPort(new QName("http://208.234.46.171/WebServiceADSEF/", "ADSEFSoap"), ADSEFSoap.class);
    }
    ...
    public ADSEFSoap getADSEFSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://208.234.46.171/WebServiceADSEF/", "ADSEFSoap"), ADSEFSoap.class, features);
    }
