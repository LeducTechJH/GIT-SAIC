 ...
 */
public class SELECCION_FECHA_VISTA_APEL_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SELECCION_FECHA_VISTA_APEL_PKT ( )
  {
    super ( "SELECCION_FECHA_VISTA_APEL_PKT" );
   ...
   *
   */
  public SELECCION_FECHA_VISTA_APEL_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SELECCION_FECHA_VISTA_APEL_PKT ( MDIFrame pFrame )
  {
    super ( "SELECCION_FECHA_VISTA_APEL_PKT", pFrame );
  ...
  {
    this.createComponents ( new SELECCION_FECHA_VISTA_APEL_FR ( ) );
   ...
   *
   */
  public static SELECCION_FECHA_VISTA_APEL_PKT get ( RallyApplication __app )
  {
    return ( SELECCION_FECHA_VISTA_APEL_PKT ) __app.getNewInstance ( "SELECCION_FECHA_VISTA_APEL_PKT" );
  }
  ...
  {
    SELECCION_FECHA_VISTA_APEL_PKT fSheet = SELECCION_FECHA_VISTA_APEL_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SELECCION_FECHA_VISTA_APEL_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; IMPRIMIR_VISTA_APELACIONES_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
