     ...
     extends Form
{
   ...
   *
   */
  public CLASSIF_AEC_FRM ( )
  {
    super ( );
    this.setName ( "CLASSIF_AEC_FRM" );

    Debug.println ( Debug.TRACE, "CLASSIF_AEC_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CLASSIF_AEC_FRM.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PARK", JDataPanelListener.HOTKEYPRESS, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CLASSIF_AEC_PARK_LF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
