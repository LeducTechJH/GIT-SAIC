 ...
 */
public class TRANSFER_COPY_PRT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TRANSFER_COPY_PRT_PKT ( )
  {
    super ( "TRANSFER_COPY_PRT_PKT" );
   ...
   *
   */
  public TRANSFER_COPY_PRT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TRANSFER_COPY_PRT_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_COPY_PRT_PKT", pFrame );
  ...
  {
    this.createComponents ( new TRANSFER_COPY_PRINT_FR ( ) );
   ...
   *
   */
  public static TRANSFER_COPY_PRT_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_COPY_PRT_PKT ) __app.getNewInstance ( "TRANSFER_COPY_PRT_PKT" );
  }
  ...
  {
    TRANSFER_COPY_PRT_PKT fSheet = TRANSFER_COPY_PRT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_COPY_PRT_PKT.exec ( __app );
  }
