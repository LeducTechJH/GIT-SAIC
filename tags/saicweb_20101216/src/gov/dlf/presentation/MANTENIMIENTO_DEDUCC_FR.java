 ...
 */
public class MANTENIMIENTO_DEDUCC_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_DEDUCC_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_DEDUCC_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_DEDUCC_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_DEDUCC_FR.jdp" );
