 ...
 */
public class RR_LISTA_AUT_MNU_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public RR_LISTA_AUT_MNU_PKT ( )
  {
    super ( "RR_LISTA_AUT_MNU_PKT" );
   ...
   *
   */
  public RR_LISTA_AUT_MNU_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RR_LISTA_AUT_MNU_PKT ( MDIFrame pFrame )
  {
    super ( "RR_LISTA_AUT_MNU_PKT", pFrame );
  ...
  {
    this.createComponents ( new RR_LISTA_AUT_MNU_FR ( ) );
   ...
   *
   */
  public static RR_LISTA_AUT_MNU_PKT get ( RallyApplication __app )
  {
    return ( RR_LISTA_AUT_MNU_PKT ) __app.getNewInstance ( "RR_LISTA_AUT_MNU_PKT" );
  }
  ...
  {
    RR_LISTA_AUT_MNU_PKT fSheet = RR_LISTA_AUT_MNU_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RR_LISTA_AUT_MNU_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; RR_LISTA_AUT_BF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
