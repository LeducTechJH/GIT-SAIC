 ...
 */
public class TECNICOS_DISPONIBLES_ENTREVISTA_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TECNICOS_DISPONIBLES_ENTREVISTA_RO_PKT ( )
  {
    super ( "TECNICOS_DISPONIBLES_ENTREVISTA_RO_PKT" );
   ...
   *
   */
  public TECNICOS_DISPONIBLES_ENTREVISTA_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TECNICOS_DISPONIBLES_ENTREVISTA_RO_PKT ( MDIFrame pFrame )
  {
    super ( "TECNICOS_DISPONIBLES_ENTREVISTA_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new TECNICOS_DISPONIBLES_ENTREVISTA_FR ( ) );
   ...
   *
   */
  public static TECNICOS_DISPONIBLES_ENTREVISTA_RO_PKT get ( RallyApplication __app )
  {
    return ( TECNICOS_DISPONIBLES_ENTREVISTA_RO_PKT ) __app.getNewInstance ( "TECNICOS_DISPONIBLES_ENTREVISTA_RO_PKT" );
  }
  ...
  {
    TECNICOS_DISPONIBLES_ENTREVISTA_RO_PKT fSheet = TECNICOS_DISPONIBLES_ENTREVISTA_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TECNICOS_DISPONIBLES_ENTREVISTA_RO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CHEK_NUM_TECNICO_DISP_ADL.exec ( app ); return app.errorFlag;
      }
    } );
