 ...
 */
public class COD_SERVICIOS_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public COD_SERVICIOS_LOV_FR ( )
  {
    super ( );
    this.setName ( "COD_SERVICIOS_LOV_FR" );

    Debug.println ( Debug.TRACE, "COD_SERVICIOS_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/COD_SERVICIOS_LOV_FR.jdp" );
