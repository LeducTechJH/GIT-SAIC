     ...
     extends FormSheet
{
   ...
   *
   */
  public LISTA_RECLA_PKT ( )
  {
    super ( "LISTA_RECLA_PKT" );
   ...
   *
   */
  public LISTA_RECLA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public LISTA_RECLA_PKT ( MDIFrame pFrame )
  {
    super ( "LISTA_RECLA_PKT", pFrame );
  ...
  {
    this.createComponents ( new LISTA_RECLA_FR ( ) );
   ...
   *
   */
  public static LISTA_RECLA_PKT get ( RallyApplication __app )
  {
    return ( LISTA_RECLA_PKT ) __app.getNewInstance ( "LISTA_RECLA_PKT" );
  }
  ...
  {
    LISTA_RECLA_PKT fSheet = LISTA_RECLA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return LISTA_RECLA_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; LISTA_RECLA_BF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
