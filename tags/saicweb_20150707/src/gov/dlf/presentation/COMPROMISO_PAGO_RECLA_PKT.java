 ...
 */
public class COMPROMISO_PAGO_RECLA_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public COMPROMISO_PAGO_RECLA_PKT ( )
  {
    super ( "COMPROMISO_PAGO_RECLA_PKT" );
   ...
   *
   */
  public COMPROMISO_PAGO_RECLA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public COMPROMISO_PAGO_RECLA_PKT ( MDIFrame pFrame )
  {
    super ( "COMPROMISO_PAGO_RECLA_PKT", pFrame );
  ...
  {
    this.createComponents ( new COMPROMISO_PAGO_RECLA_FR ( ) );
   ...
   *
   */
  public static COMPROMISO_PAGO_RECLA_PKT get ( RallyApplication __app )
  {
    return ( COMPROMISO_PAGO_RECLA_PKT ) __app.getNewInstance ( "COMPROMISO_PAGO_RECLA_PKT" );
  }
  ...
  {
    COMPROMISO_PAGO_RECLA_PKT fSheet = COMPROMISO_PAGO_RECLA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return COMPROMISO_PAGO_RECLA_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; COMPROMISO_PAGO_RECLA_BF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
