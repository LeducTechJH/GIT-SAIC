 ...
 */
public class GEN_ESTATUS_PART_TRAB_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_ESTATUS_PART_TRAB_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_ESTATUS_PART_TRAB_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_ESTATUS_PART_TRAB_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_ESTATUS_PART_TRAB_LOV_FR.jdp" );
