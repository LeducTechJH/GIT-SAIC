     ...
     extends MenuActions
{
  ...
  public void initActions ( )
  {
    ...
    //************************************************************
   /* action = new MenuAction ( "FORMULARIOS DIP" )
    {
      /**  */
      /*public static final long serialVersionUID = 0L;
      /**  */
     /*public void initAction ( )
      {
        super.initAction ( );
        this.actionCommand = "MAIN_MENU_DIP";
     ...
     /* public void actionPerformed ( ActionEvent e )
      {
        if ( executor != null )
        {
          Debug.println ( Debug.TRACE, "_RECLA_NOTI_MENU - action <FORMULARIOS DIP> invoked." );
          MAIN_MENU_DIP.exec ( app, null );
        }
      }
    };
    this.add ( action );*/
