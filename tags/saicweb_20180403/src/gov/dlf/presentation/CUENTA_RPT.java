     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "CUENTA_RPT" );

    Debug.println ( Debug.TRACE, "CUENTA_RPT - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CUENTA_RPT.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new CUENTA_RPT_FECHAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "USUARIO" );
    field.setValueProvider ( new CUENTA_RPT_USUARIOProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new CUENTA_RPT_OFICINAProvider ( this ) );
 ...
 *
 */
class CUENTA_RPT_FECHAProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public CUENTA_RPT_FECHAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class CUENTA_RPT_USUARIOProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CUENTA_RPT_USUARIOProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class CUENTA_RPT_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CUENTA_RPT_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
