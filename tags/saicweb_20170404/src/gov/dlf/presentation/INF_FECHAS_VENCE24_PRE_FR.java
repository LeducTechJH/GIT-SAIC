 ...
 */
public class INF_FECHAS_VENCE24_PRE_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public INF_FECHAS_VENCE24_PRE_FR ( )
  {
    super ( );
    this.setName ( "INF_FECHAS_VENCE24_PRE_FR" );

    Debug.println ( Debug.TRACE, "INF_FECHAS_VENCE24_PRE_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/INF_FECHAS_VENCE24_PRE_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "FINISH_ACTION", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {  
        app.errorFlag = true; INF_FECHAS_VENCE24_ADL.exec ( app ); return app.errorFlag;        
   //     app.errorFlag = true; INF_FECHAS_VENCE24_ALIST.exec ( app, null ); return app.errorFlag;
      }
    } );
  }
}
