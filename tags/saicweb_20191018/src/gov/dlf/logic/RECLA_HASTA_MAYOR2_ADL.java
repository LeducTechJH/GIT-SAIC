     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( Compare.gt ( StringService.toStringValue  ( this.app.form ( "ACTUALIZAR_RECLA_FR" ).getDateItem ( "DESDE" ),"MM",StringService.Language.SPANISH ), "09" ) ) 
        ANODESDE = MathService.plus(FormattingFactory.parseStringToDouble (StringService.toStringValue  ( this.app.form ( "ACTUALIZAR_RECLA_FR" ).getDateItem ( "DESDE" ),"YYYY",StringService.Language.SPANISH )),1);
    else
    ...
    if ( Compare.gt ( StringService.toStringValue  ( this.app.form ( "ACTUALIZAR_RECLA_FR" ).getDateItem ( "HASTA" ),"MM",StringService.Language.SPANISH ), "09" ) ) 
        ANOHASTA = MathService.plus(FormattingFactory.parseStringToDouble (StringService.toStringValue  ( this.app.form ( "ACTUALIZAR_RECLA_FR" ).getDateItem ( "HASTA" ),"YYYY",StringService.Language.SPANISH )),1);
    else
