 ...
 */
public class CODIGOS_GEN_GBL_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CODIGOS_GEN_GBL_RPT_PKT ( )
  {
    super ( "CODIGOS_GEN_GBL_RPT_PKT" );
   ...
   *
   */
  public CODIGOS_GEN_GBL_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CODIGOS_GEN_GBL_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "CODIGOS_GEN_GBL_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CODIGOS_GEN_GBL_RPT ( ) );
   ...
   *
   */
  public static CODIGOS_GEN_GBL_RPT_PKT get ( RallyApplication __app )
  {
    return ( CODIGOS_GEN_GBL_RPT_PKT ) __app.getNewInstance ( "CODIGOS_GEN_GBL_RPT_PKT" );
  }
  ...
  {
    CODIGOS_GEN_GBL_RPT_PKT fSheet = CODIGOS_GEN_GBL_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CODIGOS_GEN_GBL_RPT_PKT.exec ( __app );
  }
