     ...
     extends FormSheet
{
   ...
   *
   */
  public SC1035_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SC1035_PKT ( MDIFrame pFrame )
  {
    super ( "SC1035_PKT", pFrame );
  ...
  {
    this.createComponents ( new SC1035_FR ( ) );
   ...
   *
   */
  public static SC1035_PKT get ( RallyApplication __app )
  {
    return ( SC1035_PKT ) __app.getNewInstance ( "SC1035_PKT" );
  }
  ...
  {
    SC1035_PKT fSheet = SC1035_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  SC1035_PRN_MENU.exec ( app, null );
 return app.errorFlag;
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SC1035_DATE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERQUERY, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SC1035_FCH_PAGO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
