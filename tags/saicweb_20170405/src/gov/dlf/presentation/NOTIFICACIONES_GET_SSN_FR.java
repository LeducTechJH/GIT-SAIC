 ...
 */
public class NOTIFICACIONES_GET_SSN_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public NOTIFICACIONES_GET_SSN_FR ( )
  {
    super ( );
    this.setName ( "NOTIFICACIONES_GET_SSN_FR" );

    Debug.println ( Debug.TRACE, "NOTIFICACIONES_GET_SSN_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/NOTIFICACIONES_GET_SSN_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "SEGURO_SOCIAL", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; NOTIF_CHECK_SSN_ADL.exec ( app ); return app.errorFlag;
      }
    } );
