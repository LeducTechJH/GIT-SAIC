     ...
     extends Form
{
   ...
   *
   */
  public INFOR_CITAS_FR ( )
  {
    super ( );
    this.setName ( "INFOR_CITAS_FR" );

    Debug.println ( Debug.TRACE, "INFOR_CITAS_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/INFOR_CITAS_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "CITAS", new INFOR_CITAS_FR_CITAS_Arguments ( this ) );

    this.setObjectEvents ( );



    calculator = new INFOR_CITAS_FR_NOMBNRECalculator ( this );
    field = ( JDataPanelField ) this.getInDepth ( "NOMBNRE" );
    field.setValueCalculator ( calculator );
    calculator = new INFOR_CITAS_FR_HASTACalculator ( this );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "CITAS", JDataPanelListener.HOTKEYPRESS, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; INFOR_CITAS_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class INFOR_CITAS_FR_CITAS_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public INFOR_CITAS_FR_CITAS_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class INFOR_CITAS_FR_NOMBNRECalculator implements ICalculator
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public INFOR_CITAS_FR_NOMBNRECalculator ( Form form )
  {
    this.model = form;
  }
  ...
  {
    if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
    this.app.exec ( "CITAS_NOMBRE_PPKT0" );
  }
}
 ...
 *
 */
class INFOR_CITAS_FR_HASTACalculator implements ICalculator
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public INFOR_CITAS_FR_HASTACalculator ( Form form )
  {
    this.model = form;
  }
  ...
  {
    if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
    this.app.exec ( "INFOR_HASTA_PPKT" );
  }
}
