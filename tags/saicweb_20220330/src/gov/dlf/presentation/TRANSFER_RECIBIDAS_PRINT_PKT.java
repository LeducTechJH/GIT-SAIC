 ...
 */
public class TRANSFER_RECIBIDAS_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
  ...
  {
    TRANSFER_RECIBIDAS_PRINT_PKT fSheet = TRANSFER_RECIBIDAS_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_RECIBIDAS_PRINT_PKT.exec ( __app );
  }
   ...
   *
   */
  public static TRANSFER_RECIBIDAS_PRINT_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_RECIBIDAS_PRINT_PKT ) __app.getNewInstance ( "TRANSFER_RECIBIDAS_PRINT_PKT" );
  }
   ...
   *
   */
  public TRANSFER_RECIBIDAS_PRINT_PKT ( )
  {
    super ( "TRANSFER_RECIBIDAS_PRINT_PKT" );
   ...
   *
   */
  public TRANSFER_RECIBIDAS_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_RECIBIDAS_PRINT_PKT", pFrame );
   ...
   *
   */
  public TRANSFER_RECIBIDAS_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
  ...
  {
    this.createComponents ( new TRANSFER_RECIBIDAS_FR ( ) );
