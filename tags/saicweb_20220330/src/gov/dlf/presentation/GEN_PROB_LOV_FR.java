     ...
     extends Form
{
   ...
   *
   */
  public GEN_PROB_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_PROB_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_PROB_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_PROB_LOV_FR.jdp" );
