     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "CUIDO2_FRM" );

    Debug.println ( Debug.TRACE, "CUIDO2_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CUIDO2_FRM.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "FAM_JEFE_GP", new CUIDO2_FRM_FAM_JEFE_GP_Arguments ( this ) );
    this.setArguments ( "SERV_INFO_GP", new CUIDO2_FRM_SERV_INFO_GP_Arguments ( this ) );

    this.setObjectEvents ( );

    field = ( JDataPanelField ) this.getInDepth ( "RMO_NUCLEO" );
    field.setValueProvider ( new CUIDO2_FRM_RMO_NUCLEOProvider ( this ) );
  ...
  public void setObjectEvents ( )
  {
	    this.registerListener ( "NUCLEO_PARK", JDataPanelListener.HOTKEYPRESS, new JDataPanelListener ( )
	    {
	      ...
	      {
	        app.errorFlag = true; SOLIC_CONTRATO_PROYECCION_SELECT_LF_ADL.exec ( app ); return app.errorFlag;
	      }
	    } );
  }
}
 ...
 *
 */
class CUIDO2_FRM_FAM_JEFE_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public CUIDO2_FRM_FAM_JEFE_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class CUIDO2_FRM_SERV_INFO_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CUIDO2_FRM_SERV_INFO_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class CUIDO2_FRM_RMO_NUCLEOProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CUIDO2_FRM_RMO_NUCLEOProvider ( Form form )
  {
    this.model = form;
  }
