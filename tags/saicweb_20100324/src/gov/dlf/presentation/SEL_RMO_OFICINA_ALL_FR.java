 ...
 */
public class SEL_RMO_OFICINA_ALL_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SEL_RMO_OFICINA_ALL_FR ( )
  {
    super ( );
    this.setName ( "SEL_RMO_OFICINA_ALL_FR" );

    Debug.println ( Debug.TRACE, "SEL_RMO_OFICINA_ALL_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SEL_RMO_OFICINA_ALL_FR.jdp" );
  ...
  {
	// *** BEGIN MODS J Olmeda (KPG, INC) 8/11/2009 ***
    this.registerListener ( "RMO_OFICNA", JDataPanelListener.VALIDATION, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true;
        if ( Compare.lt ( app.form ( "SEL_RMO_OFICINA_ALL_FR" ).getDoubleItem ( "RMO_OFICNA" ), 0 ) ) 
        {
        	app.errorFlag = false;
        }
	...
	// *** END MODS J Olmeda (KPG, INC) 8/11/2009 ***
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; 
        app.RMO_GBL = app.form ( "SEL_RMO_OFICINA_ALL_FR" ).getDoubleItem ( "RMO_OFICNA" );
