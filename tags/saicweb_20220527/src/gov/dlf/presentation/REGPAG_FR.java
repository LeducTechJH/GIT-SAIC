     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "REGPAG_FR" );

    Debug.println ( Debug.TRACE, "REGPAG_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REGPAG_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "REGPAG_AG1", new REGPAG_FR_REGPAG_AG1_Arguments ( this ) );
    this.setArguments ( "REGPAG_AG2", new REGPAG_FR_REGPAG_AG2_Arguments ( this ) );

    this.setObjectEvents ( );
    field = ( JDataPanelField ) this.getInDepth ( "REGPAG_NOMBRE" );
    field.setValueProvider ( new REGPAG_FR_REGPAG_NOMBREProvider ( this ) );
 ...
 *
 */
class REGPAG_FR_REGPAG_AG1_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public REGPAG_FR_REGPAG_AG1_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class REGPAG_FR_REGPAG_AG2_Arguments extends JDataPanelGroupArguments
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public REGPAG_FR_REGPAG_AG2_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class REGPAG_FR_REGPAG_NOMBREProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public REGPAG_FR_REGPAG_NOMBREProvider ( Form form )
  {
    this.model = form;
  }
