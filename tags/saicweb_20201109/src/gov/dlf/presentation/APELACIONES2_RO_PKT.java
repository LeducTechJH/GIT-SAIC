 ...
 */
public class APELACIONES2_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public APELACIONES2_RO_PKT ( )
  {
    super ( "APELACIONES2_RO_PKT" );
   ...
   *
   */
  public APELACIONES2_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public APELACIONES2_RO_PKT ( MDIFrame pFrame )
  {
    super ( "APELACIONES2_RO_PKT", pFrame );
   ...
   *
   */
  public static APELACIONES2_RO_PKT get ( RallyApplication __app )
  {
    return ( APELACIONES2_RO_PKT ) __app.getNewInstance ( "APELACIONES2_RO_PKT" );
  }
  ...
  {
    APELACIONES2_RO_PKT fSheet = APELACIONES2_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return APELACIONES2_RO_PKT.exec ( __app );
  }
