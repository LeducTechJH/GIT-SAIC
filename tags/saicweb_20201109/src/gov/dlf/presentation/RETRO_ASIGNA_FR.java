     ...
     extends Form
{
   ...
   *
   */
  public RETRO_ASIGNA_FR ( )
  {
    super ( );
    this.setName ( "RETRO_ASIGNA_FR" );

    Debug.println ( Debug.TRACE, "RETRO_ASIGNA_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RETRO_ASIGNA_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "G1", new RETRO_ASIGNA_FR_G1_Arguments ( this ) );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "FATS", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; RR_VALIDA_FCH_ASIGNA2_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    ...
    this.registerListener ( "TSS2", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; RETRO_COPY_ASIG1_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "TSS3", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; RETRO_COPY_ASIG2_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class RETRO_ASIGNA_FR_G1_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public RETRO_ASIGNA_FR_G1_Arguments ( Form form )
  {
    this.model = form;
