 ...
 */
public class SIST_VERIFICA_RECLA_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SIST_VERIFICA_RECLA_LOV_FR ( )
  {
    super ( );
    this.setName ( "SIST_VERIFICA_RECLA_LOV_FR" );

    Debug.println ( Debug.TRACE, "SIST_VERIFICA_RECLA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SIST_VERIFICA_RECLA_LOV_FR.jdp" );
