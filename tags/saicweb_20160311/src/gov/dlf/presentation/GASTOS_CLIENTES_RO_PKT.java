 ...
 */
public class GASTOS_CLIENTES_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public GASTOS_CLIENTES_RO_PKT ( )
  {
    super ( "GASTOS_CLIENTES_RO_PKT" );
   ...
   *
   */
  public GASTOS_CLIENTES_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GASTOS_CLIENTES_RO_PKT ( MDIFrame pFrame )
  {
    super ( "GASTOS_CLIENTES_RO_PKT", pFrame );
   ...
   *
   */
  public static GASTOS_CLIENTES_RO_PKT get ( RallyApplication __app )
  {
    return ( GASTOS_CLIENTES_RO_PKT ) __app.getNewInstance ( "GASTOS_CLIENTES_RO_PKT" );
  }
  ...
  {
    GASTOS_CLIENTES_RO_PKT fSheet = GASTOS_CLIENTES_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GASTOS_CLIENTES_RO_PKT.exec ( __app );
  }
