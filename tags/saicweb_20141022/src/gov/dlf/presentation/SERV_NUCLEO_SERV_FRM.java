...
//			COMMENTED VALIDATION ON AEE        	 
//   		  else if (numCta <9999999)
//   		  {
//   			  app.setError ("0", "El numero de cuenta debe tener mas de 8 digitos.");
//   			  app.errorFlag = false;
//   			  return app.errorFlag;
//   		  }
          }
    ...
    this.registerListener ( "CANTIDAD_AUTO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
    	  ...
    	  if (  serv.equals ( "LICE1" ) )
    	  {
    		  if (Compare.gt(cantAuto, 450))
    		  {
    			  app.setError ("0", "La cantidad autorizada de atraso o pago de luz sobrepasa los $450.00.");
    			  app.errorFlag = false;
    			  return app.errorFlag;
    		  }
    	  }
    	  ...
    	  else if (  serv.equals ( "LICE3" ) )
    	  {
    		  if (Compare.gt(cantAuto, 450))
    		  {
    			  app.setError ("0", "La cantidad autorizada para compra de acondicionador de aire sobrepasa los $450.00.");
    			  app.errorFlag = false;
    			  return app.errorFlag;
    		  }
    	  }
    	  ...
    	  {
    		  if (Compare.gt(cantAuto, 50))
    		  {
    			  app.setError ("0", "La cantidad autorizada para compra o reparacion de abanico sobrepasa los $50.00.");
    			  app.errorFlag = false;
    			  return app.errorFlag;
    		  }
    	  }
