     ...
     extends Form
{
   ...
   *
   */
  public GET_ADSEF184_FR ( )
  {
    super ( );
    this.setName ( "GET_ADSEF184_FR" );

    Debug.println ( Debug.TRACE, "GET_ADSEF184_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_ADSEF184_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; ADSEF184_PERSONA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
