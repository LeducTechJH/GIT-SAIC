 ...
 */
public class RUTAS_BANCO_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public RUTAS_BANCO_LOV_FR ( )
  {
    super ( );
    this.setName ( "RUTAS_BANCO_LOV_FR" );

    Debug.println ( Debug.TRACE, "RUTAS_BANCO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RUTAS_BANCO_LOV_FR.jdp" );
