 ...
 */
public class EMISIONES_BENEFICIOS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public EMISIONES_BENEFICIOS_PKT ( )
  {
    super ( "EMISIONES_BENEFICIOS_PKT" );
   ...
   *
   */
  public EMISIONES_BENEFICIOS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public EMISIONES_BENEFICIOS_PKT ( MDIFrame pFrame )
  {
    super ( "EMISIONES_BENEFICIOS_PKT", pFrame );
  ...
  {
    this.createComponents ( new EMISIONES_BENEFICIOS_FRM ( ) );
   ...
   *
   */
  public static EMISIONES_BENEFICIOS_PKT get ( RallyApplication __app )
  {
    return ( EMISIONES_BENEFICIOS_PKT ) __app.getNewInstance ( "EMISIONES_BENEFICIOS_PKT" );
  }
  ...
  {
	  EMISIONES_BENEFICIOS_PKT fSheet = EMISIONES_BENEFICIOS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return EMISIONES_BENEFICIOS_PKT.exec ( __app );
  }
