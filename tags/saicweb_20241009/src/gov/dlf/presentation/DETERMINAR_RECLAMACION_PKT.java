 ...
 */
public class DETERMINAR_RECLAMACION_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public DETERMINAR_RECLAMACION_PKT ( )
  {
    super ( "DETERMINAR_RECLAMACION_PKT" );
   ...
   *
   */
  public DETERMINAR_RECLAMACION_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DETERMINAR_RECLAMACION_PKT ( MDIFrame pFrame )
  {
    super ( "DETERMINAR_RECLAMACION_PKT", pFrame );
  ...
  {
    this.createComponents ( new DETERMINAR_RECLAMACION_FR ( ) );
   ...
   *
   */
  public static DETERMINAR_RECLAMACION_PKT get ( RallyApplication __app )
  {
    return ( DETERMINAR_RECLAMACION_PKT ) __app.getNewInstance ( "DETERMINAR_RECLAMACION_PKT" );
  }
  ...
  {
    DETERMINAR_RECLAMACION_PKT fSheet = DETERMINAR_RECLAMACION_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DETERMINAR_RECLAMACION_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.BEFOREQUIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SALIR_DETERMINACION_RECLA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
