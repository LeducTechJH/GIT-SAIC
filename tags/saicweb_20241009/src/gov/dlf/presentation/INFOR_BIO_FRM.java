     ...
     extends Form
{
  ...
  public void setObjectEvents ( )
  {
    ...
    this.registerListener ( "COD_PSM2", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; PSM_CHK_ADL.exec ( app ); return app.errorFlag;
    ...
    this.registerListener ( "FLG_SERV_SELECTIVO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SERVICIO_VER_S_N_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    ...
    this.registerListener ( "FUERZA_LABORAL", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CHECK_CHANGE_TIPO_REG_ADL.exec ( app ); return app.errorFlag;
