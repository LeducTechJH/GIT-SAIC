 ...
 */
public class IMPRIMIR_VISTA_APELACIONES_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public IMPRIMIR_VISTA_APELACIONES_PKT ( )
  {
    super ( "IMPRIMIR_VISTA_APELACIONES_PKT" );
   ...
   *
   */
  public IMPRIMIR_VISTA_APELACIONES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public IMPRIMIR_VISTA_APELACIONES_PKT ( MDIFrame pFrame )
  {
    super ( "IMPRIMIR_VISTA_APELACIONES_PKT", pFrame );
   ...
   *
   */
  public static IMPRIMIR_VISTA_APELACIONES_PKT get ( RallyApplication __app )
  {
    return ( IMPRIMIR_VISTA_APELACIONES_PKT ) __app.getNewInstance ( "IMPRIMIR_VISTA_APELACIONES_PKT" );
  }
  ...
  {
    IMPRIMIR_VISTA_APELACIONES_PKT fSheet = IMPRIMIR_VISTA_APELACIONES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return IMPRIMIR_VISTA_APELACIONES_PKT.exec ( __app );
  }
