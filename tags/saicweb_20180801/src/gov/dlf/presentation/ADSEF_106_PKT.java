     ...
     extends FormSheet
{
   ...
   *
   */
  public ADSEF_106_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ADSEF_106_PKT ( MDIFrame pFrame )
  {
    super ( "ADSEF_106_PKT", pFrame );
   ...
   *
   */
  public static ADSEF_106_PKT get ( RallyApplication __app )
  {
    return ( ADSEF_106_PKT ) __app.getNewInstance ( "ADSEF_106_PKT" );
  }
  ...
  {
    ADSEF_106_PKT fSheet = ADSEF_106_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ADSEF_106_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_106_MENU.exec ( app, null );
