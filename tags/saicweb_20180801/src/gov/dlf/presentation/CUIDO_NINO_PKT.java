     ...
     extends FormSheet
{
   ...
   *
   */
  public CUIDO_NINO_PKT ( )
  {
    super ( "CUIDO_NINO_PKT" );
   ...
   *
   */
  public CUIDO_NINO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CUIDO_NINO_PKT ( MDIFrame pFrame )
  {
    super ( "CUIDO_NINO_PKT", pFrame );
  ...
  {
    this.createComponents ( new CUIDO_NINO_FRM ( ) );
   ...
   *
   */
  public static CUIDO_NINO_PKT get ( RallyApplication __app )
  {
    return ( CUIDO_NINO_PKT ) __app.getNewInstance ( "CUIDO_NINO_PKT" );
  }
  ...
  {
    CUIDO_NINO_PKT fSheet = CUIDO_NINO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CUIDO_NINO_PKT.exec ( __app );
  }
