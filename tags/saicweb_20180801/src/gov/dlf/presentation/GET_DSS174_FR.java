     ...
     extends Form
{
   ...
   *
   */
  public GET_DSS174_FR ( )
  {
    super ( );
    this.setName ( "GET_DSS174_FR" );

    Debug.println ( Debug.TRACE, "GET_DSS174_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_DSS174_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; DSS174_PERSONA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
