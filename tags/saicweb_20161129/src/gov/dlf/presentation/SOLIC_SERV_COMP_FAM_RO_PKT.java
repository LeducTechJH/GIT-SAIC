 ...
 */
public class SOLIC_SERV_COMP_FAM_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SOLIC_SERV_COMP_FAM_RO_PKT ( )
  {
    super ( "SOLIC_SERV_COMP_FAM_RO_PKT" );
   ...
   *
   */
  public SOLIC_SERV_COMP_FAM_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SOLIC_SERV_COMP_FAM_RO_PKT ( MDIFrame pFrame )
  {
    super ( "SOLIC_SERV_COMP_FAM_RO_PKT", pFrame );
   ...
   *
   */
  public static SOLIC_SERV_COMP_FAM_RO_PKT get ( RallyApplication __app )
  {
    return ( SOLIC_SERV_COMP_FAM_RO_PKT ) __app.getNewInstance ( "SOLIC_SERV_COMP_FAM_RO_PKT" );
  }
  ...
  {
    SOLIC_SERV_COMP_FAM_RO_PKT fSheet = SOLIC_SERV_COMP_FAM_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SOLIC_SERV_COMP_FAM_RO_PKT.exec ( __app );
  }
