 ...
 */
public class MANT_DE_CASOS_DESEA_ESTE_CLIENTE_FR_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANT_DE_CASOS_DESEA_ESTE_CLIENTE_FR_PKT ( )
  {
    super ( "MANT_DE_CASOS_DESEA_ESTE_CLIENTE_FR_PKT" );
   ...
   *
   */
  public MANT_DE_CASOS_DESEA_ESTE_CLIENTE_FR_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANT_DE_CASOS_DESEA_ESTE_CLIENTE_FR_PKT ( MDIFrame pFrame )
  {
    super ( "MANT_DE_CASOS_DESEA_ESTE_CLIENTE_FR_PKT", pFrame );
  ...
  {
    this.createComponents ( new DESEA_ESTE_CLIENTE_FR ( ) );
   ...
   *
   */
  public static MANT_DE_CASOS_DESEA_ESTE_CLIENTE_FR_PKT get ( RallyApplication __app )
  {
    return ( MANT_DE_CASOS_DESEA_ESTE_CLIENTE_FR_PKT ) __app.getNewInstance ( "MANT_DE_CASOS_DESEA_ESTE_CLIENTE_FR_PKT" );
  }
  ...
  {
    MANT_DE_CASOS_DESEA_ESTE_CLIENTE_FR_PKT fSheet = MANT_DE_CASOS_DESEA_ESTE_CLIENTE_FR_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANT_DE_CASOS_DESEA_ESTE_CLIENTE_FR_PKT.exec ( __app );
  }
