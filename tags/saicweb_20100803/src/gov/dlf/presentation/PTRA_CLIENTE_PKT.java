     ...
     extends FormSheet
{
   ...
   *
   */
  public PTRA_CLIENTE_PKT ( )
  {
    super ( "PTRA_CLIENTE_PKT" );
   ...
   *
   */
  public PTRA_CLIENTE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PTRA_CLIENTE_PKT ( MDIFrame pFrame )
  {
    super ( "PTRA_CLIENTE_PKT", pFrame );
   ...
   *
   */
  public static PTRA_CLIENTE_PKT get ( RallyApplication __app )
  {
    return ( PTRA_CLIENTE_PKT ) __app.getNewInstance ( "PTRA_CLIENTE_PKT" );
  }
  ...
  {
    PTRA_CLIENTE_PKT fSheet = PTRA_CLIENTE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PTRA_CLIENTE_PKT.exec ( __app );
  }
