 ...
 */
public class CODIGO_PROVEEDOR_RPT
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CODIGO_PROVEEDOR_RPT ( )
  {
    super ( );
    this.setName ( "CODIGO_PROVEEDOR_RPT" );

    Debug.println ( Debug.TRACE, "CODIGO_PROVEEDOR_RPT - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CODIGO_PROVEEDOR_RPT.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new CODIGO_PROVEEDOR_RPT_FECHAProvider ( this ) );
 ...
 *
 */
class CODIGO_PROVEEDOR_RPT_FECHAProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public CODIGO_PROVEEDOR_RPT_FECHAProvider ( Form form )
  {
    this.model = form;
  }
