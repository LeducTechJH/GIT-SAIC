 ...
 */
public class BAJAS_EMPLEOS_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public BAJAS_EMPLEOS_PRINT_PKT ( )
  {
    super ( "BAJAS_EMPLEOS_PRINT_PKT" );
   ...
   *
   */
  public BAJAS_EMPLEOS_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public BAJAS_EMPLEOS_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "BAJAS_EMPLEOS_PRINT_PKT", pFrame );
   ...
   *
   */
  public static BAJAS_EMPLEOS_PRINT_PKT get ( RallyApplication __app )
  {
    return ( BAJAS_EMPLEOS_PRINT_PKT ) __app.getNewInstance ( "BAJAS_EMPLEOS_PRINT_PKT" );
  }
  ...
  {
    BAJAS_EMPLEOS_PRINT_PKT fSheet = BAJAS_EMPLEOS_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return BAJAS_EMPLEOS_PRINT_PKT.exec ( __app );
  }
