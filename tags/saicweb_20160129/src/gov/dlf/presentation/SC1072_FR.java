     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "SC1072_FR" );

    Debug.println ( Debug.TRACE, "SC1072_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SC1072_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "DAT1", new SC1072_FR_DAT1_Arguments ( this ) );

    this.setObjectEvents ( );
    field = ( JDataPanelField ) this.getInDepth ( "FECHA_IMPRESION" );
    field.setValueProvider ( new SC1072_FR_FECHA_IMPRESIONProvider ( this ) );
 ...
 *
 */
class SC1072_FR_DAT1_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public SC1072_FR_DAT1_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class SC1072_FR_FECHA_IMPRESIONProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public SC1072_FR_FECHA_IMPRESIONProvider ( Form form )
  {
    this.model = form;
  }
