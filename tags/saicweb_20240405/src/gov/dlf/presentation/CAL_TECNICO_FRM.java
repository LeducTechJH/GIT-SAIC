     ...
     extends Form
{
   ...
   *
   */
  public CAL_TECNICO_FRM ( )
  {
    super ( );
    this.setName ( "CAL_TECNICO_FRM" );

    Debug.println ( Debug.TRACE, "CAL_TECNICO_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CAL_TECNICO_FRM.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "ID_TECNICO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CAL_TEC_NOMBRE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "PARK", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CAL_TECNICO_PARK_AFTER_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
