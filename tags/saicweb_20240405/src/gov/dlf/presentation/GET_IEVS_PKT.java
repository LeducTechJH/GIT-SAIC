     ...
     extends FormSheet
{
   ...
   *
   */
  public GET_IEVS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GET_IEVS_PKT ( MDIFrame pFrame )
  {
    super ( "GET_IEVS_PKT", pFrame );
  ...
  {
    this.createComponents ( new GET_IEVS_R ( ) );
   ...
   *
   */
  public static GET_IEVS_PKT get ( RallyApplication __app )
  {
    return ( GET_IEVS_PKT ) __app.getNewInstance ( "GET_IEVS_PKT" );
  }
  ...
  {
    GET_IEVS_PKT fSheet = GET_IEVS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GET_IEVS_PKT.exec ( __app );
  }
