 ...
 */
public class RECLA_BENE_INSERT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public RECLA_BENE_INSERT_PKT ( )
  {
    super ( "RECLA_BENE_INSERT_PKT" );
   ...
   *
   */
  public RECLA_BENE_INSERT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RECLA_BENE_INSERT_PKT ( MDIFrame pFrame )
  {
    super ( "RECLA_BENE_INSERT_PKT", pFrame );
  ...
  {
    this.createComponents ( new RECLA_BENE_FR ( ) );
   ...
   *
   */
  public static RECLA_BENE_INSERT_PKT get ( RallyApplication __app )
  {
    return ( RECLA_BENE_INSERT_PKT ) __app.getNewInstance ( "RECLA_BENE_INSERT_PKT" );
  }
  ...
  {
    RECLA_BENE_INSERT_PKT fSheet = RECLA_BENE_INSERT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RECLA_BENE_INSERT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SALIR_LISTA_RECLA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SET_RECLA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
