 ...
 */
public class TRANSFER_RECIBIDAS_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TRANSFER_RECIBIDAS_FR ( )
  {
    super ( );
    this.setName ( "TRANSFER_RECIBIDAS_FR" );

    Debug.println ( Debug.TRACE, "TRANSFER_RECIBIDAS_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TRANSFER_RECIBIDAS_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "RECIBIDAS_GP", new TRANSFER_RECIBIDAS_FR_RECIBIDAS_GP_Arguments ( this ) );

    this.setObjectEvents ( );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new TRANSFER_RECIBIDAS_FR_OFICINAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "FECHA" );
    field.setValueProvider ( new TRANSFER_RECIBIDAS_FR_FECHAProvider ( this ) );
 ...
 *
 */
class TRANSFER_RECIBIDAS_FR_FECHAProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public TRANSFER_RECIBIDAS_FR_FECHAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class TRANSFER_RECIBIDAS_FR_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public TRANSFER_RECIBIDAS_FR_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class TRANSFER_RECIBIDAS_FR_RECIBIDAS_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public TRANSFER_RECIBIDAS_FR_RECIBIDAS_GP_Arguments ( Form form )
  {
    this.model = form;
  ...
  public Object getArgValue ( String argName )
  {
    ...
    {
      return TRANSFER_RECIBIDAS_ADL.getFECHAS_VENCE ( this.app ); // ADL Exported Field
    }
    ...
    {
      return TRANSFER_RECIBIDAS_ADL.getFECHAS_VENCE2 ( this.app ); // ADL Exported Field
    }
    return null;
  }
}
