     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS170_MENU_PKT ( )
  {
    super ( "DSS170_MENU_PKT" );
   ...
   *
   */
  public DSS170_MENU_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS170_MENU_PKT ( MDIFrame pFrame )
  {
    super ( "DSS170_MENU_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS170_MENU_FR ( ) );
   ...
   *
   */
  public static DSS170_MENU_PKT get ( RallyApplication __app )
  {
    return ( DSS170_MENU_PKT ) __app.getNewInstance ( "DSS170_MENU_PKT" );
  }
  ...
  {
    DSS170_MENU_PKT fSheet = DSS170_MENU_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS170_MENU_PKT.exec ( __app );
  }
