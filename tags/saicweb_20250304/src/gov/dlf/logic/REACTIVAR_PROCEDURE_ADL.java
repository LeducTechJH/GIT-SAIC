  ...
  protected void step1 ( ParameterSet ps )
  {
    ...
    if ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 2 ), "AE" ) ) 
    {
      ...
      while (Compare.equals(STATUS2_ID, 0)) {
          ...
          if (!Compare.equals(this.dm.getFieldString(this.dm.get("NUCLEO_READ_LOC_DSD"), "COD_PARENTESCO_RELACION_SERV"), "ENNA")) {
              if ((Compare.equals(this.dm.getFieldDouble(this.dm.get("NUCLEO_READ_LOC_DSD"), "SEGURO_SOCIAL_BENEFICIARIO"), this.app.SS_SERV_GBL))
            	  && (Compare.equals(this.dm.getFieldString( this.dm.get ( "NUCLEO_READ_LOC_DSD" ), "COD_SERVICIO"),"AE-C" ))  
                  && (Compare.ge(this.dm.getFieldDouble(this.dm.get("CLIENTES_RO_DSD"), "CONTEO_60_MESES_TANF"), 72))) {
                  this.app.errorFlag = false;
          ...
          while (Compare.equals(STATUS7_ID, 0)) {
              if ((Compare.equals(RallyStringService.subString(this.dm.getFieldString(this.dm.get("NUCLEOS_EXISTE2_DSD"), "COD_SERVICIO"), 0, 2), "AE"))
                  ...
                  && ((Compare.equals(this.dm.getFieldString(this.dm.get("NUCLEOS_EXISTE2_DSD"), "COD_STATUS_SERVICIO"), "ACTIVO"))
                      ...
                      || (Compare.equals(this.dm.getFieldString(this.dm.get("NUCLEOS_EXISTE2_DSD"), "COD_STATUS_SERVICIO"), "JUNTAMED"))
                      || (Compare.equals(this.dm.getFieldString(this.dm.get("NUCLEOS_EXISTE2_DSD"), "COD_STATUS_SERVICIO"), "PENDJMED"))
    ...
    if (  Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ),"LICE"))
    {
		...
		if (Compare.equals(STATUS8_ID, 0)) 
		{
			this.dm.setField ( this.dm.get ( "SERVICIOS_EMERGENCIA_DSD" ), "CANTIDAD_AUTO",0);
			this.dm.setField ( this.dm.get ( "SERVICIOS_EMERGENCIA_DSD" ), "ATRASOS","");
		}
		STATUS8_ID = this.dm.update(OPEN8_ID);
    }
