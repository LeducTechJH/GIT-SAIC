 ...
 */
public class STATUS_RECLA_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public STATUS_RECLA_LOV_FR ( )
  {
    super ( );
    this.setName ( "STATUS_RECLA_LOV_FR" );

    Debug.println ( Debug.TRACE, "STATUS_RECLA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/STATUS_RECLA_LOV_FR.jdp" );
