 ...
 */
public class DETERMINACION_HIST_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public DETERMINACION_HIST_PKT ( )
  {
    super ( "DETERMINACION_HIST_PKT" );
   ...
   *
   */
  public DETERMINACION_HIST_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DETERMINACION_HIST_PKT ( MDIFrame pFrame )
  {
    super ( "DETERMINACION_HIST_PKT", pFrame );
   ...
   *
   */
  public static DETERMINACION_HIST_PKT get ( RallyApplication __app )
  {
    return ( DETERMINACION_HIST_PKT ) __app.getNewInstance ( "DETERMINACION_HIST_PKT" );
  }
  ...
  {
    DETERMINACION_HIST_PKT fSheet = DETERMINACION_HIST_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DETERMINACION_HIST_PKT.exec ( __app );
  }
