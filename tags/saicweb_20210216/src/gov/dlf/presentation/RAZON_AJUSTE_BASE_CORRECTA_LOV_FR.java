 ...
 */
public class RAZON_AJUSTE_BASE_CORRECTA_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public RAZON_AJUSTE_BASE_CORRECTA_LOV_FR ( )
  {
    super ( );
    this.setName ( "RAZON_AJUSTE_BASE_CORRECTA_LOV_FR" );

    Debug.println ( Debug.TRACE, "RAZON_AJUSTE_BASE_CORRECTA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RAZON_AJUSTE_BASE_CORRECTA_LOV_FR.jdp" );
