     ...
     extends FormSheet
{
   ...
   *
   */
  public PENDLECT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PENDLECT_PKT ( MDIFrame pFrame )
  {
    super ( "PENDLECT_PKT", pFrame );
   ...
   *
   */
  public static PENDLECT_PKT get ( RallyApplication __app )
  {
    return ( PENDLECT_PKT ) __app.getNewInstance ( "PENDLECT_PKT" );
  }
  ...
  {
    PENDLECT_PKT fSheet = PENDLECT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PENDLECT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_PENDLECT_MENU.exec ( app, null );
