 ...
 */
public class GEN_PAR_ESCI_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_PAR_ESCI_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_PAR_ESCI_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_PAR_ESCI_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_PAR_ESCI_LOV_FR.jdp" );
