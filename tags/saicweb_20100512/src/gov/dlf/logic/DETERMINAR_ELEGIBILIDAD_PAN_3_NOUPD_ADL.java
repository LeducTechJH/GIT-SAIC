 ...
 */
public class DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL
     extends ADL
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
...
//*****
  ...
  {
    ( ( DETERMINAR_ELEGIBILIDAD_PAN_2 ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_PAN_2.class ) ).BONO_ANCIANO = ( ( Double ) value ).doubleValue ( );
  }
   ...
   * @return
   */
  public static DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL get ( RallyApplication __app )
  {
    DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL adl = new DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL ( );
    __app.register ( adl, "DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL" );
    __app.setADL ( DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL.class, adl ); 
  ...
  {
    DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL.get ( __app ).process ( ps );
  }
  ...
  public static void exec ( RallyApplication __app )
  {
    ...
    DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL.exec ( __app, ps );
  }
  ...
  public void unregister ( )
  {
    ...
    IRegisteredObject rObj = this.app.get ( "DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL" );
    if ( rObj != null && rObj instanceof DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL )
    {
      this.app.setADL ( DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL.class, ( DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL ) rObj );
    }
  }
  ...
  {
    Debug.println ( Debug.TRACE, "DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL Step " + this.currentStep );
    super.process ( ps );
    switch ( this.currentStep ) 
    {
      ...
      { 
        this.currentStep = 0;
        Debug.println ( Debug.TRACE, "DETERMINAR_ELEGIBILIDAD_PAN_3_NOUPD_ADL ended" );
        this.unregister ( );
        break;
      }
    }
...
//    this.dm.setField ( this.dm.get ( "DETERMINA_RO_DSD" ), "COD_SERVICIO", this.app.COD_SERV_GBL );
    ...
    {
       this.dm.setField ( this.dm.get ( "DETERMINA_RO_DSD" ), "COD_SERVICIO", "PANE1" );
    }
...
//      EXENCION_SEG_SOC = this.dm.getFieldDouble ( this.dm.get ( "DETERMINA_RO_DSD" ), "EXENCION_SEG_SOC" );
    ...
    while ( Compare.equals ( STATUS_CODE, 0 )  )
    {
      ...
      while ( Compare.equals ( STATUS8_CODE, 0 )  )
      {
        ...
        {
          if (( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTE_AGENCIA_RO_DSD" ), "COD_AGENCIA"  ), "ACAA")) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get( "CLIENTE_AGENCIA_RO_DSD" ), "COD_AGENCIA"  ), "CFSE" )) || (Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTE_AGENCIA_RO_DSD" ), "COD_AGENCIA") , "ADSR")) || (Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTE_AGENCIA_RO_DSD" ), "COD_AGENCIA" ), "SIRM")) || (Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTE_AGENCIA_RO_DSD" ), "COD_AGENCIA" ), "RETF")) || (Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTE_AGENCIA_RO_DSD" ), "COD_AGENCIA" ), "DFAM")) || (Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTE_AGENCIA_RO_DSD" ), "COD_AGENCIA"  ), "ADSS")) || ( Compare.equals( this.dm.getFieldString( this.dm.get( "CLIENTE_AGENCIA_RO_DSD" ), "COD_AGENCIA" ), "ADSE" )) || (Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTE_AGENCIA_RO_DSD" ), "COD_AGENCIA" ), "VETE")) || ( Compare.equals( this.dm.getFieldString ( this.dm.get( "CLIENTE_AGENCIA_RO_DSD" ), "COD_AGENCIA"), "RETO")) || ( Compare.equals( this.dm.getFieldString ( this.dm.get( "CLIENTE_AGENCIA_RO_DSD" ), "COD_AGENCIA"), "SIRM")))
          {
      ...
      if ( ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 3 ), "PAN" ) ) && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "FLG_PAN" ), "X" ) )  ) || ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 3 ), "AE" ) ) && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "FLG_AE" ), "X" ) )  ) ) 
      {
        this.dm.setField ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "VLR_CANTIDAD_RECURSO", 0 );
      }
      else
      {
        if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "RNBE" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "ACNE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) ) && Compare.equals (BENEINCA,0)  ) 
        {
          if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_TIPO_RECURSO" ), "EDIF" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_TIPO_RECURSO" ), "TECA" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_TIPO_RECURSO" ), "PERS" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_TIPO_RECURSO" ), "VEH2" ) )  ) 
          {
          ...
          {
            if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PAN" ) ) && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_TIPO_RECURSO" ), "VEH2" ) )  ) 
            {
...
//          this.dm.setField ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO", this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) * 2.15 );
          INGRESOS_NUCLEO = MathService.plus ( INGRESOS_NUCLEO, this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" )* 2.15  );
        }
...
//          this.dm.setField ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO", this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) * 2.0 );
          INGRESOS_NUCLEO = MathService.plus ( INGRESOS_NUCLEO, this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" )* 2.0  );
        }
        else
        {
//          this.dm.setField ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO", this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) * 1.0 );
          INGRESOS_NUCLEO = MathService.plus ( INGRESOS_NUCLEO, this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" )* 1.0  );
        }
      }
    ...
    while ( Compare.equals ( STATUS_CODE, 0 )  )
    {
      if ( ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 3 ), "PAN" ) ) && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "FLG_PAN" ), "X" ) )  ) || ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 2 ), "AE" ) ) && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "FLG_AE" ), "X" ) )  ) ) 
      {
        this.dm.setField ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "VLR_CANTIDAD_RECURSO", 0 );
      }
      else
      {
        if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "RNBE" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "ACNE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  ) 
        {
          if ( ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) || ( Compare.equals ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "FLG_EMERGENCIA_CORRECTA" ), "E" ) ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_TIPO_RECURSO" ), "EDIF" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_TIPO_RECURSO" ), "TECA" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_TIPO_RECURSO" ), "PERS" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "COD_TIPO_RECURSO" ), "VEH2" ) )  ) 
          {
            RECURSOS_LIQUIDOS = MathService.plus ( RECURSOS_LIQUIDOS, this.dm.getFieldDouble ( this.dm.get ( "RECURSOS_NUCLEO_DSD" ), "VLR_CANTIDAD_RECURSO" )  );
          }
          else
...
//*****
      if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NA" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "RNBE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "ACNE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  ) 
    	      {
...
//*****
      ...
      {
        this.app.setError ( 5, STATUS2_CODE );
      ...
      if ( ( Compare.lt ( EDAD_IND, 18 ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL") )  )
      {
        MENOR_FLG = 1.0;
      }      
    ...
    while ( Compare.equals ( STATUS_CODE, 0 )  )
    {
      ...
      else
      {
        ...
        if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "FLG_FRECUENCIA" ), "S" ) ) 
        {
          ...
          {
            this.dm.setField ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO", this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) * 4.0 );
          }
        }
        else if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "FLG_FRECUENCIA" ), "B" ) ) 
        {
      ...
      if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "RNBE" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "ACNE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  ) 
      {
        ...
        else if ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "NPRO" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "BIAC" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "AGRN" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "BIAS" ) )  )
        {
    ...
    {
      if ( ( Compare.equals ( AGRB_FLG, 1 ) ) && ( Compare.ge ( AGRB_TOT, 461 ) )  ) 
      {
        INGRESO_BRUTO = MathService.minus ( INGRESO_BRUTO, 461  );
        SALARIO = MathService.minus ( SALARIO, 461  );
        AGRB_TOT = 0;
        AGRB_FLG = 0;
      }
      else
    ...
    if ( Compare.gt ( NPRO, 0 ) ) 
    {
      ...
      while ( Compare.equals ( STATUS_CODE, 0 )  )
      {
        if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "PROA" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "PROC" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "ALBE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "ESTU" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "ANCI" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "MEDI" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "CUID" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "OTRO" ) )  && ( ! Compare.equals ( RallyStringService.subString ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), 0, 3 ), "CMN" ) )  && ( ! Compare.equals ( RallyStringService.subString ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), 0, 3 ), "CMY" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "ACNE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  ) 
        {
    ...
    if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) || ( Compare.equals ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "FLG_EMERGENCIA_CORRECTA" ), "E" ) ) ) 
    {
      if ( Compare.ge ( this.app.FCH_SOLIC_SERV_GBL, RallySpanishDatesParser.parseDateString ( "1-MAR-2007" ) ) ) 
      {
        INGRESO_BRUTO = 0;
        RECURSOS_BRUTO = 0;
      }
    ...
    {
      if ( Compare.ge ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getDateItem ( "MES_ANO_BENEFICIO_CORRECTO" ), RallySpanishDatesParser.parseDateString ( "13-MAR-2007" ) ) ) 
      {
        INGRESO_BRUTO = 0;
        RECURSOS_BRUTO = 0;
      }
    ...
    if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) || ( Compare.equals ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "FLG_EMERGENCIA_CORRECTA" ), "E" ) ) ) 
    {
      if ( ( Compare.ge ( this.app.FCH_SOLIC_SERV_GBL, RallySpanishDatesParser.parseDateString ( "1-MAR-2007" ) ) ) && ( Compare.lt ( this.app.FCH_SOLIC_SERV_GBL, RallySpanishDatesParser.parseDateString ( "1-ABR-2007" ) ) )  ) 
      {
        while ( ( Compare.equals ( STATUS_CODE, 0 ) ) && ( Compare.le ( TruncService.lastDay ( this.dm.getFieldDate ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "FECHA_EFECTIVIDAD" ) ) , TruncService.lastDay ( this.app.FCH_SOLIC_SERV_GBL )  ) )   )
        {
      ...
      {
        while ( ( Compare.equals ( STATUS_CODE, 0 ) ) && ( Compare.le ( MathService.plus ( TruncService.lastDay ( this.dm.getFieldDate ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "FECHA_EFECTIVIDAD" ) ) , 1  ), this.app.FCH_SOLIC_SERV_GBL ) )   )
        {
          BENEFICIO = this.dm.getFieldDouble ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "VLR_BENEFICIO_MAXIMO" );
          BENEFICIO_TEMP = this.dm.getFieldDouble ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "VLR_BENEFICIO_MAXIMO" );
          INGRESO_TEMP = this.dm.getFieldDouble ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "VLR_INGRESO_BRUTO" );
    ...
    {
      while ( ( Compare.equals ( STATUS_CODE, 0 ) ) && ( Compare.le ( this.dm.getFieldDate ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "FECHA_EFECTIVIDAD" ), this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getDateItem ( "MES_ANO_BENEFICIO_CORRECTO" )) )   )
      {
        BENEFICIO = this.dm.getFieldDouble ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "VLR_BENEFICIO_MAXIMO" );
        BENEFICIO_TEMP = this.dm.getFieldDouble ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "VLR_BENEFICIO_MAXIMO" );
        INGRESO_TEMP = this.dm.getFieldDouble ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "VLR_INGRESO_BRUTO" );
...
// Apply Exencion Salary 
    ...
    if ( Compare.ge ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getDateItem ( "MES_ANO_BENEFICIO_CORRECTO" ), RallySpanishDatesParser.parseDateString ( "1-MAR-2007" ) ) ) 
    {
//***** START MODS BY J. OLMEDA (KPG INC) 7/17/2009 *****
      //OTROS = MathService.plus ( OTROS, RECURSOS_LIQUIDOS  );
...
//***** END MODS BY J. OLMEDA (KPG INC) 7/17/2009 *****
    ...
    if ( ( Compare.equals ( ANCIANO, 1 ) ) || ( Compare.equals ( INCA_FLG, 1 ) ) || ( Compare.equals ( MENOR_FLG, 1 ) ) ) 
    {
      ...
      while ( Compare.equals ( STATUS_CODE, 0 ) ) 
      {
        ...
        //if ( ( Compare.ge ( EDAD_IND, 60 ) ) && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FLG_INCAPACIDAD_VERIFICADA" ), "N" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NA" ) )  ) 
        if ( ( Compare.ge ( EDAD_IND, 60 ) ) && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FLG_INCAPACIDAD_VERIFICADA" ), "N" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NA" ) )  ) 
        {
        ...
        // Mod by JOR 2/24/2010
        //else if ( ( Compare.ge ( EDAD_IND, 60 ) ) && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FLG_INCAPACIDAD_VERIFICADA" ), "S" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NA" ) )   )
        else if ( ( Compare.ge ( EDAD_IND, 60 ) ) && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FLG_INCAPACIDAD_VERIFICADA" ), "S" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NA" ) )   )
        {
          SAVE_SSN = this.dm.getFieldDouble ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "SEGURO_SOCIAL_CLIENTE" );
          DEDUC_60 = MathService.plus ( DEDUC_60, 100  );
          // Mod by JOR 2/24/2010
        ...
        else if ( ( Compare.lt ( EDAD_IND, 60 ) ) && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FLG_INCAPACIDAD_VERIFICADA" ), "S" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )   )
        {
          SAVE_SSN = this.dm.getFieldDouble ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "SEGURO_SOCIAL_CLIENTE" );
        ...
        else if ( ( Compare.lt ( EDAD_IND, 60 ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FLG_INCAPACIDAD_VERIFICADA" ), "S" ) )  &&  ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_PARENTESCO_FAM" ), "CONY" ) ||Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_PARENTESCO_FAM" ), "JEFE" ) ) && ( Compare.equals ( CONY_FLG, 1 ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) ) )
        {
          SAVE_SSN = this.dm.getFieldDouble ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "SEGURO_SOCIAL_CLIENTE" );
          // Mod by JOR 2/24/2010
          if (  Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) )
        ...
        else if ( ( Compare.lt ( EDAD_IND, 18 ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FLG_INCAPACIDAD_VERIFICADA" ), "S" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )   )
        {
          SAVE_SSN = this.dm.getFieldDouble ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "SEGURO_SOCIAL_CLIENTE" );
          // Mod by JOR 2/24/2010
          if (  Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) )
        ...
        if ( Compare.equals ( STATUS_CODE, 0 ) ) 
        {
          if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "ACNE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  ) 
          {
            ...
            {
            	if ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FLG_INCAPACIDAD_VERIFICADA" ), "S" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )  ) 
                {
                  GASTOS = MathService.plus ( GASTOS, 1  );
                  DEDUC_INCA = MathService.plus ( DEDUC_INCA, 100  );
                }
  ...
  /// Changes Amendment # 3 PAN oct-2008
    ...
    EXENCION_RETP = 0.50;
    if ( ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) ) && ( Compare.equals ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "FLG_EMERGENCIA_CORRECTA" ), "R" ) )  ) 
    {

    if ( Compare.ge ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getDateItem ( "MES_ANO_BENEFICIO_CORRECTO" ), RallySpanishDatesParser.parseDateString ( "1-OCT-2008" ) ) ) 
    {
...
//*****
     ...
     //if ((Compare.ge(MathService.plus(MathService.plus(MathService.plus(MathService.plus(ANCIANO_COUNT, INCAPACITADO_COUNT), MENOR_COUNT), CONY_COUNT), UNIDAD_NCAL), NCAL_COUNT)) && (Compare.lt(MENOR_COUNT, UNIDAD_NCAL)) && (Compare.equals (OTROS,0) )  && (Compare.equals (INGRESO_CONY,0)) )             
     //Mod by JOR an LLM 5/5/2010
     if ((Compare.ge(MathService.plus(MathService.plus(MathService.plus(MathService.plus(ANCIANO_COUNT, INCAPACITADO_COUNT), MENOR_COUNT), CONY_COUNT), NCAL_COUNT),UNIDAD_NCAL )) && (Compare.lt(MENOR_COUNT, UNIDAD_NCAL)) && (Compare.equals (OTROS,0) )  && (Compare.equals (INGRESO_CONY,0)) )             
 //*****
        {
         ...
         else if ( Compare.ge ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getDateItem ( "MES_ANO_BENEFICIO_CORRECTO" ), RallySpanishDatesParser.parseDateString ( "1-OCT-2007" ) ) ) 
            {    
//*****
            //if (Compare.ge(MathService.plus(MathService.plus(ANCIANO_COUNT, INCAPACITADO_COUNT), MENOR_COUNT), NUCLEO) && (Compare.equals (INGRESOS_NUCLEO,SEG_SOC) )   ) 
            if (Compare.ge(MathService.plus(MathService.plus(ANCIANO_COUNT, INCAPACITADO_COUNT), MENOR_COUNT), UNIDAD_NCAL) && (Compare.equals (INGRESOS_NUCLEO,SEG_SOC) )   ) 
//*****
               {       
                 SEG_SOC =  TruncService.round(SEG_SOC*EXENCION_SEG_SOC,2);
               }
            }
    else if ( Compare.ge ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getDateItem ( "MES_ANO_BENEFICIO_CORRECTO" ), RallySpanishDatesParser.parseDateString ( "1-OCT-2004" ) ) ) 
            {    
//*****
            //if (Compare.ge(MathService.plus(ANCIANO_COUNT, INCAPACITADO_COUNT), NUCLEO) && (Compare.equals (INGRESOS_NUCLEO,SEG_SOC) )   ) 
...
//*****
    ...
    while ( Compare.equals ( STATUS_CODE, 0 )  )
    {
      ...
      if ( ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_ESCOLARIDAD" ), "EP1C" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_ESCOLARIDAD" ), "EP2C" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_ESCOLARIDAD" ), "EP3C" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_ESCOLARIDAD" ), "EP4C" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_ESCOLARIDAD" ), "EP5C" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_ESCOLARIDAD" ), "EETV" ) ) ) && ( Compare.lt ( EDAD_IND, 60 ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  ) 
      {
    ...
    while ( Compare.equals ( STATUS_CODE, 0 )  )
    {
      ...
      if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "ACNE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  && ( Compare.lt ( DateUtil.monthsBetween ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getDateItem ( "MES_ANO_BENEFICIO_CORRECTO" ), this.dm.getFieldDate ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FCH_NACIMIENTO" ) ) / 12, 60 ) )  ) 
      {
        if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "CMN1" ) ) 
        {
        ...
        if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "CMN2" ) ) 
        {
          if ( Compare.gt ( this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" ), 400 ) ) 
          {
            CUIDO_MENOR = MathService.plus ( CUIDO_MENOR, 400  );
          }
          else
          {
            CUIDO_MENOR = MathService.plus ( CUIDO_MENOR, this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" )  );
        ...
        if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "CMN3" ) ) 
        {
          if ( Compare.gt ( this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" ), 600 ) ) 
          {
            CUIDO_MENOR = MathService.plus ( CUIDO_MENOR, 600  );
          }
          else
          {
            CUIDO_MENOR = MathService.plus ( CUIDO_MENOR, this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" )  );
        ...
        if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "CMN4" ) ) 
        {
          if ( Compare.gt ( this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" ), 800 ) ) 
          {
            CUIDO_MENOR = MathService.plus ( CUIDO_MENOR, 800  );
          }
          else
          {
            CUIDO_MENOR = MathService.plus ( CUIDO_MENOR, this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" )  );
        ...
        if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "CMY1" ) ) 
        {
          if ( Compare.gt ( this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" ), 175 ) ) 
          {
        ...
        if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "CMY2" ) ) 
        {
          if ( Compare.gt ( this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" ), 350 ) ) 
          {
            CUIDO_MENOR = MathService.plus ( CUIDO_MENOR, 350  );
          }
          else
          {
            CUIDO_MENOR = MathService.plus ( CUIDO_MENOR, this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" )  );
        ...
        if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "CMY3" ) ) 
        {
//***** START MODS BY J. OLMEDA (KPG INC) 7/17/2009 *****
          //if ( Compare.gt ( this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" ), 425 ) ) 
          if ( Compare.gt ( this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" ), 425 ) ) 
          {
            //CUIDO_MENOR = MathService.plus ( CUIDO_MENOR, 425  );
            CUIDO_MENOR = MathService.plus ( CUIDO_MENOR, 525  );
//***** END MODS BY J. OLMEDA (KPG INC) 7/17/2009 *****
          }
          else
          {
        ...
        if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_TIPO_DEDUCCIONE" ), "CMY4" ) ) 
        {
//***** START MODS BY J. OLMEDA (KPG INC) 7/17/2009 *****
          //if ( Compare.gt ( this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" ), 600 ) ) 
          if ( Compare.gt ( this.dm.getFieldDouble ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "VLR_CANTIDAD_DEDUCCIONE" ), 700 ) ) 
          {
            //CUIDO_MENOR = MathService.plus ( CUIDO_MENOR, 600  );
            CUIDO_MENOR = MathService.plus ( CUIDO_MENOR, 700  );
//***** END MODS BY J. OLMEDA (KPG INC) 7/17/2009 *****
          }
          else
          {
    ...
    BENEFICIO_TEMP = 0;
    INGRESO_TEMP = 0;
    if ( ( ( Compare.equals ( ANCIANO, 1 ) ) || ( Compare.equals ( INCA_FLG, 1 ) ) ) && ( Compare.equals ( ELEG_BRUTO_FLG, 0 ) )  ) 
    {
      STATUS_CODE  = this.dm.reset ( OPEN4_ID );
    ...
    {
      if ( Compare.equals ( UNIDAD, 1 ) ) 
      {
        if ( ( Compare.ge ( INGRESO_NETO, 166 ) ) && ( Compare.lt ( INGRESO_NETO, 304 ) )  ) 
        {
          BENEFICIO = 10;
        }
        else
      ...
      if ( Compare.equals ( UNIDAD, 2 ) ) 
      {
        if ( ( Compare.ge ( INGRESO_NETO, 334 ) ) && ( Compare.lt ( INGRESO_NETO, 410 ) )  ) 
        {
          BENEFICIO = 10;
        }
        else
      ...
      if ( Compare.equals ( UNIDAD, 3 ) ) 
      {
        if ( ( Compare.ge ( INGRESO_NETO, 490 ) ) && ( Compare.lt ( INGRESO_NETO, 520 ) )  ) 
        {
          BENEFICIO = 10;
        }
        else
    ...
    if ( ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) && ( Compare.equals ( ELEGIBLE_EMER, "*" ) )  ) || ( Compare.equals ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "FLG_EMERGENCIA_CORRECTA" ), "E" ) ) ) 
    {
  ...
  {
    if ( this._condition0 )    //    if ( ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) && ( Compare.equals ( ELEGIBLE_EMER, "*" ) )  ) || ( Compare.equals ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "FLG_EMERGENCIA_CORRECTA" ), "E" ) ) ) 
    {
...
PROCEDURE DETERMINAR_ELEGIBILIDAD_PAN_3_noupd_adl;
...
OPEN6_ID : NUMBER;
OPEN7_ID : NUMBER;
AJUSTE_PAN_ID : NUMBER;

STATUS_CODE : NUMBER;
STATUS2_CODE : NUMBER;
STATUS7_CODE : NUMBER;
AJUSTE_PAN_STATUS : NUMBER;
...
GASTOS : NUMBER;
ANCIANO_COUNT : NUMBER;
INCAPACITADO_COUNT : NUMBER;
...
CANT_ANCIANO := 0;
COUNTER := 0;
OLD_COD_SERV := COD_SERV_GBL;

IF (DETERMINAR_RECLAMACION_FR.FLG_EMERGENCIA_CORRECTA = 'E') 
then 
     BEGIN
...
{        SERVICIOS2_DSD.fch_AUTORIZACION := DETERMINAR_RECLAMACION_FR.MES_ANO_BE
NEFICIO_CORRECTO;}
        ...
        then
           begin
                   ...
                   COD_SERV_GBL := OLD_COD_SERV;
                   return;
           end;
        {endif}

        WHILE (COUNTER = 0) AND (SERV_STATUS = 0)
        DO BEGIN
IF (SUBSTR(COD_SERV_GBL,0,4)='PANE')  
                THEN
                   BEGIN
                        IF (TRUNC(SERVICIOS2_DSD.FCH_COMIENZO,'MM') = TRUNC(DETE
RMINAR_RECLAMACION_FR.MES_ANO_BENEFICIO_CORRECTO,'MM'))
                        THEN BEGIN
                               COD_SERV_GBL := SERVICIOS2_DSD.COD_SERVICIO;
                                FCH_SOLIC_SERV_GBL := SERVICIOS2_DSD.FCH_SOLICIT
UD;
                                COUNTER := COUNTER + 1;
                             END;
                   END;
                ELSE
                       IF (SERVICIOS2_DSD.COD_SERVICIO = 'PAN')
                        THEN BEGIN
                               COD_SERV_GBL := SERVICIOS2_DSD.COD_SERVICIO;
                                FCH_SOLIC_SERV_GBL := SERVICIOS2_DSD.FCH_SOLICIT
UD;
                             END;
                 DB_GET_NEXT(SERV_ID,SERV_STATUS);
           END;
     ...
     END;
        ...
        DB_OPEN(AJUSTE_PAN_RO_DSD,AJUSTE_PAN_ID,AJUSTE_PAN_STATUS);
...
IF (SUBSTR(COD_SERV_GBL,0,4)='PANE') OR (DETERMINAR_RECLAMACION_FR.FLG_EMERGENCI
A_CORRECTA = 'E') THEN
BEGIN
        ...
        BEGIN
                ...
                DEBUG_LOG('FECHA='||TO_CHAR(DETERMINAR_RECLAMACION_FR.MES_ANO_BE
NEFICIO_CORRECTO));
                DEBUG_LOG('BONO='||TO_CHAR(DETERMINA_RO_DSD.BONO_ANCIANO));
                DEBUG_LOG('STANDARD='||TO_CHAR(DETERMINA_RO_DSD.DEDUCCION_STANDA
RD));
...
{ NUMERO DE PERSONAS EN EL NUCLEO}
        NUCLEO := 0;
...
{ RECURSOS DEL NUCLEO }
        ...
        WHILE STATUS_CODE = 0 DO
        BEGIN
            IF ((SUBSTR(COD_SERV_GBL,0,3)='PAN') AND (RECURSOS_NUCLEO_DSD.FLG_PA
N = 'X')) OR
...
{VERIFICAR % AJUSTE PARA MES CORRIENTE EN RECLAMACION}
IF (DETERMINAR_RECLAMACION_FR.FLG_EMERGENCIA_CORRECTA <> 'E') 
then 
     begin
        DB_RESET(AJUSTE_PAN_ID,AJUSTE_PAN_STATUS);
        AJUSTE_PAN_RO_DSD.MES_PORCIENTO := DETERMINAR_RECLAMACION_FR.MES_ANO_BEN
EFICIO_CORRECTO;
        DB_QUERY(AJUSTE_PAN_ID,AJUSTE_PAN_STATUS);
        DB_GET_FIRST(AJUSTE_PAN_ID,AJUSTE_PAN_STATUS);
        IF AJUSTE_PAN_STATUS <> 0
        THEN
                BEGIN
                   ERROR(507);
                   DETERMINAR_RECLAMACION_FR.AJUSTE_PAN := 0;
        ...
        DETERMINAR_RECLAMACION_FR.AJUSTE_PAN := AJUSTE_PAN_RO_DSD.PORCIENTO;
        DETERMINAR_RECLAMACION_FR.POS_NEG_AJUSTE := AJUSTE_PAN_RO_DSD.AUMENTO_DI
SMINUCION;

{       IF ((DETERMINAR_RECLAMACION_FR.ACCION = 'RECL') or 
           (DETERMINAR_RECLAMACION_FR.ACCION = 'RREC')) and
           (DETERMINAR_RECLAMACION_FR.MES_ANO_BENEFICIO_CORRECTO = to_date('1-DI
C-2000'))
                         then
                                DETERMINAR_RECLAMACION_FR.AJUSTE_PAN := AJUSTE_P
AN_RO_DSD.PORCIENTO+1;
}    end;
...
{       IF STATUS_CODE<>0
        ...
        WHILE STATUS_CODE = 0 DO
        BEGIN
        IF ((SUBSTR(COD_SERV_GBL,0,3)='PAN') AND (RECURSOS_NUCLEO_DSD.FLG_PAN = 
'X')) OR
           ((SUBSTR(COD_SERV_GBL,0,2)='AE') AND (RECURSOS_NUCLEO_DSD.FLG_AE = 'X
'))
        THEN
             RECURSOS_NUCLEO_DSD.VLR_CANTIDAD_RECURSO := 0;
        ELSE 
        BEGIN
             IF (RECURSOS_NUCLEO_DSD.COD_PARENTESCO_RELACION_SERV <> 'RNBE') AND
                (RECURSOS_NUCLEO_DSD.COD_PARENTESCO_RELACION_SERV <> 'ACNE') AND
                (RECURSOS_NUCLEO_DSD.COD_PARENTESCO_RELACION_SERV <> '****')
             THEN
             BEGIN
IF ((SUBSTR(COD_SERV_GBL,0,4)='PANE') OR (DETERMINAR_RECLAMACION_FR.FLG_EMERGENC
IA_CORRECTA = 'E')) AND
...
{ SE VERIFICA LA EXISTENCIA DE ANCINOS }
        ...
        BEGIN
             ...
             THEN
                ...
                END;
             ELSE
                 EDAD_IND := MONTHS_BETWEEN( DETERMINAR_RECLAMACION_FR.MES_ANO_B
ENEFICIO_CORRECTO,CLIENTES_READ_LOC_DSD.FCH_NACIMIENTO)/12;
             IF (EDAD_IND >= 60) AND
        ...
        THEN BEGIN
               IF RECURSOS_ACUM > 3000
                 THEN BEGIN
                        ...
                        DB_CLOSE(AJUSTE_PAN_ID,AJUSTE_PAN_STATUS);
...
THEN BEGIN
        ...
        BEGIN
             IF (GASTOS_NUCLEO_DSD.COD_TIPO_DEDUCCIONE <> 'PROA') AND
                ...
                (GASTOS_NUCLEO_DSD.COD_PARENTESCO_RELACION_SERV <> 'NCAL') AND
...
THEN BEGIN
        ...
        IF FCH_SOLIC_SERV_GBL >= TO_DATE('1-MAR-2007') THEN
           BEGIN
                INGRESO_BRUTO := 0;
                RECURSOS_BRUTO  := 0;
           END;
...
ELSE
     BEGIN
        ...
        IF DETERMINAR_RECLAMACION_FR.MES_ANO_BENEFICIO_CORRECTO >= TO_DATE('13-M
AR-2007') THEN
           BEGIN
                INGRESO_BRUTO := 0;
                RECURSOS_BRUTO  := 0;
...
{ SE COMPARA CONTRA TABLA DE INGRESO BRUTO }
        ...
        IF (SUBSTR(COD_SERV_GBL,0,4)='PANE') OR (DETERMINAR_RECLAMACION_FR.FLG_E
MERGENCIA_CORRECTA = 'E')
        THEN
         BEGIN
            IF (FCH_SOLIC_SERV_GBL >= TO_DATE('1-MAR-2007'))  AND
                (FCH_SOLIC_SERV_GBL < TO_DATE('1-ABR-2007')) THEN
              BEGIN
...
XIMO;
        ...
        ELSE
         BEGIN
                WHILE (STATUS_CODE = 0) AND
 (BENEFICIOS_PAN_RO_DSD.FECHA_EFECTIVIDAD <= DETERMINAR_RECLAMACION_FR.MES_ANO_B
ENEFICIO_CORRECTO) DO
                BEGIN
                        BENEFICIO:= BENEFICIOS_PAN_RO_DSD.VLR_BENEFICIO_MAXIMO;
                        BENEFICIO_TEMP:= BENEFICIOS_PAN_RO_DSD.VLR_BENEFICIO_MAX
IMO;
        ...
        THEN BEGIN
                ...
                ELSE IF DEDUCCION_INGRESO < 100
                       ...
                       ELSE BEGIN
                            ...
                            END;
            END;
        IF DETERMINAR_RECLAMACION_FR.MES_ANO_BENEFICIO_CORRECTO >= TO_DATE('1-MA
R-2007') THEN
               BEGIN
                  OTROS := OTROS + RECURSOS_LIQUIDOS;
               END;
            ING_MENOS_40 := SAL_NET + SEG_SOC + OTROS;
            DEBUG_LOG('SEG_SOC='||TO_CHAR(SEG_SOC));
            DEBUG_LOG('INGRESO_MENOS_40='||TO_CHAR(ING_MENOS_40));
...
L;
                        ...
                        THEN
                           ...
                           END;
                        ELSE
                           EDAD_IND := MONTHS_BETWEEN( DETERMINAR_RECLAMACION_FR
.MES_ANO_BENEFICIO_CORRECTO,CLIENTES_READ_LOC_DSD.FCH_NACIMIENTO)/12;
                        IF (EDAD_IND >= 60) AND 
...
{ DETERMINAR CANTIDAD DE ESTUDIANTES EN EL NUCLEO }
         ...
         BEGIN
             ...
             THEN
                ...
                END;
             ELSE
                EDAD_IND := MONTHS_BETWEEN( DETERMINAR_RECLAMACION_FR.MES_ANO_BE
NEFICIO_CORRECTO,CLIENTES_READ_LOC_DSD.FCH_NACIMIENTO)/12;
...
{ DEDUCCION POR CUIDO DE MENORES }
        ...
        BEGIN
             ...
             DB_QUERY(OPEN2_ID,STATUS2_CODE);
             DB_GET_FIRST(OPEN2_ID,STATUS2_CODE);
             IF (GASTOS_NUCLEO_DSD.COD_PARENTESCO_RELACION_SERV <> 'NCAL') AND
                (GASTOS_NUCLEO_DSD.COD_PARENTESCO_RELACION_SERV <> 'AUTE') AND
                (GASTOS_NUCLEO_DSD.COD_PARENTESCO_RELACION_SERV <> 'ACNE') AND
                (GASTOS_NUCLEO_DSD.COD_PARENTESCO_RELACION_SERV <> '****') AND
                (MONTHS_BETWEEN(DETERMINAR_RECLAMACION_FR.MES_ANO_BENEFICIO_CORR
ECTO,CLIENTES_READ_LOC_DSD.FCH_NACIMIENTO)/12 < 60)
             THEN
                BEGIN
...
{ SE COMPARA CONTRA TABLA DE INGRESO NETO }
        ...
        THEN BEGIN
                ...
                DB_GET_FIRST(OPEN4_ID,STATUS_CODE);
                WHILE (STATUS_CODE = 0) AND
               (BENEFICIOS_PAN_RO_DSD.FECHA_EFECTIVIDAD <=  DETERMINAR_RECLAMACI
ON_FR.MES_ANO_BENEFICIO_CORRECTO) DO
                BEGIN
                        BENEFICIO_TEMP := (BENEFICIOS_PAN_RO_DSD.VLR_BENEFICIO_M
AXIMO);
                        BENEFICIO := (BENEFICIOS_PAN_RO_DSD.VLR_BENEFICIO_MAXIMO
);
...
MO;;
        ...
        ELSE
         BEGIN
                WHILE (STATUS_CODE = 0) AND
                 (BENEFICIOS_PAN_RO_DSD.FECHA_EFECTIVIDAD <= DETERMINAR_RECLAMAC
ION_FR.MES_ANO_BENEFICIO_CORRECTO) DO
                BEGIN
                        BENEFICIO := BENEFICIOS_PAN_RO_DSD.VLR_BENEFICIO_MAXIMO;
                        BENEFICIO_TEMP := (BENEFICIOS_PAN_RO_DSD.VLR_BENEFICIO_M
AXIMO);
...
MP*0.34)+(BONO_ANCIANO * ANCIANO_COUNT);
                        ...
                        THEN BEGIN 
                                ...
                                DETERMINAR_RECLAMACION_FR.BENEFICIO_CALCULADO :=
 0;
                                DETERMINAR_RECLAMACION_FR.INGRESOS := INGRESO_NE
TO;
                                INGRESO_NETO := 0;
                                RETURN;
                             END;
...
AXIMO);
        ...
        THEN BEGIN
            ...
            THEN BEGIN
                 ...
                 END;
        END;
      IF ((SUBSTR(COD_SERV_GBL,0,4)='PANE') OR (DETERMINAR_RECLAMACION_FR.FLG_EM
ERGENCIA_CORRECTA = 'E'))
      THEN ELEGIBLE_EMER:='*';
        ELSE ELEGIBLE_REG := '*';
        AJUSTE_GLB := 0;
        IF ((SUBSTR(COD_SERV_GBL,0,4)='PANE') AND (ELEGIBLE_EMER='*')) or
           (DETERMINAR_RECLAMACION_FR.FLG_EMERGENCIA_CORRECTA = 'E')
        THEN
          begin
         
             CALL AJUSTE_EMERGENCIA_PKT;
             DETERMINAR_RECLAMACION_FR.AJUSTE_PAN := AJUSTE_GLB;
             DETERMINAR_RECLAMACION_FR.POS_NEG_AJUSTE := '+';
          end;
        
        DIA_SOLIC_LV:=TO_NUMBER(TO_CHAR(FCH_SOLIC_SERV_GBL,'DD'));
        DEBUG_LOG(TO_CHAR(AJUSTE_GLB));
        
        IF ((SUBSTR(COD_SERV_GBL,0,4)='PANE') OR (DETERMINAR_RECLAMACION_FR.FLG_
EMERGENCIA_CORRECTA = 'E'))
           { AND (AJUSTE_GLB = 0.0) }
           {SE ELIMINO 26/02/97 AND (AJUSTE_GLB = 0.0)}
{10-14-97 SE CAMBIO LA FORMULA PARA CALCULAR EL BENEFICIO EN PANE SEGUN MANUAL
           ANTERIOR TRUNC(BENEFICIO*AJUSTE_GLB)+ (15
           * ANCIANO_COUNT);}
        THEN
        BEGIN 
        IF (DIA_SOLIC_LV>=1) AND (DIA_SOLIC_LV<=10)
...
NO * ANCIANO_COUNT);
                DETERMINAR_RECLAMACION_FR.BENEFICIO_CALCULADO := BENEFICIO;

        END;
        

        IF (COD_SERV_GBL='PAN') AND  (DETERMINAR_RECLAMACION_FR.FLG_EMERGENCIA_C
ORRECTA = 'R')
            THEN
            BEGIN
{19-7-06 ISP PARA QUE EN LA FORMA DESPLEGARA EL TOTAL DE BENEFICIO CON LA SUMA D
EL
 BONO DE ANCIANO}
               BENEFICIO:=BENEFICIO + (BONO_ANCIANO * ANCIANO_COUNT);  
               DETERMINAR_RECLAMACION_FR.BENEFICIO_CALCULADO := BENEFICIO;
...
{19-7-06 ISP SE COMENTA TODA VEZ REALIZABA LA SUMA DE BONO DE ANCIANO 2 VECES
{ PARA EMERGENCIAS Y PRESENTABA EL AJUSTE DE MAYOR DE 60 AUTOMATICO POR PANTALLA
} 
{CANT_ANCIANO :=  (ANCIANO_COUNT * BONO_ANCIANO);}
        
        {      IF ANCIANO_COUNT > 0 
                THEN
                        DETERMINAR_RECLAMACION_FR.RAZON_AJUSTE_INCORRECTO := 'MA
60';
                ELSE
                        BEGIN
                        DETERMINAR_RECLAMACION_FR.RAZON_AJUSTE_INCORRECTO := '';
                        CANT_ANCIANO := 0;
                       END;}
                {ENDIF}
    {        DETERMINAR_RECLAMACION_FR.BENEFICIO_CALCULADO := BENEFICIO;}
