...
extends ADL
{
	...
	{
		if(Compare.equals(this.app.form ( "PTRA_EMPLEO_FR" ).getStringItem( "TIPO_EXEN" ), "PAN"))
		{
		...
		else if(Compare.equals(this.app.form ( "PTRA_EMPLEO_FR" ).getStringItem( "TIPO_EXEN" ), "TANF"))
		{
			this.app.form ( "PTRA_EMPLEO_FR" ).setItem ( "FECHA_DESDE_EXEN", DateUtil.addMonths (this.app.form ( "PTRA_EMPLEO_FR" ).getDateItem( "FCH_COBRO" ),1 ));
