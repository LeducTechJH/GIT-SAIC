 ...
 */
public class TRANSFER_ENVIADAS_ESTADISTICO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TRANSFER_ENVIADAS_ESTADISTICO_PKT ( )
  {
    super ( "TRANSFER_ENVIADAS_ESTADISTICO_PKT" );
   ...
   *
   */
  public TRANSFER_ENVIADAS_ESTADISTICO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TRANSFER_ENVIADAS_ESTADISTICO_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_ENVIADAS_ESTADISTICO_PKT", pFrame );
  ...
  {
    this.createComponents ( new TRANSFER_ENVIADAS_ESTADISTICO_FR ( ) );
   ...
   *
   */
  public static TRANSFER_ENVIADAS_ESTADISTICO_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_ENVIADAS_ESTADISTICO_PKT ) __app.getNewInstance ( "TRANSFER_ENVIADAS_ESTADISTICO_PKT" );
  }
  ...
  {
    TRANSFER_ENVIADAS_ESTADISTICO_PKT fSheet = TRANSFER_ENVIADAS_ESTADISTICO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_ENVIADAS_ESTADISTICO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_TRANSFER_ENVIADAS_ESTADISTICO_MENU.exec ( app, null );
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; TRANSFER_ENVIADAS_ESTADISTICO_LLENAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
