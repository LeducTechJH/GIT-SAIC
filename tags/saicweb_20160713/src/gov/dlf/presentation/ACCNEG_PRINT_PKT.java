     ...
     extends FormSheet
{
   ...
   *
   */
  public ACCNEG_PRINT_PKT ( )
  {
    super ( "ACCNEG_PRINT_PKT" );
   ...
   *
   */
  public ACCNEG_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ACCNEG_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "ACCNEG_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new ACCNEG_FR ( ) );
   ...
   *
   */
  public static ACCNEG_PRINT_PKT get ( RallyApplication __app )
  {
    return ( ACCNEG_PRINT_PKT ) __app.getNewInstance ( "ACCNEG_PRINT_PKT" );
  }
  ...
  {
    ACCNEG_PRINT_PKT fSheet = ACCNEG_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ACCNEG_PRINT_PKT.exec ( __app );
  }
