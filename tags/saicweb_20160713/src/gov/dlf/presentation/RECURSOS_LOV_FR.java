     ...
     extends Form
{
   ...
   *
   */
  public RECURSOS_LOV_FR ( )
  {
    super ( );
    this.setName ( "RECURSOS_LOV_FR" );

    Debug.println ( Debug.TRACE, "RECURSOS_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RECURSOS_LOV_FR.jdp" );
