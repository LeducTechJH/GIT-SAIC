 ...
 */
public class BEFORE_ACT_RECL_RO_ADL
     extends ADL
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   * @return
   */
  public static BEFORE_ACT_RECL_RO_ADL get ( RallyApplication __app )
  {
    BEFORE_ACT_RECL_RO_ADL adl = new BEFORE_ACT_RECL_RO_ADL ( );
    __app.register ( adl, "BEFORE_ACT_RECL_RO_ADL" );
    __app.setADL ( BEFORE_ACT_RECL_RO_ADL.class, adl ); 
  ...
  {
    BEFORE_ACT_RECL_RO_ADL.get ( __app ).process ( ps );
  }
  ...
  public static void exec ( RallyApplication __app )
  {
    ...
    BEFORE_ACT_RECL_RO_ADL.exec ( __app, ps );
  }
...
public void execute ( ParameterSet parms )
  ...
  public void unregister ( )
  {
    ...
    IRegisteredObject rObj = this.app.get ( "BEFORE_ACT_RECL_RO_ADL" );
    if ( rObj != null && rObj instanceof BEFORE_ACT_RECL_RO_ADL )
    {
      this.app.setADL ( BEFORE_ACT_RECL_RO_ADL.class, ( BEFORE_ACT_RECL_RO_ADL ) rObj );
    }
  }
...
protected void process ( ParameterSet ps )
  {
    Debug.println ( Debug.TRACE, "BEFORE_ACT_RECL_RO_ADL Step " + this.currentStep );
    super.process ( ps );
    switch ( this.currentStep ) 
    {
      ...
      { 
        this.currentStep = 0;
        Debug.println ( Debug.TRACE, "BEFORE_ACT_RECL_RO_ADL ended" );
        this.unregister ( );
        break;
      }
    }
...
procedure before_act_recl_ro_adl;
