     ...
     extends Form
{
   ...
   *
   */
  public PROV_VIG_LOV_FR ( )
  {
    super ( );
    this.setName ( "PROV_VIG_LOV_FR" );

    Debug.println ( Debug.TRACE, "PROV_VIG_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/PROV_VIG_LOV_FR.jdp" );
