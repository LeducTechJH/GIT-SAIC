 ...
 */
public class ANTECEDENTE_CLIENTE_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ANTECEDENTE_CLIENTE_RO_PKT ( )
  {
    super ( "ANTECEDENTE_CLIENTE_RO_PKT" );
   ...
   *
   */
  public ANTECEDENTE_CLIENTE_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ANTECEDENTE_CLIENTE_RO_PKT ( MDIFrame pFrame )
  {
    super ( "ANTECEDENTE_CLIENTE_RO_PKT", pFrame );
   ...
   *
   */
  public static ANTECEDENTE_CLIENTE_RO_PKT get ( RallyApplication __app )
  {
    return ( ANTECEDENTE_CLIENTE_RO_PKT ) __app.getNewInstance ( "ANTECEDENTE_CLIENTE_RO_PKT" );
  }
  ...
  {
    ANTECEDENTE_CLIENTE_RO_PKT fSheet = ANTECEDENTE_CLIENTE_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ANTECEDENTE_CLIENTE_RO_PKT.exec ( __app );
  }
