     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( ( ( Compare.le ( CALCULO_BASES, 0 ) )
    		&& ( Compare.equals ( this.app.ACCION_GBL, "RECL" ) )  )
    		|| ( ( Compare.le ( CALCULO_BASES, 0 ) )
    				&& ( Compare.equals ( this.app.ACCION_GBL, "RREC" ) )  ) 
    				|| ( ( Compare.ge ( CALCULO_BASES, 0 ) ) 
    						&& ( Compare.equals ( this.app.ACCION_GBL, "RETR" ) )  )
    						|| ( ( Compare.ge ( CALCULO_BASES, 0 ) ) 
