 ...
 */
public class ESFU_REFERIDAS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ESFU_REFERIDAS_PKT ( )
  {
    super ( "ESFU_REFERIDAS_PKT" );
   ...
   *
   */
  public ESFU_REFERIDAS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ESFU_REFERIDAS_PKT ( MDIFrame pFrame )
  {
    super ( "ESFU_REFERIDAS_PKT", pFrame );
  ...
  {
    this.createComponents ( new ESFU_REFERIDAS_FRM ( ) );
   ...
   *
   */
  public static ESFU_REFERIDAS_PKT get ( RallyApplication __app )
  {
    return ( ESFU_REFERIDAS_PKT ) __app.getNewInstance ( "ESFU_REFERIDAS_PKT" );
  }
  ...
  {
    ESFU_REFERIDAS_PKT fSheet = ESFU_REFERIDAS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ESFU_REFERIDAS_PKT.exec ( __app );
  }
