 ...
 */
public class ADSEF_TANF_12_A_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ADSEF_TANF_12_A_PKT ( )
  {
    super ( "ADSEF_TANF_12_A_PKT" );
   ...
   *
   */
  public ADSEF_TANF_12_A_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ADSEF_TANF_12_A_PKT ( MDIFrame pFrame )
  {
    super ( "ADSEF_TANF_12_A_PKT", pFrame );
  ...
  {
    this.createComponents ( new ADSEF_TANF_12_A_FR ( ) );
   ...
   *
   */
  public static ADSEF_TANF_12_A_PKT get ( RallyApplication __app )
  {
    return ( ADSEF_TANF_12_A_PKT ) __app.getNewInstance ( "ADSEF_TANF_12_A_PKT" );
  }
  ...
  {
    ADSEF_TANF_12_A_PKT fSheet = ADSEF_TANF_12_A_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ADSEF_TANF_12_A_PKT.exec ( __app );
  }
