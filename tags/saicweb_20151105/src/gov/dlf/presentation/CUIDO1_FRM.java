     ...
     extends Form
{
  ...
  public void setObjectEvents ( )
  {
	    ...
	    this.registerListener ( "CUIDO1_FRM", JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
	    {
	      public boolean eventFired ( String eventName )
	      {
	        app.errorFlag = true; CHECK_SECURITY_CUID.exec ( app ); return app.errorFlag;
	      }
	    } );
  }
}
