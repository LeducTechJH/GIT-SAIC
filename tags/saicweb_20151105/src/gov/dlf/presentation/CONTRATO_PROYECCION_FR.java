...
extends Form
{
	...
	{	    
		...
		this.registerListener ( "DIAS_ASIS", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
		...
		this.registerListener ( "DIAS_ASIS", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				...
				else if (Compare.le(dias_asis, 0) || Compare.equals(dias_asis, ""))
				{
					app.setError("0", "Dias asistidos debe ser distinto de cero (0).");
					app.form ( "CONTRATO_PROYECCION_FR" ).setItem ( "DIAS_ASIS", "");
					app.form ( "CONTRATO_PROYECCION_FR" ).setItem ( "PAGO", 0);
					app.errorFlag = false;
				}
