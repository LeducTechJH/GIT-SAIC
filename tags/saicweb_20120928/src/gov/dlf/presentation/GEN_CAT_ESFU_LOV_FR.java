 ...
 */
public class GEN_CAT_ESFU_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_CAT_ESFU_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_CAT_ESFU_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_CAT_ESFU_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_CAT_ESFU_LOV_FR.jdp" );
