     ...
     extends Form
{
   ...
   *
   */
  public ACC_RETRO_LOV_FR ( )
  {
    super ( );
    this.setName ( "ACC_RETRO_LOV_FR" );

    Debug.println ( Debug.TRACE, "ACC_RETRO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ACC_RETRO_LOV_FR.jdp" );
