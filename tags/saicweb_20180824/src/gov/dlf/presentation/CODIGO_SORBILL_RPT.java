 ...
 */
public class CODIGO_SORBILL_RPT
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CODIGO_SORBILL_RPT ( )
  {
    super ( );
    this.setName ( "CODIGO_SORBILL_RPT" );

    Debug.println ( Debug.TRACE, "CODIGO_SORBILL_RPT - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CODIGO_SORBILL_RPT.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new CODIGO_SORBILL_RPT_USUARIOProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new CODIGO_SORBILL_RPT_OFICINAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "FECHA" );
    field.setValueProvider ( new CODIGO_SORBILL_RPT_FECHAProvider ( this ) );
 ...
 *
 */
class CODIGO_SORBILL_RPT_USUARIOProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public CODIGO_SORBILL_RPT_USUARIOProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class CODIGO_SORBILL_RPT_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CODIGO_SORBILL_RPT_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class CODIGO_SORBILL_RPT_FECHAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CODIGO_SORBILL_RPT_FECHAProvider ( Form form )
  {
    this.model = form;
  }
