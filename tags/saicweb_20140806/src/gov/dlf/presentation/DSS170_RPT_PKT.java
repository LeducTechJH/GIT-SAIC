     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS170_RPT_PKT ( )
  {
    super ( "DSS170_RPT_PKT" );
   ...
   *
   */
  public DSS170_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS170_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "DSS170_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS170_RPT_FR ( ) );
   ...
   *
   */
  public static DSS170_RPT_PKT get ( RallyApplication __app )
  {
    return ( DSS170_RPT_PKT ) __app.getNewInstance ( "DSS170_RPT_PKT" );
  }
  ...
  {
    DSS170_RPT_PKT fSheet = DSS170_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS170_RPT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; DSS170_BFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
