     ...
     extends Form
{
   ...
   *
   */
  public AGENCIA_LOV_FR ( )
  {
    super ( );
    this.setName ( "AGENCIA_LOV_FR" );

    Debug.println ( Debug.TRACE, "AGENCIA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/AGENCIA_LOV_FR.jdp" );
