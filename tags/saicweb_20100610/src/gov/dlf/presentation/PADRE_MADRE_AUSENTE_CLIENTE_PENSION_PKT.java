 ...
 */
public class PADRE_MADRE_AUSENTE_CLIENTE_PENSION_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PADRE_MADRE_AUSENTE_CLIENTE_PENSION_PKT ( )
  {
    super ( "PADRE_MADRE_AUSENTE_CLIENTE_PENSION_PKT" );
   ...
   *
   */
  public PADRE_MADRE_AUSENTE_CLIENTE_PENSION_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PADRE_MADRE_AUSENTE_CLIENTE_PENSION_PKT ( MDIFrame pFrame )
  {
    super ( "PADRE_MADRE_AUSENTE_CLIENTE_PENSION_PKT", pFrame );
  ...
  {
    this.createComponents ( new PADRE_MADRE_AUSENTE_CLIENTE_PENSION_FR ( ) );
   ...
   *
   */
  public static PADRE_MADRE_AUSENTE_CLIENTE_PENSION_PKT get ( RallyApplication __app )
  {
    return ( PADRE_MADRE_AUSENTE_CLIENTE_PENSION_PKT ) __app.getNewInstance ( "PADRE_MADRE_AUSENTE_CLIENTE_PENSION_PKT" );
  }
  ...
  {
    PADRE_MADRE_AUSENTE_CLIENTE_PENSION_PKT fSheet = PADRE_MADRE_AUSENTE_CLIENTE_PENSION_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PADRE_MADRE_AUSENTE_CLIENTE_PENSION_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; PADRE_MADRE_AUSENTE_PENSION_PAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
