 ...
 */
public class STATUS_REC_RPT_A_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public STATUS_REC_RPT_A_PKT ( )
  {
    super ( "STATUS_REC_RPT_A_PKT" );
   ...
   *
   */
  public STATUS_REC_RPT_A_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public STATUS_REC_RPT_A_PKT ( MDIFrame pFrame )
  {
    super ( "STATUS_REC_RPT_A_PKT", pFrame );
  ...
  {
    this.createComponents ( new STATUS_REC_RPT_A_FR ( ) );
   ...
   *
   */
  public static STATUS_REC_RPT_A_PKT get ( RallyApplication __app )
  {
    return ( STATUS_REC_RPT_A_PKT ) __app.getNewInstance ( "STATUS_REC_RPT_A_PKT" );
  }
  ...
  {
    STATUS_REC_RPT_A_PKT fSheet = STATUS_REC_RPT_A_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return STATUS_REC_RPT_A_PKT.exec ( __app );
  }
