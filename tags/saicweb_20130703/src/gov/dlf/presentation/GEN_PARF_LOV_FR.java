     ...
     extends Form
{
   ...
   *
   */
  public GEN_PARF_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_PARF_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_PARF_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_PARF_LOV_FR.jdp" );
