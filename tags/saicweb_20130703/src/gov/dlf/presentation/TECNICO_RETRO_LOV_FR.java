 ...
 */
public class TECNICO_RETRO_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TECNICO_RETRO_LOV_FR ( )
  {
    super ( );
    this.setName ( "TECNICO_RETRO_LOV_FR" );

    Debug.println ( Debug.TRACE, "TECNICO_RETRO_LOV_FR - constructor" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "TECNICO_LOV", new TECNICO_RETRO_LOV_FR_Arguments ( this ) );

    calculator = new TECNICO_RETRO_LOV_FR_NOMBRE_TECNICOCalculator ( this );
 ...
 *
 */
class TECNICO_RETRO_LOV_FR_NOMBRE_TECNICOCalculator implements ICalculator
{
  /**  */
  ...
  /**  */
  public TECNICO_RETRO_LOV_FR_NOMBRE_TECNICOCalculator ( Form form )
  {
    this.model = form;
  }
  ...
  public void calculate ( )
  {
    ...
    RETRO_NOMBRE_TECNICO_ADL.exec ( this.app, null );
  }
}
...
*
*/
class TECNICO_RETRO_LOV_FR_Arguments extends JDataPanelGroupArguments
{
 protected Form model;
 protected SAIC_DMQ_ORA_Application app = null;

 public TECNICO_RETRO_LOV_FR_Arguments ( Form form )
 {
   this.model = form;
