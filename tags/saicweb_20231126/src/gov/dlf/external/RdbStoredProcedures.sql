...
DROP PROCEDURE DOWNLOAD_EPL;
DROP PROCEDURE UPLOAD_EPL;
...
--  CALL SACP540SP_EPL ( :$PARAMETER1, :$PARAMETER2, :$PARAMETER3, :$PARAMETER4 );
...
--  CALL UPLOAD_EPL ( :$PARAMETER1, :$PARAMETER2, :$PARAMETER3, :$PARAMETER4 );
