 ...
 */
public class GET_SSN_INF_REFE_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public GET_SSN_INF_REFE_RPT_PKT ( )
  {
    super ( "GET_SSN_INF_REFE_RPT_PKT" );
   ...
   *
   */
  public GET_SSN_INF_REFE_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GET_SSN_INF_REFE_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "GET_SSN_INF_REFE_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new GET_SSN_INF_REFE_RPT_FRM ( ) );
   ...
   *
   */
  public static GET_SSN_INF_REFE_RPT_PKT get ( RallyApplication __app )
  {
    return ( GET_SSN_INF_REFE_RPT_PKT ) __app.getNewInstance ( "GET_SSN_INF_REFE_RPT_PKT" );
  }
  ...
  {
    GET_SSN_INF_REFE_RPT_PKT fSheet = GET_SSN_INF_REFE_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GET_SSN_INF_REFE_RPT_PKT.exec ( __app );
  }
