     ...
     extends FormSheet
{
   ...
   *
   */
  public OTRPAG_PRN_PKT ( )
  {
    super ( "OTRPAG_PRN_PKT" );
   ...
   *
   */
  public OTRPAG_PRN_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public OTRPAG_PRN_PKT ( MDIFrame pFrame )
  {
    super ( "OTRPAG_PRN_PKT", pFrame );
   ...
   *
   */
  public static OTRPAG_PRN_PKT get ( RallyApplication __app )
  {
    return ( OTRPAG_PRN_PKT ) __app.getNewInstance ( "OTRPAG_PRN_PKT" );
  }
  ...
  {
    OTRPAG_PRN_PKT fSheet = OTRPAG_PRN_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return OTRPAG_PRN_PKT.exec ( __app );
  }
