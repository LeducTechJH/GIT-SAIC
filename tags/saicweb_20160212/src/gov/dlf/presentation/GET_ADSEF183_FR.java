     ...
     extends Form
{
   ...
   *
   */
  public GET_ADSEF183_FR ( )
  {
    super ( );
    this.setName ( "GET_ADSEF183_FR" );

    Debug.println ( Debug.TRACE, "GET_ADSEF183_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_ADSEF183_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; ADSEF183_PERSONA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
