     ...
     extends Form
{
   ...
   *
   */
  public GEN_PARC_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_PARC_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_PARC_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_PARC_LOV_FR.jdp" );
