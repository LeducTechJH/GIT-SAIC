 ...
 */
public class ACC_RECLARETRO_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public ACC_RECLARETRO_LOV_FR ( )
  {
    super ( );
    this.setName ( "ACC_RECLARETRO_LOV_FR" );

    Debug.println ( Debug.TRACE, "ACC_RECLARETRO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ACC_RECLARETRO_LOV_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "GENERAL_LOV_GP", new ACC_RECLARETRO_LOV_FR_GENERAL_LOV_GP_Arguments ( this ) );
 ...
 *
 */
class ACC_RECLARETRO_LOV_FR_GENERAL_LOV_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public ACC_RECLARETRO_LOV_FR_GENERAL_LOV_GP_Arguments ( Form form )
  {
    this.model = form;

    this.setArgName ( "FLGRECLARETRO" );
  }
  ...
  public Object getArgValue ( String argName )
  {
    ...
    else if ( argName.equals ( "FLGRECLARETRO" ) )
    {
      return this.app.getRECLARETRO_ACCION_GBL ( ); // Global Variable
    }
    return null;
  }
}
