 ...
 */
public class ACTUALIZAR_RETRO_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ACTUALIZAR_RETRO_RO_PKT ( )
  {
    super ( "ACTUALIZAR_RETRO_RO_PKT" );
   ...
   *
   */
  public ACTUALIZAR_RETRO_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ACTUALIZAR_RETRO_RO_PKT ( MDIFrame pFrame )
  {
    super ( "ACTUALIZAR_RETRO_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new ACTUALIZAR_RETRO_FR ( ) );
   ...
   *
   */
  public static ACTUALIZAR_RETRO_RO_PKT get ( RallyApplication __app )
  {
    return ( ACTUALIZAR_RETRO_RO_PKT ) __app.getNewInstance ( "ACTUALIZAR_RETRO_RO_PKT" );
  }
  ...
  {
    ACTUALIZAR_RETRO_RO_PKT fSheet = ACTUALIZAR_RETRO_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ACTUALIZAR_RETRO_RO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; BEFORE_ACT_RETR_RO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
