     ...
     extends Form
{
   ...
   *
   */
  public RETRO_AUTORI2_FR ( )
  {
    super ( );
    this.setName ( "RETRO_AUTORI2_FR" );

    Debug.println ( Debug.TRACE, "RETRO_AUTORI2_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RETRO_AUTORI2_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "G1", new RETRO_AUTORI2_FR_G1_Arguments ( this ) );
 ...
 *
 */
class RETRO_AUTORI2_FR_G1_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public RETRO_AUTORI2_FR_G1_Arguments ( Form form )
  {
    this.model = form;
