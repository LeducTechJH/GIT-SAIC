 ...
 */
public class STATUS_REC_RPT_B_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public STATUS_REC_RPT_B_FR ( )
  {
    super ( );
    this.setName ( "STATUS_REC_RPT_B_FR" );

    Debug.println ( Debug.TRACE, "STATUS_REC_RPT_B_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/STATUS_REC_RPT_B_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "G1", new STATUS_REC_RPT_B_FR_G1_Arguments ( this ) );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; STATUS_SET_CURR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class STATUS_REC_RPT_B_FR_G1_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public STATUS_REC_RPT_B_FR_G1_Arguments ( Form form )
  {
    this.model = form;
