			...
			if	( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NA" ) )
			{
						...
						( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  )
				{
							...
							( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "BILV" ) ) )
					{
						...
						//if flag, otra variable salario se usa para calcular lo exento
					}
...
//				INGRESO_TEMP = this.dm.getFieldDouble ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "VLR_INGRESO_BRUTO" );
		...
		if (Compare.ge (this.app.FCH_SOLIC_SERV_GBL, RallySpanishDatesParser.parseDateString ( "1-JAN-2018" ) )
 		 && Compare.le (this.app.FCH_SOLIC_SERV_GBL, RallySpanishDatesParser.parseDateString ( "31-JAN-2018" ) )	
 		 && !(Compare.equals(this.app.RUTINA_GBL, "RR")) )							   
		{  
...
//cambiar tablas nuevas 1-mar-2019			
			if (Compare.ge (this.app.FCH_SOLIC_SERV_GBL, RallySpanishDatesParser.parseDateString ( "1-MAR-2019" ) ))  
			{
				BENEFICIO_TEMP = MathService.minus ( BENEFICIO, TruncService.trunc ( INGRESO_NETO * 0.15 )  );
					...
					{
					BENEFICIO_TEMP = MathService.minus ( BENEFICIO, TruncService.trunc ( INGRESO_NETO * 0.3 )  );
					}
