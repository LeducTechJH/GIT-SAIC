 ...
 */
public class TECNICO_RECLA_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TECNICO_RECLA_LOV_FR ( )
  {
    super ( );
    this.setName ( "TECNICO_RECLA_LOV_FR" );

    Debug.println ( Debug.TRACE, "TECNICO_RECLA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TECNICO_RECLA_LOV_FR.jdp" );
