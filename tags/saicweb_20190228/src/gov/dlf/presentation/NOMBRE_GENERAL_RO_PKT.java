 ...
 */
public class NOMBRE_GENERAL_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public NOMBRE_GENERAL_RO_PKT ( )
  {
    super ( "NOMBRE_GENERAL_RO_PKT" );
   ...
   *
   */
  public NOMBRE_GENERAL_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public NOMBRE_GENERAL_RO_PKT ( MDIFrame pFrame )
  {
    super ( "NOMBRE_GENERAL_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_NOMBRE_GEN_FR ( ) );
   ...
   *
   */
  public static NOMBRE_GENERAL_RO_PKT get ( RallyApplication __app )
  {
    return ( NOMBRE_GENERAL_RO_PKT ) __app.getNewInstance ( "NOMBRE_GENERAL_RO_PKT" );
  }
  ...
  {
    NOMBRE_GENERAL_RO_PKT fSheet = NOMBRE_GENERAL_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return NOMBRE_GENERAL_RO_PKT.exec ( __app );
  }
