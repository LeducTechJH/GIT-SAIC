 ...
 */
public class DECISION_JUNTA_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public DECISION_JUNTA_LOV_FR ( )
  {
    super ( );
    this.setName ( "DECISION_JUNTA_LOV_FR" );

    Debug.println ( Debug.TRACE, "DECISION_JUNTA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DECISION_JUNTA_LOV_FR.jdp" );
