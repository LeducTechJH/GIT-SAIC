 ...
 */
public class CONTROL_PLAN_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CONTROL_PLAN_RPT_PKT ( )
  {
    super ( "CONTROL_PLAN_RPT_PKT" );
   ...
   *
   */
  public CONTROL_PLAN_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CONTROL_PLAN_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "CONTROL_PLAN_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CODIGO_PLAN_TRABAJO_RPT ( ) );
   ...
   *
   */
  public static CONTROL_PLAN_RPT_PKT get ( RallyApplication __app )
  {
    return ( CONTROL_PLAN_RPT_PKT ) __app.getNewInstance ( "CONTROL_PLAN_RPT_PKT" );
  }
  ...
  {
    CONTROL_PLAN_RPT_PKT fSheet = CONTROL_PLAN_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CONTROL_PLAN_RPT_PKT.exec ( __app );
  }
