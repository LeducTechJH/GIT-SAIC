     ...
     extends Form
{
  ...
  public void setApplication ( Application __app )
  {
    ...
    field = ( JDataPanelField ) this.getInDepth ( "CLI" );
    field.setValueProvider ( new PSE_2_FR_CLIProvider ( this ) );
    ...
    field = ( JDataPanelField ) this.getInDepth ( "CLI2" );
    field.setValueProvider ( new PSE_2_FR_CLI2Provider ( this ) );
    ...
    field = ( JDataPanelField ) this.getInDepth ( "VLR_BENEFICIO2" );
    field.setValueProvider ( new PSE_2_FR_VLR_BENEFICIO2Provider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "VLR_BENEFICIO3" );
    field.setValueProvider ( new PSE_2_FR_VLR_BENEFICIO3Provider ( this ) );
...
*
*/
class PSE_2_FR_CLIProvider implements IObjectValueProvider, IObjectValueReceiver 
{
 /**  */
 protected Form model;
 /**  */
 ...
 /**  */
 public PSE_2_FR_CLIProvider ( Form form )
 {
   this.model = form;
   if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
 }
 ...
 {
   if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
   return PSE_2_ADL.getCLI ( this.app );
 }
 ...
 {
   if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
   PSE_2_ADL.setCLI ( this.app, value );
 }
}
...
*
*/
class PSE_2_FR_CLI2Provider implements IObjectValueProvider, IObjectValueReceiver 
{
 /**  */
 protected Form model;
 /**  */
 ...
 /**  */
 public PSE_2_FR_CLI2Provider ( Form form )
 {
   this.model = form;
   if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
 }
 ...
 {
   if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
   return PSE_2_ADL.getCLI2 ( this.app );
 }
 ...
 {
   if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
   PSE_2_ADL.setCLI2 ( this.app, value );
 }
}
...
*
*/
class PSE_2_FR_VLR_BENEFICIO2Provider implements IObjectValueProvider, IObjectValueReceiver 
{
 protected Form model;
 protected SAIC_DMQ_ORA_Application app = null;
 public PSE_2_FR_VLR_BENEFICIO2Provider ( Form form )
 {
   this.model = form;
   if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
 }
 ...
 {
   if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
   return PSE_2_ADL.getVLR_BENEFICIO2( this.app );
 }
 public void setValue ( Object value )
 {
   if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
   PSE_2_ADL.setVLR_BENEFICIO2( this.app, value );
 }
}
/**
*
*/
class PSE_2_FR_VLR_BENEFICIO3Provider implements IObjectValueProvider, IObjectValueReceiver 
{
 protected Form model;
 protected SAIC_DMQ_ORA_Application app = null;
 public PSE_2_FR_VLR_BENEFICIO3Provider ( Form form )
 {
   this.model = form;
   if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
 }
 ...
 {
   if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
   return PSE_2_ADL.getVLR_BENEFICIO3( this.app );
 }
 public void setValue ( Object value )
 {
   if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
   PSE_2_ADL.setVLR_BENEFICIO3( this.app, value );
 }
}
