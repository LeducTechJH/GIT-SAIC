	...
	protected void step1(ParameterSet ps) 
	{
		...
		if ( Compare.equals ( STATUS2_CODE, 0 )  )
		{
			...
			while (Compare.equals(STATUS_CODE, 0)) 
			{
				...
				{
					if (!Compare.equals(this.dm.getFieldDouble( this.dm.get ( "NUCLEO_SERVICIO_DSD" ),"SEGURO_SOCIAL_JEFE_SERV"),this.dm.getFieldDouble(this.dm.get("NUCLEO_SERVICIO_DSD"),"SEGURO_SOCIAL_BENEFICIARIO")))
					{
