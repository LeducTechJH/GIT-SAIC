     ...
     extends Form
{
   ...
   *
   */
  public GET_SC1071_FR ( )
  {
    super ( );
    this.setName ( "GET_SC1071_FR" );

    Debug.println ( Debug.TRACE, "GET_SC1071_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_SC1071_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SC1071_PERSONA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
