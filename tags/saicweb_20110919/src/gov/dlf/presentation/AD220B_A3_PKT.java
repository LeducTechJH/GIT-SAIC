     ...
     extends FormSheet
{
   ...
   *
   */
  public AD220B_A3_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AD220B_A3_PKT ( MDIFrame pFrame )
  {
    super ( "AD220B_A3_PKT", pFrame );
  ...
  {
    this.createComponents ( new AD220B_A3_FR ( ) );
   ...
   *
   */
  public static AD220B_A3_PKT get ( RallyApplication __app )
  {
    return ( AD220B_A3_PKT ) __app.getNewInstance ( "AD220B_A3_PKT" );
  }
  ...
  {
    AD220B_A3_PKT fSheet = AD220B_A3_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return AD220B_A3_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; AD220B1_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; AD220B_INIT_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
