     ...
     extends FormSheet
{
   ...
   *
   */
  public CUIDO1_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CUIDO1_PKT ( MDIFrame pFrame )
  {
    super ( "CUIDO1_PKT", pFrame );
  ...
  {
    this.createComponents ( new CUIDO1_FRM ( ) );
   ...
   *
   */
  public static CUIDO1_PKT get ( RallyApplication __app )
  {
    return ( CUIDO1_PKT ) __app.getNewInstance ( "CUIDO1_PKT" );
  }
  ...
  {
    CUIDO1_PKT fSheet = CUIDO1_PKT.get ( __app );
    fSheet.execute ( null );
