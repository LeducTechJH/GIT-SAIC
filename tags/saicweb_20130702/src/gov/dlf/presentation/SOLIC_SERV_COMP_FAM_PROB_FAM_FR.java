 ...
 */
public class SOLIC_SERV_COMP_FAM_PROB_FAM_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SOLIC_SERV_COMP_FAM_PROB_FAM_FR ( )
  {
    super ( );
    this.setName ( "SOLIC_SERV_COMP_FAM_PROB_FAM_FR" );

    Debug.println ( Debug.TRACE, "SOLIC_SERV_COMP_FAM_PROB_FAM_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SOLIC_SERV_COMP_FAM_PROB_FAM_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "PROB_FAM_GP", new SOLIC_SERV_COMP_FAM_PROB_FAM_FR_PROB_FAM_GP_Arguments ( this ) );
 ...
 *
 */
class SOLIC_SERV_COMP_FAM_PROB_FAM_FR_PROB_FAM_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public SOLIC_SERV_COMP_FAM_PROB_FAM_FR_PROB_FAM_GP_Arguments ( Form form )
  {
    this.model = form;
