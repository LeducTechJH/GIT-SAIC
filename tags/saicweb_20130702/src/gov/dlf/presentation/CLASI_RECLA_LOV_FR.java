 ...
 */
public class CLASI_RECLA_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CLASI_RECLA_LOV_FR ( )
  {
    super ( );
    this.setName ( "CLASI_RECLA_LOV_FR" );

    Debug.println ( Debug.TRACE, "CLASI_RECLA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CLASI_RECLA_LOV_FR.jdp" );
