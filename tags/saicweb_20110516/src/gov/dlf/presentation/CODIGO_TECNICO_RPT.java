 ...
 */
public class CODIGO_TECNICO_RPT
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CODIGO_TECNICO_RPT ( )
  {
    super ( );
    this.setName ( "CODIGO_TECNICO_RPT" );

    Debug.println ( Debug.TRACE, "CODIGO_TECNICO_RPT - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CODIGO_TECNICO_RPT.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new CODIGO_TECNICO_RPT_FECHAProvider ( this ) );
 ...
 *
 */
class CODIGO_TECNICO_RPT_FECHAProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public CODIGO_TECNICO_RPT_FECHAProvider ( Form form )
  {
    this.model = form;
  }
