 ...
 */
public class NUEVO_JEFE_FAMILIA_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public NUEVO_JEFE_FAMILIA_PKT ( )
  {
    super ( "NUEVO_JEFE_FAMILIA_PKT" );
   ...
   *
   */
  public NUEVO_JEFE_FAMILIA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public NUEVO_JEFE_FAMILIA_PKT ( MDIFrame pFrame )
  {
    super ( "NUEVO_JEFE_FAMILIA_PKT", pFrame );
  ...
  {
    this.createComponents ( new NUEVO_JEFE_FAM_FRM ( ) );
   ...
   *
   */
  public static NUEVO_JEFE_FAMILIA_PKT get ( RallyApplication __app )
  {
    return ( NUEVO_JEFE_FAMILIA_PKT ) __app.getNewInstance ( "NUEVO_JEFE_FAMILIA_PKT" );
  }
  ...
  {
    NUEVO_JEFE_FAMILIA_PKT fSheet = NUEVO_JEFE_FAMILIA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return NUEVO_JEFE_FAMILIA_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; NEW_JEFE_SUST_ADL.exec ( app ); return app.errorFlag;
      }
    } );
