 ...
 */
public class TRANSFER_RECIBIDAS_EST_SEL_FECHAS_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TRANSFER_RECIBIDAS_EST_SEL_FECHAS_FR ( )
  {
    super ( );
    this.setName ( "TRANSFER_RECIBIDAS_EST_SEL_FECHAS_FR" );

    Debug.println ( Debug.TRACE, "TRANSFER_RECIBIDAS_EST_SEL_FECHAS_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TRANSFER_RECIBIDAS_EST_SEL_FECHAS_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "FINISH_ACTION", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      { 
        app.errorFlag = true; TRANSFER_RECIBIDAS_ESTADISTICO_ADL.exec ( app ); return app.errorFlag;    
      }
    } );
  }
}
