 ...
 */
public class GET_SSN_QUERY_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public GET_SSN_QUERY_PKT ( )
  {
    super ( "GET_SSN_QUERY_PKT" );
   ...
   *
   */
  public GET_SSN_QUERY_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GET_SSN_QUERY_PKT ( MDIFrame pFrame )
  {
    super ( "GET_SSN_QUERY_PKT", pFrame );
   ...
   *
   */
  public static GET_SSN_QUERY_PKT get ( RallyApplication __app )
  {
    return ( GET_SSN_QUERY_PKT ) __app.getNewInstance ( "GET_SSN_QUERY_PKT" );
  }
  ...
  {
    GET_SSN_QUERY_PKT fSheet = GET_SSN_QUERY_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GET_SSN_QUERY_PKT.exec ( __app );
  }
