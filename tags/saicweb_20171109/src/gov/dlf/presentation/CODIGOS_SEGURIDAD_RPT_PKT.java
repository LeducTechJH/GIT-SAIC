 ...
 */
public class CODIGOS_SEGURIDAD_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CODIGOS_SEGURIDAD_RPT_PKT ( )
  {
    super ( "CODIGOS_SEGURIDAD_RPT_PKT" );
   ...
   *
   */
  public CODIGOS_SEGURIDAD_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CODIGOS_SEGURIDAD_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "CODIGOS_SEGURIDAD_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CODIGOS_SEGURIDAD_RPT ( ) );
   ...
   *
   */
  public static CODIGOS_SEGURIDAD_RPT_PKT get ( RallyApplication __app )
  {
    return ( CODIGOS_SEGURIDAD_RPT_PKT ) __app.getNewInstance ( "CODIGOS_SEGURIDAD_RPT_PKT" );
  }
  ...
  {
    CODIGOS_SEGURIDAD_RPT_PKT fSheet = CODIGOS_SEGURIDAD_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CODIGOS_SEGURIDAD_RPT_PKT.exec ( __app );
  }
