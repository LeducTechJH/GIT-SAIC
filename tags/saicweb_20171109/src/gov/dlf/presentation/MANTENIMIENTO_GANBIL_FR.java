 ...
 */
public class MANTENIMIENTO_GANBIL_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_GANBIL_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_GANBIL_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_GANBIL_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_GANBIL_FR.jdp" );
