     ...
     extends Form
{
   ...
   *
   */
  public GEN_MUNI_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_MUNI_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_MUNI_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_MUNI_LOV_FR.jdp" );
