 ...
 */
public class REGISTRO_EMPLEO_PTRA_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REGISTRO_EMPLEO_PTRA_RO_PKT ( )
  {
    super ( "REGISTRO_EMPLEO_PTRA_RO_PKT" );
   ...
   *
   */
  public REGISTRO_EMPLEO_PTRA_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REGISTRO_EMPLEO_PTRA_RO_PKT ( MDIFrame pFrame )
  {
    super ( "REGISTRO_EMPLEO_PTRA_RO_PKT", pFrame );
   ...
   *
   */
  public static REGISTRO_EMPLEO_PTRA_RO_PKT get ( RallyApplication __app )
  {
    return ( REGISTRO_EMPLEO_PTRA_RO_PKT ) __app.getNewInstance ( "REGISTRO_EMPLEO_PTRA_RO_PKT" );
  }
  ...
  {
    REGISTRO_EMPLEO_PTRA_RO_PKT fSheet = REGISTRO_EMPLEO_PTRA_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REGISTRO_EMPLEO_PTRA_RO_PKT.exec ( __app );
  }
