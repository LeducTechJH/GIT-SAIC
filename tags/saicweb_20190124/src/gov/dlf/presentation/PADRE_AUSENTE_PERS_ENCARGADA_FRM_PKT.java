 ...
 */
public class PADRE_AUSENTE_PERS_ENCARGADA_FRM_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PADRE_AUSENTE_PERS_ENCARGADA_FRM_PKT ( )
  {
    super ( "PADRE_AUSENTE_PERS_ENCARGADA_FRM_PKT" );
   ...
   *
   */
  public PADRE_AUSENTE_PERS_ENCARGADA_FRM_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PADRE_AUSENTE_PERS_ENCARGADA_FRM_PKT ( MDIFrame pFrame )
  {
    super ( "PADRE_AUSENTE_PERS_ENCARGADA_FRM_PKT", pFrame );
  ...
  {
    this.createComponents ( new PADRE_AUSENTE_PERS_ENCARGADA_FRM ( ) );
   ...
   *
   */
  public static PADRE_AUSENTE_PERS_ENCARGADA_FRM_PKT get ( RallyApplication __app )
  {
    return ( PADRE_AUSENTE_PERS_ENCARGADA_FRM_PKT ) __app.getNewInstance ( "PADRE_AUSENTE_PERS_ENCARGADA_FRM_PKT" );
  }
  ...
  {
    PADRE_AUSENTE_PERS_ENCARGADA_FRM_PKT fSheet = PADRE_AUSENTE_PERS_ENCARGADA_FRM_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PADRE_AUSENTE_PERS_ENCARGADA_FRM_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; PERS_ENCARGADA_PAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
