...
function set_editor(objname,userConfig) {
  ...
  var editor = '<span id="_editor_toolbar"><table id="_editor_toolbar_table" border=0 cellspacing=0 cellpadding=0 bgcolor="buttonface" style="padding: 1 0 0 2" width=' + config.width + ' unselectable="on"><tr><td>\n'
  + toolbar
  + '</td></tr></table>\n'
  + '</td></tr></table></span>\n'
...
function editorResize ( objname, w, h )
{
  var elem = document.getElementById ( '_' + objname + '_editor' );
  if ( elem )
  {
    elem.style.width = w;
    elem.style.height = h;
  }
  elem = document.getElementById ( "_editor_toolbar_table" );
  if ( elem )
  {
    elem.style.width = w;
  }
