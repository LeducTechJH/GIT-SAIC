     ...
     extends ADL
{
  ...
  public Date FECHA_DESCA_VENCE = null;
  ...
  {
    return ( ( DETER_ELEG_AEC1_UPDATE_SERV_ADL ) __app.getADL ( DETER_ELEG_AEC1_UPDATE_SERV_ADL.class ) ).NULL_DATE;
  }
  public static void setNULL_DATE  ( RallyApplication __app, Date value )
  {
    ( ( DETER_ELEG_AEC1_UPDATE_SERV_ADL ) __app.getADL ( DETER_ELEG_AEC1_UPDATE_SERV_ADL.class ) ).NULL_DATE = value;
  }
  public static void setNULL_DATE  ( RallyApplication __app, Object value )
  {
    ( ( DETER_ELEG_AEC1_UPDATE_SERV_ADL ) __app.getADL ( DETER_ELEG_AEC1_UPDATE_SERV_ADL.class ) ).NULL_DATE = ( Date ) value;
  }
  public static void setNULL_DATE  ( RallyApplication __app, Parameter value )
  {
    ( ( DETER_ELEG_AEC1_UPDATE_SERV_ADL ) __app.getADL ( DETER_ELEG_AEC1_UPDATE_SERV_ADL.class ) ).NULL_DATE = value.getDate ( );
  }  
  //***** END MODS BY JOR 7/2/2009 *****
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    //***** START MODS BY J. OLMEDA 7/2/2009 *****
	NULL_DATE = TruncService.setNull ( NULL_DATE  );
    //***** END MODS BY J. OLMEDA 7/2/2009 *****
    ...
    this.dm.setField ( this.dm.get ( "SERVICIOS2_DSD" ), "FECHA_EFECTIVIDAD", this.app.FECHA_COBRO_GBL );
    if  ( Compare.lt ( this.app.FECHA_COBRO_GBL, RallySpanishDatesParser.parseDateString ( "1-ABR-2009" ) ) ) 
    {
    	// add three (3) months to the date to compute the expiration date for exemption E100
    	this.app.FECHA_COBRO_GBL = RallySpanishDatesParser.parseDateString ( "1-ABR-2009" );
    }
   
    if  ( Compare.equals ( this.app.TIPO_EXENCION_GBL, "E100")) 
    {
    	// add three (3) months to the date to compute the expiration date for exemption E100
    	this.dm.setField ( this.dm.get ( "SERVICIOS2_DSD" ), "FCH_EXPIRA_EXEN", TruncService.lastDay ( DateUtil.addMonths ( this.app.FECHA_COBRO_GBL, 2 ) ) );
    }
    else if  ( Compare.equals ( this.app.TIPO_EXENCION_GBL, "E075")) 
    {
    	// add nine (9) months to the date to compute the expiration date for exemption e075
    	this.dm.setField ( this.dm.get ( "SERVICIOS2_DSD" ), "FCH_EXPIRA_EXEN", TruncService.lastDay ( DateUtil.addMonths ( this.app.FECHA_COBRO_GBL, 8  ) ) );
    }
    ...
    //***** START MODS BY J. OLMEDA 7/2/2009 *****
    if ( ! Compare.equals ( this.app.FECHA_DESCA_VENCE_GBL, NULL_DATE ) )
    {
	  STATUS_ID  = this.dm.reset ( OPEN_ID );
	  this.dm.setField ( this.dm.get ( "SERVICIOS2_DSD" ), "SEGURO_SOCIAL_JEFE_FAM", this.app.SS_JEFE_GBL );
	  this.dm.setField ( this.dm.get ( "SERVICIOS2_DSD" ), "SEGURO_SOCIAL_JEFE_SERV", this.app.SS_SERV_GBL );
	  ...
	  if ( Compare.equals ( STATUS_ID, 0 ) ) 
	  {
	    ...
	    if ( Compare.equals ( STATUS_ID, 0 ) ) 
	    {
	      if ( Compare.gt ( this.dm.getFieldDate ( this.dm.get ( "SERVICIOS2_DSD" ), "FCH_EXPIRA_EXEN" ), this.app.FECHA_DESCA_VENCE_GBL ) )
	      {
	       	this.dm.setField ( this.dm.get ( "SERVICIOS2_DSD" ), "FCH_EXPIRA_EXEN", this.app.FECHA_DESCA_VENCE_GBL );
	       	STATUS_ID  = this.dm.update ( OPEN_ID );
	        STATUS_ID  = this.dm.dbCommit ( );
	      }
	    }
    ...
    //***** START MODS BY J. OLMEDA 8/14/2009 *****
    else
    {
  	  STATUS_ID  = this.dm.reset ( OPEN_ID );
	  this.dm.setField ( this.dm.get ( "SERVICIOS2_DSD" ), "SEGURO_SOCIAL_JEFE_FAM", this.app.SS_JEFE_GBL );
    ...
    //***** END MODS BY J. OLMEDA 8/14/2009 *****
    //***** END MODS BY J. OLMEDA 7/2/2009 *****
