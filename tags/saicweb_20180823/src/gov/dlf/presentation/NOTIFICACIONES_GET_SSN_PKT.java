 ...
 */
public class NOTIFICACIONES_GET_SSN_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public NOTIFICACIONES_GET_SSN_PKT ( )
  {
    super ( "NOTIFICACIONES_GET_SSN_PKT" );
   ...
   *
   */
  public NOTIFICACIONES_GET_SSN_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public NOTIFICACIONES_GET_SSN_PKT ( MDIFrame pFrame )
  {
    super ( "NOTIFICACIONES_GET_SSN_PKT", pFrame );
  ...
  {
    this.createComponents ( new NOTIFICACIONES_GET_SSN_FR ( ) );
   ...
   *
   */
  public static NOTIFICACIONES_GET_SSN_PKT get ( RallyApplication __app )
  {
    return ( NOTIFICACIONES_GET_SSN_PKT ) __app.getNewInstance ( "NOTIFICACIONES_GET_SSN_PKT" );
  }
  ...
  {
    NOTIFICACIONES_GET_SSN_PKT fSheet = NOTIFICACIONES_GET_SSN_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return NOTIFICACIONES_GET_SSN_PKT.exec ( __app );
  }
