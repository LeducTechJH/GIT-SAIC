 ...
 */
public class MANTENIMIENTO_NOMBRE_GEN_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_NOMBRE_GEN_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_NOMBRE_GEN_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_NOMBRE_GEN_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_NOMBRE_GEN_FR.jdp" );
