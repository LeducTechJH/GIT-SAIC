 ...
 */
public class RECHAZAR_ESFU_MENU
     extends ConfirmationMenu
{
   ...
   *
   */
  public RECHAZAR_ESFU_MENU ( )
  {
    super ( "RECHAZAR_ESFU_MENU" );
    this.setMessage ( "Desea Rechazar este Referido (S/N)?" );
    this.setActions ( new _RECHAZAR_ESFU_MENU ( this ) );
    this.setHelpCode   ( "1" );
    this.setLegendCode ( "" );
   ...
   * @return
   */
  public static RECHAZAR_ESFU_MENU get ( RallyApplication __app )
  {
    return ( RECHAZAR_ESFU_MENU ) __app.getOrNew ( "RECHAZAR_ESFU_MENU" );
  }
  ...
  {
    RECHAZAR_ESFU_MENU confMenu = RECHAZAR_ESFU_MENU.get ( __app );
  ...
  {
    return RECHAZAR_ESFU_MENU.exec ( __app );
  }
