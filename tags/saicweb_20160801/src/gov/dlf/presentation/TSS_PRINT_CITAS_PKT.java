 ...
 */
public class TSS_PRINT_CITAS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TSS_PRINT_CITAS_PKT ( )
  {
    super ( "TSS_PRINT_CITAS_PKT" );
   ...
   *
   */
  public TSS_PRINT_CITAS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TSS_PRINT_CITAS_PKT ( MDIFrame pFrame )
  {
    super ( "TSS_PRINT_CITAS_PKT", pFrame );
  ...
  {
    this.createComponents ( new TSS_PRINT_CITAS_FR ( ) );
   ...
   *
   */
  public static TSS_PRINT_CITAS_PKT get ( RallyApplication __app )
  {
    return ( TSS_PRINT_CITAS_PKT ) __app.getNewInstance ( "TSS_PRINT_CITAS_PKT" );
  }
  ...
  {
    TSS_PRINT_CITAS_PKT fSheet = TSS_PRINT_CITAS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TSS_PRINT_CITAS_PKT.exec ( __app );
  }
