     ...
     extends FormSheet
{
   ...
   *
   */
  public SC724_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SC724_PKT ( MDIFrame pFrame )
  {
    super ( "SC724_PKT", pFrame );
  ...
  {
    this.createComponents ( new SC724_FR ( ) );
   ...
   *
   */
  public static SC724_PKT get ( RallyApplication __app )
  {
    return ( SC724_PKT ) __app.getNewInstance ( "SC724_PKT" );
  }
  ...
  {
    SC724_PKT fSheet = SC724_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; GET_SC724_SET_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SC724_CHECK_RSE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
