     ...
     extends FormSheet
{
   ...
   *
   */
  public AUTPAG2_MENU_PKT ( )
  {
    super ( "AUTPAG2_MENU_PKT" );
   ...
   *
   */
  public AUTPAG2_MENU_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AUTPAG2_MENU_PKT ( MDIFrame pFrame )
  {
    super ( "AUTPAG2_MENU_PKT", pFrame );
  ...
  {
    this.createComponents ( new AUTPAG2_MENU_FR ( ) );
   ...
   *
   */
  public static AUTPAG2_MENU_PKT get ( RallyApplication __app )
  {
    return ( AUTPAG2_MENU_PKT ) __app.getNewInstance ( "AUTPAG2_MENU_PKT" );
  }
  ...
  {
    AUTPAG2_MENU_PKT fSheet = AUTPAG2_MENU_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return AUTPAG2_MENU_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; AUTPAG2_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
