     ...
     extends FormSheet
{
   ...
   *
   */
  public ADSEF_106E_PKT ( )
  {
    super ( "ADSEF_106E_PKT" );
   ...
   *
   */
  public ADSEF_106E_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ADSEF_106E_PKT ( MDIFrame pFrame )
  {
    super ( "ADSEF_106E_PKT", pFrame );
  ...
  {
    this.createComponents ( new ADSEF_106E_FR ( ) );
   ...
   *
   */
  public static ADSEF_106E_PKT get ( RallyApplication __app )
  {
    return ( ADSEF_106E_PKT ) __app.getNewInstance ( "ADSEF_106E_PKT" );
  }
  ...
  {
    ADSEF_106E_PKT fSheet = ADSEF_106E_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ADSEF_106E_PKT.exec ( __app );
  }
