     ...
     extends Form
{
   ...
   *
   */
  public REPORT_6_6_FR ( )
  {
    super ( );
    this.setName ( "REPORT_6_6_FR" );

    Debug.println ( Debug.TRACE, "REPORT_6_6_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REPORT_6_6_FR.jdp" );
  ...
  {
    this.registerListener ( "TECNICO_VAR", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; REPORT_6_6_ADL.exec ( app ); return app.errorFlag;
      }
    } );
