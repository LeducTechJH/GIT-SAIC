 ...
 */
public class CARTA_CERTIFICACION_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CARTA_CERTIFICACION_PKT ( )
  {
    super ( "CARTA_CERTIFICACION_PKT" );
   ...
   *
   */
  public CARTA_CERTIFICACION_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CARTA_CERTIFICACION_PKT ( MDIFrame pFrame )
  {
    super ( "CARTA_CERTIFICACION_PKT", pFrame );
  ...
  {
    this.createComponents ( new CARTA_CERTIFICACION_FR ( ) );
   ...
   *
   */
  public static CARTA_CERTIFICACION_PKT get ( RallyApplication __app )
  {
    return ( CARTA_CERTIFICACION_PKT ) __app.getNewInstance ( "CARTA_CERTIFICACION_PKT" );
  }
  ...
  {
    CARTA_CERTIFICACION_PKT fSheet = CARTA_CERTIFICACION_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CARTA_CERTIFICACION_PKT.exec ( __app );
  }
