 ...
 */
public class INF_SOLICITUDES_PRE_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public INF_SOLICITUDES_PRE_FR ( )
  {
    super ( );
    this.setName ( "INF_SOLICITUDES_PRE_FR" );

    Debug.println ( Debug.TRACE, "INF_SOLICITUDES_PRE_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/INF_SOLICITUDES_PRE_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "FINISH_ACTION", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      { 
        app.errorFlag = true; INF_SOLICITUDES_ADL.exec ( app ); return app.errorFlag;    
