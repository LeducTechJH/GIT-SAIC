 ...
 */
public class TRANSFER_RECIBIDAS_ESTADISTICO_PRE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TRANSFER_RECIBIDAS_ESTADISTICO_PRE_PKT ( )
  {
    super ( "TRANSFER_RECIBIDAS_ESTADISTICO_PRE_PKT" );
   ...
   *
   */
  public TRANSFER_RECIBIDAS_ESTADISTICO_PRE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TRANSFER_RECIBIDAS_ESTADISTICO_PRE_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_RECIBIDAS_ESTADISTICO_PRE_PKT", pFrame );
  ...
  {
    this.createComponents ( new TRANSFER_RECIBIDAS_EST_SEL_FECHAS_FR ( ) );
   ...
   *
   */
  public static TRANSFER_RECIBIDAS_ESTADISTICO_PRE_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_RECIBIDAS_ESTADISTICO_PRE_PKT ) __app.getNewInstance ( "TRANSFER_RECIBIDAS_ESTADISTICO_PRE_PKT" );
  }
  ...
  {
    TRANSFER_RECIBIDAS_ESTADISTICO_PRE_PKT fSheet = TRANSFER_RECIBIDAS_ESTADISTICO_PRE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_RECIBIDAS_ESTADISTICO_PRE_PKT.exec ( __app );
  }
