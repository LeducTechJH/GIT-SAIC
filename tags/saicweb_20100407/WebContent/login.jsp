...
{
  message =  message = "<div style=\"width:70%; font:20px; aligh:left;\"><b>RECORDATORIO: <font color=red>AL ACCEDER ESTE SISTEMA, USTED ESTARÁ APLICANDO CAMBIOS A DOCUMENTOS OFICIALES</font></b><div><div font:20px; aligh:left;\"><b>ATENCION: <font color=blue> LA FECAH DE CORTE DE NOVIEMBRE SE MOVIO PARA EL 29 DE OCTUBRE.  TODOS LOS CASOS DE PAN Y TANF CATEGORIAS A, B Y T SUS PERIODOS DE CERTIFICACION SE EXTENDERAN POR 2 MESES A PARTIR DEL 30 DE OCTUBRE.</font></b><div>";
}
%>
<html>
