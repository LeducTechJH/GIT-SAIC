     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "ASIG_RPT" );

    Debug.println ( Debug.TRACE, "ASIG_RPT - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ASIG_RPT.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new ASIG_RPT_FECHAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "USUARIO" );
    field.setValueProvider ( new ASIG_RPT_USUARIOProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new ASIG_RPT_OFICINAProvider ( this ) );
 ...
 *
 */
class ASIG_RPT_FECHAProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public ASIG_RPT_FECHAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class ASIG_RPT_USUARIOProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ASIG_RPT_USUARIOProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class ASIG_RPT_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ASIG_RPT_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
