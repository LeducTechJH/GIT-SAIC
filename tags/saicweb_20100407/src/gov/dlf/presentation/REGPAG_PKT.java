     ...
     extends FormSheet
{
   ...
   *
   */
  public REGPAG_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REGPAG_PKT ( MDIFrame pFrame )
  {
    super ( "REGPAG_PKT", pFrame );
  ...
  {
    this.createComponents ( new REGPAG_FR ( ) );
   ...
   *
   */
  public static REGPAG_PKT get ( RallyApplication __app )
  {
    return ( REGPAG_PKT ) __app.getNewInstance ( "REGPAG_PKT" );
  }
  ...
  {
    REGPAG_PKT fSheet = REGPAG_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_REGPAG_MENU.exec ( app, null );
 return app.errorFlag;
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; REGPAG_B_NOMBRE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERQUERY, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; REGPAG_LLENAR_NOMBRE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
