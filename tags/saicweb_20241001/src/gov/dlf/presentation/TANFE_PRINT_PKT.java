     ...
     extends FormSheet
{
   ...
   *
   */
  public TANFE_PRINT_PKT ( )
  {
    super ( "TANFE_PRINT_PKT" );
   ...
   *
   */
  public TANFE_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TANFE_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "TANFE_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new TANFE_FR ( ) );
   ...
   *
   */
  public static TANFE_PRINT_PKT get ( RallyApplication __app )
  {
    return ( TANFE_PRINT_PKT ) __app.getNewInstance ( "TANFE_PRINT_PKT" );
  }
  ...
  {
    TANFE_PRINT_PKT fSheet = TANFE_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TANFE_PRINT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; TANFE_PRINT_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
