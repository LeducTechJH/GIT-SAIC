 ...
 */
public class AJUSTE_PAG_RPT_C_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public AJUSTE_PAG_RPT_C_PKT ( )
  {
    super ( "AJUSTE_PAG_RPT_C_PKT" );
   ...
   *
   */
  public AJUSTE_PAG_RPT_C_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AJUSTE_PAG_RPT_C_PKT ( MDIFrame pFrame )
  {
    super ( "AJUSTE_PAG_RPT_C_PKT", pFrame );
  ...
  {
    this.createComponents ( new AJUSTE_PAG_RPT_C_FR ( ) );
   ...
   *
   */
  public static AJUSTE_PAG_RPT_C_PKT get ( RallyApplication __app )
  {
    return ( AJUSTE_PAG_RPT_C_PKT ) __app.getNewInstance ( "AJUSTE_PAG_RPT_C_PKT" );
  }
  ...
  {
    AJUSTE_PAG_RPT_C_PKT fSheet = AJUSTE_PAG_RPT_C_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return AJUSTE_PAG_RPT_C_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; AJUSTE_PAG_RPT_C_BFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
