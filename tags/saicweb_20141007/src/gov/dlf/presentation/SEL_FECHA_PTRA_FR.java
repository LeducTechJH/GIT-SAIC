 ...
 */
public class SEL_FECHA_PTRA_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SEL_FECHA_PTRA_FR ( )
  {
    super ( );
    this.setName ( "SEL_FECHA_PTRA_FR" );

    Debug.println ( Debug.TRACE, "SEL_FECHA_PTRA_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SEL_FECHA_PTRA_FR.jdp" );
