 ...
 */
public class CIUDADANIA_AMER_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CIUDADANIA_AMER_LOV_FR ( )
  {
    super ( );
    this.setName ( "CIUDADANIA_AMER_LOV_FR" );

    Debug.println ( Debug.TRACE, "CIUDADANIA_AMER_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CIUDADANIA_AMER_LOV_FR.jdp" );
