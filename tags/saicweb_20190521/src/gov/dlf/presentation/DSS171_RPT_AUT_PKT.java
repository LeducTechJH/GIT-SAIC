 ...
 */
public class DSS171_RPT_AUT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public DSS171_RPT_AUT_PKT ( )
  {
    super ( "DSS171_RPT_AUT_PKT" );
   ...
   *
   */
  public DSS171_RPT_AUT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS171_RPT_AUT_PKT ( MDIFrame pFrame )
  {
    super ( "DSS171_RPT_AUT_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS171_RPT_FR ( ) );
   ...
   *
   */
  public static DSS171_RPT_AUT_PKT get ( RallyApplication __app )
  {
    return ( DSS171_RPT_AUT_PKT ) __app.getNewInstance ( "DSS171_RPT_AUT_PKT" );
  }
  ...
  {
    DSS171_RPT_AUT_PKT fSheet = DSS171_RPT_AUT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS171_RPT_AUT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; RR_AUT_BFR_DSS171_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
