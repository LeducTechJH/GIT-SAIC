     ...
     extends FormSheet
{
   ...
   *
   */
  public OTRPAG_A1_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public OTRPAG_A1_PKT ( MDIFrame pFrame )
  {
    super ( "OTRPAG_A1_PKT", pFrame );
  ...
  {
    this.createComponents ( new OTRPAG_A1_FR ( ) );
   ...
   *
   */
  public static OTRPAG_A1_PKT get ( RallyApplication __app )
  {
    return ( OTRPAG_A1_PKT ) __app.getNewInstance ( "OTRPAG_A1_PKT" );
  }
  ...
  {
    OTRPAG_A1_PKT fSheet = OTRPAG_A1_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return OTRPAG_A1_PKT.exec ( __app );
  }
