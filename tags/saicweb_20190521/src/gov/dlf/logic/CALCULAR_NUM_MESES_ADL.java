     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( ( Compare.equals ( RallyStringService.subString ( this.app.form ( "COMPROMISO_PAGO_RECLA_FR" ).getStringItem ( "COD_SERVICIO" ), 0, 2 ), "LI" ) || Compare.equals ( RallyStringService.subString ( this.app.form ( "COMPROMISO_PAGO_RECLA_FR" ).getStringItem ( "COD_SERVICIO" ), 0, 4 ), "CLIM" )) && ( Compare.gt ( this.app.form ( "COMPROMISO_PAGO_RECLA_FR" ).getDoubleItem ( "NUM_MESES_DEDUCIR" ), 12 ) )  && ( Compare.equals ( this.app.form ( "COMPROMISO_PAGO_RECLA_FR" ).getStringItem ( "METODO_PAGO" ), "PLPA" ) )  ) 
    {
