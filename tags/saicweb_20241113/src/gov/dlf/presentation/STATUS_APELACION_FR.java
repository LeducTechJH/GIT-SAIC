 ...
 */
public class STATUS_APELACION_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public STATUS_APELACION_FR ( )
  {
    super ( );
    this.setName ( "STATUS_APELACION_FR" );

    Debug.println ( Debug.TRACE, "STATUS_APELACION_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/STATUS_APELACION_FR.jdp" );
