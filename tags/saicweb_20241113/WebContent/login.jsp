 ...
 {	
						...
						if (data[0] != null)
						 {
							isLock = true;
					 		...
					 		if (sampleid != undefined)
					 			{
									alert("Tiene una muestra de RMS pendiente. Favor de verificar su correo electronico y llenar la muestra para resumir trabajando con SAIC.");
	...
	function applicationResponseHandler(root) {
		...
		if (command == "start") {
			...
			var isLock = false; // checkRMS_LOCK(userName);
			...
			if (message != null) {
				alert(message.indexOf("ORA-28000"));
				...
				if (message.indexOf("ORA-01017") == 0) {
					...
					var userName = getElementValue("userName").replace(
							/^\s+|\s+$/g, "");
