 ...
 */
public class MANTENIMIENTO_REMOVER_CLIENTE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_REMOVER_CLIENTE_PKT ( )
  {
    super ( "MANTENIMIENTO_REMOVER_CLIENTE_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_REMOVER_CLIENTE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_REMOVER_CLIENTE_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_REMOVER_CLIENTE_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_REMOVER_CLIENTE_FRM ( ) );
   ...
   *
   */
  public static MANTENIMIENTO_REMOVER_CLIENTE_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_REMOVER_CLIENTE_PKT ) __app.getNewInstance ( "MANTENIMIENTO_REMOVER_CLIENTE_PKT" );
  }
  ...
  {
    MANTENIMIENTO_REMOVER_CLIENTE_PKT fSheet = MANTENIMIENTO_REMOVER_CLIENTE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_REMOVER_CLIENTE_PKT.exec ( __app );
  }
