 ...
 */
public class SOLIC_SERV_PROG_POTENCIAL_UPD_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SOLIC_SERV_PROG_POTENCIAL_UPD_PKT ( )
  {
    super ( "SOLIC_SERV_PROG_POTENCIAL_UPD_PKT" );
   ...
   *
   */
  public SOLIC_SERV_PROG_POTENCIAL_UPD_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SOLIC_SERV_PROG_POTENCIAL_UPD_PKT ( MDIFrame pFrame )
  {
    super ( "SOLIC_SERV_PROG_POTENCIAL_UPD_PKT", pFrame );
   ...
   *
   */
  public static SOLIC_SERV_PROG_POTENCIAL_UPD_PKT get ( RallyApplication __app )
  {
    return ( SOLIC_SERV_PROG_POTENCIAL_UPD_PKT ) __app.getNewInstance ( "SOLIC_SERV_PROG_POTENCIAL_UPD_PKT" );
  }
  ...
  {
    SOLIC_SERV_PROG_POTENCIAL_UPD_PKT fSheet = SOLIC_SERV_PROG_POTENCIAL_UPD_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SOLIC_SERV_PROG_POTENCIAL_UPD_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.BEFORECOMMIT, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SOLIC_SERV_COMPLETAR_SOLIC_ADL.exec ( app ); return app.errorFlag;
      }
    } );
