 ...
 */
public class AJUSTE_EMERGENCIA_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public AJUSTE_EMERGENCIA_PKT ( )
  {
    super ( "AJUSTE_EMERGENCIA_PKT" );
   ...
   *
   */
  public AJUSTE_EMERGENCIA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AJUSTE_EMERGENCIA_PKT ( MDIFrame pFrame )
  {
    super ( "AJUSTE_EMERGENCIA_PKT", pFrame );
  ...
  {
    this.createComponents ( new AJUSTE_EMERGENCIA_FR ( ) );
   ...
   *
   */
  public static AJUSTE_EMERGENCIA_PKT get ( RallyApplication __app )
  {
    return ( AJUSTE_EMERGENCIA_PKT ) __app.getNewInstance ( "AJUSTE_EMERGENCIA_PKT" );
  }
  ...
  {
    AJUSTE_EMERGENCIA_PKT fSheet = AJUSTE_EMERGENCIA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return AJUSTE_EMERGENCIA_PKT.exec ( __app );
  }
