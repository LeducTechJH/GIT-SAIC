     ...
     extends Form
{
   ...
   *
   */
  public SEL_RMO_LOV_FR ( )
  {
    super ( );
    this.setName ( "SEL_RMO_LOV_FR" );

    Debug.println ( Debug.TRACE, "SEL_RMO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SEL_RMO_LOV_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "RMO_LOVE_GP1", new SEL_RMO_LOV_FR_RMO_LOVE_GP1_Arguments ( this ) );
 ...
 *
 */
class SEL_RMO_LOV_FR_RMO_LOVE_GP1_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public SEL_RMO_LOV_FR_RMO_LOVE_GP1_Arguments ( Form form )
  {
    this.model = form;

    this.setArgName ( "RMO_PARM" );
  }
  ...
  public Object getArgValue ( String argName )
  {
    ...
    else if ( argName.equals ( "RMO_PARM" ) )
    {
