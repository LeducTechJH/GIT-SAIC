...
extends ADL
{
	...
	{
		//CALCULAR EXENCIONES 
		if(Compare.equals(this.app.form ( "PTRA_EMPLEO_FR" ).getStringItem( "TIPO_EXEN" ), "EPAN"))
		{
			...
			this.app.form ( "PTRA_EMPLEO_FR" ).setItem ( "FECHA_HASTA_EXEN", DateUtil.addMonths (this.app.form ( "PTRA_EMPLEO_FR" ).getDateItem( "FCH_COBRO" ),12 ));
		}
		else if(Compare.equals(this.app.form ( "PTRA_EMPLEO_FR" ).getStringItem( "TIPO_EXEN" ), "ETNF"))
		{
			this.app.form ( "PTRA_EMPLEO_FR" ).setItem ( "FECHA_DESDE_EXEN", DateUtil.addMonths (this.app.form ( "PTRA_EMPLEO_FR" ).getDateItem( "FCH_COBRO" ),1 ));
