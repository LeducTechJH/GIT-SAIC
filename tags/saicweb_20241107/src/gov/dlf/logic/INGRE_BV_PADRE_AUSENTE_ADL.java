	  ...
	  while ( Compare.equals ( STATUS5_CODE, 0 )  )
	  {
	    ...
	    if ( ( codServicio.startsWith("PAN") ) || ( Compare.equals ( codServicio, "AE-C" ) ) ) 
	    {
	      ...
	      while ( Compare.equals ( STATUS6_CODE, 0 )  )
	      {
	        ...
	        if( (codStatusServicio.equals("ACTIVO")) || (codStatusServicio.equals("PENDCERT")) || (codStatusServicio.equals("PENDREVI")) || (codStatusServicio.equals("PENDAUTO")) || (codStatusServicio.equals("ACCNEG")) || (codStatusServicio.equals("JUNTAMED")) || (codStatusServicio.equals("PENDJMED")) )
	        {
