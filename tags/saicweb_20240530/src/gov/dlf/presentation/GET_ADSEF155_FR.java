     ...
     extends Form
{
   ...
   *
   */
  public GET_ADSEF155_FR ( )
  {
    super ( );
    this.setName ( "GET_ADSEF155_FR" );

    Debug.println ( Debug.TRACE, "GET_ADSEF155_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_ADSEF155_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; ADSEF155_PERSONA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
