     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS108_A1_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS108_A1_PKT ( MDIFrame pFrame )
  {
    super ( "DSS108_A1_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS108_A1_FR ( ) );
   ...
   *
   */
  public static DSS108_A1_PKT get ( RallyApplication __app )
  {
    return ( DSS108_A1_PKT ) __app.getNewInstance ( "DSS108_A1_PKT" );
  }
  ...
  {
    DSS108_A1_PKT fSheet = DSS108_A1_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS108_A1_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; DSS108_A1_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
