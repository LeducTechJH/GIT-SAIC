     ...
     extends Form
{
   ...
   *
   */
  public SEL_SSN_PTRA_FR ( )
  {
    super ( );
    this.setName ( "SEL_SSN_PTRA_FR" );

    Debug.println ( Debug.TRACE, "SEL_SSN_PTRA_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SEL_SSN_PTRA_FR.jdp" );
