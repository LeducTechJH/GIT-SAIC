     ...
     extends FormSheet
{
   ...
   *
   */
  public INFOR_BIO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INFOR_BIO_PKT ( MDIFrame pFrame )
  {
    super ( "INFOR_BIO_PKT", pFrame );
   ...
   *
   */
  public static INFOR_BIO_PKT get ( RallyApplication __app )
  {
    return ( INFOR_BIO_PKT ) __app.getNewInstance ( "INFOR_BIO_PKT" );
  }
  ...
  {
    INFOR_BIO_PKT fSheet = INFOR_BIO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INFOR_BIO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; ADSEF_PPT1_ADL.exec ( app ); return app.errorFlag;
      }
    } );
