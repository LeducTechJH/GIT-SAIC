...
//				STATUS_CODE = this.dm.reset(OPEN8_ID);
...
//
//				STATUS_CODE = this.dm.limitQueryFromBuffer(OPEN8_ID);
//				STATUS_CODE = this.dm.retrieve(OPEN8_ID);
//				STATUS_CODE = this.dm.firstRow(OPEN8_ID);
//
//				while (Compare.equals(STATUS_CODE, 0)) 
//				{
//					this.dm.setField ( this.dm.get ( "SERVICIOS2_DSD" ), "FCH_CERRADO", this.app.SYSTEM_DATE);
//
//					STATUS_CODE = this.dm.update(OPEN8_ID);
//					STATUS_CODE = this.dm.nextRow(OPEN8_ID);
//				}
