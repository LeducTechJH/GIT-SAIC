 ...
 */
public class OTRPAG_A3_SUB_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public OTRPAG_A3_SUB_PKT ( )
  {
    super ( "OTRPAG_A3_SUB_PKT" );
   ...
   *
   */
  public OTRPAG_A3_SUB_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public OTRPAG_A3_SUB_PKT ( MDIFrame pFrame )
  {
    super ( "OTRPAG_A3_SUB_PKT", pFrame );
   ...
   *
   */
  public static OTRPAG_A3_SUB_PKT get ( RallyApplication __app )
  {
    return ( OTRPAG_A3_SUB_PKT ) __app.getNewInstance ( "OTRPAG_A3_SUB_PKT" );
  }
  ...
  {
    OTRPAG_A3_SUB_PKT fSheet = OTRPAG_A3_SUB_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return OTRPAG_A3_SUB_PKT.exec ( __app );
  }
