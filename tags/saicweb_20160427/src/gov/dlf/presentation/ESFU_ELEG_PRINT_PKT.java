 ...
 */
public class ESFU_ELEG_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ESFU_ELEG_PRINT_PKT ( )
  {
    super ( "ESFU_ELEG_PRINT_PKT" );
   ...
   *
   */
  public ESFU_ELEG_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ESFU_ELEG_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "ESFU_ELEG_PRINT_PKT", pFrame );
   ...
   *
   */
  public static ESFU_ELEG_PRINT_PKT get ( RallyApplication __app )
  {
    return ( ESFU_ELEG_PRINT_PKT ) __app.getNewInstance ( "ESFU_ELEG_PRINT_PKT" );
  }
  ...
  {
    ESFU_ELEG_PRINT_PKT fSheet = ESFU_ELEG_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ESFU_ELEG_PRINT_PKT.exec ( __app );
  }
