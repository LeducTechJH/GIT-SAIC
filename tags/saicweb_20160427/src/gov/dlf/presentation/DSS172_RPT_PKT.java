     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS172_RPT_PKT ( )
  {
    super ( "DSS172_RPT_PKT" );
   ...
   *
   */
  public DSS172_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS172_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "DSS172_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS172_FR ( ) );
   ...
   *
   */
  public static DSS172_RPT_PKT get ( RallyApplication __app )
  {
    return ( DSS172_RPT_PKT ) __app.getNewInstance ( "DSS172_RPT_PKT" );
  }
  ...
  {
    DSS172_RPT_PKT fSheet = DSS172_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS172_RPT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; DSS172_BFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
