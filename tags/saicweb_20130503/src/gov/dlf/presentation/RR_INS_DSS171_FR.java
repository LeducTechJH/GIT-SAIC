     ...
     extends Form
{
   ...
   *
   */
  public RR_INS_DSS171_FR ( )
  {
    super ( );
    this.setName ( "RR_INS_DSS171_FR" );

    Debug.println ( Debug.TRACE, "RR_INS_DSS171_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RR_INS_DSS171_FR.jdp" );
