 ...
 */
public class BUSCAR_POR_SOUNDEX_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public BUSCAR_POR_SOUNDEX_FR ( )
  {
    super ( );
    this.setName ( "BUSCAR_POR_SOUNDEX_FR" );

    Debug.println ( Debug.TRACE, "BUSCAR_POR_SOUNDEX_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/BUSCAR_POR_SOUNDEX_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "BUSCAR_POR_NOMBRE_GP", new BUSCAR_POR_SOUNDEX_FR_BUSCAR_POR_NOMBRE_GP_Arguments ( this ) );
 ...
 *
 */
class BUSCAR_POR_SOUNDEX_FR_BUSCAR_POR_NOMBRE_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public BUSCAR_POR_SOUNDEX_FR_BUSCAR_POR_NOMBRE_GP_Arguments ( Form form )
  {
    this.model = form;

    this.setArgName ( "SOUNDEX_PAR" );
  ...
  public Object getArgValue ( String argName )
  {
    ...
    else if ( argName.equals ( "SOUNDEX_PAR" ) )
    {
      return this.app.getSOUNDEX_GBL ( ); // Global Variable
    }
