 ...
 */
public class REPORT_9_10_PPKT0 
  implements IRegisteredObject 
{
   ...
   *
   */
  public static REPORT_9_10_PPKT0 get ( RallyApplication __app )
  {
    REPORT_9_10_PPKT0 pp = ( REPORT_9_10_PPKT0 ) __app.getNewInstance ( "REPORT_9_10_PPKT0" );
    return pp;
  }
  ...
  {
    return REPORT_9_10_PPKT0.exec ( __app );
  }
  ...
  {
    Debug.println ( Debug.TRACE, "REPORT_9_10_PPKT0" );
    this.prepareParms ( );
  ...
  {
    this.app.form ( "REPORT_9_10A_FR" ).setValue ( "COD_REVISION", this.parms.getString ( 0 ) );
    this.app.form ( "REPORT_9_10A_FR" ).setValue ( "NO_REVISION", this.parms.getString ( 1 ) );
  }
  ...
  {
    this.parms.reset ( );
    this.parms.set ( this.app.form ( "REPORT_9_10A_FR" ).getValue ( "COD_REVISION" ) );
    this.parms.set ( this.app.form ( "REPORT_9_10A_FR" ).getValue ( "NO_REVISION" ) );
  }
