 ...
 */
public class LISTA_REFERIDO_FRAUDE_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public LISTA_REFERIDO_FRAUDE_FRM ( )
  {
    super ( );
    this.setName ( "LISTA_REFERIDO_FRAUDE_FRM" );

    Debug.println ( Debug.TRACE, "LISTA_REFERIDO_FRAUDE_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/LISTA_REFERIDO_FRAUDE_FRM.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "RECLAMACIONES_REFERIDAS_GRP", new LISTA_REFERIDO_FRAUDE_FRM_RECLAMACIONES_REFERIDAS_GRP_Arguments ( this ) );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "RECLAMACIONES_REFERIDAS_GRP", JDataPanelListener.HOTKEYPRESS, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SELECCION_REFERIDO_FRAUDE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class LISTA_REFERIDO_FRAUDE_FRM_RECLAMACIONES_REFERIDAS_GRP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public LISTA_REFERIDO_FRAUDE_FRM_RECLAMACIONES_REFERIDAS_GRP_Arguments ( Form form )
  {
    this.model = form;
