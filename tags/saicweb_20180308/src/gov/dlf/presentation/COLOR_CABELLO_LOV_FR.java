 ...
 */
public class COLOR_CABELLO_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public COLOR_CABELLO_LOV_FR ( )
  {
    super ( );
    this.setName ( "COLOR_CABELLO_LOV_FR" );

    Debug.println ( Debug.TRACE, "COLOR_CABELLO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/COLOR_CABELLO_LOV_FR.jdp" );
