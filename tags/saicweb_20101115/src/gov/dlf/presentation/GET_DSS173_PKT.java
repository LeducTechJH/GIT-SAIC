     ...
     extends FormSheet
{
   ...
   *
   */
  public GET_DSS173_PKT ( )
  {
    super ( "GET_DSS173_PKT" );
   ...
   *
   */
  public GET_DSS173_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GET_DSS173_PKT ( MDIFrame pFrame )
  {
    super ( "GET_DSS173_PKT", pFrame );
  ...
  {
    this.createComponents ( new GET_DSS173_FR ( ) );
   ...
   *
   */
  public static GET_DSS173_PKT get ( RallyApplication __app )
  {
    return ( GET_DSS173_PKT ) __app.getNewInstance ( "GET_DSS173_PKT" );
  }
  ...
  {
    GET_DSS173_PKT fSheet = GET_DSS173_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GET_DSS173_PKT.exec ( __app );
  }
