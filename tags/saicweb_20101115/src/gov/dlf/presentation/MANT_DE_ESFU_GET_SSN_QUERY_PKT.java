 ...
 */
public class MANT_DE_ESFU_GET_SSN_QUERY_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANT_DE_ESFU_GET_SSN_QUERY_PKT ( )
  {
    super ( "MANT_DE_ESFU_GET_SSN_QUERY_PKT" );
   ...
   *
   */
  public MANT_DE_ESFU_GET_SSN_QUERY_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANT_DE_ESFU_GET_SSN_QUERY_PKT ( MDIFrame pFrame )
  {
    super ( "MANT_DE_ESFU_GET_SSN_QUERY_PKT", pFrame );
   ...
   *
   */
  public static MANT_DE_ESFU_GET_SSN_QUERY_PKT get ( RallyApplication __app )
  {
    return ( MANT_DE_ESFU_GET_SSN_QUERY_PKT ) __app.getNewInstance ( "MANT_DE_ESFU_GET_SSN_QUERY_PKT" );
  }
  ...
  {
    MANT_DE_ESFU_GET_SSN_QUERY_PKT fSheet = MANT_DE_ESFU_GET_SSN_QUERY_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANT_DE_ESFU_GET_SSN_QUERY_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.BEFOREQUIT, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; MANT_DE_ESFU_SET_FAILURE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
