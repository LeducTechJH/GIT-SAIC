 ...
 */
public class GEN_TIPO_REGISTRO_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_TIPO_REGISTRO_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_TIPO_REGISTRO_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_TIPO_REGISTRO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_TIPO_REGISTRO_LOV_FR.jdp" );
