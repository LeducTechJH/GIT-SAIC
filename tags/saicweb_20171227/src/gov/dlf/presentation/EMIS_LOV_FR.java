     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "EMIS_LOV_FR" );

    Debug.println ( Debug.TRACE, "EMIS_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/EMIS_LOV_FR.jdp" );
