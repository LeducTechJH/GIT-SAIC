 ...
 */
public class MANTENIMIENTO_NOTIFIC_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_NOTIFIC_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_NOTIFIC_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_NOTIFIC_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_NOTIFIC_FR.jdp" );
