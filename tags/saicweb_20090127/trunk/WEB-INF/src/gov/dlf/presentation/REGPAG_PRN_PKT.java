     ...
     extends FormSheet
{
   ...
   *
   */
  public REGPAG_PRN_PKT ( )
  {
    super ( "REGPAG_PRN_PKT" );
   ...
   *
   */
  public REGPAG_PRN_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REGPAG_PRN_PKT ( MDIFrame pFrame )
  {
    super ( "REGPAG_PRN_PKT", pFrame );
  ...
  {
    this.createComponents ( new REGPAG_PRN_FR ( ) );
   ...
   *
   */
  public static REGPAG_PRN_PKT get ( RallyApplication __app )
  {
    return ( REGPAG_PRN_PKT ) __app.getNewInstance ( "REGPAG_PRN_PKT" );
  }
  ...
  {
    REGPAG_PRN_PKT fSheet = REGPAG_PRN_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REGPAG_PRN_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        return true;
        //app.errorFlag = true; REGPAG_PRN_PKT_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
