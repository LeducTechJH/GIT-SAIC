     ...
     extends Form
{
   ...
   *
   */
  public DSS171_RPT_FR ( )
  {
    super ( );
    this.setName ( "DSS171_RPT_FR" );

    Debug.println ( Debug.TRACE, "DSS171_RPT_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DSS171_RPT_FR.jdp" );
