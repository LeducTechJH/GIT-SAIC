 ...
 */
public class ENTREVISTA_BLANCO_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public ENTREVISTA_BLANCO_FR ( )
  {
    super ( );
    this.setName ( "ENTREVISTA_BLANCO_FR" );

    Debug.println ( Debug.TRACE, "ENTREVISTA_BLANCO_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ENTREVISTA_BLANCO_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "CONTESTACION_FR", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SET_GBL_PPKT.exec ( app, null ); return app.errorFlag;
      }
    } );
