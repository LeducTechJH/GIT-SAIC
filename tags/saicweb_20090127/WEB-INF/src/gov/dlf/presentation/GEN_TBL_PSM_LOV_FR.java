 ...
 */
public class GEN_TBL_PSM_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_TBL_PSM_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_TBL_PSM_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_TBL_PSM_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_TBL_PSM_LOV_FR.jdp" );
