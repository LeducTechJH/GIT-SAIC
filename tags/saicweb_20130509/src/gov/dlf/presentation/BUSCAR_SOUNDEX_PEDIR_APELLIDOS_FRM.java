 ...
 */
public class BUSCAR_SOUNDEX_PEDIR_APELLIDOS_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public BUSCAR_SOUNDEX_PEDIR_APELLIDOS_FRM ( )
  {
    super ( );
    this.setName ( "BUSCAR_SOUNDEX_PEDIR_APELLIDOS_FRM" );

    Debug.println ( Debug.TRACE, "BUSCAR_SOUNDEX_PEDIR_APELLIDOS_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/BUSCAR_SOUNDEX_PEDIR_APELLIDOS_FRM.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "DSC_APELLIDO_PATERNO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; INIT_VALUES_SOUNDEX_ADL.exec ( app ); return app.errorFlag;
      }
    } );
