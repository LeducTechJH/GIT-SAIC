     ...
     extends FormSheet
{
   ...
   *
   */
  public PTRA_EMPLEO_PKT ( )
  {
    super ( "PTRA_EMPLEO_PKT" );
   ...
   *
   */
  public PTRA_EMPLEO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PTRA_EMPLEO_PKT ( MDIFrame pFrame )
  {
    super ( "PTRA_EMPLEO_PKT", pFrame );
   ...
   *
   */
  public static PTRA_EMPLEO_PKT get ( RallyApplication __app )
  {
    return ( PTRA_EMPLEO_PKT ) __app.getNewInstance ( "PTRA_EMPLEO_PKT" );
  }
  ...
  {
    PTRA_EMPLEO_PKT fSheet = PTRA_EMPLEO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PTRA_EMPLEO_PKT.exec ( __app );
  }
