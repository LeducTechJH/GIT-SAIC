     ...
     extends Form
{
   ...
   *
   */
  public GEN_ADEL_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_ADEL_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_ADEL_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_ADEL_LOV_FR.jdp" );
