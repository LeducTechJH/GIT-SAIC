...
extends Form
{
	...
	{
		this.registerListener ( "PROVEEDOR_GP", JDataPanelListener.AFTERINSERTINSTANCE, new JDataPanelListener ( )
		{
		...
		this.registerListener ( "NUM_CUENTA_BANCO", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				app.errorFlag = true; 
				//TODO EBT NUMBER CREATION ADL
				return app.errorFlag;
			}
		} );
		this.registerListener ( "ID_PROVEEDOR", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			...
			{
				app.errorFlag = true; 
				int iMode = app.form("MANTENIMIENTO_PROVEEDOR_FR").getMode();
				if ( iMode == ModeStyle.QUERY )
				{
					app.setError ("0", "Recuerda oprimir la 'Lupa' para concluir busqueda.");
				}
				return app.errorFlag;
			}
		} );
		...
		this.registerListener ( "NUM_CUENTA_BANCO", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				NUM_EBT_PROV_ADL.exec(app);
				app.errorFlag = true;
				return app.errorFlag;
			} 
		});
		
		this.registerListener ( "NUM_CUENTA_BANCO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				app.errorFlag = true;
				String numCuenta =  app.form("MANTENIMIENTO_PROVEEDOR_FR").getStringItem( "NUM_CUENTA_BANCO" );  
				if (numCuenta.contains("-") || numCuenta.contains(" ") || numCuenta.contains(".")){
					app.errorFlag = false;
					app.setError ("0", "Este campo no puede contener guión o caracteres especiales");
					return app.errorFlag;
				}
				return app.errorFlag;
			} 
		...
		this.registerListener ( "DIR_1", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				String dir =  app.form("MANTENIMIENTO_PROVEEDOR_FR").getStringItem( "DIR_1" );  
				if (dir.length() > 25)
				{
					app.setError ("0", "Dirección sobre pasa los 25 caracteres.");
					app.errorFlag = false;
					return app.errorFlag;
				}
				else
		...
		this.registerListener ( "DIR_2", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				String dir =  app.form("MANTENIMIENTO_PROVEEDOR_FR").getStringItem( "DIR_2" );  
				if (dir.length() > 25)
				{
					app.setError ("0", "Dirección sobre pasa los 25 caracteres.");
					app.errorFlag = false;
		...
		this.registerListener ( "DIR_POSTAL_1", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				String dir =  app.form("MANTENIMIENTO_PROVEEDOR_FR").getStringItem( "DIR_POSTAL_1" );  
				if (dir.length() > 25)
				{
					app.setError ("0", "Dirección sobre pasa los 25 caracteres.");
					app.errorFlag = false;
		...
		this.registerListener ( "DIR_POSTAL_2", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				String dir =  app.form("MANTENIMIENTO_PROVEEDOR_FR").getStringItem( "DIR_POSTAL_2" );  
				if (dir.length() > 25)
				{
					app.setError ("0", "Dirección sobre pasa los 25 caracteres.");
					app.errorFlag = false;
