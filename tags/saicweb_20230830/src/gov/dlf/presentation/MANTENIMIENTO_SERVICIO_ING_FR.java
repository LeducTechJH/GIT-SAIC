 ...
 */
public class MANTENIMIENTO_SERVICIO_ING_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_SERVICIO_ING_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_SERVICIO_ING_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_SERVICIO_ING_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_SERVICIO_ING_FR.jdp" );
