     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    {
    	double totrecla = MathService.minus ( frm.getDoubleItem ( "TOTAL_BENEFICIOS_RECIBIDOS" ), frm.getDoubleItem ( "TOTAL_BENEFICIOS_CORRECTOS" ) )  ;
    	if (Compare.ge(totrecla, 500))
    	{
    		this.app.CLASI_RECLA_GBL= "PVIN";
    		frm.setItem("RECLA_RETRO_TBL_CLASIFICACION_RECLA", "PVIN");
    	}
