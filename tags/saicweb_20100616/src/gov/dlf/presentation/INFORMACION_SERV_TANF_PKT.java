 ...
 */
public class INFORMACION_SERV_TANF_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INFORMACION_SERV_TANF_PKT ( )
  {
    super ( "INFORMACION_SERV_TANF_PKT" );
   ...
   *
   */
  public INFORMACION_SERV_TANF_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INFORMACION_SERV_TANF_PKT ( MDIFrame pFrame )
  {
    super ( "INFORMACION_SERV_TANF_PKT", pFrame );
  ...
  {
    this.createComponents ( new INFORMACION_SERV_TANF_FR ( ) );
   ...
   *
   */
  public static INFORMACION_SERV_TANF_PKT get ( RallyApplication __app )
  {
    return ( INFORMACION_SERV_TANF_PKT ) __app.getNewInstance ( "INFORMACION_SERV_TANF_PKT" );
  }
  ...
  {
    INFORMACION_SERV_TANF_PKT fSheet = INFORMACION_SERV_TANF_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INFORMACION_SERV_TANF_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; ACTUALIZAR_STATUS_ATEM_ADL.exec ( app ); return app.errorFlag;
      }
    } );
