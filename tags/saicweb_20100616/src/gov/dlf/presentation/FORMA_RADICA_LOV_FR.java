 ...
 */
public class FORMA_RADICA_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public FORMA_RADICA_LOV_FR ( )
  {
    super ( );
    this.setName ( "FORMA_RADICA_LOV_FR" );

    Debug.println ( Debug.TRACE, "FORMA_RADICA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/FORMA_RADICA_LOV_FR.jdp" );
