 ...
 */
public class ACCION_TOMADA_FRAUDE_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public ACCION_TOMADA_FRAUDE_LOV_FR ( )
  {
    super ( );
    this.setName ( "ACCION_TOMADA_FRAUDE_LOV_FR" );

    Debug.println ( Debug.TRACE, "ACCION_TOMADA_FRAUDE_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ACCION_TOMADA_FRAUDE_LOV_FR.jdp" );
