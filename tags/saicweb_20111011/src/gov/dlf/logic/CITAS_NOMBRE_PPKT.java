 ...
 */
public class CITAS_NOMBRE_PPKT 
  implements IRegisteredObject 
{
   ...
   *
   */
  public static CITAS_NOMBRE_PPKT get ( RallyApplication __app )
  {
    CITAS_NOMBRE_PPKT pp = ( CITAS_NOMBRE_PPKT ) __app.getNewInstance ( "CITAS_NOMBRE_PPKT" );
    return pp;
  }
  ...
  {
    return CITAS_NOMBRE_PPKT.exec ( __app );
  }
  ...
  {
    Debug.println ( Debug.TRACE, "CITAS_NOMBRE_PPKT" );
    this.prepareParms ( );
  ...
  {
    this.app.form ( "CITAS_FR" ).setValue ( "JEFE_SERV", this.parms.getDouble ( 0 ) );
    this.app.form ( "CITAS_FR" ).setValue ( "NOMBNRE", this.parms.getString ( 1 ) );
  }
  ...
  {
    this.parms.reset ( );
    this.parms.set ( this.app.form ( "CITAS_FR" ).getValue ( "JEFE_SERV" ) );
    this.parms.set ( this.app.form ( "CITAS_FR" ).getValue ( "NOMBNRE" ) );
  }
