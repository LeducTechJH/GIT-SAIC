 ...
 */
public class CALEND_TECNICO_DISP_MANT_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CALEND_TECNICO_DISP_MANT_FR ( )
  {
    super ( );
    this.setName ( "CALEND_TECNICO_DISP_MANT_FR" );

    Debug.println ( Debug.TRACE, "CALEND_TECNICO_DISP_MANT_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CALEND_TECNICO_DISP_MANT_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "CALEND_TECNICO_DISP_INTK_GP", new CALEND_TECNICO_DISP_MANT_FR_CALEND_TECNICO_DISP_INTK_GP_Arguments ( this ) );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; PONER_FLECHA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
 ...
 *
 */
class CALEND_TECNICO_DISP_MANT_FR_CALEND_TECNICO_DISP_INTK_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public CALEND_TECNICO_DISP_MANT_FR_CALEND_TECNICO_DISP_INTK_GP_Arguments ( Form form )
  {
    this.model = form;

    this.setArgName ( "START_DATE_PAR" );
    this.setArgName ( "ASIGNACION_RAZON_PAR" );
    this.setArgName ( "SST_PAR" );
  ...
  public Object getArgValue ( String argName )
  {
    ...
    else if ( argName.equals ( "START_DATE_PAR" ) )
    {
      return this.app.getSYSTEM_DATE ( ); // Global Variable
    }
    else if ( argName.equals ( "ASIGNACION_RAZON_PAR" ) )
    {
      return this.app.getCALEND_ASIGNACION_RAZON_GBL ( ); // Global Variable
    }
    else if ( argName.equals ( "SST_PAR" ) )
    {
      return this.app.getCALEND_SST_GBL ( ); // Global Variable
    }
