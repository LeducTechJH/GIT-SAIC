 ...
 */
public class GASTOS_CLIENTES_FR_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public GASTOS_CLIENTES_FR_PKT ( )
  {
    super ( "GASTOS_CLIENTES_FR_PKT" );
   ...
   *
   */
  public GASTOS_CLIENTES_FR_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GASTOS_CLIENTES_FR_PKT ( MDIFrame pFrame )
  {
    super ( "GASTOS_CLIENTES_FR_PKT", pFrame );
  ...
  {
    this.createComponents ( new GASTOS_CLIENTE_FR ( ) );
   ...
   *
   */
  public static GASTOS_CLIENTES_FR_PKT get ( RallyApplication __app )
  {
    return ( GASTOS_CLIENTES_FR_PKT ) __app.getNewInstance ( "GASTOS_CLIENTES_FR_PKT" );
  }
  ...
  {
    GASTOS_CLIENTES_FR_PKT fSheet = GASTOS_CLIENTES_FR_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GASTOS_CLIENTES_FR_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; GAST_PAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
