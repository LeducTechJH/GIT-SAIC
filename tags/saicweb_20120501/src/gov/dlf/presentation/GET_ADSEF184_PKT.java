     ...
     extends FormSheet
{
   ...
   *
   */
  public GET_ADSEF184_PKT ( )
  {
    super ( "GET_ADSEF184_PKT" );
   ...
   *
   */
  public GET_ADSEF184_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GET_ADSEF184_PKT ( MDIFrame pFrame )
  {
    super ( "GET_ADSEF184_PKT", pFrame );
  ...
  {
    this.createComponents ( new GET_ADSEF184_FR ( ) );
   ...
   *
   */
  public static GET_ADSEF184_PKT get ( RallyApplication __app )
  {
    return ( GET_ADSEF184_PKT ) __app.getNewInstance ( "GET_ADSEF184_PKT" );
  }
  ...
  {
    GET_ADSEF184_PKT fSheet = GET_ADSEF184_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GET_ADSEF184_PKT.exec ( __app );
  }
