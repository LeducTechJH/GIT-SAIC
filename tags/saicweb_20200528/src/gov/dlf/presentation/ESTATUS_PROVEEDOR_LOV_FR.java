 ...
 */
public class ESTATUS_PROVEEDOR_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public ESTATUS_PROVEEDOR_LOV_FR ( )
  {
    super ( );
    this.setName ( "ESTATUS_PROVEEDOR_LOV_FR" );

    Debug.println ( Debug.TRACE, "ESTATUS_PROVEEDOR_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ESTATUS_PROVEEDOR_LOV_FR.jdp" );
