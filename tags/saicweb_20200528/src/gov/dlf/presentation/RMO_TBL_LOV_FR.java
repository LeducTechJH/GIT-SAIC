     ...
     extends Form
{
   ...
   *
   */
  public RMO_TBL_LOV_FR ( )
  {
    super ( );
    this.setName ( "RMO_TBL_LOV_FR" );

    Debug.println ( Debug.TRACE, "RMO_TBL_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RMO_TBL_LOV_FR.jdp" );
