     ...
     extends Form
{
   ...
   *
   */
  public GEN_CIUD_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_CIUD_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_CIUD_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_CIUD_LOV_FR.jdp" );
