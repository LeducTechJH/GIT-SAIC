 ...
 */
public class REPORT_6_4_FR_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REPORT_6_4_FR_PKT ( )
  {
    super ( "REPORT_6_4_FR_PKT" );
   ...
   *
   */
  public REPORT_6_4_FR_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REPORT_6_4_FR_PKT ( MDIFrame pFrame )
  {
    super ( "REPORT_6_4_FR_PKT", pFrame );
  ...
  {
    this.createComponents ( new REPORT_6_4_FR ( ) );
   ...
   *
   */
  public static REPORT_6_4_FR_PKT get ( RallyApplication __app )
  {
    return ( REPORT_6_4_FR_PKT ) __app.getNewInstance ( "REPORT_6_4_FR_PKT" );
  }
  ...
  {
    REPORT_6_4_FR_PKT fSheet = REPORT_6_4_FR_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REPORT_6_4_FR_PKT.exec ( __app );
  }
