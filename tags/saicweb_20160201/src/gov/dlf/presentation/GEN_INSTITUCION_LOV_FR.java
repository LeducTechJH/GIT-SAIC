 ...
 */
public class GEN_INSTITUCION_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_INSTITUCION_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_INSTITUCION_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_INSTITUCION_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_INSTITUCION_LOV_FR.jdp" );
