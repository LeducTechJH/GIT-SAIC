 ...
 */
public class REFERIDO_RECLA_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REFERIDO_RECLA_PKT ( )
  {
    super ( "REFERIDO_RECLA_PKT" );
   ...
   *
   */
  public REFERIDO_RECLA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REFERIDO_RECLA_PKT ( MDIFrame pFrame )
  {
    super ( "REFERIDO_RECLA_PKT", pFrame );
  ...
  {
    this.createComponents ( new REFERIDO_RECLA_FR ( ) );
   ...
   *
   */
  public static REFERIDO_RECLA_PKT get ( RallyApplication __app )
  {
    return ( REFERIDO_RECLA_PKT ) __app.getNewInstance ( "REFERIDO_RECLA_PKT" );
  }
  ...
  {
    REFERIDO_RECLA_PKT fSheet = REFERIDO_RECLA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REFERIDO_RECLA_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SALIR_REFERIR_RECLA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; REFERIDO_RECLA_BF_ADL.exec ( app ); REFERIDO_RECLA_SETTING_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
