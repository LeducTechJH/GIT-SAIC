 ...
 */
public class COMPENSACION_RECLA_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public COMPENSACION_RECLA_FR ( )
  {
    super ( );
    this.setName ( "COMPENSACION_RECLA_FR" );

    Debug.println ( Debug.TRACE, "COMPENSACION_RECLA_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/COMPENSACION_RECLA_FR.jdp" );
