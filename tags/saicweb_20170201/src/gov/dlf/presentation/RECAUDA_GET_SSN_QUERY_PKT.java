 ...
 */
public class RECAUDA_GET_SSN_QUERY_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public RECAUDA_GET_SSN_QUERY_PKT ( )
  {
    super ( "RECAUDA_GET_SSN_QUERY_PKT" );
   ...
   *
   */
  public RECAUDA_GET_SSN_QUERY_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RECAUDA_GET_SSN_QUERY_PKT ( MDIFrame pFrame )
  {
    super ( "RECAUDA_GET_SSN_QUERY_PKT", pFrame );
   ...
   *
   */
  public static RECAUDA_GET_SSN_QUERY_PKT get ( RallyApplication __app )
  {
    return ( RECAUDA_GET_SSN_QUERY_PKT ) __app.getNewInstance ( "RECAUDA_GET_SSN_QUERY_PKT" );
  }
  ...
  {
	  RECAUDA_GET_SSN_QUERY_PKT fSheet = RECAUDA_GET_SSN_QUERY_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RECAUDA_GET_SSN_QUERY_PKT.exec ( __app );
  }
