     ...
     extends Form
{
   ...
   *
   */
  public EMIS_TIPO_LOV_FR ( )
  {
    super ( );
    this.setName ( "EMIS_TIPO_LOV_FR" );

    Debug.println ( Debug.TRACE, "EMIS_TIPO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/EMIS_TIPO_LOV_FR.jdp" );
