...
protected void process ( ParameterSet ps )
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( ( ( Compare.equals ( this.app.form ( "INFOR_BIO_FRM" ).getStringItem ( "TIPO_REGISTRO" ), "VOLU" ) ) || ( Compare.equals ( this.app.form ( "INFOR_BIO_FRM" ).getStringItem ( "TIPO_REGISTRO" ), "OBLI" ) ) ) && ( ! Compare.equals ( NGET_CMD, 6143 ) )  ) 
    {
  ...
  {
    if ( this._condition0 )    //    if ( ( ( Compare.equals ( this.app.form ( "INFOR_BIO_FRM" ).getStringItem ( "TIPO_REGISTRO" ), "VOLU" ) ) || ( Compare.equals ( this.app.form ( "INFOR_BIO_FRM" ).getStringItem ( "TIPO_REGISTRO" ), "OBLI" ) ) ) && ( ! Compare.equals ( NGET_CMD, 6143 ) )  ) 
    {
