...
protected void process ( ParameterSet ps )
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( ( Compare.equals ( this.app.form ( "INFOR_BIO_FRM" ).getStringItem ( "TIPO_REGISTRO" ), "OBLI" ) ) || ( Compare.equals ( this.app.form ( "INFOR_BIO_FRM" ).getStringItem ( "TIPO_REGISTRO" ), "VOLU" ) ) ) 
    {
