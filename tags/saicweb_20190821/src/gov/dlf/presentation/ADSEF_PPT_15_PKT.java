     ...
     extends FormSheet
{
   ...
   *
   */
  public ADSEF_PPT_15_PKT ( )
  {
    super ( "ADSEF_PPT_15_PKT" );
   ...
   *
   */
  public ADSEF_PPT_15_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ADSEF_PPT_15_PKT ( MDIFrame pFrame )
  {
    super ( "ADSEF_PPT_15_PKT", pFrame );
  ...
  {
    this.createComponents ( new ADSEF_PPT_15_FR ( ) );
    this.setLegendText ( LegendRegistry.get ( "10000" ) );
  }
   ...
   *
   */
  public static ADSEF_PPT_15_PKT get ( RallyApplication __app )
  {
    return ( ADSEF_PPT_15_PKT ) __app.getNewInstance ( "ADSEF_PPT_15_PKT" );
  }
  ...
  {
    ADSEF_PPT_15_PKT fSheet = ADSEF_PPT_15_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ADSEF_PPT_15_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_PPT_15_MENU.exec ( app, null );
