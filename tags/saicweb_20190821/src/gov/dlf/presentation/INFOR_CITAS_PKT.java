     ...
     extends FormSheet
{
   ...
   *
   */
  public INFOR_CITAS_PKT ( )
  {
    super ( "INFOR_CITAS_PKT" );
   ...
   *
   */
  public INFOR_CITAS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INFOR_CITAS_PKT ( MDIFrame pFrame )
  {
    super ( "INFOR_CITAS_PKT", pFrame );
  ...
  {
    this.createComponents ( new INFOR_CITAS_FR ( ) );
   ...
   *
   */
  public static INFOR_CITAS_PKT get ( RallyApplication __app )
  {
    return ( INFOR_CITAS_PKT ) __app.getNewInstance ( "INFOR_CITAS_PKT" );
  }
  ...
  {
    INFOR_CITAS_PKT fSheet = INFOR_CITAS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INFOR_CITAS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CHEK_INFOR_CITAS_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
