 ...
 */
public class REGISTROS_OCUP_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REGISTROS_OCUP_PRINT_PKT ( )
  {
    super ( "REGISTROS_OCUP_PRINT_PKT" );
   ...
   *
   */
  public REGISTROS_OCUP_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REGISTROS_OCUP_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "REGISTROS_OCUP_PRINT_PKT", pFrame );
   ...
   *
   */
  public static REGISTROS_OCUP_PRINT_PKT get ( RallyApplication __app )
  {
    return ( REGISTROS_OCUP_PRINT_PKT ) __app.getNewInstance ( "REGISTROS_OCUP_PRINT_PKT" );
  }
  ...
  {
    REGISTROS_OCUP_PRINT_PKT fSheet = REGISTROS_OCUP_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REGISTROS_OCUP_PRINT_PKT.exec ( __app );
  }
