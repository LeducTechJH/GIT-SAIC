     ...
     extends FormSheet
{
   ...
   *
   */
  public SC1071_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SC1071_PKT ( MDIFrame pFrame )
  {
    super ( "SC1071_PKT", pFrame );
  ...
  {
    this.createComponents ( new SC1071_FR ( ) );
   ...
   *
   */
  public static SC1071_PKT get ( RallyApplication __app )
  {
    return ( SC1071_PKT ) __app.getNewInstance ( "SC1071_PKT" );
  }
  ...
  {
    SC1071_PKT fSheet = SC1071_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; GET_SC1071_SET_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SC1071_GET_NOMBRE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
