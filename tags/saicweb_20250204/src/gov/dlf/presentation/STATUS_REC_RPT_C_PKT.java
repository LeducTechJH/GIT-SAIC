 ...
 */
public class STATUS_REC_RPT_C_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public STATUS_REC_RPT_C_PKT ( )
  {
    super ( "STATUS_REC_RPT_C_PKT" );
   ...
   *
   */
  public STATUS_REC_RPT_C_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public STATUS_REC_RPT_C_PKT ( MDIFrame pFrame )
  {
    super ( "STATUS_REC_RPT_C_PKT", pFrame );
  ...
  {
    this.createComponents ( new STATUS_REC_RPT_C_FR ( ) );
   ...
   *
   */
  public static STATUS_REC_RPT_C_PKT get ( RallyApplication __app )
  {
    return ( STATUS_REC_RPT_C_PKT ) __app.getNewInstance ( "STATUS_REC_RPT_C_PKT" );
  }
  ...
  {
    STATUS_REC_RPT_C_PKT fSheet = STATUS_REC_RPT_C_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return STATUS_REC_RPT_C_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; STATUS_REC_RPT_C_BFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
