 ...
 */
public class TRANSFER_COPY_ANS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TRANSFER_COPY_ANS_PKT ( )
  {
    super ( "TRANSFER_COPY_ANS_PKT" );
   ...
   *
   */
  public TRANSFER_COPY_ANS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TRANSFER_COPY_ANS_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_COPY_ANS_PKT", pFrame );
  ...
  {
    this.createComponents ( new TRANSFER_COPY_ANS_FR ( ) );
   ...
   *
   */
  public static TRANSFER_COPY_ANS_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_COPY_ANS_PKT ) __app.getNewInstance ( "TRANSFER_COPY_ANS_PKT" );
  }
  ...
  {
    TRANSFER_COPY_ANS_PKT fSheet = TRANSFER_COPY_ANS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_COPY_ANS_PKT.exec ( __app );
  }
