 ...
 */
public class CLASSIF_AEC_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CLASSIF_AEC_LOV_FR ( )
  {
    super ( );
    this.setName ( "CLASSIF_AEC_LOV_FR" );

    Debug.println ( Debug.TRACE, "CLASSIF_AEC_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CLASSIF_AEC_LOV_FR.jdp" );
