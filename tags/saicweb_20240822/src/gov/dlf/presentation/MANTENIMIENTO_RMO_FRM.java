 ...
 */
public class MANTENIMIENTO_RMO_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_RMO_FRM ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_RMO_FRM" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_RMO_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_RMO_FRM.jdp" );
