 ...
 */
public class CASOS_HIST_RECLARETRO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CASOS_HIST_RECLARETRO_PKT ( )
  {
    super ( "CASOS_HIST_RECLARETRO_PKT" );
   ...
   *
   */
  public CASOS_HIST_RECLARETRO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CASOS_HIST_RECLARETRO_PKT ( MDIFrame pFrame )
  {
    super ( "CASOS_HIST_RECLARETRO_PKT", pFrame );
  ...
  {
    this.createComponents ( new CASOS_HISTO_RECLARETRO_RP ( ) );
   ...
   *
   */
  public static CASOS_HIST_RECLARETRO_PKT get ( RallyApplication __app )
  {
    return ( CASOS_HIST_RECLARETRO_PKT ) __app.getNewInstance ( "CASOS_HIST_RECLARETRO_PKT" );
  }
  ...
  {
    CASOS_HIST_RECLARETRO_PKT fSheet = CASOS_HIST_RECLARETRO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CASOS_HIST_RECLARETRO_PKT.exec ( __app );
  }
