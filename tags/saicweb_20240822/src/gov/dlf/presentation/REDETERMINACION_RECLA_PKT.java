 ...
 */
public class REDETERMINACION_RECLA_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REDETERMINACION_RECLA_PKT ( )
  {
    super ( "REDETERMINACION_RECLA_PKT" );
   ...
   *
   */
  public REDETERMINACION_RECLA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REDETERMINACION_RECLA_PKT ( MDIFrame pFrame )
  {
    super ( "REDETERMINACION_RECLA_PKT", pFrame );
   ...
   *
   */
  public static REDETERMINACION_RECLA_PKT get ( RallyApplication __app )
  {
    return ( REDETERMINACION_RECLA_PKT ) __app.getNewInstance ( "REDETERMINACION_RECLA_PKT" );
  }
  ...
  {
    REDETERMINACION_RECLA_PKT fSheet = REDETERMINACION_RECLA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REDETERMINACION_RECLA_PKT.exec ( __app );
  }
