 ...
 */
public class MANTENIMIENTO_CUENTA_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_CUENTA_PKT ( )
  {
    super ( "MANTENIMIENTO_CUENTA_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_CUENTA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_CUENTA_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_CUENTA_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_CUENTA_FR ( ) );
   ...
   *
   */
  public static MANTENIMIENTO_CUENTA_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_CUENTA_PKT ) __app.getNewInstance ( "MANTENIMIENTO_CUENTA_PKT" );
  }
  ...
  {
    MANTENIMIENTO_CUENTA_PKT fSheet = MANTENIMIENTO_CUENTA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_CUENTA_PKT.exec ( __app );
  }
