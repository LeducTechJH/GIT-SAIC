 ...
 */
public class SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_FR ( )
  {
    super ( );
    this.setName ( "SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_FR" );

    Debug.println ( Debug.TRACE, "SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "FINISH_ACTION", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      { 
        app.errorFlag = true; SIBIF_CAL_GET_CITAS_FOR_TSS_ADL.exec ( app ); return app.errorFlag;    
      }
    } );
  }
}
