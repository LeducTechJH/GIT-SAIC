     ...
     extends FormSheet
{
   ...
   *
   */
  public PRI_TANF_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PRI_TANF_PKT ( MDIFrame pFrame )
  {
    super ( "PRI_TANF_PKT", pFrame );
  ...
  {
    this.createComponents ( new PRI_TANF_FR ( ) );
   ...
   *
   */
  public static PRI_TANF_PKT get ( RallyApplication __app )
  {
    return ( PRI_TANF_PKT ) __app.getNewInstance ( "PRI_TANF_PKT" );
  }
  ...
  {
    PRI_TANF_PKT fSheet = PRI_TANF_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PRI_TANF_PKT.exec ( __app );
  }
