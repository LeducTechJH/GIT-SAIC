 ...
 */
public class TRANSFER_ENVIADAS_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TRANSFER_ENVIADAS_PRINT_PKT ( )
  {
    super ( "TRANSFER_ENVIADAS_PRINT_PKT" );
   ...
   *
   */
  public TRANSFER_ENVIADAS_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TRANSFER_ENVIADAS_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_ENVIADAS_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new TRANSFER_ENVIADAS_FR ( ) );
   ...
   *
   */
  public static TRANSFER_ENVIADAS_PRINT_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_ENVIADAS_PRINT_PKT ) __app.getNewInstance ( "TRANSFER_ENVIADAS_PRINT_PKT" );
  }
  ...
  {
    TRANSFER_ENVIADAS_PRINT_PKT fSheet = TRANSFER_ENVIADAS_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_ENVIADAS_PRINT_PKT.exec ( __app );
  }
