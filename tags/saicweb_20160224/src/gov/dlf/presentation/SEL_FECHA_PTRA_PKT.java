 ...
 */
public class SEL_FECHA_PTRA_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SEL_FECHA_PTRA_PKT ( )
  {
    super ( "SEL_FECHA_PTRA_PKT" );
   ...
   *
   */
  public SEL_FECHA_PTRA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SEL_FECHA_PTRA_PKT ( MDIFrame pFrame )
  {
    super ( "SEL_FECHA_PTRA_PKT", pFrame );
  ...
  {
    this.createComponents ( new SEL_FECHA_PTRA_FR ( ) );
   ...
   *
   */
  public static SEL_FECHA_PTRA_PKT get ( RallyApplication __app )
  {
    return ( SEL_FECHA_PTRA_PKT ) __app.getNewInstance ( "SEL_FECHA_PTRA_PKT" );
  }
  ...
  {
    SEL_FECHA_PTRA_PKT fSheet = SEL_FECHA_PTRA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SEL_FECHA_PTRA_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SEL_FECHA_PTRA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
