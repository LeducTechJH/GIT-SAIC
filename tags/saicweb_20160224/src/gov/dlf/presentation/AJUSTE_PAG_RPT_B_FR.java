 ...
 */
public class AJUSTE_PAG_RPT_B_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public AJUSTE_PAG_RPT_B_FR ( )
  {
    super ( );
    this.setName ( "AJUSTE_PAG_RPT_B_FR" );

    Debug.println ( Debug.TRACE, "AJUSTE_PAG_RPT_B_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/AJUSTE_PAG_RPT_B_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "G1", new AJUSTE_PAG_RPT_B_FR_G1_Arguments ( this ) );
 ...
 *
 */
class AJUSTE_PAG_RPT_B_FR_G1_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public AJUSTE_PAG_RPT_B_FR_G1_Arguments ( Form form )
  {
    this.model = form;
