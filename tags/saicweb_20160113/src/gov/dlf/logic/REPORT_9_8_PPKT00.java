 ...
 */
public class REPORT_9_8_PPKT00 
  implements IRegisteredObject 
{
   ...
   *
   */
  public static REPORT_9_8_PPKT00 get ( RallyApplication __app )
  {
    REPORT_9_8_PPKT00 pp = ( REPORT_9_8_PPKT00 ) __app.getNewInstance ( "REPORT_9_8_PPKT00" );
    return pp;
  }
  ...
  {
    return REPORT_9_8_PPKT00.exec ( __app );
  }
  ...
  {
    Debug.println ( Debug.TRACE, "REPORT_9_8_PPKT00" );
    this.prepareParms ( );
  ...
  {
    this.app.form ( "REPORT_9_14_FR" ).setValue ( "COD_REVISION", this.parms.getString ( 0 ) );
    this.app.form ( "REPORT_9_14_FR" ).setValue ( "NO_REVISION", this.parms.getString ( 1 ) );
  }
  ...
  {
    this.parms.reset ( );
    this.parms.set ( this.app.form ( "REPORT_9_14_FR" ).getValue ( "COD_REVISION" ) );
    this.parms.set ( this.app.form ( "REPORT_9_14_FR" ).getValue ( "NO_REVISION" ) );
  }
