     ...
     extends FormSheet
{
   ...
   *
   */
  public REPORT_9_7_PKT ( )
  {
    super ( "REPORT_9_7_PKT" );
   ...
   *
   */
  public REPORT_9_7_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REPORT_9_7_PKT ( MDIFrame pFrame )
  {
    super ( "REPORT_9_7_PKT", pFrame );
  ...
  {
    this.createComponents ( new REPORT_9_7_FR ( ) );
   ...
   *
   */
  public static REPORT_9_7_PKT get ( RallyApplication __app )
  {
    return ( REPORT_9_7_PKT ) __app.getNewInstance ( "REPORT_9_7_PKT" );
  }
  ...
  {
    REPORT_9_7_PKT fSheet = REPORT_9_7_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REPORT_9_7_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; REPORT_9_7A_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
