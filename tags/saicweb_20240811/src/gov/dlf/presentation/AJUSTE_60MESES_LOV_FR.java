 ...
 */
public class AJUSTE_60MESES_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public AJUSTE_60MESES_LOV_FR ( )
  {
    super ( );
    this.setName ( "AJUSTE_60MESES_LOV_FR" );

    Debug.println ( Debug.TRACE, "AJUSTE_60MESES_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/AJUSTE_60MESES_LOV_FR.jdp" );
