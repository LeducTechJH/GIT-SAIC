 ...
 */
public class STATUS_SERV_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public STATUS_SERV_LOV_FR ( )
  {
    super ( );
    this.setName ( "STATUS_SERV_LOV_FR" );

    Debug.println ( Debug.TRACE, "STATUS_SERV_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/STATUS_SERV_LOV_FR.jdp" );
