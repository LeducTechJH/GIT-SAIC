 ...
 */
public class SEL_FECHAS_REP_APELACIONES_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SEL_FECHAS_REP_APELACIONES_PKT ( )
  {
    super ( "SEL_FECHAS_REP_APELACIONES_PKT" );
   ...
   *
   */
  public SEL_FECHAS_REP_APELACIONES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SEL_FECHAS_REP_APELACIONES_PKT ( MDIFrame pFrame )
  {
    super ( "SEL_FECHAS_REP_APELACIONES_PKT", pFrame );
  ...
  {
    this.createComponents ( new SEL_FECHAS_REP_APELACIONES_FR ( ) );
   ...
   *
   */
  public static SEL_FECHAS_REP_APELACIONES_PKT get ( RallyApplication __app )
  {
    return ( SEL_FECHAS_REP_APELACIONES_PKT ) __app.getNewInstance ( "SEL_FECHAS_REP_APELACIONES_PKT" );
  }
  ...
  {
    SEL_FECHAS_REP_APELACIONES_PKT fSheet = SEL_FECHAS_REP_APELACIONES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SEL_FECHAS_REP_APELACIONES_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; IMPRIMIR_REGISTRO_APELACIONES_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
