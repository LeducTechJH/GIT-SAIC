     ...
     extends FormSheet
{
   ...
   *
   */
  public GET_SC1072_PKT ( )
  {
    super ( "GET_SC1072_PKT" );
   ...
   *
   */
  public GET_SC1072_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GET_SC1072_PKT ( MDIFrame pFrame )
  {
    super ( "GET_SC1072_PKT", pFrame );
  ...
  {
    this.createComponents ( new GET_SC1072_FR ( ) );
   ...
   *
   */
  public static GET_SC1072_PKT get ( RallyApplication __app )
  {
    return ( GET_SC1072_PKT ) __app.getNewInstance ( "GET_SC1072_PKT" );
  }
  ...
  {
    GET_SC1072_PKT fSheet = GET_SC1072_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GET_SC1072_PKT.exec ( __app );
  }
