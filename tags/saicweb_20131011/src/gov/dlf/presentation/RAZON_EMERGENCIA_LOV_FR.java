 ...
 */
public class RAZON_EMERGENCIA_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public RAZON_EMERGENCIA_LOV_FR ( )
  {
    super ( );
    this.setName ( "RAZON_EMERGENCIA_LOV_FR" );

    Debug.println ( Debug.TRACE, "RAZON_EMERGENCIA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RAZON_EMERGENCIA_LOV_FR.jdp" );
