 ...
 */
public class LISTA_ESFUERZO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public LISTA_ESFUERZO_PKT ( )
  {
    super ( "LISTA_ESFUERZO_PKT" );
   ...
   *
   */
  public LISTA_ESFUERZO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public LISTA_ESFUERZO_PKT ( MDIFrame pFrame )
  {
    super ( "LISTA_ESFUERZO_PKT", pFrame );
  ...
  {
    this.createComponents ( new LISTA_ESFUERZO_FR ( ) );
   ...
   *
   */
  public static LISTA_ESFUERZO_PKT get ( RallyApplication __app )
  {
    return ( LISTA_ESFUERZO_PKT ) __app.getNewInstance ( "LISTA_ESFUERZO_PKT" );
  }
  ...
  {
    LISTA_ESFUERZO_PKT fSheet = LISTA_ESFUERZO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return LISTA_ESFUERZO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; LLENAR_LISTA_ESFUERZO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
