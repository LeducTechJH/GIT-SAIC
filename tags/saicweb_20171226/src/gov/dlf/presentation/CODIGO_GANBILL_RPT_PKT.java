 ...
 */
public class CODIGO_GANBILL_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CODIGO_GANBILL_RPT_PKT ( )
  {
    super ( "CODIGO_GANBILL_RPT_PKT" );
   ...
   *
   */
  public CODIGO_GANBILL_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CODIGO_GANBILL_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "CODIGO_GANBILL_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CODIGO_GANBILL_RPT ( ) );
   ...
   *
   */
  public static CODIGO_GANBILL_RPT_PKT get ( RallyApplication __app )
  {
    return ( CODIGO_GANBILL_RPT_PKT ) __app.getNewInstance ( "CODIGO_GANBILL_RPT_PKT" );
  }
  ...
  {
    CODIGO_GANBILL_RPT_PKT fSheet = CODIGO_GANBILL_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CODIGO_GANBILL_RPT_PKT.exec ( __app );
  }
