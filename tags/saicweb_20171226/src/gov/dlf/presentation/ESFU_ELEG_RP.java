     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "ESFU_ELEG_RP" );

    Debug.println ( Debug.TRACE, "ESFU_ELEG_RP - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ESFU_ELEG_RP.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "REGISTRO_GP", new ESFU_ELEG_RP_REGISTRO_GP_Arguments ( this ) );

    this.setObjectEvents ( );
    field = ( JDataPanelField ) this.getInDepth ( "FCH_DESDE" );
    field.setValueProvider ( new ESFU_ELEG_RP_FCH_DESDEProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "FCH_HASTA" );
    field.setValueProvider ( new ESFU_ELEG_RP_FCH_HASTAProvider ( this ) );



    calculator = new ESFU_ELEG_RP_OFICINACalculator ( this );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueCalculator ( calculator );
    calculator = new ESFU_ELEG_RP_NOMBRE_COMPLETOCalculator ( this );
 ...
 *
 */
class ESFU_ELEG_RP_REGISTRO_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public ESFU_ELEG_RP_REGISTRO_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class ESFU_ELEG_RP_FCH_DESDEProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ESFU_ELEG_RP_FCH_DESDEProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class ESFU_ELEG_RP_FCH_HASTAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ESFU_ELEG_RP_FCH_HASTAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class ESFU_ELEG_RP_OFICINACalculator implements ICalculator
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ESFU_ELEG_RP_OFICINACalculator ( Form form )
  {
    this.model = form;
  }
  ...
  {
    if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
    this.app.exec ( "ESFU_ELEG_OFC_PPKT" );
  }
}
 ...
 *
 */
class ESFU_ELEG_RP_NOMBRE_COMPLETOCalculator implements ICalculator
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ESFU_ELEG_RP_NOMBRE_COMPLETOCalculator ( Form form )
  {
    this.model = form;
  }
  ...
  {
    if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
    this.app.exec ( "ESFU_ELEG_NOM_PPKT" );
  }
}
