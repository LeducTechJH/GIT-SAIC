 ...
 */
public class DECISION_HACIENDA_FRAUDE_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public DECISION_HACIENDA_FRAUDE_LOV_FR ( )
  {
    super ( );
    this.setName ( "DECISION_HACIENDA_FRAUDE_LOV_FR" );

    Debug.println ( Debug.TRACE, "DECISION_HACIENDA_FRAUDE_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DECISION_HACIENDA_FRAUDE_LOV_FR.jdp" );
