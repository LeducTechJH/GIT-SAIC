     ...
     extends ADL
{
  ...
  {
  if ( Compare.equals ( this.app.COD_SERV_GBL, "LISE" ) || Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "LICE" ) || Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "CLIM" ))     //    else if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "AE-B" ) ) || ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "AE-G" ) )  )
    {
  ...
  {
  if ( Compare.equals ( this.app.COD_SERV_GBL, "TANFS" )  )     //    else if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "AE-B" ) ) || ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "AE-G" ) )  )
    {
	  TANFS_PRINT_PKT.exec(this.app);
  ...
  {
  if ( Compare.equals ( this.app.COD_SERV_GBL, "TANFE" )  )     //    else if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "AE-B" ) ) || ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "AE-G" ) )  )
    {
	  TANFE_PRINT_PKT.exec(this.app);
