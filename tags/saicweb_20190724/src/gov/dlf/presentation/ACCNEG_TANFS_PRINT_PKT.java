 ...
 */
public class ACCNEG_TANFS_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ACCNEG_TANFS_PRINT_PKT ( )
  {
    super ( "ACCNEG_TANFS_PRINT_PKT" );
   ...
   *
   */
  public ACCNEG_TANFS_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ACCNEG_TANFS_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "ACCNEG_TANFS_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new ACCNEG_TANFS_FR ( ) );
   ...
   *
   */
  public static ACCNEG_TANFS_PRINT_PKT get ( RallyApplication __app )
  {
    return ( ACCNEG_TANFS_PRINT_PKT ) __app.getNewInstance ( "ACCNEG_TANFS_PRINT_PKT" );
  }
  ...
  {
    ACCNEG_TANFS_PRINT_PKT fSheet = ACCNEG_TANFS_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ACCNEG_TANFS_PRINT_PKT.exec ( __app );
  }
