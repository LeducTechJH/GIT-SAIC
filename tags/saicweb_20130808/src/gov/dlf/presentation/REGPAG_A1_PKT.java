     ...
     extends FormSheet
{
   ...
   *
   */
  public REGPAG_A1_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REGPAG_A1_PKT ( MDIFrame pFrame )
  {
    super ( "REGPAG_A1_PKT", pFrame );
  ...
  {
    this.createComponents ( new REGPAG_A1_FR ( ) );
   ...
   *
   */
  public static REGPAG_A1_PKT get ( RallyApplication __app )
  {
    return ( REGPAG_A1_PKT ) __app.getNewInstance ( "REGPAG_A1_PKT" );
  }
  ...
  {
    REGPAG_A1_PKT fSheet = REGPAG_A1_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REGPAG_A1_PKT.exec ( __app );
  }
