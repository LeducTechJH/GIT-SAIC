 ...
 */
public class ESFU_RECHAZADAS_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ESFU_RECHAZADAS_PRINT_PKT ( )
  {
    super ( "ESFU_RECHAZADAS_PRINT_PKT" );
   ...
   *
   */
  public ESFU_RECHAZADAS_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ESFU_RECHAZADAS_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "ESFU_RECHAZADAS_PRINT_PKT", pFrame );
   ...
   *
   */
  public static ESFU_RECHAZADAS_PRINT_PKT get ( RallyApplication __app )
  {
    return ( ESFU_RECHAZADAS_PRINT_PKT ) __app.getNewInstance ( "ESFU_RECHAZADAS_PRINT_PKT" );
  }
  ...
  {
    ESFU_RECHAZADAS_PRINT_PKT fSheet = ESFU_RECHAZADAS_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ESFU_RECHAZADAS_PRINT_PKT.exec ( __app );
  }
