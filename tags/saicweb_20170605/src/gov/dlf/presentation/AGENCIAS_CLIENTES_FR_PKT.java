 ...
 */
public class AGENCIAS_CLIENTES_FR_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public AGENCIAS_CLIENTES_FR_PKT ( )
  {
    super ( "AGENCIAS_CLIENTES_FR_PKT" );
   ...
   *
   */
  public AGENCIAS_CLIENTES_FR_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AGENCIAS_CLIENTES_FR_PKT ( MDIFrame pFrame )
  {
    super ( "AGENCIAS_CLIENTES_FR_PKT", pFrame );
   ...
   *
   */
  public static AGENCIAS_CLIENTES_FR_PKT get ( RallyApplication __app )
  {
    return ( AGENCIAS_CLIENTES_FR_PKT ) __app.getNewInstance ( "AGENCIAS_CLIENTES_FR_PKT" );
  }
  ...
  {
    AGENCIAS_CLIENTES_FR_PKT fSheet = AGENCIAS_CLIENTES_FR_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return AGENCIAS_CLIENTES_FR_PKT.exec ( __app );
  }
