     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "EXEN_LOV_FR" );

    Debug.println ( Debug.TRACE, "EXEN_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/EXEN_LOV_FR.jdp" );
