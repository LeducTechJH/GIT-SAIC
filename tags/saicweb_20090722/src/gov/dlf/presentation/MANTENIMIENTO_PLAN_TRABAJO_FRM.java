 ...
 */
public class MANTENIMIENTO_PLAN_TRABAJO_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_PLAN_TRABAJO_FRM ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_PLAN_TRABAJO_FRM" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_PLAN_TRABAJO_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_PLAN_TRABAJO_FRM.jdp" );
