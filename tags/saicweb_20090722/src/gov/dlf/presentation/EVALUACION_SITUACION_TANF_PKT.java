 ...
 */
public class EVALUACION_SITUACION_TANF_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public EVALUACION_SITUACION_TANF_PKT ( )
  {
    super ( "EVALUACION_SITUACION_TANF_PKT" );
   ...
   *
   */
  public EVALUACION_SITUACION_TANF_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public EVALUACION_SITUACION_TANF_PKT ( MDIFrame pFrame )
  {
    super ( "EVALUACION_SITUACION_TANF_PKT", pFrame );
  ...
  {
    this.createComponents ( new EVALUACION_SITUACION_TANF ( ) );
   ...
   *
   */
  public static EVALUACION_SITUACION_TANF_PKT get ( RallyApplication __app )
  {
    return ( EVALUACION_SITUACION_TANF_PKT ) __app.getNewInstance ( "EVALUACION_SITUACION_TANF_PKT" );
  }
  ...
  {
    EVALUACION_SITUACION_TANF_PKT fSheet = EVALUACION_SITUACION_TANF_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return EVALUACION_SITUACION_TANF_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; EVALUA_SITUACION_BF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.BEFOREQUIT, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SET_COMPL_STATUS_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
