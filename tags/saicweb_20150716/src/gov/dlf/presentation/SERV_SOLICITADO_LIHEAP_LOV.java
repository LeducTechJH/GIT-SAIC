 ...
 */
public class SERV_SOLICITADO_LIHEAP_LOV
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SERV_SOLICITADO_LIHEAP_LOV ( )
  {
    super ( );
    this.setName ( "SERV_SOLICITADO_LIHEAP_LOV" );

    Debug.println ( Debug.TRACE, "SERV_SOLICITADO_LIHEAP_LOV - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SERV_SOLICITADO_LIHEAP_LOV.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "SERV_SOLICITADO_LIHEAP_LOV_GP", new SERV_SOLICITADO_LIHEAP_LOV_GP_Arguments ( this ) );
 ...
 *
 */
class  SERV_SOLICITADO_LIHEAP_LOV_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public SERV_SOLICITADO_LIHEAP_LOV_GP_Arguments ( Form form )
  {
    this.model = form;
