 ...
 */
public class TIPO_PROVEEDOR_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TIPO_PROVEEDOR_LOV_FR ( )
  {
    super ( );
    this.setName ( "TIPO_PROVEEDOR_LOV_FR" );

    Debug.println ( Debug.TRACE, "TIPO_PROVEEDOR_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TIPO_PROVEEDOR_LOV_FR.jdp" );
