 ...
 */
public class COMP_FAM_INF_SSN_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public COMP_FAM_INF_SSN_FR ( )
  {
    super ( );
    this.setName ( "COMP_FAM_INF_SSN_FR" );

    Debug.println ( Debug.TRACE, "COMP_FAM_INF_SSN_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/COMP_FAM_INF_SSN_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "SSN_JEFE_FAM", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SSN_GBL_COM_FAM_INF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
