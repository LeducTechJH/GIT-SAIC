     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "GET_AE115_FR" );

    Debug.println ( Debug.TRACE, "GET_AE115_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_AE115_FR.jdp" );
