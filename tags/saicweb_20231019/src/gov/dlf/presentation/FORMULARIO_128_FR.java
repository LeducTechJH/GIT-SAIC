 ...
 */
public class FORMULARIO_128_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public FORMULARIO_128_FR ( )
  {
    super ( );
    this.setName ( "FORMULARIO_128_FR" );

    Debug.println ( Debug.TRACE, "FORMULARIO_128_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/FORMULARIO_128_FR.jdp" );
