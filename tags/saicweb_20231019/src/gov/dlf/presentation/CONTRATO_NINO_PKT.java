 ...
 */
public class CONTRATO_NINO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CONTRATO_NINO_PKT ( )
  {
    super ( "CONTRATO_NINO_PKT" );
   ...
   *
   */
  public CONTRATO_NINO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CONTRATO_NINO_PKT ( MDIFrame pFrame )
  {
    super ( "CONTRATO_NINO_PKT", pFrame );
  ...
  {
    this.createComponents ( new CONTRATO_NINO_FRM ( ) );
   ...
   *
   */
  public static CONTRATO_NINO_PKT get ( RallyApplication __app )
  {
    return ( CONTRATO_NINO_PKT ) __app.getNewInstance ( "CONTRATO_NINO_PKT" );
  }
  ...
  {
    CONTRATO_NINO_PKT fSheet = CONTRATO_NINO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CONTRATO_NINO_PKT.exec ( __app );
  }
