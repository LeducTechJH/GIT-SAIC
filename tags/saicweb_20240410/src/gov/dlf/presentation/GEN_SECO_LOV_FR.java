     ...
     extends Form
{
   ...
   *
   */
  public GEN_SECO_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_SECO_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_SECO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_SECO_LOV_FR.jdp" );
