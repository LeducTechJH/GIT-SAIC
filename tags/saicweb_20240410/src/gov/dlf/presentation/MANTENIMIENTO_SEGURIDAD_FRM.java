 ...
 */
public class MANTENIMIENTO_SEGURIDAD_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_SEGURIDAD_FRM ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_SEGURIDAD_FRM" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_SEGURIDAD_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_SEGURIDAD_FRM.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CHECK_COUNT_ACCESS_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    ...
    this.registerListener ( "STAND_PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
    ...
    this.registerListener ( "STAND_PARK", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; FIRST_GROUP_TSS_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "PARK_ACCESO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
