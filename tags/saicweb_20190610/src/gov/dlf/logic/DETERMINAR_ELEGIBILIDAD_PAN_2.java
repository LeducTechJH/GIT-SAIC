...
//							{
								...
								{
									SALARIO = MathService.plus ( SALARIO, this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) *0 );
//									SALARIO_TEMP = SALARIO_TEMP * 0;
								}
								else if ( Compare.ge(this.dm.getFieldDouble ( this.dm.get ( "PTRA_EMPLEOS2_DSD" ),"REMANENTE" ), 6) && Compare.le(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ),"REMANENTE" ), 11))
								{
									SALARIO = MathService.plus ( SALARIO, TruncService.trunc(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) *0.34 ));
//									SALARIO_TEMP = SALARIO_TEMP - ( SALARIO_TEMP *.66 );
								}
								else if ( Compare.ge(this.dm.getFieldDouble ( this.dm.get ( "PTRA_EMPLEOS2_DSD" ),"REMANENTE" ), 12) && Compare.le(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ),"REMANENTE" ), 17))
								{
									SALARIO = MathService.plus ( SALARIO, TruncService.trunc(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) *0.67 ));
...
//									SALARIO_TEMP = SALARIO_TEMP * 0;
								...
								{
									SALARIO = MathService.plus ( SALARIO, TruncService.trunc(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) *.34) );
//									SALARIO_TEMP = SALARIO_TEMP - ( SALARIO_TEMP *.66 );
								}
								else if ( Compare.ge(this.dm.getFieldDouble ( this.dm.get ( "PTRA_EMPLEOS2_DSD" ),"REMANENTE" ), 12) && Compare.le(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ),"REMANENTE" ), 17))
								{
									SALARIO = MathService.plus ( SALARIO, TruncService.trunc(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) *.67) );
//									SALARIO_TEMP = SALARIO_TEMP - ( SALARIO_TEMP *.33 );
								}
								else
								{
