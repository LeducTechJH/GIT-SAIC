 ...
 */
public class COLOR_OJOS_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public COLOR_OJOS_LOV_FR ( )
  {
    super ( );
    this.setName ( "COLOR_OJOS_LOV_FR" );

    Debug.println ( Debug.TRACE, "COLOR_OJOS_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/COLOR_OJOS_LOV_FR.jdp" );
