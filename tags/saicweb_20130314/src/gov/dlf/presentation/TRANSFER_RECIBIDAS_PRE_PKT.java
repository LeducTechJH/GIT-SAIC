 ...
 */
public class TRANSFER_RECIBIDAS_PRE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
  ...
  {
    TRANSFER_RECIBIDAS_PRE_PKT fSheet = TRANSFER_RECIBIDAS_PRE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_RECIBIDAS_PRE_PKT.exec ( __app );
  }
   ...
   *
   */
  public static TRANSFER_RECIBIDAS_PRE_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_RECIBIDAS_PRE_PKT ) __app.getNewInstance ( "TRANSFER_RECIBIDAS_PRE_PKT" );
  }
   ...
   *
   */
  public TRANSFER_RECIBIDAS_PRE_PKT ( )
  {
    super ( "TRANSFER_RECIBIDAS_PRE_PKT" );
   ...
   *
   */
  public TRANSFER_RECIBIDAS_PRE_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_RECIBIDAS_PRE_PKT", pFrame );
   ...
   *
   */
  public TRANSFER_RECIBIDAS_PRE_PKT ( String packetTitle )
  {
    super ( packetTitle );
  ...
  {
    this.createComponents ( new TRANSFER_RECIBIDAS_SEL_FECHAS_FR ( ) );
