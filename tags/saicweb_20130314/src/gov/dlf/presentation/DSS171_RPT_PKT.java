     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS171_RPT_PKT ( )
  {
    super ( "DSS171_RPT_PKT" );
   ...
   *
   */
  public DSS171_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS171_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "DSS171_RPT_PKT", pFrame );
   ...
   *
   */
  public static DSS171_RPT_PKT get ( RallyApplication __app )
  {
    return ( DSS171_RPT_PKT ) __app.getNewInstance ( "DSS171_RPT_PKT" );
  }
  ...
  {
    DSS171_RPT_PKT fSheet = DSS171_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS171_RPT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; BFR_DSS171_RPT_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
