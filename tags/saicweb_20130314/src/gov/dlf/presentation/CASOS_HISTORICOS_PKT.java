 ...
 */
public class CASOS_HISTORICOS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CASOS_HISTORICOS_PKT ( )
  {
    super ( "CASOS_HISTORICOS_PKT" );
   ...
   *
   */
  public CASOS_HISTORICOS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CASOS_HISTORICOS_PKT ( MDIFrame pFrame )
  {
    super ( "CASOS_HISTORICOS_PKT", pFrame );
  ...
  {
    this.createComponents ( new CASOS_HISTORICOS_RP ( ) );
   ...
   *
   */
  public static CASOS_HISTORICOS_PKT get ( RallyApplication __app )
  {
    return ( CASOS_HISTORICOS_PKT ) __app.getNewInstance ( "CASOS_HISTORICOS_PKT" );
  }
  ...
  {
    CASOS_HISTORICOS_PKT fSheet = CASOS_HISTORICOS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CASOS_HISTORICOS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  CASOS_HISTORICOS_MENU.exec ( app, null );
