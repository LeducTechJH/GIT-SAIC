 ...
 */
public class INFORME_VISTA_APELACIONES_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INFORME_VISTA_APELACIONES_PKT ( )
  {
    super ( "INFORME_VISTA_APELACIONES_PKT" );
   ...
   *
   */
  public INFORME_VISTA_APELACIONES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INFORME_VISTA_APELACIONES_PKT ( MDIFrame pFrame )
  {
    super ( "INFORME_VISTA_APELACIONES_PKT", pFrame );
  ...
  {
    this.createComponents ( new INFORME_VISTA_APELACIONES_FR ( ) );
   ...
   *
   */
  public static INFORME_VISTA_APELACIONES_PKT get ( RallyApplication __app )
  {
    return ( INFORME_VISTA_APELACIONES_PKT ) __app.getNewInstance ( "INFORME_VISTA_APELACIONES_PKT" );
  }
  ...
  {
    INFORME_VISTA_APELACIONES_PKT fSheet = INFORME_VISTA_APELACIONES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INFORME_VISTA_APELACIONES_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; LLAMAR_MENU_VISTA_APELACIONES_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; LLENAR_VISTA_APELACIONES_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
