  ...
  implements IRegisteredObject 
{
   ...
   *
   */
  public static REPORT_9_8_PPKT1 get ( RallyApplication __app )
  {
    REPORT_9_8_PPKT1 pp = ( REPORT_9_8_PPKT1 ) __app.getNewInstance ( "REPORT_9_8_PPKT1" );
    return pp;
  }
  ...
  {
    return REPORT_9_8_PPKT1.exec ( __app );
  }
  ...
  {
    Debug.println ( Debug.TRACE, "REPORT_9_8_PPKT1" );
    this.prepareParms ( );
  ...
  {
    this.app.form ( "REPORT_9_9_1_FR" ).setValue ( "COD_REVISION", this.parms.getString ( 0 ) );
    this.app.form ( "REPORT_9_9_1_FR" ).setValue ( "NO_REVISION", this.parms.getString ( 1 ) );
  }
  ...
  {
    this.parms.reset ( );
    this.parms.set ( this.app.form ( "REPORT_9_9_1_FR" ).getValue ( "COD_REVISION" ) );
    this.parms.set ( this.app.form ( "REPORT_9_9_1_FR" ).getValue ( "NO_REVISION" ) );
  }
