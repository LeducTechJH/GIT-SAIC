 ...
 */
public class TECNICO_RESTR_LOV_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TECNICO_RESTR_LOV_FRM ( )
  {
    super ( );
    this.setName ( "TECNICO_RESTR_LOV_FRM" );

    Debug.println ( Debug.TRACE, "TECNICO_RESTR_LOV_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TECNICO_RESTR_LOV_FRM.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "TEC_LOV", new TECNICO_RESTR_LOV_FRM_TEC_LOV_Arguments ( this ) );
 ...
 *
 */
class TECNICO_RESTR_LOV_FRM_TEC_LOV_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public TECNICO_RESTR_LOV_FRM_TEC_LOV_Arguments ( Form form )
  {
    this.model = form;
