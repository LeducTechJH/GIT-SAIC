 ...
 */
public class TIPO_SERV_ATEM_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TIPO_SERV_ATEM_LOV_FR ( )
  {
    super ( );
    this.setName ( "TIPO_SERV_ATEM_LOV_FR" );

    Debug.println ( Debug.TRACE, "TIPO_SERV_ATEM_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TIPO_SERV_ATEM_LOV_FR.jdp" );
