 ...
 */
public class CASOS_HISTORICOS_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CASOS_HISTORICOS_PRINT_PKT ( )
  {
    super ( "CASOS_HISTORICOS_PRINT_PKT" );
   ...
   *
   */
  public CASOS_HISTORICOS_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CASOS_HISTORICOS_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "CASOS_HISTORICOS_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CASOS_HISTORICOS_PRINT_FR ( ) );
   ...
   *
   */
  public static CASOS_HISTORICOS_PRINT_PKT get ( RallyApplication __app )
  {
    return ( CASOS_HISTORICOS_PRINT_PKT ) __app.getNewInstance ( "CASOS_HISTORICOS_PRINT_PKT" );
  }
  ...
  {
    CASOS_HISTORICOS_PRINT_PKT fSheet = CASOS_HISTORICOS_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CASOS_HISTORICOS_PRINT_PKT.exec ( __app );
  }
