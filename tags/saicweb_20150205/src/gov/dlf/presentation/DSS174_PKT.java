     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS174_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS174_PKT ( MDIFrame pFrame )
  {
    super ( "DSS174_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS174_FR ( ) );
   ...
   *
   */
  public static DSS174_PKT get ( RallyApplication __app )
  {
    return ( DSS174_PKT ) __app.getNewInstance ( "DSS174_PKT" );
  }
  ...
  {
    DSS174_PKT fSheet = DSS174_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; GET_DSS174_SET_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; DSS174_GET_NOMBRE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
