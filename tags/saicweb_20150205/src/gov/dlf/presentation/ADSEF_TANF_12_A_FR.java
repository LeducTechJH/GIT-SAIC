 ...
 */
public class ADSEF_TANF_12_A_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public ADSEF_TANF_12_A_FR ( )
  {
    super ( );
    this.setName ( "ADSEF_TANF_12_A_FR" );

    Debug.println ( Debug.TRACE, "ADSEF_TANF_12_A_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ADSEF_TANF_12_A_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new ADSEF_TANF_12_A_FR_SEGSOCProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "NOMBRE" );
    field.setValueProvider ( new ADSEF_TANF_12_A_FR_NOMBREProvider ( this ) );
 ...
 *
 */
class ADSEF_TANF_12_A_FR_SEGSOCProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public ADSEF_TANF_12_A_FR_SEGSOCProvider ( Form form )
  {
    this.model = form;
  }
  ...
  public Object getValue ( )
  {
    ...
    return ADSEF_TANF_12_A_ADL.getSEGSOCDouble ( this.app );
  }
}
 ...
 *
 */
class ADSEF_TANF_12_A_FR_NOMBREProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ADSEF_TANF_12_A_FR_NOMBREProvider ( Form form )
  {
    this.model = form;
  }
  ...
  {
    if ( this.app == null ) this.app = ( SAIC_DMQ_ORA_Application ) this.model.getApplication ( );
    return ADSEF_TANF_12_A_ADL.getNOMBRE ( this.app );
  }
}
