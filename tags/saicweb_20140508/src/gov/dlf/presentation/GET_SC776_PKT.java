     ...
     extends FormSheet
{
   ...
   *
   */
  public GET_SC776_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GET_SC776_PKT ( MDIFrame pFrame )
  {
    super ( "GET_SC776_PKT", pFrame );
  ...
  {
    this.createComponents ( new GET_SC776_FR ( ) );
   ...
   *
   */
  public static GET_SC776_PKT get ( RallyApplication __app )
  {
    return ( GET_SC776_PKT ) __app.getNewInstance ( "GET_SC776_PKT" );
  }
  ...
  {
    GET_SC776_PKT fSheet = GET_SC776_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GET_SC776_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SC776_PERSONA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
