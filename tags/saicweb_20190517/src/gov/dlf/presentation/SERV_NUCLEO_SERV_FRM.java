		...
		this.registerListener ( "EMER_NUM_CUENTA", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				...
				{	  
					...
					if (Compare.gt(cantAuto, 650))
					{
						app.setError ("0", "La cantidad autorizada de atraso o pago de luz sobrepasa los $650.00.");
						app.form("SERV_NUCLEO_SERV_FRM").setItem("CANTIDAD_AUTO", 650);
						app.errorFlag = true;
						return app.errorFlag;
					}
					app.errorFlag = true;
