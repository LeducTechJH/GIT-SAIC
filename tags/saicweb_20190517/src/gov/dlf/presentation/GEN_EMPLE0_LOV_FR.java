 ...
 */
public class GEN_EMPLE0_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_EMPLE0_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_EMPLE0_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_EMPLE0_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_EMPLE0_LOV_FR.jdp" );
