     ...
     extends FormSheet
{
   ...
   *
   */
  public CITAS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CITAS_PKT ( MDIFrame pFrame )
  {
    super ( "CITAS_PKT", pFrame );
  ...
  {
    this.createComponents ( new CITAS_FR ( ) );
   ...
   *
   */
  public static CITAS_PKT get ( RallyApplication __app )
  {
    return ( CITAS_PKT ) __app.getNewInstance ( "CITAS_PKT" );
  }
  ...
  {
    CITAS_PKT fSheet = CITAS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CHEK_CITAS_AGGY_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
