     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "DSS174_FR" );

    Debug.println ( Debug.TRACE, "DSS174_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DSS174_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "DAT1", new DSS174_FR_DAT1_Arguments ( this ) );
 ...
 *
 */
class DSS174_FR_DAT1_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public DSS174_FR_DAT1_Arguments ( Form form )
  {
    this.model = form;
