     ...
     extends ADL
{
  ...
  {
    ( ( ESFU_ELEG_ADL ) __app.getADL ( ESFU_ELEG_ADL.class ) ).NGET_CMD = value.getDouble ( );
  }  
  ...
  {
    ( ( ESFU_ELEG_ADL ) __app.getADL ( ESFU_ELEG_ADL.class ) ).OLD_COMMAND = value.getString ( );
  }  
  ...
  {
    return ( ( ESFU_ELEG_ADL ) __app.getADL ( ESFU_ELEG_ADL.class ) ).OLD_COMMAND;
  }
  ...
  {
    ( ( ESFU_ELEG_ADL ) __app.getADL ( ESFU_ELEG_ADL.class ) ).OLD_COMMAND = value;
  }
  ...
  {
    ( ( ESFU_ELEG_ADL ) __app.getADL ( ESFU_ELEG_ADL.class ) ).OLD_COMMAND = ( String ) value;
  }
  ...
  {
    return ( ( ESFU_ELEG_ADL ) __app.getADL ( ESFU_ELEG_ADL.class ) ).NGET_CMD;
  }
  ...
  {
    return new Double ( ( ( ESFU_ELEG_ADL ) __app.getADL ( ESFU_ELEG_ADL.class ) ).NGET_CMD );
  }
  ...
  {
    ( ( ESFU_ELEG_ADL ) __app.getADL ( ESFU_ELEG_ADL.class ) ).NGET_CMD = value;
  }
  ...
  {
    ( ( ESFU_ELEG_ADL ) __app.getADL ( ESFU_ELEG_ADL.class ) ).NGET_CMD = ( ( Double ) value ).doubleValue ( );
  }
   ...
   * @return
   */
  public static ESFU_ELEG_ADL get ( RallyApplication __app )
  {
    ESFU_ELEG_ADL adl = new ESFU_ELEG_ADL ( );
    __app.register ( adl, "ESFU_ELEG_ADL" );
    __app.setADL ( ESFU_ELEG_ADL.class, adl ); 
  ...
  {
    ESFU_ELEG_ADL.get ( __app ).process ( ps );
  }
  ...
  public void unregister ( )
  {
    ...
    IRegisteredObject rObj = this.app.get ( "ESFU_ELEG_ADL" );
    if ( rObj != null && rObj instanceof ESFU_ELEG_ADL )
    {
      this.app.setADL ( ESFU_ELEG_ADL.class, ( ESFU_ELEG_ADL ) rObj );
    }
  }
  ...
  {
    Debug.println ( Debug.TRACE, "ESFU_ELEG_ADL Step " + this.currentStep );
    super.process ( ps );
    switch ( this.currentStep ) 
    {
      ...
      { 
        this.currentStep = 0;
        Debug.println ( Debug.TRACE, "ESFU_ELEG_ADL ended" );
        this.unregister ( );
        break;
      }
    }
