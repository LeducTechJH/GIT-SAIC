     ...
     extends Form
{
   ...
   *
   */
  public PROV_SERV_LOV_FR ( )
  {
    super ( );
    this.setName ( "PROV_SERV_LOV_FR" );

    Debug.println ( Debug.TRACE, "PROV_SERV_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/PROV_SERV_LOV_FR.jdp" );
