	...
	if ( ( Compare.equals ( this.app.form ( "AUTPAG_FR" ).getStringItem ( "STAT_AUTO" ), "S" ) ) && ( ! Compare.equals ( this.app.form ( "AUTPAG_FR" ).getStringItem ( "UPDATED" ), "U" ) )  )
    {
      ...
      if ( ! Compare.equals ( this.app.form ( "AUTPAG_FR" ).getStringItem ( "MODO_PAGO" ), "AJU+" ) )
      {
        if ( Compare.lt ( this.dm.getFieldDouble ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "VLR_BALANCE" ), this.app.form ( "AUTPAG_FR" ).getDoubleItem ( "VLR_CANTIDAD" )) )
        {
          ...
          PAGO_EXCESO = MathService.minus ( this.dm.getFieldDouble ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "VLR_BALANCE" ), this.app.form ( "AUTPAG_FR" ).getDoubleItem ( "VLR_CANTIDAD" ));
          PAGO_EXCESO = Math.abs(PAGO_EXCESO);
          this.dm.setField ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "VLR_BALANCE", 0);
          this.dm.setField ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "PAGOS_EFECTUADOS_EXCESO", PAGO_EXCESO);
          this.app.setError ( 7, 7980 );
      ...
      if ( ! Compare.equals ( this.app.form ( "AUTPAG_FR" ).getStringItem ( "MODO_PAGO" ), "AJU+" ) )
      {
        ...
        {
          //Pago Efectuado es igual al balance pendiente, queda saldo y se resta el pago al balance pentiendte.
          this.dm.setField ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "STATUS", "SALDADA" );          
