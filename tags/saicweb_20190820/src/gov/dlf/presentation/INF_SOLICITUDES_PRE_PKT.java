 ...
 */
public class INF_SOLICITUDES_PRE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INF_SOLICITUDES_PRE_PKT ( )
  {
    super ( "INF_SOLICITUDES_PRE_PKT" );
   ...
   *
   */
  public INF_SOLICITUDES_PRE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INF_SOLICITUDES_PRE_PKT ( MDIFrame pFrame )
  {
    super ( "INF_SOLICITUDES_PRE_PKT", pFrame );
  ...
  {
    this.createComponents ( new INF_SOLICITUDES_PRE_FR ( ) );
   ...
   *
   */
  public static INF_SOLICITUDES_PRE_PKT get ( RallyApplication __app )
  {
    return ( INF_SOLICITUDES_PRE_PKT ) __app.getNewInstance ( "INF_SOLICITUDES_PRE_PKT" );
  }
  ...
  {
    INF_SOLICITUDES_PRE_PKT fSheet = INF_SOLICITUDES_PRE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INF_SOLICITUDES_PRE_PKT.exec ( __app );
  }
