 ...
 */
public class DETERMINACION_PANB_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public DETERMINACION_PANB_PRINT_PKT ( )
  {
    super ( "DETERMINACION_PANB_PRINT_PKT" );
   ...
   *
   */
  public DETERMINACION_PANB_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DETERMINACION_PANB_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "DETERMINACION_PANB_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new DETERMINACION_PANB_FR ( ) );
   ...
   *
   */
  public static DETERMINACION_PANB_PRINT_PKT get ( RallyApplication __app )
  {
    return ( DETERMINACION_PANB_PRINT_PKT ) __app.getNewInstance ( "DETERMINACION_PANB_PRINT_PKT" );
  }
  ...
  {
    DETERMINACION_PANB_PRINT_PKT fSheet = DETERMINACION_PANB_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DETERMINACION_PANB_PRINT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; PASE_DE_VARIABLES_PANB_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
