 ...
 */
public class CODIGO_SERVICIO_GASTOS_RPT
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CODIGO_SERVICIO_GASTOS_RPT ( )
  {
    super ( );
    this.setName ( "CODIGO_SERVICIO_GASTOS_RPT" );

    Debug.println ( Debug.TRACE, "CODIGO_SERVICIO_GASTOS_RPT - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CODIGO_SERVICIO_GASTOS_RPT.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new CODIGO_SERVICIO_GASTOS_RPT_FECHAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "USUARIO" );
    field.setValueProvider ( new CODIGO_SERVICIO_GASTOS_RPT_USUARIOProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new CODIGO_SERVICIO_GASTOS_RPT_OFICINAProvider ( this ) );
 ...
 *
 */
class CODIGO_SERVICIO_GASTOS_RPT_FECHAProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public CODIGO_SERVICIO_GASTOS_RPT_FECHAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class CODIGO_SERVICIO_GASTOS_RPT_USUARIOProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CODIGO_SERVICIO_GASTOS_RPT_USUARIOProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class CODIGO_SERVICIO_GASTOS_RPT_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CODIGO_SERVICIO_GASTOS_RPT_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
