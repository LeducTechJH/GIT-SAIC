     ...
     extends FormSheet
{
   ...
   *
   */
  public COMMENT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public COMMENT_PKT ( MDIFrame pFrame )
  {
    super ( "COMMENT_PKT", pFrame );
  ...
  {
    this.createComponents ( new COMMENT_FR ( ) );
   ...
   *
   */
  public static COMMENT_PKT get ( RallyApplication __app )
  {
    return ( COMMENT_PKT ) __app.getNewInstance ( "COMMENT_PKT" );
  }
  ...
  {
    COMMENT_PKT fSheet = COMMENT_PKT.get ( __app );
    fSheet.execute ( null );
