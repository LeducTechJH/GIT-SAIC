     ...
     extends FormSheet
{
   ...
   *
   */
  public TARIFAS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TARIFAS_PKT ( MDIFrame pFrame )
  {
    super ( "TARIFAS_PKT", pFrame );
  ...
  {
    this.createComponents ( new TARIFAS_FR ( ) );
   ...
   *
   */
  public static TARIFAS_PKT get ( RallyApplication __app )
  {
    return ( TARIFAS_PKT ) __app.getNewInstance ( "TARIFAS_PKT" );
  }
  ...
  {
    TARIFAS_PKT fSheet = TARIFAS_PKT.get ( __app );
    fSheet.execute ( null );
