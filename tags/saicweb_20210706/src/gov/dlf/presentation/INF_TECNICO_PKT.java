     ...
     extends FormSheet
{
   ...
   *
   */
  public INF_TECNICO_PKT ( )
  {
    super ( "INF_TECNICO_PKT" );
   ...
   *
   */
  public INF_TECNICO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INF_TECNICO_PKT ( MDIFrame pFrame )
  {
    super ( "INF_TECNICO_PKT", pFrame );
  ...
  {
    this.createComponents ( new INF_TECNICO_FR ( ) );
   ...
   *
   */
  public static INF_TECNICO_PKT get ( RallyApplication __app )
  {
    return ( INF_TECNICO_PKT ) __app.getNewInstance ( "INF_TECNICO_PKT" );
  }
  ...
  {
    INF_TECNICO_PKT fSheet = INF_TECNICO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INF_TECNICO_PKT.exec ( __app );
  }
