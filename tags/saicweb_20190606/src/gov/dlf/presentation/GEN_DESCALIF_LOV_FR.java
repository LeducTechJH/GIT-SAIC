 ...
 */
public class GEN_DESCALIF_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_DESCALIF_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_DESCALIF_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_DESCALIF_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_DESCALIF_LOV_FR.jdp" );
