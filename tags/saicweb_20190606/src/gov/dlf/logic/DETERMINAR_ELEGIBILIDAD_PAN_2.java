...
//									SALARIO_TEMP = SALARIO_TEMP * 0;
								...
								{
									SALARIO = MathService.plus ( SALARIO, this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) *0.33 );
//									SALARIO_TEMP = SALARIO_TEMP - ( SALARIO_TEMP *.66 );
								...
								{
									SALARIO = MathService.plus ( SALARIO, this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) *0.66 );
...
//									SALARIO_TEMP = SALARIO_TEMP * 0;
								...
								{
									SALARIO = MathService.plus ( SALARIO, this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) *.33 );
//									SALARIO_TEMP = SALARIO_TEMP - ( SALARIO_TEMP *.66 );
								}
								else if ( Compare.ge(this.dm.getFieldDouble ( this.dm.get ( "PTRA_EMPLEOS2_DSD" ),"REMANENTE" ), 12) && Compare.le(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ),"REMANENTE" ), 17))
								{
									SALARIO = MathService.plus ( SALARIO, this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) *.66 );
//									SALARIO_TEMP = SALARIO_TEMP - ( SALARIO_TEMP *.33 );
								}
								else
								{
