  ...
  implements IRegisteredObject 
{
   ...
   *
   */
  public static REPORT_9_8_PPKT2 get ( RallyApplication __app )
  {
    REPORT_9_8_PPKT2 pp = ( REPORT_9_8_PPKT2 ) __app.getNewInstance ( "REPORT_9_8_PPKT2" );
    return pp;
  }
  ...
  {
    return REPORT_9_8_PPKT2.exec ( __app );
  }
...
public void execute ( ParameterSet ps )
  {
    Debug.println ( Debug.TRACE, "REPORT_9_8_PPKT2" );
    this.prepareParms ( );
...
public void halt ( )
  ...
  {
    this.app.form ( "REPORT_9_22_FR" ).setValue ( "COD_REVISION", this.parms.getString ( 0 ) );
    this.app.form ( "REPORT_9_22_FR" ).setValue ( "NO_REVISION", this.parms.getString ( 1 ) );
  }
  ...
  {
    this.parms.reset ( );
    this.parms.set ( this.app.form ( "REPORT_9_22_FR" ).getValue ( "COD_REVISION" ) );
    this.parms.set ( this.app.form ( "REPORT_9_22_FR" ).getValue ( "NO_REVISION" ) );
  }
