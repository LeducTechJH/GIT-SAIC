...
extends ADL
{
	...
	protected void step0 ( ParameterSet ps )
	{
		...
		{
			if ( Compare.equals( this.dm.getFieldString ( this.dm.get ( "RR_INSERT_RO_DSD" ), "ACCION"), "RECL") && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RR_INSERT_RO_DSD" ), "STATUS" ), "SALDRETR" ) ) 
					|| ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RR_INSERT_RO_DSD" ), "STATUS" ), "COMPRECL" ) ) ) 
			{
				this.app.form ( "REPORT_9_14_FR" ).setItem ( "BAL_RECLA", this.dm.getFieldDouble ( this.dm.get ( "RR_INSERT_RO_DSD" ), "VLR_BALANCE" )  );
				//this.app.form ( "REPORT_9_14_FR" ).setItem ( "BAL_RECLA", this.dm.getFieldDouble ( this.dm.get ( "RR_INSERT_RO_DSD" ), "VLR_BALANCE" )  );
			}
			if ( Compare.equals( this.dm.getFieldString ( this.dm.get ( "RR_INSERT_RO_DSD" ), "ACCION"), "RETR") && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RR_INSERT_RO_DSD" ), "STATUS" ), "AUTORIZA" ) ) ) 
			{
