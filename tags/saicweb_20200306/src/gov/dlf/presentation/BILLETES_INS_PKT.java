     ...
     extends FormSheet
{
   ...
   *
   */
  public BILLETES_INS_PKT ( )
  {
    super ( "BILLETES_INS_PKT" );
   ...
   *
   */
  public BILLETES_INS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public BILLETES_INS_PKT ( MDIFrame pFrame )
  {
    super ( "BILLETES_INS_PKT", pFrame );
  ...
  {
    this.createComponents ( new BILLETES_FR ( ) );
   ...
   *
   */
  public static BILLETES_INS_PKT get ( RallyApplication __app )
  {
    return ( BILLETES_INS_PKT ) __app.getNewInstance ( "BILLETES_INS_PKT" );
  }
  ...
  {
    BILLETES_INS_PKT fSheet = BILLETES_INS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return BILLETES_INS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; BILLETES_INI_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
