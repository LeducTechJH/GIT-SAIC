     ...
     extends FormSheet
{
   ...
   *
   */
  public AUTPAG2_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AUTPAG2_PKT ( MDIFrame pFrame )
  {
    super ( "AUTPAG2_PKT", pFrame );
  ...
  {
    this.createComponents ( new AUTPAG2_FR ( ) );
   ...
   *
   */
  public static AUTPAG2_PKT get ( RallyApplication __app )
  {
    return ( AUTPAG2_PKT ) __app.getNewInstance ( "AUTPAG2_PKT" );
  }
  ...
  {
    AUTPAG2_PKT fSheet = AUTPAG2_PKT.get ( __app );
    fSheet.execute ( null );
