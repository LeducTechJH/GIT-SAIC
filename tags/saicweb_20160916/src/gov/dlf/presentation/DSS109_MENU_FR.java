     ...
     extends Form
{
   ...
   *
   */
  public DSS109_MENU_FR ( )
  {
    super ( );
    this.setName ( "DSS109_MENU_FR" );

    Debug.println ( Debug.TRACE, "DSS109_MENU_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DSS109_MENU_FR.jdp" );
  ...
  {
    this.registerListener ( "DSS109_FCHI", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; DSS109_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "DSS109_LF", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
