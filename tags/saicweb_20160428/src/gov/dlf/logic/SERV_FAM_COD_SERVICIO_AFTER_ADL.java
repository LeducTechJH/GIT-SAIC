     ...
     extends ADL
{
  ...
  protected void step2 ( ParameterSet ps )
  {
    ...
    if(Compare.equals(this.app.form("SERV_FAM_FRM").getStringItem("COD_SERVICIO"), "TANFS") )
    {
    	if( ! Compare.equals(this.app.MACA_GBL, 1))
    	{
    		this.app.setError("0","Solo un manejador de casos puede crear este tipo de servicio.");
    		this.app.errorFlag = false;
			return;
    	}
    }
