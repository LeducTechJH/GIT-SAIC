     ...
     extends FormSheet
{
   ...
   *
   */
  public SC1218_RPT_PKT ( )
  {
    super ( "SC1218_RPT_PKT" );
   ...
   *
   */
  public SC1218_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SC1218_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "SC1218_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new SC1218_RPT_FR ( ) );
   ...
   *
   */
  public static SC1218_RPT_PKT get ( RallyApplication __app )
  {
    return ( SC1218_RPT_PKT ) __app.getNewInstance ( "SC1218_RPT_PKT" );
  }
  ...
  {
    SC1218_RPT_PKT fSheet = SC1218_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SC1218_RPT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SC1218_PRN_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SC1218_CNT_ADL.exec ( app ); return app.errorFlag;
      }
    } );
