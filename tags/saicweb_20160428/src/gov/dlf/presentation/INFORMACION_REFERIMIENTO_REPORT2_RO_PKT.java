 ...
 */
public class INFORMACION_REFERIMIENTO_REPORT2_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INFORMACION_REFERIMIENTO_REPORT2_RO_PKT ( )
  {
    super ( "INFORMACION_REFERIMIENTO_REPORT2_RO_PKT" );
   ...
   *
   */
  public INFORMACION_REFERIMIENTO_REPORT2_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INFORMACION_REFERIMIENTO_REPORT2_RO_PKT ( MDIFrame pFrame )
  {
    super ( "INFORMACION_REFERIMIENTO_REPORT2_RO_PKT", pFrame );
   ...
   *
   */
  public static INFORMACION_REFERIMIENTO_REPORT2_RO_PKT get ( RallyApplication __app )
  {
    return ( INFORMACION_REFERIMIENTO_REPORT2_RO_PKT ) __app.getNewInstance ( "INFORMACION_REFERIMIENTO_REPORT2_RO_PKT" );
  }
  ...
  {
    INFORMACION_REFERIMIENTO_REPORT2_RO_PKT fSheet = INFORMACION_REFERIMIENTO_REPORT2_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INFORMACION_REFERIMIENTO_REPORT2_RO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
	this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; INFORMACION_REFER_PRINT2_PKT.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
