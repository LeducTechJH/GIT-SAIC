     ...
     extends Form
{
   ...
   *
   */
  public DSS221_MENU_FR ( )
  {
    super ( );
    this.setName ( "DSS221_MENU_FR" );

    Debug.println ( Debug.TRACE, "DSS221_MENU_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DSS221_MENU_FR.jdp" );
  ...
  {
    this.registerListener ( "YR", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; DSS221_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "LFIELD", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
