     ...
     extends FormSheet
{
   ...
   *
   */
  public SC1072_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SC1072_PKT ( MDIFrame pFrame )
  {
    super ( "SC1072_PKT", pFrame );
  ...
  {
    this.createComponents ( new SC1072_FR ( ) );
   ...
   *
   */
  public static SC1072_PKT get ( RallyApplication __app )
  {
    return ( SC1072_PKT ) __app.getNewInstance ( "SC1072_PKT" );
  }
  ...
  {
    SC1072_PKT fSheet = SC1072_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; GET_SC1072_SET_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SC1072_GET_NOMBRE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
