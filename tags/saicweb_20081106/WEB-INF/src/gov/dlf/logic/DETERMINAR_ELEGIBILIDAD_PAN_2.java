...
// dasdasdasdasdasd
    ...
    if ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) ) 
    {
      if ( Compare.ge ( this.app.SYSTEM_DATE, RallySpanishDatesParser.parseDateString ( "1-SEP-2008" ) ) )  
      ...
      {    
        if (Compare.ge(MathService.plus(MathService.plus(ANCIANO_COUNT, INCAPACITADO_COUNT), MENOR_COUNT), UNIDAD) && (Compare.equals (INGRESOS_NUCLEO,SEG_SOC) )   ) 
        {
          SEG_SOC =  TruncService.round(SEG_SOC*EXENCION_SEG_SOC,2);
        }
      }
