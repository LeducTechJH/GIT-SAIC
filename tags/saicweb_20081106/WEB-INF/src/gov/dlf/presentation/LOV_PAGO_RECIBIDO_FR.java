 ...
 */
public class LOV_PAGO_RECIBIDO_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public LOV_PAGO_RECIBIDO_FR ( )
  {
    super ( );
    this.setName ( "LOV_PAGO_RECIBIDO_FR" );

    Debug.println ( Debug.TRACE, "LOV_PAGO_RECIBIDO_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/LOV_PAGO_RECIBIDO_FR.jdp" );
