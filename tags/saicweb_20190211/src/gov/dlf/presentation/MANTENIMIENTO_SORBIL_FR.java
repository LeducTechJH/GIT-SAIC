 ...
 */
public class MANTENIMIENTO_SORBIL_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_SORBIL_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_SORBIL_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_SORBIL_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_SORBIL_FR.jdp" );
