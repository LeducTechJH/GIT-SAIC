     ...
     extends FormSheet
{
   ...
   *
   */
  public RECOFI_PRN_PKT ( )
  {
    super ( "RECOFI_PRN_PKT" );
   ...
   *
   */
  public RECOFI_PRN_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RECOFI_PRN_PKT ( MDIFrame pFrame )
  {
    super ( "RECOFI_PRN_PKT", pFrame );
  ...
  {
    this.createComponents ( new RECOFI_PRN_FR ( ) );
   ...
   *
   */
  public static RECOFI_PRN_PKT get ( RallyApplication __app )
  {
    return ( RECOFI_PRN_PKT ) __app.getNewInstance ( "RECOFI_PRN_PKT" );
  }
  ...
  {
    RECOFI_PRN_PKT fSheet = RECOFI_PRN_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RECOFI_PRN_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; RECOFI_BF_PRN_PKT_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
