 ...
 */
public class MANTENIMIENTO_SECTOR_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_SECTOR_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_SECTOR_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_SECTOR_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_SECTOR_FR.jdp" );
