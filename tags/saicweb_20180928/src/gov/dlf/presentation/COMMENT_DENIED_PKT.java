 ...
 */
public class COMMENT_DENIED_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public COMMENT_DENIED_PKT ( )
  {
    super ( "COMMENT_DENIED_PKT" );
   ...
   *
   */
  public COMMENT_DENIED_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public COMMENT_DENIED_PKT ( MDIFrame pFrame )
  {
    super ( "COMMENT_DENIED_PKT", pFrame );
  ...
  {
    this.createComponents ( new COMMENT_DENIED_FR ( ) );
   ...
   *
   */
  public static COMMENT_DENIED_PKT get ( RallyApplication __app )
  {
    return ( COMMENT_DENIED_PKT ) __app.getNewInstance ( "COMMENT_DENIED_PKT" );
  }
  ...
  {
    COMMENT_DENIED_PKT fSheet = COMMENT_DENIED_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return COMMENT_DENIED_PKT.exec ( __app );
  }
