 ...
 */
public class RECLA_DETERMINADAS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public RECLA_DETERMINADAS_PKT ( )
  {
    super ( "RECLA_DETERMINADAS_PKT" );
   ...
   *
   */
  public RECLA_DETERMINADAS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RECLA_DETERMINADAS_PKT ( MDIFrame pFrame )
  {
    super ( "RECLA_DETERMINADAS_PKT", pFrame );
  ...
  {
    this.createComponents ( new RECLA_DETERMINADAS_FRM ( ) );
   ...
   *
   */
  public static RECLA_DETERMINADAS_PKT get ( RallyApplication __app )
  {
    return ( RECLA_DETERMINADAS_PKT ) __app.getNewInstance ( "RECLA_DETERMINADAS_PKT" );
  }
  ...
  {
    RECLA_DETERMINADAS_PKT fSheet = RECLA_DETERMINADAS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RECLA_DETERMINADAS_PKT.exec ( __app );
  }
