    ...
    this.registerListener ( "EMER_NUM_CUENTA", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
    	  ...
    	  if (  serv.equals ( "LICE1" ) )
    	  {
    		  ...
    		  if ( Compare.equals(app.form("SERV_NUCLEO_SERV_FRM").getStringItem("NOTIF_CORTE_SERV"), "N")&&Compare.equals(app.form("SERV_NUCLEO_SERV_FRM").getStringItem("ORDEN_CORTE_SERV"), "N"))
    		  {
    			  app.setError ("0", "La factura no presenta notificacion de corte de servicio.");
