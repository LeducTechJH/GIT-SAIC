...
extends ADL
{
	...
	{
	    if(  Compare.equals(this.app.MACA_GBL, 1)&&(Compare.equals(this.app.form  ( "SERV_FAM_FRM" ).getStringItem ( "COD_SERVICIO" ),"AE-C") || Compare.equals( this.app.form ( "SERV_FAM_FRM" ).getStringItem ( "COD_SERVICIO" ),"TANFS")||Compare.equals( this.app.form ( "SERV_FAM_FRM" ).getStringItem ( "COD_SERVICIO" ),"TANFE")))
	    {
	    	this.app.ACCESS_STATUS_GBL= "SUCESS" ;
	    	return;
	    }
	    else 	    if(  Compare.equals(this.app.OELP_GBL, 1)&&(Compare.equals( this.app.form ( "SERV_FAM_FRM" ).getStringItem ( "COD_SERVICIO" ),"LICE1")||Compare.equals( this.app.form ( "SERV_FAM_FRM" ).getStringItem ( "COD_SERVICIO" ),"LISE")))
	    {
	    	this.app.ACCESS_STATUS_GBL= "SUCESS" ;
	    	return;
	    }
