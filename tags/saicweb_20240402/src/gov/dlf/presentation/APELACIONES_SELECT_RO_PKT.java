 ...
 */
public class APELACIONES_SELECT_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public APELACIONES_SELECT_RO_PKT ( )
  {
    super ( "APELACIONES_SELECT_RO_PKT" );
   ...
   *
   */
  public APELACIONES_SELECT_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public APELACIONES_SELECT_RO_PKT ( MDIFrame pFrame )
  {
    super ( "APELACIONES_SELECT_RO_PKT", pFrame );
   ...
   *
   */
  public static APELACIONES_SELECT_RO_PKT get ( RallyApplication __app )
  {
    return ( APELACIONES_SELECT_RO_PKT ) __app.getNewInstance ( "APELACIONES_SELECT_RO_PKT" );
  }
  ...
  {
    APELACIONES_SELECT_RO_PKT fSheet = APELACIONES_SELECT_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return APELACIONES_SELECT_RO_PKT.exec ( __app );
  }
