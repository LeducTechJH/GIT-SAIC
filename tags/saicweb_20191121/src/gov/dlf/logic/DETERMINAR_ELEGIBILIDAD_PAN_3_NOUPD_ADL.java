...
//*****
    ...
    while ( Compare.equals ( STATUS_CODE, 0 )  )
    {
      ...
      {
        EDAD_IND = DateUtil.monthsBetween ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getDateItem ( "MES_ANO_BENEFICIO_CORRE`CTO" ), this.dm.getFieldDate ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FCH_NACIMIENTO" ) ) / 12;
      }
    ...
    //if ( Compare.equals (STATUS_CODE, 0) )
    {
      ...
      if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "ACNE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  && ( Compare.lt ( DateUtil.monthsBetween ( this.app.SYSTEM_DATE, this.dm.getFieldDate ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FCH_NACIMIENTO" ) ) / 12, 60 ) )  )
      {
   ...
   // ll cuido
          ...
          else if ( Compare.ge( EDAD_IND, 2)  && Compare.le( EDAD_IND, 17) ) 
          {
        	  MENOR_MAYOR2YEARS = MathService.plus(MENOR_MAYOR2YEARS, 1);
          }
...
else if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) || ( Compare.equals ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "FLG_EMERGENCIA_CORRECTA" ), "E" ) ) )
    {
