 ...
 */
public class RAZON_60_MESES_TANF
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public RAZON_60_MESES_TANF ( )
  {
    super ( );
    this.setName ( "RAZON_60_MESES_TANF" );

    Debug.println ( Debug.TRACE, "RAZON_60_MESES_TANF - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RAZON_60_MESES_TANF.jdp" );
