 ...
 */
public class REPORT_SOLICITUD_APELACION_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REPORT_SOLICITUD_APELACION_PKT ( )
  {
    super ( "REPORT_SOLICITUD_APELACION_PKT" );
   ...
   *
   */
  public REPORT_SOLICITUD_APELACION_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REPORT_SOLICITUD_APELACION_PKT ( MDIFrame pFrame )
  {
    super ( "REPORT_SOLICITUD_APELACION_PKT", pFrame );
  ...
  {
    this.createComponents ( new REPORT_SOLICITUD_APELACION ( ) );
   ...
   *
   */
  public static REPORT_SOLICITUD_APELACION_PKT get ( RallyApplication __app )
  {
    return ( REPORT_SOLICITUD_APELACION_PKT ) __app.getNewInstance ( "REPORT_SOLICITUD_APELACION_PKT" );
  }
  ...
  {
    REPORT_SOLICITUD_APELACION_PKT fSheet = REPORT_SOLICITUD_APELACION_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REPORT_SOLICITUD_APELACION_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; LLENAR_SOLICITUD_SERVICIO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
