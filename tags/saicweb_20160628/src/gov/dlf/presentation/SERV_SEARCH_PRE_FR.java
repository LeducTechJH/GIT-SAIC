 ...
 */
public class SERV_SEARCH_PRE_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SERV_SEARCH_PRE_FR ( )
  {
    super ( );
    this.setName ( "SERV_SEARCH_PRE_FR" );

    Debug.println ( Debug.TRACE, "SERV_SEARCH_PRE_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SERV_SEARCH_PRE_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "FINISH_ACTION", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      { 
        app.errorFlag = true; SERV_SEARCH_ADL.exec ( app ); return app.errorFlag;    
      }
    } );
  }
}
