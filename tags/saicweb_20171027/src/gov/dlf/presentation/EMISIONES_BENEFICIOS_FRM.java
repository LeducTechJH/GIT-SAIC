 ...
 */
public class EMISIONES_BENEFICIOS_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public EMISIONES_BENEFICIOS_FRM ( )
  {
    super ( );
    this.setName ( "EMISIONES_BENEFICIOS_FRM" );

    Debug.println ( Debug.TRACE, "EMISIONES_BENEFICIOS_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/EMISIONES_BENEFICIOS_FRM.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "EMISIONES_BENEFICIOS_GP", new EMISIONES_BENEFICIOS_GP_Arguments ( this ) );
  ...
  {
	  this.registerListener ( "EMISIONES_BENEFICIOS_GP", JDataPanelListener.HOTKEYPRESS, new JDataPanelListener ( )
	    {
	      public boolean eventFired ( String eventName )
	      {
	        app.errorFlag = true; 
	        if(Compare.equals(app.getCOD_SERV_GBL ( ), "TANFS")||Compare.equals(app.getCOD_SERV_GBL ( ), "TANFE"))
	        {
	        EMISIONES_BENEFICIOS_SOST_SUB_PKT.exec ( app, null );
	        }
	        else
	        {
	        EMISIONES_BENEFICIOS_SUB_PKT.exec ( app, null );
	        }
...
class EMISIONES_BENEFICIOS_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public EMISIONES_BENEFICIOS_GP_Arguments ( Form form )
  {
    this.model = form;
