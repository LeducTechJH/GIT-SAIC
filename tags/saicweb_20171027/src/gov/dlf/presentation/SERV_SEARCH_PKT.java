     ...
     extends FormSheet
{
   ...
   *
   */
  public SERV_SEARCH_PKT ( )
  {
    super ( "SERV_SEARCH_PKT" );
   ...
   *
   */
  public SERV_SEARCH_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SERV_SEARCH_PKT ( MDIFrame pFrame )
  {
    super ( "SERV_SEARCH_PKT", pFrame );
   ...
   *
   */
  public static SERV_SEARCH_PKT get ( RallyApplication __app )
  {
    return ( SERV_SEARCH_PKT ) __app.getNewInstance ( "SERV_SEARCH_PKT" );
  }
  ...
  {
    SERV_SEARCH_PKT fSheet = SERV_SEARCH_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SERV_SEARCH_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_CONSULTA_SERVICIOS_MENU.exec ( app, null );
