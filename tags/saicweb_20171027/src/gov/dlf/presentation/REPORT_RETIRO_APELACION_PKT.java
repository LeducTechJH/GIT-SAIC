 ...
 */
public class REPORT_RETIRO_APELACION_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REPORT_RETIRO_APELACION_PKT ( )
  {
    super ( "REPORT_RETIRO_APELACION_PKT" );
   ...
   *
   */
  public REPORT_RETIRO_APELACION_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REPORT_RETIRO_APELACION_PKT ( MDIFrame pFrame )
  {
    super ( "REPORT_RETIRO_APELACION_PKT", pFrame );
  ...
  {
    this.createComponents ( new REPORT_RETIRO_APELACION_PRT ( ) );
   ...
   *
   */
  public static REPORT_RETIRO_APELACION_PKT get ( RallyApplication __app )
  {
    return ( REPORT_RETIRO_APELACION_PKT ) __app.getNewInstance ( "REPORT_RETIRO_APELACION_PKT" );
  }
  ...
  {
    REPORT_RETIRO_APELACION_PKT fSheet = REPORT_RETIRO_APELACION_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REPORT_RETIRO_APELACION_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; LLENAR_RETIRO_APELACIONES_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
