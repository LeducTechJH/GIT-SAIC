 ...
 */
public class INF_FECHAS_VENCE_PRE_TANF_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public INF_FECHAS_VENCE_PRE_TANF_FR ( )
  {
    super ( );
    this.setName ( "INF_FECHAS_VENCE_PRE_TANF_FR" );

    Debug.println ( Debug.TRACE, "INF_FECHAS_VENCE_PRE_TANF_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/INF_FECHAS_VENCE_PRE_TANF_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "FINISH_ACTION", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      { 
        app.errorFlag = true; INF_FECHAS_VENCE_TANF_ADL.exec ( app ); return app.errorFlag;    
      }
    } );
  }
}
