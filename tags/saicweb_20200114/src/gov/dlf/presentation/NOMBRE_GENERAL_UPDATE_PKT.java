 ...
 */
public class NOMBRE_GENERAL_UPDATE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public NOMBRE_GENERAL_UPDATE_PKT ( )
  {
    super ( "NOMBRE_GENERAL_UPDATE_PKT" );
   ...
   *
   */
  public NOMBRE_GENERAL_UPDATE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public NOMBRE_GENERAL_UPDATE_PKT ( MDIFrame pFrame )
  {
    super ( "NOMBRE_GENERAL_UPDATE_PKT", pFrame );
   ...
   *
   */
  public static NOMBRE_GENERAL_UPDATE_PKT get ( RallyApplication __app )
  {
    return ( NOMBRE_GENERAL_UPDATE_PKT ) __app.getNewInstance ( "NOMBRE_GENERAL_UPDATE_PKT" );
  }
  ...
  {
    NOMBRE_GENERAL_UPDATE_PKT fSheet = NOMBRE_GENERAL_UPDATE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return NOMBRE_GENERAL_UPDATE_PKT.exec ( __app );
  }
