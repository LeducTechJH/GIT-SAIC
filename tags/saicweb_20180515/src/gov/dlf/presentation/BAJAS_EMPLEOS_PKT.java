 ...
 */
public class BAJAS_EMPLEOS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public BAJAS_EMPLEOS_PKT ( )
  {
    super ( "BAJAS_EMPLEOS_PKT" );
   ...
   *
   */
  public BAJAS_EMPLEOS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public BAJAS_EMPLEOS_PKT ( MDIFrame pFrame )
  {
    super ( "BAJAS_EMPLEOS_PKT", pFrame );
  ...
  {
    this.createComponents ( new BAJAS_EMPLEO_RP ( ) );
   ...
   *
   */
  public static BAJAS_EMPLEOS_PKT get ( RallyApplication __app )
  {
    return ( BAJAS_EMPLEOS_PKT ) __app.getNewInstance ( "BAJAS_EMPLEOS_PKT" );
  }
  ...
  {
    BAJAS_EMPLEOS_PKT fSheet = BAJAS_EMPLEOS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return BAJAS_EMPLEOS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_BAJAS_MENU.exec ( app, null );
 return app.errorFlag;
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; BAJAS_EMPLEO_BEF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
