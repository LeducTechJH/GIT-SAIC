     ...
     extends Form
{
  ...
  {	    
	    ...
	    this.registerListener ( "TIPO_TRANS", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				app.form("SERV_SOST2_FRM").setItem("COD_SERVICIO", "TANFE");
				app.errorFlag = true; 
				String serv = __form.getStringValue ( "SERV_SOST" );
				String tipo = __form.getStringValue ( "TIPO_TRANS" );
				app.form("SERV_SOST2_FRM").setItem("PAGO_SOST", 0);
				if(Compare.equals(serv, "ESFU"))
				{
					if( ! (Compare.equals(tipo, "ES01") || (Compare.equals(tipo, "ES02"))|| (Compare.equals(tipo, "ES03"))|| (Compare.equals(tipo, "EC01"))|| (Compare.equals(tipo, "EC02")))) 
					{
...
//	    this.registerListener ( "PAGO_SOST", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
//		{
//			public boolean eventFired ( String eventName )
//			{
//				app.errorFlag = true; 
//				double pago = __form.getDoubleValue ( "PAGO_SOST" );
//				if ( Compare.gt(pago, 0))
//				{
//					app.setError ("0", "Este servicio no permite ajustar cantidad de pago manual.");
//					app.form("SERV_SOST2_FRM").setItem("PAGO_SOST", 0);
//					app.errorFlag = false; 
//				}
//				return app.errorFlag;
//			}
//		} );
	    this.registerListener ( "CUMPLE_HRS", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				app.errorFlag = true; 
				String cumple = app.form ( "SERV_SOST2_FRM" ).getStringItem( "CUMPLE_HRS" );
				if ( ! ( ( Compare.equals ( cumple, "S" ) ) || ( Compare.equals ( cumple, "N" ) ) ) )
				{
