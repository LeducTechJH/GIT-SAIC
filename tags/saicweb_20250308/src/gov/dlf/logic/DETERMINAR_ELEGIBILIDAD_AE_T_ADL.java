     ...
     extends ADL
{
  ...
  {
    ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).OPEN7_ID = value.getDouble ( );
  }  
  ...
  {
    ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).STATUS7_CODE = value.getDouble ( );
  }  
  ...
  {
    ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).NECESIDAD = value.getDouble ( );
  }  
...
{
  return ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).OPEN7_ID;
}
...
{
  return new Double ( ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).OPEN7_ID );
}
...
{
  ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).OPEN7_ID = value;
}
...
{
  ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).OPEN7_ID = ( ( Double ) value ).doubleValue ( );
}
...
{
  return ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).STATUS7_CODE;
}
...
{
  return new Double ( ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).STATUS7_CODE );
}
...
{
  ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).STATUS7_CODE = value;
}
...
{
  ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).STATUS7_CODE = ( ( Double ) value ).doubleValue ( );
}
  ...
  {
    return ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).NECESIDAD;
  }

  /**  */
public static Double getNECESIDAD_Double ( RallyApplication __app )
{
  return new Double ( ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).NECESIDAD );
}
...
{
  ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).NECESIDAD = value;
}
...
{
  ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).NECESIDAD = ( ( Double ) value ).doubleValue ( );
}
  ...
  protected void step5 ( ParameterSet ps )
  {
    ...
    while ( ( Compare.equals ( STATUS7_CODE, 0 ) ) && ( Compare.le ( this.dm.getFieldDate ( this.dm.get ( "DETERMINA_RO_DSD" ), "FECHA_EFECTIVIDAD" ), FCH_EMISION ) )   )
    {
        ...
        {
          NECESIDAD = this.dm.getFieldDouble ( this.dm.get ( "DETERMINA_RO_DSD" ), "NECESIDAD_AJUSTADA_HOSU" );
        }
        else
        {
          NECESIDAD = this.dm.getFieldDouble ( this.dm.get ( "DETERMINA_RO_DSD" ), "NECESIDAD_AJUSTADA" );
        }
    ...
    while ( Compare.equals ( STATUS_CODE, 0 )  )
    {
      ...
      {
        NECESIDAD_AJUSTADA = MathService.plus (NECESIDAD, ( ( MathService.minus ( NUM_FAMILIA, 1  ) ) * NECESIDAD )  );
      }
    }
