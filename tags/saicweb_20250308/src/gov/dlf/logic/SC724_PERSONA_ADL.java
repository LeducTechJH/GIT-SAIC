     ...
     extends ADL
{
  ...
  protected void step1 ( ParameterSet ps )
  {
    ...
    if ( this._condition1 )
    {
      ...
      this.app.RR_FCH_IDN = this.app.FCH_FINAL_GBL;
      this.app.FECHA_PLUS_15_GBL = MathService.plus ( this.app.SYSTEM_DATE, 15  );
      if (Compare.equals(this.app.form ( "GET_SC724_FR" ).getStringItem ( "SERVICIO" ),"PAN" ) )
      {
      this.app.printChain ( "SC724_PKT;DSS109_REC_PKT;ADSEF_DIP_2_PKT" );
      }
      else
      {
    	  if (Compare.equals(RallyStringService.subString (this.app.form ( "GET_SC724_FR" ).getStringItem ( "SERVICIO" ),0,2),"AE" ) )
          {
    	      this.app.printChain ( "SC724_PKT;DSS109_REC_PKT;ADSEF_DIP_2T_PKT" );
    	   }
