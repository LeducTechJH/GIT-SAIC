 ...
 */
public class CLASIFICACION_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CLASIFICACION_LOV_FR ( )
  {
    super ( );
    this.setName ( "CLASIFICACION_LOV_FR" );

    Debug.println ( Debug.TRACE, "CLASIFICACION_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CLASIFICACION_LOV_FR.jdp" );
