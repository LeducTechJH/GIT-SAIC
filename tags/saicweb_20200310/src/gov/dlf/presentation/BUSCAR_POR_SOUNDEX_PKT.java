 ...
 */
public class BUSCAR_POR_SOUNDEX_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public BUSCAR_POR_SOUNDEX_PKT ( )
  {
    super ( "BUSCAR_POR_SOUNDEX_PKT" );
   ...
   *
   */
  public BUSCAR_POR_SOUNDEX_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public BUSCAR_POR_SOUNDEX_PKT ( MDIFrame pFrame )
  {
    super ( "BUSCAR_POR_SOUNDEX_PKT", pFrame );
   ...
   *
   */
  public static BUSCAR_POR_SOUNDEX_PKT get ( RallyApplication __app )
  {
    return ( BUSCAR_POR_SOUNDEX_PKT ) __app.getNewInstance ( "BUSCAR_POR_SOUNDEX_PKT" );
  }
  ...
  {
    BUSCAR_POR_SOUNDEX_PKT fSheet = BUSCAR_POR_SOUNDEX_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return BUSCAR_POR_SOUNDEX_PKT.exec ( __app );
  }
