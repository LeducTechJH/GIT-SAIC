     ...
     extends FormSheet
{
   ...
   *
   */
  public SEL_MES_PTRA_PKT ( )
  {
    super ( "SEL_MES_PTRA_PKT" );
   ...
   *
   */
  public SEL_MES_PTRA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SEL_MES_PTRA_PKT ( MDIFrame pFrame )
  {
    super ( "SEL_MES_PTRA_PKT", pFrame );
  ...
  {
    this.createComponents ( new SEL_MES_PTRA_FR ( ) );
   ...
   *
   */
  public static SEL_MES_PTRA_PKT get ( RallyApplication __app )
  {
    return ( SEL_MES_PTRA_PKT ) __app.getNewInstance ( "SEL_MES_PTRA_PKT" );
  }
  ...
  {
    SEL_MES_PTRA_PKT fSheet = SEL_MES_PTRA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SEL_MES_PTRA_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SEL_MES_PTRA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
