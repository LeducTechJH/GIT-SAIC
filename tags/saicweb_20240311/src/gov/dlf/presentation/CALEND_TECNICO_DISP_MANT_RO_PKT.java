 ...
 */
public class CALEND_TECNICO_DISP_MANT_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CALEND_TECNICO_DISP_MANT_RO_PKT ( )
  {
    super ( "CALEND_TECNICO_DISP_MANT_RO_PKT" );
   ...
   *
   */
  public CALEND_TECNICO_DISP_MANT_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CALEND_TECNICO_DISP_MANT_RO_PKT ( MDIFrame pFrame )
  {
    super ( "CALEND_TECNICO_DISP_MANT_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new CALEND_TECNICO_DISP_MANT_FR ( ) );
   ...
   *
   */
  public static CALEND_TECNICO_DISP_MANT_RO_PKT get ( RallyApplication __app )
  {
    return ( CALEND_TECNICO_DISP_MANT_RO_PKT ) __app.getNewInstance ( "CALEND_TECNICO_DISP_MANT_RO_PKT" );
  }
  ...
  {
    CALEND_TECNICO_DISP_MANT_RO_PKT fSheet = CALEND_TECNICO_DISP_MANT_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CALEND_TECNICO_DISP_MANT_RO_PKT.exec ( __app );
  }
