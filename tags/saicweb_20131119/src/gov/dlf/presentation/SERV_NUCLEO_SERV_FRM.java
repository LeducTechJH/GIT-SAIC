    ...
    */
    ...
    this.registerListener ( "EMERG_NOM_SUPL_SERV", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
    	  ...
    	  {
    	  app.form("SERV_NUCLEO_SERV_FRM").setItem("EMERG_NOM_SUPL_SERV", "AUTORIDAD DE ENERGIA ELECTRICA");
    	  }
        app.errorFlag = true; 
        ; return app.errorFlag;
      }
    ...
    this.registerListener ( "EMER_NUM_CUENTA", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
          ...
          if (  serv.equals ( "LICE1" ) )
          {
        	 double numCta =  app.form("SERV_NUCLEO_SERV_FRM").getDoubleItem( "EMER_NUM_CUENTA" );  
        	 if (Compare.lt(numCta, 0) )
        	 {
            	 app.setError ("0", "El número de cuenta es requerido.");
             	 app.errorFlag = false;
             	return app.errorFlag;
        	 }
          }
    ...
    this.registerListener ( "CANTIDAD_AUTO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
    	  ...
    	  if (  serv.equals ( "LICE1" ) )
    	  {
    		  if (Compare.gt(cantAuto, 300))
    		  {
    			  app.setError ("0", "La cantidad autorizada de atraso o pago de luz sobrepasa los $300.00.");
    			  app.errorFlag = false;
    			  return app.errorFlag;
    		  }
    	  }
    	  ...
    	  {
    		  if (Compare.gt(cantAuto, 90))
    		  {
    			  app.setError ("0", "La cantidad autorizada para compra de gas sobrepasa los $90.00.");
    			  app.errorFlag = false;
    			  return app.errorFlag;
    		  }
    	  }
    	  else if (  serv.equals ( "LICE3" ) )
    	  {
    		  if (Compare.gt(cantAuto, 300))
    		  {
    			  app.setError ("0", "La cantidad autorizada para compra o reparacion de acondicionador de aire sobrepasa los $300.00.");
    			  app.errorFlag = false;
    			  return app.errorFlag;
    		  }
    	  }
    	  ...
    	  {
    		  if (Compare.gt(cantAuto, 35))
    		  {
    			  app.setError ("0", "La cantidad autorizada para compra o reparacion de abanico sobrepasa los $35.00.");
    			  app.errorFlag = false;
    			  return app.errorFlag;
    		  }
    	  }
    	  else if (Compare.lt(cantAuto,0))
    	  {
