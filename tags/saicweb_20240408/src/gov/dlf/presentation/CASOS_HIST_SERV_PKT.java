 ...
 */
public class CASOS_HIST_SERV_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CASOS_HIST_SERV_PKT ( )
  {
    super ( "CASOS_HIST_SERV_PKT" );
   ...
   *
   */
  public CASOS_HIST_SERV_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CASOS_HIST_SERV_PKT ( MDIFrame pFrame )
  {
    super ( "CASOS_HIST_SERV_PKT", pFrame );
  ...
  {
    this.createComponents ( new CASOS_HIST_SERV_RP ( ) );
   ...
   *
   */
  public static CASOS_HIST_SERV_PKT get ( RallyApplication __app )
  {
    return ( CASOS_HIST_SERV_PKT ) __app.getNewInstance ( "CASOS_HIST_SERV_PKT" );
  }
  ...
  {
    CASOS_HIST_SERV_PKT fSheet = CASOS_HIST_SERV_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CASOS_HIST_SERV_PKT.exec ( __app );
  }
