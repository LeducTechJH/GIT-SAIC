     ...
     extends RallyEngineObject 
{
  ...
  /**  */
  protected static DSS180_ALIST actionList = null;
   ...
   * @return
   */
  public static DSS180_ALIST get ( RallyApplication __app )
  {
    actionList = new DSS180_ALIST ( );
    __app.register ( actionList, "DSS180_ALIST" );
  ...
  {
    DSS180_ALIST.get ( __app ).execute ( ps );
  ...
  {
    FormSheet sheet = this.app.formSheet ( "DSS180_RPT_PKT" );
