 ...
 */
public class NOTIFICACIONES_FAM_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public NOTIFICACIONES_FAM_PKT ( )
  {
    super ( "NOTIFICACIONES_FAM_PKT" );
   ...
   *
   */
  public NOTIFICACIONES_FAM_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public NOTIFICACIONES_FAM_PKT ( MDIFrame pFrame )
  {
    super ( "NOTIFICACIONES_FAM_PKT", pFrame );
  ...
  {
    this.createComponents ( new NOTIFICACIONES_FAM_FR ( ) );
   ...
   *
   */
  public static NOTIFICACIONES_FAM_PKT get ( RallyApplication __app )
  {
    return ( NOTIFICACIONES_FAM_PKT ) __app.getNewInstance ( "NOTIFICACIONES_FAM_PKT" );
  }
  ...
  {
    NOTIFICACIONES_FAM_PKT fSheet = NOTIFICACIONES_FAM_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return NOTIFICACIONES_FAM_PKT.exec ( __app );
  }
