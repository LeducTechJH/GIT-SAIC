     ...
     extends Form
{
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "EMISIONES_BENEFICIOS_FRM", new EMISIONES_BENEFICIOS_FRM_Arguments ( this ) );
...
class EMISIONES_BENEFICIOS_FRM_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public EMISIONES_BENEFICIOS_FRM_Arguments ( Form form )
  {
    this.model = form;
