 ...
 */
public class ADSEF_PPT_1_OFC_PPKT0 
  implements IRegisteredObject 
{
   ...
   *
   */
  public static ADSEF_PPT_1_OFC_PPKT0 get ( RallyApplication __app )
  {
    ADSEF_PPT_1_OFC_PPKT0 pp = ( ADSEF_PPT_1_OFC_PPKT0 ) __app.getNewInstance ( "ADSEF_PPT_1_OFC_PPKT0" );
    return pp;
  }
  ...
  {
    return ADSEF_PPT_1_OFC_PPKT0.exec ( __app );
  }
...
public void execute ( ParameterSet ps )
  {
    Debug.println ( Debug.TRACE, "ADSEF_PPT_1_OFC_PPKT0" );
    this.prepareParms ( );
...
public void halt ( )
  ...
  {
    this.app.form ( "ADSEF_PPT_1_RP" ).setValue ( "REGION", this.parms.getString ( 0 ) );
    this.app.form ( "ADSEF_PPT_1_RP" ).setValue ( "OFICINA", this.parms.getString ( 1 ) );
  }
  ...
  {
    this.parms.reset ( );
    this.parms.set ( this.app.form ( "ADSEF_PPT_1_RP" ).getValue ( "REGION" ) );
    this.parms.set ( this.app.form ( "ADSEF_PPT_1_RP" ).getValue ( "OFICINA" ) );
  }
