 ...
 */
public class SERV_SOST_LOV_DIET_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SERV_SOST_LOV_DIET_FR ( )
  {
    super ( );
    this.setName ( "SERV_SOST_LOV_DIET_FR" );

    Debug.println ( Debug.TRACE, "SERV_SOST_LOV_DIET_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SERV_SOST_LOV_DIET_FR.jdp" );
