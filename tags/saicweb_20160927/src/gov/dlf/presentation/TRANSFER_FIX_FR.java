     ...
     extends Form
{
   ...
   *
   */
  public TRANSFER_FIX_FR ( )
  {
    super ( );
    this.setName ( "TRANSFER_FIX_FR" );

    Debug.println ( Debug.TRACE, "TRANSFER_FIX_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TRANSFER_FIX_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field = ( JDataPanelField ) this.getInDepth ( "TITULO" );
    field.setValueProvider ( new TRANSFER_FIX_FR_TITULOProvider ( this ) );
 ...
 *
 */
class TRANSFER_FIX_FR_TITULOProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public TRANSFER_FIX_FR_TITULOProvider ( Form form )
  {
    this.model = form;
  }
  ...
  public Object getValue ( )
  {
    ...
    return TRANSFER_ANS_ADL.getHEADING_TYPE ( this.app );
  }
}
