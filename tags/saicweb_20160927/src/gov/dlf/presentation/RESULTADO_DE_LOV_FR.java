 ...
 */
public class RESULTADO_DE_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public RESULTADO_DE_LOV_FR ( )
  {
    super ( );
    this.setName ( "RESULTADO_DE_LOV_FR" );

    Debug.println ( Debug.TRACE, "RESULTADO_DE_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RESULTADO_DE_LOV_FR.jdp" );
