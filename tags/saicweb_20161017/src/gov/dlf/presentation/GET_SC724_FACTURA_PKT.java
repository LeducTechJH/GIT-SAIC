 ...
 */
public class GET_SC724_FACTURA_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public GET_SC724_FACTURA_PKT ( )
  {
    super ( "GET_SC724_FACTURA_PKT" );
   ...
   *
   */
  public GET_SC724_FACTURA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GET_SC724_FACTURA_PKT ( MDIFrame pFrame )
  {
    super ( "GET_SC724_FACTURA_PKT", pFrame );
  ...
  {
    this.createComponents ( new GET_SC724_FACTURA_FR ( ) );
   ...
   *
   */
  public static GET_SC724_FACTURA_PKT get ( RallyApplication __app )
  {
    return ( GET_SC724_FACTURA_PKT ) __app.getNewInstance ( "GET_SC724_FACTURA_PKT" );
  }
  ...
  {
    GET_SC724_FACTURA_PKT fSheet = GET_SC724_FACTURA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GET_SC724_FACTURA_PKT.exec ( __app );
  }
