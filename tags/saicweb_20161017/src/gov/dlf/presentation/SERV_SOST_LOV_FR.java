     ...
     extends Form
{
   ...
   *
   */
  public SERV_SOST_LOV_FR ( )
  {
    super ( );
    this.setName ( "SERV_SOST_LOV_FR" );

    Debug.println ( Debug.TRACE, "SERV_SOST_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SERV_SOST_LOV_FR.jdp" );
