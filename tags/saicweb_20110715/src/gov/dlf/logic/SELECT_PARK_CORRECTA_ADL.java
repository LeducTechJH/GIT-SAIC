     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( Compare.equals ( RallyStringService.subString ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "COD_SERVICIO" ), 0, 2 ), "AT" ) ) 
    {
  ...
  {
    if ( this._condition0 )    //    if ( Compare.equals ( RallyStringService.subString ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "COD_SERVICIO" ), 0, 2 ), "AT" ) ) 
    {
  ...
  {
    if ( ( ( Compare.equals ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "ACCION" ), "RECL" ) ) || ( Compare.equals ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "ACCION" ), "RREC" ) ) ) && ( Compare.gt ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getDoubleItem ( "TOTAL_RECLAMACION" ), 0 ) )  ) 
    {
      this.app.browseToField ( "DETERMINAR_RECLAMACION_FR", "PARK_CORRECTA" ); 
    }
    else if ( ( ( Compare.equals ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "ACCION" ), "RETR" ) ) || ( Compare.equals ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "ACCION" ), "RRET" ) ) ) && ( Compare.gt ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getDoubleItem ( "TOTAL_RETROACTIVO" ), 0 ) )   )
    {
      this.app.browseToField ( "DETERMINAR_RECLAMACION_FR", "PARK_CORRECTA" ); 
    }
