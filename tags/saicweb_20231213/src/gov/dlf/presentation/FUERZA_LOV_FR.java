     ...
     extends Form
{
   ...
   *
   */
  public FUERZA_LOV_FR ( )
  {
    super ( );
    this.setName ( "FUERZA_LOV_FR" );

    Debug.println ( Debug.TRACE, "FUERZA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/FUERZA_LOV_FR.jdp" );
