     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "RMO_LOV_FR" );

    Debug.println ( Debug.TRACE, "RMO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RMO_LOV_FR.jdp" );
