     ...
     extends FormSheet
{
   ...
   *
   */
  public SERV_FAM_RO_PKT ( )
  {
    super ( "SERV_FAM_RO_PKT" );
   ...
   *
   */
  public SERV_FAM_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SERV_FAM_RO_PKT ( MDIFrame pFrame )
  {
    super ( "SERV_FAM_RO_PKT", pFrame );
   ...
   *
   */
  public static SERV_FAM_RO_PKT get ( RallyApplication __app )
  {
    return ( SERV_FAM_RO_PKT ) __app.getNewInstance ( "SERV_FAM_RO_PKT" );
  }
  ...
  {
    SERV_FAM_RO_PKT fSheet = SERV_FAM_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SERV_FAM_RO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SER_FAM_BF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
