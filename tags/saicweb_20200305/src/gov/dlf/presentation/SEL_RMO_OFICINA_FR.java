 ...
 */
public class SEL_RMO_OFICINA_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SEL_RMO_OFICINA_FR ( )
  {
    super ( );
    this.setName ( "SEL_RMO_OFICINA_FR" );

    Debug.println ( Debug.TRACE, "SEL_RMO_OFICINA_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SEL_RMO_OFICINA_FR.jdp" );
  ...
  {
    this.registerListener ( "RMO_OFICNA", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
    {
    ...
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; 
        app.RMO_GBL = app.form ( "SEL_RMO_OFICINA_FR" ).getDoubleItem ( "RMO_OFICNA" );
