 ...
 */
public class COGIDOS_POSTALES_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public COGIDOS_POSTALES_RPT_PKT ( )
  {
    super ( "COGIDOS_POSTALES_RPT_PKT" );
   ...
   *
   */
  public COGIDOS_POSTALES_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public COGIDOS_POSTALES_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "COGIDOS_POSTALES_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CODIGOS_POSTALES_RPT ( ) );
   ...
   *
   */
  public static COGIDOS_POSTALES_RPT_PKT get ( RallyApplication __app )
  {
    return ( COGIDOS_POSTALES_RPT_PKT ) __app.getNewInstance ( "COGIDOS_POSTALES_RPT_PKT" );
  }
  ...
  {
    COGIDOS_POSTALES_RPT_PKT fSheet = COGIDOS_POSTALES_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return COGIDOS_POSTALES_RPT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SET_COMPRESS_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
