     ...
     extends ADL
{
  ...
  /**  */
  public static void setNSOR_EXT  ( RallyApplication __app, Object value )
  {
    ( ( COMP_INGRESOS_BILLETES ) __app.getADL ( COMP_INGRESOS_BILLETES.class ) ).NSOR_EXT = ( ( Double ) value ).doubleValue ( );
  }
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( ( Compare.lt ( this.app.form ( "BILLETES_FR" ).getDoubleItem ( "CANT_BILLETE_EXTRA" ), 18 ) ) || ( Compare.lt ( this.app.form ( "BILLETES_FR" ).getDoubleItem ( "CANT_BILLETE_ORDINARIO" ), 18 ) ) ) 
    {
    ...
    this.app.form ( "BILLETES_FR" ).setItem ( "INGRESO_ANUAL", MathService.plus ( this.app.form ( "BILLETES_FR" ).getDoubleItem ( "GAN_ANUAL_ORD" ), this.app.form ( "BILLETES_FR" ).getDoubleItem ( "GAN_ANUAL_EXTRA" ) )  );
    this.app.COMP_ING_BILL_GBL = ( MathService.plus ( ( ( this.app.form ( "BILLETES_FR" ).getDoubleItem ( "CANT_BILLETE_EXTRA" )* GAN_EXT ) * ( NSOR_EXT ) ), ( ( this.app.form ( "BILLETES_FR" ).getDoubleItem ( "CANT_BILLETE_ORDINARIO" )* GAN_ORD ) * ( NSOR_ORD ) )  ) ) / 12;
