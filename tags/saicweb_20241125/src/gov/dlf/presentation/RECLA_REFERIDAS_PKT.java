 ...
 */
public class RECLA_REFERIDAS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public RECLA_REFERIDAS_PKT ( )
  {
    super ( "RECLA_REFERIDAS_PKT" );
   ...
   *
   */
  public RECLA_REFERIDAS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RECLA_REFERIDAS_PKT ( MDIFrame pFrame )
  {
    super ( "RECLA_REFERIDAS_PKT", pFrame );
  ...
  {
    this.createComponents ( new RECLA_REFERIDAS_FRM ( ) );
   ...
   *
   */
  public static RECLA_REFERIDAS_PKT get ( RallyApplication __app )
  {
    return ( RECLA_REFERIDAS_PKT ) __app.getNewInstance ( "RECLA_REFERIDAS_PKT" );
  }
  ...
  {
    RECLA_REFERIDAS_PKT fSheet = RECLA_REFERIDAS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RECLA_REFERIDAS_PKT.exec ( __app );
  }
