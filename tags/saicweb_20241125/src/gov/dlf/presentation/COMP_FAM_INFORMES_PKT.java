 ...
 */
public class COMP_FAM_INFORMES_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public COMP_FAM_INFORMES_PKT ( )
  {
    super ( "COMP_FAM_INFORMES_PKT" );
   ...
   *
   */
  public COMP_FAM_INFORMES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public COMP_FAM_INFORMES_PKT ( MDIFrame pFrame )
  {
    super ( "COMP_FAM_INFORMES_PKT", pFrame );
  ...
  {
    this.createComponents ( new COMP_FAM_INFORMES_FR ( ) );
   ...
   *
   */
  public static COMP_FAM_INFORMES_PKT get ( RallyApplication __app )
  {
    return ( COMP_FAM_INFORMES_PKT ) __app.getNewInstance ( "COMP_FAM_INFORMES_PKT" );
  }
  ...
  {
    COMP_FAM_INFORMES_PKT fSheet = COMP_FAM_INFORMES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return COMP_FAM_INFORMES_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CHEK_AGG_COMP_INF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
