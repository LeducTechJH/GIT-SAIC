 ...
 */
public class MANTENIMIENTO_SERVICIOS_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_SERVICIOS_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_SERVICIOS_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_SERVICIOS_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_SERVICIOS_FR.jdp" );
