     ...
     extends FormSheet
{
   ...
   *
   */
  public ADSEF_PPT_4_PKT ( )
  {
    super ( "ADSEF_PPT_4_PKT" );
   ...
   *
   */
  public ADSEF_PPT_4_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ADSEF_PPT_4_PKT ( MDIFrame pFrame )
  {
    super ( "ADSEF_PPT_4_PKT", pFrame );
   ...
   *
   */
  public static ADSEF_PPT_4_PKT get ( RallyApplication __app )
  {
    return ( ADSEF_PPT_4_PKT ) __app.getNewInstance ( "ADSEF_PPT_4_PKT" );
  }
  ...
  {
    ADSEF_PPT_4_PKT fSheet = ADSEF_PPT_4_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ADSEF_PPT_4_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_PPT_4_MENU.exec ( app, null );
