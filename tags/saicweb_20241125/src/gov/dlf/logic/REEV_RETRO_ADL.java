     ...
     extends ADL
{
  ...
  {
    ( ( REEV_RETRO_ADL ) __app.getADL ( REEV_RETRO_ADL.class ) ).RECLA_ID = value.getDouble ( );
  }  
  ...
  {
    ( ( REEV_RETRO_ADL ) __app.getADL ( REEV_RETRO_ADL.class ) ).RECLA_STATUS = value.getDouble ( );
  }  
  ...
  {
    return ( ( REEV_RETRO_ADL ) __app.getADL ( REEV_RETRO_ADL.class ) ).RECLA_RETRO_TABLE_DSD;
  }
  ...
  {
    ( ( REEV_RETRO_ADL ) __app.getADL ( REEV_RETRO_ADL.class ) ).RECLA_RETRO_TABLE_DSD = value;
  }
  ...
  {
    ( ( REEV_RETRO_ADL ) __app.getADL ( REEV_RETRO_ADL.class ) ).RECLA_RETRO_TABLE_DSD = ( DataStore ) value;
  }
  ...
  {
    return ( ( REEV_RETRO_ADL ) __app.getADL ( REEV_RETRO_ADL.class ) ).RECLA_ID;
  }
  ...
  {
    return new Double ( ( ( REEV_RETRO_ADL ) __app.getADL ( REEV_RETRO_ADL.class ) ).RECLA_ID );
  }
  ...
  {
    ( ( REEV_RETRO_ADL ) __app.getADL ( REEV_RETRO_ADL.class ) ).RECLA_ID = value;
  }
  ...
  {
    ( ( REEV_RETRO_ADL ) __app.getADL ( REEV_RETRO_ADL.class ) ).RECLA_ID = ( ( Double ) value ).doubleValue ( );
  }
  ...
  {
    return ( ( REEV_RETRO_ADL ) __app.getADL ( REEV_RETRO_ADL.class ) ).RECLA_STATUS;
  }
  ...
  {
    return new Double ( ( ( REEV_RETRO_ADL ) __app.getADL ( REEV_RETRO_ADL.class ) ).RECLA_STATUS );
  }
  ...
  {
    ( ( REEV_RETRO_ADL ) __app.getADL ( REEV_RETRO_ADL.class ) ).RECLA_STATUS = value;
  }
  ...
  {
    ( ( REEV_RETRO_ADL ) __app.getADL ( REEV_RETRO_ADL.class ) ).RECLA_STATUS = ( ( Double ) value ).doubleValue ( );
  }
   ...
   * @return
   */
  public static REEV_RETRO_ADL get ( RallyApplication __app )
  {
    REEV_RETRO_ADL adl = new REEV_RETRO_ADL ( );
    __app.register ( adl, "REEV_RETRO_ADL" );
    __app.setADL ( REEV_RETRO_ADL.class, adl ); 
  ...
  {
    REEV_RETRO_ADL.get ( __app ).process ( ps );
  }
  ...
  public void unregister ( )
  {
    ...
    IRegisteredObject rObj = this.app.get ( "REEV_RETRO_ADL" );
    if ( rObj != null && rObj instanceof REEV_RETRO_ADL )
    {
      this.app.setADL ( REEV_RETRO_ADL.class, ( REEV_RETRO_ADL ) rObj );
    }
  }
  ...
  {
    Debug.println ( Debug.TRACE, "REEV_RETRO_ADL Step " + this.currentStep );
    super.process ( ps );
    switch ( this.currentStep ) 
    {
      ...
      { 
        this.currentStep = 0;
        Debug.println ( Debug.TRACE, "REEV_RETRO_ADL ended" );
        this.unregister ( );
        break;
      }
    }
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    this.dm.setField ( this.dm.get ( "RECLA_RETRO_TABLE_DSD" ), "STATUS_AUTORIZACION", "REEV" );
