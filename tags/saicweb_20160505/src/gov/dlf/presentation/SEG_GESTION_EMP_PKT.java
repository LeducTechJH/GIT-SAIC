 ...
 */
public class SEG_GESTION_EMP_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SEG_GESTION_EMP_PKT ( )
  {
    super ( "SEG_GESTION_EMP_PKT" );
   ...
   *
   */
  public SEG_GESTION_EMP_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SEG_GESTION_EMP_PKT ( MDIFrame pFrame )
  {
    super ( "SEG_GESTION_EMP_PKT", pFrame );
   ...
   *
   */
  public static SEG_GESTION_EMP_PKT get ( RallyApplication __app )
  {
    return ( SEG_GESTION_EMP_PKT ) __app.getNewInstance ( "SEG_GESTION_EMP_PKT" );
  }
  ...
  {
    SEG_GESTION_EMP_PKT fSheet = SEG_GESTION_EMP_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SEG_GESTION_EMP_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_SEGGEST_MENU.exec ( app, null );
