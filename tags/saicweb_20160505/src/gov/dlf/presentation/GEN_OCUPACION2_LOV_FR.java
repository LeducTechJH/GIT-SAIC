 ...
 */
public class GEN_OCUPACION2_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_OCUPACION2_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_OCUPACION2_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_OCUPACION2_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_OCUPACION2_LOV_FR.jdp" );
