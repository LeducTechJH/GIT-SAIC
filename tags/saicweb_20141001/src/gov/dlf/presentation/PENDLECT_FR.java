     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "PENDLECT_FR" );

    Debug.println ( Debug.TRACE, "PENDLECT_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/PENDLECT_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "SERVICIOS_GP", new PENDLECT_FR_SERVICIOS_GP_Arguments ( this ) );

    this.setObjectEvents ( );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new PENDLECT_FR_OFICINAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "FECHA" );
    field.setValueProvider ( new PENDLECT_FR_FECHAProvider ( this ) );
 ...
 *
 */
class PENDLECT_FR_SERVICIOS_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public PENDLECT_FR_SERVICIOS_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class PENDLECT_FR_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public PENDLECT_FR_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class PENDLECT_FR_FECHAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public PENDLECT_FR_FECHAProvider ( Form form )
  {
    this.model = form;
  }
