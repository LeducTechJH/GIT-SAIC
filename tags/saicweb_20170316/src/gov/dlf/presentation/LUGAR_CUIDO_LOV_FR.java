 ...
 */
public class LUGAR_CUIDO_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public LUGAR_CUIDO_LOV_FR ( )
  {
    super ( );
    this.setName ( "LUGAR_CUIDO_LOV_FR" );

    Debug.println ( Debug.TRACE, "LUGAR_CUIDO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/LUGAR_CUIDO_LOV_FR.jdp" );
