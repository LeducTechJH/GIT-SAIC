 ...
 */
public class CODIGOS_SERVICIO_INGRESO_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CODIGOS_SERVICIO_INGRESO_RPT_PKT ( )
  {
    super ( "CODIGOS_SERVICIO_INGRESO_RPT_PKT" );
   ...
   *
   */
  public CODIGOS_SERVICIO_INGRESO_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CODIGOS_SERVICIO_INGRESO_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "CODIGOS_SERVICIO_INGRESO_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CODIGOS_SERVICIO_INGRESO_RPT ( ) );
   ...
   *
   */
  public static CODIGOS_SERVICIO_INGRESO_RPT_PKT get ( RallyApplication __app )
  {
    return ( CODIGOS_SERVICIO_INGRESO_RPT_PKT ) __app.getNewInstance ( "CODIGOS_SERVICIO_INGRESO_RPT_PKT" );
  }
  ...
  {
    CODIGOS_SERVICIO_INGRESO_RPT_PKT fSheet = CODIGOS_SERVICIO_INGRESO_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CODIGOS_SERVICIO_INGRESO_RPT_PKT.exec ( __app );
  }
