...
extends ADL
{
	...
	protected void step1 ( ParameterSet ps )
	{
		...
		{
			if( ! Compare.ge(this.app.form ( "CONTRATO_PROYECCION_FR" ).getDateItem( "MESPROYECTADO" ), this.app.SYSTEM_DATE))
			{
			...
			this.app.form ( "CONTRATO_PROYECCION_FR" ).setItem ( "RAZON","");
			this.app.form ( "CONTRATO_PROYECCION_FR" ).setItem ( "ID_SUPERVISOR",this.app.ID_TECNICO_GBL);
			}
			else
			{
				  app.setError ("0", "No es posible autorizar un pago en fechas futuras.");
			}
		}
		else
		{
			this.app.form ( "CONTRATO_PROYECCION_FR" ).setItem ( "FCH_AUTORIZACION", null);
			this.app.form ( "CONTRATO_PROYECCION_FR" ).setItem ( "PAGO",null);
			this.app.form ( "CONTRATO_PROYECCION_FR" ).setItem ( "ID_TECNICO",null);
