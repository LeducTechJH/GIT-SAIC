 ...
 */
public class MANTENIMIENTO_CUENTA_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_CUENTA_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_CUENTA_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_CUENTA_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_CUENTA_FR.jdp" );
