     ...
     extends FormSheet
{
   ...
   *
   */
  public SC1219_MENU_PKT ( )
  {
    super ( "SC1219_MENU_PKT" );
   ...
   *
   */
  public SC1219_MENU_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SC1219_MENU_PKT ( MDIFrame pFrame )
  {
    super ( "SC1219_MENU_PKT", pFrame );
  ...
  {
    this.createComponents ( new SC1219_MENU_FR ( ) );
   ...
   *
   */
  public static SC1219_MENU_PKT get ( RallyApplication __app )
  {
    return ( SC1219_MENU_PKT ) __app.getNewInstance ( "SC1219_MENU_PKT" );
  }
  ...
  {
    SC1219_MENU_PKT fSheet = SC1219_MENU_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SC1219_MENU_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SC1219_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
