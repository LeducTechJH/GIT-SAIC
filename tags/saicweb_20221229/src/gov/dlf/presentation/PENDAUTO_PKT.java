     ...
     extends FormSheet
{
   ...
   *
   */
  public PENDAUTO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PENDAUTO_PKT ( MDIFrame pFrame )
  {
    super ( "PENDAUTO_PKT", pFrame );
   ...
   *
   */
  public static PENDAUTO_PKT get ( RallyApplication __app )
  {
    return ( PENDAUTO_PKT ) __app.getNewInstance ( "PENDAUTO_PKT" );
  }
  ...
  {
    PENDAUTO_PKT fSheet = PENDAUTO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PENDAUTO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_PENDAUTO_MENU.exec ( app, null );
