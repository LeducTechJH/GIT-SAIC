 ...
 */
public class MANTENIMIENTO_ORG_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_ORG_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_ORG_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_ORG_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_ORG_FR.jdp" );
