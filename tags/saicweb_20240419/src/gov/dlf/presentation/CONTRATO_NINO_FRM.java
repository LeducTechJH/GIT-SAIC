...
extends Form
{
	...
	{	    
		...
		this.registerListener ( "CONTRATO_NINO_FRM", JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
		{
			...
			{
				app.errorFlag = true; 
				if(Compare.equals(app.ESPE_GBL, 1)&&Compare.equals(app.form("CONTRATO_NINO_FRM").getStringItem("NECESIDAD_ESP"), "X"))
				{
					AUTORIZACION_CONTRATO_CUIDO.exec(app);
		...
		this.registerListener ( "TIEMPO_COMP", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				...
				//CHECK_TARIFAS_PROV_FORMAL_ADL.exec(app,null);
				return app.errorFlag;
			}
		} );
		...
		this.registerListener ( "ACEPTADO", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
		{
			...
			{
				app.errorFlag = true; 
				if (Compare.equals(app.SUPM_GBL , 0) && Compare.equals(app.ESPE_GBL, 0))
				{
					app.setError("0", "Solo un supervisor de manejo puede autorizar el caso.");
					app.form("CONTRATO_NINO_FRM").setItem("ACEPTADO","");
					app.form("CONTRATO_NINO_FRM").setItem("DENEGADO","");
					app.errorFlag = false; 
				}
				if (Compare.equals(app.form("CONTRATO_NINO_FRM").getDoubleItem("ESPECIALISTA"),3 ) && Compare.equals(app.ESPE_GBL, 0))
				{
					app.setError("0", "Este contrato debe ser consultado con especialista antes de ser aprobado.");
					app.errorFlag = false; 
				}
				return app.errorFlag;
			}
		} );
		this.registerListener ( "ACEPTADO", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				app.errorFlag = true; 
				...
				CONTRATO_CUIDO_INS_ADL.exec(app);
				return app.errorFlag;
			}
		} );
