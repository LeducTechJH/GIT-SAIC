 ...
 */
public class SEG_GESTION_EMP_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SEG_GESTION_EMP_PRINT_PKT ( )
  {
    super ( "SEG_GESTION_EMP_PRINT_PKT" );
   ...
   *
   */
  public SEG_GESTION_EMP_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SEG_GESTION_EMP_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "SEG_GESTION_EMP_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new SEG_GESTION_EMPLEO_RP ( ) );
   ...
   *
   */
  public static SEG_GESTION_EMP_PRINT_PKT get ( RallyApplication __app )
  {
    return ( SEG_GESTION_EMP_PRINT_PKT ) __app.getNewInstance ( "SEG_GESTION_EMP_PRINT_PKT" );
  }
  ...
  {
    SEG_GESTION_EMP_PRINT_PKT fSheet = SEG_GESTION_EMP_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SEG_GESTION_EMP_PRINT_PKT.exec ( __app );
  }
