 ...
 */
public class AJUSTE_PAGO_RECLA_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public AJUSTE_PAGO_RECLA_RO_PKT ( )
  {
    super ( "AJUSTE_PAGO_RECLA_RO_PKT" );
   ...
   *
   */
  public AJUSTE_PAGO_RECLA_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AJUSTE_PAGO_RECLA_RO_PKT ( MDIFrame pFrame )
  {
    super ( "AJUSTE_PAGO_RECLA_RO_PKT", pFrame );
   ...
   *
   */
  public static AJUSTE_PAGO_RECLA_RO_PKT get ( RallyApplication __app )
  {
    return ( AJUSTE_PAGO_RECLA_RO_PKT ) __app.getNewInstance ( "AJUSTE_PAGO_RECLA_RO_PKT" );
  }
  ...
  {
    AJUSTE_PAGO_RECLA_RO_PKT fSheet = AJUSTE_PAGO_RECLA_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return AJUSTE_PAGO_RECLA_RO_PKT.exec ( __app );
  }
