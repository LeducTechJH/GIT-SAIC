     ...
     extends Form
{
   ...
   *
   */
  public INF_TECNICO_FR ( )
  {
    super ( );
    this.setName ( "INF_TECNICO_FR" );

    Debug.println ( Debug.TRACE, "INF_TECNICO_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/INF_TECNICO_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "INPUT_END_DATE", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; TSS_DESDE_MAYOR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "FINISH_ACTION", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
      // app.errorFlag = true; INF_TECNICOS_ALIST.exec ( app, null ); return app.errorFlag;
        app.errorFlag = true; INF_TECNICO_ADL.exec ( app, null ); return app.errorFlag;     
      }
    } );
  }
}
