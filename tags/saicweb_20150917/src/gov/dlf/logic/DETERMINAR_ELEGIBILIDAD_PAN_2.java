...
//					this.dm.setField ( this.dm.get ( "EMISIONES_BENEFICIOS_ALL_DSD" ), "DIA_EMISION_PARAM" , "0");
					...
					if ( Compare.equals ( STATUS9_CODE, 0 )|| Compare.equals(fecha, "201509") )
					{
...
//				this.dm.setField ( this.dm.get ( "EMISIONES_BENEFICIOS_ALL_DSD" ), "DIA_EMISION_PARAM" , "0");
				...
				if ( Compare.equals ( STATUS9_CODE, 0 ) || Compare.equals(fecha, "201509") )
				{
					BENEFICIO = MathService.plus ( TruncService.trunc ( BENEFICIO_TEMP * 0.50 ) , ( BONO_ANCIANO * ANCIANO_COUNT )  );
				}
				else
				{
