     ...
     extends FormSheet
{
   ...
   *
   */
  public SC1035_PRN_PKT ( )
  {
    super ( "SC1035_PRN_PKT" );
   ...
   *
   */
  public SC1035_PRN_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SC1035_PRN_PKT ( MDIFrame pFrame )
  {
    super ( "SC1035_PRN_PKT", pFrame );
  ...
  {
    this.createComponents ( new SC1035_PRN_FR ( ) );
   ...
   *
   */
  public static SC1035_PRN_PKT get ( RallyApplication __app )
  {
    return ( SC1035_PRN_PKT ) __app.getNewInstance ( "SC1035_PRN_PKT" );
  }
  ...
  {
    SC1035_PRN_PKT fSheet = SC1035_PRN_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SC1035_PRN_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; LLENAR_FECHA_SC1035_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
