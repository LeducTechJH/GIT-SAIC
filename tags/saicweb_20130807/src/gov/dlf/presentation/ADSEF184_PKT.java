     ...
     extends FormSheet
{
   ...
   *
   */
  public ADSEF184_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ADSEF184_PKT ( MDIFrame pFrame )
  {
    super ( "ADSEF184_PKT", pFrame );
  ...
  {
    this.createComponents ( new ADSEF184_FR ( ) );
   ...
   *
   */
  public static ADSEF184_PKT get ( RallyApplication __app )
  {
    return ( ADSEF184_PKT ) __app.getNewInstance ( "ADSEF184_PKT" );
  }
  ...
  {
    ADSEF184_PKT fSheet = ADSEF184_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ADSEF184_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; GET_ADSEF184_SET_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; ADSEF184_CHECK_RSE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
