 ...
 */
public class AJUSTE_PAG_RPT_B_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public AJUSTE_PAG_RPT_B_PKT ( )
  {
    super ( "AJUSTE_PAG_RPT_B_PKT" );
   ...
   *
   */
  public AJUSTE_PAG_RPT_B_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AJUSTE_PAG_RPT_B_PKT ( MDIFrame pFrame )
  {
    super ( "AJUSTE_PAG_RPT_B_PKT", pFrame );
  ...
  {
    this.createComponents ( new AJUSTE_PAG_RPT_B_FR ( ) );
   ...
   *
   */
  public static AJUSTE_PAG_RPT_B_PKT get ( RallyApplication __app )
  {
    return ( AJUSTE_PAG_RPT_B_PKT ) __app.getNewInstance ( "AJUSTE_PAG_RPT_B_PKT" );
  }
  ...
  {
    AJUSTE_PAG_RPT_B_PKT fSheet = AJUSTE_PAG_RPT_B_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return AJUSTE_PAG_RPT_B_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  AJUSTE_PAG_RPT_B_MENU.exec ( app, null );
 return app.errorFlag;
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; AJUSTE_PAG_RPT_BFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
