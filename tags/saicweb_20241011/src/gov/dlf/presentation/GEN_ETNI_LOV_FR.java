     ...
     extends Form
{
   ...
   *
   */
  public GEN_ETNI_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_ETNI_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_ETNI_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_ETNI_FR.jdp" );
