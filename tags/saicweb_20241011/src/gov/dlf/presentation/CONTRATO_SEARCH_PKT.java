 ...
 */
public class CONTRATO_SEARCH_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CONTRATO_SEARCH_PKT ( )
  {
    super ( "CONTRATO_SEARCH_PKT" );
   ...
   *
   */
  public CONTRATO_SEARCH_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CONTRATO_SEARCH_PKT ( MDIFrame pFrame )
  {
    super ( "CONTRATO_SEARCH_PKT", pFrame );
  ...
  {
    this.createComponents ( new CONTRATO_SEARCH_FR ( ) );
   ...
   *
   */
  public static CONTRATO_SEARCH_PKT get ( RallyApplication __app )
  {
    return ( CONTRATO_SEARCH_PKT ) __app.getNewInstance ( "CONTRATO_SEARCH_PKT" );
  }
  ...
  {
    CONTRATO_SEARCH_PKT fSheet = CONTRATO_SEARCH_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CONTRATO_SEARCH_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  
        //DESEA_IMPRIMIR_CONSULTA_EMISIONES_MENU.exec ( app, null );
