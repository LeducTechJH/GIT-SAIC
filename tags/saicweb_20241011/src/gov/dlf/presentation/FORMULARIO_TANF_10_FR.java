 ...
 */
public class FORMULARIO_TANF_10_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public FORMULARIO_TANF_10_FR ( )
  {
    super ( );
    this.setName ( "FORMULARIO_TANF_10_FR" );

    Debug.println ( Debug.TRACE, "FORMULARIO_TANF_10_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/FORMULARIO_TANF_10_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field = ( JDataPanelField ) this.getInDepth ( "NOMBRE_JUF" );
