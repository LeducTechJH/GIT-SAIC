     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( Compare.equals ( RallyStringService.subString ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "COD_SERVICIO" ), 0, 2 ), "LI" ) || Compare.equals ( RallyStringService.subString ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "COD_SERVICIO" ), 0, 4 ), "CLIM" )) 
    {
