     ...
     extends FormSheet
{
   ...
   *
   */
  public REPORT_9_6_PKT ( )
  {
    super ( "REPORT_9_6_PKT" );
   ...
   *
   */
  public REPORT_9_6_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REPORT_9_6_PKT ( MDIFrame pFrame )
  {
    super ( "REPORT_9_6_PKT", pFrame );
   ...
   *
   */
  public static REPORT_9_6_PKT get ( RallyApplication __app )
  {
    return ( REPORT_9_6_PKT ) __app.getNewInstance ( "REPORT_9_6_PKT" );
  }
  ...
  {
    REPORT_9_6_PKT fSheet = REPORT_9_6_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REPORT_9_6_PKT.exec ( __app );
  }
