     ...
     extends Form
{
   ...
   *
   */
  public EMPRESAS_LOV_FR ( )
  {
    super ( );
    this.setName ( "EMPRESAS_LOV_FR" );

    Debug.println ( Debug.TRACE, "EMPRESAS_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/EMPRESAS_LOV_FR.jdp" );
