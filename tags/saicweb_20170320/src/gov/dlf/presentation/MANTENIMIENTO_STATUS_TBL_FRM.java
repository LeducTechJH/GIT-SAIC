 ...
 */
public class MANTENIMIENTO_STATUS_TBL_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_STATUS_TBL_FRM ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_STATUS_TBL_FRM" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_STATUS_TBL_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_STATUS_TBL_FRM.jdp" );
