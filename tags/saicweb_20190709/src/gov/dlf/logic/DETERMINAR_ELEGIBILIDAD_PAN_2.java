							...
							( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "BILV" ) ) )
					{
						...
						if  (exento)
						{
							...
							if ( Compare.equals( STATUS_PTRA, 0 ) )
							{
								...
								{
									SALARIO = MathService.minus ( this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) , MathService.plus ( SALARIO, TruncService.trunc(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) *1 )));
//									SALARIO_TEMP = SALARIO_TEMP * 0;
								...
								{
									SALARIO = MathService.minus ( this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) , MathService.plus ( SALARIO, TruncService.trunc(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) *.66 )));
//									SALARIO_TEMP = SALARIO_TEMP - ( SALARIO_TEMP *.66 );
								...
								{
									SALARIO = MathService.minus ( this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) , MathService.plus ( SALARIO, TruncService.trunc(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) *.33 )));
