     ...
     extends FormSheet
{
   ...
   *
   */
  public ACCNEG_TANFS_PKT ( )
  {
    super ( "ACCNEG_TANFS_PKT" );
   ...
   *
   */
  public ACCNEG_TANFS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ACCNEG_TANFS_PKT ( MDIFrame pFrame )
  {
    super ( "ACCNEG_TANFS_PKT", pFrame );
   ...
   *
   */
  public static ACCNEG_TANFS_PKT get ( RallyApplication __app )
  {
    return ( ACCNEG_TANFS_PKT ) __app.getNewInstance ( "ACCNEG_TANFS_PKT" );
  }
  ...
  {
    ACCNEG_TANFS_PKT fSheet = ACCNEG_TANFS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ACCNEG_TANFS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_ACCNEG_MENU.exec ( app, null );
