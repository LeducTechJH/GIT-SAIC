 ...
 */
public class TECNICO_UPDATE_FR_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TECNICO_UPDATE_FR_PKT ( )
  {
    super ( "TECNICO_UPDATE_FR_PKT" );
   ...
   *
   */
  public TECNICO_UPDATE_FR_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TECNICO_UPDATE_FR_PKT ( MDIFrame pFrame )
  {
    super ( "TECNICO_UPDATE_FR_PKT", pFrame );
   ...
   *
   */
  public static TECNICO_UPDATE_FR_PKT get ( RallyApplication __app )
  {
    return ( TECNICO_UPDATE_FR_PKT ) __app.getNewInstance ( "TECNICO_UPDATE_FR_PKT" );
  }
  ...
  {
    TECNICO_UPDATE_FR_PKT fSheet = TECNICO_UPDATE_FR_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TECNICO_UPDATE_FR_PKT.exec ( __app );
  }
