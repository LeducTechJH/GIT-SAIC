     ...
     extends Form
{
   ...
   *
   */
  public DSS180_MENU_FR ( )
  {
    super ( );
    this.setName ( "DSS180_MENU_FR" );

    Debug.println ( Debug.TRACE, "DSS180_MENU_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DSS180_MENU_FR.jdp" );
  ...
  {
    this.registerListener ( "DSS180_PI", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; DSS180_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "DSS180_LF", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
