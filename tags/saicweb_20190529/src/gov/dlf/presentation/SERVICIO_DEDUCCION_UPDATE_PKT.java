 ...
 */
public class SERVICIO_DEDUCCION_UPDATE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SERVICIO_DEDUCCION_UPDATE_PKT ( )
  {
    super ( "SERVICIO_DEDUCCION_UPDATE_PKT" );
   ...
   *
   */
  public SERVICIO_DEDUCCION_UPDATE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SERVICIO_DEDUCCION_UPDATE_PKT ( MDIFrame pFrame )
  {
    super ( "SERVICIO_DEDUCCION_UPDATE_PKT", pFrame );
   ...
   *
   */
  public static SERVICIO_DEDUCCION_UPDATE_PKT get ( RallyApplication __app )
  {
    return ( SERVICIO_DEDUCCION_UPDATE_PKT ) __app.getNewInstance ( "SERVICIO_DEDUCCION_UPDATE_PKT" );
  }
  ...
  {
    SERVICIO_DEDUCCION_UPDATE_PKT fSheet = SERVICIO_DEDUCCION_UPDATE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SERVICIO_DEDUCCION_UPDATE_PKT.exec ( __app );
  }
