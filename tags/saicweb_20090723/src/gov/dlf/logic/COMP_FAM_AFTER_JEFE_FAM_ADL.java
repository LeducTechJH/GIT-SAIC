...
//  {
      ...
      //***** START MODS by J. OLMEDA (KPG, INC) 7/23/2009 *****
      //this.dm.setField ( this.dm.get ( "FAMILIA_LOC_DSD" ), "SEGURO_SOCIAL_JEFE_FAM", this.app.SSN_JEFE_FAM_GBL );
      this.dm.setField ( this.dm.get ( "FAMILIA_LOC_DSD" ), "SEGURO_SOCIAL_JEFE_FAM", this.app.form ( "SOLIC_SERV_COMP_FAMILIAR_FR" ).getDoubleItem ( "SEGURO_SOCIAL_JEFE_FAM0" ) );
      //***** END MODS by J. OLMEDA (KPG, INC) 7/23/2009 *****
