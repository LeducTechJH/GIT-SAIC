     ...
     extends Form
{
   ...
   *
   */
  public REPORT_2_5_FR ( )
  {
    super ( );
    this.setName ( "REPORT_2_5_FR" );

    Debug.println ( Debug.TRACE, "REPORT_2_5_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REPORT_2_5_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "INPUT_END_DATE", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; REPORT_2_5_ADL.exec ( app ); return app.errorFlag;
      }
    } );
