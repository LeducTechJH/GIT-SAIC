 ...
 */
public class LOV_RECIBIDO_EN_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public LOV_RECIBIDO_EN_FR ( )
  {
    super ( );
    this.setName ( "LOV_RECIBIDO_EN_FR" );

    Debug.println ( Debug.TRACE, "LOV_RECIBIDO_EN_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/LOV_RECIBIDO_EN_FR.jdp" );
