 ...
 */
public class BEFORE_FORM_COMPENSACION_ADL
     extends ADL
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RECLA_ID = value.getDouble ( );
  }  
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RECLA_STATUS = value.getDouble ( );
  }  
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RETRO_ID = value.getDouble ( );
  }  
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RETRO_STATUS = value.getDouble ( );
  }  
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).LARGO = value.getDouble ( );
  }  
  ...
  {
    return ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RECLA_RETRO_TABLE_DSD;
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RECLA_RETRO_TABLE_DSD = value;
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RECLA_RETRO_TABLE_DSD = ( DataStore ) value;
  }
  ...
  {
    return ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RETROACTIVO_DSD;
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RETROACTIVO_DSD = value;
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RETROACTIVO_DSD = ( DataStore ) value;
  }
  ...
  {
    return ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RECLA_ID;
  }
  ...
  {
    return new Double ( ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RECLA_ID );
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RECLA_ID = value;
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RECLA_ID = ( ( Double ) value ).doubleValue ( );
  }
  ...
  {
    return ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RECLA_STATUS;
  }
  ...
  {
    return new Double ( ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RECLA_STATUS );
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RECLA_STATUS = value;
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RECLA_STATUS = ( ( Double ) value ).doubleValue ( );
  }
  ...
  {
    return ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RETRO_ID;
  }
  ...
  {
    return new Double ( ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RETRO_ID );
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RETRO_ID = value;
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RETRO_ID = ( ( Double ) value ).doubleValue ( );
  }
  ...
  {
    return ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RETRO_STATUS;
  }
  ...
  {
    return new Double ( ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RETRO_STATUS );
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RETRO_STATUS = value;
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).RETRO_STATUS = ( ( Double ) value ).doubleValue ( );
  }
  ...
  {
    return ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).LARGO;
  }
  ...
  {
    return new Double ( ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).LARGO );
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).LARGO = value;
  }
  ...
  {
    ( ( BEFORE_FORM_COMPENSACION_ADL ) __app.getADL ( BEFORE_FORM_COMPENSACION_ADL.class ) ).LARGO = ( ( Double ) value ).doubleValue ( );
  }
   ...
   * @return
   */
  public static BEFORE_FORM_COMPENSACION_ADL get ( RallyApplication __app )
  {
    BEFORE_FORM_COMPENSACION_ADL adl = new BEFORE_FORM_COMPENSACION_ADL ( );
    __app.register ( adl, "BEFORE_FORM_COMPENSACION_ADL" );
    __app.setADL ( BEFORE_FORM_COMPENSACION_ADL.class, adl ); 
  ...
  {
    BEFORE_FORM_COMPENSACION_ADL.get ( __app ).process ( ps );
  }
  ...
  public static void exec ( RallyApplication __app )
  {
    ...
    BEFORE_FORM_COMPENSACION_ADL.exec ( __app, ps );
  }
  ...
  public void unregister ( )
  {
    ...
    IRegisteredObject rObj = this.app.get ( "BEFORE_FORM_COMPENSACION_ADL" );
    if ( rObj != null && rObj instanceof BEFORE_FORM_COMPENSACION_ADL )
    {
      this.app.setADL ( BEFORE_FORM_COMPENSACION_ADL.class, ( BEFORE_FORM_COMPENSACION_ADL ) rObj );
    }
  }
  ...
  {
    Debug.println ( Debug.TRACE, "BEFORE_FORM_COMPENSACION_ADL Step " + this.currentStep );
    super.process ( ps );
    switch ( this.currentStep ) 
    {
      ...
      { 
        this.currentStep = 0;
        Debug.println ( Debug.TRACE, "BEFORE_FORM_COMPENSACION_ADL ended" );
        this.unregister ( );
        break;
      }
    }
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    while ( Compare.equals ( RECLA_STATUS, 0 ) ) 
    {
      if ( Compare.equals ( RallyStringService.subString ( this.dm.getFieldString ( this.dm.get ( "RECLA_RETRO_TABLE_DSD" ), "COD_SERVICIO" ), 0, LARGO ), RallyStringService.subString ( this.app.COD_SERV_GBL, 0, LARGO ) ) ) 
      {
        ...
        double temp = this.dm.getFieldDouble ( this.dm.get ( "RETROACTIVO_DSD" ), "VLR_BALANCE" );
        if ( Double.isNaN ( temp ) ) temp = 0;
        
        if ( Compare.ge ( this.dm.getFieldDouble ( this.dm.get ( "RECLA_RETRO_TABLE_DSD" ), "VLR_BALANCE" ), temp ) ) 
        {
          ...
          this.app.form ( "COMPENSACION_RECLA_FR" ).setItem ( "BENEFICIOS_RETROACTIVOS1", temp  );
          this.app.form ( "COMPENSACION_RECLA_FR" ).setItem ( "BALANCE_RECLAMAR", MathService.minus ( this.dm.getFieldDouble ( this.dm.get ( "RECLA_RETRO_TABLE_DSD" ), "VLR_BALANCE" ), temp  )  );
        }
        if ( Compare.lt ( this.dm.getFieldDouble ( this.dm.get ( "RECLA_RETRO_TABLE_DSD" ), "VLR_BALANCE" ), temp ) ) 
        {
          ...
          this.app.form ( "COMPENSACION_RECLA_FR" ).setItem ( "BENEFICIOS_RETROACTIVOS2", temp  );
          this.app.form ( "COMPENSACION_RECLA_FR" ).setItem ( "RETRO_OTORGAR", MathService.minus ( temp, this.dm.getFieldDouble ( this.dm.get ( "RECLA_RETRO_TABLE_DSD" ), "VLR_BALANCE" )  )  );
        }
      }
...
procedure before_form_compensacion_adl;
var
        recla_id        : number(9,0);
...
DEBUG_LOG(TO_CHAR(COMPENSACION_RECLA_FR.TOTAL_RETROACTIVO));
...
DEBUG_LOG(TO_CHAR(RETROACTIVO_DSD.VLR_BALANCE));
DEBUG_LOG(TO_CHAR(REcla_retro_table_dsd.vlr_bALANCE));
...
CLA_RETRO_TABLE_DSD.VLR_BALANCE;
   ...
   {endif}   
END;
DEBUG_LOG(TO_CHAR(COMPENSACION_RECLA_FR.RECLAMACION_DETERMINADA2));
DEBUG_LOG(TO_CHAR(COMPENSACION_RECLA_FR.BENEFICIOS_RETROACTIVOS2));
DEBUG_LOG(TO_CHAR(COMPENSACION_RECLA_FR.RETRO_OTORGAR));
