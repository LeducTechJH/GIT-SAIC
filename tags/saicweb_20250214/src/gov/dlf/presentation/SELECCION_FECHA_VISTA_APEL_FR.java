 ...
 */
public class SELECCION_FECHA_VISTA_APEL_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SELECCION_FECHA_VISTA_APEL_FR ( )
  {
    super ( );
    this.setName ( "SELECCION_FECHA_VISTA_APEL_FR" );

    Debug.println ( Debug.TRACE, "SELECCION_FECHA_VISTA_APEL_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SELECCION_FECHA_VISTA_APEL_FR.jdp" );
  ...
  {
    this.registerListener ( "SEGURO_SOCIAL_JEFE_SERVICIO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; VERIFICAR_SEG_SOC_VISTAL_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "PARK_VISTA", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; VERIFICAR_PARK_VISTA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
