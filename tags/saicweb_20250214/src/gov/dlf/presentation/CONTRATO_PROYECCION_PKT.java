 ...
 */
public class CONTRATO_PROYECCION_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CONTRATO_PROYECCION_PKT ( )
  {
    super ( "CONTRATO_PROYECCION_PKT" );
   ...
   *
   */
  public CONTRATO_PROYECCION_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CONTRATO_PROYECCION_PKT ( MDIFrame pFrame )
  {
    super ( "CONTRATO_PROYECCION_PKT", pFrame );
  ...
  {
    this.createComponents ( new CONTRATO_PROYECCION_FR ( ) );
   ...
   *
   */
  public static CONTRATO_PROYECCION_PKT get ( RallyApplication __app )
  {
    return ( CONTRATO_PROYECCION_PKT ) __app.getNewInstance ( "CONTRATO_PROYECCION_PKT" );
  }
  ...
  {
    CONTRATO_PROYECCION_PKT fSheet = CONTRATO_PROYECCION_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CONTRATO_PROYECCION_PKT.exec ( __app );
  }
