 ...
 */
public class CENTRAL_DESEA_ESTE_CLIENTE_FR_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CENTRAL_DESEA_ESTE_CLIENTE_FR_PKT ( )
  {
    super ( "CENTRAL_DESEA_ESTE_CLIENTE_FR_PKT" );
   ...
   *
   */
  public CENTRAL_DESEA_ESTE_CLIENTE_FR_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CENTRAL_DESEA_ESTE_CLIENTE_FR_PKT ( MDIFrame pFrame )
  {
    super ( "CENTRAL_DESEA_ESTE_CLIENTE_FR_PKT", pFrame );
  ...
  {
    this.createComponents ( new CENTRAL_DESEA_ESTE_CLIENTE_FR ( ) );
   ...
   *
   */
  public static CENTRAL_DESEA_ESTE_CLIENTE_FR_PKT get ( RallyApplication __app )
  {
    return ( CENTRAL_DESEA_ESTE_CLIENTE_FR_PKT ) __app.getNewInstance ( "CENTRAL_DESEA_ESTE_CLIENTE_FR_PKT" );
  }
  ...
  {
    CENTRAL_DESEA_ESTE_CLIENTE_FR_PKT fSheet = CENTRAL_DESEA_ESTE_CLIENTE_FR_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CENTRAL_DESEA_ESTE_CLIENTE_FR_PKT.exec ( __app );
  }
