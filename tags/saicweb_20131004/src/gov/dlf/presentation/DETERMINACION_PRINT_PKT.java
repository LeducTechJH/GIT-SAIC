 ...
 */
public class DETERMINACION_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public DETERMINACION_PRINT_PKT ( )
  {
    super ( "DETERMINACION_PRINT_PKT" );
   ...
   *
   */
  public DETERMINACION_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DETERMINACION_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "DETERMINACION_PRINT_PKT", pFrame );
   ...
   *
   */
  public static DETERMINACION_PRINT_PKT get ( RallyApplication __app )
  {
    return ( DETERMINACION_PRINT_PKT ) __app.getNewInstance ( "DETERMINACION_PRINT_PKT" );
  }
  ...
  {
    DETERMINACION_PRINT_PKT fSheet = DETERMINACION_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DETERMINACION_PRINT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; PASE_DE_VARIABLES.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
