 ...
 */
public class STATUS_REFERIDO_FRAUDE_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public STATUS_REFERIDO_FRAUDE_LOV_FR ( )
  {
    super ( );
    this.setName ( "STATUS_REFERIDO_FRAUDE_LOV_FR" );

    Debug.println ( Debug.TRACE, "STATUS_REFERIDO_FRAUDE_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/STATUS_REFERIDO_FRAUDE_LOV_FR.jdp" );
