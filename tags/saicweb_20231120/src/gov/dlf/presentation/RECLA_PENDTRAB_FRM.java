 ...
 */
public class RECLA_PENDTRAB_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public RECLA_PENDTRAB_FRM ( )
  {
    super ( );
    this.setName ( "RECLA_PENDTRAB_FRM" );

    Debug.println ( Debug.TRACE, "RECLA_PENDTRAB_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RECLA_PENDTRAB_FRM.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "RECLAMACIONES_REFERIDAS_GRP", new RECLA_PENDTRAB_FRM_RECLAMACIONES_REFERIDAS_GRP_Arguments ( this ) );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "RECLA_REFE_PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; BEF_VISIT_PENDTRAB_PARK_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "RECLA_REFE_PARK", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; AFT_VISIT_PENDTRAB_PARK_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class RECLA_PENDTRAB_FRM_RECLAMACIONES_REFERIDAS_GRP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public RECLA_PENDTRAB_FRM_RECLAMACIONES_REFERIDAS_GRP_Arguments ( Form form )
  {
    this.model = form;
