     ...
     extends Form
{
  ...
  public ANS_FR ( )
  {
    ...
    Debug.println ( Debug.TRACE, "ANS_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ANS_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field = ( JDataPanelField ) this.getInDepth ( "ANSWER_TEXT" );
    field.setValueProvider ( new ANS_FR_ANSWER_TEXTProvider ( this ) );
 ...
 *
 */
class ANS_FR_ANSWER_TEXTProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public ANS_FR_ANSWER_TEXTProvider ( Form form )
  {
    this.model = form;
  }
  ...
  public Object getValue ( )
  {
    ...
    return TRANSFER_ANS_ADL.getANSWER_TYPE ( this.app );
  }
}
