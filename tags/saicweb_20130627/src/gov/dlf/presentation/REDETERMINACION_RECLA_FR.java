 ...
 */
public class REDETERMINACION_RECLA_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public REDETERMINACION_RECLA_FR ( )
  {
    super ( );
    this.setName ( "REDETERMINACION_RECLA_FR" );

    Debug.println ( Debug.TRACE, "REDETERMINACION_RECLA_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REDETERMINACION_RECLA_FR.jdp" );
