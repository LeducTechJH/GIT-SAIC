 ...
 */
public class TARJETA_REF_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TARJETA_REF_PRINT_PKT ( )
  {
    super ( "TARJETA_REF_PRINT_PKT" );
   ...
   *
   */
  public TARJETA_REF_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TARJETA_REF_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "TARJETA_REF_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new TARJETA_REF_RP ( ) );
   ...
   *
   */
  public static TARJETA_REF_PRINT_PKT get ( RallyApplication __app )
  {
    return ( TARJETA_REF_PRINT_PKT ) __app.getNewInstance ( "TARJETA_REF_PRINT_PKT" );
  }
  ...
  {
    TARJETA_REF_PRINT_PKT fSheet = TARJETA_REF_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TARJETA_REF_PRINT_PKT.exec ( __app );
  }
