 ...
 */
public class TRANSFER_RECIBIDAS_ESTADISTICO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TRANSFER_RECIBIDAS_ESTADISTICO_PKT ( )
  {
    super ( "TRANSFER_RECIBIDAS_ESTADISTICO_PKT" );
   ...
   *
   */
  public TRANSFER_RECIBIDAS_ESTADISTICO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TRANSFER_RECIBIDAS_ESTADISTICO_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_RECIBIDAS_ESTADISTICO_PKT", pFrame );
  ...
  {
    this.createComponents ( new TRANSFER_RECIBIDAS_ESTADISTICO_FR ( ) );
   ...
   *
   */
  public static TRANSFER_RECIBIDAS_ESTADISTICO_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_RECIBIDAS_ESTADISTICO_PKT ) __app.getNewInstance ( "TRANSFER_RECIBIDAS_ESTADISTICO_PKT" );
  }
  ...
  {
    TRANSFER_RECIBIDAS_ESTADISTICO_PKT fSheet = TRANSFER_RECIBIDAS_ESTADISTICO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_RECIBIDAS_ESTADISTICO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_TRANSFER_RECIBIDAS_ESTADISTICO_MENU.exec ( app, null );
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; TRANSFER_RECIBIDAS_ESTADISTICO_LLENAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
