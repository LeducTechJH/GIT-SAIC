 ...
 */
public class GEN_RECHAZO_ESFU_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_RECHAZO_ESFU_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_RECHAZO_ESFU_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_RECHAZO_ESFU_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_RECHAZO_ESFU_LOV_FR.jdp" );
