     ...
     extends FormSheet
{
   ...
   *
   */
  public ADSEF_PPT1_PKT ( )
  {
    super ( "ADSEF_PPT1_PKT" );
   ...
   *
   */
  public ADSEF_PPT1_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ADSEF_PPT1_PKT ( MDIFrame pFrame )
  {
    super ( "ADSEF_PPT1_PKT", pFrame );
   ...
   *
   */
  public static ADSEF_PPT1_PKT get ( RallyApplication __app )
  {
    return ( ADSEF_PPT1_PKT ) __app.getNewInstance ( "ADSEF_PPT1_PKT" );
  }
  ...
  {
    ADSEF_PPT1_PKT fSheet = ADSEF_PPT1_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ADSEF_PPT1_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_PPT_1_MENU.exec ( app, null );
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; 
        ADSEF_PPT1_BEF_ADL.exec ( app ); 
        LIC_FCH_EXPEDIDA_ADL.exec ( app );
        return app.errorFlag;
      }
    } );
  }
