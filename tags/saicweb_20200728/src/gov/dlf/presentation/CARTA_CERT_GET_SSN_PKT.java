 ...
 */
public class CARTA_CERT_GET_SSN_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CARTA_CERT_GET_SSN_PKT ( )
  {
    super ( "CARTA_CERT_GET_SSN_PKT" );
   ...
   *
   */
  public CARTA_CERT_GET_SSN_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CARTA_CERT_GET_SSN_PKT ( MDIFrame pFrame )
  {
    super ( "CARTA_CERT_GET_SSN_PKT", pFrame );
  ...
  {
    this.createComponents ( new CARTA_CERTI_GET_SSN_FAM_FR ( ) );
   ...
   *
   */
  public static CARTA_CERT_GET_SSN_PKT get ( RallyApplication __app )
  {
    return ( CARTA_CERT_GET_SSN_PKT ) __app.getNewInstance ( "CARTA_CERT_GET_SSN_PKT" );
  }
  ...
  {
    CARTA_CERT_GET_SSN_PKT fSheet = CARTA_CERT_GET_SSN_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CARTA_CERT_GET_SSN_PKT.exec ( __app );
  }
