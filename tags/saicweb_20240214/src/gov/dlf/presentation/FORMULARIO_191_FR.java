 ...
 */
public class FORMULARIO_191_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public FORMULARIO_191_FR ( )
  {
    super ( );
    this.setName ( "FORMULARIO_191_FR" );

    Debug.println ( Debug.TRACE, "FORMULARIO_191_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/FORMULARIO_191_FR.jdp" );
