 ...
 */
public class FCH_FACTURA_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public FCH_FACTURA_LOV_FR ( )
  {
    super ( );
    this.setName ( "FCH_FACTURA_LOV_FR" );

    Debug.println ( Debug.TRACE, "FCH_FACTURA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/FCH_FACTURA_LOV_FR.jdp" );
