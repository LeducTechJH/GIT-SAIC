						...
						( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  )
				{
							...
							( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "BILV" ) ) )
					{
						...
						if  (exento)
						{
							...
							{
								if ( Compare.le(this.dm.getFieldDouble ( this.dm.get ( "PTRA_EMPLEOS2_DSD" ),"REMANENTE" ), 5))
								{
...
//									SALARIO_TEMP = SALARIO_TEMP * 0;
								...
								else if ( Compare.ge(this.dm.getFieldDouble ( this.dm.get ( "PTRA_EMPLEOS2_DSD" ),"REMANENTE" ), 6) && Compare.le(this.dm.getFieldDouble ( this.dm.get ( "PTRA_EMPLEOS2_DSD" ),"REMANENTE" ), 11))
								{
...
//									SALARIO_TEMP = SALARIO_TEMP - ( SALARIO_TEMP *.66 );
								...
								else if ( Compare.ge(this.dm.getFieldDouble ( this.dm.get ( "PTRA_EMPLEOS2_DSD" ),"REMANENTE" ), 12) && Compare.le(this.dm.getFieldDouble ( this.dm.get ( "PTRA_EMPLEOS2_DSD" ),"REMANENTE" ), 17))
								{
