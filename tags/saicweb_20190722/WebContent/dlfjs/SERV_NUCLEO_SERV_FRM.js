...
//	***** START MODS BY J. OLMEDA - 8/13/2010 *****
	...
	if ( codServicio == "PAN" || codServicio == "TANFS" || codServicio == "TANFE" || codServicio == "LICE1" || codServicio == "LICE2" || codServicio == "LICE3" || codServicio == "LICE4" || codServicio == "LICE5" || codServicio == "CLIM1" || codServicio == "CLIM2" || codServicio == "CLIM3" || codServicio == "CLIM4")
	{
	...
	if (codServicio.substring(0,4) == "LICE" || codServicio.substring(0,4) == "CLIM" || codServicio == "LISE")
	{
		...
		if (codServicio.substring(0,4)  == "LICE" || codServicio.substring(0,4)  == "CLIM")
		{
		...
		if ((codServicio.substring(0,4)  == "LISE") )
		{
			var element0 = document.getElementById("EMER_NUM_CUENTA.0.0.0");
			if (element0)
			{
