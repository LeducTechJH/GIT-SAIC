 ...
 */
public class RR_INS_DSS171_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public RR_INS_DSS171_PKT ( )
  {
    super ( "RR_INS_DSS171_PKT" );
   ...
   *
   */
  public RR_INS_DSS171_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RR_INS_DSS171_PKT ( MDIFrame pFrame )
  {
    super ( "RR_INS_DSS171_PKT", pFrame );
  ...
  {
    this.createComponents ( new RR_INS_DSS171_FR ( ) );
   ...
   *
   */
  public static RR_INS_DSS171_PKT get ( RallyApplication __app )
  {
    return ( RR_INS_DSS171_PKT ) __app.getNewInstance ( "RR_INS_DSS171_PKT" );
  }
  ...
  {
    RR_INS_DSS171_PKT fSheet = RR_INS_DSS171_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RR_INS_DSS171_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; RR_INS_BFR_DSS171_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
