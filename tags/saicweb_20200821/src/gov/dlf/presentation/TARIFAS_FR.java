     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "TARIFAS_FR" );

    Debug.println ( Debug.TRACE, "TARIFAS_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TARIFAS_FR.jdp" );
