 ...
 */
public class CASOS_HISTORICO_SUB_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CASOS_HISTORICO_SUB_PKT ( )
  {
    super ( "CASOS_HISTORICO_SUB_PKT" );
   ...
   *
   */
  public CASOS_HISTORICO_SUB_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CASOS_HISTORICO_SUB_PKT ( MDIFrame pFrame )
  {
    super ( "CASOS_HISTORICO_SUB_PKT", pFrame );
  ...
  {
    this.createComponents ( new CASOS_HISTORICOS_SUB_FR ( ) );
   ...
   *
   */
  public static CASOS_HISTORICO_SUB_PKT get ( RallyApplication __app )
  {
    return ( CASOS_HISTORICO_SUB_PKT ) __app.getNewInstance ( "CASOS_HISTORICO_SUB_PKT" );
  }
  ...
  {
    CASOS_HISTORICO_SUB_PKT fSheet = CASOS_HISTORICO_SUB_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CASOS_HISTORICO_SUB_PKT.exec ( __app );
  }
