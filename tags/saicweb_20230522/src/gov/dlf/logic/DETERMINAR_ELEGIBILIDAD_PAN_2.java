						...
						( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  )
				{
							...
							( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "BILV" ) ) )
					{
						...
						if  (exento)
						{
							...
							{
								if ( Compare.le(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ),"REMANENTE" ), 5))
								{
								...
								else if ( Compare.ge(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ),"REMANENTE" ), 6) && Compare.le(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ),"REMANENTE" ), 11))
								{
							...
							else
							{
								...
								if ( Compare.equals( STATUS_PTRA, 0 ) )
								{
									...
									{
										SALARIO = MathService.plus (SALARIO , MathService.minus (  this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ), TruncService.trunc(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) *.5 )));
									}
									else
									{
										SALARIO = MathService.plus ( SALARIO, this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" )  );
...
//									SALARIO_TEMP = SALARIO_TEMP - ( SALARIO_TEMP *.33 );
							...
							else
							{
								...
								if ( Compare.equals( STATUS_PTRA, 0 ) )
								{
									...
									else if ( Compare.ge(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ),"REMANENTE_TANF" ), 12) && Compare.le(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ),"REMANENTE" ), 17))
									{
										SALARIO = MathService.plus (SALARIO , MathService.minus ( INGRESO_BRUTO,  TruncService.trunc(INGRESO_BRUTO *.5) ));
									}
									else
									{
										SALARIO = MathService.plus (SALARIO , INGRESO_BRUTO);
