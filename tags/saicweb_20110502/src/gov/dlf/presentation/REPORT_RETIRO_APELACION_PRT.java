 ...
 */
public class REPORT_RETIRO_APELACION_PRT
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public REPORT_RETIRO_APELACION_PRT ( )
  {
    super ( );
    this.setName ( "REPORT_RETIRO_APELACION_PRT" );

    Debug.println ( Debug.TRACE, "REPORT_RETIRO_APELACION_PRT - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REPORT_RETIRO_APELACION_PRT.jdp" );
