 ...
 */
public class EMPLEOS_CLIENTE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public EMPLEOS_CLIENTE_PKT ( )
  {
    super ( "EMPLEOS_CLIENTE_PKT" );
   ...
   *
   */
  public EMPLEOS_CLIENTE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public EMPLEOS_CLIENTE_PKT ( MDIFrame pFrame )
  {
    super ( "EMPLEOS_CLIENTE_PKT", pFrame );
   ...
   *
   */
  public static EMPLEOS_CLIENTE_PKT get ( RallyApplication __app )
  {
    return ( EMPLEOS_CLIENTE_PKT ) __app.getNewInstance ( "EMPLEOS_CLIENTE_PKT" );
  }
  ...
  {
    EMPLEOS_CLIENTE_PKT fSheet = EMPLEOS_CLIENTE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return EMPLEOS_CLIENTE_PKT.exec ( __app );
  }
