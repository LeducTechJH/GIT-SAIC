     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( ( Compare.equals ( this.app.MACA_GBL, 1 ) ) && ( Compare.equals ( RallyStringService.subString ( this.dm.getFieldString ( this.dm.get ( "GEN_MODU_RO_DSD" ), "DSC_LARGA" ), 3, 1 ), "1" ) )  ) 
    {
      UPDATE_CONFIRM = 1;
    }
    if ( ( Compare.equals ( this.app.OELP_GBL, 1 ) ) && ( Compare.equals ( RallyStringService.subString ( this.dm.getFieldString ( this.dm.get ( "GEN_MODU_RO_DSD" ), "DSC_LARGA" ), 7, 1 ), "1" ) )  ) 
    {
      UPDATE_CONFIRM = 1;
    }
