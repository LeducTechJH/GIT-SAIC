     ...
     extends FormSheet
{
   ...
   *
   */
  public SERV_CUIDO_PKT ( )
  {
    super ( "SERV_CUIDO_PKT" );
   ...
   *
   */
  public SERV_CUIDO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SERV_CUIDO_PKT ( MDIFrame pFrame )
  {
    super ( "SERV_CUIDO_PKT", pFrame );
  ...
  {
    this.createComponents ( new SERV_CUIDO_FRM ( ) );
   ...
   *
   */
  public static SERV_CUIDO_PKT get ( RallyApplication __app )
  {
    return ( SERV_CUIDO_PKT ) __app.getNewInstance ( "SERV_CUIDO_PKT" );
  }
  ...
  {
    SERV_CUIDO_PKT fSheet = SERV_CUIDO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SERV_CUIDO_PKT.exec ( __app );
  }
