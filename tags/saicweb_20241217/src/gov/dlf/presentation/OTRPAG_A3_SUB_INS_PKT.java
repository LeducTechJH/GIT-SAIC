 ...
 */
public class OTRPAG_A3_SUB_INS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public OTRPAG_A3_SUB_INS_PKT ( )
  {
    super ( "OTRPAG_A3_SUB_INS_PKT" );
   ...
   *
   */
  public OTRPAG_A3_SUB_INS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public OTRPAG_A3_SUB_INS_PKT ( MDIFrame pFrame )
  {
    super ( "OTRPAG_A3_SUB_INS_PKT", pFrame );
  ...
  {
    this.createComponents ( new OTRPAG_A3_SUB_FR ( ) );
   ...
   *
   */
  public static OTRPAG_A3_SUB_INS_PKT get ( RallyApplication __app )
  {
    return ( OTRPAG_A3_SUB_INS_PKT ) __app.getNewInstance ( "OTRPAG_A3_SUB_INS_PKT" );
  }
  ...
  {
    OTRPAG_A3_SUB_INS_PKT fSheet = OTRPAG_A3_SUB_INS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return OTRPAG_A3_SUB_INS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; OTRPAG1_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
