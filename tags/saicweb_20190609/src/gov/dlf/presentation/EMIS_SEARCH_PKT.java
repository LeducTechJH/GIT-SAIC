     ...
     extends FormSheet
{
   ...
   *
   */
  public EMIS_SEARCH_PKT ( )
  {
    super ( "EMIS_SEARCH_PKT" );
   ...
   *
   */
  public EMIS_SEARCH_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public EMIS_SEARCH_PKT ( MDIFrame pFrame )
  {
    super ( "EMIS_SEARCH_PKT", pFrame );
   ...
   *
   */
  public static EMIS_SEARCH_PKT get ( RallyApplication __app )
  {
    return ( EMIS_SEARCH_PKT ) __app.getNewInstance ( "EMIS_SEARCH_PKT" );
  }
  ...
  {
    EMIS_SEARCH_PKT fSheet = EMIS_SEARCH_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return EMIS_SEARCH_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_CONSULTA_EMISIONES_MENU.exec ( app, null );
