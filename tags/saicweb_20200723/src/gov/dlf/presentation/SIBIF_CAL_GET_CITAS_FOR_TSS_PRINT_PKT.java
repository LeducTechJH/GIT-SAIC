 ...
 */
public class SIBIF_CAL_GET_CITAS_FOR_TSS_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SIBIF_CAL_GET_CITAS_FOR_TSS_PRINT_PKT ( )
  {
    super ( "SIBIF_CAL_GET_CITAS_FOR_TSS_PRINT_PKT" );
   ...
   *
   */
  public SIBIF_CAL_GET_CITAS_FOR_TSS_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SIBIF_CAL_GET_CITAS_FOR_TSS_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "SIBIF_CAL_GET_CITAS_FOR_TSS_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new SIBIF_CAL_GET_CITAS_FOR_TSS_FR ( ) );
   ...
   *
   */
  public static SIBIF_CAL_GET_CITAS_FOR_TSS_PRINT_PKT get ( RallyApplication __app )
  {
    return ( SIBIF_CAL_GET_CITAS_FOR_TSS_PRINT_PKT ) __app.getNewInstance ( "SIBIF_CAL_GET_CITAS_FOR_TSS_PRINT_PKT" );
  }
  ...
  {
    SIBIF_CAL_GET_CITAS_FOR_TSS_PRINT_PKT fSheet = SIBIF_CAL_GET_CITAS_FOR_TSS_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SIBIF_CAL_GET_CITAS_FOR_TSS_PRINT_PKT.exec ( __app );
  }
