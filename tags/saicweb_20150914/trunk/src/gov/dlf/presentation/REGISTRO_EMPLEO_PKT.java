 ...
 */
public class REGISTRO_EMPLEO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REGISTRO_EMPLEO_PKT ( )
  {
    super ( "REGISTRO_EMPLEO_PKT" );
   ...
   *
   */
  public REGISTRO_EMPLEO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REGISTRO_EMPLEO_PKT ( MDIFrame pFrame )
  {
    super ( "REGISTRO_EMPLEO_PKT", pFrame );
  ...
  {
    this.createComponents ( new REGISTRO_EMPLEOS_FR ( ) );
   ...
   *
   */
  public static REGISTRO_EMPLEO_PKT get ( RallyApplication __app )
  {
    return ( REGISTRO_EMPLEO_PKT ) __app.getNewInstance ( "REGISTRO_EMPLEO_PKT" );
  }
  ...
  {
    REGISTRO_EMPLEO_PKT fSheet = REGISTRO_EMPLEO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REGISTRO_EMPLEO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; FCH_REG_ACTUALIZAR_A_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; REGISTRO_EMPLEOS_BF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
