     ...
     extends ADL
{
  ...
  protected void step1 ( ParameterSet ps )
  {
    ...
    if ( ! Compare.equals ( this.app.form ( "SERV_FAM_FRM" ).getStringItem ( "COD_STATUS_SERVICIO" ), "CERRAD12" )) 
    {
    ...
    if (  Compare.equals ( STATUS4_ID, 0 ) ) 
    {
    	if ( ! (Compare.le( this.app.SYSTEM_DATE,DateUtil.addMonths (this.dm.getFieldDate ( this.dm.get ( "SERVICIOS_READ_LOC2_DSD" ), "FCH_CERRADO" ),1))))
    	{
    		  this.app.setError ("0","Esta opcion solo es valida hasta un mes despues de haber sido cerrado el caso." );
    	      this.doReturn ( );
    	      return; 
    	}
