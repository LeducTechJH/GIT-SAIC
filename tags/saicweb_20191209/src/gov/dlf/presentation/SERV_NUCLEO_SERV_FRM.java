    ...
    this.registerListener ( "COD_SERVICIO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
		...
		this.registerListener ( "SERV_DIRECCION_GP", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				...
				try
				{
					...
					if ( serv.equals ( "ATEM" ) || serv.equals ( "ATFS" ) || serv.equals ( "ATES" ) || serv.equals ( "LISE" ) || serv.contains ( "LICE" ) || serv.contains ( "CLIM" ))
					{
		...
		this.registerListener ( "EMERG_NOM_SUPL_SERV", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			...
			{
				String serv = __form.getStringItem ( "COD_SERVICIO" );
				if (  serv.contains ( "LICE" ) || serv.contains ( "CLIM" ) )
				{
					if(serv.contains ( "LICE1" ))
					{
		...
		this.registerListener ( "EMER_NUM_CUENTA", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				...
				{	  
					...
					{
						app.setError ("0", "La cantidad autorizada de atraso o pago de luz sobrepasa los $750.00.");
						app.form("SERV_NUCLEO_SERV_FRM").setItem("CANTIDAD_AUTO", 750);
						app.errorFlag = true;
						return app.errorFlag;
					}
					app.errorFlag = true;
		...
		this.registerListener ( "CANTIDAD_AUTO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				...
				{
					if (Compare.gt(cantAuto, 130))
					{
						app.setError ("0", "La cantidad autorizada para compra o reparacion de abanico sobrepasa los $130.00.");
						app.errorFlag = false;
						return app.errorFlag;
					}
				}
				...
				else if (  serv.equals ( "CLIM1" ) )
				{
					if (Compare.gt(cantAuto, 200))
					{
						app.setError ("0", "La cantidad autorizada para compra de luces solares sobrepasa los $200.00.");
						app.errorFlag = false;
						return app.errorFlag;
					}
				}
				else if (  serv.equals ( "CLIM2" ) )
				{
					if (Compare.gt(cantAuto, 2000))
					{
						app.setError ("0", "La cantidad autorizada para compra de nevera sobrepasa los $2,000.00.");
						app.errorFlag = false;
						return app.errorFlag;
					}
				}
				else if (  serv.equals ( "CLIM3" ) )
				{
					if (Compare.gt(cantAuto, 2000))
					{
						app.setError ("0", "La cantidad autorizada para compra de acondicionador de aire sobrepasa los $2,000.00.");
						app.errorFlag = false;
						return app.errorFlag;
					}
				}
				else if (  serv.equals ( "CLIM4" ) )
				{
					if (Compare.gt(cantAuto, 130))
					{
						app.setError ("0", "La cantidad autorizada para compra de abanico solar los $130.00.");
						app.errorFlag = false;
						return app.errorFlag;
					}
				}
