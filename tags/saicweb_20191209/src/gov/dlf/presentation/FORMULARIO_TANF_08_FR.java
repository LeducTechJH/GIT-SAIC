 ...
 */
public class FORMULARIO_TANF_08_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public FORMULARIO_TANF_08_FR ( )
  {
    super ( );
    this.setName ( "FORMULARIO_TANF_08_FR" );

    Debug.println ( Debug.TRACE, "FORMULARIO_TANF_08_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/FORMULARIO_TANF_08_FR.jdp" );
