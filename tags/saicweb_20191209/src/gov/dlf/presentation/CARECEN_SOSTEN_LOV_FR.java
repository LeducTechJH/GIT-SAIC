 ...
 */
public class CARECEN_SOSTEN_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CARECEN_SOSTEN_LOV_FR ( )
  {
    super ( );
    this.setName ( "CARECEN_SOSTEN_LOV_FR" );

    Debug.println ( Debug.TRACE, "CARECEN_SOSTEN_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CARECEN_SOSTEN_LOV_FR.jdp" );
