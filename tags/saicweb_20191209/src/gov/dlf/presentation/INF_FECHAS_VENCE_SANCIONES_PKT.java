 ...
 */
public class INF_FECHAS_VENCE_SANCIONES_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INF_FECHAS_VENCE_SANCIONES_PKT ( )
  {
    super ( "INF_FECHAS_VENCE_SANCIONES_PKT" );
   ...
   *
   */
  public INF_FECHAS_VENCE_SANCIONES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INF_FECHAS_VENCE_SANCIONES_PKT ( MDIFrame pFrame )
  {
    super ( "INF_FECHAS_VENCE_SANCIONES_PKT", pFrame );
   ...
   *
   */
  public static INF_FECHAS_VENCE_SANCIONES_PKT get ( RallyApplication __app )
  {
    return ( INF_FECHAS_VENCE_SANCIONES_PKT ) __app.getNewInstance ( "INF_FECHAS_VENCE_SANCIONES_PKT" );
  }
  ...
  {
    INF_FECHAS_VENCE_SANCIONES_PKT fSheet = INF_FECHAS_VENCE_SANCIONES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INF_FECHAS_VENCE_SANCIONES_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_SANCIONES_VENCE_MENU.exec ( app, null );
