 ...
 */
public class INF_FECHAS_VENCE24_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INF_FECHAS_VENCE24_PKT ( )
  {
    super ( "INF_FECHAS_VENCE24_PKT" );
   ...
   *
   */
  public INF_FECHAS_VENCE24_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INF_FECHAS_VENCE24_PKT ( MDIFrame pFrame )
  {
    super ( "INF_FECHAS_VENCE24_PKT", pFrame );
   ...
   *
   */
  public static INF_FECHAS_VENCE24_PKT get ( RallyApplication __app )
  {
    return ( INF_FECHAS_VENCE24_PKT ) __app.getNewInstance ( "INF_FECHAS_VENCE24_PKT" );
  }
  ...
  {
    INF_FECHAS_VENCE24_PKT fSheet = INF_FECHAS_VENCE24_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INF_FECHAS_VENCE24_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_CASOS_VENCE24_MENU.exec ( app, null );
