 ...
 */
public class REFERIDO_RECLA_AUTO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REFERIDO_RECLA_AUTO_PKT ( )
  {
    super ( "REFERIDO_RECLA_AUTO_PKT" );
   ...
   *
   */
  public REFERIDO_RECLA_AUTO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REFERIDO_RECLA_AUTO_PKT ( MDIFrame pFrame )
  {
    super ( "REFERIDO_RECLA_AUTO_PKT", pFrame );
  ...
  {
    this.createComponents ( new REFERIDO_RECLA_AUTO_FR ( ) );
   ...
   *
   */
  public static REFERIDO_RECLA_AUTO_PKT get ( RallyApplication __app )
  {
    return ( REFERIDO_RECLA_AUTO_PKT ) __app.getNewInstance ( "REFERIDO_RECLA_AUTO_PKT" );
  }
  ...
  {
    REFERIDO_RECLA_AUTO_PKT fSheet = REFERIDO_RECLA_AUTO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REFERIDO_RECLA_AUTO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; REFERIDO_RECLA_AUTO_BF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
