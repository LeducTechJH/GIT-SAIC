 ...
 */
public class REPORT_2_5_FR_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REPORT_2_5_FR_PKT ( )
  {
    super ( "REPORT_2_5_FR_PKT" );
   ...
   *
   */
  public REPORT_2_5_FR_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REPORT_2_5_FR_PKT ( MDIFrame pFrame )
  {
    super ( "REPORT_2_5_FR_PKT", pFrame );
  ...
  {
    this.createComponents ( new REPORT_2_5_FR ( ) );
   ...
   *
   */
  public static REPORT_2_5_FR_PKT get ( RallyApplication __app )
  {
    return ( REPORT_2_5_FR_PKT ) __app.getNewInstance ( "REPORT_2_5_FR_PKT" );
  }
  ...
  {
    REPORT_2_5_FR_PKT fSheet = REPORT_2_5_FR_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REPORT_2_5_FR_PKT.exec ( __app );
  }
