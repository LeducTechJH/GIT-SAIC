...
//***** START MODS BY J. OLMEDA - 8/13/2010 *****
  ...
  if (codServicio == "LICE" || codServicio == "LISE")
	  {
	  if (codServicio == "LICE")
	  	{
	  ...
	  if (!(codServicio == "LICE"))
	  	{
		  	...
		  	var element1 = document.getElementById("COD_SERV_SOLICITADO.0.0.0");
			if (element1) 
			{
			...
			var element3 = document.getElementById("SERV_EMERG_GP_TXT__21.0.0.0");
			if (element3) 
			{
			...
			var element5 = document.getElementById("DESC_COD_SERV.0.0.0");
			if (element5) 
			{
