 ...
 */
public class AJUSTE_PAN_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public AJUSTE_PAN_RPT_PKT ( )
  {
    super ( "AJUSTE_PAN_RPT_PKT" );
   ...
   *
   */
  public AJUSTE_PAN_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AJUSTE_PAN_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "AJUSTE_PAN_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new AJUSTE_PAN_RPT_FR ( ) );
   ...
   *
   */
  public static AJUSTE_PAN_RPT_PKT get ( RallyApplication __app )
  {
    return ( AJUSTE_PAN_RPT_PKT ) __app.getNewInstance ( "AJUSTE_PAN_RPT_PKT" );
  }
  ...
  {
    AJUSTE_PAN_RPT_PKT fSheet = AJUSTE_PAN_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return AJUSTE_PAN_RPT_PKT.exec ( __app );
  }
