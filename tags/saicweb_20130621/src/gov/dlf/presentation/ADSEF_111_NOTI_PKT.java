 ...
 */
public class ADSEF_111_NOTI_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ADSEF_111_NOTI_PKT ( )
  {
    super ( "ADSEF_111_NOTI_PKT" );
   ...
   *
   */
  public ADSEF_111_NOTI_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ADSEF_111_NOTI_PKT ( MDIFrame pFrame )
  {
    super ( "ADSEF_111_NOTI_PKT", pFrame );
   ...
   *
   */
  public static ADSEF_111_NOTI_PKT get ( RallyApplication __app )
  {
    return ( ADSEF_111_NOTI_PKT ) __app.getNewInstance ( "ADSEF_111_NOTI_PKT" );
  }
  ...
  {
    ADSEF_111_NOTI_PKT fSheet = ADSEF_111_NOTI_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ADSEF_111_NOTI_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; ADSEF_111_PAR_NOTI_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
