 ...
 */
public class ADSEF_PPT_4_NOM_PPKT 
  implements IRegisteredObject 
{
   ...
   *
   */
  public static ADSEF_PPT_4_NOM_PPKT get ( RallyApplication __app )
  {
    ADSEF_PPT_4_NOM_PPKT pp = ( ADSEF_PPT_4_NOM_PPKT ) __app.getNewInstance ( "ADSEF_PPT_4_NOM_PPKT" );
    return pp;
  }
  ...
  {
    return ADSEF_PPT_4_NOM_PPKT.exec ( __app );
  }
  ...
  {
    Debug.println ( Debug.TRACE, "ADSEF_PPT_4_NOM_PPKT" );
    this.prepareParms ( );
  ...
  protected void returnParms ( )
  {
    ...
    this.app.form ( "ADSEF_PPT_4_RP" ).setValue ( "NOMBRE_COMPLETO", this.parms.getString ( 1 ) );
  }
  ...
  protected void prepareParms ( )
  {
    ...
    this.parms.set ( this.app.form ( "ADSEF_PPT_4_RP" ).getValue ( "NOMBRE_COMPLETO" ) );
  }
