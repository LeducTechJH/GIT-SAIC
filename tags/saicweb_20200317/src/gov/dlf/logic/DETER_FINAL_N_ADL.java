     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
	  ...
	  {           
		  ...
		  else if (  Compare.equals (this.app.COD_SERV_GBL, "LISE" )  || ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "LICE" ) ) || ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "CLIM" ) ) )
		  {
			  this.app.returnTo ( "DETERMINAR_ELEGIBILIDAD_LIHEAP" ); if ( true ) return;
		  }
		  else if (  Compare.equals (this.app.COD_SERV_GBL, "TANFS" )  )
		  {
			  this.app.returnTo ( "DETERMINAR_ELEGIBILIDAD_TANFS" ); if ( true ) return;
		  }
		  else if (  Compare.equals (this.app.COD_SERV_GBL, "TANFE" )  )
		  {
			  this.app.returnTo ( "DETERMINAR_ELEGIBILIDAD_TANFE" ); if ( true ) return;
		  }
	  }
	  else
	  {
		 //BUSCAR_BASE_INCORRECTA_ADL.exec(this.app);
		 this.app.callCommand ( RallyAppCommandFactory.__EXITACTION );
		 //this.app.callCommand ( RallyAppCommandFactory.__EXITACTION );
   }
  }
}
