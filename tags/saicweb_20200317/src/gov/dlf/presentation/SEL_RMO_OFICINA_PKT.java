 ...
 */
public class SEL_RMO_OFICINA_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SEL_RMO_OFICINA_PKT ( )
  {
    super ( "SEL_RMO_OFICINA_PKT" );
   ...
   *
   */
  public SEL_RMO_OFICINA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SEL_RMO_OFICINA_PKT ( MDIFrame pFrame )
  {
    super ( "SEL_RMO_OFICINA_PKT", pFrame );
  ...
  {
    this.createComponents ( new SEL_RMO_OFICINA_FR ( ) );
   ...
   *
   */
  public static SEL_RMO_OFICINA_PKT get ( RallyApplication __app )
  {
    return ( SEL_RMO_OFICINA_PKT ) __app.getNewInstance ( "SEL_RMO_OFICINA_PKT" );
  }
  ...
  {
    SEL_RMO_OFICINA_PKT fSheet = SEL_RMO_OFICINA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SEL_RMO_OFICINA_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SEL_RMO_OFICINA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
