     ...
     extends Form
{
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "NOMBRE_CLIENTE", new PADRE_MADRE_AUSENTE_CLIENTE_MENORES_FR_NOMBRE_CLIENTE_Arguments ( this ) );
 ...
 *
 */
class PADRE_MADRE_AUSENTE_CLIENTE_MENORES_FR_NOMBRE_CLIENTE_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public PADRE_MADRE_AUSENTE_CLIENTE_MENORES_FR_NOMBRE_CLIENTE_Arguments ( Form form )
  {
    this.model = form;
