 ...
 */
public class MANTENIMIENTO_INGRESO_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_INGRESO_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_INGRESO_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_INGRESO_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_INGRESO_FR.jdp" );
