 ...
 */
public class PTRA_EMPLEO_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PTRA_EMPLEO_RO_PKT ( )
  {
    super ( "PTRA_EMPLEO_RO_PKT" );
   ...
   *
   */
  public PTRA_EMPLEO_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PTRA_EMPLEO_RO_PKT ( MDIFrame pFrame )
  {
    super ( "PTRA_EMPLEO_RO_PKT", pFrame );
   ...
   *
   */
  public static PTRA_EMPLEO_RO_PKT get ( RallyApplication __app )
  {
    return ( PTRA_EMPLEO_RO_PKT ) __app.getNewInstance ( "PTRA_EMPLEO_RO_PKT" );
  }
  ...
  {
    PTRA_EMPLEO_RO_PKT fSheet = PTRA_EMPLEO_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PTRA_EMPLEO_RO_PKT.exec ( __app );
  }
