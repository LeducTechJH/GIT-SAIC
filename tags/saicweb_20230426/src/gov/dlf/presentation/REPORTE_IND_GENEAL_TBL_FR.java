 ...
 */
public class REPORTE_IND_GENEAL_TBL_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public REPORTE_IND_GENEAL_TBL_FR ( )
  {
    super ( );
    this.setName ( "REPORTE_IND_GENEAL_TBL_FR" );

    Debug.println ( Debug.TRACE, "REPORTE_IND_GENEAL_TBL_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REPORTE_IND_GENEAL_TBL_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; REPORTE_IND_GEN_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    
    this.registerListener ( "CODIGO_GEN", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
