  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        ...
        //***** Start Mods by JOR 5/21/2010 *****
        String serv = formModel.getStringItem ( "COD_SERVICIO" );
        if ( RallyStringService.subString ( serv, 0, 4).equals ( "PANE" ) )
        {        
          String razonEmerg = formModel.getStringItem ( "COD_RAZON_EMERGENCIA" );
          if ( razonEmerg == "")
          {
            app.setError ( 0, 8476 );
        	app.errorFlag = false; 
