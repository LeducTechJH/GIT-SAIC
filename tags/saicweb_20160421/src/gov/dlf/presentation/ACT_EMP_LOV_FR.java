     ...
     extends Form
{
   ...
   *
   */
  public ACT_EMP_LOV_FR ( )
  {
    super ( );
    this.setName ( "ACT_EMP_LOV_FR" );

    Debug.println ( Debug.TRACE, "ACT_EMP_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ACT_EMP_LOV_FR.jdp" );
