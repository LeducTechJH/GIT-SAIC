 ...
 */
public class ACTUALIZAR_RECLA_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ACTUALIZAR_RECLA_RO_PKT ( )
  {
    super ( "ACTUALIZAR_RECLA_RO_PKT" );
   ...
   *
   */
  public ACTUALIZAR_RECLA_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ACTUALIZAR_RECLA_RO_PKT ( MDIFrame pFrame )
  {
    super ( "ACTUALIZAR_RECLA_RO_PKT", pFrame );
   ...
   *
   */
  public static ACTUALIZAR_RECLA_RO_PKT get ( RallyApplication __app )
  {
    return ( ACTUALIZAR_RECLA_RO_PKT ) __app.getNewInstance ( "ACTUALIZAR_RECLA_RO_PKT" );
  }
  ...
  {
    ACTUALIZAR_RECLA_RO_PKT fSheet = ACTUALIZAR_RECLA_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ACTUALIZAR_RECLA_RO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; BEFORE_ACT_RECL_RO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
