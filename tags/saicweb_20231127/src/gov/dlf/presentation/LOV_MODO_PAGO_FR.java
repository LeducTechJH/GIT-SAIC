     ...
     extends Form
{
   ...
   *
   */
  public LOV_MODO_PAGO_FR ( )
  {
    super ( );
    this.setName ( "LOV_MODO_PAGO_FR" );

    Debug.println ( Debug.TRACE, "LOV_MODO_PAGO_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/LOV_MODO_PAGO_FR.jdp" );
