     ...
     extends Form
{
   ...
   *
   */
  public GET_DSS173_FR ( )
  {
    super ( );
    this.setName ( "GET_DSS173_FR" );

    Debug.println ( Debug.TRACE, "GET_DSS173_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_DSS173_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; DSS173_PERSONA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
