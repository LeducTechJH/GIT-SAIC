...
import gov.dlf.presentation.AJUSTE_EMERGENCIA_PKT;
...
import net.maintrend.util.DateUtil;
...
//      EXENCION_SEG_SOC = this.dm.getFieldDouble ( this.dm.get ( "DETERMINA_RO_DSD" ), "EXENCION_SEG_SOC" );
    ...
    while ( Compare.equals ( STATUS_CODE, 0 )  )
    {
      ...
      */
      ...
      // New code (2008-09-12):
      CLIENTE_AGENCIA_RO_DSD.reset ( );
      CLIENTE_AGENCIA_RO_DSD.setCondition ( "SEGURO_SOCIAL_CLIENTE", this.app.SS_IND_GBL );
      CLIENTE_AGENCIA_RO_DSD.setCondition ( "RMO_OFICINA", RECURSOS_NUCLEO_DSD.getItem ( "RMO_OFICINA" ) );

      this.dm.retrieve ( CLIENTE_AGENCIA_RO_DSD );
      int rowCount = CLIENTE_AGENCIA_RO_DSD.getRowCount ( );
      for ( int row = 0; row < rowCount; row ++ )
      {
        if ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FLG_INCAPACIDAD_VERIFICADA" ), "S" )) )
        {
          String code = CLIENTE_AGENCIA_RO_DSD.getItemString ( row, "COD_AGENCIA" );
          if ( Compare.equals ( code, "ACAA" ) || Compare.equals ( code, "CFSE" ) || Compare.equals ( code, "ADSR" ) || Compare.equals ( code, "SIRM" ) || Compare.equals ( code, "RETF" ) || Compare.equals ( code, "DFAM" ) || Compare.equals ( code, "ADSS" ) || Compare.equals( code, "ADSE" ) || Compare.equals ( code, "VETE" ) || Compare.equals( code, "RETO" ) || Compare.equals ( code, "SIRM" ) )
          {
            BENEINCA ++;
          } 
        }
...
//          this.dm.setField ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO", this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) * 1.0 );
    ...
    while ( Compare.equals ( STATUS_CODE, 0 )  )
    {
      ...
      if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "RNBE" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "ACNE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  ) 
      {
        ...
        else if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "RETI") || ( Compare.equals ( this.dm.getFieldString( this.dm.get( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "RETP" )) || ( Compare.equals(this.dm.getFieldString( this.dm.get( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO"), "RETM" )) || ( Compare.equals( this.dm.getFieldString( this.dm.get( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO"), "RETF" )) || ( Compare.equals(this.dm.getFieldString( this.dm.get( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO"), "VETE")))
        {
        ...
        else if ( ( Compare.equals  ( this.dm.getFieldString ( this.dm.get( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "RETI" ) ) ||  ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "RETM" ) ))
        {
        ...
        if  ( ( Compare.lt ( EDAD_IND, 60 ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FLG_INCAPACIDAD_VERIFICADA" ), "S" ) ) && ( ! Compare.equals(this.dm.getFieldString( this.dm.get( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO"), "SEGS"))  && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_PARENTESCO_FAM" ), "CONY" ) )) 
          {
...
// Apply Exencion Salary 
    ...
    if ( ( Compare.equals ( ANCIANO, 1 ) ) || ( Compare.equals ( INCA_FLG, 1 ) ) || ( Compare.equals ( MENOR_FLG, 1 ) ) ) 
    {
      ...
      while ( Compare.equals ( STATUS_CODE, 0 ) ) 
      {
        ...
        // Change of Amendment # 3 PAN oct-2008
        else if ( ( Compare.lt ( EDAD_IND, 60 ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FLG_INCAPACIDAD_VERIFICADA" ), "S" ) )  && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_PARENTESCO_FAM" ), "CONY" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) ) )
        {
          SAVE_SSN = this.dm.getFieldDouble ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "SEGURO_SOCIAL_CLIENTE" );
          CONY_COUNT = MathService.plus ( CONY_COUNT, 1  );
        }
  ...
  /// Changes Amendment # 3 PAN oct-2008
    ...
    if ( Compare.ge ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getDateItem ( "MES_ANO_BENEFICIO_CORRECTO" ), RallySpanishDatesParser.parseDateString ( "1-OCT-2008" ) ) ) 
    {
        ...
        if ((Compare.ge(MathService.plus(MathService.plus(MathService.plus(ANCIANO_COUNT, INCAPACITADO_COUNT), MENOR_COUNT), CONY_COUNT), UNIDAD)) && (Compare.equals (OTROS,0) )  && (Compare.equals (INGRESO_CONY,0)) && (Compare.equals(SALARIO,0) || Compare.equals(RETIRO,0) || Compare.equals(SEG_SOC,0) ) )             
        {
