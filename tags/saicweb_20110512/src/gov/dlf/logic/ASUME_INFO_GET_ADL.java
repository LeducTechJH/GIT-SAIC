...
public class ASUME_INFO_GET_ADL extends ADL {
	...
	/**  */
	  ...
	  {
		  int ssint = (int)this.app.SS_SERV_GBL;
			  ...
			  else
			  {
				  ...
				  if ( fechasList.getLength() > 6 )
				  {
					  for (int i=0; i<6; i++)
					  {
						  ...
						  sb.append("Fecha: " + fechasElem.getTextContent().substring(0, 10) + " " + "    Cantidad: $" + cantidadElem.getTextContent() + "\\r\\n");
					  }
				  }
				  else
				  {
				  ...
				  this.app.setError("0", "El caso esta activo en ASUME con los siguientes pagos:\\r\\n\\r\\n" + sb);
