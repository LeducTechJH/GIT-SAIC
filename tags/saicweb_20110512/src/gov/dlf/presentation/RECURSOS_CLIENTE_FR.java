 ...
 */
public class RECURSOS_CLIENTE_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public RECURSOS_CLIENTE_FR ( )
  {
    super ( );
    this.setName ( "RECURSOS_CLIENTE_FR" );

    Debug.println ( Debug.TRACE, "RECURSOS_CLIENTE_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RECURSOS_CLIENTE_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "NOMBRE_CLIENTE", new RECURSOS_CLIENTE_FR_NOMBRE_CLIENTE_Arguments ( this ) );
  ...
  public void setObjectEvents ( )
  {
    ...
    this.registerListener ( "PARK", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CHECK_RECURSOS_CLIENTES_PARK_CMD_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "RECURSO_CLIENTE", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; RECUR_BV_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    //***** START MODS BY JOR 4/6/2011 *****
    //***** Add BEFOREINSERT event to properly set RMO_OFICINA2
    this.registerListener ( "RECURSO_CLIENTE", JDataPanelListener.BEFOREINSERT, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; RECUR_BV_ADL.exec ( app ); return app.errorFlag;
 ...
 *
 */
class RECURSOS_CLIENTE_FR_NOMBRE_CLIENTE_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public RECURSOS_CLIENTE_FR_NOMBRE_CLIENTE_Arguments ( Form form )
  {
    this.model = form;
