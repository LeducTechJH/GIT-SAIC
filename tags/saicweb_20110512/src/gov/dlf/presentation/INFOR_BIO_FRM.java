     ...
     extends Form
{
  ...
  public void setObjectEvents ( )
  {
    ...
    this.registerListener ( "SEGURO_SOCIAL_CLIENTE", JDataPanelListener.BEFOREVALUECHANGE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; INFOR_BIO_SSCLIENTE_BEF_CHANGE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "SEGURO_SOCIAL_CLIENTE", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; INFOR_BIO_SSCLIENTE_AFTER_CHANGE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    ...
    this.registerListener ( "COD_PSM", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; ASUME_INFO_GET_ADL.exec( app ); return app.errorFlag;
      }
    } );
    ...
    this.registerListener ( "TIPO_REGISTRO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CHECK_TIPO_REGISTRO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "TIPO_REGISTRO", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CHECK_CHANGE_TIPO_REG_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    ...
    this.registerListener ( "ACEPTA_REGISTRO_EMPLEO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; REGISTRO_EMPLEO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
