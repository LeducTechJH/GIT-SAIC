 ...
 */
public class SERV_SOST_LOV_EMER_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SERV_SOST_LOV_EMER_FR ( )
  {
    super ( );
    this.setName ( "SERV_SOST_LOV_EMER_FR" );

    Debug.println ( Debug.TRACE, "SERV_SOST_LOV_EMER_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SERV_SOST_LOV_EMER_FR.jdp" );
