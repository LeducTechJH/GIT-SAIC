 ...
 */
public class CALENDARIO_TEC_SIBIF_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CALENDARIO_TEC_SIBIF_FR ( )
  {
    super ( );
    this.setName ( "CALENDARIO_TEC_SIBIF_FR" );

    Debug.println ( Debug.TRACE, "CALENDARIO_TEC_SIBIF_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CALENDARIO_TEC_SIBIF_FR.jdp" );
  ...
  {
	this.registerListener ( "CALENDARIO_TEC_SIBIF_FR", JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
	{
	  public boolean eventFired ( String eventName )
	  {
	    app.errorFlag = true; SET_SIBIF_TOKEN_ADL.exec ( app ); return app.errorFlag;
	  }
	} );
	/*
