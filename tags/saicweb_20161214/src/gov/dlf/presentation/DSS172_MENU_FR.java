     ...
     extends Form
{
   ...
   *
   */
  public DSS172_MENU_FR ( )
  {
    super ( );
    this.setName ( "DSS172_MENU_FR" );

    Debug.println ( Debug.TRACE, "DSS172_MENU_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DSS172_MENU_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "DSS172_FCHI", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; DSS172_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "DSS172_LF", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; app.returnTo ( "RETRO_NOTI_MENU" ); return app.errorFlag;
      }
    } );
  }
}
