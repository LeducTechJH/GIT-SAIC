     ...
     extends FormSheet
{
   ...
   *
   */
  public REPORT_9_8_PKT ( )
  {
    super ( "REPORT_9_8_PKT" );
   ...
   *
   */
  public REPORT_9_8_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REPORT_9_8_PKT ( MDIFrame pFrame )
  {
    super ( "REPORT_9_8_PKT", pFrame );
  ...
  {
    this.createComponents ( new REPORT_9_8_FR ( ) );
   ...
   *
   */
  public static REPORT_9_8_PKT get ( RallyApplication __app )
  {
    return ( REPORT_9_8_PKT ) __app.getNewInstance ( "REPORT_9_8_PKT" );
  }
  ...
  {
    REPORT_9_8_PKT fSheet = REPORT_9_8_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REPORT_9_8_PKT.exec ( __app );
  }
