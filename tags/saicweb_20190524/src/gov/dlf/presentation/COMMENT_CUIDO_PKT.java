 ...
 */
public class COMMENT_CUIDO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public COMMENT_CUIDO_PKT ( )
  {
    super ( "COMMENT_CUIDO_PKT" );
   ...
   *
   */
  public COMMENT_CUIDO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public COMMENT_CUIDO_PKT ( MDIFrame pFrame )
  {
    super ( "COMMENT_CUIDO_PKT", pFrame );
  ...
  {
    this.createComponents ( new COMMENT_CUIDO_FR ( ) );
   ...
   *
   */
  public static COMMENT_CUIDO_PKT get ( RallyApplication __app )
  {
    return ( COMMENT_CUIDO_PKT ) __app.getNewInstance ( "COMMENT_CUIDO_PKT" );
  }
  ...
  {
    COMMENT_CUIDO_PKT fSheet = COMMENT_CUIDO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return COMMENT_CUIDO_PKT.exec ( __app );
  }
