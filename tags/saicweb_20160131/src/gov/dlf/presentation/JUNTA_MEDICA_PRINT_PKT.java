 ...
 */
public class JUNTA_MEDICA_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public JUNTA_MEDICA_PRINT_PKT ( )
  {
    super ( "JUNTA_MEDICA_PRINT_PKT" );
   ...
   *
   */
  public JUNTA_MEDICA_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public JUNTA_MEDICA_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "JUNTA_MEDICA_PRINT_PKT", pFrame );
   ...
   *
   */
  public static JUNTA_MEDICA_PRINT_PKT get ( RallyApplication __app )
  {
    return ( JUNTA_MEDICA_PRINT_PKT ) __app.getNewInstance ( "JUNTA_MEDICA_PRINT_PKT" );
  }
  ...
  {
    JUNTA_MEDICA_PRINT_PKT fSheet = JUNTA_MEDICA_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return JUNTA_MEDICA_PRINT_PKT.exec ( __app );
  }
