 ...
 */
public class SOL_RECONSIDERACION_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SOL_RECONSIDERACION_LOV_FR ( )
  {
    super ( );
    this.setName ( "SOL_RECONSIDERACION_LOV_FR" );

    Debug.println ( Debug.TRACE, "SOL_RECONSIDERACION_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SOL_RECONSIDERACION_LOV_FR.jdp" );
