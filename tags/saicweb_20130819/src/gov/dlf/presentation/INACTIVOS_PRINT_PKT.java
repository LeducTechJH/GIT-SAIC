 ...
 */
public class INACTIVOS_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INACTIVOS_PRINT_PKT ( )
  {
    super ( "INACTIVOS_PRINT_PKT" );
   ...
   *
   */
  public INACTIVOS_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INACTIVOS_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "INACTIVOS_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new INACTIVOS_FR ( ) );
   ...
   *
   */
  public static INACTIVOS_PRINT_PKT get ( RallyApplication __app )
  {
    return ( INACTIVOS_PRINT_PKT ) __app.getNewInstance ( "INACTIVOS_PRINT_PKT" );
  }
  ...
  {
    INACTIVOS_PRINT_PKT fSheet = INACTIVOS_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INACTIVOS_PRINT_PKT.exec ( __app );
  }
