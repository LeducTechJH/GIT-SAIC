     ...
     extends Form
{
   ...
   *
   */
  public REPORT_6_3_FR ( )
  {
    super ( );
    this.setName ( "REPORT_6_3_FR" );

    Debug.println ( Debug.TRACE, "REPORT_6_3_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REPORT_6_3_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "INPUT_END_DATE", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; REPORT_6_3_ADL.exec ( app ); return app.errorFlag;
      }
    } );
