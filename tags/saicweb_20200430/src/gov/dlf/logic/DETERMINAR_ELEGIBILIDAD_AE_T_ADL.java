     ...
     extends ADL
{
  ...
  {
    return ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).DETERMINA_RO_DSD;
  }
  ...
  {
    ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).DETERMINA_RO_DSD = value;
  }
  ...
  {
    ( ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_AE_T_ADL.class ) ).DETERMINA_RO_DSD = ( DataStore ) value;
  }
...
//        NECESIDAD_AJUSTADA = MathService.plus ( 32, ( ( MathService.minus ( NUM_FAMILIA, 1  ) ) * 24 )  );
 //     }
    ...
    while ( ( Compare.equals ( STATUS7_CODE, 0 ) ) && ( Compare.le ( this.dm.getFieldDate ( this.dm.get ( "DETERMINA_RO_DSD" ), "FECHA_EFECTIVIDAD" ), FCH_EMISION ) )   )
    {
      ...
      {
 	     NECESIDAD_AJUSTADA = MathService.plus ( this.dm.getFieldDouble ( this.dm.get ( "DETERMINA_RO_DSD" ), "NECESIDAD_AJUSTADA_HOSU" ), ( ( MathService.minus ( NUM_FAMILIA, 1  ) ) * this.dm.getFieldDouble ( this.dm.get ( "DETERMINA_RO_DSD" ), "NECESIDAD_AJUSTADA_FAM" ) )  );
      }
      else
      {
