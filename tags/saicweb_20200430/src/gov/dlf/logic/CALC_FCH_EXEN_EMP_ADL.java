...
this.dm.setField ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "SEGURO_SOCIAL_CLIENTE",this.app.form ( "PTRA_EMPLEO_FR" ).getValue ( "SSN_CLIENTE" ));
...
{
if ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "COD_TIPO_INGRESO" ), "SALA" ) ) ||
( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "COD_TIPO_INGRESO" ), "ADIE" ) ) ||
( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "COD_TIPO_INGRESO" ), "NPRO" ) ) ||
( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "COD_TIPO_INGRESO" ), "AGRN" ) ) ||
( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "COD_TIPO_INGRESO" ), "PTRA" ) ) ||
( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "COD_TIPO_INGRESO" ), "RETE" ) ) ||
( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "COD_TIPO_INGRESO" ), "JTPA" ) ) ||
( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "COD_TIPO_INGRESO" ), "BIAC" ) ) ||
( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "COD_TIPO_INGRESO" ), "BIAS" ) ) ||
( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "COD_TIPO_INGRESO" ), "BILV" ) ) ||
     ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "COD_TIPO_INGRESO" ), "AGRB" ) ) ||
( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "COD_TIPO_INGRESO" ), "MARI" ) ) ||  
( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "COD_TIPO_INGRESO" ), "ACUA" ) ) )

{

if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "FLG_FRECUENCIA" ), "S" ) )
{
ingreso = MathService.plus ( ingreso, TruncService.trunc ( this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "VLR_CANTIDAD_INGRESO" ) )* 4.3  );
}
else if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "FLG_FRECUENCIA" ), "B" ) )
{
ingreso = MathService.plus ( ingreso, TruncService.trunc ( this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "VLR_CANTIDAD_INGRESO" ) )* 2.15  );
}
else if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "FLG_FRECUENCIA" ), "Q" ) )
{
ingreso = MathService.plus ( ingreso, TruncService.trunc ( this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "VLR_CANTIDAD_INGRESO" ) )* 2.0  );
}
else
{
ingreso = MathService.plus ( ingreso, TruncService.trunc ( this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "VLR_CANTIDAD_INGRESO" ) )* 1.0  );
}

}
INGRESOS_CLIENTE_2_STATUS_CODE = this.dm.nextRow(INGRESOS_CLIENTE_2_DSD_ID);
 }
