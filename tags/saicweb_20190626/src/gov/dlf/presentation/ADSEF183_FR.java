     ...
     extends Form
{
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "D1", new ADSEF183_FR_Arguments ( this ) );
    this.setArguments ( "D2", new ADSEF183_FR_Arguments ( this ) );
    this.setArguments ( "D3", new ADSEF183_FR_Arguments ( this ) );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "SEGURO_SOCIAL_JEFE_FAM2", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        ...
        app.errorFlag = true; ADSEF183_GET_NOMBRE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class ADSEF183_FR_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public ADSEF183_FR_Arguments ( Form form )
  {
    this.model = form;

    this.setArgName ( "RMO_PAR" );
    this.setArgName ( "FCH_FINAL_GBL" );
    this.setArgName ( "FCH_INICIO_GBL" );
  }
  ...
  public Object getArgValue ( String argName )
  {
    ...
    else if ( argName.equals ( "FCH_INICIO_GBL" ) )
    {
