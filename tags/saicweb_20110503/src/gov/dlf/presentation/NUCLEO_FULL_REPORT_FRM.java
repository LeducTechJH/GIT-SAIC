 ...
 */
public class NUCLEO_FULL_REPORT_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public NUCLEO_FULL_REPORT_FRM ( )
  {
    super ( );
    this.setName ( "NUCLEO_FULL_REPORT_FRM" );

    Debug.println ( Debug.TRACE, "NUCLEO_FULL_REPORT_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/NUCLEO_FULL_REPORT_FRM.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new NUCLEO_FULL_REPORT_FRM_TSS_IDProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "NOMBRE_TECNICO" );
    field.setValueProvider ( new NUCLEO_FULL_REPORT_FRM_NOMBRE_TECNICOProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "FECHA" );
    field.setValueProvider ( new NUCLEO_FULL_REPORT_FRM_FECHAProvider ( this ) );



    calculator = new NUCLEO_FULL_REPORT_FRM_NOMBRE_CLIENTE1Calculator ( this );
 ...
 *
 */
class NUCLEO_FULL_REPORT_FRM_TSS_IDProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public NUCLEO_FULL_REPORT_FRM_TSS_IDProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class NUCLEO_FULL_REPORT_FRM_NOMBRE_TECNICOProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public NUCLEO_FULL_REPORT_FRM_NOMBRE_TECNICOProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class NUCLEO_FULL_REPORT_FRM_FECHAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public NUCLEO_FULL_REPORT_FRM_FECHAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class NUCLEO_FULL_REPORT_FRM_NOMBRE_CLIENTE1Calculator implements ICalculator
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public NUCLEO_FULL_REPORT_FRM_NOMBRE_CLIENTE1Calculator ( Form form )
  {
    this.model = form;
  }
