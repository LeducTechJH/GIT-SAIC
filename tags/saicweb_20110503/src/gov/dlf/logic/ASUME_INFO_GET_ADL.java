	  ...
	  protected void step1 ( ParameterSet ps )
	  {
		 ...
		 ADSEFSoap soap = service.getADSEFSoap();
		  ...
		  case 0: case 3:
			  ...
			  if ( respObj.getPagosEfectuados().getAny().isEmpty() )
			  {
				  break;
			  }
			  else
			  {
				  ...
				  Iterator<Object> pagosIter = respObj.getPagosEfectuados().getAny().iterator();
				  StringBuilder sb = new StringBuilder();

				  for (; pagosIter.hasNext();)
				  {
					  Object pago = pagosIter.next();
			  ...
			  break;
		  case 1:
			  this.app.setError("1", "Favor de pasar a registrarse por la oficina de ASUME");
			  this.setASUME_STATUS(1);
			  this.returnParms(ps, ASUME_STATUS);
			  this.doReturn();
			  break;
		  case 2:
			  this.app.setError("2", "Favor de pasar a registrarse por la oficina de ASUME");
