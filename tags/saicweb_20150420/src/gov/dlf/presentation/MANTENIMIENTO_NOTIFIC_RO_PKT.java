 ...
 */
public class MANTENIMIENTO_NOTIFIC_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_NOTIFIC_RO_PKT ( )
  {
    super ( "MANTENIMIENTO_NOTIFIC_RO_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_NOTIFIC_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_NOTIFIC_RO_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_NOTIFIC_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_NOTIFIC_FR ( ) );
   ...
   *
   */
  public static MANTENIMIENTO_NOTIFIC_RO_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_NOTIFIC_RO_PKT ) __app.getNewInstance ( "MANTENIMIENTO_NOTIFIC_RO_PKT" );
  }
  ...
  {
    MANTENIMIENTO_NOTIFIC_RO_PKT fSheet = MANTENIMIENTO_NOTIFIC_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_NOTIFIC_RO_PKT.exec ( __app );
  }
