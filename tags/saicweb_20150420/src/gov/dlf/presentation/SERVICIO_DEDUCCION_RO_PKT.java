 ...
 */
public class SERVICIO_DEDUCCION_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SERVICIO_DEDUCCION_RO_PKT ( )
  {
    super ( "SERVICIO_DEDUCCION_RO_PKT" );
   ...
   *
   */
  public SERVICIO_DEDUCCION_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SERVICIO_DEDUCCION_RO_PKT ( MDIFrame pFrame )
  {
    super ( "SERVICIO_DEDUCCION_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_SERVICIO_DEC_FR ( ) );
   ...
   *
   */
  public static SERVICIO_DEDUCCION_RO_PKT get ( RallyApplication __app )
  {
    return ( SERVICIO_DEDUCCION_RO_PKT ) __app.getNewInstance ( "SERVICIO_DEDUCCION_RO_PKT" );
  }
  ...
  {
    SERVICIO_DEDUCCION_RO_PKT fSheet = SERVICIO_DEDUCCION_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SERVICIO_DEDUCCION_RO_PKT.exec ( __app );
  }
