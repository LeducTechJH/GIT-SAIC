     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "OTRPAG_A1_FR" );

    Debug.println ( Debug.TRACE, "OTRPAG_A1_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/OTRPAG_A1_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "CSRV", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; OTRPAG_A_COD_SERV_ADL.exec ( app ); return app.errorFlag;
      }
    } );
