 ...
 */
public class INF_FECHA_VENCE_RECLA_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INF_FECHA_VENCE_RECLA_PKT ( )
  {
    super ( "INF_FECHA_VENCE_RECLA_PKT" );
   ...
   *
   */
  public INF_FECHA_VENCE_RECLA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INF_FECHA_VENCE_RECLA_PKT ( MDIFrame pFrame )
  {
    super ( "INF_FECHA_VENCE_RECLA_PKT", pFrame );
  ...
  {
    this.createComponents ( new INF_FECHA_VENCE_RECLA_FR ( ) );
   ...
   *
   */
  public static INF_FECHA_VENCE_RECLA_PKT get ( RallyApplication __app )
  {
    return ( INF_FECHA_VENCE_RECLA_PKT ) __app.getNewInstance ( "INF_FECHA_VENCE_RECLA_PKT" );
  }
  ...
  {
    INF_FECHA_VENCE_RECLA_PKT fSheet = INF_FECHA_VENCE_RECLA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INF_FECHA_VENCE_RECLA_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_FCH_VENCE_MENU.exec ( app, null );
