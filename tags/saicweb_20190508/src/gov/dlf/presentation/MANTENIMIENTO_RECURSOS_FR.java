 ...
 */
public class MANTENIMIENTO_RECURSOS_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_RECURSOS_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_RECURSOS_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_RECURSOS_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_RECURSOS_FR.jdp" );
