     ...
     extends Form
{
   ...
   *
   */
  public ADSEF_106E_FR ( )
  {
    super ( );
    this.setName ( "ADSEF_106E_FR" );

    Debug.println ( Debug.TRACE, "ADSEF_106E_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ADSEF_106E_FR.jdp" );
