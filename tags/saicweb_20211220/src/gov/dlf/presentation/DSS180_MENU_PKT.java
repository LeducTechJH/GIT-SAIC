     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS180_MENU_PKT ( )
  {
    super ( "DSS180_MENU_PKT" );
   ...
   *
   */
  public DSS180_MENU_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS180_MENU_PKT ( MDIFrame pFrame )
  {
    super ( "DSS180_MENU_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS180_MENU_FR ( ) );
   ...
   *
   */
  public static DSS180_MENU_PKT get ( RallyApplication __app )
  {
    return ( DSS180_MENU_PKT ) __app.getNewInstance ( "DSS180_MENU_PKT" );
  }
  ...
  {
    DSS180_MENU_PKT fSheet = DSS180_MENU_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS180_MENU_PKT.exec ( __app );
  }
