 ...
 */
public class INF_NINOS_CUMPLIERON_18_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INF_NINOS_CUMPLIERON_18_PKT ( )
  {
    super ( "INF_NINOS_CUMPLIERON_18_PKT" );
   ...
   *
   */
  public INF_NINOS_CUMPLIERON_18_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INF_NINOS_CUMPLIERON_18_PKT ( MDIFrame pFrame )
  {
    super ( "INF_NINOS_CUMPLIERON_18_PKT", pFrame );
   ...
   *
   */
  public static INF_NINOS_CUMPLIERON_18_PKT get ( RallyApplication __app )
  {
    return ( INF_NINOS_CUMPLIERON_18_PKT ) __app.getNewInstance ( "INF_NINOS_CUMPLIERON_18_PKT" );
  }
  ...
  {
    INF_NINOS_CUMPLIERON_18_PKT fSheet = INF_NINOS_CUMPLIERON_18_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INF_NINOS_CUMPLIERON_18_PKT.exec ( __app );
  }
