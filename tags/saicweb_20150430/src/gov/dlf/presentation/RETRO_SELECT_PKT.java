     ...
     extends FormSheet
{
   ...
   *
   */
  public RETRO_SELECT_PKT ( )
  {
    super ( "RETRO_SELECT_PKT" );
   ...
   *
   */
  public RETRO_SELECT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RETRO_SELECT_PKT ( MDIFrame pFrame )
  {
    super ( "RETRO_SELECT_PKT", pFrame );
  ...
  {
    this.createComponents ( new RETRO_SELECT_FR ( ) );
   ...
   *
   */
  public static RETRO_SELECT_PKT get ( RallyApplication __app )
  {
    return ( RETRO_SELECT_PKT ) __app.getNewInstance ( "RETRO_SELECT_PKT" );
  }
  ...
  {
    RETRO_SELECT_PKT fSheet = RETRO_SELECT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RETRO_SELECT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; RR_SEL_AFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; RR_SEL_BFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
