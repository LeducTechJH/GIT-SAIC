 ...
 */
public class YES_LECT_SUPV_ADL
     extends ADL
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
  ...
  {
    ( ( YES_LECT_SUPV_ADL ) __app.getADL ( YES_LECT_SUPV_ADL.class ) ).RECLA_ID = value.getDouble ( );
  }  
  ...
  {
    ( ( YES_LECT_SUPV_ADL ) __app.getADL ( YES_LECT_SUPV_ADL.class ) ).RECLA_STATUS = value.getDouble ( );
  }  
  ...
  {
    return ( ( YES_LECT_SUPV_ADL ) __app.getADL ( YES_LECT_SUPV_ADL.class ) ).RECLA_RETRO_TABLE_DSD;
  }
  ...
  {
    ( ( YES_LECT_SUPV_ADL ) __app.getADL ( YES_LECT_SUPV_ADL.class ) ).RECLA_RETRO_TABLE_DSD = value;
  }
  ...
  {
    ( ( YES_LECT_SUPV_ADL ) __app.getADL ( YES_LECT_SUPV_ADL.class ) ).RECLA_RETRO_TABLE_DSD = ( DataStore ) value;
  }
  ...
  {
    return ( ( YES_LECT_SUPV_ADL ) __app.getADL ( YES_LECT_SUPV_ADL.class ) ).RECLA_ID;
  }
  ...
  {
    return new Double ( ( ( YES_LECT_SUPV_ADL ) __app.getADL ( YES_LECT_SUPV_ADL.class ) ).RECLA_ID );
  }
  ...
  {
    ( ( YES_LECT_SUPV_ADL ) __app.getADL ( YES_LECT_SUPV_ADL.class ) ).RECLA_ID = value;
  }
  ...
  {
    ( ( YES_LECT_SUPV_ADL ) __app.getADL ( YES_LECT_SUPV_ADL.class ) ).RECLA_ID = ( ( Double ) value ).doubleValue ( );
  }
  ...
  {
    return ( ( YES_LECT_SUPV_ADL ) __app.getADL ( YES_LECT_SUPV_ADL.class ) ).RECLA_STATUS;
  }
  ...
  {
    return new Double ( ( ( YES_LECT_SUPV_ADL ) __app.getADL ( YES_LECT_SUPV_ADL.class ) ).RECLA_STATUS );
  }
  ...
  {
    ( ( YES_LECT_SUPV_ADL ) __app.getADL ( YES_LECT_SUPV_ADL.class ) ).RECLA_STATUS = value;
  }
  ...
  {
    ( ( YES_LECT_SUPV_ADL ) __app.getADL ( YES_LECT_SUPV_ADL.class ) ).RECLA_STATUS = ( ( Double ) value ).doubleValue ( );
  }
   ...
   * @return
   */
  public static YES_LECT_SUPV_ADL get ( RallyApplication __app )
  {
    YES_LECT_SUPV_ADL adl = new YES_LECT_SUPV_ADL ( );
    __app.register ( adl, "YES_LECT_SUPV_ADL" );
    __app.setADL ( YES_LECT_SUPV_ADL.class, adl ); 
  ...
  {
    YES_LECT_SUPV_ADL.get ( __app ).process ( ps );
  }
  ...
  public static void exec ( RallyApplication __app )
  {
    ...
    YES_LECT_SUPV_ADL.exec ( __app, ps );
  }
  ...
  public void unregister ( )
  {
    ...
    IRegisteredObject rObj = this.app.get ( "YES_LECT_SUPV_ADL" );
    if ( rObj != null && rObj instanceof YES_LECT_SUPV_ADL )
    {
      this.app.setADL ( YES_LECT_SUPV_ADL.class, ( YES_LECT_SUPV_ADL ) rObj );
    }
  }
  ...
  {
    Debug.println ( Debug.TRACE, "YES_LECT_SUPV_ADL Step " + this.currentStep );
    super.process ( ps );
    switch ( this.currentStep ) 
    {
      ...
      { 
        this.currentStep = 0;
        Debug.println ( Debug.TRACE, "YES_LECT_SUPV_ADL ended" );
        this.unregister ( );
        break;
      }
    }
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECLA_RETRO_TABLE_DSD" ), "STATUS" ), "NOPRODT" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RECLA_RETRO_TABLE_DSD" ), "STATUS" ), "NOPROC10" ) )  ) 
    {
      if ( ( Compare.equals ( this.app.ACCION_GBL, "RECL" ) ) || ( Compare.equals ( this.app.ACCION_GBL, "RREC" ) ) ) 
      {
        this.app.setError ( 0, 1110 );
      }
      else
      {
        this.app.setError ( 1, 1111 );
      }
    }
...
{               RECLA_RETRO_TABLE_DSD.FECHA_AUTORIZADO := SYSTEM_DATE;}
       ...
       IF (RECLA_RETRO_TABLE_DSD.STATUS <> 'NOPRODT') AND
          (RECLA_RETRO_TABLE_DSD.STATUS <> 'NOPROC10') THEN
