     ...
     extends Form
{
   ...
   *
   */
  public METODO_LOV_FRM ( )
  {
    super ( );
    this.setName ( "METODO_LOV_FRM" );

    Debug.println ( Debug.TRACE, "METODO_LOV_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/METODO_LOV_FRM.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "ACCION_GRP", new METODO_LOV_FRM_ACCION_GRP_Arguments ( this ) );
 ...
 *
 */
class METODO_LOV_FRM_ACCION_GRP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public METODO_LOV_FRM_ACCION_GRP_Arguments ( Form form )
  {
    this.model = form;
