 ...
 */
public class TRANSFER_ENVIADAS_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TRANSFER_ENVIADAS_FR ( )
  {
    super ( );
    this.setName ( "TRANSFER_ENVIADAS_FR" );

    Debug.println ( Debug.TRACE, "TRANSFER_ENVIADAS_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TRANSFER_ENVIADAS_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "ENVIADAS_GP", new TRANSFER_ENVIADAS_FR_ENVIADAS_GP_Arguments ( this ) );

    this.setObjectEvents ( );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new TRANSFER_ENVIADAS_FR_OFICINAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "FECHA" );
    field.setValueProvider ( new TRANSFER_ENVIADAS_FR_FECHAProvider ( this ) );
 ...
 *
 */
class TRANSFER_ENVIADAS_FR_ENVIADAS_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public TRANSFER_ENVIADAS_FR_ENVIADAS_GP_Arguments ( Form form )
  {
    this.model = form;
  ...
  public Object getArgValue ( String argName )
  {
    ...
    {
      return TRANSFER_ENVIADAS_ADL.getFECHAS_VENCE ( this.app ); // ADL Exported Field
    }
    ...
    {
      return TRANSFER_ENVIADAS_ADL.getFECHAS_VENCE2 ( this.app ); // ADL Exported Field
    }
    return null;
  }
}
 ...
 *
 */
class TRANSFER_ENVIADAS_FR_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public TRANSFER_ENVIADAS_FR_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class TRANSFER_ENVIADAS_FR_FECHAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public TRANSFER_ENVIADAS_FR_FECHAProvider ( Form form )
  {
    this.model = form;
  }
