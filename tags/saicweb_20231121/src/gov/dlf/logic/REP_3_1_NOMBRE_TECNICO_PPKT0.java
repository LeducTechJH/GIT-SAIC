 ...
 */
public class REP_3_1_NOMBRE_TECNICO_PPKT0 
  implements IRegisteredObject 
{
   ...
   *
   */
  public REP_3_1_NOMBRE_TECNICO_PPKT0 ( )
  {
   ...
   *
   */
  public static REP_3_1_NOMBRE_TECNICO_PPKT0 get ( RallyApplication __app )
  {
    REP_3_1_NOMBRE_TECNICO_PPKT0 pp = ( REP_3_1_NOMBRE_TECNICO_PPKT0 ) __app.getNewInstance ( "REP_3_1_NOMBRE_TECNICO_PPKT0" );
    return pp;
  }
  ...
  {
    return REP_3_1_NOMBRE_TECNICO_PPKT0.exec ( __app );
  }
  ...
  {
    Debug.println ( Debug.TRACE, "REP_3_1_NOMBRE_TECNICO_PPKT0" );
    this.prepareParms ( );
  ...
  {
    this.app.form ( "REPORT_3_1_FR" ).setValue ( "ID_TECNICO0", this.parms.getDouble ( 0 ) );
    this.app.form ( "REPORT_3_1_FR" ).setValue ( "NOMBRE_TECNICO", this.parms.getString ( 1 ) );
  }
  ...
  protected void prepareParms ( )
  {
    ...
    this.parms.set ( this.app.form ( "REPORT_3_1_FR" ).getValue ( "NOMBRE_TECNICO" ) );
  }
