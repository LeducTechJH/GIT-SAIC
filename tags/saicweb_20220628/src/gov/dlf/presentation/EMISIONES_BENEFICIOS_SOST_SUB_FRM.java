 ...
 */
public class EMISIONES_BENEFICIOS_SOST_SUB_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public EMISIONES_BENEFICIOS_SOST_SUB_FRM ( )
  {
    super ( );
    this.setName ( "EMISIONES_BENEFICIOS_SOST_SUB_FRM" );

    Debug.println ( Debug.TRACE, "EMISIONES_BENEFICIOS_SOST_SUB_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/EMISIONES_BENEFICIOS_SOST_SUB_FRM.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "EMISIONES_BENEFICIOS_SUB_GP", new EMISIONES_BENEFICIOS_SUB_GP_Arguments ( this ) );
...
class EMISIONES_BENEFICIOS_SUB_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public EMISIONES_BENEFICIOS_SUB_GP_Arguments ( Form form )
  {
    this.model = form;
