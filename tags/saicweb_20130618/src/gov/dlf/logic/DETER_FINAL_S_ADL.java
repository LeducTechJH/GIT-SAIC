     ...
     extends ADL
{
  ...
  {
  if ( Compare.equals ( this.app.COD_SERV_GBL, "LISE" ) || Compare.equals ( this.app.COD_SERV_GBL, "LICE" ) )     //    else if ( ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "AE-B" ) ) || ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "AE-G" ) )  )
    {
