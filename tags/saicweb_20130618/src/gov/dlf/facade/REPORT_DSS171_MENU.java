 ...
 */
public class REPORT_DSS171_MENU
     extends ConfirmationMenu
{
   ...
   *
   */
  public REPORT_DSS171_MENU ( )
  {
    super ( "REPORT_DSS171_MENU" );
    this.setMessage ( "Desea imprimir el formulario DSS-171 (S/N)?" );
    this.setActions ( new _REPORT_DSS171_MENU ( this ) );
    this.setHelpCode   ( "1" );
    this.setLegendCode ( "" );
   ...
   * @return
   */
  public static REPORT_DSS171_MENU get ( RallyApplication __app )
  {
    return ( REPORT_DSS171_MENU ) __app.getOrNew ( "REPORT_DSS171_MENU" );
  }
  ...
  {
    REPORT_DSS171_MENU confMenu = REPORT_DSS171_MENU.get ( __app );
  ...
  {
    return REPORT_DSS171_MENU.exec ( __app );
  }
