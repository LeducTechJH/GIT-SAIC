 ...
 */
public class RECURSOS_CLIENTES_FR_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public RECURSOS_CLIENTES_FR_PKT ( )
  {
    super ( "RECURSOS_CLIENTES_FR_PKT" );
   ...
   *
   */
  public RECURSOS_CLIENTES_FR_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RECURSOS_CLIENTES_FR_PKT ( MDIFrame pFrame )
  {
    super ( "RECURSOS_CLIENTES_FR_PKT", pFrame );
   ...
   *
   */
  public static RECURSOS_CLIENTES_FR_PKT get ( RallyApplication __app )
  {
    return ( RECURSOS_CLIENTES_FR_PKT ) __app.getNewInstance ( "RECURSOS_CLIENTES_FR_PKT" );
  }
  ...
  {
    RECURSOS_CLIENTES_FR_PKT fSheet = RECURSOS_CLIENTES_FR_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RECURSOS_CLIENTES_FR_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; REC_PAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
