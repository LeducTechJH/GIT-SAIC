 ...
 */
public class REGISTRO_APELACIONES_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REGISTRO_APELACIONES_PKT ( )
  {
    super ( "REGISTRO_APELACIONES_PKT" );
   ...
   *
   */
  public REGISTRO_APELACIONES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REGISTRO_APELACIONES_PKT ( MDIFrame pFrame )
  {
    super ( "REGISTRO_APELACIONES_PKT", pFrame );
   ...
   *
   */
  public static REGISTRO_APELACIONES_PKT get ( RallyApplication __app )
  {
    return ( REGISTRO_APELACIONES_PKT ) __app.getNewInstance ( "REGISTRO_APELACIONES_PKT" );
  }
  ...
  {
    REGISTRO_APELACIONES_PKT fSheet = REGISTRO_APELACIONES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REGISTRO_APELACIONES_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CAMBIAR_COMANDO_DCL_GBL_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.BEFOREQUIT, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; DEVOLVER_VALOR_COMANDO_DCL_GBL_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
