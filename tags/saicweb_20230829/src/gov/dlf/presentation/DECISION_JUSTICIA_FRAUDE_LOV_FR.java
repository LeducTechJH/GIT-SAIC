 ...
 */
public class DECISION_JUSTICIA_FRAUDE_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public DECISION_JUSTICIA_FRAUDE_LOV_FR ( )
  {
    super ( );
    this.setName ( "DECISION_JUSTICIA_FRAUDE_LOV_FR" );

    Debug.println ( Debug.TRACE, "DECISION_JUSTICIA_FRAUDE_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DECISION_JUSTICIA_FRAUDE_LOV_FR.jdp" );
