 ...
 */
public class REPORTE_IND_GEN_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REPORTE_IND_GEN_RPT_PKT ( )
  {
    super ( "REPORTE_IND_GEN_RPT_PKT" );
   ...
   *
   */
  public REPORTE_IND_GEN_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REPORTE_IND_GEN_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "REPORTE_IND_GEN_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new REPORTE_IND_GENEAL_TBL_FR ( ) );
   ...
   *
   */
  public static REPORTE_IND_GEN_RPT_PKT get ( RallyApplication __app )
  {
    return ( REPORTE_IND_GEN_RPT_PKT ) __app.getNewInstance ( "REPORTE_IND_GEN_RPT_PKT" );
  }
  ...
  {
    REPORTE_IND_GEN_RPT_PKT fSheet = REPORTE_IND_GEN_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REPORTE_IND_GEN_RPT_PKT.exec ( __app );
  }
