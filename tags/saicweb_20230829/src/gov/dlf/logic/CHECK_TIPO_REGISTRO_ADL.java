     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( ( Compare.equals ( this.app.form ( "INFOR_BIO_FRM" ).getStringItem ( "TIPO_REGISTRO" ), "HABL" ) ) && ( ( Compare.lt ( EDAD, 18 ) ) || ( Compare.ge ( EDAD, 50 ) ) )  ) 
    {
      this.app.setError ( 0, 8100 );
      this.app.errorFlag = false;
    }
    else if ( ( Compare.equals ( this.app.form ( "INFOR_BIO_FRM" ).getStringItem ( "TIPO_REGISTRO" ), "DISP" ) ) && ( ( Compare.ge ( EDAD, 18 ) ) && ( Compare.lt ( EDAD, 50 ) )  )   )
    {
