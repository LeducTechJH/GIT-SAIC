     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    this.dm.setField ( this.dm.get ( "SERVICIOS2_DSD" ), "BENEFICIO_EXEN1",DETERMINAR_ELEGIBILIDAD_PAN_2.getBENEFICIO1(this.app));
    this.dm.setField ( this.dm.get ( "SERVICIOS2_DSD" ), "BENEFICIO_EXEN2",DETERMINAR_ELEGIBILIDAD_PAN_2.getBENEFICIO2(this.app));
    this.dm.setField ( this.dm.get ( "SERVICIOS2_DSD" ), "BENEFICIO_EXEN3",DETERMINAR_ELEGIBILIDAD_PAN_2.getBENEFICIO3(this.app));
