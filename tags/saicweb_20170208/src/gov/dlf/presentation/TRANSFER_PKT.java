     ...
     extends FormSheet
{
   ...
   *
   */
  public TRANSFER_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TRANSFER_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_PKT", pFrame );
  ...
  {
    this.createComponents ( new TRANSFER_FR ( ) );
   ...
   *
   */
  public static TRANSFER_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_PKT ) __app.getNewInstance ( "TRANSFER_PKT" );
  }
  ...
  {
    TRANSFER_PKT fSheet = TRANSFER_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; TRANSFER_ANS_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
