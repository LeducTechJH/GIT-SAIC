     ...
     extends Form
{
   ...
   *
   */
  public ZIP_SERV_LOV_FR ( )
  {
    super ( );
    this.setName ( "ZIP_SERV_LOV_FR" );

    Debug.println ( Debug.TRACE, "ZIP_SERV_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ZIP_SERV_LOV_FR.jdp" );
