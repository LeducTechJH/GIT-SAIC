     ...
     extends FormSheet
{
   ...
   *
   */
  public ADSEF155_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ADSEF155_PKT ( MDIFrame pFrame )
  {
    super ( "ADSEF155_PKT", pFrame );
  ...
  {
    this.createComponents ( new ADSEF155_FR ( ) );
   ...
   *
   */
  public static ADSEF155_PKT get ( RallyApplication __app )
  {
    return ( ADSEF155_PKT ) __app.getNewInstance ( "ADSEF155_PKT" );
  }
  ...
  {
    ADSEF155_PKT fSheet = ADSEF155_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ADSEF155_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; ADSEF155_CHECK_RSE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
