...
extends Form
{
	...
	{	    
		this.registerListener ( "CONTRATO_PROYECCION_FR", JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
		{
			...
			{
				app.errorFlag = true;
				String cuido = __form.getStringValue ( "COD_CUIDO" );
				if (  cuido.equals ( "TCOM"  ))
				{
					app.form("CONTRATO_PROYECCION_FR").setItem("TIPO_CUIDO", "TIEMPO COMPLETO");
				}
				else if (  cuido.equals ( "TPRT"  ))
				{
					app.form("CONTRATO_PROYECCION_FR").setItem("TIPO_CUIDO", "TIEMPO PARCIAL");
				}
				else
					app.form("CONTRATO_PROYECCION_FR").setItem("TIPO_CUIDO", app.form("CONTRATO_PROYECCION_FR").getItem("COD_CUIDO"));
		...
		this.registerListener ( "ID_ACTIVIDAD", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
		...
		this.registerListener ( "DIAS_ASIS", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				app.errorFlag = true; 
				...
				if(Compare.gt(dias_asis, dias_labs))
				{
				...
				else if (Compare.gt(dias_mes,dias_labs))
				{
					app.setError("0", "Dias asistidos tiempos completo y parcial no deben sobrepasar dias laborables.");
					app.form ( "CONTRATO_PROYECCION_FR" ).setItem ( "DIAS_ASIS", "");
					app.form ( "CONTRATO_PROYECCION_FR" ).setItem ( "PAGO", 0);
					app.errorFlag = false;
				}
		...
		this.registerListener ( "DIAS_ASIS_PART", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
		{
			public boolean eventFired ( String eventName )
			{
				app.errorFlag = true; 
				...
				double dias_mes = MathService.plus(dias_asis, dias_asis_part);
				double dias_labs = app.form ( "CONTRATO_PROYECCION_FR" ).getDoubleItem ( "DIAS_LABORABLES" );
				if(Compare.gt(dias_asis_part, dias_labs))
				{
					app.setError("0", "Dias asistidos parciales sobrepasan los dias laborables.");
