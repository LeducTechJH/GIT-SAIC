 ...
 */
public class ADSEF_PPT_6_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ADSEF_PPT_6_PRINT_PKT ( )
  {
    super ( "ADSEF_PPT_6_PRINT_PKT" );
   ...
   *
   */
  public ADSEF_PPT_6_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ADSEF_PPT_6_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "ADSEF_PPT_6_PRINT_PKT", pFrame );
   ...
   *
   */
  public static ADSEF_PPT_6_PRINT_PKT get ( RallyApplication __app )
  {
    return ( ADSEF_PPT_6_PRINT_PKT ) __app.getNewInstance ( "ADSEF_PPT_6_PRINT_PKT" );
  }
  ...
  {
    ADSEF_PPT_6_PRINT_PKT fSheet = ADSEF_PPT_6_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ADSEF_PPT_6_PRINT_PKT.exec ( __app );
  }
