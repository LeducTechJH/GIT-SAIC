 ...
 */
public class DEDUCCIONES_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public DEDUCCIONES_LOV_FR ( )
  {
    super ( );
    this.setName ( "DEDUCCIONES_LOV_FR" );

    Debug.println ( Debug.TRACE, "DEDUCCIONES_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DEDUCCIONES_LOV_FR.jdp" );
