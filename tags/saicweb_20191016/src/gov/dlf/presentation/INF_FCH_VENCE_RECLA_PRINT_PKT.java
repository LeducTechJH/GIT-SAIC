 ...
 */
public class INF_FCH_VENCE_RECLA_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INF_FCH_VENCE_RECLA_PRINT_PKT ( )
  {
    super ( "INF_FCH_VENCE_RECLA_PRINT_PKT" );
   ...
   *
   */
  public INF_FCH_VENCE_RECLA_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INF_FCH_VENCE_RECLA_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "INF_FCH_VENCE_RECLA_PRINT_PKT", pFrame );
   ...
   *
   */
  public static INF_FCH_VENCE_RECLA_PRINT_PKT get ( RallyApplication __app )
  {
    return ( INF_FCH_VENCE_RECLA_PRINT_PKT ) __app.getNewInstance ( "INF_FCH_VENCE_RECLA_PRINT_PKT" );
  }
  ...
  {
    INF_FCH_VENCE_RECLA_PRINT_PKT fSheet = INF_FCH_VENCE_RECLA_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INF_FCH_VENCE_RECLA_PRINT_PKT.exec ( __app );
  }
