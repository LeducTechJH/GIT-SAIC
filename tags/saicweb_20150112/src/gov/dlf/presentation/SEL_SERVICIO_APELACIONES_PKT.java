 ...
 */
public class SEL_SERVICIO_APELACIONES_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SEL_SERVICIO_APELACIONES_PKT ( )
  {
    super ( "SEL_SERVICIO_APELACIONES_PKT" );
   ...
   *
   */
  public SEL_SERVICIO_APELACIONES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SEL_SERVICIO_APELACIONES_PKT ( MDIFrame pFrame )
  {
    super ( "SEL_SERVICIO_APELACIONES_PKT", pFrame );
  ...
  {
    this.createComponents ( new SEL_SERVICIO_APELACIONES_FR ( ) );
   ...
   *
   */
  public static SEL_SERVICIO_APELACIONES_PKT get ( RallyApplication __app )
  {
    return ( SEL_SERVICIO_APELACIONES_PKT ) __app.getNewInstance ( "SEL_SERVICIO_APELACIONES_PKT" );
  }
  ...
  {
    SEL_SERVICIO_APELACIONES_PKT fSheet = SEL_SERVICIO_APELACIONES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SEL_SERVICIO_APELACIONES_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; LLENAR_SEL_SERVICIOS_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
