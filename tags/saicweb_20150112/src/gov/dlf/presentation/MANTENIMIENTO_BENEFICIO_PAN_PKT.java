 ...
 */
public class MANTENIMIENTO_BENEFICIO_PAN_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_BENEFICIO_PAN_PKT ( )
  {
    super ( "MANTENIMIENTO_BENEFICIO_PAN_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_BENEFICIO_PAN_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_BENEFICIO_PAN_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_BENEFICIO_PAN_PKT", pFrame );
   ...
   *
   */
  public static MANTENIMIENTO_BENEFICIO_PAN_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_BENEFICIO_PAN_PKT ) __app.getNewInstance ( "MANTENIMIENTO_BENEFICIO_PAN_PKT" );
  }
  ...
  {
    MANTENIMIENTO_BENEFICIO_PAN_PKT fSheet = MANTENIMIENTO_BENEFICIO_PAN_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_BENEFICIO_PAN_PKT.exec ( __app );
  }
