 ...
 */
public class SOLICITADO_POR_LOV_FR1
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SOLICITADO_POR_LOV_FR1 ( )
  {
    super ( );
    this.setName ( "SOLICITADO_POR_LOV_FR1" );

    Debug.println ( Debug.TRACE, "SOLICITADO_POR_LOV_FR1 - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SOLICITADO_POR_LOV_FR1.jdp" );
