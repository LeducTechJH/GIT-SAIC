 ...
 */
public class MANTENIMIENTO_ASIG_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_ASIG_PKT ( )
  {
    super ( "MANTENIMIENTO_ASIG_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_ASIG_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_ASIG_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_ASIG_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_ASIG_FR ( ) );
   ...
   *
   */
  public static MANTENIMIENTO_ASIG_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_ASIG_PKT ) __app.getNewInstance ( "MANTENIMIENTO_ASIG_PKT" );
  }
  ...
  {
    MANTENIMIENTO_ASIG_PKT fSheet = MANTENIMIENTO_ASIG_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_ASIG_PKT.exec ( __app );
  }
