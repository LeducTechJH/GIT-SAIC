 ...
 */
public class SOLIC_SERV_COMP_FAM_UPD_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SOLIC_SERV_COMP_FAM_UPD_PKT ( )
  {
    super ( "SOLIC_SERV_COMP_FAM_UPD_PKT" );
   ...
   *
   */
  public SOLIC_SERV_COMP_FAM_UPD_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SOLIC_SERV_COMP_FAM_UPD_PKT ( MDIFrame pFrame )
  {
    super ( "SOLIC_SERV_COMP_FAM_UPD_PKT", pFrame );
  ...
  {
    this.createComponents ( new SOLIC_SERV_COMP_FAMILIAR_FR ( ) );
   ...
   *
   */
  public static SOLIC_SERV_COMP_FAM_UPD_PKT get ( RallyApplication __app )
  {
    return ( SOLIC_SERV_COMP_FAM_UPD_PKT ) __app.getNewInstance ( "SOLIC_SERV_COMP_FAM_UPD_PKT" );
  }
  ...
  {
    SOLIC_SERV_COMP_FAM_UPD_PKT fSheet = SOLIC_SERV_COMP_FAM_UPD_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SOLIC_SERV_COMP_FAM_UPD_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SOLIC_SERV_COMP_FAM_INIT_FAM_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERQUERY, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SOLIC_SERV_COMP_FAM_AFTER_QUERY_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.BEFOREROLLBACK, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; REST_OF_CHECK_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
