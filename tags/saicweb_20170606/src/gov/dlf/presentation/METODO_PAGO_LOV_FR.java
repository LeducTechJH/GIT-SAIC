 ...
 */
public class METODO_PAGO_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public METODO_PAGO_LOV_FR ( )
  {
    super ( );
    this.setName ( "METODO_PAGO_LOV_FR" );

    Debug.println ( Debug.TRACE, "METODO_PAGO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/METODO_PAGO_LOV_FR.jdp" );
