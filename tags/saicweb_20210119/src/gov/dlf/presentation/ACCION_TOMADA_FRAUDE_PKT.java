 ...
 */
public class ACCION_TOMADA_FRAUDE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ACCION_TOMADA_FRAUDE_PKT ( )
  {
    super ( "ACCION_TOMADA_FRAUDE_PKT" );
   ...
   *
   */
  public ACCION_TOMADA_FRAUDE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ACCION_TOMADA_FRAUDE_PKT ( MDIFrame pFrame )
  {
    super ( "ACCION_TOMADA_FRAUDE_PKT", pFrame );
  ...
  {
    this.createComponents ( new ACCION_TOMADA_FRAUDE_FR ( ) );
   ...
   *
   */
  public static ACCION_TOMADA_FRAUDE_PKT get ( RallyApplication __app )
  {
    return ( ACCION_TOMADA_FRAUDE_PKT ) __app.getNewInstance ( "ACCION_TOMADA_FRAUDE_PKT" );
  }
  ...
  {
    ACCION_TOMADA_FRAUDE_PKT fSheet = ACCION_TOMADA_FRAUDE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ACCION_TOMADA_FRAUDE_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; AFTER_ACCION_TOMADA_FRAUDE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; LLENAR_ACCION_FRAUDE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERQUERY, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; AFTER_EXECUTE_ACCION_TOMADA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
