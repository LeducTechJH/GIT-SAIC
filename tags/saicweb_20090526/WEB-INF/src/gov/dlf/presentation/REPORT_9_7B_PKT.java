     ...
     extends FormSheet
{
   ...
   *
   */
  public REPORT_9_7B_PKT ( )
  {
    super ( "REPORT_9_7B_PKT" );
   ...
   *
   */
  public REPORT_9_7B_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REPORT_9_7B_PKT ( MDIFrame pFrame )
  {
    super ( "REPORT_9_7B_PKT", pFrame );
  ...
  {
    this.createComponents ( new REPORT_9_7B_FR ( ) );
   ...
   *
   */
  public static REPORT_9_7B_PKT get ( RallyApplication __app )
  {
    return ( REPORT_9_7B_PKT ) __app.getNewInstance ( "REPORT_9_7B_PKT" );
  }
  ...
  {
    REPORT_9_7B_PKT fSheet = REPORT_9_7B_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REPORT_9_7B_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; REPORT_9_7B_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
