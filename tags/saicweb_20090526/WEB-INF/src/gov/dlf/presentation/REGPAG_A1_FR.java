     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "REGPAG_A1_FR" );

    Debug.println ( Debug.TRACE, "REGPAG_A1_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REGPAG_A1_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "CSRV", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; REGPAG_A_COD_SERV_ADL.exec ( app ); return app.errorFlag;
      }
    } );
