 ...
 */
public class FORMULARIO_153_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public FORMULARIO_153_FR ( )
  {
    super ( );
    this.setName ( "FORMULARIO_153_FR" );

    Debug.println ( Debug.TRACE, "FORMULARIO_153_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/FORMULARIO_153_FR.jdp" );
