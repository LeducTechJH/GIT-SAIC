 ...
 */
public class RECLA_PENDCOBR_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public RECLA_PENDCOBR_PKT ( )
  {
    super ( "RECLA_PENDCOBR_PKT" );
   ...
   *
   */
  public RECLA_PENDCOBR_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RECLA_PENDCOBR_PKT ( MDIFrame pFrame )
  {
    super ( "RECLA_PENDCOBR_PKT", pFrame );
  ...
  {
    this.createComponents ( new RECLA_PENDCOBR_FRM ( ) );
   ...
   *
   */
  public static RECLA_PENDCOBR_PKT get ( RallyApplication __app )
  {
    return ( RECLA_PENDCOBR_PKT ) __app.getNewInstance ( "RECLA_PENDCOBR_PKT" );
  }
  ...
  {
    RECLA_PENDCOBR_PKT fSheet = RECLA_PENDCOBR_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RECLA_PENDCOBR_PKT.exec ( __app );
  }
