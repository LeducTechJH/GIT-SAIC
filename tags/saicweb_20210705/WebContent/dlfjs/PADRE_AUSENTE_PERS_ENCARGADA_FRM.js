...
function afterInit ( )
{
  ...
  names [ k ++ ] = "Actualizar/Crear datos del P/M Ausente";
  names [ k ++ ] = "Imprimir Reporte del P/M Ausente";

  var form = document.getElementById ( "PADRE_AUSENTE_PERS_ENCARGADA_FRM" );
  var x = 3;
...
function buttonOnClick ( )
{
  ...
  switch ( this.id )
  {
    case "button0":
    {
      ...
      doAppRequest ( request + "PADRES_AUSENTES_PKT" );
      break;
    }
    case "button1":
    {
