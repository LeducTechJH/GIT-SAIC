     ...
     extends FormSheet
{
   ...
   *
   */
  public ADSEF_PPT_5A_PKT ( )
  {
    super ( "ADSEF_PPT_5A_PKT" );
   ...
   *
   */
  public ADSEF_PPT_5A_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ADSEF_PPT_5A_PKT ( MDIFrame pFrame )
  {
    super ( "ADSEF_PPT_5A_PKT", pFrame );
   ...
   *
   */
  public static ADSEF_PPT_5A_PKT get ( RallyApplication __app )
  {
    return ( ADSEF_PPT_5A_PKT ) __app.getNewInstance ( "ADSEF_PPT_5A_PKT" );
  }
  ...
  {
    ADSEF_PPT_5A_PKT fSheet = ADSEF_PPT_5A_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ADSEF_PPT_5A_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_PPT_5A_MENU.exec ( app, null );
