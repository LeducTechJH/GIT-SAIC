 ...
 */
public class MANTENIMIENTO_BENEFICIO_PAN_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_BENEFICIO_PAN_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_BENEFICIO_PAN_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_BENEFICIO_PAN_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_BENEFICIO_PAN_FR.jdp" );
