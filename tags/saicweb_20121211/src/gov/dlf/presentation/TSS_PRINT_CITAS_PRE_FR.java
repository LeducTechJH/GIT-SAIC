 ...
 */
public class TSS_PRINT_CITAS_PRE_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TSS_PRINT_CITAS_PRE_FR ( )
  {
    super ( );
    this.setName ( "TSS_PRINT_CITAS_PRE_FR" );

    Debug.println ( Debug.TRACE, "TSS_PRINT_CITAS_PRE_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TSS_PRINT_CITAS_PRE_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "FINISH_ACTION", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      { 
        app.errorFlag = true; TSS_PRINT_CITAS_PRE_ADL.exec ( app ); return app.errorFlag;    
      }
    } );
  }
}
