 ...
 */
public class INF_NINOS_CUMPLIRAN_18_SCR_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INF_NINOS_CUMPLIRAN_18_SCR_PKT ( )
  {
    super ( "INF_NINOS_CUMPLIRAN_18_SCR_PKT" );
   ...
   *
   */
  public INF_NINOS_CUMPLIRAN_18_SCR_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INF_NINOS_CUMPLIRAN_18_SCR_PKT ( MDIFrame pFrame )
  {
    super ( "INF_NINOS_CUMPLIRAN_18_SCR_PKT", pFrame );
  ...
  {
    this.createComponents ( new INF_NINOS_CUMPLIRAN_18_FR ( ) );
   ...
   *
   */
  public static INF_NINOS_CUMPLIRAN_18_SCR_PKT get ( RallyApplication __app )
  {
    return ( INF_NINOS_CUMPLIRAN_18_SCR_PKT ) __app.getNewInstance ( "INF_NINOS_CUMPLIRAN_18_SCR_PKT" );
  }
  ...
  {
    INF_NINOS_CUMPLIRAN_18_SCR_PKT fSheet = INF_NINOS_CUMPLIRAN_18_SCR_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INF_NINOS_CUMPLIRAN_18_SCR_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_CUMPLIRAN_18_MENU.exec ( app, null );
 return app.errorFlag;
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CHK_AGGY_18B_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
