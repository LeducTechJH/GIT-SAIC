     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "DIP_108_A_FR" );

    Debug.println ( Debug.TRACE, "DIP_108_A_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DIP_108_A.jdp" );
