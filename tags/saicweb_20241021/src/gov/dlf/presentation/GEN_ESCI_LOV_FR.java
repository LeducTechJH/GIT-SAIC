     ...
     extends Form
{
   ...
   *
   */
  public GEN_ESCI_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_ESCI_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_ESCI_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_ESCI_LOV_FR.jdp" );
