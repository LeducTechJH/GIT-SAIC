 ...
 */
public class MANTENIMIENTO_SERV_PROV_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_SERV_PROV_FRM ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_SERV_PROV_FRM" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_SERV_PROV_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_SERV_PROV_FRM.jdp" );
