     ...
     extends FormSheet
{
   ...
   *
   */
  public AD220A_A3_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AD220A_A3_PKT ( MDIFrame pFrame )
  {
    super ( "AD220A_A3_PKT", pFrame );
  ...
  {
    this.createComponents ( new AD220A_A3_FR ( ) );
   ...
   *
   */
  public static AD220A_A3_PKT get ( RallyApplication __app )
  {
    return ( AD220A_A3_PKT ) __app.getNewInstance ( "AD220A_A3_PKT" );
  }
  ...
  {
    AD220A_A3_PKT fSheet = AD220A_A3_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return AD220A_A3_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; AD220A1_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; AD220A_B_NOMBRE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
