 ...
 */
public class PADRE_AUSENTE_PERS_ENCARGADA_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public PADRE_AUSENTE_PERS_ENCARGADA_FRM ( )
  {
    super ( );
    this.setName ( "PADRE_AUSENTE_PERS_ENCARGADA_FRM" );

    Debug.println ( Debug.TRACE, "PADRE_AUSENTE_PERS_ENCARGADA_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/PADRE_AUSENTE_PERS_ENCARGADA_FRM.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    //this.setArguments ( "SERV_INFO_GP", new PADRE_AUSENTE_PERS_ENCARGADA_FRM_SERV_INFO_GP_Arguments ( this ) );
    this.setArguments ( "PERS_ENCARGADA", new PADRE_AUSENTE_PERS_ENCARGADA_FRM_PERS_ENCARGADA_Arguments ( this ) );
  ...
  {
    this.registerListener ( "PERS_ENCARGADA", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
 ...
 *
 */
class PADRE_AUSENTE_PERS_ENCARGADA_FRM_PERS_ENCARGADA_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public PADRE_AUSENTE_PERS_ENCARGADA_FRM_PERS_ENCARGADA_Arguments ( Form form )
  {
    this.model = form;
