		...
		{        
			...
			case 1:
			{
				if (Compare.equals(this.dm.getFieldString ( this.dm.get ( "PROVEEDORES_TBL_DSD" ), "LIC_DPT_FAM_FLG" ), "X") &&
						(Compare.equals(this.dm.getFieldString ( this.dm.get ( "PROVEEDORES_TBL_DSD" ), "EVI_BANK_FLG" ), "X")))
				{
					if (( Compare.lt ( this.dm.getFieldDate ( this.dm.get ( "PROVEEDORES_TBL_DSD" ), "HASTA_LIC" ), this.app.SYSTEM_DATE ))  &&
							(  Compare.lt ( this.dm.getFieldDate ( this.dm.get ( "PROVEEDORES_TBL_DSD" ), "HASTA_EVI" ), this.app.SYSTEM_DATE ) )
						)
					{
						doc_activC = false;
					}
