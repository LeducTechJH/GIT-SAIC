     ...
     extends Form
{
   ...
   *
   */
  public REPORT_6_5_FR ( )
  {
    super ( );
    this.setName ( "REPORT_6_5_FR" );

    Debug.println ( Debug.TRACE, "REPORT_6_5_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REPORT_6_5_FR.jdp" );
  ...
  {
    this.registerListener ( "INPUT_START_DATE", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; REPORT_6_5_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "FINISH_ACTION", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; REPORT_6_EXIT.exec ( app, null ); return app.errorFlag;
      }
    } );
  }
}
