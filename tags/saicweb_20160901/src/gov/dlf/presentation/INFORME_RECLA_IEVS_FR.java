 ...
 */
public class INFORME_RECLA_IEVS_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public INFORME_RECLA_IEVS_FR ( )
  {
    super ( );
    this.setName ( "INFORME_RECLA_IEVS_FR" );

    Debug.println ( Debug.TRACE, "INFORME_RECLA_IEVS_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/INFORME_RECLA_IEVS_FR.jdp" );
