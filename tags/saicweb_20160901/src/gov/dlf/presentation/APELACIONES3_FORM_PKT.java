 ...
 */
public class APELACIONES3_FORM_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public APELACIONES3_FORM_PKT ( )
  {
    super ( "APELACIONES3_FORM_PKT" );
   ...
   *
   */
  public APELACIONES3_FORM_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public APELACIONES3_FORM_PKT ( MDIFrame pFrame )
  {
    super ( "APELACIONES3_FORM_PKT", pFrame );
  ...
  {
    this.createComponents ( new APELACIONES3_FR ( ) );
   ...
   *
   */
  public static APELACIONES3_FORM_PKT get ( RallyApplication __app )
  {
    return ( APELACIONES3_FORM_PKT ) __app.getNewInstance ( "APELACIONES3_FORM_PKT" );
  }
  ...
  {
    APELACIONES3_FORM_PKT fSheet = APELACIONES3_FORM_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return APELACIONES3_FORM_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; IMPRIMIR_APELACIONES_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; LLENAR_APELACIONES3_FR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
