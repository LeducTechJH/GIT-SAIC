     ...
     extends Form
{
   ...
   *
   */
  public GEN_SEGU_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_SEGU_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_SEGU_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_SEGU_LOV_FR.jdp" );
