     ...
     extends Form
{
  ...
  public void setObjectEvents ( )
  {
    ...
    */
    ...
    this.registerListener ( "ZIP_CODE_4", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        try
        {
          ...
          if ( serv.equals ( "ATEM" ) || serv.equals ( "ATFS" ) || serv.equals ( "ATES" ) || serv.equals ( "ATSE" ) || serv.equals ( "ATCR" ) )
          {
    ...
    this.registerListener ( "CONF_NUM_CUENTA", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
    	 public boolean eventFired ( String eventName )
         {
    		 app.errorFlag = true;
           try
           {
        	 ...
        	 double cta = app.form("SERV_NUCLEO_SERV_FRM").getDoubleItem( "EMER_NUM_CUENTA" );  
        	 double conf = app.form("SERV_NUCLEO_SERV_FRM").getDoubleItem( "CONF_NUM_CUENTA" );
             if (!(Compare.equals(conf, cta)))
             	{
            	 app.setError ("0", "Numero de cuenta debe ser igual en ambos campos.");
            	 app.errorFlag = false;
             	}
           }
           catch ( Exception ex )
    ...
    this.registerListener ( "ATRASO_LUZ", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; app.callCommand ( "SET WORD_WRAP" ); return app.errorFlag;
    ...
    this.registerListener ( "ATRASO_LUZ", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; app.callCommand ( "CLEAR WORD_WRAP" ); return app.errorFlag;
    ...
    this.registerListener ( "PAGO_RECON", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; app.callCommand ( "SET WORD_WRAP" ); return app.errorFlag;
    ...
    this.registerListener ( "PAGO_RECON", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; app.callCommand ( "CLEAR WORD_WRAP" ); return app.errorFlag;
    ...
    this.registerListener ( "GAS", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; app.callCommand ( "SET WORD_WRAP" ); return app.errorFlag;
    ...
    this.registerListener ( "GAS", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; app.callCommand ( "CLEAR WORD_WRAP" ); return app.errorFlag;
    ...
    this.registerListener ( "COMPRA_ABAN_AC", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; app.callCommand ( "SET WORD_WRAP" ); return app.errorFlag;
    ...
    this.registerListener ( "COMPRA_ABAN_AC", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; app.callCommand ( "CLEAR WORD_WRAP" ); return app.errorFlag;
