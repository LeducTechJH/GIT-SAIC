...
extends ADL
{
	...
	protected void step2 ( ParameterSet ps )
	{
		...
		if ( Compare.equals ( STATUS_ID, 0 ))
		{
			...
			String tiempo_cuido = "";
			if (Compare.equals(this.app.form ( "CONTRATO_PROYECCION_FR" ).getStringItem("COD_CUIDO"),"TCOM"))
			{
				tiempo_cuido = "COMPLETO";
			}
			else if (Compare.equals(this.app.form ( "CONTRATO_PROYECCION_FR" ).getStringItem("COD_CUIDO"),"TPRT"))
			{
				tiempo_cuido = "PARCIAL";
			}
			else
			{
				this.app.setError("0", "Debe verificar tiempo de cuido solicitado.");
				return;
			}
			//RATE CALCULATOR
			...
			if ( Compare.equals ( STATUS1_ID, 0 ) ) 
			{        
				if (Compare.equals(tiempo_cuido,"COMPLETO"))
				{
					tarifa = this.dm.getFieldDouble( this.dm.get ( "TARIFA_PROVEEDORES_DSD" ), "TARIFA_TIEMPO_COMP" );
				}
				else if (Compare.equals(tiempo_cuido,"PARCIAL"))
				{
					tarifa = this.dm.getFieldDouble( this.dm.get ( "TARIFA_PROVEEDORES_DSD" ), "TARIFA_TIEMPO_PART" );
				}
				else 
				{
					this.app.setError("0", "Debe verificar tiempo de cuido solicitado.");
				...
				rate = tarifa  / dias_labs;
				DecimalFormat df = new DecimalFormat("#.##");  
				rate = Double.valueOf(df.format(rate));
				this.app.form ( "CONTRATO_PROYECCION_FR" ).setItem ( "PAGO", TruncService.round (rate * dias_asis)); 
