 ...
 */
public class SECURITY_CUIDO_ADL
     extends ADL
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
  ...
  {
    ( ( SECURITY_CUIDO_ADL ) __app.getADL ( SECURITY_CUIDO_ADL.class ) ).OPEN_ID = value.getDouble ( );
  }  
  ...
  {
    ( ( SECURITY_CUIDO_ADL ) __app.getADL ( SECURITY_CUIDO_ADL.class ) ).STATUS_ID = value.getDouble ( );
  }  
  ...
  {
    return ( ( SECURITY_CUIDO_ADL ) __app.getADL ( SECURITY_CUIDO_ADL.class ) ).TSS_ACCESS_RO_DSD;
  }
  ...
  {
    ( ( SECURITY_CUIDO_ADL ) __app.getADL ( SECURITY_CUIDO_ADL.class ) ).TSS_ACCESS_RO_DSD = value;
  }
  ...
  {
    ( ( SECURITY_CUIDO_ADL ) __app.getADL ( SECURITY_CUIDO_ADL.class ) ).TSS_ACCESS_RO_DSD = ( DataStore ) value;
  }
  ...
  {
    return ( ( SECURITY_CUIDO_ADL ) __app.getADL ( SECURITY_CUIDO_ADL.class ) ).OPEN_ID;
  }
  ...
  {
    return new Double ( ( ( SECURITY_CUIDO_ADL ) __app.getADL ( SECURITY_CUIDO_ADL.class ) ).OPEN_ID );
  }
  ...
  {
    ( ( SECURITY_CUIDO_ADL ) __app.getADL ( SECURITY_CUIDO_ADL.class ) ).OPEN_ID = value;
  }
  ...
  {
    ( ( SECURITY_CUIDO_ADL ) __app.getADL ( SECURITY_CUIDO_ADL.class ) ).OPEN_ID = ( ( Double ) value ).doubleValue ( );
  }
  ...
  {
    return ( ( SECURITY_CUIDO_ADL ) __app.getADL ( SECURITY_CUIDO_ADL.class ) ).STATUS_ID;
  }
  ...
  {
    return new Double ( ( ( SECURITY_CUIDO_ADL ) __app.getADL ( SECURITY_CUIDO_ADL.class ) ).STATUS_ID );
  }
  ...
  {
    ( ( SECURITY_CUIDO_ADL ) __app.getADL ( SECURITY_CUIDO_ADL.class ) ).STATUS_ID = value;
  }
  ...
  {
    ( ( SECURITY_CUIDO_ADL ) __app.getADL ( SECURITY_CUIDO_ADL.class ) ).STATUS_ID = ( ( Double ) value ).doubleValue ( );
  }
   ...
   * @return
   */
  public static SECURITY_CUIDO_ADL get ( RallyApplication __app )
  {
    SECURITY_CUIDO_ADL adl = new SECURITY_CUIDO_ADL ( );
    __app.register ( adl, "SECURITY_ADL" );
    __app.setADL ( SECURITY_CUIDO_ADL.class, adl ); 
  ...
  {
    SECURITY_CUIDO_ADL.get ( __app ).process ( ps );
  }
  ...
  public static void exec ( RallyApplication __app )
  {
    ...
    SECURITY_CUIDO_ADL.exec ( __app, ps );
  }
  ...
  public void unregister ( )
  {
    ...
    IRegisteredObject rObj = this.app.get ( "SECURITY_CUIDO_ADL" );
    if ( rObj != null && rObj instanceof SECURITY_CUIDO_ADL )
    {
      this.app.setADL ( SECURITY_CUIDO_ADL.class, ( SECURITY_CUIDO_ADL ) rObj );
    }
  }
  ...
  {
    Debug.println ( Debug.TRACE, "SECURITY_CUIDO_ADL Step " + this.currentStep );
    super.process ( ps );
    switch ( this.currentStep ) 
    {
      ...
      { 
        this.currentStep = 0;
        Debug.println ( Debug.TRACE, "SECURITY_CUIDO_ADL ended" );
        this.unregister ( );
        break;
      }
    }
