     ...
     extends ADL
{
  ...
  protected void step4 ( ParameterSet ps )
  {
    ...
    if ( ( Compare.equals ( this.app.MANT_ACCION_SERV_GBL, "RS" ) ) || ( Compare.equals ( this.app.MANT_ACCION_SERV_GBL, "RR" ) ) || ( Compare.equals ( this.app.MANT_ACCION_SERV_GBL, "RF" ) ) || ( Compare.equals ( this.app.MANT_ACCION_SERV_GBL, "RO" ) ) ) 
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if ( ( ( ( Compare.equals ( this.app.RUTINA_GBL, "MC" ) ) || ( Compare.equals ( this.app.RUTINA_GBL, "IR" ) ) || ( Compare.equals ( this.app.RUTINA_GBL, "AC" ) ) ) && ( Compare.equals ( this.app.AUTORIZADA_GBL, "N" ) )  ) || ( ( Compare.gt ( MathService.plus ( this.app.form ( "FECHAS_SERVICIO_FRM" ).getDoubleItem ( "CONTEO_60_MESES_TANF_VAR" ), this.app.form ( "FECHAS_SERVICIO_FRM" ).getDoubleItem ( "NUM_MESES" ) ), 60 ) ) && ( Compare.equals ( this.app.form ( "FECHAS_SERVICIO_FRM" ).getStringItem ( "COD_SERVICIO" ), "AE-C" ) )  ) ) 
          {
    ...
    {
      if ( ( Compare.equals ( RallyStringService.subString ( this.app.form ( "FECHAS_SERVICIO_FRM" ).getStringItem ( "COD_SERVICIO" ), 0, 4 ), "PANE" ) ) || ( Compare.equals ( RallyStringService.subString ( this.app.form ( "FECHAS_SERVICIO_FRM" ).getStringItem ( "COD_SERVICIO" ), 0, 2 ), "AT" ) ) ) 
      {
        this.app.form ( "FECHAS_SERVICIO_FRM" ).setItem ( "COD_STATUS_SERVICIO", "CERRAD39"  );
        this.app.form ( "FECHAS_SERVICIO_FRM" ).setItem ( "FCH_CERRADO", this.app.SYSTEM_DATE  );
        this.app.form ( "SERV_FAM_FRM" ).setItem ( "COD_STATUS_SERVICIO", "CERRAD39"  );
        this.app.form ( "PRE_MENU_MANT_SERV_FR" ).setItem ( "COD_STATUS_SERVICIO", "CERRAD39"  );
      }
      else
      {
        this.app.form ( "FECHAS_SERVICIO_FRM" ).setItem ( "COD_STATUS_SERVICIO", "ACTIVO"  );
    ...
    if ( Compare.equals ( this.app.MANT_ACCION_SERV_GBL, "AT" ) ) 
    {
