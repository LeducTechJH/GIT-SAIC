 ...
 */
public class MANTENIMIENTO_RECURSOS_UPDATE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_RECURSOS_UPDATE_PKT ( )
  {
    super ( "MANTENIMIENTO_RECURSOS_UPDATE_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_RECURSOS_UPDATE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_RECURSOS_UPDATE_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_RECURSOS_UPDATE_PKT", pFrame );
   ...
   *
   */
  public static MANTENIMIENTO_RECURSOS_UPDATE_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_RECURSOS_UPDATE_PKT ) __app.getNewInstance ( "MANTENIMIENTO_RECURSOS_UPDATE_PKT" );
  }
  ...
  {
    MANTENIMIENTO_RECURSOS_UPDATE_PKT fSheet = MANTENIMIENTO_RECURSOS_UPDATE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_RECURSOS_UPDATE_PKT.exec ( __app );
  }
