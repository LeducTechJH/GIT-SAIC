 ...
 */
public class PLAN_TRABAJO_UPD_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PLAN_TRABAJO_UPD_PKT ( )
  {
    super ( "PLAN_TRABAJO_UPD_PKT" );
   ...
   *
   */
  public PLAN_TRABAJO_UPD_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PLAN_TRABAJO_UPD_PKT ( MDIFrame pFrame )
  {
    super ( "PLAN_TRABAJO_UPD_PKT", pFrame );
  ...
  {
    this.createComponents ( new PLAN_TRABAJO_FRM ( ) );
   ...
   *
   */
  public static PLAN_TRABAJO_UPD_PKT get ( RallyApplication __app )
  {
    return ( PLAN_TRABAJO_UPD_PKT ) __app.getNewInstance ( "PLAN_TRABAJO_UPD_PKT" );
  }
  ...
  {
    PLAN_TRABAJO_UPD_PKT fSheet = PLAN_TRABAJO_UPD_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PLAN_TRABAJO_UPD_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; PLAN_TRABAJO_BF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
