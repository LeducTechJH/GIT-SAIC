 ...
 */
public class SIBIF_CAL_GET_CITAS_FOR_TSS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SIBIF_CAL_GET_CITAS_FOR_TSS_PKT ( )
  {
    super ( "SIBIF_CAL_GET_CITAS_FOR_TSS_PKT" );
   ...
   *
   */
  public SIBIF_CAL_GET_CITAS_FOR_TSS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SIBIF_CAL_GET_CITAS_FOR_TSS_PKT ( MDIFrame pFrame )
  {
    super ( "SIBIF_CAL_GET_CITAS_FOR_TSS_PKT", pFrame );
   ...
   *
   */
  public static SIBIF_CAL_GET_CITAS_FOR_TSS_PKT get ( RallyApplication __app )
  {
    return ( SIBIF_CAL_GET_CITAS_FOR_TSS_PKT ) __app.getNewInstance ( "SIBIF_CAL_GET_CITAS_FOR_TSS_PKT" );
  }
  ...
  {
    SIBIF_CAL_GET_CITAS_FOR_TSS_PKT fSheet = SIBIF_CAL_GET_CITAS_FOR_TSS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SIBIF_CAL_GET_CITAS_FOR_TSS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_CALENDARIO_CITAS_MENU.exec ( app, null );
