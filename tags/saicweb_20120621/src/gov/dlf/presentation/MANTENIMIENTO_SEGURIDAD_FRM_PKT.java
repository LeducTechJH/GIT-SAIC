 ...
 */
public class MANTENIMIENTO_SEGURIDAD_FRM_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_SEGURIDAD_FRM_PKT ( )
  {
    super ( "MANTENIMIENTO_SEGURIDAD_FRM_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_SEGURIDAD_FRM_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_SEGURIDAD_FRM_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_SEGURIDAD_FRM_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_SEGURIDAD_FRM ( ) );
   ...
   *
   */
  public static MANTENIMIENTO_SEGURIDAD_FRM_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_SEGURIDAD_FRM_PKT ) __app.getNewInstance ( "MANTENIMIENTO_SEGURIDAD_FRM_PKT" );
  }
  ...
  {
    MANTENIMIENTO_SEGURIDAD_FRM_PKT fSheet = MANTENIMIENTO_SEGURIDAD_FRM_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_SEGURIDAD_FRM_PKT.exec ( __app );
  }
