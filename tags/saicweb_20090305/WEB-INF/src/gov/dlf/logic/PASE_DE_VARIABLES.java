     ...
     extends ADL
{
  ...
  protected void step1 ( ParameterSet ps )
  {
    ...
    if ( ! Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "PANE" ) ) 
    {
      ...
      this.app.form ( "DETERMINACION_FR" ).setItem ( "OTROS", DETERMINAR_ELEGIBILIDAD_PAN_2.getOTROS ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "SUMA_ING", DETERMINAR_ELEGIBILIDAD_PAN_2.getING_MENOS_40 ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "DEDUC_60", DETERMINAR_ELEGIBILIDAD_PAN_2.getDEDUC_60 ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "TOT_60", DETERMINAR_ELEGIBILIDAD_PAN_2.getTOTAL_60 ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "DEDU_INCA", DETERMINAR_ELEGIBILIDAD_PAN_2.getDEDUC_INCA ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "TOT_INCA", DETERMINAR_ELEGIBILIDAD_PAN_2.getTOTAL_INCA ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "DEDU_EST", DETERMINAR_ELEGIBILIDAD_PAN_2.getDEDUC_EST ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "TOT_EST", DETERMINAR_ELEGIBILIDAD_PAN_2.getTOTAL_EST ( this.app )  );
    ...
    else
    {
      ...
      this.app.form ( "DETERMINACION_FR" ).setItem ( "OTROS_EMER", DETERMINAR_ELEGIBILIDAD_PAN_2.getOTROS ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "SUMA_ING_EMER", DETERMINAR_ELEGIBILIDAD_PAN_2.getING_MENOS_40 ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "DEDUC_60_EMER", DETERMINAR_ELEGIBILIDAD_PAN_2.getDEDUC_60 ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "TOT_60_EMER", DETERMINAR_ELEGIBILIDAD_PAN_2.getTOTAL_60 ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "DEDU_INCA_EMER", DETERMINAR_ELEGIBILIDAD_PAN_2.getDEDUC_INCA ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "TOT_INCA_EMER", DETERMINAR_ELEGIBILIDAD_PAN_2.getTOTAL_INCA ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "DEDU_EST_EMER", DETERMINAR_ELEGIBILIDAD_PAN_2.getDEDUC_EST ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "TOT_EST_EMER", DETERMINAR_ELEGIBILIDAD_PAN_2.getTOTAL_EST ( this.app )  );
      ...
      this.app.form ( "DETERMINACION_FR" ).setItem ( "BENEFICIO_EMER", DETERMINAR_ELEGIBILIDAD_PAN_2.getBENEFICIO ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "INELEGIBLE_EMER", DETERMINAR_ELEGIBILIDAD_PAN_2.getINELEGIBLE_EMER ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "ELEGIBLE_EMER", DETERMINAR_ELEGIBILIDAD_PAN_2.getELEGIBLE_EMER ( this.app )  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "FECHA_ELEG_EMER", this.app.FCH_SOLIC_SERV_GBL  );
      this.app.form ( "DETERMINACION_FR" ).setItem ( "RAZON", DETERMINAR_ELEGIBILIDAD_PAN_2.getRAZON ( this.app )  );
    }
    if ( Compare.equals ( this.app.DETERMINACION_FINAL_GBL, "S" ) ) 
    {
      ...
      if ( Compare.equals ( PRESUPUESTO_LOC_STAT, 0 ) ) 
      {
        ...
        this.dm.setField ( this.dm.get ( "PRESUPUESTO_LOC_DSD" ), "DEDUCIONES_OTROS_ING", DETERMINAR_ELEGIBILIDAD_PAN_2.getOTROS ( this.app ) );
