 ...
 */
public class REGISTRO_APELACIONES_FRM_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REGISTRO_APELACIONES_FRM_PKT ( )
  {
    super ( "REGISTRO_APELACIONES_FRM_PKT" );
   ...
   *
   */
  public REGISTRO_APELACIONES_FRM_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REGISTRO_APELACIONES_FRM_PKT ( MDIFrame pFrame )
  {
    super ( "REGISTRO_APELACIONES_FRM_PKT", pFrame );
  ...
  {
    this.createComponents ( new REGISTRO_APELACIONES_RPT ( ) );
   ...
   *
   */
  public static REGISTRO_APELACIONES_FRM_PKT get ( RallyApplication __app )
  {
    return ( REGISTRO_APELACIONES_FRM_PKT ) __app.getNewInstance ( "REGISTRO_APELACIONES_FRM_PKT" );
  }
  ...
  {
    REGISTRO_APELACIONES_FRM_PKT fSheet = REGISTRO_APELACIONES_FRM_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REGISTRO_APELACIONES_FRM_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  IMPRIMIR_REGISTRO_APEL_MENU.exec ( app, null );
 return app.errorFlag;
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; LLENAR_REGISTRO_APELACIONES_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
