 ...
 */
public class TRANSFER_ENVIADAS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TRANSFER_ENVIADAS_PKT ( )
  {
    super ( "TRANSFER_ENVIADAS_PKT" );
   ...
   *
   */
  public TRANSFER_ENVIADAS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TRANSFER_ENVIADAS_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_ENVIADAS_PKT", pFrame );
   ...
   *
   */
  public static TRANSFER_ENVIADAS_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_ENVIADAS_PKT ) __app.getNewInstance ( "TRANSFER_ENVIADAS_PKT" );
  }
  ...
  {
    TRANSFER_ENVIADAS_PKT fSheet = TRANSFER_ENVIADAS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_ENVIADAS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_TRANSFER_ENVIADAS_MENU.exec ( app, null );
