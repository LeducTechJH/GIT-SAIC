     ...
     extends FormSheet
{
   ...
   *
   */
  public RETRO_INSERT_PKT ( )
  {
    super ( "RETRO_INSERT_PKT" );
   ...
   *
   */
  public RETRO_INSERT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RETRO_INSERT_PKT ( MDIFrame pFrame )
  {
    super ( "RETRO_INSERT_PKT", pFrame );
  ...
  {
    this.createComponents ( new RETRO_INSERT_FR ( ) );
   ...
   *
   */
  public static RETRO_INSERT_PKT get ( RallyApplication __app )
  {
    return ( RETRO_INSERT_PKT ) __app.getNewInstance ( "RETRO_INSERT_PKT" );
  }
  ...
  {
    RETRO_INSERT_PKT fSheet = RETRO_INSERT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RETRO_INSERT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; RR_INS_AFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; RETRO_INS_BFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
