     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( Compare.equals ( this.app.MANT_ACCION_SERV_GBL, "CS" ) ) 
    {
      ...
      if ( Compare.equals ( this.app.form ( "FECHAS_SERVICIO_FRM" ).getStringItem ( "COD_STATUS_SERVICIO" ), "CERRAD25" ) ||
    	   Compare.equals ( this.app.form ( "FECHAS_SERVICIO_FRM" ).getStringItem ( "COD_STATUS_SERVICIO" ), "CERRAD12" ) ) 
      {
    ...
    // code added:
    if ( ( Compare.equals ( this.app.MANT_ACCION_SERV_GBL, "CS" ) ) && 
    		( Compare.equals ( this.app.form ( "FECHAS_SERVICIO_FRM" ).getStringItem ( "COD_STATUS_SERVICIO" ), "CERRAD28" ) )  && 
...
{ISP 17-nov-2005 Validación para que a un caso cerrad14 no le puedan cambiar
