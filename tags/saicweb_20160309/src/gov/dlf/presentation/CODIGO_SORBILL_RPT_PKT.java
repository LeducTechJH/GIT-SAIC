 ...
 */
public class CODIGO_SORBILL_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CODIGO_SORBILL_RPT_PKT ( )
  {
    super ( "CODIGO_SORBILL_RPT_PKT" );
   ...
   *
   */
  public CODIGO_SORBILL_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CODIGO_SORBILL_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "CODIGO_SORBILL_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CODIGO_SORBILL_RPT ( ) );
   ...
   *
   */
  public static CODIGO_SORBILL_RPT_PKT get ( RallyApplication __app )
  {
    return ( CODIGO_SORBILL_RPT_PKT ) __app.getNewInstance ( "CODIGO_SORBILL_RPT_PKT" );
  }
  ...
  {
    CODIGO_SORBILL_RPT_PKT fSheet = CODIGO_SORBILL_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CODIGO_SORBILL_RPT_PKT.exec ( __app );
  }
