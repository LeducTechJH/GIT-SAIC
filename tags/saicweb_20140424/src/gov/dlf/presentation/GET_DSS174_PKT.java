     ...
     extends FormSheet
{
   ...
   *
   */
  public GET_DSS174_PKT ( )
  {
    super ( "GET_DSS174_PKT" );
   ...
   *
   */
  public GET_DSS174_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GET_DSS174_PKT ( MDIFrame pFrame )
  {
    super ( "GET_DSS174_PKT", pFrame );
  ...
  {
    this.createComponents ( new GET_DSS174_FR ( ) );
   ...
   *
   */
  public static GET_DSS174_PKT get ( RallyApplication __app )
  {
    return ( GET_DSS174_PKT ) __app.getNewInstance ( "GET_DSS174_PKT" );
  }
  ...
  {
    GET_DSS174_PKT fSheet = GET_DSS174_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GET_DSS174_PKT.exec ( __app );
  }
