 ...
 */
public class PTRA_CLIENTE_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PTRA_CLIENTE_RO_PKT ( )
  {
    super ( "PTRA_CLIENTE_RO_PKT" );
   ...
   *
   */
  public PTRA_CLIENTE_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PTRA_CLIENTE_RO_PKT ( MDIFrame pFrame )
  {
    super ( "PTRA_CLIENTE_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new PTRA_CLIENTE_FR ( ) );
   ...
   *
   */
  public static PTRA_CLIENTE_RO_PKT get ( RallyApplication __app )
  {
    return ( PTRA_CLIENTE_RO_PKT ) __app.getNewInstance ( "PTRA_CLIENTE_RO_PKT" );
  }
  ...
  {
    PTRA_CLIENTE_RO_PKT fSheet = PTRA_CLIENTE_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PTRA_CLIENTE_RO_PKT.exec ( __app );
  }
