 ...
 */
public class BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_PKT ( )
  {
    super ( "BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_PKT" );
   ...
   *
   */
  public BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_PKT ( MDIFrame pFrame )
  {
    super ( "BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_PKT", pFrame );
  ...
  {
    this.createComponents ( new BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_FRM ( ) );
   ...
   *
   */
  public static BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_PKT get ( RallyApplication __app )
  {
    return ( BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_PKT ) __app.getNewInstance ( "BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_PKT" );
  }
  ...
  {
    BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_PKT fSheet = BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.BEFOREQUIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; BUSCAR3_QUIT_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
