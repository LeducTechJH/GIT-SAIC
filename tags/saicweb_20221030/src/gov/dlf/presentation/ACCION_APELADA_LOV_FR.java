 ...
 */
public class ACCION_APELADA_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public ACCION_APELADA_LOV_FR ( )
  {
    super ( );
    this.setName ( "ACCION_APELADA_LOV_FR" );

    Debug.println ( Debug.TRACE, "ACCION_APELADA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ACCION_APELADA_LOV_FR.jdp" );
