     ...
     extends FormSheet
{
   ...
   *
   */
  public AUTO_PAGO_PCK ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AUTO_PAGO_PCK ( MDIFrame pFrame )
  {
    super ( "AUTO_PAGO_PCK", pFrame );
  ...
  {
    this.createComponents ( new AUTO_PAGO_FRM ( ) );
   ...
   *
   */
  public static AUTO_PAGO_PCK get ( RallyApplication __app )
  {
    return ( AUTO_PAGO_PCK ) __app.getNewInstance ( "AUTO_PAGO_PCK" );
  }
  ...
  {
    AUTO_PAGO_PCK fSheet = AUTO_PAGO_PCK.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return AUTO_PAGO_PCK.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; AUTORIZACION_PAGO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
