     ...
     extends Form
{
   ...
   *
   */
  public TECNICO_LOV_FR ( )
  {
    super ( );
    this.setName ( "TECNICO_LOV_FR" );

    Debug.println ( Debug.TRACE, "TECNICO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TECNICO_LOV_FR.jdp" );
