     ...
     extends ADL
{
  ...
  protected void step2 ( ParameterSet ps )
  {
	...
	/*   1. Read CLIENTES rows for JEFE_FAMILIA                                                     */
	/*   2. For each CLIENTES row found:                                                            */
	/*      2.1. Using the SEGURO_SOCIAL_CLIENTE:                                                   */
	/*           2.1.1. For CLIENTES table:                                                         */
	/*                  2.1.1.1. Delete CLIENTES_HIST rows.                                         */
	/*                  2.1.1.2. Copy CLIENTES row to CLIENTES_HIST.                                */
	/*           2.1.2. For INGRESOS_CLIENTES table:                                                */
	/*                  2.1.2.1. Delete INGRESOS_CLIENTES_HIST rows.                                */
	/*                  2.1.2.2. Copy INGRESOS_CLIENTES rows to INGRESOS_CLIENTES_HIST.             */
	/*           2.1.3. For RECURSOS_CLIENTES table:                                                */
	/*                  2.1.3.1. Delete RECURSOS_CLIENTES_HIST rows.                                */
	/*                  2.1.3.2. Copy RECURSOS_CLIENTES rows to RECURSOS_CLIENTES_HIST.             */
	/*           2.1.4. For DEDUCCIONES_CLIENTES table:                                             */
	/*                  2.1.4.1. Delete DEDUCCIONES_CLIENTES_HIST rows.                             */
	/*                  2.1.4.2. Copy DEDUCCIONES_CLIENTES rows to DEDUCCIONES_CLIENTES_HIST.       */
	/*           2.1.5. For BILLETES table:                                                         */
	/*                  2.1.5.1. Delete BILLETES_HIST rows.                                         */
	/*                  2.1.5.2. Copy BILLETES rows to BILLETES_HIST.                               */
	/*      2.2. Using the SEGURO_SOCIAL_BENEFICIARIO:                                              */
	/*           2.2.1. For NUCLEO_SERVICIO table:                                                  */
	/*                  2.2.1.1. Delete NUCLEO_SERVICIO_HIST rows.                                  */
	/*                  2.2.1.2. Copy from NUCLEO_SERVICIO rows to NUCLEO_SERVICIO_HIST.            */
	/*      2.3. Read next CLIENTES row, repeat from step 2.                                        */
    ...
    if ( Compare.equals ( CLIENTES_READ_LOC_STATUS_CODE, 0 )  )
    {
		/* loop to process CLIENTES rows */
	    while ( Compare.equals ( CLIENTES_READ_LOC_STATUS_CODE, 0 )  )
	    {
			/* delete from CLIENTES_HIST all records that correspond to the SSN */
	    	...
	    	/* copy current CLIENTES record to CLIENTES_HIST */
    		setFieldDouble ( CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "RMO_OFICINA");
    		setFieldString ( CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "USUARIO");
	     	setFieldDouble ( CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "SEGURO_SOCIAL_CLIENTE");	
	     	...
	     	setFieldString ( CLIENTES_HIST_RW_DSD, "TIPO_TRANS","T");
	        setFieldString ( CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "VERIFICACION_SEGUROSOCIAL" );
	        setFieldString ( CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "VERIFICACION_IDENTIDAD" );
	        setFieldString ( CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "VERIFICACION_CIUDADANIA" );
	        setFieldString ( CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "VERIFICACION_RESIDENCIA" );
	        
	        
	        /*ADDED 10/17/2023 */
	        
	     // Fields for CLIENTES_HIST_RW_DSD and CLIENTES_READ_LOC_DSD
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "ESTADO_RESIDENCIA");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "CIUDAD_RESIDENCIA");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "DIRECCION_RESIDENCIA");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "ZIPCODE");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "FLG_DISCAPACIDAD");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "FLG_ESTUDIANTE");
	        setFieldDate(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "FECHA_REGISTRO_EMPLEO");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "ESTATUS_REGISTRO_EMPLEO");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "NIVEL_EDUCACION");
	        setFieldDate(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "FECHA_ULTIMA_ACTUALIZACION");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "USUARIO_ULTIMA_ACTUALIZACION");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "IDIOMA_PREFERIDO");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "FLG_RECIBE_CORRESPONDENCIA");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "FLG_AUTORIZA_CONTACTO_EMERGENCIA");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "NOMBRE_CONTACTO_EMERGENCIA");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "TELEFONO_CONTACTO_EMERGENCIA");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "RELACION_CONTACTO_EMERGENCIA");
	       
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "COD_RZ_NSS_SUST");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "EMAIL");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "TELEFONO_CELULAR");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "NUM_VER_SS");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "NUM_VER_RES");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "NUM_VER_ID");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "NUM_VER_CIU");
	        setFieldDouble(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "REMANENTE_TANF");
	        setFieldDate(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "FECHA_EMIGRACION");
	        setFieldDate(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "FECHA_DECESO");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "PERSONAID");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "EXPEDIENTEID");
	        setFieldString(CLIENTES_HIST_RW_DSD, CLIENTES_READ_LOC_DSD, "COD_ETNICIDAD");
	    	...
	    	/* insert the CLIENTES_HIST row */
	     	CLIENTES_HIST_RW_STATUS_CODE  = this.dm.insertRow ( CLIENTES_HIST_RW_DSD_ID );
	     	
			/* delete from INGRESOS_CLIENTE_HIST all records that correspond to the SSN */
			INGRESOS_CLIENTE_HIST_RW_STATUS_CODE  = this.dm.reset ( INGRESOS_CLIENTE_HIST_RW_DSD_ID );
			setFieldDouble ( INGRESOS_CLIENTE_HIST_RW_DSD , CLIENTES_READ_LOC_DSD, "SEGURO_SOCIAL_CLIENTE");
    		...
    		/* copy current INGRESOS record to INGRESOS_CLIENTE_HIST */
    		...
    		/* copy current RECURSOS record to RECURSOS_CLIENTE_HIST */
			...
			/* delete from DEDUCCIONES_CLIENTE_HIST all records that correspond to the SSN */
			DEDUCCIONES_CLIENTE_HIST_RW_STATUS_CODE = this.dm.reset ( DEDUCCIONES_CLIENTE_HIST_RW_DSD_ID );
			setFieldDouble ( DEDUCCIONES_CLIENTE_HIST_RW_DSD , CLIENTES_READ_LOC_DSD, "SEGURO_SOCIAL_CLIENTE" );
			setFieldString ( DEDUCCIONES_CLIENTE_HIST_RW_DSD , "TIPO_TRANS", "T" );
			DEDUCCIONES_CLIENTE_HIST_RW_STATUS_CODE  = this.deleteRows( DEDUCCIONES_CLIENTE_HIST_RW_DSD_ID );
    		/* copy current DEDUCCIONES record to DEDUCCIONES_CLIENTE_HIST */
			...
			/* delete from BILLETES_HIST all records that correspond to the SSN */
			BILLETES_HIST_RW_STATUS_CODE = this.dm.reset ( BILLETES_HIST_RW_DSD_ID );
			setFieldDouble ( BILLETES_HIST_RW_DSD , CLIENTES_READ_LOC_DSD, "SEGURO_SOCIAL_CLIENTE");
			setFieldString ( BILLETES_HIST_RW_DSD, "TIPO_TRANS", "T" );
			BILLETES_HIST_RW_STATUS_CODE  = this.deleteRows( BILLETES_HIST_RW_DSD_ID );
    		/* copy current BILLETES record to BILLETES_CLIENTE_HIST */
			...
			/* delete NUCLEO_SERVICIO_HIST rows */
			...
			setFieldDouble ( NUCLEO_SERVICIO_HIST_RW_DSD, "SEGURO_SOCIAL_BENEFICIARIO", CLIENTES_READ_LOC_DSD, "SEGURO_SOCIAL_CLIENTE" );
			setFieldDouble ( NUCLEO_SERVICIO_HIST_RW_DSD, "RMO_OFICINA", CLIENTES_READ_LOC_DSD, "RMO_OFICINA" );
			NUCLEO_SERVICIO_HIST_RW_STATUS_CODE  = this.deleteRows( NUCLEO_SERVICIO_HIST_RW_DSD_ID );
			/* copy NUCLEO_SERVICIO records to NUCLEO_SERVICIO_HIST */
			NUCLEO_READ_LOC_STATUS_CODE  = this.dm.reset ( NUCLEO_READ_LOC_DSD_ID );
			setFieldDouble ( NUCLEO_READ_LOC_DSD, "SEGURO_SOCIAL_BENEFICIARIO", CLIENTES_READ_LOC_DSD, "SEGURO_SOCIAL_CLIENTE" );
			setFieldDouble ( NUCLEO_READ_LOC_DSD, "RMO_OFICINA", CLIENTES_READ_LOC_DSD, "RMO_OFICINA" );
	        ...
	        /* Read next CLIENTES row and repeat process if there are more rows */
			CLIENTES_READ_LOC_STATUS_CODE = this.dm.nextRow ( CLIENTES_READ_LOC_DSD_ID );
	    }
    	/*---------------------------------------------------------*/
    	/* STEP3: Commit changes made to database.                 */
    	/*---------------------------------------------------------*/
