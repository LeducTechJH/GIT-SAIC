     ...
     extends FormSheet
{
   ...
   *
   */
  public INACTIVOS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INACTIVOS_PKT ( MDIFrame pFrame )
  {
    super ( "INACTIVOS_PKT", pFrame );
   ...
   *
   */
  public static INACTIVOS_PKT get ( RallyApplication __app )
  {
    return ( INACTIVOS_PKT ) __app.getNewInstance ( "INACTIVOS_PKT" );
  }
  ...
  {
    INACTIVOS_PKT fSheet = INACTIVOS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INACTIVOS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_INACTIVOS_MENU.exec ( app, null );
