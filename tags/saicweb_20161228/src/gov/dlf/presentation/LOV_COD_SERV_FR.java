     ...
     extends Form
{
   ...
   *
   */
  public LOV_COD_SERV_FR ( )
  {
    super ( );
    this.setName ( "LOV_COD_SERV_FR" );

    Debug.println ( Debug.TRACE, "LOV_COD_SERV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/LOV_COD_SERV_FR.jdp" );
