     ...
     extends FormSheet
{
   ...
   *
   */
  public GET_SC1071_PKT ( )
  {
    super ( "GET_SC1071_PKT" );
   ...
   *
   */
  public GET_SC1071_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GET_SC1071_PKT ( MDIFrame pFrame )
  {
    super ( "GET_SC1071_PKT", pFrame );
  ...
  {
    this.createComponents ( new GET_SC1071_FR ( ) );
   ...
   *
   */
  public static GET_SC1071_PKT get ( RallyApplication __app )
  {
    return ( GET_SC1071_PKT ) __app.getNewInstance ( "GET_SC1071_PKT" );
  }
  ...
  {
    GET_SC1071_PKT fSheet = GET_SC1071_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GET_SC1071_PKT.exec ( __app );
  }
