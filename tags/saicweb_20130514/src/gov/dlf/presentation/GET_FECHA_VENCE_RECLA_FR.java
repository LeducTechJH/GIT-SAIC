 ...
 */
public class GET_FECHA_VENCE_RECLA_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GET_FECHA_VENCE_RECLA_FR ( )
  {
    super ( );
    this.setName ( "GET_FECHA_VENCE_RECLA_FR" );

    Debug.println ( Debug.TRACE, "GET_FECHA_VENCE_RECLA_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_FECHA_VENCE_RECLA_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new GET_FECHA_VENCE_RECLA_FR_OFICINAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "FECHA" );
    field.setValueProvider ( new GET_FECHA_VENCE_RECLA_FR_FECHAProvider ( this ) );
  ...
  {
    this.registerListener ( "FCH_HASTA", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; FECHA_VENCE_HASTA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class GET_FECHA_VENCE_RECLA_FR_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public GET_FECHA_VENCE_RECLA_FR_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class GET_FECHA_VENCE_RECLA_FR_FECHAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public GET_FECHA_VENCE_RECLA_FR_FECHAProvider ( Form form )
  {
    this.model = form;
  }
