...
//***** START MODS BY J. OLMEDA - 8/13/2010 *****
  ...
  if (codServicio == "ATCR" || codServicio == "ATSE")
	  {
	  if (codServicio == "ATCR")
	  	{
	  ...
	  if (!(codServicio == "ATCR"))
	  	{
		  	...
		  	var element1 = document.getElementById("ATRASO_LUZ.0.0.0");
			if (element1) 
			{
				element1.style.display = "none";
			}
			var element2 = document.getElementById("SERV_EMERG_GP_TXT__12.0.0.0");
			if (element2) 
			{
				element2.style.display = "none";
			}
			var element3 = document.getElementById("SERV_EMERG_GP_TXT__13.0.0.0");
			if (element3) 
			{
				element3.style.display = "none";
			}
			var element4 = document.getElementById("SERV_EMERG_GP_TXT__14.0.0.0");
			if (element4) 
			{
				element4.style.display = "none";
			}
			var element5 = document.getElementById("SERV_EMERG_GP_TXT__15.0.0.0");
			if (element5) 
			{
			...
			var element11 = document.getElementById("PAGO_RECON.0.0.0");
			if (element11) 
			{
				element11.style.display = "none";
			}
			var element12 = document.getElementById("GAS.0.0.0");
			if (element12) 
			{
				element12.style.display = "none";
			}
			var element13 = document.getElementById("COMPRA_ABAN_AC.0.0.0");
			if (element13) 
			{
...
function buttonOnClick ( )
{
  var request = "command=appAction&action=UpdateForm;";
          ...
          var pass = document.getElementById("EMER_NUM_CUENTA.0.0.0").value;
          var confPass = document.getElementById("CONF_NUM_CUENTA.0.0.0").value;
          if(pass != confPass)
          { 
              alert('El numero de cuenta debe ser igual en ambos campos.');
          }
