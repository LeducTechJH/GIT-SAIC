     ...
     extends Form
{
   ...
   *
   */
  public INGRESOS_LOV_FR ( )
  {
    super ( );
    this.setName ( "INGRESOS_LOV_FR" );

    Debug.println ( Debug.TRACE, "INGRESOS_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/INGRESOS_LOV_FR.jdp" );
