 ...
 */
public class BUSCAR_SOLICITUD_ADL
     extends ADL
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
  ...
  protected void process ( ParameterSet ps )
  {
    ...
    else
    {
        ...
        if ( ! Compare.equals ( STATUS, 0 ) ) 
        {
          ...
          this.app.returnTo ( "BUSCAR_SOLICITUD_PKT" ); if ( true ) return;
        }
        ...
        if ( Compare.equals ( STATUS, 0 ) ) 
        {
      	  this.app.NUMERO_SOLICITUD_GBL = this.dm.getFieldString( this.dm.get ( "IMPORTADOS_SIBIF_DSD" ), "NUMERO_SOLICITUD" );
          this.app.SSN_JEFE_FAM_GBL = this.dm.getFieldDouble ( this.dm.get ( "IMPORTADOS_SIBIF_DSD" ), "SEGURO_SOCIAL_JEFE_FAM" );
    	...
    	if (Compare.equals(sw,0))
    	{
            ...
            if ( Compare.equals ( STATUS, 0 ) ) 
            {
          	  this.app.NUMERO_SOLICITUD_GBL = this.dm.getFieldString( this.dm.get ( "MV_SOLICITUDES_DSD" ), "NumeroSolicitud" );
