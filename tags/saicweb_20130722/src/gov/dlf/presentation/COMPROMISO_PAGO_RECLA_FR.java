 ...
 */
public class COMPROMISO_PAGO_RECLA_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public COMPROMISO_PAGO_RECLA_FR ( )
  {
    super ( );
    this.setName ( "COMPROMISO_PAGO_RECLA_FR" );

    Debug.println ( Debug.TRACE, "COMPROMISO_PAGO_RECLA_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/COMPROMISO_PAGO_RECLA_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "INFO_COMPROMISO_GP", new COMPROMISO_PAGO_RECLA_FR_INFO_COMPROMISO_GP_Arguments ( this ) );
  ...
  {
    this.registerListener ( "NUM_MESES_DEDUCIR", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CALCULAR_NUM_MESES_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "CANTIDAD_DEDUCIR", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; BEFORE_VISIT_CANT_DEDUCIR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "CANTIDAD_DEDUCIR", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; AFTER_VISIT_CANT_DEDUCIR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "FECHA_COMPROMISO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SALIR_FECHA_COMPROMISO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "PARK_PAGO", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CALCULAR_PAGO_RECLA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "PARK_PAGO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; ACTUALIZAR_STATUS_COMPROMISO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "INFO_COMPROMISO_GP", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; LLENAR_COMPROMISO_PAGO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class COMPROMISO_PAGO_RECLA_FR_INFO_COMPROMISO_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public COMPROMISO_PAGO_RECLA_FR_INFO_COMPROMISO_GP_Arguments ( Form form )
  {
    this.model = form;
