 ...
 */
public class REFERIR_CASO_RECLAMACIONES_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REFERIR_CASO_RECLAMACIONES_PKT ( )
  {
    super ( "REFERIR_CASO_RECLAMACIONES_PKT" );
   ...
   *
   */
  public REFERIR_CASO_RECLAMACIONES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REFERIR_CASO_RECLAMACIONES_PKT ( MDIFrame pFrame )
  {
    super ( "REFERIR_CASO_RECLAMACIONES_PKT", pFrame );
  ...
  {
    this.createComponents ( new REFERIR_CASO_FRAUDE_RECLA_FR ( ) );
   ...
   *
   */
  public static REFERIR_CASO_RECLAMACIONES_PKT get ( RallyApplication __app )
  {
    return ( REFERIR_CASO_RECLAMACIONES_PKT ) __app.getNewInstance ( "REFERIR_CASO_RECLAMACIONES_PKT" );
  }
  ...
  {
    REFERIR_CASO_RECLAMACIONES_PKT fSheet = REFERIR_CASO_RECLAMACIONES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REFERIR_CASO_RECLAMACIONES_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; AFTER_FORM_REFERIR_RECLA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; LLENAR_REFERIDO_FRAUDE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
