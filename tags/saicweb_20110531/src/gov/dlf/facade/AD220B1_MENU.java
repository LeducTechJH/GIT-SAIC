     ...
     extends ConfirmationMenu
{
  ...
  public AD220B1_MENU ( )
  {
    ...
    this.setActions ( new _AD220B1_MENU ( this ) );
    this.setHelpCode   ( "1" );
    this.setLegendCode ( "" );
   ...
   * @return
   */
  public static AD220B1_MENU get ( RallyApplication __app )
  {
    return ( AD220B1_MENU ) __app.getOrNew ( "AD220B1_MENU" );
  }
  ...
  {
    AD220B1_MENU confMenu = AD220B1_MENU.get ( __app );
  ...
  {
    return AD220B1_MENU.exec ( __app );
  }
