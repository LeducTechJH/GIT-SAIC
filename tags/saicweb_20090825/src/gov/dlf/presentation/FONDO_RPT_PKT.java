     ...
     extends FormSheet
{
   ...
   *
   */
  public FONDO_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public FONDO_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "FONDO_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new FONDO_RPT ( ) );
   ...
   *
   */
  public static FONDO_RPT_PKT get ( RallyApplication __app )
  {
    return ( FONDO_RPT_PKT ) __app.getNewInstance ( "FONDO_RPT_PKT" );
  }
  ...
  {
    FONDO_RPT_PKT fSheet = FONDO_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return FONDO_RPT_PKT.exec ( __app );
  }
