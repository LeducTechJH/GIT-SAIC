     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "TECNICO_LOV2" );

    Debug.println ( Debug.TRACE, "TECNICO_LOV2 - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TECNICO_LOV2.jdp" );
