 ...
 */
public class ESFUERZO2_INSERT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ESFUERZO2_INSERT_PKT ( )
  {
    super ( "ESFUERZO2_INSERT_PKT" );
   ...
   *
   */
  public ESFUERZO2_INSERT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ESFUERZO2_INSERT_PKT ( MDIFrame pFrame )
  {
    super ( "ESFUERZO2_INSERT_PKT", pFrame );
   ...
   *
   */
  public static ESFUERZO2_INSERT_PKT get ( RallyApplication __app )
  {
    return ( ESFUERZO2_INSERT_PKT ) __app.getNewInstance ( "ESFUERZO2_INSERT_PKT" );
  }
  ...
  {
    ESFUERZO2_INSERT_PKT fSheet = ESFUERZO2_INSERT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ESFUERZO2_INSERT_PKT.exec ( __app );
  }
