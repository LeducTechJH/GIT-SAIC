     ...
     extends Form
{
   ...
   *
   */
  public SERVICIO_LOV_FR ( )
  {
    super ( );
    this.setName ( "SERVICIO_LOV_FR" );

    Debug.println ( Debug.TRACE, "SERVICIO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SERVICIO_LOV_FR.jdp" );
