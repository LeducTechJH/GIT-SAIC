 ...
 */
public class SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_PKT ( )
  {
    super ( "SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_PKT" );
   ...
   *
   */
  public SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_PKT ( MDIFrame pFrame )
  {
    super ( "SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_PKT", pFrame );
  ...
  {
    this.createComponents ( new SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_FR ( ) );
   ...
   *
   */
  public static SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_PKT get ( RallyApplication __app )
  {
    return ( SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_PKT ) __app.getNewInstance ( "SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_PKT" );
  }
  ...
  {
    SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_PKT fSheet = SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SIBIF_CAL_GET_CITAS_FOR_TSS_PRE_PKT.exec ( __app );
  }
