     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS109_REC_PKT ( )
  {
    super ( "DSS109_REC_PKT" );
   ...
   *
   */
  public DSS109_REC_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS109_REC_PKT ( MDIFrame pFrame )
  {
    super ( "DSS109_REC_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS109_REC_FR ( ) );
   ...
   *
   */
  public static DSS109_REC_PKT get ( RallyApplication __app )
  {
    return ( DSS109_REC_PKT ) __app.getNewInstance ( "DSS109_REC_PKT" );
  }
  ...
  {
    DSS109_REC_PKT fSheet = DSS109_REC_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS109_REC_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; DSS109_REC_BFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
