 ...
 */
public class INFORMACION_REFER_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INFORMACION_REFER_PRINT_PKT ( )
  {
    super ( "INFORMACION_REFER_PRINT_PKT" );
   ...
   *
   */
  public INFORMACION_REFER_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INFORMACION_REFER_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "INFORMACION_REFER_PRINT_PKT", pFrame );
   ...
   *
   */
  public static INFORMACION_REFER_PRINT_PKT get ( RallyApplication __app )
  {
    return ( INFORMACION_REFER_PRINT_PKT ) __app.getNewInstance ( "INFORMACION_REFER_PRINT_PKT" );
  }
  ...
  {
    INFORMACION_REFER_PRINT_PKT fSheet = INFORMACION_REFER_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INFORMACION_REFER_PRINT_PKT.exec ( __app );
  }
...
/*	this.formModel.setListener ( JDataPanelListener.BEFORELOAD, new JDataPanelListener ( )
	{
	  ...
	  {
	    app.errorFlag = true; SIBIF_GET_RESERVED_CITA_ADL.exec ( app ); return app.errorFlag;
	  }
	} ); */
