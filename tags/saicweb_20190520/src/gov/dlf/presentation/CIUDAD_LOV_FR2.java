     ...
     extends Form
{
   ...
   *
   */
  public CIUDAD_LOV_FR2 ( )
  {
    super ( );
    this.setName ( "CIUDAD_LOV_FR2" );

    Debug.println ( Debug.TRACE, "CIUDAD_LOV_FR2 - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CIUDAD_LOV_FR.jdp" );
