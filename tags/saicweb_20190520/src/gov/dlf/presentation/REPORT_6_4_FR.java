     ...
     extends Form
{
   ...
   *
   */
  public REPORT_6_4_FR ( )
  {
    super ( );
    this.setName ( "REPORT_6_4_FR" );

    Debug.println ( Debug.TRACE, "REPORT_6_4_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REPORT_6_4_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "INPUT_START_DATE", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; REPORT_6_4_ADL.exec ( app ); return app.errorFlag;
      }
    } );
