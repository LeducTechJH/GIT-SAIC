     ...
     extends FormSheet
{
   ...
   *
   */
  public SEL_SSN_PTRA_PKT ( )
  {
    super ( "SEL_SSN_PTRA_PKT" );
   ...
   *
   */
  public SEL_SSN_PTRA_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SEL_SSN_PTRA_PKT ( MDIFrame pFrame )
  {
    super ( "SEL_SSN_PTRA_PKT", pFrame );
  ...
  {
    this.createComponents ( new SEL_SSN_PTRA_FR ( ) );
   ...
   *
   */
  public static SEL_SSN_PTRA_PKT get ( RallyApplication __app )
  {
    return ( SEL_SSN_PTRA_PKT ) __app.getNewInstance ( "SEL_SSN_PTRA_PKT" );
  }
  ...
  {
    SEL_SSN_PTRA_PKT fSheet = SEL_SSN_PTRA_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SEL_SSN_PTRA_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SEL_SSN_PTRA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
