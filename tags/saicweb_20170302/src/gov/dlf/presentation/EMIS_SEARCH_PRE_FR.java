 ...
 */
public class EMIS_SEARCH_PRE_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public EMIS_SEARCH_PRE_FR ( )
  {
    super ( );
    this.setName ( "EMIS_SEARCH_PRE_FR" );

    Debug.println ( Debug.TRACE, "EMIS_SEARCH_PRE_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/EMIS_SEARCH_PRE_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "FINISH_ACTION", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      { 
        app.errorFlag = true; EMIS_SEARCH_ADL.exec ( app ); return app.errorFlag;    
      }
    } );
  }
}
