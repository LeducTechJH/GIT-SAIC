     ...
     extends FormSheet
{
   ...
   *
   */
  public ORG_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ORG_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "ORG_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new ORG_RPT ( ) );
   ...
   *
   */
  public static ORG_RPT_PKT get ( RallyApplication __app )
  {
    return ( ORG_RPT_PKT ) __app.getNewInstance ( "ORG_RPT_PKT" );
  }
  ...
  {
    ORG_RPT_PKT fSheet = ORG_RPT_PKT.get ( __app );
    fSheet.execute ( null );
