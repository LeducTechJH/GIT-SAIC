     ...
     extends FormSheet
{
   ...
   *
   */
  public CUIDO_SEARCH_PKT ( )
  {
    super ( "CUIDO_SEARCH_PKT" );
   ...
   *
   */
  public CUIDO_SEARCH_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CUIDO_SEARCH_PKT ( MDIFrame pFrame )
  {
    super ( "CUIDO_SEARCH_PKT", pFrame );
  ...
  {
    this.createComponents ( new CUIDO_SEARCH_FR ( ) );
   ...
   *
   */
  public static CUIDO_SEARCH_PKT get ( RallyApplication __app )
  {
    return ( CUIDO_SEARCH_PKT ) __app.getNewInstance ( "CUIDO_SEARCH_PKT" );
  }
  ...
  {
    CUIDO_SEARCH_PKT fSheet = CUIDO_SEARCH_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CUIDO_SEARCH_PKT.exec ( __app );
  }
