 ...
 */
public class BUSCAR_POR_SOUNDEX_PEDIR_APELLIDOS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public BUSCAR_POR_SOUNDEX_PEDIR_APELLIDOS_PKT ( )
  {
    super ( "BUSCAR_POR_SOUNDEX_PEDIR_APELLIDOS_PKT" );
   ...
   *
   */
  public BUSCAR_POR_SOUNDEX_PEDIR_APELLIDOS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public BUSCAR_POR_SOUNDEX_PEDIR_APELLIDOS_PKT ( MDIFrame pFrame )
  {
    super ( "BUSCAR_POR_SOUNDEX_PEDIR_APELLIDOS_PKT", pFrame );
   ...
   *
   */
  public static BUSCAR_POR_SOUNDEX_PEDIR_APELLIDOS_PKT get ( RallyApplication __app )
  {
    return ( BUSCAR_POR_SOUNDEX_PEDIR_APELLIDOS_PKT ) __app.getNewInstance ( "BUSCAR_POR_SOUNDEX_PEDIR_APELLIDOS_PKT" );
  }
  ...
  {
    BUSCAR_POR_SOUNDEX_PEDIR_APELLIDOS_PKT fSheet = BUSCAR_POR_SOUNDEX_PEDIR_APELLIDOS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return BUSCAR_POR_SOUNDEX_PEDIR_APELLIDOS_PKT.exec ( __app );
  }
