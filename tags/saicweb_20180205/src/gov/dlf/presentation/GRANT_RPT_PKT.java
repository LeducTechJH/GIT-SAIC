     ...
     extends FormSheet
{
   ...
   *
   */
  public GRANT_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GRANT_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "GRANT_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new GRANT_RPT ( ) );
   ...
   *
   */
  public static GRANT_RPT_PKT get ( RallyApplication __app )
  {
    return ( GRANT_RPT_PKT ) __app.getNewInstance ( "GRANT_RPT_PKT" );
  }
  ...
  {
    GRANT_RPT_PKT fSheet = GRANT_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GRANT_RPT_PKT.exec ( __app );
  }
