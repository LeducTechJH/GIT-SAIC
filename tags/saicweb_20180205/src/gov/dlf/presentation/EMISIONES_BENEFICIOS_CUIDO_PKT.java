 ...
 */
public class EMISIONES_BENEFICIOS_CUIDO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public EMISIONES_BENEFICIOS_CUIDO_PKT ( )
  {
    super ( "EMISIONES_BENEFICIOS_CUIDO_PKT" );
   ...
   *
   */
  public EMISIONES_BENEFICIOS_CUIDO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public EMISIONES_BENEFICIOS_CUIDO_PKT ( MDIFrame pFrame )
  {
    super ( "EMISIONES_BENEFICIOS_CUIDO_PKT", pFrame );
  ...
  {
    this.createComponents ( new EMISIONES_BENEFICIOS_CUIDO_FRM ( ) );
   ...
   *
   */
  public static EMISIONES_BENEFICIOS_CUIDO_PKT get ( RallyApplication __app )
  {
    return ( EMISIONES_BENEFICIOS_CUIDO_PKT ) __app.getNewInstance ( "EMISIONES_BENEFICIOS_CUIDO_PKT" );
  }
  ...
  {
	  EMISIONES_BENEFICIOS_CUIDO_PKT fSheet = EMISIONES_BENEFICIOS_CUIDO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return EMISIONES_BENEFICIOS_CUIDO_PKT.exec ( __app );
  }
