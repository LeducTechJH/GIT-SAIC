	...
	protected void step1 ( ParameterSet ps )
	{
		...
		else
		{
			if ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) && Compare.ge (this.app.FCH_SOLIC_SERV_GBL, RallySpanishDatesParser.parseDateString ( "1-MAR-2016" ) ) && ( Compare.equals ( this.app.AUTORIZADA_GBL, "N" ) ))  
			{
				...
				else if (Compare.ge (this.app.FCH_SOLIC_SERV_GBL, RallySpanishDatesParser.parseDateString ( "5-FEB-2018" ) )
	...
	protected void step9 ( ParameterSet ps )
	{
			...
			//if ( Compare.equals ( this.app.COD_SERV_GBL, "PANED" )   || this.condition_17 )
		{
			...
			else
			{
				...
				{
					BENEFICIO = this.dm.getFieldDouble ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "VLR_BENEFICIO_MAXIMO" );
					if (Compare.ge (this.app.FCH_SOLIC_SERV_GBL, RallySpanishDatesParser.parseDateString ( "5-FEB-2018" ) )
							 && Compare.le (this.app.FCH_SOLIC_SERV_GBL, RallySpanishDatesParser.parseDateString ( "28-FEB-2018" ) )	) 								
					{					
	                   BENEFICIO_TEMP = this.dm.getFieldDouble ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "VLR_BENEFICIO_MAXIMO" )-this.dm.getFieldDouble ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "AUMENTO" );
					}                   
					else 
					{
		                BENEFICIO_TEMP = this.dm.getFieldDouble ( this.dm.get ( "BENEFICIOS_PAN_RO_DSD" ), "VLR_BENEFICIO_MAXIMO" );
