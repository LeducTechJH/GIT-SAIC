 ...
 */
public class TRANSFER_COPY_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TRANSFER_COPY_PKT ( )
  {
    super ( "TRANSFER_COPY_PKT" );
   ...
   *
   */
  public TRANSFER_COPY_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TRANSFER_COPY_PKT ( MDIFrame pFrame )
  {
    super ( "TRANSFER_COPY_PKT", pFrame );
  ...
  {
    this.createComponents ( new TRANSFER_COPY_FR ( ) );
   ...
   *
   */
  public static TRANSFER_COPY_PKT get ( RallyApplication __app )
  {
    return ( TRANSFER_COPY_PKT ) __app.getNewInstance ( "TRANSFER_COPY_PKT" );
  }
  ...
  {
    TRANSFER_COPY_PKT fSheet = TRANSFER_COPY_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TRANSFER_COPY_PKT.exec ( __app );
  }
