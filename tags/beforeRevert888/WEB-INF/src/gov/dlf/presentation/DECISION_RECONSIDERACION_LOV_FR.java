 ...
 */
public class DECISION_RECONSIDERACION_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public DECISION_RECONSIDERACION_LOV_FR ( )
  {
    super ( );
    this.setName ( "DECISION_RECONSIDERACION_LOV_FR" );

    Debug.println ( Debug.TRACE, "DECISION_RECONSIDERACION_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DECISION_RECONSIDERACION_LOV_FR.jdp" );
