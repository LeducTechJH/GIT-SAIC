 ...
 */
public class MANTENIMIENTO_SERVICIO_REC_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_SERVICIO_REC_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_SERVICIO_REC_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_SERVICIO_REC_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_SERVICIO_REC_FR.jdp" );
