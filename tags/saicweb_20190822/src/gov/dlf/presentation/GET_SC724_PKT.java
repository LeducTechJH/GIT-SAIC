     ...
     extends FormSheet
{
   ...
   *
   */
  public GET_SC724_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GET_SC724_PKT ( MDIFrame pFrame )
  {
    super ( "GET_SC724_PKT", pFrame );
  ...
  {
    this.createComponents ( new GET_SC724_FR ( ) );
   ...
   *
   */
  public static GET_SC724_PKT get ( RallyApplication __app )
  {
    return ( GET_SC724_PKT ) __app.getNewInstance ( "GET_SC724_PKT" );
  }
  ...
  {
    GET_SC724_PKT fSheet = GET_SC724_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GET_SC724_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SC724_PERSONA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
