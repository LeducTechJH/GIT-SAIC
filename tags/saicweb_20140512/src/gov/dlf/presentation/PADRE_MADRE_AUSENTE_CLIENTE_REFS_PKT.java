 ...
 */
public class PADRE_MADRE_AUSENTE_CLIENTE_REFS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PADRE_MADRE_AUSENTE_CLIENTE_REFS_PKT ( )
  {
    super ( "PADRE_MADRE_AUSENTE_CLIENTE_REFS_PKT" );
   ...
   *
   */
  public PADRE_MADRE_AUSENTE_CLIENTE_REFS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PADRE_MADRE_AUSENTE_CLIENTE_REFS_PKT ( MDIFrame pFrame )
  {
    super ( "PADRE_MADRE_AUSENTE_CLIENTE_REFS_PKT", pFrame );
  ...
  {
    this.createComponents ( new PADRE_MADRE_AUSENTE_CLIENTE_REFS_FR ( ) );
   ...
   *
   */
  public static PADRE_MADRE_AUSENTE_CLIENTE_REFS_PKT get ( RallyApplication __app )
  {
    return ( PADRE_MADRE_AUSENTE_CLIENTE_REFS_PKT ) __app.getNewInstance ( "PADRE_MADRE_AUSENTE_CLIENTE_REFS_PKT" );
  }
  ...
  {
    PADRE_MADRE_AUSENTE_CLIENTE_REFS_PKT fSheet = PADRE_MADRE_AUSENTE_CLIENTE_REFS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PADRE_MADRE_AUSENTE_CLIENTE_REFS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; PADRE_MADRE_AUSENTE_REFS_PAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
