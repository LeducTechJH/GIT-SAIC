 ...
 */
public class CALENDARIO_TEC_SIBIF2_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CALENDARIO_TEC_SIBIF2_FR ( )
  {
    super ( );
    this.setName ( "CALENDARIO_TEC_SIBIF2_FR" );

    Debug.println ( Debug.TRACE, "CALENDARIO_TEC_SIBIF2_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CALENDARIO_TEC_SIBIF2_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
	...
	this.registerListener ( "CALENDARIO_TEC_SIBIF2_FR", JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
	{
	...
	/*
    this.registerListener ( "ANSWER", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; TRANSFER_COPY_ADL.exec ( app ); return app.errorFlag;
      }
    } );*/
  }
}
