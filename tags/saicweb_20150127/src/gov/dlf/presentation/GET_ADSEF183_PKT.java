     ...
     extends FormSheet
{
   ...
   *
   */
  public GET_ADSEF183_PKT ( )
  {
    super ( "GET_ADSEF183_PKT" );
   ...
   *
   */
  public GET_ADSEF183_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GET_ADSEF183_PKT ( MDIFrame pFrame )
  {
    super ( "GET_ADSEF183_PKT", pFrame );
  ...
  {
    this.createComponents ( new GET_ADSEF183_FR ( ) );
   ...
   *
   */
  public static GET_ADSEF183_PKT get ( RallyApplication __app )
  {
    return ( GET_ADSEF183_PKT ) __app.getNewInstance ( "GET_ADSEF183_PKT" );
  }
  ...
  {
    GET_ADSEF183_PKT fSheet = GET_ADSEF183_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GET_ADSEF183_PKT.exec ( __app );
  }
