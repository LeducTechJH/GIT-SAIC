 ...
 */
public class GEN_FACT_ELEG_AEC_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_FACT_ELEG_AEC_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_FACT_ELEG_AEC_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_FACT_ELEG_AEC_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_FACT_ELEG_AEC_LOV_FR.jdp" );
