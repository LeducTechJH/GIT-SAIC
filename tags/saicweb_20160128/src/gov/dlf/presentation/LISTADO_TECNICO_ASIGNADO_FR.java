 ...
 */
public class LISTADO_TECNICO_ASIGNADO_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public LISTADO_TECNICO_ASIGNADO_FR ( )
  {
    super ( );
    this.setName ( "LISTADO_TECNICO_ASIGNADO_FR" );

    Debug.println ( Debug.TRACE, "LISTADO_TECNICO_ASIGNADO_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/LISTADO_TECNICO_ASIGNADO_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "LISTADO_TECNICO_ASIGNADO_GP", new LISTADO_TECNICO_ASIGNADO_FR_LISTADO_TECNICO_ASIGNADO_GP_Arguments ( this ) );
  ...
  public void setObjectEvents ( )
  {
    ...
    this.registerListener ( "PARK", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CLEAR_FLECHA_ASIGN_TECNICO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "PARK", JDataPanelListener.HOTKEYPRESS, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SAVE_ASIGNADO_TECNICO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class LISTADO_TECNICO_ASIGNADO_FR_LISTADO_TECNICO_ASIGNADO_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public LISTADO_TECNICO_ASIGNADO_FR_LISTADO_TECNICO_ASIGNADO_GP_Arguments ( Form form )
  {
    this.model = form;
