     ...
     extends Form
{
   ...
   *
   */
  public SERV_CUIDO_FRM ( )
  {
    super ( );
    this.setName ( "SERV_CUIDO_FRM" );

    Debug.println ( Debug.TRACE, "SERV_CUIDO_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SERV_CUIDO_FRM.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "FAM_JEFE_GP", new SERV_CUIDO_FRM_FAM_JEFE_GP_Arguments ( this ) );
    this.setArguments ( "SERV_INFO_GP", new SERV_CUIDO_FRM_SERV_INFO_GP_Arguments ( this ) );

    this.setObjectEvents ( );

    field = ( JDataPanelField ) this.getInDepth ( "RMO_NUCLEO" );
    field.setValueProvider ( new SERV_CUIDO_FRM_RMO_NUCLEOProvider ( this ) );

    calculator = new SERV_CUIDO_FRM_OTRA_LOCALCalculator ( this );
  ...
  public void setObjectEvents ( )
  {
	    this.registerListener ( "NUCLEO_PARK", JDataPanelListener.HOTKEYPRESS, new JDataPanelListener ( )
	    {
	      ...
	      {
	        app.errorFlag = true; SOLIC_SERV_CUIDO_SELECT_LF_ADL.exec ( app ); return app.errorFlag;
	      }
	    } );
  }
}
 ...
 *
 */
class SERV_CUIDO_FRM_FAM_JEFE_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public SERV_CUIDO_FRM_FAM_JEFE_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class SERV_CUIDO_FRM_SERV_INFO_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public SERV_CUIDO_FRM_SERV_INFO_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class SERV_CUIDO_FRM_RMO_NUCLEOProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public SERV_CUIDO_FRM_RMO_NUCLEOProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class SERV_CUIDO_FRM_OTRA_LOCALCalculator implements ICalculator
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public SERV_CUIDO_FRM_OTRA_LOCALCalculator ( Form form )
  {
    this.model = form;
  }
