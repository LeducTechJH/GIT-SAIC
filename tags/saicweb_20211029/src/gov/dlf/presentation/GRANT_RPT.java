     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "GRANT_RPT" );

    Debug.println ( Debug.TRACE, "GRANT_RPT - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GRANT_RPT.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new GRANT_RPT_FECHAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "USUARIO" );
    field.setValueProvider ( new GRANT_RPT_USUARIOProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new GRANT_RPT_OFICINAProvider ( this ) );
 ...
 *
 */
class GRANT_RPT_FECHAProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public GRANT_RPT_FECHAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class GRANT_RPT_USUARIOProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public GRANT_RPT_USUARIOProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class GRANT_RPT_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public GRANT_RPT_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
