     ...
     extends Form
{
   ...
   *
   */
  public REPORT_DSS171_RP ( )
  {
    super ( );
    this.setName ( "REPORT_DSS171_RP" );

    Debug.println ( Debug.TRACE, "REPORT_DSS171_RP - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REPORT_DSS171_RP.jdp" );
