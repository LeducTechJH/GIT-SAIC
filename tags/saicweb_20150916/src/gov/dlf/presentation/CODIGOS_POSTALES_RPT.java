 ...
 */
public class CODIGOS_POSTALES_RPT
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CODIGOS_POSTALES_RPT ( )
  {
    super ( );
    this.setName ( "CODIGOS_POSTALES_RPT" );

    Debug.println ( Debug.TRACE, "CODIGOS_POSTALES_RPT - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CODIGOS_POSTALES_RPT.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new CODIGOS_POSTALES_RPT_FECHAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "USUARIO" );
    field.setValueProvider ( new CODIGOS_POSTALES_RPT_USUARIOProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new CODIGOS_POSTALES_RPT_OFICINAProvider ( this ) );
 ...
 *
 */
class CODIGOS_POSTALES_RPT_FECHAProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public CODIGOS_POSTALES_RPT_FECHAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class CODIGOS_POSTALES_RPT_USUARIOProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CODIGOS_POSTALES_RPT_USUARIOProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class CODIGOS_POSTALES_RPT_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CODIGOS_POSTALES_RPT_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
