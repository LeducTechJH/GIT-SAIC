     ...
     extends FormSheet
{
   ...
   *
   */
  public SC1218_MENU_PKT ( )
  {
    super ( "SC1218_MENU_PKT" );
   ...
   *
   */
  public SC1218_MENU_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SC1218_MENU_PKT ( MDIFrame pFrame )
  {
    super ( "SC1218_MENU_PKT", pFrame );
  ...
  {
    this.createComponents ( new SC1218_MENU_FR ( ) );
   ...
   *
   */
  public static SC1218_MENU_PKT get ( RallyApplication __app )
  {
    return ( SC1218_MENU_PKT ) __app.getNewInstance ( "SC1218_MENU_PKT" );
  }
  ...
  {
    SC1218_MENU_PKT fSheet = SC1218_MENU_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SC1218_MENU_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SC1218_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
