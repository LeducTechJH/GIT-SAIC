...
public class DETERMINAR_ELEGIBILIDAD_LIHEAP extends ADL {
	...
	public DataStore LIHEAP_LIMITS_DSD = null;
	public String exceptionTitle = "DETERM LIHEAP";

	public static void setOPEN_ID(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).OPEN_ID = value
				.getDouble();
	}

	public static void setOPEN2_ID(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).OPEN2_ID = value
				.getDouble();
	}

	public static void setSTATUS_CODE(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS_CODE = value
				.getDouble();
	}

	public static void setSTATUS2_CODE(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS2_CODE = value
				.getDouble();
	}

	public static double getOPEN_ID(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).OPEN_ID;
	}

	public static Double getOPEN_IDDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).OPEN_ID);
	}
	...
	public static void setOPEN_ID(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).OPEN_ID = ((Double) value)
				.doubleValue();
	}

	public static double getOPEN2_ID(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).OPEN2_ID;
	}

	public static Double getOPEN2_IDDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).OPEN2_ID);
	}
	...
	public static void setOPEN2_ID(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).OPEN2_ID = ((Double) value).doubleValue();
	}

	public static double getSTATUS_CODE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS_CODE;
	}

	public static Double getSTATUS_CODEDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS_CODE);
	}
	...
	public static void setSTATUS_CODE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS_CODE = ((Double) value).doubleValue();
	}

	public static double getSTATUS2_CODE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS2_CODE;
	}

	public static Double getSTATUS2_CODEDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS2_CODE);
	}
	...
	public static void setSTATUS2_CODE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS2_CODE = ((Double) value).doubleValue();
	}

	public static double getSTATUS3_CODE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS3_CODE;
	}

	public static Double getSTATUS3_CODEDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS3_CODE);
	}

	public static void setSTATUS3_CODE(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS3_CODE = value;
	}

	public static void setSTATUS3_CODE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS3_CODE = ((Double) value).doubleValue();
	}

	public static double getSTATUS4_CODE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS4_CODE;
	}

	public static Double getSTATUS4_CODEDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS4_CODE);
	}

	public static void setSTATUS4_CODE(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS4_CODE = value;
	}

	public static void setSTATUS4_CODE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS4_CODE = ((Double) value).doubleValue();
	}

	public static double getSTATUS5_CODE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS5_CODE;
	}

	public static Double getSTATUS5_CODEDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS5_CODE);
	}

	public static void setSTATUS5_CODE(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS5_CODE = value;
	}

	public static void setSTATUS5_CODE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS5_CODE = ((Double) value).doubleValue();
	}

	public static double getSTATUS6_CODE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS6_CODE;
	}

	public static Double getSTATUS6_CODEDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS6_CODE);
	}

	public static void setSTATUS6_CODE(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS6_CODE = value;
	}

	public static void setSTATUS6_CODE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).STATUS6_CODE = ((Double) value).doubleValue();
	}

	/**  */
	public static double getINGRESOS_NUCLEO(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).INGRESOS_NUCLEO;
	}

	/**  */
	public static Double getINGRESOS_NUCLEODouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).INGRESOS_NUCLEO);
	}

	/**  */
	public static void setINGRESOS_NUCLEO(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).INGRESOS_NUCLEO = value;
	}

	/**  */
	public static void setINGRESOS_NUCLEO(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).INGRESOS_NUCLEO = ((Double) value).doubleValue();
	}

	public static double getBENEINCA(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).BENEINCA;
	}

	public static Double getBENEINCADouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).BENEINCA);
	}

	public static void setBENEINCA(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).BENEINCA = value;
	}

	public static void setBENEINCA(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).BENEINCA = ((Double) value).doubleValue();
	}

	public static void setRECURSOS_ACUM(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RECURSOS_ACUM = value
				.getDouble();
	}

	public static double getRECURSOS_ACUM(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RECURSOS_ACUM;
	}

	public static Double getRECURSOS_ACUMDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RECURSOS_ACUM);
	}
	...
	public static void setRECURSOS_ACUM(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RECURSOS_ACUM = ((Double) value).doubleValue();
	}

	public static double getRECURSOS_LIQUIDOS(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RECURSOS_LIQUIDOS;
	}

	public static Double getRECURSOS_LIQUIDOSDouble(RallyApplication __app) {
		return new Double(((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
	...
	public static void setRECURSOS_LIQUIDOS(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RECURSOS_LIQUIDOS = value;
	}

	public static void setRECURSOS_LIQUIDOS(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RECURSOS_LIQUIDOS = ((Double) value).doubleValue();
	}

	public static void setRECURSOS_TOTAL(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RECURSOS_TOTAL = value
				.getDouble();
	}

	public static double getRECURSOS_TOTAL(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RECURSOS_TOTAL;
	}

	public static Double getRECURSOS_TOTALDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RECURSOS_TOTAL);
	}
	...
	public static void setRECURSOS_TOTAL(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RECURSOS_TOTAL = ((Double) value).doubleValue();
	}

	public static void setANCIANO(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).ANCIANO = value
				.getDouble();
	}

	public static double getANCIANO(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).ANCIANO;
	}

	public static Double getANCIANODouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).ANCIANO);
	}
	...
	public static void setANCIANO(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).ANCIANO = ((Double) value)
				.doubleValue();
	}

	public static void setANCIANO_COUNT(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).ANCIANO_COUNT = value
				.getDouble();
	}

	public static void setINCAPACITADO_COUNT(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).INCAPACITADO_COUNT = value
				.getDouble();
	}

	public static double getANCIANO_COUNT(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).ANCIANO_COUNT;
	}

	public static Double getANCIANO_COUNTDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).ANCIANO_COUNT);
	}
	...
	public static void setANCIANO_COUNT(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).ANCIANO_COUNT = ((Double) value).doubleValue();
	}

	public static double getMENOR_COUNT(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MENOR_COUNT;
	}

	public static Double getMENOR_COUNTDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MENOR_COUNT);
	}

	public static void setMENOR_COUNT(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MENOR_COUNT = value;
	}

	public static void setMENOR_COUNT(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MENOR_COUNT = ((Double) value).doubleValue();
	}

	public static double getMIEMBROS_FAMILIA_COUNT(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MIEMBROS_FAMILIA;
	}

	public static Double getMIEMBROS_FAMILIA_COUNTDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MIEMBROS_FAMILIA);
	}

	public static void setMIEMBROS_FAMILIA_COUNT(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MIEMBROS_FAMILIA = value;
	}

	public static void setMIEMBROS_FAMILIA_COUNT(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MIEMBROS_FAMILIA = ((Double) value).doubleValue();
	}

	public static double getINCAPACITADO_COUNT(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).INCAPACITADO_COUNT;
	}
	...
	public static void setINCAPACITADO_COUNT(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).INCAPACITADO_COUNT = ((Double) value).doubleValue();
	}
	...
	public static void setSERVICIOS_EMERGENCIA_DSD(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
	...
	public static DataStore getSERVICIOS2_DSD(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).SERVICIOS2_DSD;
	}

	public static void setSERVICIOS2_DSD(RallyApplication __app, DataStore value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).SERVICIOS2_DSD = value;
	}
	...
	public static String getSERVICIO_STATUS(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).SERVICIO_STATUS;
	}

	public static void setSERVICIO_STATUS(RallyApplication __app, String value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).SERVICIO_STATUS = value;
	}
	...
	public static String getRAZON(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RAZON;
	}

	public static void setRAZON(RallyApplication __app, String value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RAZON = value;
	}

	public static void setRAZON(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).RAZON = (String) value;
	}

	public static Date getNULL_DATE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).NULL_DATE;
	}

	public static void setNULL_DATE(RallyApplication __app, Date value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).NULL_DATE = value;
	}

	public static void setNULL_DATE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).NULL_DATE = (Date) value;
	}

	public static Date getFCH_CERRADO(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).FCH_CERRADO;
	}

	public static void setFCH_CERRADO(RallyApplication __app, Date value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).FCH_CERRADO = value;
	}
	...
	public static double getSERVICIO_BENEFICIO(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).SERVICIO_BENEFICIO;
	}
	...
	public static void setSERVICIO_BENEFICIO(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).SERVICIO_BENEFICIO = ((Double) value).doubleValue();
	}

	public static double getLIHEAP_INCOME_MAX(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).LIHEAP_INCOME_MAX;
	}
	...
	public static void setLIHEAP_INCOME_MAX(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).LIHEAP_INCOME_MAX = value;
	}

	public static void setLIHEAP_INCOME_MAX(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).LIHEAP_INCOME_MAX = ((Double) value).doubleValue();
	}

	public static double getEDAD_IND(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).EDAD_IND;
	}

	public static Double getEDAD_INDDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).EDAD_IND);
	}

	public static void setEDAD_IND(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).EDAD_IND = value;
	}

	public static void setEDAD_IND(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).EDAD_IND = ((Double) value).doubleValue();
	}

	public static Double getINCA_FLGDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).INCA_FLG);
	}

	public static void setINCA_FLG(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).INCA_FLG = value;
	}

	public static void setINCA_FLG(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).INCA_FLG = ((Double) value).doubleValue();
	}

	public static double getMENOR_FLG(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MENOR_FLG;
	}

	public static Double getMENOR_FLGDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MENOR_FLG);
	}

	public static void setMENOR_FLG(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MENOR_FLG = value;
	}

	public static void setMENOR_FLG(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MENOR_FLG = ((Double) value).doubleValue();
	}

	public static double getBENEFICIO(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).BENEFICIO;
	}

	public static Double getBENEFICIODouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).BENEFICIO);
	}

	public static void setBENEFICIO(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).BENEFICIO = value;
	}

	public static void setBENEFICIO(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).BENEFICIO = ((Double) value).doubleValue();
	}

	public static double getCANTIDAD_AUTO(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).CANTIDAD_AUTO;
	}

	public static Double getCANTIDAD_AUTODouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).CANTIDAD_AUTO);
	}

	public static void setCANTIDAD_AUTO(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).CANTIDAD_AUTO = value;
	}

	public static void setCANTIDAD_AUTO(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).CANTIDAD_AUTO = ((Double) value).doubleValue();
	}

	public static double getMENOR(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MENOR;
	}

	public static Double getMENORDouble(RallyApplication __app) {
		return new Double(((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MENOR);
	}

	public static void setMENOR(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MENOR = value;
	}

	public static void setMENOR(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).MENOR = ((Double) value)
				.doubleValue();
	}

	public static DataStore getLIHEAP_INCOME_DSD(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).LIHEAP_INCOME_DSD;
	}

	public static void setLIHEAP_INCOME_DSD(RallyApplication __app, DataStore value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app.getADL(DETERMINAR_ELEGIBILIDAD_LIHEAP.class)).LIHEAP_INCOME_DSD = value;
	}

	public static void setLIHEAP_INCOME_DSD(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_LIHEAP) __app
	...
	protected void process(ParameterSet ps) {
		...
		case 2: {
			this.currentStep++;
			this.step2(this.keyParms);
			break;
		}
		case 3: {
			this.currentStep++;
			this.step3(this.keyParms);
			break;
		}
		case 4: {
			this.currentStep++;
			this.step4(this.keyParms);
			break;
		}
		default: {
			this.currentStep = 0;
	...
	protected void step0(ParameterSet ps) {
		...
		LIHEAP_LIMITS_DSD = this.dm.create("LIHEAP_LIMITS_DSD");
		OPEN9_ID = LIHEAP_LIMITS_DSD.getId();
	...
	protected void step1(ParameterSet ps) {
		...
		while (Compare.equals(STATUS4_CODE, 0)) {
			if (Compare.equals(this.dm.getFieldString(this.dm.get("INGRESOS_NUCLEO_DSD"), "FLG_FRECUENCIA"), "S")) {
				INGRESOS_NUCLEO = MathService.plus(INGRESOS_NUCLEO,
						this.dm.getFieldDouble(this.dm.get("INGRESOS_NUCLEO_DSD"), "VLR_CANTIDAD_INGRESO") * 4.3);
			} else if (Compare.equals(this.dm.getFieldString(this.dm.get("INGRESOS_NUCLEO_DSD"), "FLG_FRECUENCIA"),
					"B")) {
				INGRESOS_NUCLEO = MathService.plus(INGRESOS_NUCLEO,
						TruncService.trunc(
								this.dm.getFieldDouble(this.dm.get("INGRESOS_NUCLEO_DSD"), "VLR_CANTIDAD_INGRESO"))
						* 2.15);
			} else if (Compare.equals(this.dm.getFieldString(this.dm.get("INGRESOS_NUCLEO_DSD"), "FLG_FRECUENCIA"),
					"Q")) {
				INGRESOS_NUCLEO = MathService.plus(INGRESOS_NUCLEO,
			...
			STATUS4_CODE = this.dm.nextRow(OPEN4_ID);
		}
		RECURSOS_ACUM = 0;
		RECURSOS_LIQUIDOS = 0;
		...
		if (!Compare.equals(STATUS3_CODE, 0)) {
			this.app.setError(1, STATUS3_CODE);
			this.doReturn();
			return;
		}
		...
		while (Compare.equals(STATUS3_CODE, 0)) {
			BENEINCA = 0;
			this.app.SS_IND_GBL = this.dm.getFieldDouble(this.dm.get("RECURSOS_NUCLEO_DSD"),
			...
			if ((!Compare.equals(
					this.dm.getFieldString(this.dm.get("RECURSOS_NUCLEO_DSD"), "COD_PARENTESCO_RELACION_SERV"), "RNBE"))
					&& (!Compare.equals(
							this.dm.getFieldString(this.dm.get("RECURSOS_NUCLEO_DSD"), "COD_PARENTESCO_RELACION_SERV"),
							"ACNE"))
					&& (!Compare.equals(
							this.dm.getFieldString(this.dm.get("RECURSOS_NUCLEO_DSD"), "COD_PARENTESCO_RELACION_SERV"),
							"****"))) {
				if ((!Compare.equals(this.dm.getFieldString(this.dm.get("RECURSOS_NUCLEO_DSD"), "COD_TIPO_RECURSO"),
						"EDIF"))
						&& (!Compare.equals(
								this.dm.getFieldString(this.dm.get("RECURSOS_NUCLEO_DSD"), "COD_TIPO_RECURSO"), "TECA"))
						&& (!Compare.equals(
								this.dm.getFieldString(this.dm.get("RECURSOS_NUCLEO_DSD"), "COD_TIPO_RECURSO"), "PERS"))
						&& (!Compare.equals(
								this.dm.getFieldString(this.dm.get("RECURSOS_NUCLEO_DSD"), "COD_TIPO_RECURSO"),
								"VEH2"))) {
					RECURSOS_LIQUIDOS = MathService.plus(RECURSOS_LIQUIDOS,
							this.dm.getFieldDouble(this.dm.get("RECURSOS_NUCLEO_DSD"), "VLR_CANTIDAD_RECURSO"));
				} else {
					RECURSOS_ACUM = MathService.plus(RECURSOS_ACUM,
							this.dm.getFieldDouble(this.dm.get("RECURSOS_NUCLEO_DSD"), "VLR_CANTIDAD_RECURSO"));
		...
		while (Compare.equals(STATUS_CODE, 0)) {
			this.app.SS_IND_GBL = this.dm.getFieldDouble(this.dm.get("NUCLEO_SERVICIO_DSD"),
					"SEGURO_SOCIAL_BENEFICIARIO");
			STATUS2_CODE = this.dm.reset(OPEN2_ID);
			this.dm.setField(this.dm.get("CLIENTES_READ_LOC_DSD"), "SEGURO_SOCIAL_CLIENTE", this.app.SS_IND_GBL);
			...
			if (Compare.equals(this.dm.getFieldDate(this.dm.get("CLIENTES_READ_LOC_DSD"), "FCH_NACIMIENTO"),
					NULL_DATE)) {
				EDAD_IND = 0;
			} else {
				EDAD_IND = DateUtil.monthsBetween(TruncService.lastDay(this.app.SYSTEM_DATE),
						this.dm.getFieldDate(this.dm.get("CLIENTES_READ_LOC_DSD"), "FCH_NACIMIENTO")) / 12;
			}
			if ((Compare.ge(EDAD_IND, 60)) && (!Compare.equals(
					this.dm.getFieldString(this.dm.get("NUCLEO_SERVICIO_DSD"), "COD_PARENTESCO_RELACION_SERV"),
					"NCAL"))) {
				ANCIANO = 1;
			}

			if ((Compare.lt(EDAD_IND, 18)) && (!Compare.equals(
					this.dm.getFieldString(this.dm.get("NUCLEO_SERVICIO_DSD"), "COD_PARENTESCO_RELACION_SERV"),
					"NCAL"))) {
				MENOR_FLG = 1.0;
			}
			...
			if ((Compare.equals(
					this.dm.getFieldString(this.dm.get("CLIENTES_READ_LOC_DSD"), "FLG_INCAPACIDAD_VERIFICADA"), "S"))
					&& (!Compare.equals(
							this.dm.getFieldString(this.dm.get("NUCLEO_SERVICIO_DSD"), "COD_PARENTESCO_RELACION_SERV"),
							"NCAL"))) {
				INCA_FLG = 1;
			...
			if ((Compare.equals(
					this.dm.getFieldString(this.dm.get("NUCLEO_SERVICIO_DSD"), "COD_PARENTESCO_RELACION_SERV"), "BNPR"))
					|| (Compare.equals(
							this.dm.getFieldString(this.dm.get("NUCLEO_SERVICIO_DSD"), "COD_PARENTESCO_RELACION_SERV"),
							"BNSC"))) {
		...
		String subprg = RallyStringService.subString(this.app.COD_SERV_GBL, 0, 4);
		LIHEAP_INCOME_MAX = 0;
		...
		this.dm.setField("LIHEAP_INCOME_DSD", "SUB_PROGRAMA", subprg);
		...
		if (Compare.ge(LIHEAP_INCOME_MAX, INGRESOS_NUCLEO)) {
			if (Compare.equals(this.app.COD_SERV_GBL, "LISE")) {
				CANTIDAD_AUTO = 0;
				...
				while (Compare.equals(STATUS8_CODE, 0)) {
					...
					STATUS8_CODE = this.dm.update(OPEN8_ID);
					STATUS8_CODE = this.dm.nextRow(OPEN8_ID);
				}
			}
			this._condition3 = true;
			if (Compare.equals(RallyStringService.subString(this.app.COD_SERV_GBL, 0, 4), "LICE") || Compare.equals(RallyStringService.subString(this.app.COD_SERV_GBL, 0, 4), "LISE") || Compare.equals(RallyStringService.subString(this.app.COD_SERV_GBL, 0, 4), "CLIM")) {
				CANTIDAD_AUTO = 0;
				STATUS7_CODE = this.dm.reset(OPEN7_ID);
				this.dm.setField("SERVICIOS_EMERGENCIA_DSD", "SEGURO_SOCIAL_JEFE_FAM", this.app.SS_JEFE_GBL);
				this.dm.setField("SERVICIOS_EMERGENCIA_DSD", "SEGURO_SOCIAL_JEFE_SERV", this.app.SS_SERV_GBL);
				this.dm.setField("SERVICIOS_EMERGENCIA_DSD", "COD_SERVICIO", this.app.COD_SERV_GBL);
				// this.dm.setField("SERVICIOS_EMERGENCIA_DSD", "RMO_OFICINA",
				// this.app.RMO_GBL);
				...
				// {
				// this. app.setError ("0", "La cantidad autorizada esta en 0,
				// favor verificar.");
				// }

				double anio = FormattingFactory.parseStringToDouble ( StringService.toStringValue  ( this.app.SYSTEM_DATE,"yyyy" ,StringService.Language.SPANISH ) );
				String ano_fiscal = StringService.toStringValue(anio);

/*				STATUS9_CODE = this.dm.reset(OPEN9_ID);
				this.dm.setField("LIHEAP_LIMITS_DSD", "TIPO_SERVICIO", this.app.COD_SERV_GBL);
				this.dm.setField("LIHEAP_LIMITS_DSD", "ANO_FISCAL", ano_fiscal);
				...
				if (Compare.equals(STATUS9_CODE, 0)) {
					if (Compare.ge(CANTIDAD_AUTO, this.dm.getFieldDouble(this.dm.get("LIHEAP_LIMITS_DSD"), "CANT_LIMITE"))) {
						CANTIDAD_AUTO = this.dm.getFieldDouble(this.dm.get("LIHEAP_LIMITS_DSD"), "CANT_LIMITE");
					}
				}
				else
				{
					this.app.setError("0", "No se encontraron valores en la tabla de límites.");
					this.doReturn();
				}
*/
				STATUS8_CODE = this.dm.reset(OPEN8_ID);
		...
		if (!this._condition3)
		 {
			if (Compare.equals(RallyStringService.subString(this.app.COD_SERV_GBL, 0, 4), "CLIM"))
					{
  		            RAZON = "EL INGRESO FAMILIAR EXCEDE EL 200% DE POBREZA";
					}
			else
...
//			STATUS9_CODE = this.dm.dbClose(OPEN9_ID);
		...
		} else if (Compare.equals(this.app.COD_SERV_GBL, "LICE1") && (!(Compare.equals(atrasos, "X")))) {
...
//			STATUS9_CODE = this.dm.dbClose(OPEN9_ID);
		...
		else if (Compare.equals(this.app.COD_SERV_GBL, "LICE1") && (Compare.equals(flg_mult, "X"))) {
...
//			STATUS9_CODE = this.dm.dbClose(OPEN9_ID);
	...
	protected void step4(ParameterSet ps) {
		if ((Compare.equals(this.app.DETERMINACION_FINAL_GBL, "N"))
				|| (Compare.equals(this.app.DETERMINACION_FINAL_GBL, "n"))) {
			this.doReturn();
			return;
		}
	
	     PSE_2_PRINT_PKT.exec(this.app);
         return;
	}
}
