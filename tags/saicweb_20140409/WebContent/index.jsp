...
function cmd ( commandText )
{
  ...
  if ( formFrame != null )
  {
    ...
    {
      finished = true;
      var url = "http://desempleo.trabajo.pr.gov/reclamacionsubsiguiente//default.aspx?scr=1366";
      var winTop = 100;
      var winLeft = 150;
    ...
    {
    	finished = true;
        var url = "http://10.201.11.6/certServicio.aspx";
        var winTop = 100;
        var winLeft = 150;
    ...
    {
    	finished = true;
        var url = "http://www.aeepr.com/certificaciones.asp";
        var winTop = 100;
        var winLeft = 150;
        var winHeight = screen.availHeight;
        var winWidth = 960;
