     ...
     extends FormSheet
{
   ...
   *
   */
  public SC776_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SC776_PKT ( MDIFrame pFrame )
  {
    super ( "SC776_PKT", pFrame );
  ...
  {
    this.createComponents ( new SC776_FR ( ) );
   ...
   *
   */
  public static SC776_PKT get ( RallyApplication __app )
  {
    return ( SC776_PKT ) __app.getNewInstance ( "SC776_PKT" );
  }
  ...
  {
    SC776_PKT fSheet = SC776_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; GET_SC776_SET_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SC776_CHECK_RSE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
