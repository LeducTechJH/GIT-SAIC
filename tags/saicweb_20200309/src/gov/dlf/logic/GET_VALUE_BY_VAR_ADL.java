	...
	extends ADL
{
	...
	public static boolean TSS_NAME_AUTO_CP (RallyApplication app)
	{
	    ...
	    dm.setField ( TECNICO_LOV_DSD, "ID_TECNICO", app.form ( "CONTRATOS_CUIDO_PRINT_FR" ).getDoubleItem ( "ID_TECNICO_AUTORIZA" ) );
	    ...
	    {
	    	NAME = dm.getFieldString ( dm.get ( "TECNICO_LOV_DSD" ), "DSC_NOMBRE" ) + " " + dm.getFieldString ( dm.get ( "TECNICO_LOV_DSD" ), "DSC_APELLIDO_PATERNO" );
	        app.form ( "CONTRATOS_CUIDO_PRINT_FR" ).setItem ( "SUPERVISOR", NAME  );
	    }
