     ...
     extends ADL
{
  ...
  {
    ( ( TRANSFER_COPY_ADL ) __app.getADL ( TRANSFER_COPY_ADL.class ) ).TODAY = value.getDate ( );
  }  
  ...
  {
    return ( ( TRANSFER_COPY_ADL ) __app.getADL ( TRANSFER_COPY_ADL.class ) ).TODAY;
  }
  ...
  {
    ( ( TRANSFER_COPY_ADL ) __app.getADL ( TRANSFER_COPY_ADL.class ) ).TODAY = value;
  }
  ...
  {
    ( ( TRANSFER_COPY_ADL ) __app.getADL ( TRANSFER_COPY_ADL.class ) ).TODAY = ( Date ) value;
  }
...
protected void process ( ParameterSet ps )
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    while ( Compare.equals ( CLIENTES_LOC_STAT, 0 )  )
    {
      ...
      this.dm.setField ( this.dm.get ( "CLIENTES_LOC_DSD" ), "FCH_STATUS", TODAY );
...
{Crea Clientes LOC}            
            ...
            clientes_loc_dsd.fch_status:=today;
