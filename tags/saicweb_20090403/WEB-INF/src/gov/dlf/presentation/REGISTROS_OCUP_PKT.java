 ...
 */
public class REGISTROS_OCUP_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public REGISTROS_OCUP_PKT ( )
  {
    super ( "REGISTROS_OCUP_PKT" );
   ...
   *
   */
  public REGISTROS_OCUP_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REGISTROS_OCUP_PKT ( MDIFrame pFrame )
  {
    super ( "REGISTROS_OCUP_PKT", pFrame );
  ...
  {
    this.createComponents ( new REGISTROS_OCUP_RP ( ) );
   ...
   *
   */
  public static REGISTROS_OCUP_PKT get ( RallyApplication __app )
  {
    return ( REGISTROS_OCUP_PKT ) __app.getNewInstance ( "REGISTROS_OCUP_PKT" );
  }
  ...
  {
    REGISTROS_OCUP_PKT fSheet = REGISTROS_OCUP_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REGISTROS_OCUP_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_PARTREG_MENU.exec ( app, null );
 return app.errorFlag;
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; REGISTRO_OCUP_BEF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
