     ...
     extends Form
{
   ...
   *
   */
  public GET_SC1072_FR ( )
  {
    super ( );
    this.setName ( "GET_SC1072_FR" );

    Debug.println ( Debug.TRACE, "GET_SC1072_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_SC1072_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SC1072_PERSONA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
