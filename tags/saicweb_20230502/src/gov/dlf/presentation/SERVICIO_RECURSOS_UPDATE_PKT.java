 ...
 */
public class SERVICIO_RECURSOS_UPDATE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SERVICIO_RECURSOS_UPDATE_PKT ( )
  {
    super ( "SERVICIO_RECURSOS_UPDATE_PKT" );
   ...
   *
   */
  public SERVICIO_RECURSOS_UPDATE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SERVICIO_RECURSOS_UPDATE_PKT ( MDIFrame pFrame )
  {
    super ( "SERVICIO_RECURSOS_UPDATE_PKT", pFrame );
   ...
   *
   */
  public static SERVICIO_RECURSOS_UPDATE_PKT get ( RallyApplication __app )
  {
    return ( SERVICIO_RECURSOS_UPDATE_PKT ) __app.getNewInstance ( "SERVICIO_RECURSOS_UPDATE_PKT" );
  }
  ...
  {
    SERVICIO_RECURSOS_UPDATE_PKT fSheet = SERVICIO_RECURSOS_UPDATE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SERVICIO_RECURSOS_UPDATE_PKT.exec ( __app );
  }
