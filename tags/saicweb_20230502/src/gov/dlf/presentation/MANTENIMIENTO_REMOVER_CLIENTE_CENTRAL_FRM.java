 ...
 */
public class MANTENIMIENTO_REMOVER_CLIENTE_CENTRAL_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_REMOVER_CLIENTE_CENTRAL_FRM ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_REMOVER_CLIENTE_CENTRAL_FRM" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_REMOVER_CLIENTE_CENTRAL_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_REMOVER_CLIENTE_CENTRAL_FRM.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "SEGURO_SOCIAL_CLIENTE", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CENTRAL_REMOVER_CLIENTE_AF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
