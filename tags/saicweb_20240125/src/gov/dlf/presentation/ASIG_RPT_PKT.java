     ...
     extends FormSheet
{
   ...
   *
   */
  public ASIG_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ASIG_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "ASIG_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new ASIG_RPT ( ) );
   ...
   *
   */
  public static ASIG_RPT_PKT get ( RallyApplication __app )
  {
    return ( ASIG_RPT_PKT ) __app.getNewInstance ( "ASIG_RPT_PKT" );
  }
  ...
  {
    ASIG_RPT_PKT fSheet = ASIG_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ASIG_RPT_PKT.exec ( __app );
  }
