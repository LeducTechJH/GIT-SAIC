 ...
 */
public class GEN_RAZON_BAJA_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_RAZON_BAJA_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_RAZON_BAJA_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_RAZON_BAJA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_RAZON_BAJA_LOV_FR.jdp" );
