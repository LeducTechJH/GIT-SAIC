 ...
 */
public class GET_COMPROMISO_PAGO_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GET_COMPROMISO_PAGO_FR ( )
  {
    super ( );
    this.setName ( "GET_COMPROMISO_PAGO_FR" );

    Debug.println ( Debug.TRACE, "GET_COMPROMISO_PAGO_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_COMPROMISO_PAGO_FR.jdp" );
  ...
  {
    this.registerListener ( "FECHA_ID", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; AFTER_PARK_COMP_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; GET_PARK_COMPROMISO_PAGO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
