 ...
 */
public class RESULTADO_BUSCAR_SOLICITUD_2_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public RESULTADO_BUSCAR_SOLICITUD_2_PKT ( )
  {
    super ( "RESULTADO_BUSCAR_SOLICITUD_2_PKT" );
   ...
   *
   */
  public RESULTADO_BUSCAR_SOLICITUD_2_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RESULTADO_BUSCAR_SOLICITUD_2_PKT ( MDIFrame pFrame )
  {
    super ( "RESULTADO_BUSCAR_SOLICITUD_2_PKT", pFrame );
  ...
  {
    this.createComponents ( new RESULTADO_BUSCAR_SOLICITUD_2_FR ( ) );
   ...
   *
   */
  public static RESULTADO_BUSCAR_SOLICITUD_2_PKT get ( RallyApplication __app )
  {
    return ( RESULTADO_BUSCAR_SOLICITUD_2_PKT ) __app.getNewInstance ( "RESULTADO_BUSCAR_SOLICITUD_2_PKT" );
  }
  ...
  {
    RESULTADO_BUSCAR_SOLICITUD_2_PKT fSheet = RESULTADO_BUSCAR_SOLICITUD_2_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RESULTADO_BUSCAR_SOLICITUD_2_PKT.exec ( __app );
  }
