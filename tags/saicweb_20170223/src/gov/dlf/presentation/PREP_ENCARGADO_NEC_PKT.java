 ...
 */
public class PREP_ENCARGADO_NEC_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PREP_ENCARGADO_NEC_PKT ( )
  {
    super ( "PREP_ENCARGADO_NEC_PKT" );
   ...
   *
   */
  public PREP_ENCARGADO_NEC_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PREP_ENCARGADO_NEC_PKT ( MDIFrame pFrame )
  {
    super ( "PREP_ENCARGADO_NEC_PKT", pFrame );
  ...
  {
    this.createComponents ( new PREP_ENCARGADO_NEC_FR ( ) );
   ...
   *
   */
  public static PREP_ENCARGADO_NEC_PKT get ( RallyApplication __app )
  {
    return ( PREP_ENCARGADO_NEC_PKT ) __app.getNewInstance ( "PREP_ENCARGADO_NEC_PKT" );
  }
  ...
  {
    PREP_ENCARGADO_NEC_PKT fSheet = PREP_ENCARGADO_NEC_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PREP_ENCARGADO_NEC_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; PREP_ENCARGADO_NEC_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
