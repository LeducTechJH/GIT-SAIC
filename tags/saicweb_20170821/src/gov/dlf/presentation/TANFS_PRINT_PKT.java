     ...
     extends FormSheet
{
   ...
   *
   */
  public TANFS_PRINT_PKT ( )
  {
    super ( "TANFS_PRINT_PKT" );
   ...
   *
   */
  public TANFS_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TANFS_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "TANFS_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new TANFS_FR ( ) );
   ...
   *
   */
  public static TANFS_PRINT_PKT get ( RallyApplication __app )
  {
    return ( TANFS_PRINT_PKT ) __app.getNewInstance ( "TANFS_PRINT_PKT" );
  }
  ...
  {
    TANFS_PRINT_PKT fSheet = TANFS_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TANFS_PRINT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; TANFS_PRINT_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
