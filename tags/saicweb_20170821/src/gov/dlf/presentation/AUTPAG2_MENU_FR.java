     ...
     extends Form
{
   ...
   *
   */
  public AUTPAG2_MENU_FR ( )
  {
    super ( );
    this.setName ( "AUTPAG2_MENU_FR" );

    Debug.println ( Debug.TRACE, "AUTPAG2_MENU_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/AUTPAG2_MENU_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new AUTPAG2_MENU_FR_DESDEProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "HASTA" );
    field.setValueProvider ( new AUTPAG2_MENU_FR_HASTAProvider ( this ) );
 ...
 *
 */
class AUTPAG2_MENU_FR_DESDEProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public AUTPAG2_MENU_FR_DESDEProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class AUTPAG2_MENU_FR_HASTAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public AUTPAG2_MENU_FR_HASTAProvider ( Form form )
  {
    this.model = form;
  }
