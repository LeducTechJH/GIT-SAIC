     ...
     extends Form
{
  ...
  {	    
	    ...
	    this.registerListener ( "CONTRATO_NINO_FRM", JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
	    {
	      public boolean eventFired ( String eventName )
	      {
	        app.errorFlag = true; CONTRATOS_CUIDO_PRINT_PKT.exec ( app, null ); return app.errorFlag;
	      }
	    } );
	    ...
	    this.registerListener ( "HASTA", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
	    {
	      public boolean eventFired ( String eventName )
	      {
