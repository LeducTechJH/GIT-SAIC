 ...
 */
public class CASOS_HISTO_RECLARETRO_RP
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CASOS_HISTO_RECLARETRO_RP ( )
  {
    super ( );
    this.setName ( "CASOS_HISTO_RECLARETRO_RP" );

    Debug.println ( Debug.TRACE, "CASOS_HISTO_RECLARETRO_RP - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CASOS_HISTO_RECLARETRO_RP.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    calculator = new CASOS_HISTO_RECLARETRO_RP_NOMBRECalculator ( this );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "SS_JEFE_SERV", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CASOS_HIST_RR_NOM_PPKT.exec ( app, null ); return app.errorFlag;
      }
    } );
    this.registerListener ( "SS_JEFE_SERV", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CASOS_HIST_RR_ALIST.exec ( app, null ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class CASOS_HISTO_RECLARETRO_RP_NOMBRECalculator implements ICalculator
{
  /**  */
  ...
  /**  */
  public CASOS_HISTO_RECLARETRO_RP_NOMBRECalculator ( Form form )
  {
    this.model = form;
  }
  ...
  public void calculate ( )
  {
    ...
    this.app.exec ( "CASOS_HIST_RR_NOM_PPKT" );
  }
}
