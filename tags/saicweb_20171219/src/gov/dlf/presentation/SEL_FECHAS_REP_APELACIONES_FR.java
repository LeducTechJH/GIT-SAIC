 ...
 */
public class SEL_FECHAS_REP_APELACIONES_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SEL_FECHAS_REP_APELACIONES_FR ( )
  {
    super ( );
    this.setName ( "SEL_FECHAS_REP_APELACIONES_FR" );

    Debug.println ( Debug.TRACE, "SEL_FECHAS_REP_APELACIONES_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SEL_FECHAS_REP_APELACIONES_FR.jdp" );
