 ...
 */
public class NOMBRE_GENERAL_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public NOMBRE_GENERAL_LOV_FR ( )
  {
    super ( );
    this.setName ( "NOMBRE_GENERAL_LOV_FR" );

    Debug.println ( Debug.TRACE, "NOMBRE_GENERAL_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/NOMBRE_GENERAL_LOV_FR.jdp" );
