 ...
 */
public class EMPLEOS_CLIENTE_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public EMPLEOS_CLIENTE_RO_PKT ( )
  {
    super ( "EMPLEOS_CLIENTE_RO_PKT" );
   ...
   *
   */
  public EMPLEOS_CLIENTE_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public EMPLEOS_CLIENTE_RO_PKT ( MDIFrame pFrame )
  {
    super ( "EMPLEOS_CLIENTE_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new EMPLEOS_CLIENTE_FR ( ) );
   ...
   *
   */
  public static EMPLEOS_CLIENTE_RO_PKT get ( RallyApplication __app )
  {
    return ( EMPLEOS_CLIENTE_RO_PKT ) __app.getNewInstance ( "EMPLEOS_CLIENTE_RO_PKT" );
  }
  ...
  {
    EMPLEOS_CLIENTE_RO_PKT fSheet = EMPLEOS_CLIENTE_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return EMPLEOS_CLIENTE_RO_PKT.exec ( __app );
  }
