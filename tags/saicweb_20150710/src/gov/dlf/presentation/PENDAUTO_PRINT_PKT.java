 ...
 */
public class PENDAUTO_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PENDAUTO_PRINT_PKT ( )
  {
    super ( "PENDAUTO_PRINT_PKT" );
   ...
   *
   */
  public PENDAUTO_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PENDAUTO_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "PENDAUTO_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new PENDAUTO_FR ( ) );
   ...
   *
   */
  public static PENDAUTO_PRINT_PKT get ( RallyApplication __app )
  {
    return ( PENDAUTO_PRINT_PKT ) __app.getNewInstance ( "PENDAUTO_PRINT_PKT" );
  }
  ...
  {
    PENDAUTO_PRINT_PKT fSheet = PENDAUTO_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PENDAUTO_PRINT_PKT.exec ( __app );
  }
