 ...
 */
public class CASOS_HIST_SERV_RP
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CASOS_HIST_SERV_RP ( )
  {
    super ( );
    this.setName ( "CASOS_HIST_SERV_RP" );

    Debug.println ( Debug.TRACE, "CASOS_HIST_SERV_RP - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CASOS_HIST_SERV_RP.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    calculator = new CASOS_HIST_SERV_RP_NOMBRECalculator ( this );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "SS_JEFE_SERV", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CASOS_HIST_SERV_NOM_PPKT.exec ( app, null ); return app.errorFlag;
      }
    } );
    this.registerListener ( "SS_JEFE_SERV", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CASOS_HIST_SERV_ALIST.exec ( app, null ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class CASOS_HIST_SERV_RP_NOMBRECalculator implements ICalculator
{
  /**  */
  ...
  /**  */
  public CASOS_HIST_SERV_RP_NOMBRECalculator ( Form form )
  {
    this.model = form;
  }
  ...
  public void calculate ( )
  {
    ...
    this.app.exec ( "CASOS_HIST_SERV_NOM_PPKT" );
  }
}
