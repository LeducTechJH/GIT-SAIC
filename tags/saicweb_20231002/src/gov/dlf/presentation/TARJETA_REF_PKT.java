     ...
     extends FormSheet
{
   ...
   *
   */
  public TARJETA_REF_PKT ( )
  {
    super ( "TARJETA_REF_PKT" );
   ...
   *
   */
  public TARJETA_REF_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TARJETA_REF_PKT ( MDIFrame pFrame )
  {
    super ( "TARJETA_REF_PKT", pFrame );
   ...
   *
   */
  public static TARJETA_REF_PKT get ( RallyApplication __app )
  {
    return ( TARJETA_REF_PKT ) __app.getNewInstance ( "TARJETA_REF_PKT" );
  }
  ...
  {
    TARJETA_REF_PKT fSheet = TARJETA_REF_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TARJETA_REF_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_TARREF_MENU.exec ( app, null );
