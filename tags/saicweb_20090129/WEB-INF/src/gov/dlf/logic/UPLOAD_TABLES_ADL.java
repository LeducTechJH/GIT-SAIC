     ...
     extends ADL
{
  ...
  protected void step2 ( ParameterSet ps )
  {
    ...
    {
    	/*---------------------------------------------------------*/
    	/* STEP1: Remove any existing HISTORY data for the CLIENTE */
    	/*---------------------------------------------------------*/
    	boolean noMoreRows;
    	while ( Compare.equals ( CLIENTES_READ_LOC_STATUS_CODE, 0 )  )
    	{
    		...
    		while ( Compare.equals ( noMoreRows, false ) )
    		{
    			...
    			DEDUCCIONES_CLIENTE_HIST_RW_STATUS_CODE  = getFirstRow ( DEDUCCIONES_CLIENTE_HIST_RW_DSD_ID );
    			if ( Compare.equals ( DEDUCCIONES_CLIENTE_HIST_RW_STATUS_CODE, 0 ) )
    			{
    				DEDUCCIONES_CLIENTE_HIST_RW_STATUS_CODE  = this.dm.delete ( DEDUCCIONES_CLIENTE_HIST_RW_DSD_ID );
    	...
    	/*---------------------------------------------------------*/
    	/* STEP2: Copy CLIENTES data to HISTORY                    */
    	/*---------------------------------------------------------*/
	    CLIENTES_READ_LOC_STATUS_CODE  = this.dm.reset ( CLIENTES_READ_LOC_DSD_ID );
	    this.dm.setField ( CLIENTES_READ_LOC_DSD, "SEGURO_SOCIAL_JEFE_FAMILIA", this.app.SS_JEFE_GBL );
	    CLIENTES_READ_LOC_STATUS_CODE  = getFirstRow ( CLIENTES_READ_LOC_DSD_ID );
    	...
    	/*---------------------------------------------------------*/
    	/* STEP3: Commit changes done to db                        */
    	/*---------------------------------------------------------*/
  ...
  private final double deleteRows(double DSD_ID, DataStore DSD)
  {
	...
	while ( Compare.equals ( STATUS_CODE, 0 ) )
	{
    	...
    	STATUS_CODE  = this.dm.update ( DSD );
