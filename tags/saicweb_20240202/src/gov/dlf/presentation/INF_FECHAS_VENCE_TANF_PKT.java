 ...
 */
public class INF_FECHAS_VENCE_TANF_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INF_FECHAS_VENCE_TANF_PKT ( )
  {
    super ( "INF_FECHAS_VENCE_TANF_PKT" );
   ...
   *
   */
  public INF_FECHAS_VENCE_TANF_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INF_FECHAS_VENCE_TANF_PKT ( MDIFrame pFrame )
  {
    super ( "INF_FECHAS_VENCE_TANF_PKT", pFrame );
   ...
   *
   */
  public static INF_FECHAS_VENCE_TANF_PKT get ( RallyApplication __app )
  {
    return ( INF_FECHAS_VENCE_TANF_PKT ) __app.getNewInstance ( "INF_FECHAS_VENCE_TANF_PKT" );
  }
  ...
  {
    INF_FECHAS_VENCE_TANF_PKT fSheet = INF_FECHAS_VENCE_TANF_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INF_FECHAS_VENCE_TANF_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_CASOS_VENCE_TANF_MENU.exec ( app, null );
