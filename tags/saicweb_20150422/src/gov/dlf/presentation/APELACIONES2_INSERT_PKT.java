 ...
 */
public class APELACIONES2_INSERT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public APELACIONES2_INSERT_PKT ( )
  {
    super ( "APELACIONES2_INSERT_PKT" );
   ...
   *
   */
  public APELACIONES2_INSERT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public APELACIONES2_INSERT_PKT ( MDIFrame pFrame )
  {
    super ( "APELACIONES2_INSERT_PKT", pFrame );
  ...
  {
    this.createComponents ( new APELACIONES2_FR ( ) );
   ...
   *
   */
  public static APELACIONES2_INSERT_PKT get ( RallyApplication __app )
  {
    return ( APELACIONES2_INSERT_PKT ) __app.getNewInstance ( "APELACIONES2_INSERT_PKT" );
  }
  ...
  {
    APELACIONES2_INSERT_PKT fSheet = APELACIONES2_INSERT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return APELACIONES2_INSERT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SEGURIDAD_APELACIONES2_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
