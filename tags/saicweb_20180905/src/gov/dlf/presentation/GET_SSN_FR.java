     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "GET_SSN_FR" );

    Debug.println ( Debug.TRACE, "GET_SSN_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_SSN_FR.jdp" );
  ...
  {
		// *** BEGIN MODS JOR 11/20/2008 ***
	    this.registerListener ( "SEGURO_SOCIAL", JDataPanelListener.VALIDATION, new JDataPanelListener ( )
	    {
	      public boolean eventFired ( String eventName )
	      {
	        app.errorFlag = true;
	        if ( Compare.le ( app.form ( "GET_SSN_FR" ).getDoubleItem ( "SEGURO_SOCIAL" ), 0 ) ) 
	        {
	        	app.errorFlag = false;
	        }
		...
		// *** END MODS JOR 11/20/2008 ***
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; IR_OR_MANT_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
