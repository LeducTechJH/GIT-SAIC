 ...
 */
public class TECNICO_RETRO_LOV_FR3
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TECNICO_RETRO_LOV_FR3 ( )
  {
    super ( );
    this.setName ( "TECNICO_RETRO_LOV_FR3" );

    Debug.println ( Debug.TRACE, "TECNICO_RETRO_LOV_FR3 - constructor" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "TECNICO_LOV", new TECNICO_RETRO_LOV_FR3_Arguments ( this ) );

    calculator = new TECNICO_RETRO_LOV_FR3_NOMBRE_TECNICOCalculator ( this );
 ...
 *
 */
class TECNICO_RETRO_LOV_FR3_NOMBRE_TECNICOCalculator implements ICalculator
{
  /**  */
  ...
  /**  */
  public TECNICO_RETRO_LOV_FR3_NOMBRE_TECNICOCalculator ( Form form )
  {
    this.model = form;
  }
  ...
  public void calculate ( )
  {
    ...
    RETRO_NOMBRE_TECNICO_ADL3.exec ( this.app, null );
  }
}
...
*
*/
class TECNICO_RETRO_LOV_FR3_Arguments extends JDataPanelGroupArguments
{
 protected Form model;
 protected SAIC_DMQ_ORA_Application app = null;

 public TECNICO_RETRO_LOV_FR3_Arguments ( Form form )
 {
   this.model = form;
