     ...
     extends Form
{
   ...
   *
   */
  public DSS170_MENU_FR ( )
  {
    super ( );
    this.setName ( "DSS170_MENU_FR" );

    Debug.println ( Debug.TRACE, "DSS170_MENU_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DSS170_MENU_FR.jdp" );
  ...
  {
    this.registerListener ( "DSS170_PROG", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; DSS170_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
