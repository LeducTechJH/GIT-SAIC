 ...
 */
public class RAZON_REFERIDO_FRAUDE_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public RAZON_REFERIDO_FRAUDE_LOV_FR ( )
  {
    super ( );
    this.setName ( "RAZON_REFERIDO_FRAUDE_LOV_FR" );

    Debug.println ( Debug.TRACE, "RAZON_REFERIDO_FRAUDE_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RAZON_REFERIDO_FRAUDE_LOV_FR.jdp" );
