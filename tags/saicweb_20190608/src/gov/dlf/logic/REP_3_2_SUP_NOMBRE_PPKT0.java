 ...
 */
public class REP_3_2_SUP_NOMBRE_PPKT0 
  implements IRegisteredObject 
{
   ...
   *
   */
  public REP_3_2_SUP_NOMBRE_PPKT0 ( )
  {
   ...
   *
   */
  public static REP_3_2_SUP_NOMBRE_PPKT0 get ( RallyApplication __app )
  {
    REP_3_2_SUP_NOMBRE_PPKT0 pp = ( REP_3_2_SUP_NOMBRE_PPKT0 ) __app.getNewInstance ( "REP_3_2_SUP_NOMBRE_PPKT0" );
    return pp;
  }
  ...
  {
    return REP_3_2_SUP_NOMBRE_PPKT0.exec ( __app );
  }
  ...
  {
    Debug.println ( Debug.TRACE, "REP_3_2_SUP_NOMBRE_PPKT0" );
    this.prepareParms ( );
  ...
  {
    this.app.form ( "REPORT_3_2_FR" ).setValue ( "ID_SUPERVISOR", this.parms.getDouble ( 0 ) );
    this.app.form ( "REPORT_3_2_FR" ).setValue ( "NOMBRE_COMPLETO", this.parms.getString ( 1 ) );
  }
  ...
  {
    this.parms.reset ( );
    this.parms.set ( this.app.form ( "REPORT_3_2_FR" ).getValue ( "ID_SUPERVISOR" ) );
    this.parms.set ( this.app.form ( "REPORT_3_2_FR" ).getValue ( "NOMBRE_COMPLETO" ) );
  }
