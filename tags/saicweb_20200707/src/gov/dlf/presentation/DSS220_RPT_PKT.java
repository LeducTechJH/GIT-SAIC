     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS220_RPT_PKT ( )
  {
    super ( "DSS220_RPT_PKT" );
   ...
   *
   */
  public DSS220_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS220_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "DSS220_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS220_RPT_FR ( ) );
   ...
   *
   */
  public static DSS220_RPT_PKT get ( RallyApplication __app )
  {
    return ( DSS220_RPT_PKT ) __app.getNewInstance ( "DSS220_RPT_PKT" );
  }
  ...
  {
    DSS220_RPT_PKT fSheet = DSS220_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS220_RPT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; DSS220_RPT_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
