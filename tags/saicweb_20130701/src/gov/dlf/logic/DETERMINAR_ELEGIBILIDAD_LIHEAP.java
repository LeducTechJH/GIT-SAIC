...
public class DETERMINAR_ELEGIBILIDAD_LIHEAP extends ADL {
	...
	protected void step1(ParameterSet ps) 
	{
	    ...
	    {
		      Debug.println ( Debug.EXCEPTION, this.exceptionTitle + "INGRESOS_NUCLEO_DSD Exception: " );
...
{
      Debug.println ( Debug.EXCEPTION, this.exceptionTitle + "RECURSOS_NUCLEO_DSD Exception: " );
      Debug.printStackTrace ( Debug.EXCEPTION, e );
}
		while (Compare.equals(STATUS_CODE, 0)) 
		{
		    ...
		    {
			      Debug.println ( Debug.EXCEPTION, this.exceptionTitle + "CLIENTE_AGENCIA_RO_DSD Exception: " );
			      Debug.printStackTrace ( Debug.EXCEPTION, e );
			}
			while (Compare.equals(STATUS_CODE, 0)) 
			{
	    ...
	    {
		      Debug.println ( Debug.EXCEPTION, this.exceptionTitle + "NUCLEO_SERVICIO_DSD Exception: " );
		      Debug.printStackTrace ( Debug.EXCEPTION, e );
		}
		while (Compare.equals(STATUS_CODE, 0)) 
		{
	    ...
	    {
		      Debug.println ( Debug.EXCEPTION, this.exceptionTitle + "LIHEAP_INCOME_DSD Exception: " );
		      Debug.printStackTrace ( Debug.EXCEPTION, e );
		}
				...
				if(Compare.gt(LIHEAP_INCOME_MAX, INGRESOS_NUCLEO))
				{
					if (Compare.equals (RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 4 ), "LICE" ))
					{
					    ...
					    {
						      Debug.println ( Debug.EXCEPTION, this.exceptionTitle + "SERVICIOS_EMERGENCIA_DSD Exception: " );
						      Debug.printStackTrace ( Debug.EXCEPTION, e );
						}
							...
							{
								this. app.setError ("0", "La cantidad autorizada no debe ser 0.");
								return;
							}
							//fact = CANTIDAD_AUTO / INGRESOS_NUCLEO;
								if(Compare.equals(this.app.COD_SERV_GBL,"LICE1")||Compare.equals(this.app.COD_SERV_GBL,"LICE3"))
								{
									if(Compare.ge(CANTIDAD_AUTO, 300))
									{
										CANTIDAD_AUTO = 300;
									}
								}
								...
								{
									if(Compare.ge(CANTIDAD_AUTO, 90))
									{
										CANTIDAD_AUTO = 90;
									}
								}
								...
								{
									if(Compare.ge(CANTIDAD_AUTO, 35))
									{
										CANTIDAD_AUTO = 35;
									}
								}
							    ...
							    {
								      Debug.println ( Debug.EXCEPTION, this.exceptionTitle + "SERVICIOS2_DSD Exception: " );
								      Debug.printStackTrace ( Debug.EXCEPTION, e );
								}
		...
		if (!this._condition3) 
		{
			...
			else 
			{
			    ...
			    {
				      Debug.println ( Debug.EXCEPTION, this.exceptionTitle + "SERVICIOS2_DSD 2 Exception: " );
				      Debug.printStackTrace ( Debug.EXCEPTION, e );
				}
				while (Compare.equals(STATUS2_CODE, 0)) 
				{
