 ...
 */
public class RECURSOS_CLIENTES_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public RECURSOS_CLIENTES_RO_PKT ( )
  {
    super ( "RECURSOS_CLIENTES_RO_PKT" );
   ...
   *
   */
  public RECURSOS_CLIENTES_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RECURSOS_CLIENTES_RO_PKT ( MDIFrame pFrame )
  {
    super ( "RECURSOS_CLIENTES_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new RECURSOS_CLIENTE_FR ( ) );
   ...
   *
   */
  public static RECURSOS_CLIENTES_RO_PKT get ( RallyApplication __app )
  {
    return ( RECURSOS_CLIENTES_RO_PKT ) __app.getNewInstance ( "RECURSOS_CLIENTES_RO_PKT" );
  }
  ...
  {
    RECURSOS_CLIENTES_RO_PKT fSheet = RECURSOS_CLIENTES_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RECURSOS_CLIENTES_RO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; REC_PAR2_ADL.exec ( app ); return app.errorFlag;
      }
    } );
