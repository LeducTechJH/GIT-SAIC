 ...
 */
public class LOV_MODO_PAGO_ADSEF220_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public LOV_MODO_PAGO_ADSEF220_FR ( )
  {
    super ( );
    this.setName ( "LOV_MODO_PAGO_ADSEF220_FR" );

    Debug.println ( Debug.TRACE, "LOV_MODO_PAGO_ADSEF220_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/LOV_MODO_PAGO_ADSEF220_FR.jdp" );
