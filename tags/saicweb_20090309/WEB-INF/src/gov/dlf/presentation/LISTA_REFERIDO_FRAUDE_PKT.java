 ...
 */
public class LISTA_REFERIDO_FRAUDE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public LISTA_REFERIDO_FRAUDE_PKT ( )
  {
    super ( "LISTA_REFERIDO_FRAUDE_PKT" );
   ...
   *
   */
  public LISTA_REFERIDO_FRAUDE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public LISTA_REFERIDO_FRAUDE_PKT ( MDIFrame pFrame )
  {
    super ( "LISTA_REFERIDO_FRAUDE_PKT", pFrame );
  ...
  {
    this.createComponents ( new LISTA_REFERIDO_FRAUDE_FRM ( ) );
   ...
   *
   */
  public static LISTA_REFERIDO_FRAUDE_PKT get ( RallyApplication __app )
  {
    return ( LISTA_REFERIDO_FRAUDE_PKT ) __app.getNewInstance ( "LISTA_REFERIDO_FRAUDE_PKT" );
  }
  ...
  {
    LISTA_REFERIDO_FRAUDE_PKT fSheet = LISTA_REFERIDO_FRAUDE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return LISTA_REFERIDO_FRAUDE_PKT.exec ( __app );
  }
