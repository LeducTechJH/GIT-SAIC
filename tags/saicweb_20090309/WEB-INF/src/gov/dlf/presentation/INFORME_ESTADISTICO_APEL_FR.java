 ...
 */
public class INFORME_ESTADISTICO_APEL_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public INFORME_ESTADISTICO_APEL_FR ( )
  {
    super ( );
    this.setName ( "INFORME_ESTADISTICO_APEL_FR" );

    Debug.println ( Debug.TRACE, "INFORME_ESTADISTICO_APEL_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/INFORME_ESTADISTICO_APEL_FR.jdp" );
