     ...
     extends FormSheet
{
   ...
   *
   */
  public RESUMEN_FULL_PCK ( )
  {
    super ( "RESUMEN_FULL_PCK" );
   ...
   *
   */
  public RESUMEN_FULL_PCK ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RESUMEN_FULL_PCK ( MDIFrame pFrame )
  {
    super ( "RESUMEN_FULL_PCK", pFrame );
  ...
  {
    this.createComponents ( new NUCLEO_FULL_REPORT_FRM ( ) );
   ...
   *
   */
  public static RESUMEN_FULL_PCK get ( RallyApplication __app )
  {
    return ( RESUMEN_FULL_PCK ) __app.getNewInstance ( "RESUMEN_FULL_PCK" );
  }
  ...
  {
    RESUMEN_FULL_PCK fSheet = RESUMEN_FULL_PCK.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RESUMEN_FULL_PCK.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; RESUMEN_FULL_VAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
