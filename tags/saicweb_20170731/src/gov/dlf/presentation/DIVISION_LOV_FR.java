     ...
     extends Form
{
   ...
   *
   */
  public DIVISION_LOV_FR ( )
  {
    super ( );
    this.setName ( "DIVISION_LOV_FR" );

    Debug.println ( Debug.TRACE, "DIVISION_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DIVISION_LOV_FR.jdp" );
