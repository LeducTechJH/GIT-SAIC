 ...
 */
public class SERV_SEARCH_PRE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SERV_SEARCH_PRE_PKT ( )
  {
    super ( "SERV_SEARCH_PRE_PKT" );
   ...
   *
   */
  public SERV_SEARCH_PRE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SERV_SEARCH_PRE_PKT ( MDIFrame pFrame )
  {
    super ( "SERV_SEARCH_PRE_PKT", pFrame );
  ...
  {
    this.createComponents ( new SERV_SEARCH_PRE_FR ( ) );
   ...
   *
   */
  public static SERV_SEARCH_PRE_PKT get ( RallyApplication __app )
  {
    return ( SERV_SEARCH_PRE_PKT ) __app.getNewInstance ( "SERV_SEARCH_PRE_PKT" );
  }
  ...
  {
    SERV_SEARCH_PRE_PKT fSheet = SERV_SEARCH_PRE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SERV_SEARCH_PRE_PKT.exec ( __app );
  }
