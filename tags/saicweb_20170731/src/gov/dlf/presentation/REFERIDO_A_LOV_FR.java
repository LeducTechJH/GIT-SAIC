 ...
 */
public class REFERIDO_A_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public REFERIDO_A_LOV_FR ( )
  {
    super ( );
    this.setName ( "REFERIDO_A_LOV_FR" );

    Debug.println ( Debug.TRACE, "REFERIDO_A_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REFERIDO_A_LOV_FR.jdp" );
