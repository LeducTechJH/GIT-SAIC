 ...
 */
public class LISTA_CAMBIO_OWNER_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public LISTA_CAMBIO_OWNER_FRM ( )
  {
    super ( );
    this.setName ( "LISTA_CAMBIO_OWNER_FRM" );

    Debug.println ( Debug.TRACE, "LISTA_CAMBIO_OWNER_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/LISTA_CAMBIO_OWNER_FRM.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "RECLAMACIONES_REFERIDAS_GRP", new LISTA_CAMBIO_OWNER_FRM_RECLAMACIONES_REFERIDAS_GRP_Arguments ( this ) );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "RECLA_REFE_PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; BEF_PARK_LISTA_RECLA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "RECLA_REFE_PARK", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; AFT_PARK_LISTA_RECLA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "RECLAMACIONES_REFERIDAS_GRP", JDataPanelListener.HOTKEYPRESS, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; BUSCAR_CAMBIO_OWNER_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class LISTA_CAMBIO_OWNER_FRM_RECLAMACIONES_REFERIDAS_GRP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public LISTA_CAMBIO_OWNER_FRM_RECLAMACIONES_REFERIDAS_GRP_Arguments ( Form form )
  {
    this.model = form;
