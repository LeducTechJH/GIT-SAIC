 ...
 */
public class CASOS_HIST_60MESES_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CASOS_HIST_60MESES_PKT ( )
  {
    super ( "CASOS_HIST_60MESES_PKT" );
   ...
   *
   */
  public CASOS_HIST_60MESES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CASOS_HIST_60MESES_PKT ( MDIFrame pFrame )
  {
    super ( "CASOS_HIST_60MESES_PKT", pFrame );
  ...
  {
    this.createComponents ( new CASOS_HIST_60MESES_RP ( ) );
   ...
   *
   */
  public static CASOS_HIST_60MESES_PKT get ( RallyApplication __app )
  {
    return ( CASOS_HIST_60MESES_PKT ) __app.getNewInstance ( "CASOS_HIST_60MESES_PKT" );
  }
  ...
  {
    CASOS_HIST_60MESES_PKT fSheet = CASOS_HIST_60MESES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CASOS_HIST_60MESES_PKT.exec ( __app );
  }
