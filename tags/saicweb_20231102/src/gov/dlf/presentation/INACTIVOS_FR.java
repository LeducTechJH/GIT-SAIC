     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "INACTIVOS_FR" );

    Debug.println ( Debug.TRACE, "INACTIVOS_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/INACTIVOS_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "SERVICIOS_GP", new INACTIVOS_FR_SERVICIOS_GP_Arguments ( this ) );

    this.setObjectEvents ( );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new INACTIVOS_FR_OFICINAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "FECHA" );
    field.setValueProvider ( new INACTIVOS_FR_FECHAProvider ( this ) );
 ...
 *
 */
class INACTIVOS_FR_SERVICIOS_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public INACTIVOS_FR_SERVICIOS_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class INACTIVOS_FR_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public INACTIVOS_FR_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class INACTIVOS_FR_FECHAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public INACTIVOS_FR_FECHAProvider ( Form form )
  {
    this.model = form;
  }
