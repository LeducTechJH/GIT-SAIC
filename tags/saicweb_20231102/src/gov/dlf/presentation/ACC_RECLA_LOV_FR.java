     ...
     extends Form
{
   ...
   *
   */
  public ACC_RECLA_LOV_FR ( )
  {
    super ( );
    this.setName ( "ACC_RECLA_LOV_FR" );

    Debug.println ( Debug.TRACE, "ACC_RECLA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ACC_RECLA_LOV_FR.jdp" );
