     ...
     extends FormSheet
{
   ...
   *
   */
  public CUIDO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CUIDO_PKT ( MDIFrame pFrame )
  {
    super ( "CUIDO_PKT", pFrame );
  ...
  {
    this.createComponents ( new CUIDO_FRM ( ) );
   ...
   *
   */
  public static CUIDO_PKT get ( RallyApplication __app )
  {
    return ( CUIDO_PKT ) __app.getNewInstance ( "CUIDO_PKT" );
  }
  ...
  {
    CUIDO_PKT fSheet = CUIDO_PKT.get ( __app );
    fSheet.execute ( null );
