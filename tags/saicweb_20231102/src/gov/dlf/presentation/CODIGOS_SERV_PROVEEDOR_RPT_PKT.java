 ...
 */
public class CODIGOS_SERV_PROVEEDOR_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CODIGOS_SERV_PROVEEDOR_RPT_PKT ( )
  {
    super ( "CODIGOS_SERV_PROVEEDOR_RPT_PKT" );
   ...
   *
   */
  public CODIGOS_SERV_PROVEEDOR_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CODIGOS_SERV_PROVEEDOR_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "CODIGOS_SERV_PROVEEDOR_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CODIGOS_SERV_PROVEEDOR_RPT ( ) );
   ...
   *
   */
  public static CODIGOS_SERV_PROVEEDOR_RPT_PKT get ( RallyApplication __app )
  {
    return ( CODIGOS_SERV_PROVEEDOR_RPT_PKT ) __app.getNewInstance ( "CODIGOS_SERV_PROVEEDOR_RPT_PKT" );
  }
  ...
  {
    CODIGOS_SERV_PROVEEDOR_RPT_PKT fSheet = CODIGOS_SERV_PROVEEDOR_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CODIGOS_SERV_PROVEEDOR_RPT_PKT.exec ( __app );
  }
