 ...
 */
public class CONTRATO_LIST_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CONTRATO_LIST_PKT ( )
  {
    super ( "CONTRATO_LIST_PKT" );
   ...
   *
   */
  public CONTRATO_LIST_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CONTRATO_LIST_PKT ( MDIFrame pFrame )
  {
    super ( "CONTRATO_LIST_PKT", pFrame );
  ...
  {
    this.createComponents ( new CONTRATO_LIST_FRM ( ) );
   ...
   *
   */
  public static CONTRATO_LIST_PKT get ( RallyApplication __app )
  {
    return ( CONTRATO_LIST_PKT ) __app.getNewInstance ( "CONTRATO_LIST_PKT" );
  }
  ...
  {
    CONTRATO_LIST_PKT fSheet = CONTRATO_LIST_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CONTRATO_LIST_PKT.exec ( __app );
  }
