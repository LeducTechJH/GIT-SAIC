     ...
     extends Form
{
   ...
   *
   */
  public GEN_PASOS_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_PASOS_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_PASOS_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_PASOS_LOV_FR.jdp" );
