...
extends ADL
{
	...
	protected void step0 ( ParameterSet ps )
	{
		...
		double mesgbl = FormattingFactory.parseStringToDouble ( StringService.toStringValue  ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getDateItem ( "FCH_SOLICITUD" ) ,"MM" ,StringService.Language.SPANISH ) );
		double aniogbl = FormattingFactory.parseStringToDouble ( StringService.toStringValue  ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getDateItem ( "FCH_SOLICITUD" ) ,"yyyy" ,StringService.Language.SPANISH ) );
		...
		( ! (Compare.equals ( this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem ( "FLG_EMERGENCIA" ), "E" ))   &&
				( 
						( ! ( ( Compare.equals ( this.fechaMesCorrecto,this.fechaRetro) )  && (Compare.equals (this.app.form ( "DETERMINAR_RECLAMACION_FR" ).getStringItem("RECLA_RETRO_TBL_RAZON_RETRO"),"CNFA") )))
				) &&
				(!Compare.equals (this.fechaMesCorrecto , this.fechaSolGlobal))
		) 
		{
