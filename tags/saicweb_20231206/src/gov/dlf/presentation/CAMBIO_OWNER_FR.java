     ...
     extends Form
{
   ...
   *
   */
  public CAMBIO_OWNER_FR ( )
  {
    super ( );
    this.setName ( "CAMBIO_OWNER_FR" );

    Debug.println ( Debug.TRACE, "CAMBIO_OWNER_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CAMBIO_OWNER_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "INFO_BENE_RECLA", new CAMBIO_OWNER_FR_INFO_BENE_RECLA_Arguments ( this ) );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "SS_DUENO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CAMBIO_OWNER_TABLAS_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "SS_DUENO", JDataPanelListener.AFTERVALUECHANGE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CAMBIO_OWNER_TABLAS_ADL.exec ( app ); return app.errorFlag;
    ...
    this.registerListener ( "INFO_BENE_RECLA", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SET_OWNER_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class CAMBIO_OWNER_FR_INFO_BENE_RECLA_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public CAMBIO_OWNER_FR_INFO_BENE_RECLA_Arguments ( Form form )
  {
    this.model = form;
