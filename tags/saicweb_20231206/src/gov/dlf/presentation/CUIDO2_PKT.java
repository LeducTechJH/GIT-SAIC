     ...
     extends FormSheet
{
   ...
   *
   */
  public CUIDO2_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CUIDO2_PKT ( MDIFrame pFrame )
  {
    super ( "CUIDO2_PKT", pFrame );
  ...
  {
    this.createComponents ( new CUIDO2_FRM ( ) );
   ...
   *
   */
  public static CUIDO2_PKT get ( RallyApplication __app )
  {
    return ( CUIDO2_PKT ) __app.getNewInstance ( "CUIDO2_PKT" );
  }
  ...
  {
    CUIDO2_PKT fSheet = CUIDO2_PKT.get ( __app );
    fSheet.execute ( null );
