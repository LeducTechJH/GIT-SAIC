...
extends ADL
{
	...
	public DataStore PTRA_EMPLEOS_DSD = null;
						...
						( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  )
				{
							...
							( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "BILV" ) ) )
					{
						...
						if  (exento)
						{
							...
							PTRA_ID = PTRA_EMPLEOS_DSD.getId ( );
							STATUS_PTRA = RallyDataStoreException.getDefault ( );

							STATUS_PTRA  = this.dm.reset ( PTRA_ID );

							this.dm.setField ( this.dm.get ( "PTRA_EMPLEOS_DSD" ), "SEGURO_SOCIAL_CLIENTE", this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ),"SEGURO_SOCIAL_BENEFICIARIO" ));
							...
							{
								if ( Compare.le(this.dm.getFieldDouble ( this.dm.get ( "PTRA_EMPLEOS_DSD" ),"REMANENTE" ), 5))
								{
...
//									SALARIO_TEMP = SALARIO_TEMP * 0;
								...
								else if ( Compare.ge(this.dm.getFieldDouble ( this.dm.get ( "PTRA_EMPLEOS_DSD" ),"REMANENTE" ), 6) && Compare.le(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ),"REMANENTE" ), 11))
								{
...
//									SALARIO_TEMP = SALARIO_TEMP - ( SALARIO_TEMP *.66 );
								...
								else if ( Compare.ge(this.dm.getFieldDouble ( this.dm.get ( "PTRA_EMPLEOS_DSD" ),"REMANENTE" ), 12) && Compare.le(this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ),"REMANENTE" ), 17))
								{
...
//									SALARIO_TEMP = SALARIO_TEMP - ( SALARIO_TEMP *.33 );
							...
							Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_TIPO_INGRESO" ), "ACUA" )  )
					{
						...
						if  (exento)
						{
							double SALARIO_TEMP = SALARIO;
							PTRA_EMPLEOS_DSD = this.dm.create ( "PTRA_EMPLEOS_DSD" );
							PTRA_ID = PTRA_EMPLEOS_DSD.getId ( );
							STATUS_PTRA = RallyDataStoreException.getDefault ( );
