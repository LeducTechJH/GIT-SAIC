     ...
     extends FormSheet
{
   ...
   *
   */
  public DIP_108_A_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DIP_108_A_PKT ( MDIFrame pFrame )
  {
    super ( "DIP_108_A_PKT", pFrame );
  ...
  {
    this.createComponents ( new DIP_108_A_FR ( ) );
   ...
   *
   */
  public static DIP_108_A_PKT get ( RallyApplication __app )
  {
    return ( DIP_108_A_PKT ) __app.getNewInstance ( "DIP_108_A_PKT" );
  }
  ...
  {
    DIP_108_A_PKT fSheet = DIP_108_A_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DIP_108_A_PKT.exec ( __app );
  }
