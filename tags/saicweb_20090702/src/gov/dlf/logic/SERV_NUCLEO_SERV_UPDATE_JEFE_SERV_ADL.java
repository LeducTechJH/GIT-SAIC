     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    if ( ( Compare.equals ( this.app.getInstanceMode ( ), "UPDATE" ) ) && ( ! Compare.equals ( this.app.SSJS_ANT_GBL, this.app.form ( "SERV_NUCLEO_SERV_FRM" ).getDoubleItem ( "SEGURO_SOCIAL_JEFE_SERV" )) )  ) 
    {
