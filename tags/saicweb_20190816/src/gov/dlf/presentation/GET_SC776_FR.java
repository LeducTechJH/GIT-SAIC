     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "GET_SC776_FR" );

    Debug.println ( Debug.TRACE, "GET_SC776_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_SC776_FR.jdp" );
  ...
  {
    this.registerListener ( "OPT", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SC776_CHECK_OPT_ADL.exec ( app ); return app.errorFlag;
      }
    } );
