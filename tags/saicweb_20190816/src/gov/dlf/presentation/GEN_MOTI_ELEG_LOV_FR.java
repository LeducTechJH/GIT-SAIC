 ...
 */
public class GEN_MOTI_ELEG_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_MOTI_ELEG_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_MOTI_ELEG_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_MOTI_ELEG_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_MOTI_ELEG_LOV_FR.jdp" );
