 ...
 */
public class PENDLECT_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PENDLECT_PRINT_PKT ( )
  {
    super ( "PENDLECT_PRINT_PKT" );
   ...
   *
   */
  public PENDLECT_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PENDLECT_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "PENDLECT_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new PENDLECT_FR ( ) );
   ...
   *
   */
  public static PENDLECT_PRINT_PKT get ( RallyApplication __app )
  {
    return ( PENDLECT_PRINT_PKT ) __app.getNewInstance ( "PENDLECT_PRINT_PKT" );
  }
  ...
  {
    PENDLECT_PRINT_PKT fSheet = PENDLECT_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PENDLECT_PRINT_PKT.exec ( __app );
  }
