 ...
 */
public class RR_LISTA_AUT_MNU_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public RR_LISTA_AUT_MNU_FR ( )
  {
    super ( );
    this.setName ( "RR_LISTA_AUT_MNU_FR" );

    Debug.println ( Debug.TRACE, "RR_LISTA_AUT_MNU_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RR_LISTA_AUT_MNU_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "RECLAMACIONES_REFERIDAS_GRP", new RR_LISTA_AUT_MNU_FR_RECLAMACIONES_REFERIDAS_GRP_Arguments ( this ) );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "RECLA_REFE_PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; RR_BEF_PARK_AUT_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "RECLA_REFE_PARK", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; RR_AFT_PARK_AUT_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "RECLAMACIONES_REFERIDAS_GRP", JDataPanelListener.HOTKEYPRESS, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; RR_AUT_REFERIDO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class RR_LISTA_AUT_MNU_FR_RECLAMACIONES_REFERIDAS_GRP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public RR_LISTA_AUT_MNU_FR_RECLAMACIONES_REFERIDAS_GRP_Arguments ( Form form )
  {
    this.model = form;
