 ...
 */
public class DETERMINACION_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public DETERMINACION_PKT ( )
  {
    super ( "DETERMINACION_PKT" );
   ...
   *
   */
  public DETERMINACION_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DETERMINACION_PKT ( MDIFrame pFrame )
  {
    super ( "DETERMINACION_PKT", pFrame );
   ...
   *
   */
  public static DETERMINACION_PKT get ( RallyApplication __app )
  {
    return ( DETERMINACION_PKT ) __app.getNewInstance ( "DETERMINACION_PKT" );
  }
  ...
  {
    DETERMINACION_PKT fSheet = DETERMINACION_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DETERMINACION_PKT.exec ( __app );
  }
