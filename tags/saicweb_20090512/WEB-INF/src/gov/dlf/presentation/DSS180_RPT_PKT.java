     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS180_RPT_PKT ( )
  {
    super ( "DSS180_RPT_PKT" );
   ...
   *
   */
  public DSS180_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS180_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "DSS180_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS180_RPT_FR ( ) );
   ...
   *
   */
  public static DSS180_RPT_PKT get ( RallyApplication __app )
  {
    return ( DSS180_RPT_PKT ) __app.getNewInstance ( "DSS180_RPT_PKT" );
  }
  ...
  {
    DSS180_RPT_PKT fSheet = DSS180_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS180_RPT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; DSS180_BFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
