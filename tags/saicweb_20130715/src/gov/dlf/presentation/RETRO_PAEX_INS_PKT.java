 ...
 */
public class RETRO_PAEX_INS_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public RETRO_PAEX_INS_PKT ( )
  {
    super ( "RETRO_PAEX_INS_PKT" );
   ...
   *
   */
  public RETRO_PAEX_INS_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RETRO_PAEX_INS_PKT ( MDIFrame pFrame )
  {
    super ( "RETRO_PAEX_INS_PKT", pFrame );
  ...
  {
    this.createComponents ( new RETRO_PAEX_FR ( ) );
   ...
   *
   */
  public static RETRO_PAEX_INS_PKT get ( RallyApplication __app )
  {
    return ( RETRO_PAEX_INS_PKT ) __app.getNewInstance ( "RETRO_PAEX_INS_PKT" );
  }
  ...
  {
    RETRO_PAEX_INS_PKT fSheet = RETRO_PAEX_INS_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RETRO_PAEX_INS_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; RETRO_PAEX_BFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
