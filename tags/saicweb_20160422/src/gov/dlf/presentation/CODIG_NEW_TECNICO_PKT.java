 ...
 */
public class CODIG_NEW_TECNICO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CODIG_NEW_TECNICO_PKT ( )
  {
    super ( "CODIG_NEW_TECNICO_PKT" );
   ...
   *
   */
  public CODIG_NEW_TECNICO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CODIG_NEW_TECNICO_PKT ( MDIFrame pFrame )
  {
    super ( "CODIG_NEW_TECNICO_PKT", pFrame );
  ...
  {
    this.createComponents ( new CODIGO_NEW_TECNICO_RPT ( ) );
   ...
   *
   */
  public static CODIG_NEW_TECNICO_PKT get ( RallyApplication __app )
  {
    return ( CODIG_NEW_TECNICO_PKT ) __app.getNewInstance ( "CODIG_NEW_TECNICO_PKT" );
  }
  ...
  {
    CODIG_NEW_TECNICO_PKT fSheet = CODIG_NEW_TECNICO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CODIG_NEW_TECNICO_PKT.exec ( __app );
  }
