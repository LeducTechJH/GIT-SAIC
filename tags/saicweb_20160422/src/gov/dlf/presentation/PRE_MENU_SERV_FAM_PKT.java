 ...
 */
public class PRE_MENU_SERV_FAM_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PRE_MENU_SERV_FAM_PKT ( )
  {
    super ( "PRE_MENU_SERV_FAM_PKT" );
   ...
   *
   */
  public PRE_MENU_SERV_FAM_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PRE_MENU_SERV_FAM_PKT ( MDIFrame pFrame )
  {
    super ( "PRE_MENU_SERV_FAM_PKT", pFrame );
  ...
  {
    this.createComponents ( new PRE_MENU_MANT_SERV_FR ( ) );
   ...
   *
   */
  public static PRE_MENU_SERV_FAM_PKT get ( RallyApplication __app )
  {
    return ( PRE_MENU_SERV_FAM_PKT ) __app.getNewInstance ( "PRE_MENU_SERV_FAM_PKT" );
  }
  ...
  {
    PRE_MENU_SERV_FAM_PKT fSheet = PRE_MENU_SERV_FAM_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PRE_MENU_SERV_FAM_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; PRE_MENU_MANT_SERV_BF_ADL.exec ( app ); return app.errorFlag;
      } 
    } );
