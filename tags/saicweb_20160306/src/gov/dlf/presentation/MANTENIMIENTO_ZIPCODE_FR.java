 ...
 */
public class MANTENIMIENTO_ZIPCODE_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_ZIPCODE_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_ZIPCODE_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_ZIPCODE_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_ZIPCODE_FR.jdp" );
