 ...
 */
public class SERVICIO_RECURSOS_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SERVICIO_RECURSOS_RO_PKT ( )
  {
    super ( "SERVICIO_RECURSOS_RO_PKT" );
   ...
   *
   */
  public SERVICIO_RECURSOS_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SERVICIO_RECURSOS_RO_PKT ( MDIFrame pFrame )
  {
    super ( "SERVICIO_RECURSOS_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_SERVICIO_REC_FR ( ) );
   ...
   *
   */
  public static SERVICIO_RECURSOS_RO_PKT get ( RallyApplication __app )
  {
    return ( SERVICIO_RECURSOS_RO_PKT ) __app.getNewInstance ( "SERVICIO_RECURSOS_RO_PKT" );
  }
  ...
  {
    SERVICIO_RECURSOS_RO_PKT fSheet = SERVICIO_RECURSOS_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SERVICIO_RECURSOS_RO_PKT.exec ( __app );
  }
