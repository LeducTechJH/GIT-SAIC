 ...
 */
public class AJUSTE_PAG_RPT_A_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public AJUSTE_PAG_RPT_A_FR ( )
  {
    super ( );
    this.setName ( "AJUSTE_PAG_RPT_A_FR" );

    Debug.println ( Debug.TRACE, "AJUSTE_PAG_RPT_A_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/AJUSTE_PAG_RPT_A_FR.jdp" );
  ...
  {
    this.registerListener ( "AJUSTE_HASTA", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; AJUSTE_PAG_RPT_A_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    // *** BEGIN MODS BY JOR 12/3/2008 ***
