     ...
     extends ADL
{
  ...
  protected void step2 ( ParameterSet ps )
  {
    ...
    if(Compare.equals(this.app.form("SERV_FAM_FRM").getStringItem("COD_SERVICIO"), "LICE") || Compare.equals(this.app.form("SERV_FAM_FRM").getStringItem("COD_SERVICIO"), "LISE"))
    {
    	...
    	{
    		double ServCountLICE = 0;
    		double ServCountLISE = 0;
    		if(Compare.equals(this.app.form("SERV_FAM_FRM").getStringItem("COD_SERVICIO"), "LICE"))
    		{
    			if (Compare.equals(this.dm.getFieldString(this.dm.get("SERV_LIHEAP_CHECK_DSD"), "COD_SERVICIO"),"LICE")) 
    			{
    				ServCountLICE = MathService.plus(ServCountLICE, 1);
    				if (Compare.gt(ServCountLICE, 0)) 
    				{
    					this.app.setError("0","Ya existe un Servicio de Crisis de Energía en esta familia.");
    					this.app.errorFlag = false;
    					return;
    				}
    			}
