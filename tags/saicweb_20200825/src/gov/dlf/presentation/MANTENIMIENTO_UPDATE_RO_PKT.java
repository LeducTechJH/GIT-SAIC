 ...
 */
public class MANTENIMIENTO_UPDATE_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_UPDATE_RO_PKT ( )
  {
    super ( "MANTENIMIENTO_UPDATE_RO_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_UPDATE_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_UPDATE_RO_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_UPDATE_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_INGRESO_FR ( ) );
   ...
   *
   */
  public static MANTENIMIENTO_UPDATE_RO_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_UPDATE_RO_PKT ) __app.getNewInstance ( "MANTENIMIENTO_UPDATE_RO_PKT" );
  }
  ...
  {
    MANTENIMIENTO_UPDATE_RO_PKT fSheet = MANTENIMIENTO_UPDATE_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_UPDATE_RO_PKT.exec ( __app );
  }
