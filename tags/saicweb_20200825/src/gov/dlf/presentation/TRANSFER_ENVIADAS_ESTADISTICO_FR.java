 ...
 */
public class TRANSFER_ENVIADAS_ESTADISTICO_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TRANSFER_ENVIADAS_ESTADISTICO_FR ( )
  {
    super ( );
    this.setName ( "TRANSFER_ENVIADAS_ESTADISTICO_FR" );

    Debug.println ( Debug.TRACE, "TRANSFER_ENVIADAS_ESTADISTICO_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TRANSFER_ENVIADAS_ESTADISTICO_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new TRANSFER_ENVIADAS_ESTADISTICO_FR_OFICINAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "FECHA" );
    field.setValueProvider ( new TRANSFER_ENVIADAS_ESTADISTICO_FR_FECHAProvider ( this ) );
...
*
*/
class TRANSFER_ENVIADAS_ESTADISTICO_FR_OFICINAProvider implements IObjectValueProvider
{
 /**  */
 ...
 /**  */
 public TRANSFER_ENVIADAS_ESTADISTICO_FR_OFICINAProvider ( Form form )
 {
   this.model = form;
 }
...
*
*/
class TRANSFER_ENVIADAS_ESTADISTICO_FR_FECHAProvider implements IObjectValueProvider
{
 /**  */
 protected Form model;
 /**  */
 ...
 /**  */
 public TRANSFER_ENVIADAS_ESTADISTICO_FR_FECHAProvider ( Form form )
 {
   this.model = form;
 }
