     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    {
      this.app.form ( "ADSEF_DIP_2T" ).setItem ( "X1", "X"  );
      this.app.form ( "ADSEF_DIP_2T" ).setItem ( "CANT_RECLA_RETRO", this.dm.getFieldDouble ( this.dm.get ( "RR_INSERT_RO_DSD" ), "CANTIDAD_RECLA_RETRO" )  );
      CANT_RECLA = this.dm.getFieldDouble ( this.dm.get ( "RR_INSERT_RO_DSD" ), "CANTIDAD_RECLA_RETRO" );
      this.app.form ( "ADSEF_DIP_2T" ).setItem ( "DESDE", this.dm.getFieldDate ( this.dm.get ( "RR_INSERT_RO_DSD" ), "DESDE" )  );
      this.app.form ( "ADSEF_DIP_2T" ).setItem ( "HASTA", this.dm.getFieldDate ( this.dm.get ( "RR_INSERT_RO_DSD" ), "HASTA" )  );
    }
    else if ( Compare.equals ( this.app.RR_ACCION_GBL, "RREC" ) ) 
    {
      this.app.form ( "ADSEF_DIP_2T" ).setItem ( "X2", "X"  );
      this.app.form ( "ADSEF_DIP_2T" ).setItem ( "CANT_RECLA_RETRO_2", this.dm.getFieldDouble ( this.dm.get ( "RR_INSERT_RO_DSD" ), "CANTIDAD_RECLA_RETRO" )  );
      CANT_RECLA = this.dm.getFieldDouble ( this.dm.get ( "RR_INSERT_RO_DSD" ), "CANTIDAD_RECLA_RETRO" );
      this.app.form ( "ADSEF_DIP_2T" ).setItem ( "DESDE_2", this.dm.getFieldDate ( this.dm.get ( "RR_INSERT_RO_DSD" ), "DESDE" )  );
      this.app.form ( "ADSEF_DIP_2T" ).setItem ( "HASTA_2", this.dm.getFieldDate ( this.dm.get ( "RR_INSERT_RO_DSD" ), "HASTA" )  );
    }
    else
    {
      this.doReturn ( );
    ...
    this.app.form ( "ADSEF_DIP_2T" ).setItem ( "RAZON_RETRO", this.dm.getFieldString ( this.dm.get ( "CLASI_RECLA_DSD" ), "DSC_LARGA" )  );
      ...
      if ( Compare.equals ( RallyStringService.subString ( this.dm.getFieldString ( this.dm.get ( "RR_INSERT_RO_DSD" ), "COD_SERVICIO" ), 0, 3 ), RallyStringService.subString ( this.app.COD_SERVICIO_GBL, 0, 3 ) ) ) 
      {
        if ( ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RR_INSERT_RO_DSD" ), "STATUS" ), "COMPRECL" ) ) && ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RR_INSERT_RO_DSD" ), "STATUS_AUTORIZACION" ), "AUTO" ) )  ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "RR_INSERT_RO_DSD" ), "STATUS" ), "AUTORIZA" ) ) ) 
        {
          ...
          if ( ! Compare.equals ( this.app.RR_ACCION_GBL, "RREC" ) ) 
          {
            ...
            {
              this.app.form ( "ADSEF_DIP_2T" ).setItem ( "CANT_RETRO", CANT_RECLA  );
              this.app.form ( "ADSEF_DIP_2T" ).setItem ( "BAL_RECLA", MathService.minus ( CANT_RECLA, this.dm.getFieldDouble ( this.dm.get ( "RR_INSERT_RO_DSD" ), "VLR_BALANCE" )  )  );
            }
            else
            {
              if ( ! Compare.equals ( CANT_RETRO, 0 ) ) 
              {
                this.app.form ( "ADSEF_DIP_2T" ).setItem ( "CANT_RETRO", this.dm.getFieldDouble ( this.dm.get ( "RR_INSERT_RO_DSD" ), "CANTIDAD_RECLA_RETRO" )  );
                this.app.form ( "ADSEF_DIP_2T" ).setItem ( "BAL_RECLA", MathService.minus ( this.app.form ( "ADSEF_DIP_2T" ).getDoubleItem ( "CANT_RECLA_RETRO" ), this.dm.getFieldDouble ( this.dm.get ( "RR_INSERT_RO_DSD" ), "CANTIDAD_RECLA_RETRO" )  )  );
              }
            }
          }
        }
    ...
    if ( Compare.equals ( this.app.RR_ACCION_GBL, "RREC" ) ) 
    {
      this.app.form ( "ADSEF_DIP_2T" ).setItem ( "PAGOS_EFECTUADOS", CANT_RETRO  );
      this.app.form ( "ADSEF_DIP_2T" ).setItem ( "BAL_RECLA_2", MathService.minus ( this.app.form ( "ADSEF_DIP_2T" ).getDoubleItem ( "CANT_RECLA_RETRO_2" ), CANT_RETRO  )  );
    }
    ...
    while ( Compare.equals ( RCD, 0 ) ) 
    {
      ...
      {
        this.app.form ( "ADSEF_DIP_2T" ).setItem ( "DIA", StringService.toStringValue  ( this.dm.getFieldDate ( this.dm.get ( "CALENDARIO_RECLA_RO_DSD" ), "FCH_ACTIVIDAD_HORA_MIN_CONTAC0" ) ,"dd" ,StringService.Language.SPANISH )  );
        this.app.form ( "ADSEF_DIP_2T" ).setItem ( "MES", StringService.toStringValue  ( this.dm.getFieldDate ( this.dm.get ( "CALENDARIO_RECLA_RO_DSD" ), "FCH_ACTIVIDAD_HORA_MIN_CONTAC0" ) ,"MMMM" ,StringService.Language.SPANISH )  );
        this.app.form ( "ADSEF_DIP_2T" ).setItem ( "ANO", StringService.toStringValue  ( this.dm.getFieldDate ( this.dm.get ( "CALENDARIO_RECLA_RO_DSD" ), "FCH_ACTIVIDAD_HORA_MIN_CONTAC0" ) ,"yyyy" ,StringService.Language.SPANISH )  );
        this.app.form ( "ADSEF_DIP_2T" ).setItem ( "HORA", StringService.toStringValue  ( this.dm.getFieldDate ( this.dm.get ( "CALENDARIO_RECLA_RO_DSD" ), "FCH_ACTIVIDAD_HORA_MIN_CONTAC0" ) ,"h" ,StringService.Language.SPANISH )  );
        this.app.form ( "ADSEF_DIP_2T" ).setItem ( "MINUTOS", StringService.toStringValue  ( this.dm.getFieldDate ( this.dm.get ( "CALENDARIO_RECLA_RO_DSD" ), "FCH_ACTIVIDAD_HORA_MIN_CONTAC0" ) ,"mm" ,StringService.Language.SPANISH )  );
      }

      RCD  = this.dm.nextRow ( RID );

    }
    this.app.form ( "ADSEF_DIP_2T" ).setItem ( "TEL1", this.app.RMO_PHONE_GBL  );
    this.app.form ( "ADSEF_DIP_2T" ).setItem ( "TEL2", this.app.RMO_PHONE_GBL  );
    this.app.form ( "ADSEF_DIP_2T" ).setItem ( "TEL3", this.app.RMO_PHONE_GBL  );
    RCD  = this.dm.dbClose ( RID );
