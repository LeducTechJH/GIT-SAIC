 ...
 */
public class RECLA_RETRO_GET_SSN_QUERY_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public RECLA_RETRO_GET_SSN_QUERY_PKT ( )
  {
    super ( "RECLA_RETRO_GET_SSN_QUERY_PKT" );
   ...
   *
   */
  public RECLA_RETRO_GET_SSN_QUERY_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RECLA_RETRO_GET_SSN_QUERY_PKT ( MDIFrame pFrame )
  {
    super ( "RECLA_RETRO_GET_SSN_QUERY_PKT", pFrame );
   ...
   *
   */
  public static RECLA_RETRO_GET_SSN_QUERY_PKT get ( RallyApplication __app )
  {
    return ( RECLA_RETRO_GET_SSN_QUERY_PKT ) __app.getNewInstance ( "RECLA_RETRO_GET_SSN_QUERY_PKT" );
  }
  ...
  {
    RECLA_RETRO_GET_SSN_QUERY_PKT fSheet = RECLA_RETRO_GET_SSN_QUERY_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RECLA_RETRO_GET_SSN_QUERY_PKT.exec ( __app );
  }
