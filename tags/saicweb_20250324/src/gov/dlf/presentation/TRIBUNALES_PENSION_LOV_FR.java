 ...
 */
public class TRIBUNALES_PENSION_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TRIBUNALES_PENSION_LOV_FR ( )
  {
    super ( );
    this.setName ( "TRIBUNALES_PENSION_LOV_FR" );

    Debug.println ( Debug.TRACE, "TRIBUNALES_PENSION_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TRIBUNALES_PENSION_LOV_FR.jdp" );
