 ...
 */
public class GEN_ESCOLARIDAD_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_ESCOLARIDAD_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_ESCOLARIDAD_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_ESCOLARIDAD_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_ESCOLARIDAD_LOV_FR.jdp" );
