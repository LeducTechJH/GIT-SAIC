     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "GET_SC724_FR" );

    Debug.println ( Debug.TRACE, "GET_SC724_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_SC724_FR.jdp" );
