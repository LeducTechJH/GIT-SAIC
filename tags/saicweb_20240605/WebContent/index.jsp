...
String message = "";
if ( conString.indexOf ( "SAICPRD" ) >= 0 )
{
...
function showMode ( msg )
{
  ...
  //disable RMS lock check for test Feb-05-2023
  //checkRMS_LOCK(e);
...
function cmd ( commandText )
{
  ...
  if ( formFrame != null )
  {
    ...
    {
    	finished = true;
        var url = "https://servicios.adsef.pr.gov/views/certServicio.aspx";
        var winTop = 100;
        var winLeft = 150;
...
<h1></h1>
	...
	if (browserComp == "Estas utilizando un browser que no es compatible con el SAIC" )
	{
...
<div id="header2" style="width: 800px; position:relative; height: 100px;"><img src="images/BANNER02.gif" width="780px" height="70px" />
