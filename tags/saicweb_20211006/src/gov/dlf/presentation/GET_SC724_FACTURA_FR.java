 ...
 */
public class GET_SC724_FACTURA_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GET_SC724_FACTURA_FR ( )
  {
    super ( );
    this.setName ( "GET_SC724_FACTURA_FR" );

    Debug.println ( Debug.TRACE, "GET_SC724_FACTURA_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_SC724_FACTURA_FR.jdp" );
  ...
  {
    this.registerListener ( "FACTURA_NO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; AFTER_VISIT_NUM_FACTURA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "FCH_FACTURA", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; AFTER_VISIT_FCH_FACTURA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SC724_FACTURA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
