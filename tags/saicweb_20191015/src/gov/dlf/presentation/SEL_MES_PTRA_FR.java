     ...
     extends Form
{
   ...
   *
   */
  public SEL_MES_PTRA_FR ( )
  {
    super ( );
    this.setName ( "SEL_MES_PTRA_FR" );

    Debug.println ( Debug.TRACE, "SEL_MES_PTRA_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SEL_MES_PTRA_FR.jdp" );
  ...
  {
    this.registerListener ( "FECHA_POR_MES", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
