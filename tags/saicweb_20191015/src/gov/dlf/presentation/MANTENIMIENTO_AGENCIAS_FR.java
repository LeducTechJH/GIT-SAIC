 ...
 */
public class MANTENIMIENTO_AGENCIAS_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_AGENCIAS_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_AGENCIAS_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_AGENCIAS_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_AGENCIAS_FR.jdp" );
