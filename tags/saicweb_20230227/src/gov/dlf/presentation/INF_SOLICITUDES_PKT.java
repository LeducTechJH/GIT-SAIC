 ...
 */
public class INF_SOLICITUDES_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INF_SOLICITUDES_PKT ( )
  {
    super ( "INF_SOLICITUDES_PKT" );
   ...
   *
   */
  public INF_SOLICITUDES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INF_SOLICITUDES_PKT ( MDIFrame pFrame )
  {
    super ( "INF_SOLICITUDES_PKT", pFrame );
   ...
   *
   */
  public static INF_SOLICITUDES_PKT get ( RallyApplication __app )
  {
    return ( INF_SOLICITUDES_PKT ) __app.getNewInstance ( "INF_SOLICITUDES_PKT" );
  }
  ...
  {
    INF_SOLICITUDES_PKT fSheet = INF_SOLICITUDES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INF_SOLICITUDES_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_INF_SOLICITUDES_MENU.exec ( app, null );
