 ...
 */
public class SUPLIDORES_CRISIS_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public SUPLIDORES_CRISIS_LOV_FR ( )
  {
    super ( );
    this.setName ( "SUPLIDORES_CRISIS_LOV_FR" );

    Debug.println ( Debug.TRACE, "SUPLIDORES_CRISIS_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SUPLIDORES_CRISIS_LOV_FR.jdp" );
