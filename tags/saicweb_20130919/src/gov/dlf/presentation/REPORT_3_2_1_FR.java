     ...
     extends Form
{
   ...
   *
   */
  public REPORT_3_2_1_FR ( )
  {
    super ( );
    this.setName ( "REPORT_3_2_1_FR" );

    Debug.println ( Debug.TRACE, "REPORT_3_2_1_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REPORT_3_2_1_FR.jdp" );
  ...
  {
    this.registerListener ( "HASTA_FECHA", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; REPORT_3_2_1_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.registerListener ( "TONTO", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; app.returnTo ( "MAIN_MENU_3" ); return app.errorFlag;
      }
    } );
  }
}
