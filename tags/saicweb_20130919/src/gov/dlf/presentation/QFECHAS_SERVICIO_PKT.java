 ...
 */
public class QFECHAS_SERVICIO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public QFECHAS_SERVICIO_PKT ( )
  {
    super ( "QFECHAS_SERVICIO_PKT" );
   ...
   *
   */
  public QFECHAS_SERVICIO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public QFECHAS_SERVICIO_PKT ( MDIFrame pFrame )
  {
    super ( "QFECHAS_SERVICIO_PKT", pFrame );
  ...
  {
    this.createComponents ( new FECHAS_SERVICIO_FRM ( ) );
   ...
   *
   */
  public static QFECHAS_SERVICIO_PKT get ( RallyApplication __app )
  {
    return ( QFECHAS_SERVICIO_PKT ) __app.getNewInstance ( "QFECHAS_SERVICIO_PKT" );
  }
  ...
  {
    QFECHAS_SERVICIO_PKT fSheet = QFECHAS_SERVICIO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return QFECHAS_SERVICIO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; FECHAS_SERVICIO_AFTER_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    ...
    this.formModel.setListener ( JDataPanelListener.BEFOREQUIT, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; FECHAS_SERVICIO_SET_FAILURE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
