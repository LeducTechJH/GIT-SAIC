          ...
          if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "ACNE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  )
          {
            ...
            else
            {
              ...
              else 
              {
            	  ...
            	  if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_INCAPACIDAD_PRIMARIA" ), "CANC" ) || Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_INCAPACIDAD_PRIMARIA" ), "SIDA" ) || Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_INCAPACIDAD_PRIMARIA" ), "CARD" ) || Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_INCAPACIDAD_PRIMARIA" ), "CORE" ) || Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_INCAPACIDAD_PRIMARIA" ), "TBAC" ) || Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_INCAPACIDAD_PRIMARIA" ), "ESCL" ) || Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_INCAPACIDAD_PRIMARIA" ), "ENEU" ) || Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_INCAPACIDAD_PRIMARIA" ), "PARK" ) || Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_INCAPACIDAD_PRIMARIA" ), "DIMU" ) || Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "COD_INCAPACIDAD_PRIMARIA" ), "HEPC" ) )
            	  {
            		  GASTOS = MathService.plus ( GASTOS, 1  );
                      DEDUC_INCA = MathService.plus ( DEDUC_INCA, 100  );
            	  }
...
//*****
 ...
 //ll cuido
      ...
      if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "AUTE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "ACNE" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "GASTOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  && ( Compare.lt ( DateUtil.monthsBetween ( FCH_DETERMINA, this.dm.getFieldDate ( this.dm.get ( "CLIENTES_READ_LOC_DSD" ), "FCH_NACIMIENTO" ) ) / 12, 60 ) )  )
      {
