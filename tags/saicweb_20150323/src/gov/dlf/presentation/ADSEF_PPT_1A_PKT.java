     ...
     extends FormSheet
{
   ...
   *
   */
  public ADSEF_PPT_1A_PKT ( )
  {
    super ( "ADSEF_PPT_1A_PKT" );
   ...
   *
   */
  public ADSEF_PPT_1A_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ADSEF_PPT_1A_PKT ( MDIFrame pFrame )
  {
    super ( "ADSEF_PPT_1A_PKT", pFrame );
  ...
  {
    this.createComponents ( new ADSEF_PPT_1A_RP ( ) );
   ...
   *
   */
  public static ADSEF_PPT_1A_PKT get ( RallyApplication __app )
  {
    return ( ADSEF_PPT_1A_PKT ) __app.getNewInstance ( "ADSEF_PPT_1A_PKT" );
  }
  ...
  {
    ADSEF_PPT_1A_PKT fSheet = ADSEF_PPT_1A_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ADSEF_PPT_1A_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  DESEA_IMPRIMIR_PPT_1A_MENU.exec ( app, null );
 return app.errorFlag;
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; ADSEF_PPT_1A_BEF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
