 ...
 */
public class CODIGO_GENERAL_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CODIGO_GENERAL_RPT_PKT ( )
  {
    super ( "CODIGO_GENERAL_RPT_PKT" );
   ...
   *
   */
  public CODIGO_GENERAL_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CODIGO_GENERAL_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "CODIGO_GENERAL_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CODIGOS_GENERALES_RPT ( ) );
   ...
   *
   */
  public static CODIGO_GENERAL_RPT_PKT get ( RallyApplication __app )
  {
    return ( CODIGO_GENERAL_RPT_PKT ) __app.getNewInstance ( "CODIGO_GENERAL_RPT_PKT" );
  }
  ...
  {
    CODIGO_GENERAL_RPT_PKT fSheet = CODIGO_GENERAL_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CODIGO_GENERAL_RPT_PKT.exec ( __app );
  }
