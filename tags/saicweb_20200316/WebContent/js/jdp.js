...
function JDataPanelObject ( objName )
{
  ...
  this.fireEvent = function ( eventName, instance )
  {
    ...
    {
    	console.log("posting JDP event " + eventName);
...
{
	console.log("setEditManager of " + objName);
  if ( model == null ) return;
...
{
	console.log("register field edit:" + objName);
...
{
	console.log("1- running event code " + eventCode);
...
function postJDPEvent ( fullName, eventName )
{
  ...
  console.log("posting app request " + cmd);
  doAppRequest ( cmd );
}
