...
function afterInit ( )
{
  ...
  if ( value == "LISE" || value.substring(0,4) == "LICE" )
  {
  ...
  //Block TECNICOID backspace
  console.log("Registered onKeyDown event");
  window.onkeydown = function(e) {
	  console.log("OnKeyDown event firing");
	  console.log(e);
	  if (e.keyCode == 8 && e.target == elem){
