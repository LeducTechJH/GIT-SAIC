 ...
 */
public class MANTENIMIENTO_GRANT_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_GRANT_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_GRANT_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_GRANT_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_GRANT_FR.jdp" );
