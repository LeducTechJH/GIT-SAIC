 ...
 */
public class GEN_LOV_TBL_PARF_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_LOV_TBL_PARF_FR ( )
  {
    super ( );
    this.setName ( "GEN_LOV_TBL_PARF_FR" );

    Debug.println ( Debug.TRACE, "GEN_LOV_TBL_PARF_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_LOV_TBL_PARF_FR.jdp" );
