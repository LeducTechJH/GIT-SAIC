     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "FONDO_RPT" );

    Debug.println ( Debug.TRACE, "FONDO_RPT - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/FONDO_RPT.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new FONDO_RPT_FECHAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "USUARIO" );
    field.setValueProvider ( new FONDO_RPT_USUARIOProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new FONDO_RPT_OFICINAProvider ( this ) );
 ...
 *
 */
class FONDO_RPT_FECHAProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public FONDO_RPT_FECHAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class FONDO_RPT_USUARIOProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public FONDO_RPT_USUARIOProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class FONDO_RPT_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public FONDO_RPT_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
