...
public class DETERMINAR_ELEGIBILIDAD_LIHEAP extends ADL {
	...
	protected void step1(ParameterSet ps) 
	{
		...
		while (Compare.equals(STATUS_CODE, 0)) 
		{
			...
			if ( (  Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "BNPR" ) ) || (  Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_SERVICIO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "BNCC" ) )  )
		      {
