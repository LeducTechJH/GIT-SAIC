 ...
 */
public class CARTA_CERTI_GET_SSN_FAM_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CARTA_CERTI_GET_SSN_FAM_FR ( )
  {
    super ( );
    this.setName ( "CARTA_CERTI_GET_SSN_FAM_FR" );

    Debug.println ( Debug.TRACE, "CARTA_CERTI_GET_SSN_FAM_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CARTA_CERTI_GET_SSN_FAM_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "SEGURO_SOCIAL", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CARTA_CERTIFICACION_ADL.exec ( app ); return app.errorFlag;
      }
    } );
