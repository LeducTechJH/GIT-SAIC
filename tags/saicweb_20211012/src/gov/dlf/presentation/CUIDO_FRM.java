     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "CUIDO_FRM" );

    Debug.println ( Debug.TRACE, "CUIDO_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CUIDO_FRM.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "FAM_JEFE_GP", new CUIDO_FRM_FAM_JEFE_GP_Arguments ( this ) );
    this.setArguments ( "SERV_INFO_GP", new CUIDO_FRM_SERV_INFO_GP_Arguments ( this ) );

    this.setObjectEvents ( );

    field = ( JDataPanelField ) this.getInDepth ( "RMO_NUCLEO" );
    field.setValueProvider ( new CUIDO_FRM_RMO_NUCLEOProvider ( this ) );
...
//	    this.registerListener ( "CUIDO_FRM", JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
//	    {
//	      public boolean eventFired ( String eventName )
//	      {
 ...
 *
 */
class CUIDO_FRM_FAM_JEFE_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public CUIDO_FRM_FAM_JEFE_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class CUIDO_FRM_SERV_INFO_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CUIDO_FRM_SERV_INFO_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class CUIDO_FRM_RMO_NUCLEOProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CUIDO_FRM_RMO_NUCLEOProvider ( Form form )
  {
    this.model = form;
  }
