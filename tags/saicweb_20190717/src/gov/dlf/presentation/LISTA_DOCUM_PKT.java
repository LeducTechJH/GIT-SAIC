     ...
     extends FormSheet
{
   ...
   *
   */
  public LISTA_DOCUM_PKT ( )
  {
    super ( "LISTA_DOCUM_PKT" );
   ...
   *
   */
  public LISTA_DOCUM_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public LISTA_DOCUM_PKT ( MDIFrame pFrame )
  {
    super ( "LISTA_DOCUM_PKT", pFrame );
  ...
  {
    this.createComponents ( new LISTA_DOCUM_FR ( ) );
   ...
   *
   */
  public static LISTA_DOCUM_PKT get ( RallyApplication __app )
  {
    return ( LISTA_DOCUM_PKT ) __app.getNewInstance ( "LISTA_DOCUM_PKT" );
  }
  ...
  {
    LISTA_DOCUM_PKT fSheet = LISTA_DOCUM_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return LISTA_DOCUM_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; LISTA_DOCUM_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
