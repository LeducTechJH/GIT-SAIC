     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS108_MENU_PKT ( )
  {
    super ( "DSS108_MENU_PKT" );
   ...
   *
   */
  public DSS108_MENU_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS108_MENU_PKT ( MDIFrame pFrame )
  {
    super ( "DSS108_MENU_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS108_MENU_FR ( ) );
   ...
   *
   */
  public static DSS108_MENU_PKT get ( RallyApplication __app )
  {
    return ( DSS108_MENU_PKT ) __app.getNewInstance ( "DSS108_MENU_PKT" );
  }
  ...
  {
    DSS108_MENU_PKT fSheet = DSS108_MENU_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS108_MENU_PKT.exec ( __app );
  }
