 ...
 */
public class BUSCAR_POR_NOMBRE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public BUSCAR_POR_NOMBRE_PKT ( )
  {
    super ( "BUSCAR_POR_NOMBRE_PKT" );
   ...
   *
   */
  public BUSCAR_POR_NOMBRE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public BUSCAR_POR_NOMBRE_PKT ( MDIFrame pFrame )
  {
    super ( "BUSCAR_POR_NOMBRE_PKT", pFrame );
   ...
   *
   */
  public static BUSCAR_POR_NOMBRE_PKT get ( RallyApplication __app )
  {
    return ( BUSCAR_POR_NOMBRE_PKT ) __app.getNewInstance ( "BUSCAR_POR_NOMBRE_PKT" );
  }
  ...
  {
    BUSCAR_POR_NOMBRE_PKT fSheet = BUSCAR_POR_NOMBRE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return BUSCAR_POR_NOMBRE_PKT.exec ( __app );
  }
