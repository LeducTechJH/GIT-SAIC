     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "SAIR_MENU_FR" );

    Debug.println ( Debug.TRACE, "SAIR_MENU_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SAIR_MENU_FR.jdp" );
  ...
  {
    this.registerListener ( "SDEP", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SAIR_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
