     ...
     extends Form
{
   ...
   *
   */
  public SC1219_MENU_FR ( )
  {
    super ( );
    this.setName ( "SC1219_MENU_FR" );

    Debug.println ( Debug.TRACE, "SC1219_MENU_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SC1219_MENU_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new SC1219_MENU_FR_DESDEProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "SC1219_HASTA" );
    field.setValueProvider ( new SC1219_MENU_FR_SC1219_HASTAProvider ( this ) );
 ...
 *
 */
class SC1219_MENU_FR_DESDEProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public SC1219_MENU_FR_DESDEProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class SC1219_MENU_FR_SC1219_HASTAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public SC1219_MENU_FR_SC1219_HASTAProvider ( Form form )
  {
    this.model = form;
  }
