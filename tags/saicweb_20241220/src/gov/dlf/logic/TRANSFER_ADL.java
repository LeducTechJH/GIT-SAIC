     ...
     extends ADL
{
  ...
  protected void step2 ( ParameterSet ps )
  {
    if ( this._condition0 )    //    while ( Compare.equals ( SERVICIOS_READ_LOC_STAT, 0 )  )
    {
      ...
      if ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "SERVICIOS_READ_LOC_DSD" ), "COD_STATUS_SERVICIO" ), "ACCNEG" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "SERVICIOS_READ_LOC_DSD" ), "COD_STATUS_SERVICIO" ), "PENDREVI" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "SERVICIOS_READ_LOC_DSD" ), "COD_STATUS_SERVICIO" ), "PENDJMED" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "SERVICIOS_READ_LOC_DSD" ), "COD_STATUS_SERVICIO" ), "JUNTAMED" ) )) 
      {
