 ...
 */
public class HORAS_DURACION_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public HORAS_DURACION_LOV_FR ( )
  {
    super ( );
    this.setName ( "HORAS_DURACION_LOV_FR" );

    Debug.println ( Debug.TRACE, "HORAS_DURACION_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/HORAS_DURACION_LOV_FR.jdp" );
