 ...
 */
public class SERVICIO_INGRESO_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SERVICIO_INGRESO_RO_PKT ( )
  {
    super ( "SERVICIO_INGRESO_RO_PKT" );
   ...
   *
   */
  public SERVICIO_INGRESO_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SERVICIO_INGRESO_RO_PKT ( MDIFrame pFrame )
  {
    super ( "SERVICIO_INGRESO_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_SERVICIO_ING_FR ( ) );
   ...
   *
   */
  public static SERVICIO_INGRESO_RO_PKT get ( RallyApplication __app )
  {
    return ( SERVICIO_INGRESO_RO_PKT ) __app.getNewInstance ( "SERVICIO_INGRESO_RO_PKT" );
  }
  ...
  {
    SERVICIO_INGRESO_RO_PKT fSheet = SERVICIO_INGRESO_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SERVICIO_INGRESO_RO_PKT.exec ( __app );
  }
