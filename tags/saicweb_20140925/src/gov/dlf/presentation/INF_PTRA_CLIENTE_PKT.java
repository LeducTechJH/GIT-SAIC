 ...
 */
public class INF_PTRA_CLIENTE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INF_PTRA_CLIENTE_PKT ( )
  {
    super ( "INF_PTRA_CLIENTE_PKT" );
   ...
   *
   */
  public INF_PTRA_CLIENTE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INF_PTRA_CLIENTE_PKT ( MDIFrame pFrame )
  {
    super ( "INF_PTRA_CLIENTE_PKT", pFrame );
   ...
   *
   */
  public static INF_PTRA_CLIENTE_PKT get ( RallyApplication __app )
  {
    return ( INF_PTRA_CLIENTE_PKT ) __app.getNewInstance ( "INF_PTRA_CLIENTE_PKT" );
  }
  ...
  {
    INF_PTRA_CLIENTE_PKT fSheet = INF_PTRA_CLIENTE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INF_PTRA_CLIENTE_PKT.exec ( __app );
  }
