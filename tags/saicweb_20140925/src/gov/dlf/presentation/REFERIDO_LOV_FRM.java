     ...
     extends Form
{
   ...
   *
   */
  public REFERIDO_LOV_FRM ( )
  {
    super ( );
    this.setName ( "REFERIDO_LOV_FRM" );

    Debug.println ( Debug.TRACE, "REFERIDO_LOV_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/REFERIDO_LOV_FRM.jdp" );
