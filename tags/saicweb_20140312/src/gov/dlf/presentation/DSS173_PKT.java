     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS173_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS173_PKT ( MDIFrame pFrame )
  {
    super ( "DSS173_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS173_FR ( ) );
   ...
   *
   */
  public static DSS173_PKT get ( RallyApplication __app )
  {
    return ( DSS173_PKT ) __app.getNewInstance ( "DSS173_PKT" );
  }
  ...
  {
    DSS173_PKT fSheet = DSS173_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; GET_DSS173_SET_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; DSS173_GET_NOMBRE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
