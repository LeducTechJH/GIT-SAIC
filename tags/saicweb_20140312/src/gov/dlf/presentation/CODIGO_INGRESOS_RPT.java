 ...
 */
public class CODIGO_INGRESOS_RPT
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CODIGO_INGRESOS_RPT ( )
  {
    super ( );
    this.setName ( "CODIGO_INGRESOS_RPT" );

    Debug.println ( Debug.TRACE, "CODIGO_INGRESOS_RPT - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CODIGO_INGRESOS_RPT.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new CODIGO_INGRESOS_RPT_FECHAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "USUARIO" );
    field.setValueProvider ( new CODIGO_INGRESOS_RPT_USUARIOProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new CODIGO_INGRESOS_RPT_OFICINAProvider ( this ) );
 ...
 *
 */
class CODIGO_INGRESOS_RPT_FECHAProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public CODIGO_INGRESOS_RPT_FECHAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class CODIGO_INGRESOS_RPT_USUARIOProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CODIGO_INGRESOS_RPT_USUARIOProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class CODIGO_INGRESOS_RPT_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public CODIGO_INGRESOS_RPT_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
