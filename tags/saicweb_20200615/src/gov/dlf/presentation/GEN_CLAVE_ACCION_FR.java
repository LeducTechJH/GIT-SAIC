 ...
 */
public class GEN_CLAVE_ACCION_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_CLAVE_ACCION_FR ( )
  {
    super ( );
    this.setName ( "GEN_CLAVE_ACCION_FR" );

    Debug.println ( Debug.TRACE, "GEN_CLAVE_ACCION_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_CLAVE_ACCION_FR.jdp" );
