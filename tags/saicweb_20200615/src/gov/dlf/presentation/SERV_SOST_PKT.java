     ...
     extends FormSheet
{
   ...
   *
   */
  public SERV_SOST_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SERV_SOST_PKT ( MDIFrame pFrame )
  {
    super ( "SERV_SOST_PKT", pFrame );
  ...
  {
    this.createComponents ( new SERV_SOST_FRM ( ) );
   ...
   *
   */
  public static SERV_SOST_PKT get ( RallyApplication __app )
  {
    return ( SERV_SOST_PKT ) __app.getNewInstance ( "SERV_SOST_PKT" );
  }
  ...
  {
    SERV_SOST_PKT fSheet = SERV_SOST_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SERV_SOST_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
	    ...
	    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
	    {
			...
			{
				app.errorFlag = true; 
				double ajus = app.form("SERV_SOST_FRM").getDoubleItem("AJUSTE_SOST");
				if(Compare.lt(ajus, 0))
				{
					app.form("SERV_SOST_FRM").setItem("AJUSTE_SOST", 0);
				}
				return app.errorFlag;
