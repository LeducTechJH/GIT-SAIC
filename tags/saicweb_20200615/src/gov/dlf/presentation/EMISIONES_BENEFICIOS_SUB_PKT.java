 ...
 */
public class EMISIONES_BENEFICIOS_SUB_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public EMISIONES_BENEFICIOS_SUB_PKT ( )
  {
    super ( "EMISIONES_BENEFICIOS_SUB_PKT" );
   ...
   *
   */
  public EMISIONES_BENEFICIOS_SUB_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public EMISIONES_BENEFICIOS_SUB_PKT ( MDIFrame pFrame )
  {
    super ( "EMISIONES_BENEFICIOS_SUB_PKT", pFrame );
  ...
  {
    this.createComponents ( new EMISIONES_BENEFICIOS_SUB_FRM ( ) );
   ...
   *
   */
  public static EMISIONES_BENEFICIOS_SUB_PKT get ( RallyApplication __app )
  {
    return ( EMISIONES_BENEFICIOS_SUB_PKT ) __app.getNewInstance ( "EMISIONES_BENEFICIOS_SUB_PKT" );
  }
  ...
  {
	  EMISIONES_BENEFICIOS_SUB_PKT fSheet = EMISIONES_BENEFICIOS_SUB_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return EMISIONES_BENEFICIOS_SUB_PKT.exec ( __app );
  }
