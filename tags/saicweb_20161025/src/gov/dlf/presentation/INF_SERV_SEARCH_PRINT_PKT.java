 ...
 */
public class INF_SERV_SEARCH_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INF_SERV_SEARCH_PRINT_PKT ( )
  {
    super ( "INF_SERV_SEARCH_PRINT_PKT" );
   ...
   *
   */
  public INF_SERV_SEARCH_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INF_SERV_SEARCH_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "INF_SERV_SEARCH_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new SERV_SEARCH_FR ( ) );
   ...
   *
   */
  public static INF_SERV_SEARCH_PRINT_PKT get ( RallyApplication __app )
  {
    return ( INF_SERV_SEARCH_PRINT_PKT ) __app.getNewInstance ( "INF_SERV_SEARCH_PRINT_PKT" );
  }
  ...
  {
	  INF_SERV_SEARCH_PRINT_PKT fSheet = INF_SERV_SEARCH_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INF_SERV_SEARCH_PRINT_PKT.exec ( __app );
  }
