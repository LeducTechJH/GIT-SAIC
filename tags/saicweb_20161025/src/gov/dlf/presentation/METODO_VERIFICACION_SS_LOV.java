 ...
 */
public class METODO_VERIFICACION_SS_LOV
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public METODO_VERIFICACION_SS_LOV ( )
  {
    super ( );
    this.setName ( "METODO_VERIFICACION_SS_LOV" );

    Debug.println ( Debug.TRACE, "METODO_VERIFICACION_SS_LOV - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/METODO_VERIFICACION_SS_LOV.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "METODO_VERIFICACION_SS_GP", new METODO_VERIFICACION_SS_GP_Arguments ( this ) );
 ...
 *
 */
class  METODO_VERIFICACION_SS_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public METODO_VERIFICACION_SS_GP_Arguments ( Form form )
  {
    this.model = form;
