     ...
     extends FormSheet
{
   ...
   *
   */
  public AD220A_A2_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AD220A_A2_PKT ( MDIFrame pFrame )
  {
    super ( "AD220A_A2_PKT", pFrame );
  ...
  {
    this.createComponents ( new AD220A_A2_FR ( ) );
   ...
   *
   */
  public static AD220A_A2_PKT get ( RallyApplication __app )
  {
    return ( AD220A_A2_PKT ) __app.getNewInstance ( "AD220A_A2_PKT" );
  }
  ...
  {
    AD220A_A2_PKT fSheet = AD220A_A2_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return AD220A_A2_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; AD220A_A_NOMBRE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
