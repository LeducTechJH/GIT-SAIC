 ...
 */
public class SOLIC_SERV_DESEA_ESTE_CLIENTE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SOLIC_SERV_DESEA_ESTE_CLIENTE_PKT ( )
  {
    super ( "SOLIC_SERV_DESEA_ESTE_CLIENTE_PKT" );
   ...
   *
   */
  public SOLIC_SERV_DESEA_ESTE_CLIENTE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SOLIC_SERV_DESEA_ESTE_CLIENTE_PKT ( MDIFrame pFrame )
  {
    super ( "SOLIC_SERV_DESEA_ESTE_CLIENTE_PKT", pFrame );
   ...
   *
   */
  public static SOLIC_SERV_DESEA_ESTE_CLIENTE_PKT get ( RallyApplication __app )
  {
    return ( SOLIC_SERV_DESEA_ESTE_CLIENTE_PKT ) __app.getNewInstance ( "SOLIC_SERV_DESEA_ESTE_CLIENTE_PKT" );
  }
  ...
  {
    SOLIC_SERV_DESEA_ESTE_CLIENTE_PKT fSheet = SOLIC_SERV_DESEA_ESTE_CLIENTE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SOLIC_SERV_DESEA_ESTE_CLIENTE_PKT.exec ( __app );
  }
