 ...
 */
public class CODIGOS_RMO_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CODIGOS_RMO_RPT_PKT ( )
  {
    super ( "CODIGOS_RMO_RPT_PKT" );
   ...
   *
   */
  public CODIGOS_RMO_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CODIGOS_RMO_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "CODIGOS_RMO_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CODIGOS_RMO_RPT ( ) );
   ...
   *
   */
  public static CODIGOS_RMO_RPT_PKT get ( RallyApplication __app )
  {
    return ( CODIGOS_RMO_RPT_PKT ) __app.getNewInstance ( "CODIGOS_RMO_RPT_PKT" );
  }
  ...
  {
    CODIGOS_RMO_RPT_PKT fSheet = CODIGOS_RMO_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CODIGOS_RMO_RPT_PKT.exec ( __app );
  }
