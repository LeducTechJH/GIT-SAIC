 ...
 */
public class CALENDARIO_BUSQUEDA_UPDAT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CALENDARIO_BUSQUEDA_UPDAT_PKT ( )
  {
    super ( "CALENDARIO_BUSQUEDA_UPDAT_PKT" );
   ...
   *
   */
  public CALENDARIO_BUSQUEDA_UPDAT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CALENDARIO_BUSQUEDA_UPDAT_PKT ( MDIFrame pFrame )
  {
    super ( "CALENDARIO_BUSQUEDA_UPDAT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CALENDARIO_BUSQUEDA_FR ( ) );
    this.setLegendText ( LegendRegistry.get ( "" ) );
  }
   ...
   *
   */
  public static CALENDARIO_BUSQUEDA_UPDAT_PKT get ( RallyApplication __app )
  {
    return ( CALENDARIO_BUSQUEDA_UPDAT_PKT ) __app.getNewInstance ( "CALENDARIO_BUSQUEDA_UPDAT_PKT" );
  }
  ...
  {
    CALENDARIO_BUSQUEDA_UPDAT_PKT fSheet = CALENDARIO_BUSQUEDA_UPDAT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CALENDARIO_BUSQUEDA_UPDAT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CALENDARIO_MAIN_AFTER_QUERY_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.BEFOREQUERY, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; CALENDARIO_BUSQUEDA_BEF_QUERY_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
