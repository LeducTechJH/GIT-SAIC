 ...
 */
public class STATUS_REC_RPT_B_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public STATUS_REC_RPT_B_PKT ( )
  {
    super ( "STATUS_REC_RPT_B_PKT" );
   ...
   *
   */
  public STATUS_REC_RPT_B_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public STATUS_REC_RPT_B_PKT ( MDIFrame pFrame )
  {
    super ( "STATUS_REC_RPT_B_PKT", pFrame );
  ...
  {
    this.createComponents ( new STATUS_REC_RPT_B_FR ( ) );
   ...
   *
   */
  public static STATUS_REC_RPT_B_PKT get ( RallyApplication __app )
  {
    return ( STATUS_REC_RPT_B_PKT ) __app.getNewInstance ( "STATUS_REC_RPT_B_PKT" );
  }
  ...
  {
    STATUS_REC_RPT_B_PKT fSheet = STATUS_REC_RPT_B_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return STATUS_REC_RPT_B_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  STATUS_REC_RPT_B_MENU.exec ( app, null );
 return app.errorFlag;
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; STATUS_REC_RPT_BFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
