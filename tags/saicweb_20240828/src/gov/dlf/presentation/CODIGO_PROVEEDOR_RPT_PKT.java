 ...
 */
public class CODIGO_PROVEEDOR_RPT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public CODIGO_PROVEEDOR_RPT_PKT ( )
  {
    super ( "CODIGO_PROVEEDOR_RPT_PKT" );
   ...
   *
   */
  public CODIGO_PROVEEDOR_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CODIGO_PROVEEDOR_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "CODIGO_PROVEEDOR_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CODIGO_PROVEEDOR_RPT ( ) );
   ...
   *
   */
  public static CODIGO_PROVEEDOR_RPT_PKT get ( RallyApplication __app )
  {
    return ( CODIGO_PROVEEDOR_RPT_PKT ) __app.getNewInstance ( "CODIGO_PROVEEDOR_RPT_PKT" );
  }
  ...
  {
    CODIGO_PROVEEDOR_RPT_PKT fSheet = CODIGO_PROVEEDOR_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CODIGO_PROVEEDOR_RPT_PKT.exec ( __app );
  }
