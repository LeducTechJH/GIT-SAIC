	...
	public Cliente retirveDataCliente(SAIC_DMQ_ORA_Application app) throws Exception
	{
	  try
	  {
		  ...
		  RallyDataManager dm = (RallyDataManager) app.getDataManager ( );
			  ...
			  cl.NombreCliente = rs.getString("nombre_cl") + i + rs.getString("paterno_cl") + " " + rs.getString("materno_cl");
			  ...
			  cl.NombreConyuge = rs.getString("nombre_ccy") + i + rs.getString("paterno_ccy") + " " + rs.getString("materno_ccy");
			  ...
			  {
				  cl.FechaNacimiento = Integer.toString(dayn) + "          " + Integer.toString(monthn) + "        " + Integer.toString(yearn);
			  }
			...
			//Direccion residencial cliente
			  ...
			  {
				  cl.FechaSolicid = Integer.toString(day) + "         " + Integer.toString(month) + "         " + Integer.toString(year);
			  }
			  ...
			  if (oi == "RETIRO PRIVADO" || oi == "RETIRO PRIVADO" || oi == "RETIRO DE MAESTROS" || oi == "RETIRO FEDERAL" || oi == "RETIRO" )
			  {
	...
	public List<Otros> retirveDataOtros(SAIC_DMQ_ORA_Application app) throws Exception
	{
	  try
	  {
		  ...
		  while(rs.next())
		  {
			  ...
			  ot.Nombre = rs.getString("nombre_ot") + i + rs.getString("paterno_ot") + " " + rs.getString("materno_ot");
			  ...
			  {
				  ot.FechaNacimiento = Integer.toString(day) + "/" + Integer.toString(month) + "/" + Integer.toString(year);
	...
	public List<Hijos> retirveDataHijos(SAIC_DMQ_ORA_Application app) throws Exception
	{
	  try
	  {
		  ...
		  while(rs.next())
		  {
			  ...
			  hj.Nombre = rs.getString("nombre_hj") + i + rs.getString("paterno_hj") + " " + rs.getString("materno_hj");
			  ...
			  {
				  hj.FechaNacimiento = Integer.toString(day) + "/" + Integer.toString(month) + "/" + Integer.toString(year);
				  FechaParse = Integer.toString(year) + "-" + Integer.toString(month) + "-" + Integer.toString(day);
			  }
