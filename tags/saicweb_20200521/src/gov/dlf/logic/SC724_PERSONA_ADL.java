     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    this.dm.setField ( this.dm.get ( "SC724_READ_DSD" ), "RECLA_RETRO_TBL_RMO_OFICINA", this.app.RMO_GBL );
    this.dm.setField ( this.dm.get ( "SC724_READ_DSD" ), "CLIENTES_RMO_OFICINA", this.app.RMO_GBL );
    ...
    if ( this._condition0 )
    {
      ...
      this.app.printChain ( "DSS109_REC_PKT", 3 );
      return;
    }
  ...
  protected void step1 ( ParameterSet ps )
  {
    ...
    if ( this._condition1 )
    {
      ...
      this.app.RR_FCH_IDN = this.app.FCH_FINAL_GBL;
      this.app.FECHA_PLUS_15_GBL = MathService.plus ( this.app.SYSTEM_DATE, 15  );
      this.app.printChain ( "SC724_PKT;DSS109_REC_PKT;DSS109_REC_PKT;DSS109_REC_PKT" );
      return;
    }
      ...
      if ( this._condition2 )    //      if ( Compare.equals ( STATUS_CODE, 0 ) ) 
      {
        ...
        else
        {
          ...
          if ( this._condition4 )
          {
            ...
            this.app.RR_FCH_IDN = this.app.FCH_FINAL_GBL;
            this.app.FECHA_PLUS_15_GBL = MathService.plus ( this.app.SYSTEM_DATE, 15  );
            this.app.printChain ( "DSS109_REC_PKT;DSS109_REC_PKT;DSS109_REC_PKT" );
