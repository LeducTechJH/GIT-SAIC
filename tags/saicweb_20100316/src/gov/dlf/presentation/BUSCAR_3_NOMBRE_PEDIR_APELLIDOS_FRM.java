 ...
 */
public class BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_FRM ( )
  {
    super ( );
    this.setName ( "BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_FRM" );

    Debug.println ( Debug.TRACE, "BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/BUSCAR_3_NOMBRE_PEDIR_APELLIDOS_FRM.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "DSC_APELLIDO_PATERNO", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; BUSCAR_3_PPKT.exec ( app, null ); return app.errorFlag;
      }
    } );
