 ...
 */
public class MANTENIMIENTO_RMO_FRM_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_RMO_FRM_PKT ( )
  {
    super ( "MANTENIMIENTO_RMO_FRM_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_RMO_FRM_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_RMO_FRM_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_RMO_FRM_PKT", pFrame );
   ...
   *
   */
  public static MANTENIMIENTO_RMO_FRM_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_RMO_FRM_PKT ) __app.getNewInstance ( "MANTENIMIENTO_RMO_FRM_PKT" );
  }
  ...
  {
    MANTENIMIENTO_RMO_FRM_PKT fSheet = MANTENIMIENTO_RMO_FRM_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_RMO_FRM_PKT.exec ( __app );
  }
