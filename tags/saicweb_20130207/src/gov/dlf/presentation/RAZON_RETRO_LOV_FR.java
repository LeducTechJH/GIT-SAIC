 ...
 */
public class RAZON_RETRO_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public RAZON_RETRO_LOV_FR ( )
  {
    super ( );
    this.setName ( "RAZON_RETRO_LOV_FR" );

    Debug.println ( Debug.TRACE, "RAZON_RETRO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/RAZON_RETRO_LOV_FR.jdp" );
