 ...
 */
public class MANTENIMIENTO_FONDO_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_FONDO_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_FONDO_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_FONDO_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_FONDO_FR.jdp" );
