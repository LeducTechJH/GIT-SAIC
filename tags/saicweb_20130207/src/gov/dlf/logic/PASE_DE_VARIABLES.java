  ...
  protected void step1 ( ParameterSet ps )
  {
    ...
    if ( Compare.equals ( this.app.DETERMINACION_FINAL_GBL, "S" ) ) 
    {
      ...
      if ( Compare.equals ( PRESUPUESTO_LOC_STAT, 0 ) ) 
      {
        ...
        //Start mod Marcos Acevedo 1/28/2013
        //this.dm.setField ( this.dm.get ( "PRESUPUESTO_LOC_DSD" ), "OTROS_INGR_PENS", DETERMINAR_ELEGIBILIDAD_PAN_2.getOTROS ( this.app ) );
        this.dm.setField ( this.dm.get ( "PRESUPUESTO_LOC_DSD" ), "OTROS_INGR_PENS", DETERMINAR_ELEGIBILIDAD_PAN_2.getDEDUC_FIJA ( this.app ) );
        //end mod Marcos Acevedo 1/28/2013
