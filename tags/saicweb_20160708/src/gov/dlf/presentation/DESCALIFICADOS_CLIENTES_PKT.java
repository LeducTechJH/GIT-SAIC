 ...
 */
public class DESCALIFICADOS_CLIENTES_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public DESCALIFICADOS_CLIENTES_PKT ( )
  {
    super ( "DESCALIFICADOS_CLIENTES_PKT" );
   ...
   *
   */
  public DESCALIFICADOS_CLIENTES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DESCALIFICADOS_CLIENTES_PKT ( MDIFrame pFrame )
  {
    super ( "DESCALIFICADOS_CLIENTES_PKT", pFrame );
  ...
  {
    this.createComponents ( new DESCALIFICADOS_CLIENTE_FR ( ) );
   ...
   *
   */
  public static DESCALIFICADOS_CLIENTES_PKT get ( RallyApplication __app )
  {
    return ( DESCALIFICADOS_CLIENTES_PKT ) __app.getNewInstance ( "DESCALIFICADOS_CLIENTES_PKT" );
  }
  ...
  {
    DESCALIFICADOS_CLIENTES_PKT fSheet = DESCALIFICADOS_CLIENTES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DESCALIFICADOS_CLIENTES_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; DESCALIFICADOS_PAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
