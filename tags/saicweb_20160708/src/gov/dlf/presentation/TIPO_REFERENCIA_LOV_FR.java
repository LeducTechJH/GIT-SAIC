 ...
 */
public class TIPO_REFERENCIA_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TIPO_REFERENCIA_LOV_FR ( )
  {
    super ( );
    this.setName ( "TIPO_REFERENCIA_LOV_FR" );

    Debug.println ( Debug.TRACE, "TIPO_REFERENCIA_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TIPO_REFERENCIA_LOV_FR.jdp" );
