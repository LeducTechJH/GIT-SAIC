 ...
 */
public class RETRO_AUTORI2_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public RETRO_AUTORI2_PKT ( )
  {
    super ( "RETRO_AUTORI2_PKT" );
   ...
   *
   */
  public RETRO_AUTORI2_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public RETRO_AUTORI2_PKT ( MDIFrame pFrame )
  {
    super ( "RETRO_AUTORI2_PKT", pFrame );
  ...
  {
    this.createComponents ( new RETRO_AUTORI2_FR ( ) );
   ...
   *
   */
  public static RETRO_AUTORI2_PKT get ( RallyApplication __app )
  {
    return ( RETRO_AUTORI2_PKT ) __app.getNewInstance ( "RETRO_AUTORI2_PKT" );
  }
  ...
  {
    RETRO_AUTORI2_PKT fSheet = RETRO_AUTORI2_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return RETRO_AUTORI2_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; RR_AUT_AFR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; RR_AUT_BFR2_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
