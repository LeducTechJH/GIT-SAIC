     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "HORAS_LOV_FR" );

    Debug.println ( Debug.TRACE, "HORAS_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/HORAS_LOV_FR.jdp" );
