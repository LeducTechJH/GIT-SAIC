 ...
 */
public class MANT_DE_CASOS_BUSCAR_POR_SOUNDEX_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANT_DE_CASOS_BUSCAR_POR_SOUNDEX_PKT ( )
  {
    super ( "MANT_DE_CASOS_BUSCAR_POR_SOUNDEX_PKT" );
   ...
   *
   */
  public MANT_DE_CASOS_BUSCAR_POR_SOUNDEX_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANT_DE_CASOS_BUSCAR_POR_SOUNDEX_PKT ( MDIFrame pFrame )
  {
    super ( "MANT_DE_CASOS_BUSCAR_POR_SOUNDEX_PKT", pFrame );
  ...
  {
    this.createComponents ( new BUSCAR_POR_SOUNDEX_FR ( ) );
   ...
   *
   */
  public static MANT_DE_CASOS_BUSCAR_POR_SOUNDEX_PKT get ( RallyApplication __app )
  {
    return ( MANT_DE_CASOS_BUSCAR_POR_SOUNDEX_PKT ) __app.getNewInstance ( "MANT_DE_CASOS_BUSCAR_POR_SOUNDEX_PKT" );
  }
  ...
  {
    MANT_DE_CASOS_BUSCAR_POR_SOUNDEX_PKT fSheet = MANT_DE_CASOS_BUSCAR_POR_SOUNDEX_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANT_DE_CASOS_BUSCAR_POR_SOUNDEX_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; CHK_SNDX_AGG_ADL.exec ( app ); return app.errorFlag;
      }
    } );
