     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "AD220A_A1_FR" );

    Debug.println ( Debug.TRACE, "AD220A_A1_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/AD220A_A1_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "CSRV", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; AD220A_A_COD_SERV_ADL.exec ( app ); return app.errorFlag;
      }
    } );
