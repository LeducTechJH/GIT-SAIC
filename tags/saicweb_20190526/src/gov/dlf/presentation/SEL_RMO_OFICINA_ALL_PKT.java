 ...
 */
public class SEL_RMO_OFICINA_ALL_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SEL_RMO_OFICINA_ALL_PKT ( )
  {
    super ( "SEL_RMO_OFICINA_ALL_PKT" );
   ...
   *
   */
  public SEL_RMO_OFICINA_ALL_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SEL_RMO_OFICINA_ALL_PKT ( MDIFrame pFrame )
  {
    super ( "SEL_RMO_OFICINA_ALL_PKT", pFrame );
  ...
  {
    this.createComponents ( new SEL_RMO_OFICINA_ALL_FR ( ) );
   ...
   *
   */
  public static SEL_RMO_OFICINA_ALL_PKT get ( RallyApplication __app )
  {
    return ( SEL_RMO_OFICINA_ALL_PKT ) __app.getNewInstance ( "SEL_RMO_OFICINA_ALL_PKT" );
  }
  ...
  {
    SEL_RMO_OFICINA_ALL_PKT fSheet = SEL_RMO_OFICINA_ALL_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SEL_RMO_OFICINA_ALL_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; SEL_RMO_OFICINA_ALL_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.BEFOREQUIT, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; app.callCommand ( "FINISH TASK" ); return app.errorFlag;
      }
    } );
  }
}
