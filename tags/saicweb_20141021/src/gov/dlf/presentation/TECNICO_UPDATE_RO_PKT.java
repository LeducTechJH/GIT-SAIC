 ...
 */
public class TECNICO_UPDATE_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public TECNICO_UPDATE_RO_PKT ( )
  {
    super ( "TECNICO_UPDATE_RO_PKT" );
   ...
   *
   */
  public TECNICO_UPDATE_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public TECNICO_UPDATE_RO_PKT ( MDIFrame pFrame )
  {
    super ( "TECNICO_UPDATE_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_TECNICO_FR ( ) );
   ...
   *
   */
  public static TECNICO_UPDATE_RO_PKT get ( RallyApplication __app )
  {
    return ( TECNICO_UPDATE_RO_PKT ) __app.getNewInstance ( "TECNICO_UPDATE_RO_PKT" );
  }
  ...
  {
    TECNICO_UPDATE_RO_PKT fSheet = TECNICO_UPDATE_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return TECNICO_UPDATE_RO_PKT.exec ( __app );
  }
