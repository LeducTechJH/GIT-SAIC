 ...
 */
public class PRINT_COMPROMISO_PAGO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public PRINT_COMPROMISO_PAGO_PKT ( )
  {
    super ( "PRINT_COMPROMISO_PAGO_PKT" );
   ...
   *
   */
  public PRINT_COMPROMISO_PAGO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public PRINT_COMPROMISO_PAGO_PKT ( MDIFrame pFrame )
  {
    super ( "PRINT_COMPROMISO_PAGO_PKT", pFrame );
  ...
  {
    this.createComponents ( new PRINT_COMPROMISO_PAGO_FR ( ) );
   ...
   *
   */
  public static PRINT_COMPROMISO_PAGO_PKT get ( RallyApplication __app )
  {
    return ( PRINT_COMPROMISO_PAGO_PKT ) __app.getNewInstance ( "PRINT_COMPROMISO_PAGO_PKT" );
  }
  ...
  {
    PRINT_COMPROMISO_PAGO_PKT fSheet = PRINT_COMPROMISO_PAGO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return PRINT_COMPROMISO_PAGO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; LLENAR_PRINT_COMPROMISO_PAGO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
