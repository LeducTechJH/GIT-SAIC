 ...
 */
public class AJUSTE_PAN_RPT_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public AJUSTE_PAN_RPT_FR ( )
  {
    super ( );
    this.setName ( "AJUSTE_PAN_RPT_FR" );

    Debug.println ( Debug.TRACE, "AJUSTE_PAN_RPT_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/AJUSTE_PAN_RPT_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new AJUSTE_PAN_RPT_FR_FECHAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "USUARIO" );
    field.setValueProvider ( new AJUSTE_PAN_RPT_FR_USUARIOProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new AJUSTE_PAN_RPT_FR_OFICINAProvider ( this ) );
 ...
 *
 */
class AJUSTE_PAN_RPT_FR_FECHAProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public AJUSTE_PAN_RPT_FR_FECHAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class AJUSTE_PAN_RPT_FR_USUARIOProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public AJUSTE_PAN_RPT_FR_USUARIOProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class AJUSTE_PAN_RPT_FR_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public AJUSTE_PAN_RPT_FR_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
