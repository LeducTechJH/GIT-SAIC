  ...
  implements IRegisteredObject 
{
  ...
  {
    super ( );
    this.setProcedureName ( "CALL_RUN_MAIL" );
    this.exceptionTitle = "OracleRdbClient_RUN_MAIL.process ( ) - ";
    this.parmCount = 2;
  }
   ...
   *
   */
  public static RUN_MAIL exec ( SAIC_DMQ_ORA_Application __app, ParameterSet ps )
  {
    RUN_MAIL link = new RUN_MAIL ( );
   ...
   *
   */
  public static RUN_MAIL exec ( SAIC_DMQ_ORA_Application __app )
  {
    return RUN_MAIL.exec ( __app, null );
  }
  ...
  protected void createParameters ( ParameterSet ps )
  {
    ...
    parm.set ( this.app.getMAIL_COMMAND ( ) );
  ...
  {
    Debug.println ( Debug.TRACE, "RUN_MAIL" );
