...
public class DETERMINAR_ELEGIBILIDAD_TANFS extends ADL {
	...
	public static void setOPEN_ID(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).OPEN_ID = value
				.getDouble();
	}

	public static void setOPEN2_ID(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).OPEN2_ID = value
				.getDouble();
	}

	public static void setSTATUS_CODE(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS_CODE = value
				.getDouble();
	}

	public static void setSTATUS2_CODE(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS2_CODE = value
				.getDouble();
	}

	public static double getOPEN_ID(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).OPEN_ID;
	}
	...
	public static void setOPEN_ID(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).OPEN_ID = ((Double) value)
				.doubleValue();
	}

	public static double getOPEN2_ID(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).OPEN2_ID;
	}
	...
	public static void setOPEN2_ID(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).OPEN2_ID = ((Double) value)
				.doubleValue();
	}

	public static double getSTATUS_CODE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS_CODE;
	}
	...
	public static void setSTATUS_CODE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS_CODE = ((Double) value)
				.doubleValue();
	}

	public static double getSTATUS2_CODE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS2_CODE;
	}
	...
	public static void setSTATUS2_CODE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS2_CODE = ((Double) value)
				.doubleValue();
	}

	public static double getSTATUS3_CODE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS3_CODE;
	}
	...
	public static void setSTATUS3_CODE(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS3_CODE = value;
	}

	public static void setSTATUS3_CODE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS3_CODE = ((Double) value)
				.doubleValue();
	}

	public static double getSTATUS4_CODE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS4_CODE;
	}
	...
	public static void setSTATUS4_CODE(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS4_CODE = value;
	}

	public static void setSTATUS4_CODE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS4_CODE = ((Double) value)
				.doubleValue();
	}

	public static double getSTATUS5_CODE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS5_CODE;
	}
	...
	public static void setSTATUS5_CODE(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS5_CODE = value;
	}

	public static void setSTATUS5_CODE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS5_CODE = ((Double) value)
				.doubleValue();
	}

	public static double getSTATUS6_CODE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS6_CODE;
	}
	...
	public static void setSTATUS6_CODE(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS6_CODE = value;
	}

	public static void setSTATUS6_CODE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).STATUS6_CODE = ((Double) value)
				.doubleValue();
	}
	/**  */
	public static double getINGRESOS_NUCLEO(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).INGRESOS_NUCLEO;
	}
	...
	public static void setINGRESOS_NUCLEO(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).INGRESOS_NUCLEO = value;
	}

	/**  */
	public static void setINGRESOS_NUCLEO(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).INGRESOS_NUCLEO = ((Double) value)
				.doubleValue();
	}

	public static double getBENEINCA(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).BENEINCA;
	}
	...
	public static void setBENEINCA(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).BENEINCA = value;
	}

	public static void setBENEINCA(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).BENEINCA = ((Double) value)
				.doubleValue();
	}

	public static void setRECURSOS_ACUM(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RECURSOS_ACUM = value
				.getDouble();
	}

	public static double getRECURSOS_ACUM(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RECURSOS_ACUM;
	}
	...
	public static void setRECURSOS_ACUM(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RECURSOS_ACUM = ((Double) value)
				.doubleValue();
	}

	public static double getRECURSOS_LIQUIDOS(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RECURSOS_LIQUIDOS;
	}
	...
	public static void setRECURSOS_LIQUIDOS(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RECURSOS_LIQUIDOS = value;
	}

	public static void setRECURSOS_LIQUIDOS(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RECURSOS_LIQUIDOS = ((Double) value)
				.doubleValue();
	}

	public static void setRECURSOS_TOTAL(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RECURSOS_TOTAL = value
				.getDouble();
	}

	public static double getRECURSOS_TOTAL(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RECURSOS_TOTAL;
	}
	...
	public static void setRECURSOS_TOTAL(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RECURSOS_TOTAL = ((Double) value)
				.doubleValue();
	}

	public static void setANCIANO(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).ANCIANO = value
				.getDouble();
	}

	public static double getANCIANO(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).ANCIANO;
	}
	...
	public static void setANCIANO(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).ANCIANO = ((Double) value)
				.doubleValue();
	}

	public static void setANCIANO_COUNT(RallyApplication __app, Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).ANCIANO_COUNT = value
				.getDouble();
	}
	...
	public static void setINCAPACITADO_COUNT(RallyApplication __app,
			Parameter value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).INCAPACITADO_COUNT = value
				.getDouble();
	}

	public static double getANCIANO_COUNT(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).ANCIANO_COUNT;
	}
	...
	public static void setANCIANO_COUNT(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).ANCIANO_COUNT = ((Double) value)
				.doubleValue();
	}

	public static double getMENOR_COUNT(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).MENOR_COUNT;
	}
	...
	public static void setMENOR_COUNT(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).MENOR_COUNT = value;
	}

	public static void setMENOR_COUNT(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).MENOR_COUNT = ((Double) value)
				.doubleValue();
	}

	public static double getMIEMBROS_FAMILIA_COUNT(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).MIEMBROS_FAMILIA;
	}
	...
	public static void setMIEMBROS_FAMILIA_COUNT(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).MIEMBROS_FAMILIA = value;
	}

	public static void setMIEMBROS_FAMILIA_COUNT(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).MIEMBROS_FAMILIA = ((Double) value)
				.doubleValue();
	}

	public static double getINCAPACITADO_COUNT(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).INCAPACITADO_COUNT;
	}
	...
	{
		( ( DETERMINAR_ELEGIBILIDAD_TANFS ) __app.getADL ( DETERMINAR_ELEGIBILIDAD_TANFS.class ) ).INCAPACITADO_COUNT = ( ( Double ) value ).doubleValue ( );
	}
	public static DataStore getNUCLEO_SERVICIO_DSD(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).NUCLEO_SERVICIO_DSD;
	}

	public static void setNUCLEO_SERVICIO_DSD(RallyApplication __app,
			DataStore value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).NUCLEO_SERVICIO_DSD = value;
	}

	public static void setNUCLEO_SERVICIO_DSD(RallyApplication __app,
			Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).NUCLEO_SERVICIO_DSD = (DataStore) value;
	}

	public static DataStore getCLIENTES_READ_LOC_DSD(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).CLIENTES_READ_LOC_DSD;
	}

	public static void setCLIENTES_READ_LOC_DSD(RallyApplication __app,
			DataStore value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).CLIENTES_READ_LOC_DSD = value;
	}

	public static void setCLIENTES_READ_LOC_DSD(RallyApplication __app,
			Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).CLIENTES_READ_LOC_DSD = (DataStore) value;
	}

	public static DataStore getCLIENTE_AGENCIA_RO_DSD(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).CLIENTE_AGENCIA_RO_DSD;
	}

	public static void setCLIENTE_AGENCIA_RO_DSD(RallyApplication __app,
			DataStore value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).CLIENTE_AGENCIA_RO_DSD = value;
	}

	public static void setCLIENTE_AGENCIA_RO_DSD(RallyApplication __app,
			Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).CLIENTE_AGENCIA_RO_DSD = (DataStore) value;
	}
	public static DataStore getSERVICIOS_EMERGENCIA_DSD(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).SERVICIOS_EMERGENCIA_DSD;
	}

	public static void setSERVICIOS_EMERGENCIA_DSD(RallyApplication __app,
			DataStore value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).SERVICIOS_EMERGENCIA_DSD = value;
	}

	public static void setSERVICIOS_EMERGENCIA_DSD(RallyApplication __app,
			Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).SERVICIOS_EMERGENCIA_DSD = (DataStore) value;
	}

	public static DataStore getSERVICIOS2_DSD(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).SERVICIOS2_DSD;
	}

	public static void setSERVICIOS2_DSD(RallyApplication __app,
			DataStore value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).SERVICIOS2_DSD = value;
	}

	public static void setSERVICIOS2_DSD(RallyApplication __app,
			Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).SERVICIOS2_DSD = (DataStore) value;
	}
	public static DataStore getRECURSOS_NUCLEO_DSD(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RECURSOS_NUCLEO_DSD;
	}

	public static void setRECURSOS_NUCLEO_DSD(RallyApplication __app,
			DataStore value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RECURSOS_NUCLEO_DSD = value;
	}

	public static void setRECURSOS_NUCLEO_DSD(RallyApplication __app,
			Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RECURSOS_NUCLEO_DSD = (DataStore) value;
	}

	public static DataStore getINGRESOS_NUCLEO_DSD(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).INGRESOS_NUCLEO_DSD;
	}

	public static void setINGRESOS_NUCLEO_DSD(RallyApplication __app,
			DataStore value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).INGRESOS_NUCLEO_DSD = value;
	}

	public static void setINGRESOS_NUCLEO_DSD(RallyApplication __app,
			Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).INGRESOS_NUCLEO_DSD = (DataStore) value;
	}

	public static String getSERVICIO_STATUS(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).SERVICIO_STATUS;
	}

	public static void setSERVICIO_STATUS(RallyApplication __app, String value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).SERVICIO_STATUS = value;
	}

	public static void setSERVICIO_STATUS(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).SERVICIO_STATUS = (String) value;
	}

	public static String getRAZON(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RAZON;
	}

	public static void setRAZON(RallyApplication __app, String value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RAZON = value;
	}

	public static void setRAZON(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).RAZON = (String) value;
	}

	public static Date getNULL_DATE(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).NULL_DATE;
	}

	public static void setNULL_DATE(RallyApplication __app, Date value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).NULL_DATE = value;
	}

	public static void setNULL_DATE(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).NULL_DATE = (Date) value;
	}

	public static Date getFCH_CERRADO(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).FCH_CERRADO;
	}

	public static void setFCH_CERRADO(RallyApplication __app, Date value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).FCH_CERRADO = value;
	}

	public static void setFCH_CERRADO(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).FCH_CERRADO = (Date) value;
	}

	public static double getSERVICIO_BENEFICIO(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).SERVICIO_BENEFICIO;
	}
	...
	public static void setSERVICIO_BENEFICIO(RallyApplication __app,
			double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).SERVICIO_BENEFICIO = value;
	}

	public static void setSERVICIO_BENEFICIO(RallyApplication __app,
			Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).SERVICIO_BENEFICIO = ((Double) value)
				.doubleValue();
	}
	public static double getLIHEAP_INCOME_MAX(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).LIHEAP_INCOME_MAX;
	}
	...
	public static void setLIHEAP_INCOME_MAX(RallyApplication __app,
			double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).LIHEAP_INCOME_MAX = value;
	}

	public static void setLIHEAP_INCOME_MAX(RallyApplication __app,
			Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).LIHEAP_INCOME_MAX = ((Double) value)
				.doubleValue();
	}

	public static double getEDAD_IND(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).EDAD_IND;
	}
	...
	public static void setEDAD_IND(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).EDAD_IND = value;
	}

	public static void setEDAD_IND(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).EDAD_IND = ((Double) value)
				.doubleValue();
	}
	...
	public static Double getINCA_FLGDouble(RallyApplication __app) {
		return new Double(
				((DETERMINAR_ELEGIBILIDAD_TANFS) __app
						.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).INCA_FLG);
	}

	public static void setINCA_FLG(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).INCA_FLG = value;
	}

	public static void setINCA_FLG(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).INCA_FLG = ((Double) value)
				.doubleValue();
	}

	public static double getMENOR_FLG(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).MENOR_FLG;
	}
	...
	public static void setMENOR_FLG(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).MENOR_FLG = value;
	}

	public static void setMENOR_FLG(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).MENOR_FLG = ((Double) value)
				.doubleValue();
	}

	public static double getBENEFICIO(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).BENEFICIO;
	}
	...
	public static void setBENEFICIO(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).BENEFICIO = value;
	}

	public static void setBENEFICIO(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).BENEFICIO = ((Double) value)
				.doubleValue();
	}

	public static double getCANTIDAD_AUTO(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).CANTIDAD_AUTO;
	}
	...
	public static void setCANTIDAD_AUTO(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).CANTIDAD_AUTO = value;
	}

	public static void setCANTIDAD_AUTO(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).CANTIDAD_AUTO = ((Double) value)
				.doubleValue();
	}

	public static double getMENOR(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).MENOR;
	}
	...
	public static void setMENOR(RallyApplication __app, double value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).MENOR = value;
	}

	public static void setMENOR(RallyApplication __app, Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).MENOR = ((Double) value)
				.doubleValue();
	}

	public static DataStore getLIHEAP_INCOME_DSD(RallyApplication __app) {
		return ((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).LIHEAP_INCOME_DSD;
	}

	public static void setLIHEAP_INCOME_DSD(RallyApplication __app,
			DataStore value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).LIHEAP_INCOME_DSD = value;
	}

	public static void setLIHEAP_INCOME_DSD(RallyApplication __app,
			Object value) {
		((DETERMINAR_ELEGIBILIDAD_TANFS) __app
				.getADL(DETERMINAR_ELEGIBILIDAD_TANFS.class)).LIHEAP_INCOME_DSD = (DataStore) value;
	}
	/**
	 * 
	 * @param __app
	 * @return
	 */
	public static DETERMINAR_ELEGIBILIDAD_TANFS get(RallyApplication __app) 
	{
		DETERMINAR_ELEGIBILIDAD_TANFS adl = new DETERMINAR_ELEGIBILIDAD_TANFS();
		__app.register(adl, "DETERMINAR_ELEGIBILIDAD_TANFS");
		__app.setADL(DETERMINAR_ELEGIBILIDAD_TANFS.class, adl);
	...
	{
		DETERMINAR_ELEGIBILIDAD_TANFS.get(__app).process(ps);
	}
	/**
	 * 
	 * @param __app
	...
	public static void exec(RallyApplication __app) 
	{
		...
		DETERMINAR_ELEGIBILIDAD_TANFS.exec(__app, ps);
	}
	/**
	...
	public void unregister() 
	{
		...
		IRegisteredObject rObj = this.app.get("DETERMINAR_ELEGIBILIDAD_TANFS");
		if (rObj != null && rObj instanceof DETERMINAR_ELEGIBILIDAD_TANFS) 
		{
			this.app.setADL(DETERMINAR_ELEGIBILIDAD_TANFS.class,(DETERMINAR_ELEGIBILIDAD_TANFS) rObj);
		}
	}
	...
	{
		Debug.println(Debug.TRACE, "DETERMINAR_ELEGIBILIDAD_TANFS Step "+ this.currentStep);
		super.process(ps);
		...
		{
			this.currentStep = 0;
			Debug.println(Debug.TRACE, "DETERMINAR_ELEGIBILIDAD_TANFS ended");
			this.unregister();
			break;
		}
		}
	...
	protected void step0(ParameterSet ps) 
	{
	    ...
	    OPEN5_ID = SERVICIOS2_RO_DSD.getId ( );
		...
		STATUS5_CODE  = this.dm.reset ( OPEN5_ID );
	      ...
	      STATUS5_CODE  = this.dm.firstRow ( OPEN5_ID );
			...
			{
				this.dm.setField ( this.dm.get ( "SERVICIOS2_RO_DSD" ), "ID_TECNICO_AUTORIZA",null );
				this.dm.setField ( this.dm.get ( "SERVICIOS2_RO_DSD" ), "FCH_AUTORIZACION",null );
			}
			STATUS5_CODE = this.dm.update(OPEN5_ID);
