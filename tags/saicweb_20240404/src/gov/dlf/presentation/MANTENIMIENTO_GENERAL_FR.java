 ...
 */
public class MANTENIMIENTO_GENERAL_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public MANTENIMIENTO_GENERAL_FR ( )
  {
    super ( );
    this.setName ( "MANTENIMIENTO_GENERAL_FR" );

    Debug.println ( Debug.TRACE, "MANTENIMIENTO_GENERAL_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/MANTENIMIENTO_GENERAL_FR.jdp" );
