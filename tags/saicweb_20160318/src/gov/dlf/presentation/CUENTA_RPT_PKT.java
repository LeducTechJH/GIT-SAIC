     ...
     extends FormSheet
{
   ...
   *
   */
  public CUENTA_RPT_PKT ( )
  {
    super ( "CUENTA_RPT_PKT" );
   ...
   *
   */
  public CUENTA_RPT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public CUENTA_RPT_PKT ( MDIFrame pFrame )
  {
    super ( "CUENTA_RPT_PKT", pFrame );
  ...
  {
    this.createComponents ( new CUENTA_RPT ( ) );
   ...
   *
   */
  public static CUENTA_RPT_PKT get ( RallyApplication __app )
  {
    return ( CUENTA_RPT_PKT ) __app.getNewInstance ( "CUENTA_RPT_PKT" );
  }
  ...
  {
    CUENTA_RPT_PKT fSheet = CUENTA_RPT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return CUENTA_RPT_PKT.exec ( __app );
  }
