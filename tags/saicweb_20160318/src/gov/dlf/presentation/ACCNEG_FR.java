     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "ACCNEG_FR" );

    Debug.println ( Debug.TRACE, "ACCNEG_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ACCNEG_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "SERVICIOS_GP", new ACCNEG_FR_SERVICIOS_GP_Arguments ( this ) );

    this.setObjectEvents ( );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new ACCNEG_FR_OFICINAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "FECHA" );
    field.setValueProvider ( new ACCNEG_FR_FECHAProvider ( this ) );
 ...
 *
 */
class ACCNEG_FR_SERVICIOS_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public ACCNEG_FR_SERVICIOS_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class ACCNEG_FR_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ACCNEG_FR_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class ACCNEG_FR_FECHAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ACCNEG_FR_FECHAProvider ( Form form )
  {
    this.model = form;
  }
