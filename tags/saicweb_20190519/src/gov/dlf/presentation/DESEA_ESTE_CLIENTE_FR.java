 ...
 */
public class DESEA_ESTE_CLIENTE_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public DESEA_ESTE_CLIENTE_FR ( )
  {
    super ( );
    this.setName ( "DESEA_ESTE_CLIENTE_FR" );

    Debug.println ( Debug.TRACE, "DESEA_ESTE_CLIENTE_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/DESEA_ESTE_CLIENTE_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "CLIENTE_DESEADO_GP", new DESEA_ESTE_CLIENTE_FR_CLIENTE_DESEADO_GP_Arguments ( this ) );
    this.setArguments ( "NUCLEOS_EXISTE", new DESEA_ESTE_CLIENTE_FR_NUCLEOS_EXISTE_Arguments ( this ) );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "SEGURO_SOCIAL_CLIENTE", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; DESEA_ESTE_CLIENTE_MENU_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
 ...
 *
 */
class DESEA_ESTE_CLIENTE_FR_CLIENTE_DESEADO_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public DESEA_ESTE_CLIENTE_FR_CLIENTE_DESEADO_GP_Arguments ( Form form )
  {
    this.model = form;

    this.setArgName ( "SSN_GBL_PAR" );
  ...
  public Object getArgValue ( String argName )
  {
    ...
    else if ( argName.equals ( "SSN_GBL_PAR" ) )
    {
 ...
 *
 */
class DESEA_ESTE_CLIENTE_FR_NUCLEOS_EXISTE_Arguments extends JDataPanelGroupArguments
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public DESEA_ESTE_CLIENTE_FR_NUCLEOS_EXISTE_Arguments ( Form form )
  {
    this.model = form;
