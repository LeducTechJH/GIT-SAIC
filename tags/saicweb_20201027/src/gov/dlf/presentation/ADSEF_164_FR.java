     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "ADSEF_164_FR" );

    Debug.println ( Debug.TRACE, "ADSEF_164_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ADSEF_164_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "HEADER_GP", new ADSEF_164_FR_HEADER_GP_Arguments ( this ) );

    this.setObjectEvents ( );

    calculator = new ADSEF_164_FR_OFICINA_REGIONALCalculator ( this );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA_REGIONAL" );
    field.setValueCalculator ( calculator );
    calculator = new ADSEF_164_FR_NOMBRE_JEFE_SERVICIOCalculator ( this );
 ...
 *
 */
class ADSEF_164_FR_HEADER_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public ADSEF_164_FR_HEADER_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class ADSEF_164_FR_OFICINA_REGIONALCalculator implements ICalculator
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ADSEF_164_FR_OFICINA_REGIONALCalculator ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class ADSEF_164_FR_NOMBRE_JEFE_SERVICIOCalculator implements ICalculator
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ADSEF_164_FR_NOMBRE_JEFE_SERVICIOCalculator ( Form form )
  {
    this.model = form;
  }
