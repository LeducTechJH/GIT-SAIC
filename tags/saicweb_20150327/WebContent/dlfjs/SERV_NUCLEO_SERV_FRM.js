...
//	***** START MODS BY J. OLMEDA - 8/13/2010 *****
	...
	if (codServicio.substring(0,4) == "LICE" || codServicio == "LISE")
	{
		...
		if (!(codServicio == "LICE1"))
		{
			...
			if (element0)
			{
				setNextObject("EMER_NUM_CUENTA","ATRASOS");
				element0.style.nextobject="ATRASOS.0.0.0";
			}
			var element1 = document.getElementById("ATRASOS.0.0.0");
			if (element1)
			{
				setNextObject("ATRASOS","CANTIDAD_AUTO");
				element1.style.nextobject="CANTIDAD_AUTO.0.0.0";
			}
		...
		if (!(codServicio.substring(0,4)  == "LICE"))
		{
			...
			if (element1)
			{
				setNextObject("ATRASOS","EMERG_DUMMY_FIELD");
				element1.style.nextobject="EMERG_DUMMY_FIELD.0.0.0";
			}
