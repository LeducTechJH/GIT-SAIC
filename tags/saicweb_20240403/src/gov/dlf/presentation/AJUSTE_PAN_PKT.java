     ...
     extends FormSheet
{
   ...
   *
   */
  public AJUSTE_PAN_PKT ( )
  {
    super ( "AJUSTE_PAN_PKT" );
   ...
   *
   */
  public AJUSTE_PAN_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AJUSTE_PAN_PKT ( MDIFrame pFrame )
  {
    super ( "AJUSTE_PAN_PKT", pFrame );
  ...
  {
    this.createComponents ( new AJUSTE_PAN_FR ( ) );
   ...
   *
   */
  public static AJUSTE_PAN_PKT get ( RallyApplication __app )
  {
    return ( AJUSTE_PAN_PKT ) __app.getNewInstance ( "AJUSTE_PAN_PKT" );
  }
  ...
  {
    AJUSTE_PAN_PKT fSheet = AJUSTE_PAN_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return AJUSTE_PAN_PKT.exec ( __app );
  }
