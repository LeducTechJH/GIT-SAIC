 ...
 */
public class FREC_PAGO_PENSION_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public FREC_PAGO_PENSION_LOV_FR ( )
  {
    super ( );
    this.setName ( "FREC_PAGO_PENSION_LOV_FR" );

    Debug.println ( Debug.TRACE, "FREC_PAGO_PENSION_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/FREC_PAGO_PENSION_LOV_FR.jdp" );
