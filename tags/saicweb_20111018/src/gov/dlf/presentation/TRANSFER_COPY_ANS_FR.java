 ...
 */
public class TRANSFER_COPY_ANS_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TRANSFER_COPY_ANS_FR ( )
  {
    super ( );
    this.setName ( "TRANSFER_COPY_ANS_FR" );

    Debug.println ( Debug.TRACE, "TRANSFER_COPY_ANS_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TRANSFER_COPY_ANS_FR.jdp" );
