 ...
 */
public class TECNICO_RETRO_LOV_RMO_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public TECNICO_RETRO_LOV_RMO_FR ( )
  {
    super ( );
    this.setName ( "TECNICO_RETRO_LOV_RMO_FR" );

    Debug.println ( Debug.TRACE, "TECNICO_RETRO_LOV_RMO_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/TECNICO_RETRO_LOV_FR.jdp" );
    String definition = ResourceUtil.getResourceText ( this.definitionPath );
    this.setDefinition     ( definition );

    JDataPanelGroup group = ( JDataPanelGroup ) this.getInDepth ( "TECNICO_LOV" );
    if ( group != null ) group.setDataStoreName ( "TSS_RMO_RO_DSD" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "TECNICO_LOV", new TECNICO_RETRO_LOV_RMO_FR_Arguments ( this ) );

    calculator = new TECNICO_RETRO_LOV_RMO_FR_NOMBRE_TECNICOCalculator ( this );
 ...
 *
 */
class TECNICO_RETRO_LOV_RMO_FR_NOMBRE_TECNICOCalculator implements ICalculator
{
  /**  */
  ...
  /**  */
  public TECNICO_RETRO_LOV_RMO_FR_NOMBRE_TECNICOCalculator ( Form form )
  {
    this.model = form;
  }
  ...
  public void calculate ( )
  {
    ...
    RETRO_NOMBRE_TECNICO_RMO_ADL.exec ( this.app, null );
  }
}
...
*
*/
class TECNICO_RETRO_LOV_RMO_FR_Arguments extends JDataPanelGroupArguments
{
 protected Form model;
 protected SAIC_DMQ_ORA_Application app = null;

 public TECNICO_RETRO_LOV_RMO_FR_Arguments ( Form form )
 {
   this.model = form;
