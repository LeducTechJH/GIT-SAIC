 ...
 */
public class MANTENIMIENTO_GANBIL_UPDATE_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_GANBIL_UPDATE_PKT ( )
  {
    super ( "MANTENIMIENTO_GANBIL_UPDATE_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_GANBIL_UPDATE_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_GANBIL_UPDATE_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_GANBIL_UPDATE_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_GANBIL_FR ( ) );
   ...
   *
   */
  public static MANTENIMIENTO_GANBIL_UPDATE_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_GANBIL_UPDATE_PKT ) __app.getNewInstance ( "MANTENIMIENTO_GANBIL_UPDATE_PKT" );
  }
  ...
  {
    MANTENIMIENTO_GANBIL_UPDATE_PKT fSheet = MANTENIMIENTO_GANBIL_UPDATE_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_GANBIL_UPDATE_PKT.exec ( __app );
  }
