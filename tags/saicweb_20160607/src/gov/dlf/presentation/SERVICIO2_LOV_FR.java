     ...
     extends Form
{
   ...
   *
   */
  public SERVICIO2_LOV_FR ( )
  {
    super ( );
    this.setName ( "SERVICIO2_LOV_FR" );

    Debug.println ( Debug.TRACE, "SERVICIO2_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/SERVICIO2_LOV_FR.jdp" );
