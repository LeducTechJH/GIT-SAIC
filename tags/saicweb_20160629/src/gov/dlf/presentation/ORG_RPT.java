     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "ORG_RPT" );

    Debug.println ( Debug.TRACE, "ORG_RPT - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/ORG_RPT.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    field.setValueProvider ( new ORG_RPT_FECHAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "USUARIO" );
    field.setValueProvider ( new ORG_RPT_USUARIOProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new ORG_RPT_OFICINAProvider ( this ) );
 ...
 *
 */
class ORG_RPT_FECHAProvider implements IObjectValueProvider
{
  /**  */
  ...
  /**  */
  public ORG_RPT_FECHAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class ORG_RPT_USUARIOProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ORG_RPT_USUARIOProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class ORG_RPT_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public ORG_RPT_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
