 ...
 */
public class ADSEF_106_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public ADSEF_106_PRINT_PKT ( )
  {
    super ( "ADSEF_106_PRINT_PKT" );
   ...
   *
   */
  public ADSEF_106_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public ADSEF_106_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "ADSEF_106_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new ADSEF_106_RP ( ) );
   ...
   *
   */
  public static ADSEF_106_PRINT_PKT get ( RallyApplication __app )
  {
    return ( ADSEF_106_PRINT_PKT ) __app.getNewInstance ( "ADSEF_106_PRINT_PKT" );
  }
  ...
  {
    ADSEF_106_PRINT_PKT fSheet = ADSEF_106_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return ADSEF_106_PRINT_PKT.exec ( __app );
  }
