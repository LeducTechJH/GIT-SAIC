     ...
     extends FormSheet
{
   ...
   *
   */
  public GET_ADSEF155_PKT ( )
  {
    super ( "GET_ADSEF155_PKT" );
   ...
   *
   */
  public GET_ADSEF155_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public GET_ADSEF155_PKT ( MDIFrame pFrame )
  {
    super ( "GET_ADSEF155_PKT", pFrame );
  ...
  {
    this.createComponents ( new GET_ADSEF155_FR ( ) );
   ...
   *
   */
  public static GET_ADSEF155_PKT get ( RallyApplication __app )
  {
    return ( GET_ADSEF155_PKT ) __app.getNewInstance ( "GET_ADSEF155_PKT" );
  }
  ...
  {
    GET_ADSEF155_PKT fSheet = GET_ADSEF155_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return GET_ADSEF155_PKT.exec ( __app );
  }
