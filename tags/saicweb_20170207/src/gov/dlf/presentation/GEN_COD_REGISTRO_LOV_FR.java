 ...
 */
public class GEN_COD_REGISTRO_LOV_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public GEN_COD_REGISTRO_LOV_FR ( )
  {
    super ( );
    this.setName ( "GEN_COD_REGISTRO_LOV_FR" );

    Debug.println ( Debug.TRACE, "GEN_COD_REGISTRO_LOV_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GEN_COD_REGISTRO_LOV_FR.jdp" );
