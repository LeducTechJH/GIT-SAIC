     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
    ...
    while ( Compare.equals ( STATUS, 0 ) ) 
    {
      ...
      //*** Start mods by J. Olmeda 3/19/2010 for a SUPR: set SUPV_GBL=1
      if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "TSS_ACCESS_RO_DSD" ), "COD_ACCESS_LEVEL" ), "SUPR" ) ) 
      {
        this.app.SUPV_GBL = 1;
      }
      //*** End mods by J. Olmeda 3/19/2010
      ...
      if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "TSS_ACCESS_RO_DSD" ), "COD_ACCESS_LEVEL" ), "OELP" ) ) 
      {
        this.app.OELP_GBL = 1;
      }
      if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "TSS_ACCESS_RO_DSD" ), "COD_ACCESS_LEVEL" ), "SUPM" ) ) 
      {
        this.app.SUPM_GBL = 1;
      }
      if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "TSS_ACCESS_RO_DSD" ), "COD_ACCESS_LEVEL" ), "ESPE" ) ) 
      {
        this.app.ESPE_GBL = 1;
      }
      ...
      if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "TSS_ACCESS_RO_DSD" ), "COD_ACCESS_LEVEL" ), "RTRC" ) ) 
      {
        this.app.RTRC_GBL = 1;
      }
