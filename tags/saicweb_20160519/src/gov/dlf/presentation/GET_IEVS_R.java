     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "GET_IEVS_R" );

    Debug.println ( Debug.TRACE, "GET_IEVS_R - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/GET_IEVS_R.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; IEVS_PERSONA_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
