 ...
 */
public class ADSEF_PPT_1A_OFC_PPKT 
  implements IRegisteredObject 
{
   ...
   *
   */
  public static ADSEF_PPT_1A_OFC_PPKT get ( RallyApplication __app )
  {
    ADSEF_PPT_1A_OFC_PPKT pp = ( ADSEF_PPT_1A_OFC_PPKT ) __app.getNewInstance ( "ADSEF_PPT_1A_OFC_PPKT" );
    return pp;
  }
  ...
  {
    return ADSEF_PPT_1A_OFC_PPKT.exec ( __app );
  }
...
public void execute ( ParameterSet ps )
  {
    Debug.println ( Debug.TRACE, "ADSEF_PPT_1A_OFC_PPKT" );
    this.prepareParms ( );
...
public void halt ( )
  ...
  {
    this.app.form ( "ADSEF_PPT_1A_RP" ).setValue ( "REGION", this.parms.getString ( 0 ) );
    this.app.form ( "ADSEF_PPT_1A_RP" ).setValue ( "OFICINA", this.parms.getString ( 1 ) );
  }
  ...
  {
    this.parms.reset ( );
    this.parms.set ( this.app.form ( "ADSEF_PPT_1A_RP" ).getValue ( "REGION" ) );
    this.parms.set ( this.app.form ( "ADSEF_PPT_1A_RP" ).getValue ( "OFICINA" ) );
  }
