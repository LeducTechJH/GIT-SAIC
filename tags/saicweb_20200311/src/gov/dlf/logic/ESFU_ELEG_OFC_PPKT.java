 ...
 */
public class ESFU_ELEG_OFC_PPKT 
  implements IRegisteredObject 
{
   ...
   *
   */
  public static ESFU_ELEG_OFC_PPKT get ( RallyApplication __app )
  {
    ESFU_ELEG_OFC_PPKT pp = ( ESFU_ELEG_OFC_PPKT ) __app.getNewInstance ( "ESFU_ELEG_OFC_PPKT" );
    return pp;
  }
  ...
  {
    return ESFU_ELEG_OFC_PPKT.exec ( __app );
  }
...
public void execute ( ParameterSet ps )
  {
    Debug.println ( Debug.TRACE, "ESFU_ELEG_OFC_PPKT" );
    this.prepareParms ( );
...
public void halt ( )
  ...
  {
    this.app.form ( "ESFU_ELEG_RP" ).setValue ( "REGION", this.parms.getString ( 0 ) );
    this.app.form ( "ESFU_ELEG_RP" ).setValue ( "OFICINA", this.parms.getString ( 1 ) );
  }
  ...
  {
    this.parms.reset ( );
    this.parms.set ( this.app.form ( "ESFU_ELEG_RP" ).getValue ( "REGION" ) );
    this.parms.set ( this.app.form ( "ESFU_ELEG_RP" ).getValue ( "OFICINA" ) );
  }
