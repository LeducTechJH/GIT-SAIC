  ...
  implements IRegisteredObject 
{
   ...
   *
   */
  public static SEX_VAL_PPKT get ( RallyApplication __app )
  {
    SEX_VAL_PPKT pp = ( SEX_VAL_PPKT ) __app.getNewInstance ( "SEX_VAL_PPKT" );
    return pp;
  }
  ...
  {
    return SEX_VAL_PPKT.exec ( __app );
  }
...
public void execute ( ParameterSet ps )
  {
    Debug.println ( Debug.TRACE, "SEX_VAL_PPKT" );
    this.prepareParms ( );
...
public void halt ( )
  ...
  {
    this.app.form ( "SOLICITUD_SERVICIO_FR" ).setValue ( "SEXO", this.parms.getString ( 0 ) );
  }
  ...
  {
    this.parms.reset ( );
    this.parms.set ( this.app.form ( "SOLICITUD_SERVICIO_FR" ).getValue ( "SEXO" ) );
  }
