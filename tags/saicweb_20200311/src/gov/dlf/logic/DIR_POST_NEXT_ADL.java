 ...
 */
public class DIR_POST_NEXT_ADL
     extends ADL
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).LAST_CMD = value.getDouble ( );
  }  
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).LAST_MOD = value.getString ( );
  }  
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).OPEN_ID = value.getDouble ( );
  }  
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).STATUS_CODE = value.getDouble ( );
  }  
  ...
  {
    return ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).LAST_MOD;
  }
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).LAST_MOD = value;
  }
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).LAST_MOD = ( String ) value;
  }
  ...
  {
    return ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).DIRECCIONES_R_DSD;
  }
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).DIRECCIONES_R_DSD = value;
  }
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).DIRECCIONES_R_DSD = ( DataStore ) value;
  }
  ...
  {
    return ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).LAST_CMD;
  }
  ...
  {
    return new Double ( ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).LAST_CMD );
  }
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).LAST_CMD = value;
  }
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).LAST_CMD = ( ( Double ) value ).doubleValue ( );
  }
  ...
  {
    return ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).OPEN_ID;
  }
  ...
  {
    return new Double ( ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).OPEN_ID );
  }
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).OPEN_ID = value;
  }
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).OPEN_ID = ( ( Double ) value ).doubleValue ( );
  }
  ...
  {
    return ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).STATUS_CODE;
  }
  ...
  {
    return new Double ( ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).STATUS_CODE );
  }
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).STATUS_CODE = value;
  }
  ...
  {
    ( ( DIR_POST_NEXT_ADL ) __app.getADL ( DIR_POST_NEXT_ADL.class ) ).STATUS_CODE = ( ( Double ) value ).doubleValue ( );
  }
   ...
   * @return
   */
  public static DIR_POST_NEXT_ADL get ( RallyApplication __app )
  {
    DIR_POST_NEXT_ADL adl = new DIR_POST_NEXT_ADL ( );
    __app.register ( adl, "DIR_POST_NEXT_ADL" );
    __app.setADL ( DIR_POST_NEXT_ADL.class, adl ); 
  ...
  {
    DIR_POST_NEXT_ADL.get ( __app ).process ( ps );
  }
  ...
  public static void exec ( RallyApplication __app )
  {
    ...
    DIR_POST_NEXT_ADL.exec ( __app, ps );
  }
...
public void execute ( ParameterSet parms )
  ...
  public void unregister ( )
  {
    ...
    IRegisteredObject rObj = this.app.get ( "DIR_POST_NEXT_ADL" );
    if ( rObj != null && rObj instanceof DIR_POST_NEXT_ADL )
    {
      this.app.setADL ( DIR_POST_NEXT_ADL.class, ( DIR_POST_NEXT_ADL ) rObj );
    }
  }
...
protected void process ( ParameterSet ps )
  {
    Debug.println ( Debug.TRACE, "DIR_POST_NEXT_ADL Step " + this.currentStep );
    super.process ( ps );
    switch ( this.currentStep ) 
    {
      ...
      { 
        this.currentStep = 0;
        Debug.println ( Debug.TRACE, "DIR_POST_NEXT_ADL ended" );
        this.unregister ( );
        break;
      }
    }
  ...
  protected void step2 ( ParameterSet ps )
  {
    if ( this._condition1 )    //    if ( ( Compare.equals ( LAST_MOD, "UPDATE" ) ) && ( Compare.equals ( LAST_CMD, RallyAppCommandFactory.FNEXT ) )  ) 
    {
      ...
      {
        this.app.form ( "SOLICITUD_SERVICIO_FR" ).setItem ( "DIR_POST_FLG", "T"  );
      }
      else
      {
  ...
  protected void step3 ( ParameterSet ps )
  {
    ...
    if ( ( Compare.equals ( LAST_MOD, "INSERT" ) ) && ( ( Compare.equals ( LAST_CMD, RallyAppCommandFactory.FNEXT ) ) || ( Compare.equals ( LAST_CMD, RallyAppCommandFactory.EXITACTION ) ) )  ) 
    {
    ...
    if ( this._condition3 )
    {
      if ( Compare.equals ( this.app.form ( "SOLICITUD_SERVICIO_FR" ).getStringItem ( "DIR_POST_FLG" ), "F" ) ) 
      {
  ...
  {
    if ( this._condition3 )    //    if ( ( Compare.equals ( LAST_MOD, "INSERT" ) ) && ( ( Compare.equals ( LAST_CMD, RallyAppCommandFactory.FNEXT ) ) || ( Compare.equals ( LAST_CMD, RallyAppCommandFactory.EXITACTION ) ) )  ) 
    {
      if ( this._condition4 )    //      if ( Compare.equals ( this.app.form ( "SOLICITUD_SERVICIO_FR" ).getStringItem ( "DIR_POST_FLG" ), "F" ) ) 
      {
...
begin
            ...
            begin
                ...
                then
                   begin
                        ...
                        SOLICITUD_SERVICIO_FR.DIR_post_FLG:='T';
                   end;
                else
                   begin
                        call_cmd('Next group');
        ...
        if (last_mod='INSERT') and ((last_cmd=FNEXT) OR (last_cmd=EXITACTION))  
        then
                if (SOLICITUD_SERVICIO_FR.DIR_post_FLG='F')
                then
                    begin       
                        db_reset(open_id,status_code);
                        direcciones_r_dsd.seguro_social_jefe_fam := 
