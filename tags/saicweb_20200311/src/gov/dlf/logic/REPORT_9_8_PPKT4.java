  ...
  implements IRegisteredObject 
{
   ...
   *
   */
  public static REPORT_9_8_PPKT4 get ( RallyApplication __app )
  {
    REPORT_9_8_PPKT4 pp = ( REPORT_9_8_PPKT4 ) __app.getNewInstance ( "REPORT_9_8_PPKT4" );
    return pp;
  }
  ...
  {
    return REPORT_9_8_PPKT4.exec ( __app );
  }
...
public void execute ( ParameterSet ps )
  {
    Debug.println ( Debug.TRACE, "REPORT_9_8_PPKT4" );
    this.prepareParms ( );
...
public void halt ( )
  ...
  {
    this.app.form ( "REPORT_9_24_B_FR" ).setValue ( "COD_REVISION", this.parms.getString ( 0 ) );
    this.app.form ( "REPORT_9_24_B_FR" ).setValue ( "NO_REVISION", this.parms.getString ( 1 ) );
  }
  ...
  {
    this.parms.reset ( );
    this.parms.set ( this.app.form ( "REPORT_9_24_B_FR" ).getValue ( "COD_REVISION" ) );
    this.parms.set ( this.app.form ( "REPORT_9_24_B_FR" ).getValue ( "NO_REVISION" ) );
  }
