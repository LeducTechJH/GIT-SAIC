 ...
 */
public class STATUS_REC_RPT_A_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public STATUS_REC_RPT_A_FR ( )
  {
    super ( );
    this.setName ( "STATUS_REC_RPT_A_FR" );

    Debug.println ( Debug.TRACE, "STATUS_REC_RPT_A_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/STATUS_REC_RPT_A_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "AJUSTE_HASTA", JDataPanelListener.BEFORELEAVE, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; STATUS_REC_RPT_A_ADL.exec ( app ); return app.errorFlag;
      }
    } );
