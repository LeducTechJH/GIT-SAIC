 ...
 */
public class AGENCIAS_CLIENTES_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public AGENCIAS_CLIENTES_RO_PKT ( )
  {
    super ( "AGENCIAS_CLIENTES_RO_PKT" );
   ...
   *
   */
  public AGENCIAS_CLIENTES_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public AGENCIAS_CLIENTES_RO_PKT ( MDIFrame pFrame )
  {
    super ( "AGENCIAS_CLIENTES_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new AGENCIAS_CLIENTE_FR ( ) );
   ...
   *
   */
  public static AGENCIAS_CLIENTES_RO_PKT get ( RallyApplication __app )
  {
    return ( AGENCIAS_CLIENTES_RO_PKT ) __app.getNewInstance ( "AGENCIAS_CLIENTES_RO_PKT" );
  }
  ...
  {
    AGENCIAS_CLIENTES_RO_PKT fSheet = AGENCIAS_CLIENTES_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return AGENCIAS_CLIENTES_RO_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; AGEN_PAR_ADL.exec ( app ); return app.errorFlag;
      }
    } );
