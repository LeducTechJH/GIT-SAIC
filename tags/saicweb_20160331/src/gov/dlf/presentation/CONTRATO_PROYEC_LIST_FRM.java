 ...
 */
public class CONTRATO_PROYEC_LIST_FRM
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public CONTRATO_PROYEC_LIST_FRM ( )
  {
    super ( );
    this.setName ( "CONTRATO_PROYEC_LIST_FRM" );

    Debug.println ( Debug.TRACE, "CONTRATO_PROYEC_LIST_FRM - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/CONTRATO_PROYEC_LIST_FRM.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "FAM_JEFE_GP", new CONTRATO_PROYEC_LIST_FRM_GP_Arguments ( this ) );
    this.setArguments ( "CUIDO_SERV_GP", new LISTADO_CONTRATO_PROYEC_FRM_GP_Arguments ( this ) );
  ...
  {	    
	    ...
	    this.registerListener ( "PARK", JDataPanelListener.HOTKEYPRESS, new JDataPanelListener ( )
	    {
	      public boolean eventFired ( String eventName )
	      {
	        app.errorFlag = true; SOLIC_CONTRATO_PROYEC_LIST_SELECT_LF_ADL.exec ( app ); return app.errorFlag;
	      }
	    } );
  }
}
 ...
 *
 */
class CONTRATO_PROYEC_LIST_FRM_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public CONTRATO_PROYEC_LIST_FRM_GP_Arguments ( Form form )
  {
    this.model = form;
...
class LISTADO_CONTRATO_PROYEC_FRM_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public LISTADO_CONTRATO_PROYEC_FRM_GP_Arguments ( Form form )
  {
    this.model = form;
  ...
  public Object getArgValue ( String argName )
  {
    ...
    {
    	 return this.app.form("CONTRATO_PROYEC_LIST_FRM").getDoubleItem( "SEGURO_SOCIAL_CLIENTE" );
    }
    return null;
  }
}
