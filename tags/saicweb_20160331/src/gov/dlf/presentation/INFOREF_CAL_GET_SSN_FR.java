 ...
 */
public class INFOREF_CAL_GET_SSN_FR
     extends Form
{
  // -------------------------------------------------------------------
  // ----------   Instance Attributes   --------------------------------
   ...
   *
   */
  public INFOREF_CAL_GET_SSN_FR ( )
  {
    super ( );
    this.setName ( "INFOREF_CAL_GET_SSN_FR" );

    Debug.println ( Debug.TRACE, "INFOREF_CAL_GET_SSN_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/INFOREF_CAL_GET_SSN_FR.jdp" );
  ...
  public void setObjectEvents ( )
  {
    this.registerListener ( "PARK", JDataPanelListener.BEFOREENTER, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; INFOREF_CHECK_SSN_ADL.exec ( app ); 
        return app.errorFlag;
      }
    } );
//    this.registerListener ( "PARK", JDataPanelListener.AFTERENTER, new JDataPanelListener ( )
//    {
//      public boolean eventFired ( String eventName )
//      {
