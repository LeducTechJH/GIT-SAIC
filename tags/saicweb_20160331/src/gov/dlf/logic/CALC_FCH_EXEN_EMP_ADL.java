...
extends ADL
{
	...
	protected void step1 ( ParameterSet ps )
	{
		...
		if ( Compare.equals ( INGRESOS_CLIENTE_2_STATUS_CODE, 0 ) )
		{
			...
			{
				ingreso = MathService.plus ( ingreso, TruncService.trunc ( this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) )* 2.15  );
			}
			else if ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_CLIENTE_2_DSD" ), "FLG_FRECUENCIA" ), "Q" ) )
			{
				ingreso = MathService.plus ( ingreso, TruncService.trunc ( this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) )* 2.0  );
			}
			else
			{
				ingreso = MathService.plus ( ingreso, TruncService.trunc ( this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) )* 1.0  );
			}
