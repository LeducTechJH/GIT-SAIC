...
extends ADL
{
	...
	protected void step1 ( ParameterSet ps )
	{
		...
		{
			if ( Compare.equals ( this.app.COD_SERV_GBL, "PAN" ) && Compare.ge (this.app.SYSTEM_DATE, RallySpanishDatesParser.parseDateString ( "1-MAR-2016" ) ) && ( Compare.equals ( this.app.AUTORIZADA_GBL, "N" ) ))
			{
				FCH_DETERMINA = this.app.FCH_SOLIC_SERV_GBL;
			}
			else
