     ...
     extends ADL
{
  ...
  {
    if ( this._condition0 )    //    if ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 2 ), "PA" ) ) 
    {
      ...
      if ( this._condition1 )
      {
        ...
        this.dm.setField ( this.dm.get ( "EMPLEOS_CLIENTE_RO_DSD" ), "SEGURO_SOCIAL_CLIENTE", this.dm.getFieldDouble ( this.dm.get ( "NUCLEO_READ_LOC_DSD" ), "SEGURO_SOCIAL_BENEFICIARIO" ) );
        this.dm.setField ( this.dm.get ( "EMPLEOS_CLIENTE_RO_DSD" ), "RMO_OFICINA", this.app.RMO_GBL );
        ...
        while ( ( Compare.equals ( STATUS_CODE6, 0 ) ) && ( Compare.le ( this.dm.getFieldDate ( this.dm.get ( "EMPLEOS_CLIENTE_RO_DSD" ), "FCH_GESTION" ), this.app.SYSTEM_DATE ) )   )
        {
          STATUS_CODE6  = this.dm.nextRow ( OPEN_ID6 );
        ...
        if ( ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "TIPO_REGISTRO" ), "VOLU" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "TIPO_REGISTRO" ), "OBLI" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "TIPO_REGISTRO" ), "" ) ) ) && ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "ACEPTA_REGISTRO_EMPLEO" ), "S" ) ) || ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "EMPLEOS_CLIENTE_RO_DSD" ), "FLG_GESTION" ), "S" ) ) || ( ! Compare.equals ( STATUS_CODE6, 0 ) ) ) )  && ( Compare.equals ( STATUS_CODE, 0 ) )  ) 
        {
          ...
          if ( this._condition3 )
          {
            ...
            if ( this._condition4 )
            {
              ...
              if ( this._condition5 )
              {
                ...
                if ( this._condition6 )
                {
                  if ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "ACEPTA_REGISTRO_EMPLEO" ), "S" ) ) 
                  {
  ...
  protected void step3 ( ParameterSet ps )
  {
    if ( this._condition0 )    //    if ( Compare.equals ( RallyStringService.subString ( this.app.COD_SERV_GBL, 0, 2 ), "PA" ) ) 
    {
      if ( this._condition1 )    //      while ( Compare.equals ( STATUS_CODE2, 0 )  )
      {
        if ( this._condition2 )    //        if ( ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "TIPO_REGISTRO" ), "VOLU" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "TIPO_REGISTRO" ), "OBLI" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "TIPO_REGISTRO" ), "" ) ) ) && ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "ACEPTA_REGISTRO_EMPLEO" ), "S" ) ) || ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "EMPLEOS_CLIENTE_RO_DSD" ), "FLG_GESTION" ), "S" ) ) || ( ! Compare.equals ( STATUS_CODE6, 0 ) ) ) )  && ( Compare.equals ( STATUS_CODE, 0 ) )  ) 
        {
          if ( this._condition3 )    //          if ( Compare.equals ( FLG_DESCALIFICADO, 0 ) ) 
          {
            if ( this._condition4 )    //            if ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "COD_PARENTESCO_FAM" ), "JEFE" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "COD_PARENTESCO_FAM" ), "CONY" ) ) ) 
            {
              if ( this._condition5 )    //              if ( Compare.equals ( STATUS_CODE3, 0 ) ) 
              {
                if ( this._condition6 )    //                if ( Compare.gt ( StringService.toStringValue  ( this.dm.getFieldDate ( this.dm.get ( "SERVICIOS_LOC2_DSD" ), "FCH_AUTORIZACION" ) ), "" ) ) 
                {
                  if ( this._condition7 )    //                  if ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "ACEPTA_REGISTRO_EMPLEO" ), "S" ) ) 
                  {
                  ...
                  {
                    if ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "EMPLEOS_CLIENTE_RO_DSD" ), "FLG_GESTION" ), "S" ) ) 
                    {
                    ...
                    if ( this._condition8 )
                    {
                      DESEA_CERRAD_SEGGEST_MENU.exec ( this.app );
                      return;
                    }
                  }
                }
            ...
            if ( this._condition4 )    //            if ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "COD_PARENTESCO_FAM" ), "JEFE" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "COD_PARENTESCO_FAM" ), "CONY" ) ) ) 
            {
              if ( this._condition5 )    //              if ( Compare.equals ( STATUS_CODE3, 0 ) ) 
              {
                if ( this._condition6 )    //                if ( Compare.gt ( StringService.toStringValue  ( this.dm.getFieldDate ( this.dm.get ( "SERVICIOS_LOC2_DSD" ), "FCH_AUTORIZACION" ) ), "" ) ) 
                {
                  ...
                  {
                    if ( this._condition8 )    //                    if ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "EMPLEOS_CLIENTE_RO_DSD" ), "FLG_GESTION" ), "S" ) ) 
                    {
                      if ( Compare.equals ( this.app.ANSWER_GBL, "N" ) ) 
                      {
                        this.doReturn ( );
                ...
                else
                {
                  ...
                  if ( this._condition9 )
                  {
                    DESEA_RECHAZ30_MENU.exec ( this.app );
                    return;
                  }
                }
              }
          ...
          if ( this._condition3 )    //          if ( Compare.equals ( FLG_DESCALIFICADO, 0 ) ) 
          {
            if ( this._condition4 )    //            if ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "COD_PARENTESCO_FAM" ), "JEFE" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "COD_PARENTESCO_FAM" ), "CONY" ) ) ) 
            {
              if ( this._condition5 )    //              if ( Compare.equals ( STATUS_CODE3, 0 ) ) 
              {
                ...
                {
                  if ( this._condition9 )    //                  if ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "ACEPTA_REGISTRO_EMPLEO" ), "S" ) ) 
                  {
                    if ( Compare.equals ( this.app.ANSWER_GBL, "Y" ) ) 
                    {
                      this.app.form ( "PRE_MENU_MANT_SERV_FR" ).setItem ( "COD_STATUS_SERVICIO", "RECHAZ24"  );
                      this.app.form ( "SERV_FAM_FRM" ).setItem ( "COD_STATUS_SERVICIO", "RECHAZ24"  );
                      this.dm.setField ( this.dm.get ( "SERVICIOS_LOC2_DSD" ), "COD_STATUS_SERVICIO", "RECHAZ24" );
                      this.dm.setField ( this.dm.get ( "SERVICIOS_LOC2_DSD" ), "FCH_CERRADO", TruncService.trunc ( this.app.SYSTEM_DATE, "DDD" )  );
                    }
                    if ( Compare.equals ( this.app.ANSWER_GBL, "N" ) ) 
                    {
            ...
            else
            {
              ...
              if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "EMPLEOS_CLIENTE_RO_DSD" ), "FLG_GESTION" ), "S" ) ) && ( Compare.gt ( StringService.toStringValue  ( this.dm.getFieldDate ( this.dm.get ( "SERVICIOS_LOC2_DSD" ), "FCH_AUTORIZACION" ) ), "" ) )  ) 
              {
                this.app.setError ( 5, 6121 );
                STATUS_CODE  = this.dm.dbClose ( OPEN_ID );
  ...
  protected void step8 ( ParameterSet ps )
  {
    if ( this._condition10 )    //    if ( Compare.equals ( this.app.COD_SERV_GBL, "AE-C" ) ) 
    {
      if ( this._condition11 )    //      while ( Compare.equals ( STATUS_CODE2, 0 )  )
      {
        if ( this._condition12 )    //        if ( ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_READ_LOC_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "EXIN" ) ) && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_READ_LOC_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAL" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_READ_LOC_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "ENNA" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_READ_LOC_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NCAT" ) )  && ( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_READ_LOC_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NA" ) )  ) 
        {
          if ( this._condition13 )    //          if ( ( Compare.gt ( EDAD, 18 ) ) && ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_READ_LOC_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "BNPR" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "NUCLEO_READ_LOC_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "BNSC" ) ) )  ) 
          {
            if ( this._condition14 )    //            if ( ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "COD_PASOS" ), "NOAC" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "COD_PASOS" ), "NA" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "COD_PASOS" ), "" ) ) ) && ( Compare.equals ( STATUS_CODE, 0 ) )  ) 
            {
              if ( this._condition15 )    //              if ( Compare.equals ( FLG_DESCALIFICADO, 0 ) ) 
              {
                if ( this._condition16 )    //                if ( ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "COD_PARENTESCO_FAM" ), "JEFE" ) ) || ( Compare.equals ( this.dm.getFieldString ( this.dm.get ( "CLIENTES2_RO_DSD" ), "COD_PARENTESCO_FAM" ), "CONY" ) ) ) 
                {
                  if ( this._condition17 )    //                  if ( Compare.equals ( STATUS_CODE3, 0 ) ) 
                  {
                    if ( Compare.gt ( StringService.toStringValue  ( this.dm.getFieldDate ( this.dm.get ( "SERVICIOS_LOC2_DSD" ), "FCH_AUTORIZACION" ) ), "" ) ) 
                    {
                    }
                    else
                    {
                      if ( Compare.equals ( this.app.ANSWER_GBL, "Y" ) ) 
                      {
                        this.app.form ( "PRE_MENU_MANT_SERV_FR" ).setItem ( "COD_STATUS_SERVICIO", "RECHAZ17"  );
                        this.app.form ( "SERV_FAM_FRM" ).setItem ( "COD_STATUS_SERVICIO", "RECHAZ17"  );
                        this.dm.setField ( this.dm.get ( "SERVICIOS_LOC2_DSD" ), "COD_STATUS_SERVICIO", "RECHAZ17" );
                        this.dm.setField ( this.dm.get ( "SERVICIOS_LOC2_DSD" ), "FCH_CERRADO", TruncService.trunc ( this.app.SYSTEM_DATE, "DDD" )  );
                        this.app.ANSWER_GBL = "N";
