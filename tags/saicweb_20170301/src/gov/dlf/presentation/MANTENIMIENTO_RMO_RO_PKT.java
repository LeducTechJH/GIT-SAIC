 ...
 */
public class MANTENIMIENTO_RMO_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public MANTENIMIENTO_RMO_RO_PKT ( )
  {
    super ( "MANTENIMIENTO_RMO_RO_PKT" );
   ...
   *
   */
  public MANTENIMIENTO_RMO_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public MANTENIMIENTO_RMO_RO_PKT ( MDIFrame pFrame )
  {
    super ( "MANTENIMIENTO_RMO_RO_PKT", pFrame );
  ...
  {
    this.createComponents ( new MANTENIMIENTO_RMO_FRM ( ) );
   ...
   *
   */
  public static MANTENIMIENTO_RMO_RO_PKT get ( RallyApplication __app )
  {
    return ( MANTENIMIENTO_RMO_RO_PKT ) __app.getNewInstance ( "MANTENIMIENTO_RMO_RO_PKT" );
  }
  ...
  {
    MANTENIMIENTO_RMO_RO_PKT fSheet = MANTENIMIENTO_RMO_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return MANTENIMIENTO_RMO_RO_PKT.exec ( __app );
  }
