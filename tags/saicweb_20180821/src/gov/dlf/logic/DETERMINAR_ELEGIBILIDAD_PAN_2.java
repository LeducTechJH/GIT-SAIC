			...
			if	( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "NA" ) )
			{
						...
						( ! Compare.equals ( this.dm.getFieldString ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "COD_PARENTESCO_RELACION_SERV" ), "****" ) )  )
				{
					...
					//CHANGE RELIEF SEP-2018
  					 ...
  					 Compare.ge ( FCH_DETERMINA, RallySpanishDatesParser.parseDateString ( "24-AUG-2018" ) ) )
							{
 						SALARIO = MathService.plus ( SALARIO, ( this.dm.getFieldDouble ( this.dm.get ( "INGRESOS_NUCLEO_DSD" ), "VLR_CANTIDAD_INGRESO" ) )  );						
							}
					else
...
//			}
			...
			{
				//Change Relief sep 2018	
			 if ( Compare.ge ( FCH_DETERMINA, RallySpanishDatesParser.parseDateString ( "24-AUG-2018" ) ) )
			 {
				 SEG_SOC =  TruncService.round(SEG_SOC*EXENCION_SEG_SOC,2);				 
				 RETP = TruncService.round(RETIRO*EXENCION_RETP,2);
			 }
...
//			OTROS = MathService.plus(MathService.plus(MathService.plus(RETI, RETP), RETF), OTROS);
			...
			// Changes Amendment # 3 PAN oct-2008
			//Change Relief sep 2018
			ING_MENOS_40 = MathService.plus (MathService.plus ( MathService.plus ( SAL_NET, SEG_SOC  ), OTROS  ), TruncService.round(RETIRO*EXENCION_RETP,2));
