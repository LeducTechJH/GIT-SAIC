 ...
 */
public class FORMULARIO_TANF_08_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public FORMULARIO_TANF_08_PKT ( )
  {
    super ( "FORMULARIO_TANF_08_PKT" );
   ...
   *
   */
  public FORMULARIO_TANF_08_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public FORMULARIO_TANF_08_PKT ( MDIFrame pFrame )
  {
    super ( "FORMULARIO_TANF_08_PKT", pFrame );
  ...
  {
    this.createComponents ( new FORMULARIO_TANF_08_FR ( ) );
   ...
   *
   */
  public static FORMULARIO_TANF_08_PKT get ( RallyApplication __app )
  {
    return ( FORMULARIO_TANF_08_PKT ) __app.getNewInstance ( "FORMULARIO_TANF_08_PKT" );
  }
  ...
  {
    FORMULARIO_TANF_08_PKT fSheet = FORMULARIO_TANF_08_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return FORMULARIO_TANF_08_PKT.exec ( __app );
  }
