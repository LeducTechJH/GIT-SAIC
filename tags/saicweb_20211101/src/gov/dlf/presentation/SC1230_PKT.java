     ...
     extends FormSheet
{
   ...
   *
   */
  public SC1230_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SC1230_PKT ( MDIFrame pFrame )
  {
    super ( "SC1230_PKT", pFrame );
  ...
  {
    this.createComponents ( new SC1230_FR ( ) );
   ...
   *
   */
  public static SC1230_PKT get ( RallyApplication __app )
  {
    return ( SC1230_PKT ) __app.getNewInstance ( "SC1230_PKT" );
  }
  ...
  {
    SC1230_PKT fSheet = SC1230_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true;  SC1230_PRN_MENU.exec ( app, null );
 return app.errorFlag;
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SC1230_DATE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
    this.formModel.setListener ( JDataPanelListener.AFTERQUERY, new JDataPanelListener ( )
    {
      public boolean eventFired ( String eventName )
      {
        app.errorFlag = true; SC1230_FCH_PAGO_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
