 ...
 */
public class INFORME_ESTADISTICO_APEL_PRINT_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public INFORME_ESTADISTICO_APEL_PRINT_PKT ( )
  {
    super ( "INFORME_ESTADISTICO_APEL_PRINT_PKT" );
   ...
   *
   */
  public INFORME_ESTADISTICO_APEL_PRINT_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public INFORME_ESTADISTICO_APEL_PRINT_PKT ( MDIFrame pFrame )
  {
    super ( "INFORME_ESTADISTICO_APEL_PRINT_PKT", pFrame );
  ...
  {
    this.createComponents ( new INFORME_ESTADISTICO_APEL_FR ( ) );
   ...
   *
   */
  public static INFORME_ESTADISTICO_APEL_PRINT_PKT get ( RallyApplication __app )
  {
    return ( INFORME_ESTADISTICO_APEL_PRINT_PKT ) __app.getNewInstance ( "INFORME_ESTADISTICO_APEL_PRINT_PKT" );
  }
  ...
  {
    INFORME_ESTADISTICO_APEL_PRINT_PKT fSheet = INFORME_ESTADISTICO_APEL_PRINT_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return INFORME_ESTADISTICO_APEL_PRINT_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; LLENAR_INF_EST_APEL_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
