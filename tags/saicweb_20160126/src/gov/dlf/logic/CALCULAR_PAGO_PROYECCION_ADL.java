	...
	protected void step1 ( ParameterSet ps )
	{
		...
		{        
			...
			while (Compare.equals(PROV_VIGENCIAS_STATUS, 0))
			{
				...
				{
					if (Compare.equals(this.dm.getFieldDouble ( this.dm.get ( "PROV_VIGENCIAS2_DSD" ), "ID_DOC" ), 3))
					{
					...
					else if (Compare.equals(this.dm.getFieldDouble ( this.dm.get ( "PROV_VIGENCIAS2_DSD" ), "ID_DOC" ), 5))
					{
						if (  Compare.lt ( this.dm.getFieldDate ( this.dm.get ( "PROV_VIGENCIAS2_DSD" ), "VIG_HASTA" ), this.app.SYSTEM_DATE )  || 
								Compare.gt ( this.dm.getFieldDate ( this.dm.get ( "PROV_VIGENCIAS2_DSD" ), "VIG_DESDE" ), this.app.SYSTEM_DATE ) ) 
						{
					...
					{
						this.app.setError("0", "A este proveedor formal le hace falta algun documento.");
						doc_activ = false;
					}
				}
				else if(Compare.equals(TIPO_PROVEEDOR, "INFORMAL"))
				{
					if (Compare.equals(this.dm.getFieldDouble ( this.dm.get ( "PROV_VIGENCIAS2_DSD" ), "ID_DOC" ), 1))
					{
						if (  Compare.lt ( this.dm.getFieldDate ( this.dm.get ( "PROV_VIGENCIAS2_DSD" ), "VIG_HASTA" ), this.app.SYSTEM_DATE )  || 
								Compare.gt ( this.dm.getFieldDate ( this.dm.get ( "PROV_VIGENCIAS2_DSD" ), "VIG_DESDE" ), this.app.SYSTEM_DATE ) ) 
						{
					...
					else if (Compare.equals(this.dm.getFieldDouble ( this.dm.get ( "PROV_VIGENCIAS2_DSD" ), "ID_DOC" ), 2))
					{
						if (  Compare.lt ( this.dm.getFieldDate ( this.dm.get ( "PROV_VIGENCIAS2_DSD" ), "VIG_HASTA" ), this.app.SYSTEM_DATE )  || 
								Compare.gt ( this.dm.getFieldDate ( this.dm.get ( "PROV_VIGENCIAS2_DSD" ), "VIG_DESDE" ), this.app.SYSTEM_DATE ) ) 
						{
				...
				{
					this.app.setError("0", "Verificar el tipo de proveedor.");
				}
