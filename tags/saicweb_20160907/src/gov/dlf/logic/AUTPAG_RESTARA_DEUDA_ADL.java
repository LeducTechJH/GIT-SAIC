     ...
     extends ADL
{
  ...
  protected void step0 ( ParameterSet ps )
  {
	    ...
	    AUTPAG_RECLA_DSD = this.dm.create ( "AUTPAG_RECLA_DSD" );
	      ...
	      this.dm.setField ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "SEGURO_SOCIAL_JEFE_FAM", this.app.form ( "AUTPAG2_FR" ).getDoubleItem ( "SS_JF" ));
	      this.dm.setField ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "SEGURO_SOCIAL_JEFE_SERV", this.app.form ( "AUTPAG2_FR" ).getDoubleItem ( "SEGURO_SOCIAL_JEFE_SERV" ));
	      this.dm.setField ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "COD_SERVICIO", this.app.form ( "AUTPAG2_FR" ).getStringItem ( "CD_SERV" ));
	      this.dm.setField ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "FECHA_IDENTIFICADO", this.app.form ( "AUTPAG2_FR" ).getDateItem ( "FCH_IDN" ));
	      ...
	      this.dm.setField ( this.dm.get ( "AUTPAG_AG2_DSD" ), "SS_JF", this.app.form ( "AUTPAG2_FR" ).getDoubleItem ( "SS_JF" ));
	      this.dm.setField ( this.dm.get ( "AUTPAG_AG2_DSD" ), "SEGURO_SOCIAL_JEFE_SERV", this.app.form ( "AUTPAG2_FR" ).getDoubleItem ( "SEGURO_SOCIAL_JEFE_SERV" ));
	      this.dm.setField ( this.dm.get ( "AUTPAG_AG2_DSD" ), "CD_SERV", this.app.form ( "AUTPAG2_FR" ).getStringItem ( "CD_SERV" ));
	      this.dm.setField ( this.dm.get ( "AUTPAG_AG2_DSD" ), "FCH_IDN", this.app.form ( "AUTPAG2_FR" ).getDateItem ( "FCH_IDN" ));
	      this.dm.setField ( this.dm.get ( "AUTPAG_AG2_DSD" ), "FCH_PAGO", this.app.form ( "AUTPAG2_FR" ).getDateItem ( "FCH_PAGO" ));
	    ...
	    //  Hashtable hTable = this.dm.getInMemoryRegistry();
	      ...
	      double valorEntrado = this.app.form ( "AUTPAG2_FR" ).getDoubleItem ( "VLR_CANTIDAD" );

	      if ( this.app.form ( "AUTPAG2_FR" ).getStringItem ( "MODO_PAGO" ) != "AJU+" )
	      {
	...
	if ( ( Compare.equals ( this.app.form ( "AUTPAG2_FR" ).getStringItem ( "STAT_AUTO" ), "S" ) ) && ( ! Compare.equals ( this.app.form ( "AUTPAG2_FR" ).getStringItem ( "UPDATED" ), "U" ) )  )
    {

      this.dm.setField ( this.dm.get ( "AUTPAG_AG2_DSD" ), "AUTPAG_AUTORIZACION", this.app.form ( "AUTPAG2_FR" ).getStringItem ( "STAT_AUTO" ));
      if ( ! Compare.equals ( this.app.form ( "AUTPAG2_FR" ).getStringItem ( "MODO_PAGO" ), "AJU+" ) )
      {
        if ( Compare.lt ( this.dm.getFieldDouble ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "VLR_BALANCE" ), this.app.form ( "AUTPAG2_FR" ).getDoubleItem ( "VLR_CANTIDAD" )) )
        {
          this.app.setError ( 7, 7275 );
          this.app.form ( "AUTPAG2_FR" ).setItem ( "STAT_AUTO", "N"  );
          this.app.errorFlag = false;
          this.doReturn ( );
          return;
        }
      ...
      if ( ! Compare.equals ( this.app.form ( "AUTPAG2_FR" ).getStringItem ( "MODO_PAGO" ), "AJU+" ) )
      {
        if ( Compare.equals ( MathService.minus ( this.dm.getFieldDouble ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "VLR_BALANCE" ), this.app.form ( "AUTPAG2_FR" ).getDoubleItem ( "VLR_CANTIDAD" ) ), 0 ) )
        {
          this.dm.setField ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "STATUS", "SALDADA" );
          this.app.setError ( 8, 7255 );
        }
        this.dm.setField ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "VLR_BALANCE", MathService.minus ( this.dm.getFieldDouble ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "VLR_BALANCE" ), this.app.form ( "AUTPAG2_FR" ).getDoubleItem ( "VLR_CANTIDAD" ) ) );
      }
      else
      {
        this.dm.setField ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "VLR_BALANCE", MathService.plus ( this.dm.getFieldDouble ( this.dm.get ( "AUTPAG_RECLA_DSD" ), "VLR_BALANCE" ), this.app.form ( "AUTPAG2_FR" ).getDoubleItem ( "VLR_CANTIDAD" ) ) );
      }
    }
      ...
      this.app.form ( "AUTPAG2_FR" ).setItem ( "UPDATED", "U"  );
