     ...
     extends FormSheet
{
   ...
   *
   */
  public BILLETES_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public BILLETES_PKT ( MDIFrame pFrame )
  {
    super ( "BILLETES_PKT", pFrame );
   ...
   *
   */
  public static BILLETES_PKT get ( RallyApplication __app )
  {
    return ( BILLETES_PKT ) __app.getNewInstance ( "BILLETES_PKT" );
  }
  ...
  {
    BILLETES_PKT fSheet = BILLETES_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return BILLETES_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTEREXIT, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; FLAG_BILLETE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
