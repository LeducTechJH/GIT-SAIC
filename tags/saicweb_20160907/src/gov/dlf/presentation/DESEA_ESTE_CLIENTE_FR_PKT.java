 ...
 */
public class DESEA_ESTE_CLIENTE_FR_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public DESEA_ESTE_CLIENTE_FR_PKT ( )
  {
    super ( "DESEA_ESTE_CLIENTE_FR_PKT" );
   ...
   *
   */
  public DESEA_ESTE_CLIENTE_FR_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DESEA_ESTE_CLIENTE_FR_PKT ( MDIFrame pFrame )
  {
    super ( "DESEA_ESTE_CLIENTE_FR_PKT", pFrame );
   ...
   *
   */
  public static DESEA_ESTE_CLIENTE_FR_PKT get ( RallyApplication __app )
  {
    return ( DESEA_ESTE_CLIENTE_FR_PKT ) __app.getNewInstance ( "DESEA_ESTE_CLIENTE_FR_PKT" );
  }
  ...
  {
    DESEA_ESTE_CLIENTE_FR_PKT fSheet = DESEA_ESTE_CLIENTE_FR_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DESEA_ESTE_CLIENTE_FR_PKT.exec ( __app );
  }
