 ...
 */
public class SERV_SOST2_RO_PKT
     extends FormSheet
{
  // -------------------------------------------------------------------
  // ----------   Class Attributes   -----------------------------------
   ...
   *
   */
  public SERV_SOST2_RO_PKT ( )
  {
    super ( "SERV_SOST2_RO_PKT" );
   ...
   *
   */
  public SERV_SOST2_RO_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public SERV_SOST2_RO_PKT ( MDIFrame pFrame )
  {
    super ( "SERV_SOST2_RO_PKT", pFrame );
   ...
   *
   */
  public static SERV_SOST2_RO_PKT get ( RallyApplication __app )
  {
    return ( SERV_SOST2_RO_PKT ) __app.getNewInstance ( "SERV_SOST2_RO_PKT" );
  }
  ...
  {
    SERV_SOST2_RO_PKT fSheet = SERV_SOST2_RO_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return SERV_SOST2_RO_PKT.exec ( __app );
  }
