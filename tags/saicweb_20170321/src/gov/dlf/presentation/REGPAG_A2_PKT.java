     ...
     extends FormSheet
{
   ...
   *
   */
  public REGPAG_A2_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public REGPAG_A2_PKT ( MDIFrame pFrame )
  {
    super ( "REGPAG_A2_PKT", pFrame );
  ...
  {
    this.createComponents ( new REGPAG_A2_FR ( ) );
   ...
   *
   */
  public static REGPAG_A2_PKT get ( RallyApplication __app )
  {
    return ( REGPAG_A2_PKT ) __app.getNewInstance ( "REGPAG_A2_PKT" );
  }
  ...
  {
    REGPAG_A2_PKT fSheet = REGPAG_A2_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return REGPAG_A2_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; REGPAG_A_NOMBRE_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
