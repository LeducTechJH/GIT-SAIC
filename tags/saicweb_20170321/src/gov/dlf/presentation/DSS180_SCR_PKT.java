     ...
     extends FormSheet
{
   ...
   *
   */
  public DSS180_SCR_PKT ( )
  {
    super ( "DSS180_SCR_PKT" );
   ...
   *
   */
  public DSS180_SCR_PKT ( String packetTitle )
  {
    super ( packetTitle );
   ...
   *
   */
  public DSS180_SCR_PKT ( MDIFrame pFrame )
  {
    super ( "DSS180_SCR_PKT", pFrame );
  ...
  {
    this.createComponents ( new DSS180_SCR_FR ( ) );
   ...
   *
   */
  public static DSS180_SCR_PKT get ( RallyApplication __app )
  {
    return ( DSS180_SCR_PKT ) __app.getNewInstance ( "DSS180_SCR_PKT" );
  }
  ...
  {
    DSS180_SCR_PKT fSheet = DSS180_SCR_PKT.get ( __app );
    fSheet.execute ( null );
  ...
  {
    return DSS180_SCR_PKT.exec ( __app );
  }
  ...
  public void setEvents ( )
  {
    ...
    this.formModel.setListener ( JDataPanelListener.AFTERLOAD, new JDataPanelListener ( )
    {
      ...
      {
        app.errorFlag = true; DSS180_BF_ADL.exec ( app ); return app.errorFlag;
      }
    } );
  }
}
