     ...
     extends Form
{
  ...
  {
    super ( );
    this.setName ( "PENDAUTO_FR" );

    Debug.println ( Debug.TRACE, "PENDAUTO_FR - constructor" );

    this.setDefinitionPath ( "gov/dlf/presentation/PENDAUTO_FR.jdp" );
  ...
  public void setApplication ( Application __app )
  {
    ...
    this.setArguments ( "SERVICIOS_GP", new PENDAUTO_FR_SERVICIOS_GP_Arguments ( this ) );

    this.setObjectEvents ( );
    field = ( JDataPanelField ) this.getInDepth ( "OFICINA" );
    field.setValueProvider ( new PENDAUTO_FR_OFICINAProvider ( this ) );
    field = ( JDataPanelField ) this.getInDepth ( "FECHA" );
    field.setValueProvider ( new PENDAUTO_FR_FECHAProvider ( this ) );
 ...
 *
 */
class PENDAUTO_FR_SERVICIOS_GP_Arguments extends JDataPanelGroupArguments
{
  /**  */
  ...
  /**  */
  public PENDAUTO_FR_SERVICIOS_GP_Arguments ( Form form )
  {
    this.model = form;
 ...
 *
 */
class PENDAUTO_FR_OFICINAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public PENDAUTO_FR_OFICINAProvider ( Form form )
  {
    this.model = form;
  }
 ...
 *
 */
class PENDAUTO_FR_FECHAProvider implements IObjectValueProvider
{
  /**  */
  protected Form model;
  /**  */
  ...
  /**  */
  public PENDAUTO_FR_FECHAProvider ( Form form )
  {
    this.model = form;
  }
